...
int func_53(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_63(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_63(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_63(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_95(iVar0);
						if (Global_71400 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_63(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_63(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_63(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
void func_73(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_74(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_63(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_63(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_75(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_75(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_75(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_75(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_112(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_106(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_106(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_63(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_167(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_63(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_63(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_180()
{
	...
	vVar7 = { func_179() };
	GAMEPLAY::GET_MODEL_DIMENSIONS(iVar0, &vVar1, &vVar4);
...
int func_182(int iParam0, int iParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_186(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			...
			if (bParam1)
			{
				if ((((((func_222(3, Local_237.f_1, Local_237.f_4) && func_222(4, Local_244.f_1, Local_244.f_4)) && func_222(8, Local_251.f_1, Local_251.f_4)) && func_208(&Local_257, Local_257.f_5, Local_257.f_1, Local_257.f_4, 1)) && func_222(9, vLocal_209, 0)) && func_222(5, Local_251.f_1, Local_251.f_4)) && func_222(7, vLocal_209, 0))
				{
					...
					if (func_451(iLocal_263))
					{
						...
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_263, vLocal_212, 1f, 60000, 1048576000, 0, 1193033728);
					}
					if (func_451(Local_237))
					{
					...
					ENTITY::SET_ENTITY_COORDS(Local_251, -1106.365f, -579.0142f, 31.1366f, 1, 1, 0, 1);
...
void func_205(int iParam0, int iParam1)
{
	...
	{
		VEHICLE::SET_VEHICLE_ENGINE_ON(Local_251, 1, 1, 0);
		VEHICLE::SET_VEHICLE_FORWARD_SPEED(Local_251, iParam0);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_237, 1, 1);
		AI::TASK_VEHICLE_DRIVE_TO_COORD(Local_237, Local_251, -1106.365f, -579.0142f, 31.1366f, iParam1, 0, 0, 36438053, 2f, 0.5f);
		VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(Local_251, 0);
...
int func_222(int iParam0, vector3 vParam1, float fParam4)
{
	switch (iParam0)
	{
		...
		case 1:
			if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_204, "NONE") && GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_267, "NONE"))
			{
				return 1;
			}
		...
		case 3:
			if (func_451(Global_90209.f_9[0]))
			{
				...
				if (func_451(Local_237))
				{
					AUDIO::STOP_PED_SPEAKING(Local_237, 1);
					PED::SET_PED_CONFIG_FLAG(Local_237, 214, 0);
		...
		case 4:
			...
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_9[1], 1, 1);
				Local_244 = Global_90209.f_9[1];
				if (func_451(Local_244))
				{
					AUDIO::STOP_PED_SPEAKING(Local_244, 1);
					PED::SET_PED_CONFIG_FLAG(Local_244, 214, 0);
					func_224(&uLocal_268, 4, Local_244, "GIANNI", 0, 1);
					WEAPON::GIVE_WEAPON_TO_PED(Local_244, joaat("weapon_pistol"), -1, 0, 1);
		...
		case 5:
			...
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_9[2], 1, 1);
	...
	switch (iLocal_92)
	{
		...
		case 1:
			...
			if (iLocal_93 == 0 || iLocal_96 != 0)
			{
				...
				{
					ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_212, 4f, 4f, 2f, 1, 1, 0);
					func_235(&uLocal_206, vLocal_212, 0);
					if (iLocal_229 == 0)
					{
						UI::_0x3D3D15AF7BCAAF83(12, 1, 0);
						UI::_0xA905192A6781C41B(vLocal_215);
...
int func_237()
{
	switch (iLocal_96)
	{
		...
		case 2:
			PED::SET_PED_MIN_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID(), 1f);
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_222) > 4000)
			{
				iLocal_96 = 3;
			}
			break;
...
void func_240()
{
	if (iLocal_91 == 2)
	{
		if (func_241(&uLocal_97, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
		{
			CUTSCENE::REQUEST_CUTSCENE("sol_2_ext_concat", 8);
			if (CUTSCENE::_0xB56BBBCC2955D9CB())
			{
...
void func_245()
{
	...
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_222) > 2000)
		{
			if (func_8(Local_251))
			{
				AUDIO::_0x18EB48CFC41F2EA0(Local_251, 0);
		...
		case 1:
			if (!iLocal_450)
			{
				if (!func_30())
				{
					if (iLocal_234 != -1)
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_234) > 2000)
						{
			...
			{
				Var0 = { func_250() };
				if (GAMEPLAY::ARE_STRINGS_EQUAL(&Var0, sLocal_446))
				{
					iLocal_92 = 2;
				}
			}
...
void func_282(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_284(Var11.f_1)) && iVar72 < 51)
			{
...
int func_299(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_315(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_300(iVar0, 0), 1);
...
void func_340()
{
	...
	switch (iLocal_92)
	{
		...
		case 1:
			if (!func_30() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_222) > 3000)
			{
...
void func_341()
{
	...
	switch (iLocal_92)
	{
			...
			if (!func_451(Local_237))
			{
				...
				if (!bLocal_448)
				{
					if (func_399(0, &bLocal_448, "SOL2_MKT", 1092616192, 7))
					{
						...
						vLocal_218 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
						if (func_8(Local_251))
						{
		...
		case 2:
			if (iLocal_223 != -1)
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_223) > 1000)
				{
					iLocal_92 = 0;
					iLocal_91 = 6;
				}
...
void func_347(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_370(uParam1) && ENTITY::IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
int func_353(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_360() || func_359(Global_4456448.f_161209)) || func_358())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_356(uVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
	...
	if (iLocal_235 != -1)
	{
		if (func_378() > 20f)
		{
			if (!func_30() && !UI::IS_MESSAGE_BEING_DISPLAYED())
			{
				...
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_235) > 5000)
					{
						if (func_376())
						{
				...
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_235) > 12000)
					{
...
void func_381()
{
	if (func_451(Local_244))
	{
		...
		if (iLocal_95 != 3)
		{
			...
			{
				AI::TASK_COMBAT_PED(Local_244, PLAYER::PLAYER_PED_ID(), 0, 16);
		...
		switch (iLocal_95)
		{
			...
			case 2:
				if (!iLocal_221)
				{
					if (!func_241(&uLocal_97, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) && !func_241(&uLocal_97, ENTITY::GET_ENTITY_COORDS(Local_244, 1)))
					{
						iLocal_221 = 1;
					}
				}
				...
				{
					AI::TASK_DRIVE_BY(Local_244, PLAYER::PLAYER_PED_ID(), 0, vLocal_209, 35f, 65, 0, -753768974);
				}
				break;
...
int func_384(var uParam0, bool bParam1, var uParam2, int iParam3)
{
	...
	if (bVar1)
	{
		if (func_7(uParam0))
		{
			...
			UI::SET_BLIP_AS_FRIENDLY(iVar0, uParam2);
			UI::SET_BLIP_PRIORITY(iVar0, iParam3);
...
void func_385()
{
	if (func_451(Local_237))
	{
		...
		{
			case 1:
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_222) > 250)
				{
					if (func_8(Local_251))
					{
			...
			case 3:
				if (func_8(Local_251))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_237, Local_251, 0))
					{
						if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_251))
						{
							if (AI::GET_VEHICLE_WAYPOINT_PROGRESS(Local_251) > 54)
							{
								AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_237, Local_251, PLAYER::PLAYER_PED_ID(), 8, 35f, 34340900, 550f, 2f, 1);
								VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(Local_251, 1);
								iLocal_94 = 4;
							}
						}
					}
			...
			case 5:
				...
				{
					AI::TASK_LEAVE_ANY_VEHICLE(Local_237, 0, 0);
				}
				else
				{
...
void func_390(int iParam0, char* sParam1, int iParam2, int iParam3)
{
	...
	{
		ENTITY::FREEZE_ENTITY_POSITION(iParam0, 0);
		if (func_8(Local_251) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(sParam1))
		{
			AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iParam0, Local_251, sParam1, 786468, iParam2, iParam3, -1, -1082130432, 0, 1073741824);
		}
	}
}
	...
	if ((iLocal_94 > 3 && iLocal_94 != 5) && iLocal_94 != 7)
	{
		if (func_8(Local_251))
		{
			if (!iLocal_230)
			{
				...
				{
					AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_237, Local_251, PLAYER::PLAYER_PED_ID(), 8, 50f, 34340900, 200f, 2f, 1);
					iLocal_230 = 1;
				}
			}
			else if (!func_377(Local_237, PLAYER::PLAYER_PED_ID(), 145f, 1))
			{
				AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_237, Local_251, PLAYER::PLAYER_PED_ID(), 8, 35f, 34340900, 200f, 2f, 1);
				iLocal_230 = 0;
			}
		}
	}
...
void func_392()
{
	if (iLocal_94 != 7)
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_237, -1737.935f, -1125.939f, 12.01733f, -1751.796f, -1114.709f, 16.0172f, 8.77f, 0, 1, 0))
		{
			if (func_8(Local_251))
			{
				AI::TASK_VEHICLE_MISSION_COORS_TARGET(Local_237, Local_251, -1844.916f, -1224.451f, 12.01705f, 4, 50f, 2883621, 5f, 2f, 1);
				iLocal_94 = 7;
			}
		}
	}
...
void func_393()
{
	if (func_8(Local_251))
	{
		...
		{
			if (UI::DOES_BLIP_EXIST(Local_237.f_6))
			{
				if (!iLocal_226)
				{
					func_29(&(Local_237.f_6));
		...
		else if (UI::DOES_BLIP_EXIST(Local_237.f_6))
		{
			if (iLocal_226)
			{
				func_29(&(Local_237.f_6));
		...
		if (func_451(iLocal_263))
		{
			...
			else if (iLocal_92 == 1)
			{
				if (func_377(PLAYER::PLAYER_PED_ID(), iLocal_263, 15f, 1))
				{
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_233) > 15000 && !UI::IS_MESSAGE_BEING_DISPLAYED())
						{
...
void func_398()
{
	PED::ADD_RELATIONSHIP_GROUP("SolomonREL", &uLocal_266);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_266, 1862763509);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, 1862763509, uLocal_266);
	if (func_451(iLocal_263))
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_263, uLocal_266);
	}
}
...
void func_404()
{
	...
	switch (iLocal_92)
	{
		...
		case 2:
			...
			{
				PED::SET_PED_MOVEMENT_CLIPSET(iLocal_263, "move_injured_generic", 1048576000);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_263, vLocal_212, 0.2f, 60000, 1048576000, 0, 1193033728);
			}
			UNK1::_0x81CBAE94390F9F89();
			func_231(0);
			break;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_435(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_432(ENTITY::GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
{
	GAMEPLAY::SET_BIT(&Global_25923, iParam0);
...
void func_439(bool bParam0)
{
	...
	func_442();
	func_441();
	PED::REMOVE_RELATIONSHIP_GROUP(uLocal_266);
	if (func_451(PLAYER::PLAYER_PED_ID()))
	{
		PED::SET_PED_USING_ACTION_MODE(PLAYER::PLAYER_PED_ID(), 0, -1, "DEFAULT_ACTION");
	}
