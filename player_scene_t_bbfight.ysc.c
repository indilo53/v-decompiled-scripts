...
int func_2()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
	{
		...
		if (func_20(iVar1))
		{
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_497))
			{
				if (!iLocal_502)
				{
					if (fVar0 < fLocal_501)
					...
					{
						if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_489))
						{
							func_15(&uLocal_114, func_16(), PLAYER::PLAYER_PED_ID(), &Local_489, 0, 1);
						}
						if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_493))
						{
	...
	if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_299) > 100f)
	{
		return 1;
	}
	return 0;
		...
		if (!PED::IS_PED_INJURED((*iParam0)[iVar0]))
		{
			switch ((*iParam1)[iVar0])
			{
				case 100:
					...
					{
						AI::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_91041, &cLocal_371, &(Local_387[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
						(*iParam1)[iVar0] = 101;
					}
				...
				case 101:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
					{
						AI::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_91042, &cLocal_371, &(Local_420[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
				...
				case 102:
					if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_371) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/]), 2))
					{
						...
						if (iLocal_113 == 165)
						{
							if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_453[iVar0 /*16*/])))
							{
								...
								if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_91042))
								{
									...
									{
										AI::TASK_START_SCENARIO_IN_PLACE((*iParam0)[iVar0], &(Local_453[iVar0 /*16*/]), 0, 0);
				...
				case 200:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_91041))
					{
						AI::TASK_PLAY_ANIM((*iParam0)[iVar0], &cLocal_371, &(Local_387[iVar0 /*16*/]), 8f, -1000f, -1, 0, 0, 0, 0, 0);
						(*iParam1)[iVar0] = 201;
					}
					else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
					{
				...
				case 201:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
					{
						AI::TASK_PLAY_ANIM((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/]), 8f, -1.5f, -1, 32768, 0, 0, 0, 0);
					...
					if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_371) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/]), 1))
					{
						...
						if (iLocal_113 == 108 || iLocal_113 == 109)
						{
							if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/])) > 0.954f)
							{
								...
								AI::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
				...
				case 0:
					...
					fVar17 = GAMEPLAY::ABSF((fVar15 - fVar16));
					if (fVar17 > 45f)
					{
						if (!AI::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], 1920390111) == 1)
						{
							AI::TASK_ACHIEVE_HEADING((*iParam0)[iVar0], fVar16, 0);
						}
						break;
					}
					if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_453[iVar0 /*16*/])))
				...
				case 1:
					vVar18 = { ENTITY::GET_ENTITY_COORDS((*iParam0)[iVar0], 1) };
					...
					{
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vVar21, 0.5f, -1, 1048576000, 0, 1193033728);
						break;
					}
					break;
				...
				case 10:
					if (AI::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], -71340211) == 7 || AI::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], -71340211) == 1)
					{
						...
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_289, 1862763509);
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_289);
				...
				case 11:
					if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_299) > 50f && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS((*iParam0)[iVar0], 1)) > 50f)
					{
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_289, 1862763509);
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, 1862763509, uLocal_289);
						AI::CLEAR_PED_TASKS((*iParam0)[iVar0]);
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 0.5f, -1, 1048576000, 0, 1193033728);
						(*iParam1)[iVar0] = 1;
					}
				...
				case 5:
					...
					{
						if (GAMEPLAY::ARE_STRINGS_EQUAL(&(Local_453[iVar0 /*16*/]), "any"))
						{
							if (AI::DOES_SCENARIO_EXIST_IN_AREA(vLocal_299 + vLocal_303[iVar0 /*3*/], 20f, 1))
							{
								AI::TASK_USE_NEAREST_SCENARIO_TO_COORD((*iParam0)[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 20f, 0);
								iLocal_486[iVar0] = GAMEPLAY::GET_GAME_TIMER();
							}
						}
						else
						{
							...
							AI::TASK_START_SCENARIO_IN_PLACE((*iParam0)[iVar0], &(Local_453[iVar0 /*16*/]), 0, iVar26);
							iLocal_486[iVar0] = GAMEPLAY::GET_GAME_TIMER();
						}
					}
					else if (ENTITY::DOES_ENTITY_EXIST(uLocal_290[iVar0]))
					{
						if (iLocal_486[iVar0] > 0)
						{
							if (GAMEPLAY::GET_GAME_TIMER() > iLocal_486[iVar0] + 1000)
							{
								OBJECT::DELETE_OBJECT(&(uLocal_290[iVar0]));
								ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(uLocal_290[iVar0]));
							}
	...
	while (iVar0 < 263)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_26140[iVar0 /*23*/].f_11, 0))
		{
			...
			else
			{
				...
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uParam0, 1), vVar1) < (fParam1 * fParam1))
				{
					return 1;
				}
				if (GAMEPLAY::IS_BIT_SET(Global_26140[iVar0 /*23*/].f_11, 19))
				{
					iVar5 = 3;
					iVar4 = 0;
					while (iVar4 < iVar5)
					{
						...
						if (!func_24(vVar6))
						{
							if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uParam0, 1), vVar6) < (fParam1 * fParam1))
							{
								return 1;
							}
						}
...
int func_27(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7, int iParam8, int iParam9, int iParam10)
{
	...
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(uParam0, vVar0, vVar3, (vParam4.y * 2f), iParam8, iParam9, iParam10))
	{
		return 1;
	}
	return 0;
...
int func_32(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_34(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_34(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_50()
{
	...
	PED::ADD_RELATIONSHIP_GROUP("FIGHTERS", &uLocal_289);
	iVar0 = 0;
	while (iVar0 < iLocal_280)
	{
		if (iLocal_286[iVar0] != 0)
		{
			iLocal_280[iVar0] = PED::CREATE_PED(26, iLocal_286[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 0, 1, 1);
			...
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_280[iVar0], uLocal_289);
			AI::TASK_STAND_STILL(iLocal_280[iVar0], -1);
			if (iLocal_113 == 285)
			{
		...
		if (iLocal_293[iVar0] != 0)
		{
			uLocal_290[iVar0] = OBJECT::CREATE_OBJECT(iLocal_293[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 1, 1, 0);
			ENTITY::SET_ENTITY_HEADING(uLocal_290[iVar0], (fLocal_302 + fLocal_310[iVar0]));
			ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_290[iVar0], iLocal_280[iVar0], PED::GET_PED_BONE_INDEX(iLocal_280[iVar0], iLocal_296[iVar0]), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
		iVar0++;
	}
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_289, 1862763509);
...
void func_51()
{
	...
	switch (iLocal_113)
	{
		...
		case 166:
			...
			fLocal_310[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
		...
		case 259:
			vLocal_303[0 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_303[1 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			fLocal_310[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_310[1] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
		...
		default:
			...
			fLocal_321[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			break;
	}
}
...
void func_62()
{
	...
	PED::REMOVE_RELATIONSHIP_GROUP(uLocal_289);
