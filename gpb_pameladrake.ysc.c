...
void __EntryFunction__()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < Global_26026 + 10000 && !func_100())
	{
		func_107(0);
	}
	...
	Global_26026 = GAMEPLAY::GET_GAME_TIMER();
	GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_242, 0.5f, 0);
	uLocal_240 = PED::CREATE_PED(25, iLocal_36, vLocal_242, ScriptParam_0.f_17[0], 0, 1);
	func_97();
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_36);
	iLocal_241 = 1;
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_240) && func_96(uLocal_240))
	{
	...
	while (iVar0 == 1)
	{
		...
		fVar43 = func_90(PLAYER::PLAYER_PED_ID(), uLocal_240);
		...
		vVar76 = { ENTITY::GET_ENTITY_COORDS(uLocal_240, 1) };
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if ((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_240) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_240)) && fVar43 < 25f) && func_82(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_79(uLocal_240, PLAYER::PLAYER_PED_ID(), 1126825984, 0))
			{
				if (!func_83())
				{
					func_85();
		...
		if (((((PED::IS_PED_INJURED(uLocal_240) || GAMEPLAY::IS_BULLET_IN_AREA(vVar76, 50f, 1)) || GAMEPLAY::IS_BULLET_IN_AREA(vVar76, 50f, 0)) || GAMEPLAY::IS_PROJECTILE_IN_AREA(vVar76, 20f, 20f, 20f, 0)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vVar76, 50f)) || GRAPHICS::_0x2F09F7976C512404(vVar76, 1f))
		{
			if (!func_83())
			{
				func_85();
		...
		if (func_78(uLocal_240, PLAYER::PLAYER_PED_ID(), 1) < 25f)
		{
		...
		switch (iLocal_250)
		{
			...
			case 5:
				...
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_240, vLocal_242, 1f, -1, 1f, 1024, ScriptParam_0.f_17[0]);
					iLocal_250 = 6;
				}
				break;
			...
			case 3:
				...
				if (func_78(uLocal_240, PLAYER::PLAYER_PED_ID(), 1) < fVar40)
				{
					if (func_52() == 1)
					{
						iLocal_250 = 8;
			...
			case 8:
				...
				else if (iLocal_440 == 1)
				{
					...
					{
						func_46(Global_106510[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_240, &Local_372, &Local_356));
					}
				}
				break;
		...
		if (((((((((((((iLocal_250 == 0 || iLocal_250 == 1) || iLocal_250 == 3) || iLocal_250 == 8) || iLocal_250 == 9) || iLocal_250 == 7) && func_78(uLocal_240, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_436 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar30 == 0) && bLocal_439 == 1) && !Global_3) && func_7()) && bVar81)
		{
			if (iLocal_298 == -1)
			{
	...
	while (true)
	{
		...
		if ((ENTITY::IS_ENTITY_OCCLUDED(uLocal_240) && func_78(uLocal_240, PLAYER::PLAYER_PED_ID(), 1) > 50f) && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			func_107(1);
		}
		SYSTEM::WAIT(0);
...
void func_1()
{
	...
	if ((ENTITY::DOES_ENTITY_EXIST(uLocal_448) && !ENTITY::IS_ENTITY_DEAD(uLocal_448, 0)) && !ENTITY::IS_ENTITY_DEAD(uLocal_240, 0))
	{
		if (!iLocal_449)
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_240, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) < 15f)
			{
				AI::TASK_FLUSH_ROUTE();
				...
				AI::TASK_FOLLOW_POINT_ROUTE(uLocal_448, 1f, 0);
				iLocal_449 = 1;
			}
		}
		else
		{
			...
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_448, 1), 377.4565f, 154.6708f, 102.0838f, 1) > 25f)
			{
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uLocal_448);
				iLocal_450 = 1;
			}
			else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_448, 1), ENTITY::GET_ENTITY_COORDS(uLocal_240, 1), 1) < 3f && iLocal_451 == 0)
			{
				iLocal_451 = 1;
			}
		}
...
{
	func_9();
	if (func_96(uLocal_240) && func_96(PLAYER::PLAYER_PED_ID()))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_240, 0);
...
void func_9()
{
	...
	{
		AUDIO::_0x18EB48CFC41F2EA0(uLocal_240, 0);
	}
}
...
void func_62(int iParam0, bool bParam1)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (func_71(iParam0))
		{
			if (!func_69(iParam0))
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_26428.f_2), iVar0);
				if (!bParam1)
				{
...
int func_69(int iParam0)
{
	if (func_71(iParam0))
	{
		return GAMEPLAY::IS_BIT_SET(Global_106565.f_26428.f_2, iParam0);
	}
	return 0;
}
...
int func_70(int iParam0)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		return GAMEPLAY::IS_BIT_SET(Global_106565.f_26428.f_2, iVar0);
	}
	return 0;
}
...
int func_79(var uParam0, var uParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_81(ENTITY::GET_ENTITY_COORDS(uParam1, 1) - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_81(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_98()
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uLocal_240, 0))
	{
		AUDIO::_DYNAMIC_MIXER_RELATED_FN(uLocal_240, "MAG_2_PAM_PED_GROUP", 0);
	}
}
...
int func_106(var uParam0)
{
	...
	if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam0, "gpb_AndyMoon"))
	{
		return 1;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam0, "gpb_Baygor"))
	{
		return 2;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam0, "gpb_BillBinder"))
	{
		return 4;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam0, "gpb_Clinton"))
	{
		return 8;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam0, "gpb_Griff"))
	{
		return 16;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam0, "gpb_Jane"))
	{
		return 64;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam0, "gpb_Jerome"))
	{
		return 128;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam0, "gpb_Jesse"))
	{
		return 256;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam0, "gpb_Mani"))
	{
		return 512;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam0, "gpb_Mime"))
	{
		return 1024;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam0, "gpb_PamelaDrake"))
	{
		return 2048;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam0, "gpb_Superhero"))
	{
		return 4096;
	}
	else if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam0, "gpb_Zombie"))
	{
		return 8192;
	}
	return 0;
