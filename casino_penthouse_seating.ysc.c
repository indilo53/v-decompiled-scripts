...
void func_1(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			...
			{
				if ((((((((((((func_53(uParam0) || func_49(uParam0)) || func_48(uParam0)) || !func_47(uParam0)) || func_45(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) || PED::_0xDCCA191DF9980FD7(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) || GAMEPLAY::IS_BIT_SET(Global_1671295.f_4, 2)) || func_44(uParam0->f_16[uParam0->f_9 /*14*/].f_13))
				{
					if (func_49(uParam0))
					{
				...
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - uParam0->f_11) > 150)
					{
				...
				else if (CONTROLS::IS_CONTROL_JUST_PRESSED(0, 51))
				{
					...
					{
						GAMEPLAY::SET_BIT(&(Global_2424047[PLAYER::PLAYER_ID() /*416*/].f_309.f_4), 15);
						func_35(157);
					}
				}
			}
		...
		case 4:
			...
			vVar23 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_30(uParam0), func_29(uParam0), 0, 2) };
			uVar26 = vVar23.z;
			fVar27 = 0.05f;
		...
		case 5:
			...
			vVar29 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_30(uParam0), func_29(uParam0), 0, 2) };
			fVar32 = vVar29.z;
		...
		case 8:
			...
			if (iVar35 == 0 || iVar35 == 1)
			{
				...
				{
					if ((PED::GET_SYNCHRONIZED_SCENE_PHASE(uVar34) >= 0.7f || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), GAMEPLAY::GET_HASH_KEY("BREAKOUT_FINISH"))) || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), GAMEPLAY::GET_HASH_KEY("BREAK_OUT")))
					{
						NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_8);
						func_28(-1);
						func_40(uParam0);
...
void func_2(var uParam0, bool bParam1)
{
	...
	else
	{
		...
		if ((GAMEPLAY::GET_GAME_TIMER() - uParam0->f_1) >= 90000 && uParam0->f_1.f_1 != 3)
		{
			iVar1 = func_3(uParam0);
			if (iVar1 != uParam0->f_1.f_2)
			{
...
void func_8(var uParam0)
{
	...
	if (uParam0->f_13 == 6)
	{
		...
		if ((uParam0->f_13 == 6 && !ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), GAMEPLAY::GET_HASH_KEY("BLOCK_INTERRUPT"))) && !func_32(&(uParam0->f_7), 12))
		{
		...
		if (ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), GAMEPLAY::GET_HASH_KEY("BLOCK_INTERRUPT")))
		{
			func_40(uParam0);
		}
		...
		else
		{
			...
			if (((((!UI::IS_PAUSE_MENU_ACTIVE() && !func_32(&(uParam0->f_7), 0)) && !func_32(&(uParam0->f_7), 4)) && !func_11()) && !func_9(1)) && uParam0->f_1.f_3 != 3)
			{
				if (uParam0->f_6 == -1)
				{
				...
				if (uParam0->f_13 == 6)
				{
					...
					if (CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(2, iVar4))
					{
						func_14(uParam0);
					}
				}
...
int func_37(var uParam0)
{
	...
	iVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, func_6(uParam0->f_1.f_1));
	if (uParam0->f_1.f_1 == 1)
	{
		if (func_4())
		{
...
int func_54(var uParam0, vector3 vParam1, int iParam4)
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
		...
		{
			if (func_16(ENTITY::GET_ENTITY_HEADING(uParam0), (vParam1.z - 180f), 45f))
			{
				return 1;
			}
		}
		else if (func_16(ENTITY::GET_ENTITY_HEADING(uParam0), vParam1.z, 45f))
		{
			return 1;
		}
	}
...
void func_59(var uParam0)
{
	...
	else if (uParam0->f_13 > 4)
	{
		...
		uParam0->f_12 = GAMEPLAY::GET_FRAME_COUNT();
	}
	else if ((GAMEPLAY::GET_FRAME_COUNT() - uParam0->f_12) < 5)
	{
		PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_60());
	}
}
...
void func_61(var uParam0)
{
	...
	func_62(&(uParam0->f_7), 2, AI::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
void func_85(var uParam0)
{
	...
	GAMEPLAY::CLEAR_BIT(&(Global_2424047[PLAYER::PLAYER_ID() /*416*/].f_309.f_4), 15);
}
