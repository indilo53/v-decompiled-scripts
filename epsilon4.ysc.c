...
void func_11()
{
	...
	while (func_339(PLAYER::PLAYER_PED_ID()) == iLocal_159)
	{
		...
		if (STREAMING::HAS_ANIM_DICT_LOADED("weapons@holster_1h"))
		{
			...
			{
				AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "weapons@holster_1h", "holster", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
			}
...
int func_49(var uParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(uParam0, func_92(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(uParam0, func_92(iParam1), Global_71402[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_92(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, 0);
		}
	}
...
int func_52(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_92(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_92(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_92(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_83(iVar0);
						if (Global_71400 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_92(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_92(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_92(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
void func_68(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_69(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_70(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_70(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_70(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_70(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_110(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_103(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_103(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_92(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_165(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_92(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_92(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_234(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_236(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_236(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_238()
{
	...
	if (Local_772.f_1 == 0)
	{
		...
		{
			uLocal_362 = VEHICLE::CREATE_VEHICLE(joaat("bison"), 1851.57f, 4772.12f, 39.8f, 31.35f, 1, 1, 0);
			VEHICLE::SET_VEHICLE_COLOURS(uLocal_362, 157, 157);
			VEHICLE::SET_VEHICLE_EXTRA_COLOURS(uLocal_362, 5, 157);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_362, 1084227584);
		}
		...
		if (func_340(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (iLocal_353 == 0)
			{
				...
				{
					uLocal_641 = func_269(PLAYER::PLAYER_PED_ID(), joaat("weapon_digiscanner"), 1, 0, 0, 0, 0, 0, 0);
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_641, "Artefact_Detector", 0, 0, 0);
				}
...
void func_248()
{
	...
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(10f);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		...
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Jimmy_Boston", 0))
		{
			if (iLocal_353 >= 2)
			{
				if (func_229(Local_83.f_28[1]) && func_286(uLocal_362))
				{
					...
					AI::TASK_WARP_PED_INTO_VEHICLE(0, uLocal_362, 0);
	...
	if (func_229(Local_606[0 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Marnie", 0))
		{
			if (iLocal_353 >= 2)
			{
				...
				{
					AI::OPEN_SEQUENCE_TASK(&uLocal_782);
					AI::TASK_WARP_PED_INTO_VEHICLE(0, uLocal_362, -1);
					AI::TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_362, 1743.33f, 4962.18f, 45.16f, 20f, 0, joaat("bison"), 786599, 5f, -1f);
					AI::TASK_VEHICLE_DRIVE_WANDER(0, uLocal_362, 30f, 262275);
					AI::CLOSE_SEQUENCE_TASK(uLocal_782);
			...
			{
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_83.f_28[0], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_83.f_28[0], 0f, 7f, 0f), 1f, 20000, 1048576000, 5, 1193033728);
	...
	if (func_229(uLocal_641))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Artefact_Detector", 0))
		{
			if (iLocal_353 < 2)
			{
				...
				WEAPON::GIVE_WEAPON_OBJECT_TO_PED(uLocal_641, PLAYER::PLAYER_PED_ID());
				func_5(&uLocal_641);
...
int func_269(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_273(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(uParam0, iVar2, func_273(iVar2, iVar8)))
			{
				if (func_272(func_273(iVar2, iVar8)))
				{
					uVar9 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_273(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_273(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(uParam0, iVar2, func_273(iVar2, iVar8)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_273(iVar2, iVar8));
...
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_165, "SET_COLOUR");
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(67);
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(200);
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(255);
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(255);
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(209);
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(67);
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(255);
...
void func_301()
{
	...
	if (Local_772.f_3 == 1)
	{
		...
		if (iLocal_353 == 0)
		{
			...
			if (func_340(Local_606[1 /*8*/]))
			{
				...
				GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(1829.75f, 4693.5f, 38.51f, &uVar1, 0, 0);
				ENTITY::SET_ENTITY_COORDS(Local_606[1 /*8*/], vVar2.x, vVar2.y, uVar1, 1, 0, 0, 1);
	...
	if (Local_772.f_1 == 0)
	{
		...
		if (iLocal_353 == 0)
		{
			...
			if (func_340(Local_606[1 /*8*/]))
			{
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_606[1 /*8*/], 1826.246f, 4696.506f, 38.1187f, 1f, 20000, 0.1f, 0, 1193033728);
			}
	...
	if (Local_772.f_1 == 1)
	{
		...
		else if (!func_321(&uLocal_694, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
		{
			func_237(6);
			Local_772.f_9 = 8;
			Local_772.f_1 = 3;
		...
		else
		{
			...
			{
				func_315(&uLocal_164);
				if (!func_321(&uLocal_642, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
				{
					iLocal_339 = 0;
					AUDIO::STOP_SCRIPTED_CONVERSATION(0);
					UI::CLEAR_PRINTS();
				...
				{
					if (GAMEPLAY::ARE_STRINGS_EQUAL(Local_363[iLocal_353 /*43*/].f_36, sLocal_161) || func_306(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_36, 7, 0, 0, 0))
					{
						if (!GAMEPLAY::ARE_STRINGS_EQUAL(Local_363[iLocal_353 /*43*/].f_36, sLocal_161))
						{
							if (func_229(uLocal_361))
							{
								AI::TASK_LOOK_AT_ENTITY(uLocal_361, PLAYER::PLAYER_PED_ID(), 10000, 0, 2);
							}
						}
						iLocal_759 = GAMEPLAY::GET_GAME_TIMER();
						iLocal_340 = 1;
				...
				{
					if (!func_280() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_358) >= 7500)
					{
						if ((GAMEPLAY::ARE_STRINGS_EQUAL(Local_363[iLocal_353 /*43*/].f_37, sLocal_161) || !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_361, 30f, 30f, 30f, 0, 1, 0)) || func_306(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_37, 7, 0, 0, 0))
						{
							if (!GAMEPLAY::ARE_STRINGS_EQUAL(Local_363[iLocal_353 /*43*/].f_37, sLocal_161))
							{
								if (func_229(uLocal_361))
								{
									AI::TASK_LOOK_AT_ENTITY(uLocal_361, PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
								}
							}
							iLocal_341 = 1;
							iLocal_759 = GAMEPLAY::GET_GAME_TIMER();
				...
				else if (iLocal_338 == 0 && !func_304(PLAYER::PLAYER_PED_ID(), Local_363[iLocal_353 /*43*/].f_2, 9f))
				{
					...
					{
						if (func_303(PLAYER::PLAYER_PED_ID(), uLocal_361, 30f, 1) || iLocal_353 == 2)
						{
							if (!func_280() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_356) > 15000)
							{
								if (bLocal_336)
								{
									if (iLocal_352 == 0)
									{
										...
										{
											if (GAMEPLAY::ARE_STRINGS_EQUAL(Local_363[iLocal_353 /*43*/].f_40, sLocal_161) || func_306(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_40, 7, 0, 0, 0))
											{
												if (func_340(uLocal_361))
												{
													AI::TASK_LOOK_AT_ENTITY(uLocal_361, PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
												}
												iLocal_356 = GAMEPLAY::GET_GAME_TIMER();
												iLocal_750++;
												if (iLocal_353 == 2)
									...
									{
										if (GAMEPLAY::ARE_STRINGS_EQUAL(Local_363[iLocal_353 /*43*/].f_40, sLocal_161) || func_306(&uLocal_168, "EPS4AUD", "EPS4_HASSIG", 7, 0, 0, 0))
										{
											iLocal_356 = GAMEPLAY::GET_GAME_TIMER();
											iLocal_752++;
										}
								...
								{
									if (GAMEPLAY::ARE_STRINGS_EQUAL(Local_363[iLocal_353 /*43*/].f_41, sLocal_161) || func_306(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_41, 7, 0, 0, 0))
									{
										if (func_340(uLocal_361))
										{
											AI::TASK_LOOK_AT_ENTITY(uLocal_361, PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
				...
				if (iLocal_353 == 0)
				{
					if (iLocal_753 < 5)
					{
						if (((GAMEPLAY::GET_GAME_TIMER() - iLocal_755) > 7500 && !func_280()) && !UI::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (func_229(Local_606[0 /*8*/]))
							{
			...
			else
			{
				...
				else if (iLocal_344 == 0)
				{
					if (iLocal_353 < 2)
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_361, 30f, 30f, 30f, 0, 1, 0))
						{
							if (!func_280() && !UI::IS_MESSAGE_BEING_DISPLAYED())
							{
								if (GAMEPLAY::ARE_STRINGS_EQUAL(Local_363[iLocal_353 /*43*/].f_38, sLocal_161) || func_306(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_38, 7, 0, 0, 0))
								{
									iLocal_344 = 1;
								}
							}
				...
				else if (iLocal_345 == 0)
				{
					if (iLocal_353 < 2)
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_361, 30f, 30f, 30f, 0, 1, 0))
						{
							if ((!func_280() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_358) >= 7500) && !UI::IS_MESSAGE_BEING_DISPLAYED())
							{
								if (GAMEPLAY::ARE_STRINGS_EQUAL(Local_363[iLocal_353 /*43*/].f_39, sLocal_161) || func_306(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_39, 7, 0, 0, 0))
								{
									iLocal_345 = 1;
								}
							}
					...
					else if ((!func_280() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_358) >= 7500) && !UI::IS_MESSAGE_BEING_DISPLAYED())
					{
						if (GAMEPLAY::ARE_STRINGS_EQUAL(Local_363[iLocal_353 /*43*/].f_39, sLocal_161) || func_306(&uLocal_168, "EPS4AUD", Local_363[iLocal_353 /*43*/].f_39, 7, 0, 0, 0))
						{
							iLocal_345 = 1;
...
void func_317(var uParam0)
{
	...
	else
	{
		...
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_165, "SET_DISTANCE");
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(fLocal_640);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		UI::SET_TEXT_RENDER_ID(uLocal_166);
		GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_165, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	}
			...
			else if (uParam0->f_2 == 0)
			{
				...
				if (Local_538[uParam0->f_3 /*6*/].f_4 == 0)
				{
					if (*uParam0 == Local_606[1 /*8*/])
					{
						...
						AI::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_idle_a_jb", 1090519040, -4f, -1, 0, 0, 0, 0, 0);
					...
					else
					{
						...
						AI::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_idle_a_marnie", 1090519040, -4f, -1, 0, 0, 0, 0, 0);
				...
				else if (Local_538[uParam0->f_3 /*6*/].f_4 == 2)
				{
					...
					AI::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "peeing", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
				}
		...
		case 4:
			...
			else if (uParam0->f_2 == 0)
			{
				if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uParam0->f_4, 1f, 1f, 1f, 0, 1, 0) || iLocal_353 > 0)
				{
					...
					PED::SET_GROUP_FORMATION_SPACING(func_319(), 4f, -1082130432, -1082130432);
					uParam0->f_2 = 1;
				}
			}
			else if (uParam0->f_2 == 1)
			{
				...
				{
					if ((((GAMEPLAY::GET_GAME_TIMER() - iLocal_757) > 7500 && !func_280()) && !UI::IS_MESSAGE_BEING_DISPLAYED()) && !iLocal_337)
					{
						if (*uParam0 == Local_606[1 /*8*/])
						{
				...
				{
					if ((((iLocal_758 < 4 && !func_280()) && !UI::IS_MESSAGE_BEING_DISPLAYED()) && !iLocal_337) && !func_341())
					{
						if (*uParam0 == Local_606[1 /*8*/])
						{
...
{
	if (func_340(uParam0) && func_229(PLAYER::PLAYER_PED_ID()))
	{
		if (iLocal_623 == 0)
		{
			if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0) && PED::IS_PED_RAGDOLL(uParam0))
			{
...
int func_331()
{
	...
	if (!STREAMING::HAS_MODEL_LOADED(uLocal_160) || !STREAMING::HAS_MODEL_LOADED(joaat("bison")))
	{
		return 0;
	}
	return 1;
...
void func_335()
{
	if (func_229(Local_606[0 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Marnie", 0))
		{
			...
			AI::TASK_GO_STRAIGHT_TO_COORD(Local_606[0 /*8*/], Local_538[Local_606[0 /*8*/].f_3 /*6*/], 1f, -1, 1193033728, 1056964608);
...
void func_338()
{
	...
	if (Local_772.f_1 == 0)
	{
		...
		if (!func_401(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, 1, 0))
		{
...
void func_366(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1))
	{
		...
		func_367("Rock actual position: ", ENTITY::GET_ENTITY_COORDS(uParam0->f_1, 0));
...
void func_368()
{
	...
	UI::LINK_NAMED_RENDERTARGET(uLocal_160);
	if (UI::IS_NAMED_RENDERTARGET_REGISTERED("digiscanner"))
	{
