...
void func_55(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_57() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_57() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
int func_63(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_57() /*10778*/].f_6165.f_10, iParam0);
}
...
void func_94(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	if (!func_100(uParam0->f_1, 256) || (func_100(uParam0->f_1, 8192) && CONTROLS::_0x6CD79468A1E595C6(2)))
	{
		...
		if (GAMEPLAY::IS_PC_VERSION())
		{
			...
			GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(func_100(uParam0->f_1, 4096));
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		}
		iVar5 = 0;
		iVar6 = 0;
...
void func_103(var uParam0, bool bParam1)
{
	...
	func_99(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 215, 1));
	func_98("ES_HELP");
	if (GAMEPLAY::IS_PC_VERSION())
	{
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(1);
	...
	if (bParam1)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
		func_99(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 216, 1));
		func_98("ES_XPAND");
		if (GAMEPLAY::IS_PC_VERSION())
		{
			GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(1);
...
void func_105(var uParam0, float fParam1, var uParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_120();
		GRAPHICS::DRAW_RECT(0.5f, (fVar1 - (func_123((2f - 0.5f)) - 0.001388889f)), fVar6, func_118(1f), uVar13, uVar14, uVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_104((fVar11 / (0.6f * func_123(25f))), 0f, 1f);
					func_120();
					GRAPHICS::DRAW_RECT(0.5f, (fVar1 + func_123((2f * 0.5f))), fVar6, func_118(1f), uVar13, uVar14, uVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_123((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_123((25f * 0.2f)));
		...
		if (fVar11 >= 0f)
		{
			...
			switch (uParam0->f_556)
			{
				case 0:
					...
					UI::END_TEXT_COMMAND_DISPLAY_TEXT(fVar20, (fVar1 + func_123((2f * 2f))), 0);
					break;
...
void func_115(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, var uParam5)
{
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			GRAPHICS::DRAW_SPRITE("CommonMenu", func_111(7, 0), (fParam4 - 0.006f), ((fParam2 + func_123(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, uParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_108(5, 0, 1, &fVar5, &fVar6, 0);
			GRAPHICS::DRAW_SPRITE("CommonMenu", func_111(5, 0), (fParam4 - 0.006f), ((fParam2 + func_123(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, uParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_108(6, 0, 1, &fVar5, &fVar6, 0);
			GRAPHICS::DRAW_SPRITE("CommonMenu", func_111(6, 0), (fParam4 - 0.006f), ((fParam2 + func_123(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, uParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_134(var uParam0)
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(2);
	func_99(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 188, 1));
	func_98("ES_HELP_TU");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
	func_99(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 187, 1));
	func_98("ES_HELP_TD");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(0);
	func_99(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 202, 1));
	func_98("ES_HELP_AB");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	...
	switch (iLocal_1042)
	{
		...
		case 7:
			...
			if (iLocal_1461 >= 2)
			{
				...
				{
					if (func_274(uLocal_1575, PLAYER::PLAYER_PED_ID(), 1) > 500f)
					{
...
void func_183(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_208(uParam1) && ENTITY::IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
int func_188(char* sParam0)
{
	if (!func_189(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_210(sParam0)) || func_210("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_189(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_197() || func_196(Global_4456448.f_161209)) || func_195())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_193(uVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_217(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_218(PLAYER::PLAYER_PED_ID(), uParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (PED::IS_PED_RAGDOLL(uParam0) && func_256(uParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_220(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (WEAPON::IS_PED_ARMED(uParam0, 2))
	{
		...
		else
		{
			...
			if (PED::IS_PED_PLANTING_BOMB(uParam0) || func_221(iVar3))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(uParam1, ENTITY::GET_ENTITY_COORDS(uParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (PED::IS_PED_FACING_PED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(uParam1), uParam0, 120f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(uParam1, uParam0, 17))
...
int func_224(var uParam0, int iParam1, bool bParam2)
{
	...
	if (ENTITY::IS_ENTITY_A_VEHICLE(uParam0))
	{
		UI::SET_BLIP_SCALE(uVar0, func_97(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_97(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, iParam1);
	}
	else if (ENTITY::IS_ENTITY_AN_OBJECT(uParam0))
	{
...
void func_225(var uParam0)
{
	switch (iLocal_1462)
	{
		...
		case 1:
			if (!iLocal_1516)
			{
				if ((((func_216(*uParam0, 0, &Local_122, &uLocal_133, 0, 1, 0, 1, 1) || GAMEPLAY::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), 15f, 0, 1)) || iLocal_1518) || func_256(*uParam0, 1) < 5f) || (PED::IS_PED_IN_FLYING_VEHICLE(PLAYER::PLAYER_PED_ID()) && func_256(*uParam0, 1) <= 35f))
				{
					if (!PED::IS_PED_INJURED(*uParam0))
					{
...
void func_237(var uParam0, var uParam1)
{
	...
	switch (iLocal_1462)
	{
		...
		case 1:
			if (((((func_216(*uParam1, 0, &Local_122, &uLocal_133, 1, 0, 0, 1, 1) || func_247(&bLocal_1523)) || func_246(*uParam1, &uLocal_1596, 1f, 20f, &uLocal_1524)) || (func_235(*uParam1, 25f) && iLocal_1518)) || FIRE::IS_EXPLOSION_IN_ANGLED_AREA(-1, -1218.042f, -1549.616f, -3.3703f, -1185.349f, -1597.103f, 10.5993f, 46f)) || iLocal_1518)
			{
				AUDIO::STOP_SCRIPTED_CONVERSATION(0);
		...
		if (!func_45())
		{
			if (!iLocal_1518)
			{
				if (!iLocal_1519)
				{
					...
					else if (func_256(*uParam0, 1) < 20f && !UI::IS_MESSAGE_BEING_DISPLAYED())
					{
						func_241(uParam0);
					}
				}
...
{
	return func_274(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), uParam0, iParam1);
}
...
int func_258(var uParam0)
{
	if (iLocal_1461 == 0)
	{
		if ((func_216(*uParam0, 0, &Local_122, &uLocal_133, 0, 0, 0, 1, 1) || func_247(&bLocal_1523)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vLocal_1563, 25f))
		{
			return 1;
		}
	}
	...
	if (!iLocal_1527)
	{
		...
		while (iVar0 <= 1)
		{
			if (!PED::IS_PED_INJURED(Local_2204[iVar0 /*9*/]))
			{
				...
				{
					AI::TASK_GO_TO_COORD_ANY_MEANS(Local_2204[iVar0 /*9*/], func_260(), 2f, 0, 0, 786603, -1082130432);
					PED::SET_PED_KEEP_TASK(Local_2204[iVar0 /*9*/], 1);
				}
			}
			if (bParam0)
...
{
	return func_243(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), vParam0, iParam3);
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_289(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_311(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_313(Var11.f_1)) && iVar72 < 51)
			{
...
int func_323(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_325() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_64(func_324(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
var func_344()
{
	...
	func_354(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_353(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_352(&uVar0, TIME::GET_CLOCK_HOURS());
	func_347(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_346(&uVar0, TIME::GET_CLOCK_MONTH());
	func_345(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_350(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
						...
						if (Global_2992[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_370(Global_14534, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(uVar6), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
...
int func_389(var uParam0, var uParam1, bool bParam2)
{
	...
	if ((!UI::HAS_ADDITIONAL_TEXT_LOADED(3) && !func_385(&(uParam0->f_34))) && !func_381(uParam1))
	{
		func_492(uParam1);
		return 0;
	}
	...
	if (func_392(uParam0))
	{
		...
		if (func_391(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_426(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && GAMEPLAY::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_426(var uParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_427(uParam0, uVar1[iVar6], 1) && func_393(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_202(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_430(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_289(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_289(iVar1 + 1)))
			{
			}
			else
			{
				GAMEPLAY::SET_BIT(&(uParam1->f_77), func_289(iVar1 + 1));
			}
		}
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_438(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_437())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam1->f_77, func_289(iVar2 + 1)))
				{
...
int func_431(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_435(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_434(*uParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_434(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_433(uParam0);
	if (func_432(*uParam0))
	{
...
void func_447(var uParam0, var uParam1, bool bParam2)
{
	...
	while ((!UI::HAS_ADDITIONAL_TEXT_LOADED(3) || !func_385(&(uParam0->f_34))) || !func_381(uParam1))
	{
		func_492(uParam1);
		SYSTEM::WAIT(0);
	}
...
void func_466(var uParam0)
{
	...
	switch (iLocal_1464)
	{
		...
		case 1:
			...
			if (((func_488(&uLocal_1491) && func_39(&uLocal_1491) > fLocal_1476) || (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_1505) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_1505) >= 0.978f)) || bLocal_1497)
			{
				iLocal_1464 = 3;
			}
			break;
