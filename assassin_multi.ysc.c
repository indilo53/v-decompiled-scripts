...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(3))
	{
		...
		func_503();
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_1465))
		{
			ENTITY::SET_ENTITY_VISIBLE(uLocal_1465, 1, 0);
			ENTITY::SET_ENTITY_COLLISION(uLocal_1465, 1, 0);
			ENTITY::SET_ENTITY_CAN_BE_DAMAGED(uLocal_1465, 1);
		}
	...
	uLocal_1589 = PED::ADD_SCENARIO_BLOCKING_AREA(vLocal_1563 - Vector(2f, 2f, 2f), vLocal_1563 + Vector(2f, 2f, 2f), 0, 1, 1, 1);
	func_498();
	iLocal_1444 = 1;
	...
	if (func_501())
	{
		...
		if (iLocal_1552 == 0)
		{
			...
			fLocal_1573 = 0.0954f;
			func_494(vLocal_1614, fLocal_1627, 1, 0);
		}
		else if (iLocal_1552 == 1)
		{
			...
			func_494(vLocal_1566, fLocal_1569, 1, 0);
		}
...
void func_5(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_7(Global_106070.f_18505[iVar0], &vVar2, &fVar5))
			{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_44(iParam2), 1);
}
...
void func_47(struct<39> Param0, var uParam39, var uParam40)
{
	...
	switch (iLocal_1044)
	{
		...
		case 1:
			...
			if (func_130(&uLocal_150, 1, 0) && AUDIO::_0x6F259F82D873B8B8())
			{
...
void func_91(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (!func_97(uParam0->f_1, 256) || (func_97(uParam0->f_1, 8192) && CONTROLS::_0x6CD79468A1E595C6(2)))
	{
		...
		if (GAMEPLAY::IS_PC_VERSION())
		{
			...
			GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(func_97(uParam0->f_1, 4096));
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		}
		iVar5 = 0;
		iVar6 = 0;
...
void func_100(var uParam0, bool bParam1)
{
	...
	func_96(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 215, 1));
	func_95("ES_HELP");
	if (GAMEPLAY::IS_PC_VERSION())
	{
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(1);
	...
	if (bParam1)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
		func_96(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 216, 1));
		func_95("ES_XPAND");
		if (GAMEPLAY::IS_PC_VERSION())
		{
			GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(1);
...
void func_102(var uParam0, float fParam1, var uParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	if (fVar11 >= 0f)
	{
		...
		func_117();
		GRAPHICS::DRAW_RECT(0.5f, (fVar1 - (func_120((2f - 0.5f)) - 0.001388889f)), fVar6, func_115(1f), uVar13, uVar14, uVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_101((fVar11 / (0.6f * func_120(25f))), 0f, 1f);
					func_117();
					GRAPHICS::DRAW_RECT(0.5f, (fVar1 + func_120((2f * 0.5f))), fVar6, func_115(1f), uVar13, uVar14, uVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_120((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_120((25f * 0.2f)));
...
void func_104(var uParam0, float fParam1, float fParam2, int iParam3, bool bParam4, int iParam5)
{
...
void func_112(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, var uParam5)
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			GRAPHICS::DRAW_SPRITE("CommonMenu", func_108(7, 0), (fParam4 - 0.006f), ((fParam2 + func_120(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, uParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_105(5, 0, 1, &fVar5, &fVar6, 0);
			GRAPHICS::DRAW_SPRITE("CommonMenu", func_108(5, 0), (fParam4 - 0.006f), ((fParam2 + func_120(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, uParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_105(6, 0, 1, &fVar5, &fVar6, 0);
			GRAPHICS::DRAW_SPRITE("CommonMenu", func_108(6, 0), (fParam4 - 0.006f), ((fParam2 + func_120(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, uParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_113(int iParam0, var uParam1, float fParam2, float fParam3, var uParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_131(var uParam0)
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(2);
	func_96(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 188, 1));
	func_95("ES_HELP_TU");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
	func_96(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 187, 1));
	func_95("ES_HELP_TD");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(0);
	func_96(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 202, 1));
	func_95("ES_HELP_AB");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
void func_134()
{
	...
	if (!iLocal_139)
	{
		...
		if (Global_87504)
		{
			func_139(&uLocal_150, 6, &(Local_727.f_12), "MTPHPERSKI", SYSTEM::FLOOR(fLocal_134), 0, 3, 0);
			func_139(&uLocal_150, 6, &(Local_727.f_24), "MTPHPERSKI", 0, 0, 3, 0);
			func_139(&uLocal_150, 6, &(Local_727.f_30), "MTPHPERSKI", SYSTEM::ROUND((fLocal_136 + fLocal_135)), 0, 3, 0);
			func_138();
		}
		else
		{
			if (bLocal_138)
			{
				func_139(&uLocal_150, 6, &(Local_727.f_12), "MTPHPERRET", SYSTEM::FLOOR(fLocal_134), 0, 3, 0);
			}
			else
			{
				func_139(&uLocal_150, 9, &(Local_727.f_12), "", SYSTEM::FLOOR(fLocal_134), 0, 0, 0);
			}
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_727.f_18)))
			{
				if (bLocal_137)
				{
					...
					func_139(&uLocal_150, 3, &(Local_727.f_30), "", SYSTEM::ROUND((fLocal_136 + fLocal_135)), 0, 2, 0);
				}
				else
				{
					func_139(&uLocal_150, 6, &(Local_727.f_24), "", 0, 0, 1, 0);
					func_139(&uLocal_150, 3, &(Local_727.f_30), "", SYSTEM::ROUND(fLocal_135), 0, 0, 0);
				}
			}
			else
			{
...
void func_135()
{
	...
	{
		func_136(38, SYSTEM::FLOOR(fLocal_134), 1);
		if (bLocal_137)
		{
			func_136(39, 1, 1);
		}
		...
		if (bLocal_137)
		{
			func_136(40, SYSTEM::ROUND((fLocal_136 + fLocal_135)), 1);
		}
		else
		{
			func_136(40, SYSTEM::ROUND(fLocal_135), 1);
		}
	...
	{
		func_136(52, SYSTEM::FLOOR(fLocal_134), 1);
		if (bLocal_137)
		{
			func_136(53, 1, 1);
		}
		...
		if (bLocal_137)
		{
			func_136(56, SYSTEM::ROUND((fLocal_136 + fLocal_135)), 1);
		}
		else
		{
			func_136(56, SYSTEM::ROUND(fLocal_135), 1);
		}
	...
	{
		func_136(66, SYSTEM::FLOOR(fLocal_134), 1);
		if (bLocal_137)
		{
			func_136(67, 1, 1);
		}
		...
		if (bLocal_137)
		{
			func_136(68, SYSTEM::ROUND((fLocal_136 + fLocal_135)), 1);
		}
		else
		{
			func_136(68, SYSTEM::ROUND(fLocal_135), 1);
		}
	...
	{
		func_136(81, SYSTEM::FLOOR(fLocal_134), 1);
		if (bLocal_137)
		{
			func_136(82, 1, 1);
		}
		...
		if (bLocal_137)
		{
			func_136(83, SYSTEM::ROUND((fLocal_136 + fLocal_135)), 1);
		}
		else
		{
			func_136(83, SYSTEM::ROUND(fLocal_135), 1);
		}
	...
	{
		func_136(97, SYSTEM::FLOOR(fLocal_134), 1);
		if (bLocal_137)
		{
			func_136(98, 1, 1);
		}
		...
		if (bLocal_137)
		{
			func_136(99, SYSTEM::ROUND((fLocal_136 + fLocal_135)), 1);
		}
		else
		{
			func_136(99, SYSTEM::ROUND(fLocal_135), 1);
		}
...
void func_143(var uParam0)
{
	if (func_487(uParam0))
	{
		if (!func_41(uParam0))
		{
			uParam0->f_2 = (func_40(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
	...
	switch (iLocal_1042)
	{
		...
		case 4:
			...
			if (bLocal_1514)
			{
				...
				GAMEPLAY::CLEAR_AREA(vLocal_1570, 5f, 1, 0, 0, 0);
				uVar1 = func_407(vLocal_1570, fLocal_1573);
		...
		case 7:
			...
			if (iLocal_1461 >= 2)
			{
				if (ENTITY::DOES_ENTITY_EXIST(uLocal_1575))
				{
					if (func_271(uLocal_1575, PLAYER::PLAYER_PED_ID(), 1) > 500f)
					{
						ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_1575);
					}
				}
			}
			if (!iLocal_1536)
...
void func_155(var uParam0, var uParam1)
{
	...
	*uParam1 = 0;
	if (iLocal_1461 != 1)
	{
		ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uParam1->f_1));
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_1575))
		{
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_1575);
		}
	}
	else if (ENTITY::DOES_ENTITY_EXIST(uParam1->f_1))
	{
		uLocal_1575 = uParam1->f_1;
	}
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_1574))
	{
		ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_1574);
	}
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_1577))
	{
		ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_1577);
	}
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_1576))
	{
		ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_1576);
	}
	iLocal_1518 = 0;
	iLocal_1548 = 0;
	iLocal_143 = 0;
...
void func_176(var uParam0, var uParam1)
{
	...
	func_177(&uLocal_1794, *uParam1, 0, 0, 1, 1, 1);
}

void func_177(var uParam0, var uParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	func_178(uParam0, uParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_178(var uParam0, var uParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)
{
	func_179(uParam0, uParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_179(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	uParam0->f_6 = 2;
	func_180(uParam0, uParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_180(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	...
	if (func_205(uParam1) && ENTITY::IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_196(uParam0, uParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
int func_186(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_194() || func_193(Global_4456448.f_152990)) || func_192())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_190(uVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_196(var uParam0, var uParam1, vector3 vParam2, int iParam5)
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool func_199(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
...
int func_212(var uParam0, float fParam1, float fParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
		if (!PED::IS_PED_INJURED(uParam0))
		{
			...
			else if (func_253(uParam0, 1) > fParam1)
			{
...
int func_213(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)
{
	var uVar0;
	bool bVar1;
	...
	if (!ENTITY::IS_ENTITY_DEAD(uVar0, 0) && !ENTITY::IS_ENTITY_DEAD(uParam0, 0))
	{
		...
		{
			if (func_217(uVar0, uParam0, uParam2, bParam5))
			{
				*uParam3 = 4;
				return 1;
			}
		...
		{
			if (func_216(uVar0, uParam0, uParam2))
			{
				*uParam3 = 8;
				return 1;
			}
		...
		if (bParam4)
		{
			if (func_214(uParam0, iParam1, 1, bParam6, bVar1, 1))
			{
				*uParam3 = 32;
				return 1;
			}
		...
		{
			if (func_214(uParam0, iParam1, 0, bParam6, bVar1, bParam8))
			{
				*uParam3 = 16;
				return 1;
			}
...
int func_214(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	var uVar0;
	var uVar1;
	...
	if (func_215(PLAYER::PLAYER_PED_ID(), uParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (PED::IS_PED_RAGDOLL(uParam0) && func_253(uParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_217(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	...
	if (WEAPON::IS_PED_ARMED(uParam0, 2))
	{
		...
		else
		{
			...
			if (PED::IS_PED_PLANTING_BOMB(uParam0) || func_218(iVar3))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(uParam1, ENTITY::GET_ENTITY_COORDS(uParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (PED::IS_PED_FACING_PED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(uParam1), uParam0, 120f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(uParam1, uParam0, 17))
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
	{
		if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uParam0))
			{
				...
				{
					if (func_253(uParam0, 1) < uParam1->f_2)
					{
						if (uParam1->f_1 == 0)
						{
...
void func_222(var uParam0)
{
	switch (iLocal_1462)
	{
		...
		case 1:
			if (!iLocal_1516)
			{
				if ((((func_213(*uParam0, 0, &Local_122, &uLocal_133, 0, 1, 0, 1, 1) || GAMEPLAY::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), 15f, 0, 1)) || iLocal_1518) || func_253(*uParam0, 1) < 5f) || (PED::IS_PED_IN_FLYING_VEHICLE(PLAYER::PLAYER_PED_ID()) && func_253(*uParam0, 1) <= 35f))
				{
					if (!PED::IS_PED_INJURED(*uParam0))
					{
	...
	switch (iLocal_1462)
	{
		...
		case 1:
			...
			else
			{
				...
				if (!iLocal_1522)
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_1574, 0))
					{
						if (!PED::IS_PED_INJURED(uParam1->f_9))
						{
							if (AI::GET_SCRIPT_TASK_STATUS(uParam1->f_9, 1805844857) != 1)
...
void func_234(var uParam0, var uParam1)
{
	...
	switch (iLocal_1462)
	{
		...
		case 1:
			if (((((func_213(*uParam1, 0, &Local_122, &uLocal_133, 1, 0, 0, 1, 1) || func_244(&bLocal_1523)) || func_243(*uParam1, &uLocal_1596, 1f, 20f, &uLocal_1524)) || (func_232(*uParam1, 25f) && iLocal_1518)) || FIRE::IS_EXPLOSION_IN_ANGLED_AREA(-1, -1218.042f, -1549.616f, -3.3703f, -1185.349f, -1597.103f, 10.5993f, 46f)) || iLocal_1518)
			{
				AUDIO::STOP_SCRIPTED_CONVERSATION(0);
...
void func_237(var uParam0, char* sParam1, char* sParam2)
{
	var uVar0;
...
var func_239(bool bParam0, vector3 vParam1, float fParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 1)
	{
		if (!PED::IS_PED_INJURED(Local_2204[iVar0 /*9*/]))
		{
			...
			{
				fVar2 = func_240(Local_2204[iVar0 /*9*/], vParam1, 1);
				if (fVar2 <= fVar1)
				{
...
float func_240(var uParam0, vector3 vParam1, int iParam4)
{
	if (ENTITY::IS_ENTITY_DEAD(uParam0, 0))
	{
		return -1f;
	...
	if (!PED::IS_PED_INJURED(Local_2204[iVar0 /*9*/]))
	{
		switch (Local_2204[iVar0 /*9*/].f_8)
		{
			case 0:
				...
				{
					if (AI::GET_SCRIPT_TASK_STATUS(Local_2204[iVar0 /*9*/], 242628503) != 1)
					{
						AI::CLEAR_PED_TASKS(Local_2204[iVar0 /*9*/]);
						AI::OPEN_SEQUENCE_TASK(&uVar1);
						AI::TASK_GO_TO_COORD_ANY_MEANS(0, Local_2204[iVar0 /*9*/].f_1, 1f, 0, 0, 786603, -1082130432);
						AI::TASK_TURN_PED_TO_FACE_COORD(0, vLocal_1563, 0);
						AI::CLOSE_SEQUENCE_TASK(uVar1);
						AI::TASK_PERFORM_SEQUENCE(Local_2204[iVar0 /*9*/], uVar1);
						AI::CLEAR_SEQUENCE_TASK(&uVar1);
					}
				}
				else if (AI::GET_SCRIPT_TASK_STATUS(Local_2204[iVar0 /*9*/], 242628503) != 1 && AI::GET_SCRIPT_TASK_STATUS(Local_2204[iVar0 /*9*/], -2017877118) != 1)
				{
			...
			case 1:
				if (AI::GET_SCRIPT_TASK_STATUS(Local_2204[iVar0 /*9*/], -2017877118) != 1)
				{
			...
			case 2:
				if (AI::GET_SCRIPT_TASK_STATUS(Local_2204[iVar0 /*9*/], -1146898486) != 1)
				{
					AI::TASK_WANDER_STANDARD(Local_2204[iVar0 /*9*/], 1193033728, 0);
				}
				break;
			}
	}
	...
	if (!PED::IS_PED_RAGDOLL(uParam0))
	{
		if (bParam1)
		{
			if (PED::IS_PED_MALE(uParam0))
			{
				...
				if (iVar0 == 0)
				{
					AI::TASK_PLAY_ANIM(uParam0, "oddjobs@assassinate@multi@", "react_big_variations_a", 4f, -4f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 0, 0, 0);
				}
				else if (iVar0 == 1)
				{
					AI::TASK_PLAY_ANIM(uParam0, "oddjobs@assassinate@multi@", "react_big_variations_b", 4f, -4f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 0, 0, 0);
				}
				else
				{
					AI::TASK_PLAY_ANIM(uParam0, "oddjobs@assassinate@multi@", "react_big_variations_c", 4f, -4f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 0, 0, 0);
				}
			}
			else
			{
				...
				if (iVar0 == 0)
				{
					AI::TASK_PLAY_ANIM(uParam0, "oddjobs@assassinate@multi@", "idle_a_pros", 4f, -4f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 0, 0, 0);
				}
				else
				{
					AI::TASK_PLAY_ANIM(uParam0, "oddjobs@assassinate@multi@", "idle_a_pros", 4f, -4f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 0, 0, 0);
...
int func_243(var uParam0, var uParam1, float fParam2, float fParam3, var uParam4)
{
	if (func_253(uParam0, 1) < fParam3)
	{
...
{
	if (func_253(uParam0, 0) > fLocal_1558)
	{
		fLocal_1558 = (func_253(uParam0, 0) + 50f);
	}
}

float func_253(var uParam0, int iParam1)
{
	return func_271(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), uParam0, iParam1);
}
...
int func_255(var uParam0)
{
	if (iLocal_1461 == 0)
	{
		if ((func_213(*uParam0, 0, &Local_122, &uLocal_133, 0, 0, 0, 1, 1) || func_244(&bLocal_1523)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vLocal_1563, 25f))
		{
			return 1;
		}
	}
	...
	{
		if (func_213(*uParam0, uParam0->f_1, &Local_122, &uLocal_133, 0, 0, 0, 1, 1) || func_213(uParam0->f_7, 0, &Local_122, &uLocal_133, 0, 0, 0, 1, 1))
		{
			return 1;
		}
	}
	else if (func_213(*uParam0, uParam0->f_1, &Local_122, &uLocal_133, 0, 0, 0, 1, 1))
	{
		return 1;
	}
	return 0;
	...
	if (!iLocal_1527)
	{
		...
		while (iVar0 <= 1)
		{
			if (!PED::IS_PED_INJURED(Local_2204[iVar0 /*9*/]))
			{
				...
				if (iVar1 == 0 || iVar1 == 1)
				{
					if (AI::GET_SCRIPT_TASK_STATUS(Local_2204[iVar0 /*9*/], 1805844857) != 1)
					{
						AI::TASK_SMART_FLEE_PED(Local_2204[iVar0 /*9*/], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
						PED::SET_PED_KEEP_TASK(Local_2204[iVar0 /*9*/], 1);
					}
				}
				else if (AI::GET_SCRIPT_TASK_STATUS(Local_2204[iVar0 /*9*/], 1805844857) != 1)
				{
					AI::TASK_GO_TO_COORD_ANY_MEANS(Local_2204[iVar0 /*9*/], func_257(), 2f, 0, 0, 786603, -1082130432);
					PED::SET_PED_KEEP_TASK(Local_2204[iVar0 /*9*/], 1);
				}
			}
			if (bParam0)
...
void func_262(var uParam0, var uParam1)
{
	switch (iLocal_1461)
	{
		...
		case 1:
			...
			{
				uParam1->f_9 = PED::CREATE_PED(5, uParam0->f_16, uParam0->f_22, uParam0->f_25, 1, 1);
				PED::_0x2208438012482A1A(uParam1->f_9, 0, 0);
				AI::TASK_START_SCENARIO_AT_POSITION(uParam1->f_9, "WORLD_HUMAN_SUNBATHE", uParam0->f_22, uParam0->f_25, 0, 0, 1);
				PED::SET_PED_COMBAT_ATTRIBUTES(uParam1->f_9, 17, 1);
			}
			if (!PED::IS_PED_INJURED(uParam1->f_7))
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam1->f_7, 1);
				PED::SET_PED_DIES_IN_WATER(uParam1->f_7, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam1->f_7, 0, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam1->f_7, 2, 1, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam1->f_7, 3, 0, 3, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam1->f_7, 4, 0, 3, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam1->f_7, 8, 1, 0, 0);
			}
			if (ENTITY::DOES_ENTITY_EXIST(uParam1->f_1))
			{
				AUDIO::SET_VEHICLE_RADIO_ENABLED(uParam1->f_1, 1);
				AUDIO::SET_VEHICLE_RADIO_LOUD(uParam1->f_1, 1);
				ENTITY::_SET_ENTITY_SOMETHING(uParam1->f_1, 1);
			}
			if (!PED::IS_PED_INJURED(*uParam1))
			{
				PED::SET_PED_DIES_IN_WATER(*uParam1, 0);
				func_32(&uLocal_1629, 3, *uParam1, "OJAmlYACHTTARGET", 0, 1);
				func_32(&(uParam1->f_16), 3, *uParam1, "OJAmlYACHTTARGET", 0, 1);
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(*uParam1, 1, 1);
			}
			uLocal_1574 = VEHICLE::CREATE_VEHICLE(joaat("seashark"), -2190.741f, -470.3163f, -0.4779f, 308.1181f, 1, 1, 0);
			PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_1589, 0);
		...
		case 2:
			if ((!PED::IS_PED_INJURED(*uParam1) && ENTITY::DOES_ENTITY_EXIST(uParam1->f_11[0])) && ENTITY::DOES_ENTITY_EXIST(uParam1->f_11[1]))
			{
				...
				ENTITY::ATTACH_ENTITY_TO_ENTITY(*uParam1, uParam1->f_11[0], 0, -2.1f, -0.4f, 0.25f, 0f, 0f, 180f, 1, 1, 0, 0, 2, 1);
				AI::TASK_PLAY_ANIM(*uParam1, "oddjobs@assassinate@multi@windowwasher", "_idle", 8f, -8f, -1, 1, 0, 0, 0, 0);
		...
		case 3:
			if (!PED::IS_PED_INJURED(*uParam1))
			{
				PED::SET_PED_COMBAT_ATTRIBUTES(*uParam1, 6, 1);
				PED::GIVE_PED_HELMET(*uParam1, 0, 4096, -1);
				PED::SET_PED_HELMET(*uParam1, 1);
			...
			uLocal_1576 = VEHICLE::CREATE_VEHICLE(joaat("camper"), -1400.575f, 738.8264f, 182.1478f, 194.607f, 1, 1, 0);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_1576, 1084227584);
			uLocal_1577 = VEHICLE::CREATE_VEHICLE(joaat("bjxl"), -1371.269f, 734.4243f, 182.5433f, 182.766f, 1, 1, 0);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_1577, 1084227584);
			break;
	}
	if (!PED::IS_PED_INJURED(*uParam1))
	{
...
void func_263()
{
	...
	Local_2204[0 /*9*/] = PED::CREATE_PED(5, joaat("a_f_y_fitness_02"), Local_2204[0 /*9*/].f_1, 169.9513f, 1, 1);
	func_242(Local_2204[0 /*9*/], 1);
	Local_2204[1 /*9*/] = PED::CREATE_PED(5, joaat("a_f_y_beach_01"), Local_2204[1 /*9*/].f_1, 257.4617f, 1, 1);
...
void func_264(var uParam0, var uParam1)
{
	...
	func_32(&(uParam1->f_16), 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	if (uParam0->f_274 == 1)
	{
	...
	if (!func_199(uParam1->f_3, func_154(), 0))
	{
		func_268(&(uParam1->f_2), uParam1->f_3, uParam1->f_6);
	}
...
void func_268(var uParam0, vector3 vParam1, var uParam4)
{
...
float func_270(vector3 vParam0, int iParam3)
{
	return func_240(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), vParam0, iParam3);
}
						...
						if (ENTITY::DOES_ENTITY_EXIST(uParam1->f_11[0]))
						{
							if (ENTITY::DOES_ENTITY_EXIST(uParam1->f_11[1]))
							{
								...
								else
								{
									...
									{
										ROPE::ATTACH_ENTITIES_TO_ROPE(uLocal_1562, uParam1->f_11[1], uParam1->f_11[0], -648.59f, 305.73f, fVar13, -648.59f, 305.73f, vVar9.z, fVar14, 0, 0, 0, 0);
										ROPE::ATTACH_ENTITIES_TO_ROPE(uLocal_1561, uParam1->f_11[1], uParam1->f_11[0], -638.93f, 304.92f, fVar13, -638.93f, 304.92f, vVar9.z, fVar14, 0, 0, 0, 0);
										bLocal_1525 = true;
										iLocal_1550 = 1;
									}
								}
...
void func_292()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_1466))
	{
		return;
	}
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	...
	if (SYSTEM::VDIST2(vVar0, vLocal_1469) > 10000f)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_1466))
		{
			...
			OBJECT::DELETE_OBJECT(&uLocal_1466);
		}
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_1465))
		{
			ENTITY::SET_ENTITY_VISIBLE(uLocal_1465, 1, 0);
...
int func_303(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2535519[iParam0 /*3*/][func_304(iParam1)];
...
void func_310(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_312(Var11.f_1)) && iVar72 < 50)
			{
...
int func_318(vector3 vParam0, char* sParam3, vector3 vParam4)
{
	int iVar0;
	int iVar1;
...
int func_326(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_330(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	vVar18 = { Var12 - Var0 };
	vVar18 = { func_331(vVar18, -Var0.f_3.f_2) };
	vVar18 = { func_331(vVar18, vVar6.f_3.f_2) };
	*uParam2 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vVar6, 0f, vVar18) };
	uParam2->f_3 = { Var12.f_3 };
	return 1;
}

Vector3 func_331(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_349(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_358(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
						...
						if (Global_2952[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_369(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2390[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(uVar6), -1f, &(Global_2390[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
...
void func_369(var uParam0, char* sParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
...
{
	return func_408(&(Global_99633.f_2875), vParam0, fParam3, 0);
}
...
int func_425(var uParam0, vector3 vParam1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_426(uParam0, Global_70024.f_139[38], 0))
			{
				func_419(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_426(uParam0, Global_70024.f_139[43], 1))
			{
				func_419(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_426(uParam0, uVar1[iVar6], 1) && func_392(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_199(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
int func_426(var uParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_429(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_437(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_436())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
		{
			func_430(&uParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
...
int func_430(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_434(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_433(*uParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_433(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_432(uParam0);
	if (func_431(*uParam0))
	{
...
void func_445(vector3 vParam0, float fParam3, int iParam4)
{
	int iVar0;
	...
	switch (iLocal_1464)
	{
		case 0:
			...
			if (bLocal_1535)
			{
				if (ENTITY::DOES_ENTITY_EXIST(uLocal_1465))
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_1465))
					{
						ENTITY::SET_ENTITY_VISIBLE(uLocal_1465, 0, 0);
						ENTITY::SET_ENTITY_COLLISION(uLocal_1465, 0, 0);
						ENTITY::SET_ENTITY_CAN_BE_DAMAGED(uLocal_1465, 0);
						uLocal_1466 = OBJECT::CREATE_OBJECT(-1559354806, -700.1226f, -916.8699f, 18.1667f, 1, 1, 0);
						ENTITY::SET_ENTITY_ROTATION(uLocal_1466, 0f, 0f, 0f, 2, 1);
						ENTITY::SET_ENTITY_COLLISION(uLocal_1466, 0, 0);
						ENTITY::SET_ENTITY_CAN_BE_DAMAGED(uLocal_1466, 0);
					}
					...
					uLocal_1505 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_1499, vLocal_1502, 2);
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_1466))
					{
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_1505, uLocal_1466, -1);
					}
					AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_1505, "oddjobs@assassinate@multi@call", "ass_multi_target_call_p1", 1000f, -2f, 2, 0, 1148846080, 0);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_1466, uLocal_1505, "ass_multi_target_call_phone", "oddjobs@assassinate@multi@call", 1000f, -2f, 0, 1148846080);
					if (!CAM::DOES_CAM_EXIST(uLocal_1467))
					{
						uLocal_1468 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_1479, vLocal_1482, 35f, 1, 2);
						uLocal_1467 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_1485, vLocal_1488, 35f, 0, 2);
				...
				else
				{
					...
					if (!ENTITY::DOES_ENTITY_EXIST(uLocal_1465))
					{
						uLocal_1465 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_1469, 5f, 1281992692, 1, 0, 1);
					}
				}
			}
			break;
		...
		case 1:
			...
			if (!iLocal_1498)
			{
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_1505))
					{
						if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_1505) > 0.05f)
						{
			...
			if (((func_487(&uLocal_1491) && func_39(&uLocal_1491) > fLocal_1476) || (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_1505) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_1505) >= 0.978f)) || bLocal_1497)
			{
				iLocal_1464 = 3;
			}
			break;
		...
		case 2:
			...
			if (bLocal_1497)
			{
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					...
					ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_1466, -1000f, 1);
					SYSTEM::WAIT(0);
		...
		case 3:
			...
			ENTITY::SET_ENTITY_COLLISION(uLocal_1466, 1, 0);
			STREAMING::CLEAR_HD_AREA();
			UI::DISPLAY_RADAR(1);
			UI::DISPLAY_HUD(1);
			...
			ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_1465);
			iLocal_1042 = 4;
			break;
	}
}
...
int func_469(var uParam0, float fParam1, vector3 vParam2, vector3 vParam5, float fParam8, bool bParam9, float fParam10)
{
	if (CAM::DOES_CAM_EXIST(*uParam0))
	{
		if (func_487(&uLocal_1494))
		{
			...
			{
				CAM::SET_CAM_COORD(uLocal_1467, vParam2);
				CAM::SET_CAM_ROT(uLocal_1467, vParam5, 2);
...
void func_479(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	func_480(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_480(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, var uParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	var uVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(uVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(uVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_481(uVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_481(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = { func_483(vParam1 - vParam4) };
		vVar3 = { vVar0 };
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_482(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_482(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_482(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_482(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_482(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_482(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_482(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_482(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_482(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_482(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_482(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_482(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_482(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_482(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_482(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_482(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return 1;
		}
	}
...
void func_494(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	if (func_501())
	{
