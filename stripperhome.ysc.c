	...
	if (bParam1)
	{
		if (!bVar0)
		{
			...
			switch (iParam2)
			{
				...
				case 6:
				case 7:
					GAMEPLAY::SET_BIT(&(Global_2097152[func_124() /*10778*/].f_6165.f_1272), iParam0);
					func_121(15, 0);
					break;
			}
			func_120(iVar1);
...
int func_180()
{
	if ((UI::IS_MESSAGE_BEING_DISPLAYED() || AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()) || Global_15866 != 0)
	{
		return 0;
	}
	return 1;
