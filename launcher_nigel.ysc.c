...
{
	if (func_188(uParam1, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
	{
		if (func_177(2))
		{
			if (func_175(iParam0->f_27))
...
int func_191(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_126(PLAYER::PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && !func_144()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_195(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_228(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_230(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_237(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_230(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_230(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_229(vVar3, vVar0);
...
int func_250(var uParam0, var uParam1)
{
	...
	{
		*uParam0 = PED::CREATE_PED(26, joaat("u_m_m_aldinapoli"), -59.7094f, -1330.129f, 32.1963f, 0, 1, 1);
