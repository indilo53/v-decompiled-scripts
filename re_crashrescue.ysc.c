...
void __EntryFunction__()
{
	...
	{
		if (!PED::IS_PED_INJURED(uLocal_75))
		{
			if (PED::IS_PED_GROUP_MEMBER(uLocal_75, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID())))
			{
				PED::REMOVE_PED_FROM_GROUP(uLocal_75);
			}
			AI::TASK_WANDER_STANDARD(uLocal_75, 1193033728, 0);
			PED::SET_PED_KEEP_TASK(uLocal_75, 1);
			SYSTEM::WAIT(0);
		}
...
void func_1()
{
	switch (iLocal_283)
	{
		case 0:
			...
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_75, 1);
				if (!func_333())
				{
					...
					PED::SET_PED_CONFIG_FLAG(uLocal_75, 137, 1);
					iLocal_283++;
				}
			}
			else
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_284 && CAM::IS_SCREEN_FADED_IN())
			{
				if (!PED::IS_PED_INJURED(uLocal_75))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_75, 0))
					{
						PED::SET_PED_DIES_IN_VEHICLE(uLocal_75, 1);
						PED::APPLY_DAMAGE_TO_PED(uLocal_75, 200, 0, 0);
					}
					else
					{
						PED::SET_PED_TO_RAGDOLL(uLocal_75, 500, 1000, 0, 0, 0, 0);
						ENTITY::SET_ENTITY_HEALTH(uLocal_75, 0, 0);
					}
...
void func_20()
{
	...
	{
		case 0:
			if (!PED::IS_PED_INJURED(uLocal_75) && !PED::IS_PED_INJURED(uLocal_76))
			{
				if (PED::IS_PED_IN_GROUP(uLocal_75) || ENTITY::IS_ENTITY_AT_COORD(uLocal_75, vLocal_60, Global_22, 0, 1, 0))
				{
					func_202(1, 0, 1, 0);
			...
			if (iVar0 == 1)
			{
				...
				GAMEPLAY::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(uLocal_76, 1), 20f, 1, 0, 0, 0);
				GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(uLocal_76, 1), 20f, 0);
				SYSTEM::WAIT(0);
				iLocal_55 = 1;
			}
			break;
		...
		case 1:
			if (!PED::IS_PED_INJURED(uLocal_75) && !PED::IS_PED_INJURED(uLocal_76))
			{
				...
				{
					ENTITY::SET_ENTITY_HEALTH(uLocal_75, 200, 0);
					func_63(1, 1, 1, 0, 0, 0);
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						if (func_61(uVar1))
						{
							ENTITY::SET_ENTITY_COORDS(uVar1, 1738.655f, 3836.227f, 33.879f, 1, 0, 0, 1);
							ENTITY::SET_ENTITY_HEADING(uVar1, 119f);
						}
						else
						{
							ENTITY::SET_ENTITY_COORDS(uVar1, vLocal_60, 1, 0, 0, 1);
							ENTITY::SET_ENTITY_HEADING(uVar1, 119f);
						}
						VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uVar1, 1084227584);
						if (func_190())
						{
							CAM::_0x11FA5D3479C7DD47(ENTITY::GET_ENTITY_MODEL(uVar1));
						}
					}
					else
					{
					...
					ENTITY::SET_ENTITY_COORDS(uLocal_75, 1738.047f, 3842.438f, 33.7707f, 1, 0, 0, 1);
					ENTITY::SET_ENTITY_HEADING(uLocal_75, 36.8203f);
					PED::_0x2208438012482A1A(uLocal_75, 0, 0);
					GAMEPLAY::CLEAR_AREA(vLocal_60, 4f, 1, 0, 0, 0);
					func_60(&uVar1);
					uLocal_271 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_80, vLocal_83, 2);
					AI::TASK_SYNCHRONIZED_SCENE(uLocal_75, uLocal_271, sLocal_269, "helping_friend_inside_victim", 1000f, -1000f, 0, 0, 1148846080, 0);
					AI::TASK_SYNCHRONIZED_SCENE(uLocal_76, uLocal_271, sLocal_269, "helping_friend_inside_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
		...
		case 4:
			...
			if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_271) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_271) >= fLocal_282) || func_57())
			{
				...
				PED::DELETE_PED(&uLocal_75);
				PED::DELETE_PED(&uLocal_76);
...
void func_46(int iParam0, bool bParam1)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (!func_49(iParam0))
		{
			GAMEPLAY::SET_BIT(&(Global_106565.f_26428.f_1), iVar0);
			if (!bParam1)
			{
...
int func_49(int iParam0)
{
	...
	{
		return GAMEPLAY::IS_BIT_SET(Global_106565.f_26428.f_1, iParam0);
	}
	return 0;
}
...
void func_51(int iParam0, bool bParam1)
{
	...
	GAMEPLAY::SET_BIT(&(Global_106565.f_1.f_116), iParam0);
	switch (iParam0)
	{
		case 10:
			GAMEPLAY::SET_BIT(&(Global_106565.f_1.f_119), 14);
			break;
		
		case 13:
			GAMEPLAY::SET_BIT(&(Global_106565.f_1.f_119), 16);
			break;
		
		case 12:
			GAMEPLAY::SET_BIT(&(Global_106565.f_1.f_119), 15);
			break;
		
		case 11:
			GAMEPLAY::SET_BIT(&(Global_106565.f_1.f_119), 17);
			break;
	}
	if (!bParam1)
	{
...
int func_61(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
		GAMEPLAY::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(uParam0), &(vVar0[0 /*3*/]), &(vVar0[1 /*3*/]));
		vVar7 = { func_62() };
...
int func_74(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_84(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_84(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_84(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_116(iVar0);
						if (Global_71400 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_84(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_84(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_84(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
void func_94(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_95(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
...
int func_96(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_84(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_99(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_101(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_101(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 4);
		}
	}
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_84(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_96(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_96(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_96(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_96(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_133(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_127(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_127(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_84(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_188(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_84(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_84(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_203()
{
	if (!PED::IS_PED_INJURED(uLocal_75))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uLocal_75))
		{
			bLocal_286 = true;
			iLocal_54 = 2;
			iLocal_283 = 5;
		...
		{
			PED::SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(uLocal_75, 0);
			if (!PED::IS_PED_FLEEING(uLocal_75))
			{
				func_227();
			}
			if (func_215())
			{
				...
				if (bLocal_256)
				{
					if (PED::IS_PED_INJURED(uLocal_76))
					{
						bLocal_286 = true;
						iLocal_54 = 2;
					}
					else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_76, PLAYER::PLAYER_PED_ID(), 1) || func_208(uLocal_76, PLAYER::PLAYER_PED_ID(), 1.25f, 1))
					{
						AI::CLEAR_PED_TASKS(uLocal_76);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_76, 0);
						PED::SET_PED_TO_RAGDOLL(uLocal_76, 250, 500, 0, 0, 0, 0);
						AI::TASK_SMART_FLEE_PED(uLocal_76, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
						PED::SET_PED_KEEP_TASK(uLocal_76, 1);
						bLocal_286 = true;
						iLocal_54 = 2;
						iLocal_283 = 0;
					}
					else if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_60, Global_19, 1, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1722.09f, 3843f, 33.6f, 1740.11f, 3854.94f, 39.22f, 12f, 0, 1, 0))
					{
						iLocal_54 = 1;
						iLocal_55 = 0;
					}
				...
				if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(uLocal_75) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
				{
					if (!PED::IS_PED_ON_ANY_BIKE(uLocal_75))
					{
						...
						if (AI::GET_SCRIPT_TASK_STATUS(uLocal_75, -2017877118) == 7)
						{
							AI::TASK_PLAY_ANIM(uLocal_75, sLocal_268, "LOOP", 2f, -8f, -1, 1, 0, 0, 0, 0);
						}
					}
				}
			}
			else
			{
				...
				if (!func_208(PLAYER::PLAYER_PED_ID(), uLocal_75, 200f, 1))
				{
					iLocal_54 = 2;
					iLocal_283 = 5;
				}
...
int func_204()
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_75, 0))
	{
		uVar0 = PED::GET_VEHICLE_PED_IS_IN(uLocal_75, 0);
...
void func_206()
{
	if (!bLocal_256 && func_214(PLAYER::PLAYER_PED_ID(), vLocal_60, 150f))
	{
		...
		if ((STREAMING::HAS_MODEL_LOADED(iLocal_258) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_269)) && OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(1728.778f, 3851.287f, 33.7826f, 5f, joaat("prop_skid_chair_01"), 0))
		{
			...
			vLocal_83 = { 0f, 0f, 36f };
			uLocal_76 = PED::CREATE_PED(26, iLocal_258, 1728.778f, 3851.287f, 33.7826f, 211.7722f, 1, 1);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_76, 1);
			func_207(&uLocal_88, 5, uLocal_76, "CrashSafehouse", 0, 1);
			uLocal_271 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_80, vLocal_83, 2);
			AI::TASK_SYNCHRONIZED_SCENE(uLocal_76, uLocal_271, sLocal_269, "helping_friend_idle_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
			bLocal_256 = true;
		}
	}
}
...
var func_210(vector3 vParam0, var uParam3)
{
	...
	UI::SET_BLIP_SCALE(uVar0, func_211(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
	UI::SET_BLIP_ROUTE(uVar0, uParam3);
	return uVar0;
}
...
void func_212()
{
	...
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_79, 0))
		{
			iLocal_69 = GAMEPLAY::GET_GAME_TIMER();
			if ((iLocal_69 - iLocal_70) < 1000)
			{
				VEHICLE::SET_VEHICLE_BRAKE_LIGHTS(uLocal_79, 1);
			}
			else if ((iLocal_69 - iLocal_70) > 2000)
			{
				VEHICLE::SET_VEHICLE_BRAKE_LIGHTS(uLocal_79, 0);
...
int func_215()
{
	PED::SET_PED_MAX_MOVE_BLEND_RATIO(uLocal_75, 1f);
	if (PED::IS_PED_GROUP_MEMBER(uLocal_75, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID())))
	{
		...
		else if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_75, 20f, 20f, 20f, 0, 1, 0) || !func_224())
		{
			PED::REMOVE_PED_FROM_GROUP(uLocal_75);
		}
		else if (PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_ON_FOOT(uLocal_75))
			{
				if (AI::GET_SCRIPT_TASK_STATUS(uLocal_75, -828834893) == 7)
				{
					AI::CLEAR_PED_TASKS(uLocal_75);
					AI::TASK_LEAVE_ANY_VEHICLE(uLocal_75, 0, 0);
				}
			}
		}
		return 1;
	...
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_75, Global_19, 0, 1, 0) && func_224())
		{
			PED::SET_PED_AS_GROUP_MEMBER(uLocal_75, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID()));
		}
	}
	else
	{
...
var func_216(var uParam0, bool bParam1, int iParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
		...
		{
			uVar0 = func_222(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(uParam0), bParam1, 0);
		}
		else if (ENTITY::IS_ENTITY_A_VEHICLE(uParam0))
		{
			uVar0 = func_220(ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(uParam0), bParam1, 0);
		}
		else if (ENTITY::IS_ENTITY_AN_OBJECT(uParam0))
		{
			uVar0 = func_217(ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(uParam0));
		}
	}
	return uVar0;
}
...
int func_219(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_211(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
	else if (ENTITY::IS_ENTITY_AN_OBJECT(uParam0))
	{
...
int func_224()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (!PED::IS_PED_INJURED(uLocal_75))
			{
				if (PED::IS_PED_IN_VEHICLE(uLocal_75, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
				{
					iLocal_278 = 0;
					return 1;
				}
...
void func_227()
{
	switch (iLocal_56)
	{
		...
		case 4:
			if (iLocal_67 == 0)
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_66 && !func_333())
				{
					if (func_215())
					{
	...
	switch (iLocal_71)
	{
		...
		case 1:
			if (!PED::IS_PED_INJURED(uLocal_75))
			{
				...
				vLocal_80 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_75, 0f, 0f, 5f) };
				GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vLocal_80, &(vLocal_80.f_2), 0, 0);
				vLocal_83 = { func_235() };
				vLocal_83.z = func_234((fLocal_275 + 180f), 0f, 360f);
				uLocal_270 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_80, vLocal_83, 2);
				...
				GAMEPLAY::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(uLocal_75, 1), 5f, 1, 0, 0, 0);
				GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(uLocal_75, 1), 20f, 0);
				GRAPHICS::REMOVE_PARTICLE_FX_IN_RANGE(ENTITY::GET_ENTITY_COORDS(uLocal_75, 1), 7f);
				uLocal_280 = GRAPHICS::ADD_DECAL(1110, vLocal_272, 0f, 0f, -1f, func_198(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
				...
				AI::TASK_SYNCHRONIZED_SCENE(uLocal_75, uLocal_270, sLocal_263, "HELPING_VICTIM_TO_FEET_VICTIM", 1000f, -4f, 0, 0, 1148846080, 0);
		...
		case 4:
			...
			if (func_19(uLocal_75))
			{
				PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(uLocal_75, 1);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_75, 0);
				PED::SET_PED_CONFIG_FLAG(uLocal_75, 172, 0);
			}
			...
			if (iLocal_254)
			{
				...
				CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
				AI::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				AI::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_75);
				PED::FORCE_PED_MOTION_STATE(PLAYER::PLAYER_PED_ID(), -1871534317, 0, 0, 0);
				PED::FORCE_PED_MOTION_STATE(uLocal_75, -1871534317, 0, 0, 0);
				PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
				PED::_0x2208438012482A1A(uLocal_75, 0, 0);
			...
			else
			{
				if (!bLocal_255)
				{
					...
					AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sVar3, "idle_intro", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
				}
...
void func_236()
{
	if (!PED::IS_PED_INJURED(uLocal_75) && !func_254())
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_75, 80f, 80f, 15f, 0, 1, 0))
		{
			STREAMING::REQUEST_ANIM_DICT(sLocal_263);
			if (!iLocal_287)
			{
			...
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_75, 2.5f, 2.5f, 2.5f, 0, 1, 1) && func_251(1, 0, 1))
			{
				PED::SET_PED_AS_GROUP_MEMBER(uLocal_75, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID()));
				PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uLocal_75, 0);
				PED::SET_PED_CONFIG_FLAG(uLocal_75, 206, 1);
				iLocal_53 = 2;
			}
			else if (func_208(PLAYER::PLAYER_PED_ID(), uLocal_75, 15f, 1) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 4f)
			{
				if (func_333())
				{
					func_249();
				...
				switch (iLocal_68)
				{
					...
					case 1:
						if (!func_333())
						{
							...
							AI::TASK_LOOK_AT_ENTITY(uLocal_75, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
...
int func_247()
{
	if ((Global_106554 == func_43() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
int func_254()
{
	if (!PED::IS_PED_INJURED(uLocal_75))
	{
		if (GAMEPLAY::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(uLocal_75, 31086, 0f, 0f, 0f), 1f, 1))
		{
			return 1;
		}
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_75))
				{
					return 1;
				}
			}
		}
		if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, PED::GET_PED_BONE_COORDS(uLocal_75, 31086, 0f, 0f, 0f), 8f))
		{
			return 1;
		}
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_75, PLAYER::PLAYER_PED_ID(), 1))
		{
			return 1;
		}
		if (PED::IS_PED_RAGDOLL(uLocal_75))
		{
			return 1;
		}
	}
...
void func_255()
{
	...
	if (((((((((STREAMING::HAS_MODEL_LOADED(iLocal_258) && STREAMING::HAS_MODEL_LOADED(iLocal_260)) && STREAMING::HAS_MODEL_LOADED(iLocal_259)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_261)) && STREAMING::HAS_CLIP_SET_LOADED(sLocal_262)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_265)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_266)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_267)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_264)) && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		...
		uLocal_79 = VEHICLE::CREATE_VEHICLE(iLocal_260, 1932.98f, 6291.91f, 41.08f, 350.85f, 1, 1, 0);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_260);
		VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_79, 0, 0, 0);
		VEHICLE::SET_VEHICLE_LIGHTS(uLocal_79, 1);
		VEHICLE::SET_VEHICLE_TYRE_BURST(uLocal_79, 0, 0, 1148846080);
		GAMEPLAY::GET_MODEL_DIMENSIONS(iLocal_260, &uVar0, &vVar3);
		VEHICLE::SMASH_VEHICLE_WINDOW(uLocal_79, 0);
		VEHICLE::SMASH_VEHICLE_WINDOW(uLocal_79, 2);
		VEHICLE::SMASH_VEHICLE_WINDOW(uLocal_79, 3);
		VEHICLE::_DETACH_VEHICLE_WINDSCREEN(uLocal_79);
		VEHICLE::SET_VEHICLE_DAMAGE(uLocal_79, 0f, vVar3.y, 0f, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DAMAGE(uLocal_79, vVar3.x, (vVar3.y * 0.75f), 0f, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DAMAGE(uLocal_79, vVar3.x, 0f, 0f, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DAMAGE(uLocal_79, 0f, 0f, vVar3.z, 500f, 10000f, 1);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(uLocal_79, 5, 1, 1);
		VEHICLE::SET_VEHICLE_DIRT_LEVEL(uLocal_79, 12f);
		VEHICLE::START_VEHICLE_ALARM(uLocal_79);
		ENTITY::SET_ENTITY_PROOFS(uLocal_79, 0, 1, 0, 0, 0, 0, 0, 0);
		ENTITY::SET_ENTITY_ROTATION(uLocal_79, 0f, 180f, 0f, 2, 1);
		VEHICLE::_0x192547247864DFDD(uLocal_79, 1);
		VEHICLE::SET_VEHICLE_UNDRIVEABLE(uLocal_79, 1);
		uLocal_279 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_recrash_rescue_fire", uLocal_79, -0.45f, -1.25f, -0.5f, 0f, 0f, 0f, 1f, 0, 0, 1);
		if (bLocal_276)
		{
			uLocal_75 = PED::CREATE_PED(26, iLocal_259, vLocal_272, (fLocal_275 - 180f), 1, 1);
		}
		else
		{
			uLocal_75 = PED::CREATE_PED(26, iLocal_259, vLocal_272, fLocal_275, 1, 1);
		}
		PED::APPLY_PED_BLOOD_DAMAGE_BY_ZONE(uLocal_75, 0, 0.7f, 0.5f, 2);
		vLocal_63 = { ENTITY::GET_ENTITY_COORDS(uLocal_75, 1) };
		GAMEPLAY::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vLocal_63.x, (vLocal_63.y + 0.1f), (vLocal_63.z + 0.1f), vLocal_63.x, (vLocal_63.y - 0.1f), (vLocal_63.z - 0.1f), 1, 1, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
		AI::TASK_PLAY_ANIM(uLocal_75, sLocal_261, "BASE", 8f, -8f, -1, 9, 0, 0, 0, 0);
		if (func_19(uLocal_75))
		{
			PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(uLocal_75, 0);
		}
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_75, 1);
		ENTITY::SET_ENTITY_HEALTH(uLocal_75, 115, 0);
		PED::SET_PED_DIES_WHEN_INJURED(uLocal_75, 1);
		PED::SET_PED_KEEP_TASK(uLocal_75, 1);
		PED::SET_PED_DIES_IN_VEHICLE(uLocal_75, 1);
		PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(uLocal_75, 0);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_75, 13, 0);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_75, 17, 1);
		PED::SET_PED_MOVEMENT_CLIPSET(uLocal_75, sLocal_262, 1048576000);
		PED::SET_PED_CONFIG_FLAG(uLocal_75, 229, 1);
		func_207(&uLocal_88, 3, uLocal_75, "TALINA", 0, 1);
		PED::APPLY_PED_BLOOD(uLocal_75, 3, 0f, 0f, 0f, "wound_sheet");
		PED::SET_PED_CAN_BE_TARGETTED(uLocal_75, 0);
		uLocal_77 = PED::CREATE_PED(26, iLocal_258, 1935.53f, 6291.888f, 41.144f, -28.44f, 1, 1);
		iLocal_78 = 1;
		vLocal_63 = { ENTITY::GET_ENTITY_COORDS(uLocal_77, 1) };
		PED::APPLY_PED_BLOOD(uLocal_77, 3, 0f, 0f, 0f, "wound_sheet");
		GAMEPLAY::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vLocal_63.x, (vLocal_63.y + 0.1f), (vLocal_63.z + 0.1f), vLocal_63.x, (vLocal_63.y - 0.1f), (vLocal_63.z - 0.1f), 1, 1, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
		PED::SET_PED_CONFIG_FLAG(uLocal_77, 227, 1);
		AI::TASK_PLAY_ANIM_ADVANCED(uLocal_77, sLocal_264, "dead_ped", 1935.53f, 6291.888f, 41.144f, 0f, 0f, -28.44f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		ENTITY::SET_ENTITY_HEALTH(uLocal_77, 0, 0);
...
void func_316()
{
	...
	{
		ENTITY::SET_ENTITY_PROOFS(uLocal_79, 0, 0, 0, 0, 0, 0, 0, 0);
		VEHICLE::SET_VEHICLE_ENGINE_HEALTH(uLocal_79, -400f);
		VEHICLE::SET_VEHICLE_PETROL_TANK_HEALTH(uLocal_79, -100f);
	}
	if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_279))
	{
		GRAPHICS::STOP_PARTICLE_FX_LOOPED(uLocal_279, 0);
	...
	{
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_257, 0);
