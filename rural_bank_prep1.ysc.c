...
void func_8()
{
	...
	switch (iLocal_1481)
	{
		...
		case 1:
			if (func_40(&Local_403, vLocal_49, 0.1f, 0.1f, 2f, 1, Local_94[0 /*2*/], "RHP_RTN", "", "RHP_BK", 1, 0, 1, -1) || (UI::DOES_BLIP_EXIST(Local_403.f_5) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_94[0 /*2*/], 1359.476f, 3614.326f, 36.87141f, 1356.748f, 3621.605f, 33.72731f, 5f, 0, 1, 0)))
			{
		...
		case 2:
			...
			while (iVar0 <= (9 - 1))
			{
				...
				{
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_111[iVar0 /*14*/], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) < 400f)
					{
					...
					if (bVar1)
					{
						...
						while (iVar2 < 3)
						{
							if (!PED::IS_PED_INJURED(uParam0->f_17[iVar2]))
							{
								...
								else if (!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar2], func_34()) || !func_48(uParam0->f_17[iVar2], 1))
								{
									bVar1 = false;
								}
							}
...
int func_43(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_44(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_44(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
int func_48(var uParam0, int iParam1)
{
	if (!PED::IS_PED_INJURED(uParam0))
	{
		...
		else if (PED::IS_PED_GROUP_MEMBER(uParam0, func_34()))
		{
			PED::SET_GROUP_SEPARATION_RANGE(func_34(), 50f);
			return 1;
		}
...
int func_68(var uParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(uParam0))
	{
		if (!PED::IS_PED_GROUP_MEMBER(uParam0, func_34()))
		{
...
void func_109()
{
	...
	switch (iLocal_1481)
	{
		case 0:
			...
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_493);
			UNK1::_0x293220DA1B46CEBC(3f, 5f, 4);
			iLocal_1481++;
			break;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_140(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_137(ENTITY::GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_121(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_145()
{
	...
	while (iLocal_447 <= (9 - 1))
	{
		...
		if ((((func_31(Local_111[iLocal_447 /*14*/]) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_455) > 8000) && bLocal_456) && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_111[iLocal_447 /*14*/])) && !PED::IS_PED_IN_ANY_VEHICLE(Local_111[iLocal_447 /*14*/], 0))
		{
	...
	if (func_31(Local_94[0 /*2*/]) && func_31(PLAYER::PLAYER_PED_ID()))
	{
		if (iLocal_1480 > 0)
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) > 650f)
			{
				func_187(5);
			}
			else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) > 600f)
			{
				if (!iLocal_454)
				{
		...
		if (!PED::IS_PED_INJURED(iVar1))
		{
			...
			else if (func_159(iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, 1))
			{
				...
				else if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_94[0 /*2*/]))
				{
					...
					{
						AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iVar1, Local_94[0 /*2*/], sLocal_491, 786469, 0, 8, -1, 10f, 0, 2f);
					}
				}
			}
			else if (func_157(iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, 1))
			{
				if (func_31(Local_111[5 /*14*/]))
				{
					if (AI::GET_SCRIPT_TASK_STATUS(iVar1, -1273030092) != 1 && AI::GET_SCRIPT_TASK_STATUS(iVar1, -1273030092) != 0)
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(iVar1, PED::GET_VEHICLE_PED_IS_IN(iVar1, 0), Local_111[5 /*14*/], 7, 15f, 786469, 15f, -1f, 1);
					}
				}
			}
			else
...
int func_159(int iParam0)
{
	if (!func_158())
	{
		if (func_31(Local_94[0 /*2*/]) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_94[0 /*2*/], 1364.248f, 3620.511f, 33.89069f, 1350.9f, 3616.225f, 37.12358f, 6.5f, 0, 1, 0))
		{
...
void func_164()
{
	...
	switch (iLocal_434)
	{
		case 0:
			if (!bLocal_456)
			{
				...
				if (((((func_31(Local_111[4 /*14*/]) && func_31(Local_111[0 /*14*/])) && func_31(Local_111[5 /*14*/])) && func_31(Local_94[1 /*2*/])) && func_31(Local_94[2 /*2*/])) && func_31(Local_94[0 /*2*/]))
				{
					...
					{
						AI::SET_DRIVE_TASK_CRUISE_SPEED(Local_111[0 /*14*/], uVar2);
					}
				}
			}
			else
						...
						case 0:
							if (!func_182(Local_111[0 /*14*/], 242628503, 1))
							{
								if (iLocal_437 == 2 || (iLocal_437 == 3 && fLocal_439 > 0.8f))
								{
									...
									AI::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_94[1 /*2*/], -1785.46f, 3169.625f, 31.93f, 4, 10f, 786603, 3f, 3f, 1);
									AI::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_94[1 /*2*/], -1885.875f, 3006.152f, 31.81027f, 4, 10f, 786603, -1f, -1f, 1);
									AI::CLOSE_SEQUENCE_TASK(uVar4);
									AI::TASK_PERFORM_SEQUENCE(Local_111[0 /*14*/], uVar4);
									AI::CLEAR_SEQUENCE_TASK(&uVar4);
								}
							}
							if (!func_182(Local_111[4 /*14*/], -1273030092, 1))
							{
								AI::TASK_VEHICLE_ESCORT(Local_111[4 /*14*/], Local_94[0 /*2*/], Local_94[1 /*2*/], -1, 11f, 786603, -1f, 20, 0f);
							}
							if (!func_182(Local_111[5 /*14*/], -1273030092, 1))
							{
								AI::TASK_VEHICLE_ESCORT(Local_111[5 /*14*/], Local_94[2 /*2*/], Local_94[0 /*2*/], -1, 11f, 786603, -1f, 20, 0f);
							}
		...
		case 1:
			PED::GET_CLOSEST_PED(vLocal_460, 50f, 1, 0, &uVar5, 0, 0, -1);
			if (func_31(uVar5))
			{
				PED::SET_PED_FLEE_ATTRIBUTES(uVar5, 2, 0);
				PED::SET_PED_FLEE_ATTRIBUTES(uVar5, 2048, 0);
			}
			switch (iLocal_435)
			{
				case 0:
						...
						case 1:
							if (func_31(Local_111[0 /*14*/]) && func_31(Local_94[1 /*2*/]))
							{
								if (PED::IS_PED_IN_VEHICLE(Local_111[0 /*14*/], Local_94[1 /*2*/], 0))
								{
									...
									AI::TASK_PERFORM_SEQUENCE(Local_111[0 /*14*/], uLocal_446);
							...
							if (func_31(Local_111[4 /*14*/]) && func_31(Local_94[0 /*2*/]))
							{
								if (PED::IS_PED_IN_VEHICLE(Local_111[4 /*14*/], Local_94[0 /*2*/], 0))
								{
									...
									AI::CLOSE_SEQUENCE_TASK(uLocal_446);
									AI::TASK_PERFORM_SEQUENCE(Local_111[4 /*14*/], uLocal_446);
									AI::CLEAR_SEQUENCE_TASK(&uLocal_446);
								}
							}
							if ((func_31(Local_111[5 /*14*/]) && func_31(Local_94[2 /*2*/])) && func_31(Local_94[1 /*2*/]))
							{
								if (PED::IS_PED_IN_VEHICLE(Local_111[5 /*14*/], Local_94[2 /*2*/], 0))
								{
									...
									{
										AI::TASK_VEHICLE_DRIVE_TO_COORD(0, Local_94[2 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_94[1 /*2*/], -3f, 0f, 0f), 10f, 0, joaat("crusader"), 786469, 4f, -1f);
									}
									AI::TASK_VEHICLE_TEMP_ACTION(0, Local_94[2 /*2*/], 5, 1000);
									AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 65536);
									AI::CLOSE_SEQUENCE_TASK(uLocal_446);
									AI::TASK_PERFORM_SEQUENCE(Local_111[5 /*14*/], uLocal_446);
									AI::CLEAR_SEQUENCE_TASK(&uLocal_446);
								}
							}
							iLocal_435 = 1;
						...
						case 2:
							...
							if ((func_31(Local_111[5 /*14*/]) && func_31(Local_94[2 /*2*/])) && func_31(Local_94[0 /*2*/]))
							{
								if (PED::IS_PED_IN_VEHICLE(Local_111[5 /*14*/], Local_94[2 /*2*/], 0))
								{
									...
									{
										AI::TASK_VEHICLE_DRIVE_TO_COORD(0, Local_94[2 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_94[0 /*2*/], -2f, 1f, 0f), 10f, 0, joaat("crusader"), 786469, 4f, -1f);
									}
						...
						case 3:
							if ((func_31(Local_111[0 /*14*/]) && func_31(Local_94[1 /*2*/])) && func_31(Local_94[2 /*2*/]))
							{
								if (PED::IS_PED_IN_VEHICLE(Local_111[0 /*14*/], Local_94[1 /*2*/], 0))
								{
									...
									{
										AI::TASK_VEHICLE_DRIVE_TO_COORD(0, Local_94[1 /*2*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_94[2 /*2*/], 2f, 0f, 0f), 10f, 0, joaat("crusader"), 786469, 4f, -1f);
									}
									AI::TASK_VEHICLE_TEMP_ACTION(0, Local_94[1 /*2*/], 5, 1000);
					...
					while (iVar0 <= (9 - 1))
					{
						if (func_31(Local_111[iVar0 /*14*/]) && func_31(PLAYER::PLAYER_PED_ID()))
						{
							...
							if ((iVar0 != 0 && iVar0 != 4) && iVar0 != 5)
							{
								...
								AI::CLOSE_SEQUENCE_TASK(uLocal_446);
								AI::TASK_PERFORM_SEQUENCE(Local_111[iVar0 /*14*/], uLocal_446);
								AI::CLEAR_SEQUENCE_TASK(&uLocal_446);
								PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 3, 1);
							}
						}
				...
				case 2:
					...
					while (iVar0 <= (9 - 1))
					{
						if (func_31(Local_111[iVar0 /*14*/]) && func_31(PLAYER::PLAYER_PED_ID()))
						{
							...
							if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_111[iVar0 /*14*/], 0), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) < 75f)
							{
				...
				case 3:
					...
					while (iVar0 <= (9 - 1))
					{
						if (func_31(Local_111[iVar0 /*14*/]) && func_31(PLAYER::PLAYER_PED_ID()))
						{
							if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_111[iVar0 /*14*/], 0), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) > 120f)
							{
								PED::SET_PED_COMBAT_MOVEMENT(Local_111[iVar0 /*14*/], 1);
								PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 51, 0);
								Local_111[iVar0 /*14*/].f_12 = 0;
				...
				case 4:
					...
					while (iVar0 <= (9 - 1))
					{
						if ((func_31(PLAYER::PLAYER_PED_ID()) && func_31(Local_111[iVar0 /*14*/])) && func_31(Local_94[0 /*2*/]))
						{
							...
							else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_94[0 /*2*/], 0) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], 0), ENTITY::GET_ENTITY_COORDS(Local_111[iVar0 /*14*/], 0), 1) > (120f / 2f))
							{
								PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 1, 1);
								if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_111[iVar0 /*14*/], 0), 1) > (120f * 2f))
								{
									if (!PED::IS_PED_IN_ANY_VEHICLE(Local_111[iVar0 /*14*/], 0) && !ENTITY::IS_ENTITY_ON_SCREEN(Local_111[iVar0 /*14*/]))
									{
										...
										if (func_31(iVar9))
										{
											...
											if (func_167(iVar9))
											{
												...
												{
													AI::TASK_ENTER_VEHICLE(Local_111[iVar0 /*14*/], iVar9, 1000, iVar8, 2f, 16, 0);
												}
									...
									if (func_166(PLAYER::PLAYER_PED_ID(), Local_111[iVar0 /*14*/], 1) < 35f)
									{
										if (func_165(Local_111[iVar0 /*14*/], PED::GET_VEHICLE_PED_IS_IN(Local_111[iVar0 /*14*/], 0)) == -1)
										{
											...
											if (bLocal_470)
											{
												...
												{
													AI::TASK_VEHICLE_ESCORT(Local_111[iVar0 /*14*/], PED::GET_VEHICLE_PED_IS_IN(Local_111[iVar0 /*14*/], 0), Local_94[0 /*2*/], 1, 11f, 786468, -1f, 20, 0f);
												}
											}
											else if (!PED::IS_PED_IN_COMBAT(Local_111[iVar0 /*14*/], 0))
											{
...
void func_174()
{
	...
	if (func_31(Local_94[1 /*2*/]))
	{
		...
		if (func_178(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(Local_94[1 /*2*/], 0), 30f, 0))
		{
			bLocal_456 = true;
		}
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			vVar1 = { func_177(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0) - ENTITY::GET_ENTITY_COORDS(Local_94[1 /*2*/], 0)) };
	...
	if (func_31(Local_94[2 /*2*/]))
	{
		...
		if (func_178(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(Local_94[2 /*2*/], 0), 30f, 0))
		{
			bLocal_456 = true;
		}
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			vVar7 = { func_177(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0) - ENTITY::GET_ENTITY_COORDS(Local_94[2 /*2*/], 0)) };
	...
	if (func_31(Local_94[0 /*2*/]))
	{
		...
		if (func_178(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], 0), 30f, 0))
		{
			bLocal_456 = true;
		}
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			vVar13 = { func_177(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0) - ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], 0)) };
		...
		if (func_175())
		{
			uVar19 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(uVar19, 0))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(uVar19, Local_94[0 /*2*/]))
				{
					bLocal_456 = true;
				}
				vVar20 = { func_177(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0) - ENTITY::GET_ENTITY_COORDS(Local_94[0 /*2*/], 0)) };
	...
	if (((((func_31(Local_94[0 /*2*/]) && func_31(Local_94[1 /*2*/])) && func_31(Local_94[2 /*2*/])) && func_31(Local_111[4 /*14*/])) && func_31(Local_111[0 /*14*/])) && func_31(Local_111[5 /*14*/]))
	{
		...
		switch (iLocal_433)
		{
			case 0:
				...
				else
				{
					if ((PED::IS_PED_IN_ANY_VEHICLE(Local_111[5 /*14*/], 0) && PED::IS_PED_IN_ANY_VEHICLE(Local_111[0 /*14*/], 0)) && PED::IS_PED_IN_ANY_VEHICLE(Local_111[4 /*14*/], 0))
					{
						...
						{
							AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_111[0 /*14*/], Local_94[1 /*2*/], &cLocal_475, 786603, 0, 24, -1, 11f, 0, 1073741824);
						}
			...
			case 1:
				...
				if ((!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar0, vVar3, 9f, 0, 1, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar6, vVar9, 9f, 0, 1, 0)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar12, vVar15, 9f, 0, 1, 0))
				{
...
{
	Local_94[0 /*2*/] = VEHICLE::CREATE_VEHICLE(joaat("barracks"), vParam0, fParam3, 1, 1, 0);
	...
	ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_108[0], Local_94[0 /*2*/], 0, 0f, -0.5f, 1.5f, 0f, 0f, -90f, 0, 0, 0, 0, 2, 1);
	uLocal_108[1] = OBJECT::CREATE_OBJECT(joaat("prop_mil_crate_01"), 1006.765f, 2128.32f, 48.0929f, 1, 1, 0);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_108[1], Local_94[0 /*2*/], 0, 0f, -2.85f, 1.5f, 0f, 0f, -90f, 0, 0, 0, 0, 2, 1);
...
{
	Local_94[2 /*2*/] = VEHICLE::CREATE_VEHICLE(joaat("crusader"), vParam0, fParam3, 1, 1, 0);
...
void func_210(int iParam0, int iParam1)
{
	...
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[iParam0 /*14*/], uLocal_493);
...
{
	Local_94[1 /*2*/] = VEHICLE::CREATE_VEHICLE(joaat("crusader"), vParam0, fParam3, 1, 1, 0);
...
int func_218(var uParam0, var uParam1)
{
	...
	while (iVar0 < uParam0->f_374)
	{
		...
		{
			if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam0->f_374[iVar0 /*5*/].f_4, uParam1))
			{
...
void func_237(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_261(uParam1) && ENTITY::IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
int func_242(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_250() || func_249(Global_4456448.f_161209)) || func_248())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_246(uVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_264()
{
	...
	PED::REMOVE_RELATIONSHIP_GROUP(uLocal_492);
	PED::REMOVE_RELATIONSHIP_GROUP(uLocal_493);
	PED::ADD_RELATIONSHIP_GROUP("trevor", &uLocal_492);
	PED::ADD_RELATIONSHIP_GROUP("enemies", &uLocal_493);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_493, 1862763509);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_493, uLocal_492);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_492, uLocal_493);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_493, -1533126372);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, uLocal_493);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_493, uLocal_493);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_493, -472287501);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -472287501, uLocal_493);
...
int func_303(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_318(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_304(iVar0, 0), 1);
...
int func_332()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_111[1 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_9[3], 1, 1);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_111[2 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_9[4], 1, 1);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_111[3 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_9[5], 1, 1);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_111[5 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_9[6], 1, 1);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_111[6 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_9[7], 1, 1);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_111[7 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_9[8], 1, 1);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_111[8 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_9[9], 1, 1);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_108[1]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_28[1], 1, 1);
	...
	while (iVar0 <= (9 - 1))
	{
		if (func_31(Local_111[iVar0 /*14*/]))
		{
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[iVar0 /*14*/], uLocal_493);
...
void func_333(int iParam0, vector3 vParam1)
{
	...
	if (UI::DOES_BLIP_EXIST(Global_26140[iParam0 /*23*/].f_19))
	{
		UI::SET_BLIP_COORDS(Global_26140[iParam0 /*23*/].f_19, vParam1);
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 <= 2)
