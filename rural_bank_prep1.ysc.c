	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_96664.f_4, 0))
		{
			if (func_140(24) != Global_96664.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_137(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_113(Global_96664.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_150()
{
	...
	if (iLocal_437 == 3 || iLocal_437 == 1)
	{
		...
		OBJECT::_SET_DOOR_AJAR_ANGLE(Global_35240[20 /*31*/], fLocal_439, 0, 1);
...
void func_192(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_194(Global_106070.f_18505[iVar0], &vVar2, &fVar5))
			{
...
void func_287(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_289(Var11.f_1)) && iVar72 < 50)
			{
...
int func_332()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_111[8 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89824.f_9[9], 1, 1);
