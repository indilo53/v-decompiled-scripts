...
void func_3()
{
	GAMEPLAY::CLEAR_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_794), 3);
}
...
void func_13()
{
	GAMEPLAY::CLEAR_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_794), 1);
}
...
void func_14(var uParam0)
{
	...
	if (func_49(uParam0))
	{
		if (((func_48(uParam0) && !func_47(uParam0)) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(uParam0->f_1)) && !func_46())
		{
			func_45(uParam0, 1, 0);
			func_44(uParam0);
		}
		...
		{
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(uParam0->f_1) && !func_46())
			{
				func_45(uParam0, 0, 0);
	...
	func_3();
	GAMEPLAY::CLEAR_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_794), 4);
}
...
void func_15(var uParam0)
{
	...
	if (((((((!func_9(&(uParam0->f_6), 0) && !func_9(&(uParam0->f_6), 2)) && !UI::IS_HELP_MESSAGE_BEING_DISPLAYED()) && func_31(uParam0)) && !func_30(0)) && !func_29()) && func_27()) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(uParam0->f_1, -1, 0)))
	{
		func_21(uParam0, 1);
...
bool func_27()
{
	return (!GAMEPLAY::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_794, 4) && !func_28());
}
...
void func_37(var uParam0)
{
	...
	if (((((((!func_9(&(uParam0->f_6), 0) && !func_9(&(uParam0->f_6), 1)) && !UI::IS_HELP_MESSAGE_BEING_DISPLAYED()) && func_9(&(uParam0->f_6), 3)) && !func_30(0)) && !func_29()) && func_27()) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(uParam0->f_1, -1, 0)))
	{
...
void func_42()
{
	GAMEPLAY::SET_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_794), 1);
}
...
bool func_46()
{
	return GAMEPLAY::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_794, 3);
}
...
{
	return ((func_35(uParam0) && uParam0->f_3 == PLAYER::PLAYER_PED_ID()) || VEHICLE::GET_PED_IN_VEHICLE_SEAT(uParam0->f_1, -1, 0) == PLAYER::PLAYER_PED_ID());
}
...
void func_51(var uParam0)
{
	...
	GAMEPLAY::CLEAR_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_794), 2);
}
...
bool func_53()
{
	return GAMEPLAY::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_794, 2);
}
...
int func_55(int iParam0)
{
	if (iParam0 > -1)
	{
		...
		if (GAMEPLAY::IS_BIT_SET(Global_2424047[iParam0 /*416*/].f_195, 4))
		{
			return 1;
		}
	}
...
void func_64(var uParam0)
{
	...
	if (func_63(uParam0))
	{
		...
		if (func_35(uParam0))
		{
			uParam0->f_4 = func_74(PLAYER::PLAYER_PED_ID(), 0);
		}
		if (func_49(uParam0))
		{
...
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_3) && func_66(NETWORK::NETWORK_GET_PLAYER_INDEX_FROM_PED(uParam0->f_3)))
	{
		func_20(uParam0, 0);
	}
	else
...
{
	return (iParam0 != -1 && GAMEPLAY::IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_794, 1));
}
...
var func_72()
{
	return GAMEPLAY::IS_BIT_SET(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_794, 1);
}
