...
void func_163()
{
	if ((GAMEPLAY::IS_BIT_SET(uLocal_105, 0) && Global_36425 == 15) && !func_195())
	{
		if (iLocal_38 == 0)
		{
...
void func_211()
{
	...
	if (((((((Global_36425 == 15 && iLocal_37 != 3) && GAMEPLAY::IS_BIT_SET(uLocal_105, 5)) && !func_195()) && Global_71587 == -1) && !func_221()) && !func_82(9)) || func_101(35))
	{
		func_220();
		func_218();
		switch (iLocal_39)
