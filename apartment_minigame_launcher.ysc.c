...
void __EntryFunction__()
{
	...
	while (iVar3 <= 1)
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_246.f_5, iVar3))
		{
			...
			if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(uVar5))
			{
				...
				if (iLocal_398[iVar4] > Local_355[iVar4 /*21*/].f_11)
				{
					if (!bVar6)
					{
						...
						{
							func_18(2072412573, NETWORK::NETWORK_GET_PLAYER_INDEX(uVar5), iVar4);
							bVar6 = true;
						}
					}
				}
				...
				while (iVar3 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
				{
					if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar3)))
					{
						...
						else
						{
							...
							{
								case 0:
									if (GAMEPLAY::IS_BIT_SET(Local_275.f_5, iVar3))
									{
										GAMEPLAY::CLEAR_BIT(&(Local_275.f_5), iVar3);
									}
									break;
								
								case 1:
									if (GAMEPLAY::IS_BIT_SET(Local_275.f_6, iVar3))
									{
										GAMEPLAY::CLEAR_BIT(&(Local_275.f_6), iVar3);
									}
									break;
								}
							}
...
var func_7(var uParam0, struct<13>[] Param1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, int iParam61)
{
	...
	while (iVar4 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		...
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(uVar5))
		{
			uVar2 = NETWORK::NETWORK_GET_PLAYER_INDEX(PLAYER::INT_TO_PARTICIPANTINDEX(iVar4));
			if ((uParam0[iVar4 /*5*/])->f_1 == iParam61 && func_19(uParam0[iVar4 /*5*/], 1))
			{
				uVar3 = PLAYER::GET_PLAYER_PED(uVar2);
				if (func_8(uVar3))
				{
					if (func_8(uVar3))
					{
						...
						{
							iVar0 = iVar4;
							fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uVar3, 1), Param1[0 /*13*/], 1);
						}
						else
						{
							fVar6 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uVar3, 1), Param1[0 /*13*/], 1);
							if (fVar6 < fVar1)
							{
								fVar1 = fVar6;
								iVar0 = iVar4;
	...
	if (iVar0 >= 0)
	{
		uVar2 = NETWORK::NETWORK_GET_PLAYER_INDEX(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0));
	}
	return uVar2;
}
...
void func_18(int iParam0, var uParam1, int iParam2)
{
	...
	Var0.f_4 = uParam1;
	Var0.f_3 = iParam2;
	SCRIPT::TRIGGER_SCRIPT_EVENT(1, &Var0, 6, func_5(uParam1));
}
...
void func_21(var uParam0, var uParam1, bool bParam2)
{
	...
	Var0.f_4 = uParam0;
	Var0.f_3 = uParam1;
	SCRIPT::TRIGGER_SCRIPT_EVENT(1, &Var0, 6, func_5(uParam0));
}
...
void func_25(var uParam0, var uParam1, var uParam2)
{
	...
	{
		case 0:
			if (!GAMEPLAY::IS_BIT_SET(Local_401[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3, 2))
			{
		...
		case 1:
			...
			{
				if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(Local_246.f_3))
				{
...
void func_26(var uParam0)
{
	...
	if (GAMEPLAY::IS_BIT_SET(*uParam0, 7) != GAMEPLAY::IS_BIT_SET(*uParam0, 8))
	{
		...
		func_17(uParam0, 8, GAMEPLAY::IS_BIT_SET(*uParam0, 7));
	}
...
int func_35(var uParam0, int iParam1, struct<17> Param2, var uParam19, var uParam20, var uParam21, var uParam22, bool bParam23, int iParam24, bool bParam25, bool bParam26, bool bParam27)
{
	if (SCRIPT::DOES_SCRIPT_EXIST(uParam0))
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18), 4);
		...
		if (SCRIPT::HAS_SCRIPT_LOADED(uParam0))
		{
			...
			if (!bParam26)
			{
				GAMEPLAY::SET_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18), 0);
			}
			GAMEPLAY::CLEAR_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_39.f_18), 4);
			if (bParam25)
			{
...
void func_45(var uParam0, var uParam1, bool bParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (!PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1))
		{
			...
			else if (!GAMEPLAY::IS_BIT_SET(bParam2->f_5, Local_401[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_1))
			{
					...
					if (Param0 == 1)
					{
						...
						while (iVar1 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
						{
							...
							if (iVar1 != NETWORK::PARTICIPANT_ID_TO_INT())
							{
								if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(uVar2))
								{
									if ((Local_401[iVar1 /*5*/].f_1 == Param0 && GAMEPLAY::IS_BIT_SET(Local_401[iVar1 /*5*/].f_3, 6)) && GAMEPLAY::IS_BIT_SET(Local_401[iVar1 /*5*/].f_3, 1))
									{
										Local_220.f_5 = 1;
										if (Local_220.f_8 >= 0)
										{
											if (Local_220.f_8 == 0 && GAMEPLAY::IS_BIT_SET(Local_401[iVar1 /*5*/].f_3, 5))
											{
												Local_220.f_6 = 1;
											}
											else if (Local_220.f_8 == 1 && !GAMEPLAY::IS_BIT_SET(Local_401[iVar1 /*5*/].f_3, 5))
											{
												Local_220.f_6 = 1;
											}
										}
						...
						if (Local_246.f_4 == 0)
						{
							if (((!Local_220.f_4 && Local_220.f_5) || (Local_220.f_4 && Local_220.f_6)) && GAMEPLAY::IS_BIT_SET(Local_275.f_1, Param0))
							{
		...
		switch (Local_246.f_4)
		{
			case 0:
				if (Local_220.f_4 && Local_220.f_7)
				{
					...
					if (GAMEPLAY::IS_BIT_SET(Local_275.f_3, Param0))
					{
					...
					else if (!GAMEPLAY::IS_BIT_SET(Local_275.f_1, Param0))
					{
						func_103(func_102(Param0, 6), 0);
			...
			case 2:
				fVar7 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_285[0 /*13*/], 1);
				fVar8 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_285[1 /*13*/], 1);
				if (fVar7 < fVar8)
				{
				...
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					AI::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), vVar4, 1f, 300, uVar9, 0.05f);
				}
				func_40(&Local_246, 6);
				break;
			...
			case 6:
				...
				else if (func_14(&uLocal_349) >= 1f || !func_19(&(Local_401[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/]), 3))
				{
					func_11(&uLocal_349);
				...
				if ((CONTROLS::IS_CONTROL_JUST_PRESSED(2, func_98(0)) || GAMEPLAY::IS_BIT_SET(Local_275.f_3, Param0)) && !bLocal_115)
				{
					func_40(&Local_246, 8);
				}
				...
				if (func_19(&(Local_401[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/]), 3))
				{
					...
					{
						if ((CONTROLS::IS_CONTROL_JUST_PRESSED(2, 201) && GAMEPLAY::IS_BIT_SET(Local_275.f_2, Param0)) && !bLocal_115)
						{
							func_40(&Local_246, 7);
						}
						if (Param0.f_2 == 0)
						...
						if (GAMEPLAY::IS_BIT_SET(Local_275.f_2, Param0))
						{
							if (Local_220.f_1)
							{
					...
					{
						if (GAMEPLAY::IS_BIT_SET(Local_275.f_1, Local_401[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_1))
						{
							func_43(&(Local_401[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/]), 1, 1);
						}
		...
		if (iVar5 == 1 && Global_17411.f_5728)
		{
			...
			if (GAMEPLAY::GET_HASH_KEY(&(Global_17411.f_4690)) != 0 && Global_17411.f_4766 != -1)
			{
				...
				if (Global_17411.f_4768 != 0)
				{
					...
					GRAPHICS::DRAW_SPRITE(func_76(Global_17411.f_4768), func_73(Global_17411.f_4768, 1), ((Global_17408 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
				}
			...
			if (GAMEPLAY::GET_HASH_KEY(&(Global_4267964.f_21)) != 0 && Global_4267964.f_65 != -1)
			{
				...
				if (Global_4267964.f_67 != 0)
				{
					...
					GRAPHICS::DRAW_SPRITE(func_76(Global_4267964.f_67), func_73(Global_4267964.f_67, 1), ((Global_17408 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
				}
				fVar51 = (fVar51 + (((UI::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
									...
									if (bVar54)
									{
										if (func_82(26, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_82(26, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													GRAPHICS::DRAW_SPRITE(func_76(26), func_73(26, 1), ((fVar34 + fVar42) + fVar45), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
												}
											}
										}
										if (func_82(27, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_82(27, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													GRAPHICS::DRAW_SPRITE(func_76(27), func_73(27, 1), (((fVar34 + fVar42) + fVar45) + (fVar43 + fVar44)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
												}
											}
										}
									}
												...
												if (func_82(Global_17411.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (func_82(Global_17411.f_4433[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
													{
														...
														if (iVar5 == 1)
														{
															if (Global_17411.f_5083[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_76(Global_17411.f_4433[(iVar22 + iVar28)]), func_73(Global_17411.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar42) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_76(Global_17411.f_4433[(iVar22 + iVar28)]), func_73(Global_17411.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar42) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
														}
												...
												if (func_82(Global_17411.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														if (func_82(Global_17411.f_4433[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															...
															{
																GRAPHICS::DRAW_SPRITE(func_76(Global_17411.f_4433[(iVar22 + iVar14)]), func_73(Global_17411.f_4433[(iVar22 + iVar14)], bVar32), (Global_17408 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
															else if (Global_17411.f_5083[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_76(Global_17411.f_4433[(iVar22 + iVar14)]), func_73(Global_17411.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar42) + fVar43) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_76(Global_17411.f_4433[(iVar22 + iVar14)]), func_73(Global_17411.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar42) + fVar43) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
														}
													}
									...
									if (func_82(Global_17411.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											if (func_82(Global_17411.f_4433[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												GRAPHICS::DRAW_SPRITE(func_76(Global_17411.f_4433[iVar22]), func_73(Global_17411.f_4433[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), (fVar36 * func_52(Global_17411.f_4433[iVar22])), (fVar37 * func_52(Global_17411.f_4433[iVar22])), 0f, uVar47, uVar48, uVar49, uVar50, 0);
											}
										}
									}
								}
...
int func_84(bool bParam0, bool bParam1)
{
	...
	if ((((((((!CAM::IS_SCREEN_FADED_IN() || (func_86(8, -1) && func_85() != 64)) || (UI::GET_PAUSE_MENU_STATE() != 0 && !bParam1)) || (STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0)) || NETWORK::_0x2EAC52B4019E2782()) || Global_71850) || Global_17411.f_8352) || UI::IS_WARNING_MESSAGE_ACTIVE()) || Global_93734.f_1409)
	{
		return 0;
	}
	return 1;
...
void func_107(var uParam0, var uParam1)
{
	...
	if ((!uParam1->f_1[uParam0->f_4] && (*uParam0 >= 1 && *uParam0 <= 3)) || GAMEPLAY::IS_BIT_SET(Local_275.f_3, uParam0->f_4))
	{
		bVar21 = false;
		func_110(uParam0, 4);
	}
	switch (*uParam0)
	{
		case 0:
			...
			while (iVar23 <= 1)
			{
				if ((iVar23 != uParam0->f_4 && uParam1->f_1[iVar23]) && !GAMEPLAY::IS_BIT_SET(Local_275.f_3, iVar23))
				{
					uParam0->f_4 = iVar23;
					uParam1->f_14 = 4f;
					func_110(uParam0, 1);
...
void func_113(var uParam0)
{
	...
	while (iVar2 <= 1)
	{
		...
		iVar3 = 0;
		if ((GAMEPLAY::IS_BIT_SET(Local_275.f_1, iVar2) && !NETWORK::NETWORK_IS_SCRIPT_ACTIVE(Local_355[iVar2 /*21*/].f_1, uParam0->f_13, 0, 0)) && func_20(&Local_401, iVar2) > 0)
		{
			iVar3 = 1;
		}
...
{
	return GAMEPLAY::IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_273.f_23, 14);
}
