...
void func_20(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_22() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_22() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
int func_28(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_22() /*10778*/].f_6165.f_10, iParam0);
}
									...
									if (func_112(Global_17411.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											if (func_112(Global_17411.f_4433[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												GRAPHICS::DRAW_SPRITE(func_106(Global_17411.f_4433[iVar22]), func_103(Global_17411.f_4433[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), (fVar36 * func_85(Global_17411.f_4433[iVar22])), (fVar37 * func_85(Global_17411.f_4433[iVar22])), 0f, uVar47, uVar48, uVar49, uVar50, 0);
											}
										}
									}
								}
...
int func_114(bool bParam0, bool bParam1)
{
	...
	if ((((((((!CAM::IS_SCREEN_FADED_IN() || (func_116(8, -1) && func_115() != 64)) || (UI::GET_PAUSE_MENU_STATE() != 0 && !bParam1)) || (STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0)) || NETWORK::_0x2EAC52B4019E2782()) || Global_71850) || Global_17411.f_8352) || UI::IS_WARNING_MESSAGE_ACTIVE()) || Global_93734.f_1409)
	{
		return 0;
	}
	return 1;
...
float func_132(var uParam0)
{
	if (func_135(uParam0))
	{
		...
		{
			return (func_133(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	uParam0->f_1 = (func_133(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_139(iParam3), 0);
}
...
int func_142()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			else if ((ENTITY::GET_ENTITY_HEALTH(uLocal_0) <= 200 || FIRE::IS_ENTITY_ON_FIRE(uLocal_0)) || func_147())
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(cLocal_184))
				{
					if (iLocal_193)
					{
						...
						while (iVar0 <= (iLocal_174 - 1))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_DEAD(uLocal_103[iVar0], 0) && !func_161(uLocal_103[iVar0], -2017877118))
								{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(cLocal_184))
				{
					if (iLocal_193)
					{
						...
						while (iVar1 <= (iLocal_174 - 3))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_DEAD(uLocal_103[iVar1], 0) && !func_161(uLocal_103[iVar1], -2017877118))
								{
...
void func_169(var uParam0)
{
	...
	if (uParam0->f_145)
	{
		if ((GAMEPLAY::GET_FRAME_COUNT() >= (uParam0->f_146 + uParam0->f_147) || GAMEPLAY::IS_BIT_SET(Global_93682.f_20, 2)) || GAMEPLAY::IS_BIT_SET(Global_93682.f_20, 13))
		{
			iVar0 = 0;
			while (iVar0 < 8)
			{
...
int func_178()
{
	...
	if (func_63(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (((func_14(uVar0) && PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uVar0)) && !func_200(PLAYER::PLAYER_PED_ID(), uVar0, -1)) && ENTITY::GET_ENTITY_MODEL(uVar0) != joaat("taxi"))
		{
			return 0;
		}
	}
	...
	if (func_180())
	{
		...
		switch (Local_83)
		{
			case 0:
				Global_106539[0] = 1;
				Global_106545[0] = GAMEPLAY::GET_GAME_TIMER();
				break;
			
			case 1:
				Global_106539[1] = 1;
				Global_106545[1] = GAMEPLAY::GET_GAME_TIMER();
				break;
			
			case 2:
				Global_106539[2] = 1;
				Global_106545[2] = GAMEPLAY::GET_GAME_TIMER();
				break;
			
			case 3:
				Global_106539[3] = 1;
				Global_106545[3] = GAMEPLAY::GET_GAME_TIMER();
				break;
			
			case 4:
				Global_106539[4] = 1;
				Global_106545[4] = GAMEPLAY::GET_GAME_TIMER();
				break;
			
			case 5:
				Global_106529[0] = 1;
				Global_106534[0] = GAMEPLAY::GET_GAME_TIMER();
				break;
			
			case 6:
				Global_106529[1] = 1;
				Global_106534[1] = GAMEPLAY::GET_GAME_TIMER();
				break;
			
			case 7:
				Global_106529[2] = 1;
				Global_106534[2] = GAMEPLAY::GET_GAME_TIMER();
				break;
			
			case 8:
				Global_106529[3] = 1;
				Global_106534[3] = GAMEPLAY::GET_GAME_TIMER();
				break;
		}
		return 0;
	}
	...
	if (func_15(PLAYER::PLAYER_PED_ID()) && func_15(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_194(PLAYER::PLAYER_PED_ID(), iParam0, iParam2);
				}
			}
		}
		if (bParam4)
...
int func_198(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_190(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_190(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_189(vVar3, vVar0);
...
int func_201()
{
	...
	{
		case 5:
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_24970.f_2, 0);
			break;
		
		case 6:
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_24970.f_2, 1);
			break;
		
		case 7:
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_24970.f_2, 2);
			break;
		
		case 8:
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_24970.f_2, 3);
			break;
		
		case 0:
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_24973.f_3, 0);
			break;
		
		case 1:
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_24973.f_3, 1);
			break;
		
		case 2:
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_24973.f_3, 2);
			break;
		
		case 3:
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_24973.f_3, 3);
			break;
		
		case 4:
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_24973.f_3, 4);
			break;
	}
	return 0;
}
...
int func_208(int iParam0)
{
	...
	{
		case 0:
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_24973.f_1, 0);
			break;
		
		case 1:
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_24973.f_1, 1);
			break;
		
		case 2:
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_24973.f_1, 2);
			break;
		
		case 3:
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_24973.f_1, 3);
			break;
		
		case 4:
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_24973.f_1, 4);
			break;
	}
	return 0;
}
