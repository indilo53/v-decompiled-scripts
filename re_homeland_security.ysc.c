					...
					if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
					{
						switch (iLocal_49)
						{
							...
							case 1:
								if (!func_138())
								{
									if ((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_73, 75f, 75f, 75f, 0, 1, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_72)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_72, 15f, 15f, 15f, 0, 1, 0))
									{
										if (!func_161())
										{
							...
							case 3:
								...
								if (!PED::IS_PED_INJURED(iLocal_72))
								{
									...
									else if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_65, 0))
									{
										if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_65, 0))
										{
							...
							case 5:
								...
								if (!PED::IS_PED_INJURED(iLocal_72))
								{
									if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_93, Global_22, 1, 1, 0) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_72, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0))
									{
										if (PED::IS_PED_IN_GROUP(iLocal_72))
										{
											if (UI::DOES_BLIP_EXIST(uLocal_120))
										...
										if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_65, 0))
										{
											if (!PED::IS_PED_INJURED(iLocal_72))
											{
												if (!PED::IS_PED_IN_VEHICLE(iLocal_72, uLocal_65, 0))
												{
													...
													{
														AI::CLEAR_PED_TASKS(iLocal_72);
														PED::SET_PED_INTO_VEHICLE(iLocal_72, uLocal_65, 2);
														PED::SET_PED_KEEP_TASK(iLocal_72, 1);
														iLocal_151 = 1;
													}
													else
...
void func_38(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_40() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_40() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
int func_44(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_40() /*10778*/].f_6165.f_10, iParam0);
}
...
var func_97(vector3 vParam0, int iParam3)
{
	...
	UI::SET_BLIP_SCALE(uVar0, func_98(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
int func_101()
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_118, 0))
		{
			if (!PED::IS_PED_INJURED(iLocal_72))
			{
				if (PED::IS_PED_SITTING_IN_VEHICLE(iLocal_72, uLocal_118))
				{
					return 1;
				}
			}
...
int func_103(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_98(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
int func_107()
{
	...
	{
		if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_65, 0) && PED::IS_PED_IN_VEHICLE(iLocal_72, uLocal_65, 0)) && !PED::IS_PED_IN_VEHICLE(iLocal_52[0], uLocal_65, 0)) && !PED::IS_PED_IN_VEHICLE(iLocal_52[1], uLocal_65, 0))
		{
			return 1;
		}
	}
...
void func_113()
{
	if (!iLocal_109)
	{
		if (!PED::IS_PED_INJURED(iLocal_52[0]))
		{
			...
			if (UI::DOES_BLIP_EXIST(uLocal_121[0]))
			{
				UI::SET_BLIP_AS_FRIENDLY(uLocal_121[0], 0);
			}
			SYSTEM::SETTIMERB(0);
			iLocal_109 = 1;
		}
	...
	if (!iLocal_110)
	{
		if (UI::DOES_BLIP_EXIST(uLocal_121[1]))
		{
			UI::SET_BLIP_AS_FRIENDLY(uLocal_121[1], 0);
		}
		func_99();
		SYSTEM::WAIT(0);
		if (!PED::IS_PED_INJURED(iLocal_52[1]))
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_115(iParam2), 1);
}
	...
	if (!bLocal_138)
	{
		switch (iLocal_51)
		{
			...
			case 5:
				...
				{
					if (((VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_65, 0) && !PED::IS_PED_INJURED(iLocal_52[0])) && !PED::IS_PED_INJURED(iLocal_52[1])) && !PED::IS_PED_INJURED(iLocal_72))
					{
						if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_149))
						{
								...
								if (!func_111())
								{
									if (PED::IS_PED_FACING_PED(iLocal_52[0], iLocal_72, 10f))
									{
										if (func_109(&uLocal_154, "REHOMAU", "REHOM_ARR", 4, 0, 0, 0))
										{
											...
											PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_149, uLocal_65, 0);
											...
											ENTITY::PLAY_ENTITY_ANIM(uLocal_65, "exit_car", "random@homelandsecurity", 4f, 0, 0, 0, 0, 0);
											iLocal_150 = 1;
											iLocal_127 = GAMEPLAY::GET_GAME_TIMER();
											iLocal_51 = 6;
										}
						...
						if (!func_111())
						{
							if (PED::IS_PED_FACING_PED(iLocal_52[0], iLocal_72, 10f))
							{
								if (func_109(&uLocal_154, "REHOMAU", "REHOM_ARR", 4, 0, 0, 0))
								{
									...
									AI::TASK_SYNCHRONIZED_SCENE(iLocal_52[0], uLocal_149, "random@homelandsecurity", "exit_cop_gun", 2f, -4f, 1, 0, 1148846080, 0);
									AI::TASK_SYNCHRONIZED_SCENE(iLocal_52[1], uLocal_149, "random@homelandsecurity", "exit_cop_ground", 2f, -4f, 1, 0, 1148846080, 0);
									ENTITY::PLAY_ENTITY_ANIM(uLocal_65, "exit_car", "random@homelandsecurity", 2f, 0, 0, 0, 0, 0);
									iLocal_150 = 1;
									iLocal_127 = GAMEPLAY::GET_GAME_TIMER();
									iLocal_51 = 6;
								}
			...
			case 6:
				...
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_149))
				{
					...
					{
						if ((VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_65, 0) && !PED::IS_PED_INJURED(iLocal_72)) && !PED::IS_PED_INJURED(iLocal_52[0]))
						{
						}
					}
				}
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_149))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_149) > 0.9f)
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_65, 0))
						{
							if (!PED::IS_PED_INJURED(iLocal_52[0]))
							{
								AI::TASK_ENTER_VEHICLE(iLocal_52[0], uLocal_65, -1, -1, 1f, 9, 0);
								iLocal_51 = 7;
							}
						}
					}
				...
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_149))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_149) > 0.95f)
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_65, 0))
						{
							if (!PED::IS_PED_INJURED(iLocal_52[1]))
							{
								AI::TASK_ENTER_VEHICLE(iLocal_52[1], uLocal_65, -1, 0, 1f, 9, 0);
								PED::SET_PED_KEEP_TASK(iLocal_52[1], 1);
								iLocal_51 = 8;
							}
						}
			...
			case 8:
				func_123();
				if ((VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_65, 0) && !PED::IS_PED_INJURED(iLocal_52[0])) && !PED::IS_PED_INJURED(iLocal_52[1]))
				{
					if ((PED::IS_PED_SITTING_IN_VEHICLE(iLocal_72, uLocal_65) && PED::IS_PED_SITTING_IN_VEHICLE(iLocal_52[0], uLocal_65)) && PED::IS_PED_SITTING_IN_VEHICLE(iLocal_52[1], uLocal_65))
					{
						AI::TASK_VEHICLE_DRIVE_WANDER(iLocal_52[0], uLocal_65, 15f, 786468);
						VEHICLE::SET_VEHICLE_SIREN(uLocal_65, 1);
						bLocal_138 = true;
					}
				}
				break;
...
int func_138()
{
	...
	if (!bLocal_133)
	{
		if (GAMEPLAY::IS_PROJECTILE_IN_AREA(vLocal_66 - Vector(30f, 30f, 30f), vLocal_66 + Vector(30f, 30f, 30f), 1) || GAMEPLAY::IS_BULLET_IN_BOX(vLocal_66 - Vector(30f, 30f, 30f), vLocal_66 + Vector(30f, 30f, 30f), 1))
		{
			iLocal_50 = 2;
			return 1;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_65))
		{
			if (!ENTITY::IS_ENTITY_DEAD(uLocal_65, 0))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_65, PLAYER::PLAYER_PED_ID(), 1))
				{
					iLocal_50 = 2;
					return 1;
				}
				if (PED::IS_PED_ON_SPECIFIC_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_65) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 0.1f)
				{
					iLocal_50 = 2;
					return 1;
				}
				...
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_65, uVar0, 1))
					{
						iLocal_50 = 2;
						return 1;
					}
			...
			else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_65, PLAYER::PLAYER_PED_ID(), 1))
			{
				iLocal_50 = 2;
				return 1;
			}
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), joaat("towtruck")) || PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), joaat("towtruck2")))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(uLocal_65, 0))
				{
					if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uVar1, uLocal_65))
					{
						iLocal_50 = 2;
						return 1;
					}
		...
		if (!PED::IS_PED_INJURED(iLocal_52[0]) || ENTITY::IS_ENTITY_DEAD(iLocal_52[0], 0))
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(uVar0, 0))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_52[0], uVar0, 1))
				{
					iLocal_50 = 5;
					return 1;
				}
		...
		if (!PED::IS_PED_INJURED(iLocal_52[1]) || ENTITY::IS_ENTITY_DEAD(iLocal_52[1], 0))
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(uVar0, 0))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_52[1], uVar0, 1))
				{
					iLocal_50 = 5;
					return 1;
				}
		...
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_72, 0))
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(uVar0, 0))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_72, uVar0, 1))
				{
					iLocal_50 = 4;
					return 1;
				}
...
void func_139()
{
	...
	iLocal_72 = PED::CREATE_PED(26, iLocal_76, vLocal_73, 0, 1, 1);
	...
	PED::ADD_RELATIONSHIP_GROUP("OFFICERS", &uLocal_153);
	iLocal_126 = 0;
	while (iLocal_126 <= 1)
	{
		...
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_52[iLocal_126], uLocal_153);
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_153, 1862763509);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_153, -1533126372);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, uLocal_153);
	uLocal_65 = VEHICLE::CREATE_VEHICLE(iLocal_71, vLocal_66, fLocal_69, 1, 1, 0);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_71, 1);
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_65, 1084227584);
	VEHICLE::SET_VEHICLE_SIREN(uLocal_65, 1);
...
int func_145(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_11() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_45(func_143(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_161()
{
	if ((Global_106554 == func_30() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
void func_207()
{
	...
	if (iLocal_102)
	{
		...
		while (iVar0 < iLocal_52)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_52[iVar0]))
			{
				if (!PED::IS_PED_INJURED(iLocal_52[iVar0]))
				{
					if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						AI::TASK_AIM_GUN_AT_COORD(iLocal_52[iVar0], func_219(PLAYER::PLAYER_ID()), -1, 0, 0);
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_65))
		{
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_65);
		}
