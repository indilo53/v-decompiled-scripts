					...
					if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
					{
						switch (iLocal_49)
						{
							...
							case 3:
								...
								{
									if (((WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_52[0], joaat("weapon_stungun"), 0) && WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_52[1], joaat("weapon_stungun"), 0)) || (PED::IS_PED_DEAD_OR_DYING(iLocal_52[0], 1) && PED::IS_PED_DEAD_OR_DYING(iLocal_52[1], 1))) || func_104())
									{
										if (UI::DOES_BLIP_EXIST(uLocal_121[0]))
										{
											UI::REMOVE_BLIP(&(uLocal_121[0]));
							...
							case 4:
								if (!bLocal_90)
								{
									if (!PED::IS_PED_INJURED(iLocal_72))
									{
										...
										PED::SET_PED_AS_GROUP_MEMBER(iLocal_72, func_103());
	...
	if (!PED::IS_PED_INJURED(iLocal_72))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_72, 8f, 8f, 8f, 0, 1, 0) || PED::IS_PED_IN_ANY_TAXI(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			{
				if (!UI::DOES_BLIP_EXIST(uLocal_124))
				{
					uLocal_124 = func_94(vLocal_93, 1);
				}
				...
				if (func_101() == 2 && !func_93())
				{
					if (!UI::DOES_BLIP_EXIST(uLocal_125))
					{
						uLocal_125 = func_94(vLocal_99, 0);
...
var func_94(vector3 vParam0, int iParam3)
{
	var uVar0;
	
	uVar0 = UI::ADD_BLIP_FOR_COORD(vParam0);
	UI::SET_BLIP_SCALE(uVar0, func_95(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
int func_100(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_95(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
void func_136()
{
	...
	if (func_101() == 0)
	{
		func_137(&uLocal_154, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	}
	else if (func_101() == 1)
	{
		func_137(&uLocal_154, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	uLocal_149 = PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
	PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_149, uLocal_65, 0);
...
void func_137(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
