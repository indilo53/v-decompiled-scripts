...
int func_2()
{
	...
	if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&cLocal_90))
	{
		if (!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_87))
		{
			...
			uLocal_87 = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD(&cLocal_90, vLocal_83 + vVar0, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
		}
	}
		...
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &sLocal_143, &cLocal_159, 2))
		{
			...
			switch (iLocal_224)
			{
				case 0:
					...
					if (fVar3 > fLocal_141)
					{
						if (!ENTITY::DOES_ENTITY_EXIST(uLocal_72) || iLocal_89 != -1)
						{
						...
						else if (GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY(&cLocal_106, uLocal_72, 0f, 0f, -1f, 0f, 0f, 0f, 1065353216, 0, 0, 0))
						{
							if (GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_106, "scr_meth_pipe_smoke"))
							{
								func_16(PLAYER::PLAYER_PED_ID(), 0, 1);
			...
			{
				if (ENTITY::IS_ENTITY_ATTACHED(uLocal_72))
				{
					if (iLocal_82 != -1)
					{
						if (fVar3 > fLocal_81)
...
int func_3(var uParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			if (ENTITY::GET_ENTITY_MODEL(*uParam0) != joaat("prop_cs_ironing_board") && ENTITY::GET_ENTITY_MODEL(*uParam0) != joaat("prop_iron_01"))
			{
				ENTITY::FREEZE_ENTITY_POSITION(*uParam0, 0);
				ENTITY::SET_ENTITY_DYNAMIC(*uParam0, 1);
			}
			if (ENTITY::GET_ENTITY_MODEL(*uParam0) == joaat("prop_iron_01"))
			{
				vVar1 = { ENTITY::GET_ENTITY_COORDS(*uParam0, 1) };
				vVar4 = { ENTITY::GET_ENTITY_ROTATION(*uParam0, 2) };
				ENTITY::SET_ENTITY_COORDS(*uParam0, vVar1 + Vector(0.1f, 0f, 0f), 1, 0, 0, 1);
				ENTITY::SET_ENTITY_ROTATION(*uParam0, vVar4.x, vVar4.y, vVar4.z, 2, 1);
			}
			if (ENTITY::GET_ENTITY_MODEL(*uParam0) != joaat("p_defilied_ragdoll_01_s"))
			{
		...
		case 3:
			...
			if (((ENTITY::GET_ENTITY_MODEL(*uParam0) != -1593767197 && ENTITY::GET_ENTITY_MODEL(*uParam0) != joaat("v_res_tt_flusher")) && ENTITY::GET_ENTITY_MODEL(*uParam0) != joaat("v_ilev_fh_lampa_on")) && ENTITY::GET_ENTITY_MODEL(*uParam0) != joaat("prop_cs_remote_01"))
			{
				ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(*uParam0, -8f, 1);
			}
			if ((ENTITY::GET_ENTITY_MODEL(*uParam0) != joaat("v_ilev_fh_dineeamesa") && ENTITY::GET_ENTITY_MODEL(*uParam0) != joaat("v_res_tt_flusher")) && ENTITY::GET_ENTITY_MODEL(*uParam0) != joaat("v_ilev_fh_lampa_on"))
			{
				ENTITY::FREEZE_ENTITY_POSITION(*uParam0, 0);
			}
			ENTITY::SET_ENTITY_DYNAMIC(*uParam0, 1);
		...
		case 4:
			vVar7 = { ENTITY::GET_ENTITY_COORDS(*uParam0, 1) };
			vVar10 = { ENTITY::GET_ENTITY_ROTATION(*uParam0, 2) };
			iVar13 = 0;
			switch (ENTITY::GET_ENTITY_MODEL(*uParam0))
			{
				...
				case joaat("prop_toiletfoot_static"):
					...
					vVar17 = { 0f, 0f, 53.6f };
					ENTITY::SET_ENTITY_COORDS(*uParam0, vVar14, 1, 0, 0, 1);
					ENTITY::SET_ENTITY_ROTATION(*uParam0, vVar17, 2, 1);
			...
			OBJECT::DELETE_OBJECT(uParam0);
			*uParam0 = OBJECT::CREATE_OBJECT(iVar13, vVar7, 1, 1, 0);
			ENTITY::SET_ENTITY_ROTATION(*uParam0, vVar10, 2, 1);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iVar13);
			return 1;
			break;
		
		case 5:
			FIRE::ADD_EXPLOSION(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), 0, 1056964608, 1, 0, 1065353216, 0);
			OBJECT::DELETE_OBJECT(uParam0);
			return 1;
			break;
		...
		case 7:
			if (ENTITY::GET_ENTITY_MODEL(*uParam0) == WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_pistol")))
			{
		...
		case 8:
			vVar20 = { ENTITY::GET_ENTITY_COORDS(*uParam0, 1) };
			vVar23 = { ENTITY::GET_ENTITY_ROTATION(*uParam0, 2) };
			sVar26 = "";
			switch (ENTITY::GET_ENTITY_MODEL(*uParam0))
			{
		...
		case 9:
			vVar27 = { ENTITY::GET_ENTITY_COORDS(*uParam0, 1) };
			vVar30 = { ENTITY::GET_ENTITY_ROTATION(*uParam0, 2) };
			sVar33 = "";
			switch (ENTITY::GET_ENTITY_MODEL(*uParam0))
			{
				case joaat("prop_cs_beer_bot_01"):
			...
			OBJECT::DELETE_OBJECT(uParam0);
			*uParam0 = OBJECT::CREATE_OBJECT(iVar34, vVar27, 1, 1, 0);
			ENTITY::SET_ENTITY_ROTATION(*uParam0, vVar30, 2, 1);
			if (func_6(iVar0, &sVar35, &cVar51, &uVar67))
			{
				if (func_4(iVar0, &sVar68, &cVar84, &cVar100, &uVar116, &uVar117))
				{
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, &sVar68, &sVar35, 2))
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(*uParam0, Global_91042, &sVar35, &sVar68, 1000f, -8f, uVar67, 1148846080);
					}
				}
			}
...
int func_35()
{
	if (!iLocal_73 == 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_72))
		{
			...
			{
				uLocal_72 = OBJECT::CREATE_OBJECT(iLocal_73, vLocal_83, 1, 1, 0);
				ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_72, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), iLocal_80), vLocal_74, vLocal_77, 0, 0, 0, 0, 2, 1);
			}
			else
			{
				uLocal_72 = OBJECT::CREATE_OBJECT(iLocal_73, vLocal_83 + vLocal_74, 1, 1, 0);
				ENTITY::SET_ENTITY_COORDS(uLocal_72, vLocal_83 + vLocal_74, 1, 0, 0, 1);
				ENTITY::SET_ENTITY_ROTATION(uLocal_72, Vector(uLocal_86, 0f, 0f) + vLocal_77, 2, 1);
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_72, 1);
			}
		}
	}
	if (!func_36())
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_72))
		{
			if (iLocal_80 != -1)
			{
				if (!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_72, PLAYER::PLAYER_PED_ID()))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_72, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), iLocal_80), vLocal_74, vLocal_77, 0, 0, 0, 0, 2, 1);
				}
			}
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 17, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 144, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 43, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
