...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		iLocal_214 = 0;
		iLocal_810 = 0;
		fLocal_594 = (fLocal_594 + GAMEPLAY::GET_FRAME_TIME());
		func_566();
		...
		if (func_31())
		{
			...
			{
				AUDIO::SET_AUDIO_SCENE_VARIABLE(sLocal_344, "DrugsEffect", ((SYSTEM::SIN((((SYSTEM::TO_FLOAT(GAMEPLAY::GET_GAME_TIMER()) / 1000f) * 45f) % 360f)) * 0.25f) + 0.25f));
			}
			func_26();
			func_1();
		}
...
void func_1()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < iLocal_606)
	{
		return;
	}
	if (!bLocal_603)
	...
	{
		iLocal_606 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(20000, 40000));
		if ((iLocal_605 - GAMEPLAY::GET_GAME_TIMER()) < 2500)
		{
			iLocal_605 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 5000));
		}
	}
}
...
void func_26()
{
	if (bLocal_210)
	{
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_186[0 /*3*/], Local_186[1 /*3*/], Local_186.f_7, 0, 1, 0))
		{
			...
			iLocal_211 = GAMEPLAY::GET_GAME_TIMER() + 10000;
			bLocal_210 = false;
		}
	}
	...
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_211)
		{
		}
		func_27("B2_FAIL2");
	}
...
void func_32(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_158))
			{
				func_624(1);
			}
			else
		...
		case 2:
			...
			else if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_158, "B2_FAIL2"))
			{
	...
	switch (iLocal_160)
	{
		...
		case 1:
			if (iParam0 == 0)
			{
				...
				{
					ENTITY::DETACH_ENTITY(uLocal_162, 1, 0);
				}
			}
			...
			CAM::ATTACH_CAM_TO_ENTITY(uVar4, PLAYER::PLAYER_PED_ID(), -vVar0, 1);
			if (CAM::DOES_CAM_EXIST(uVar4))
			{
				CAM::SET_CAM_ACTIVE(uVar4, 1);
			}
			iLocal_157 = GAMEPLAY::GET_GAME_TIMER() + 6000;
			func_19(&uLocal_632, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			iLocal_160 = 2;
			break;
		...
		case 2:
			...
			if (iParam0 == 1)
			{
				if (func_2(&uLocal_632, "BARY2AU", "BARY2_PREOUT", 8, 0, 0, 0) || GAMEPLAY::GET_GAME_TIMER() > iLocal_157)
				{
					if (GAMEPLAY::GET_GAME_TIMER() < iLocal_157)
					{
					}
			...
			{
				iLocal_157 = GAMEPLAY::GET_GAME_TIMER() + 2000;
				bVar3 = true;
			}
			if (bVar3 == 1)
			{
		...
		case 3:
			...
			if (iParam0 == 1)
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_157)
				{
					...
					iLocal_157 = GAMEPLAY::GET_GAME_TIMER() + 3500;
					bVar3 = true;
				}
			}
			else
		...
		case 4:
			if (iParam0 == 1)
			{
				bVar3 = GAMEPLAY::GET_GAME_TIMER() > iLocal_157;
			}
			else
			{
				if (GAMEPLAY::GET_GAME_TIMER() < iLocal_157)
				...
				uLocal_162 = func_35(PLAYER::PLAYER_PED_ID(), 1, 0, 0, 0, 0);
				if (ENTITY::DOES_ENTITY_EXIST(uLocal_162))
				{
					if (func_44(PLAYER::PLAYER_PED_ID()))
					{
						ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_162, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
						...
						if (func_44(uLocal_162) && ENTITY::IS_ENTITY_ATTACHED(uLocal_162))
						{
							ENTITY::DETACH_ENTITY(uLocal_162, 1, 0);
						}
						bVar3 = true;
			...
			{
				AUDIO::TRIGGER_MUSIC_EVENT("RC18B_END");
				iLocal_157 = GAMEPLAY::GET_GAME_TIMER() + 1000;
				iLocal_160 = 5;
			}
			break;
		...
		case 5:
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_157)
			{
				if (iParam0 == 1)
				{
					...
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_173, 200f, 0, 0, 0, 0, 0, 0);
...
int func_36(var uParam0, var uParam1, int iParam2, bool bParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8)
{
	...
	iVar0 = 0;
	iVar2 = uParam1;
	if (!WEAPON::HAS_PED_GOT_WEAPON(uParam0, uParam1, 0))
	{
		iVar0 = 1;
	}
	...
	while (func_40(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(uParam0, iVar2, func_40(iVar2, iVar8)))
			{
				if (func_39(func_40(iVar2, iVar8)))
				{
					uVar9 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_40(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_40(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(uParam0, iVar2, func_40(iVar2, iVar8)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_40(iVar2, iVar8));
	...
	if (func_56(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 < Local_346)
		{
			if (func_72(&(Local_346[iVar0 /*19*/])))
			{
				...
				AI::TASK_SMART_FLEE_COORD(Local_346[iVar0 /*19*/].f_3, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 400f, -1, 0, 0);
			}
			iVar0++;
		}
	}
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_302(1, 1093140480, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2"))
			{
				...
				func_296();
				iLocal_345 = 0;
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_173, 250f, 0, 0, 0, 0, 0, 0);
				GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_173, 50f, 0);
				GAMEPLAY::CLEAR_AREA_OF_OBJECTS(vLocal_173, 30f, 0);
				GRAPHICS::REMOVE_DECALS_IN_RANGE(vLocal_173, 500f);
...
void func_123(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_124(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
...
int func_125(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_147(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_128(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_130(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_130(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 4);
		}
	}
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_147(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_125(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_125(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_125(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_125(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_164(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_158(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_158(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_147(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_269(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_11(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar1 <= (8 - 1))
		{
			UI::_0x72C1056D678BB7D8(Global_106565.f_2357.f_539.f_1730[iVar1 /*4*/][iVar0]);
			if (bParam2)
			{
				if (iVar1 == Global_106565.f_2357.f_539.f_1763 || (Global_106565.f_2357.f_539.f_1763 == -1 && iVar1 == 4))
				{
					if (Global_106565.f_2357.f_539.f_1730[iVar1 /*4*/][iVar0] != 0 && Global_106565.f_2357.f_539.f_1730[iVar1 /*4*/][iVar0] != joaat("weapon_molotov"))
					{
						...
						{
							WEAPON::SET_CURRENT_PED_WEAPON(iParam0, Global_106565.f_2357.f_539.f_1730[iVar1 /*4*/][iVar0], 1);
						}
					}
				}
			}
...
void func_270(int iParam0, var uParam1, bool bParam2)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar7 < 2)
		{
			...
			iVar169 = DLC1::GET_NUM_DLC_WEAPONS();
			iVar8 = 0;
			while (iVar8 < iVar169)
			{
				if (iVar8 < 51)
			...
			if ((iVar8 != -1 && iVar8 < 51) && !func_275(Var9.f_1))
			{
				...
				if (iVar3 != 0)
				{
					if (iVar3 != joaat("weapon_unarmed"))
					{
						...
						{
							if (DLC1::GET_DLC_WEAPON_COMPONENT_DATA(iVar8, iVar6, &Var48))
							{
								if (!func_41(Var48.f_3))
								{
									if (GAMEPLAY::IS_BIT_SET(uParam1->f_221[iVar70 /*5*/].f_2, iVar71))
									{
...
int func_278(bool bParam0, bool bParam1)
{
	if (bParam0)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_106565.f_668.f_1311, 2))
		{
			return 1;
		}
	}
...
void func_337(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_275(Var11.f_1)) && iVar72 < 51)
			{
...
void func_338(var uParam0)
{
	...
	if (func_11(iVar0) && !PED::IS_PED_INJURED(uParam0))
	{
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_371(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
	...
	if (!*bParam0)
	{
		if (iLocal_582 == 1)
		{
			...
			if (iVar0 != -1)
			{
				...
				Local_346[iVar0 /*19*/].f_11 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_601, (iLocal_601 + iLocal_600)));
...
void func_387(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(uParam0->f_3, 50, 1);
	}
...
{
	uParam0->f_1 = (func_395(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
int func_402(var uParam0, vector3 vParam1, int iParam4, bool bParam5, bool bParam6)
{
	...
	uParam0->f_3 = PED::CREATE_PED(26, iLocal_545, vParam1, iParam4, 1, 1);
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_3))
	{
		return 0;
	}
	...
	PED::SET_PED_COMBAT_ATTRIBUTES(uParam0->f_3, 24, 0);
	...
	PED::SET_PED_COMBAT_ATTRIBUTES(uParam0->f_3, 13, 0);
	...
	*uParam0 = 1;
	...
	if (func_404())
	{
		PED::SET_PED_PROP_INDEX(uParam0->f_3, 0, 0, 0, 0);
	}
	PED::SET_PED_CAN_COWER_IN_COVER(uParam0->f_3, 0);
	PED::SET_PED_CAN_PEEK_IN_COVER(uParam0->f_3, 1);
	PED::SET_PED_COMBAT_ATTRIBUTES(uParam0->f_3, 1, 0);
	...
	AI::TASK_PLAY_ANIM(uParam0->f_3, sLocal_343, &(uParam0->f_7), 8f, -2f, -1, 0, 0, 0, 0, 0);
...
void func_403(var uParam0, var uParam1, bool bParam2)
{
	...
	PED::SET_PED_SHOOT_RATE(uParam0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(uParam1->f_16, uParam1->f_17));
	PED::SET_PED_FIRING_PATTERN(uParam0, *uParam1);
	PED::SET_COMBAT_FLOAT(uParam0, 3, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(uParam1->f_12, uParam1->f_13));
	PED::SET_COMBAT_FLOAT(uParam0, 4, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(uParam1->f_10, uParam1->f_11));
	PED::SET_COMBAT_FLOAT(uParam0, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(uParam1->f_14, uParam1->f_15));
	if (bParam2)
	{
	...
	PED::SET_PED_COMBAT_ATTRIBUTES(uParam0, 13, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < uParam1->f_20);
	PED::SET_PED_COMBAT_ATTRIBUTES(uParam0, 42, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < uParam1->f_8);
	PED::SET_PED_COMBAT_ATTRIBUTES(uParam0, 11, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < uParam1->f_9);
	if (uParam1->f_19 != -1)
	{
		iVar0 = uParam1->f_19;
	}
...
void func_406(var uParam0)
{
	...
	uVar0 = func_407(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
...
void func_411(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			func_398(&uLocal_1108);
			fLocal_1111 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(5f, 8f);
			*iParam0 = 2;
			break;
		...
		case 2:
			if (!iLocal_800)
			{
				...
				{
					func_412(2, 5, 5, 0);
					fLocal_1111 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(20f, 30f);
					func_398(&uLocal_1108);
				}
			}
			if (iLocal_577 >= 5)
...
int func_414(int iParam0)
{
	...
	if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Local_834[iParam0 /*11*/].f_2, &uVar0, 0, 0))
	{
...
int func_423(var uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vParam1, 5f, 0, 0, 0, 0, 0, 0);
	...
	*uParam0 = 1;
	uParam0->f_6 = (GAMEPLAY::GET_GAME_TIMER() + iParam6);
	uParam0->f_7 = 0;
	uParam0->f_2 = 1;
	uParam0->f_10 = 0;
...
void func_425(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 2:
			if (iLocal_582 > 1)
			{
				if (func_422(&uLocal_1108, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(9f, 12f)))
				{
					func_412(1, 5, 5, 0);
				}
			}
...
{
	func_19(&uLocal_632, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	iLocal_606 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(20000, 30000);
	iLocal_605 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10000, 20000);
	bLocal_603 = false;
}
...
void func_434()
{
	uLocal_36 = GAMEPLAY::GET_GAME_TIMER();
}
...
int func_447()
{
	...
	if (!iLocal_806)
	{
		if (iLocal_890 == 9 && GAMEPLAY::GET_GAME_TIMER() > iLocal_604)
		{
			func_19(&uLocal_632, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	...
	switch (iLocal_890)
	{
		...
		case 8:
			...
			{
				iLocal_604 = GAMEPLAY::GET_GAME_TIMER() + 1500;
				iLocal_890 = 9;
			}
			break;
...
int func_448(var uParam0)
{
	...
	if (AI::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 780511057) > 1)
	{
		...
		{
			uParam0->f_11 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_600, iLocal_601));
			uParam0->f_2 = 12;
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_453(iParam3), 0);
}
...
int func_454(var uParam0, char* sParam1, int iParam2)
{
	if (uParam0->f_2 == 0)
	{
		if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_3, sLocal_343, sParam1, 3))
		{
			...
			AI::TASK_PLAY_ANIM(uParam0->f_3, sLocal_343, &(uParam0->f_7), 8f, -1f, -1, 0, iParam2, 0, 0, 0);
		}
		else
		{
			return 1;
...
void func_466(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 2:
			if (!CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				GAMEPLAY::SET_TIME_SCALE(fLocal_177);
...
void func_477()
{
	...
	uVar0 = ENTITY::GET_ENTITY_MODEL(PLAYER::GET_PLAYERS_LAST_VEHICLE());
	if (VEHICLE::IS_THIS_MODEL_A_HELI(uVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(uVar0))
	{
	...
	switch (*iParam0)
	{
		case 0:
			...
			*iParam0 = 1;
			if (func_56(Local_96.f_28[0]))
			{
				...
				if (func_56(PLAYER::PLAYER_PED_ID()))
				{
					AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_96.f_28[0], -1, 0, 2);
				}
			}
			break;
		...
		case 1:
			if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_343) && !func_23())
			{
				...
				{
					AI::TASK_PLAY_ANIM(Local_96.f_28[0], sLocal_343, "lead_in", 8f, -4f, -1, 2, 0, 0, 0, 0);
					AI::TASK_LOOK_AT_ENTITY(Local_96.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
					*iParam0 = 2;
					iLocal_595 = GAMEPLAY::GET_GAME_TIMER() + 30000;
				}
			}
			break;
		...
		case 2:
			if (func_56(Local_96.f_28[0]))
			{
				if (!func_23() || GAMEPLAY::GET_GAME_TIMER() > iLocal_595)
				{
					if (func_56(PLAYER::PLAYER_PED_ID()))
					{
...
void func_523()
{
	...
	if (func_402(&(Local_346[iVar0 /*19*/]), vVar1, 0, 0, 0))
	{
		if (iLocal_159 == 9)
		{
			iLocal_570 = GAMEPLAY::GET_GAME_TIMER() + 25;
			iLocal_1112++;
		}
		else
		{
			iLocal_570 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_571, iLocal_572));
		}
	}
}
...
int func_524(var uParam0)
{
	...
	if (iLocal_159 != 9)
	{
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar0, vLocal_169, 1) > fLocal_172)
		{
			return 0;
		}
	}
...
{
	return GAMEPLAY::IS_POSITION_OCCUPIED(vParam0, fParam3, 0, 0, 1, 0, 0, uParam4, iParam5);
}
...
Vector3 func_527(vector3 vParam0, float fParam3, float fParam4)
{
	...
	fVar3 = (fParam4 / 2f);
	vVar0 = { func_528(vVar0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam3)) };
...
int func_530(var uParam0)
{
	...
	if (uParam0->f_9 == 0)
	{
		...
		{
			uParam0->f_6 = (GAMEPLAY::GET_GAME_TIMER() + iVar6);
			uParam0->f_9 = 1;
		}
	}
	if (bLocal_213)
	...
	switch (uParam0->f_2)
	{
		...
		case 2:
			...
			if (GAMEPLAY::GET_GAME_TIMER() >= uParam0->f_6 || uParam0->f_5 >= 255f)
			{
				...
				uParam0->f_6 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_573, iLocal_574));
				if (uParam0->f_13 != 0)
				{
					uParam0->f_2 = 10;
				}
		...
		case 10:
			...
			if (func_408(&iVar0))
			{
				...
				if (func_535(&(Local_346[uParam0->f_14 /*19*/]), uParam0->f_3, 1))
				{
					...
					AI::CLEAR_PED_TASKS(Local_346[uParam0->f_14 /*19*/].f_3);
					...
					AI::TASK_PERFORM_SEQUENCE(Local_346[uParam0->f_14 /*19*/].f_3, uVar2);
		...
		case 11:
			...
			{
				if (AI::GET_SCRIPT_TASK_STATUS(Local_346[uParam0->f_14 /*19*/].f_3, 242628503) == 7)
				{
					...
					AI::TASK_PERFORM_SEQUENCE(Local_346[uParam0->f_14 /*19*/].f_3, uVar7);
		...
		case 12:
			...
			{
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_599 && ENTITY::IS_ENTITY_ON_SCREEN(uParam0->f_3))
				{
			...
			if (func_408(&iVar0))
			{
				if (func_535(&(Local_346[iVar0 /*19*/]), uParam0->f_3, 0))
				{
					...
					vVar8 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_3, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-2.5f, 2.5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-6.5f, -10f), -0.7f) };
					AI::OPEN_SEQUENCE_TASK(&uVar11);
					AI::TASK_SWAP_WEAPON(0, 1);
					AI::TASK_LEAVE_VEHICLE(0, uParam0->f_3, 256);
					AI::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vVar8, PLAYER::PLAYER_PED_ID(), 1f, 1, 1.5f, 2f, 1, 0, 0, -957453492, 20000);
					AI::CLOSE_SEQUENCE_TASK(uVar11);
					AI::TASK_PERFORM_SEQUENCE(Local_346[iVar0 /*19*/].f_3, uVar11);
					AI::CLEAR_SEQUENCE_TASK(&uVar11);
					if (uParam0->f_9 == 0)
					{
						uParam0->f_6 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_573 * 4, iLocal_574 * 4));
					}
					else
					{
						uParam0->f_6 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_573 + 500, iLocal_574));
					}
					if (uParam0->f_10 > 5)
					{
						uParam0->f_6 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_573 * 4, iLocal_574 * 4));
					...
					if (!iLocal_1106)
					{
						iLocal_599 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_574 + 500);
						iLocal_1106 = 1;
					}
				}
			}
...
int func_535(var uParam0, var uParam1, int iParam2)
{
	...
	if (iParam2 == 0)
	{
		...
		else if (VEHICLE::IS_VEHICLE_SEAT_FREE(uParam1, 2, 0))
		{
			iVar1 = 2;
		}
		else
	...
	*uParam0 = 1;
	...
	uParam0->f_2 = 0;
	func_405(uParam0, 0);
	uParam0->f_11 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(SYSTEM::ROUND((IntToFloat(iLocal_600) * 1.5f)), iLocal_601));
	PED::SET_PED_CAN_COWER_IN_COVER(uParam0->f_3, 0);
	PED::SET_PED_CAN_PEEK_IN_COVER(uParam0->f_3, 1);
	PED::SET_PED_COMBAT_ATTRIBUTES(uParam0->f_3, 1, 0);
	PED::SET_PED_AS_ENEMY(uParam0->f_3, 1);
...
void func_538(var uParam0, var uParam1, int iParam2)
{
	...
	ENTITY::SET_ENTITY_ALPHA(uParam0, uParam1, 0);
	*iParam2++;
}
...
int func_542(var uParam0, bool bParam1)
{
	...
	if (ENTITY::GET_ENTITY_HEALTH(uParam0) == 0)
	{
		return 1;
	}
	if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
...
void func_545(var uParam0)
{
	...
	if (!func_556(uParam0))
	{
		if ((ENTITY::IS_ENTITY_DEAD(uParam0->f_3, 0) || PED::IS_PED_INJURED(uParam0->f_3)) || PED::IS_PED_DEAD_OR_DYING(uParam0->f_3, 0))
		{
			...
			uParam0->f_2 = 15;
			uParam0->f_12 = (GAMEPLAY::GET_GAME_TIMER() + iVar4);
			func_69(&(uParam0->f_5));
	...
	{
		case 1:
			if (GAMEPLAY::GET_GAME_TIMER() >= uParam0->f_12 || iLocal_159 == 9)
			{
				ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_3, 1);
		...
		case 12:
			...
			if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_11)
			{
				...
				{
					uParam0->f_11 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(iLocal_600, (iLocal_601 / 2)));
				}
			}
			vVar0 = { ENTITY::GET_ENTITY_COORDS(uParam0->f_3, 1) };
			if (vVar0.z < 27.7f)
		...
		case 9:
			if (GAMEPLAY::ARE_STRINGS_EQUAL(&(uParam0->f_7), sLocal_817))
			{
				sVar5 = sLocal_816;
				fVar6 = 0.802f;
				fVar7 = 0.815f;
...
void func_548(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 0)
	{
		...
		AI::TASK_PLAY_ANIM(uParam0->f_3, sLocal_816, &(uParam0->f_7), 8f, -4f, -1, 0, 0.625f, 0, 0, 0);
	}
	else
	{
		StringCopy(&(uParam0->f_7), "clown_idle_", 16);
		StringIntConCat(&(uParam0->f_7), GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 6), 16);
		AI::TASK_PLAY_ANIM(uParam0->f_3, sLocal_343, &(uParam0->f_7), 8f, -1f, -1, 0, 0, 0, 0, 0);
	}
}
...
void func_553()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() < iLocal_605)
	{
		return;
	}
	if (!bLocal_603)
	...
	{
		iLocal_605 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10000, 20000));
		if ((iLocal_606 - GAMEPLAY::GET_GAME_TIMER()) < 2500)
		{
			iLocal_606 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 5000));
		}
	}
}
...
void func_558(int iParam0)
{
	...
	if (ENTITY::IS_ENTITY_DEAD(Local_834[iParam0 /*11*/], 0) || PED::IS_PED_DEAD_OR_DYING(Local_834[iParam0 /*11*/], 1))
	{
		if (Local_834[iParam0 /*11*/].f_6 < 5)
		{
			...
			func_69(&iLocal_811);
			Local_834[iParam0 /*11*/].f_8 = GAMEPLAY::GET_GAME_TIMER() + 500;
	...
	{
		case 0:
			Local_834[iParam0 /*11*/].f_9 = (Local_834[iParam0 /*11*/].f_9 + (GAMEPLAY::GET_FRAME_TIME() * 512f));
		...
		case 2:
			if (func_56(PLAYER::PLAYER_PED_ID()))
			{
				if (func_56(Local_834[iParam0 /*11*/]))
				{
					...
					AI::TASK_SMART_FLEE_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_834[iParam0 /*11*/], vVar0), 200f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uVar3);
					AI::CLEAR_PED_TASKS(Local_834[iParam0 /*11*/]);
					AI::TASK_PERFORM_SEQUENCE(Local_834[iParam0 /*11*/], uVar3);
		...
		case 5:
			if (GAMEPLAY::GET_GAME_TIMER() > Local_834[iParam0 /*11*/].f_8)
			{
		...
		case 6:
			if (GAMEPLAY::GET_GAME_TIMER() > Local_834[iParam0 /*11*/].f_8)
			{
				Local_834[iParam0 /*11*/].f_9 = (Local_834[iParam0 /*11*/].f_9 - (GAMEPLAY::GET_FRAME_TIME() * 1024f));
...
void func_559(int iParam0)
{
	if (Local_834[iParam0 /*11*/].f_1 == iLocal_808)
	{
		...
		{
			AI::TASK_PLAY_ANIM(Local_834[iParam0 /*11*/], sLocal_814, sLocal_815, 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.5f), 0, 0, 0);
		}
	}
	else if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_834[iParam0 /*11*/], sLocal_812, sLocal_813, 3))
	{
		AI::TASK_PLAY_ANIM(Local_834[iParam0 /*11*/], sLocal_812, sLocal_813, 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.5f), 0, 0, 0);
	}
}
	...
	while (iVar3 < Local_834)
	{
		if (iVar3 != iParam0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_834[iVar3 /*11*/]))
			{
				...
				{
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar0, ENTITY::GET_ENTITY_COORDS(Local_834[iVar3 /*11*/], 0), 0) < 20f)
					{
						return 1;
					}
				}
