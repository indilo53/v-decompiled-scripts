...
void func_1()
{
	if (iLocal_3505)
	{
		if (INTERIOR::IS_INTERIOR_READY(uLocal_3504))
		{
			INTERIOR::_LOAD_INTERIOR(uLocal_3504);
			iLocal_3505 = 0;
		}
	}
}
		...
		if (Local_2515[iVar0 /*6*/].f_1 == 1)
		{
			switch (Local_2515[iVar0 /*6*/])
			{
				...
				case 3:
					...
					switch (Local_2515[iVar0 /*6*/].f_2)
					{
						case 0:
							...
							iLocal_2888 = 0;
							Local_2515[iVar0 /*6*/].f_5 = GAMEPLAY::GET_GAME_TIMER() + 3000;
							break;
						...
						case 1:
							if (!func_59())
							{
								if (!func_34())
								{
									...
									{
										if (GAMEPLAY::GET_GAME_TIMER() > Local_2515[iVar0 /*6*/].f_5)
										{
											if (iLocal_2888 < 13)
											{
												...
												{
													iLocal_2888++;
													Local_2515[iVar0 /*6*/].f_5 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(4000, 10000));
												}
											}
											else
											{
				...
				case 5:
					...
					{
						case -20:
							if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2460.073f, 4964.176f, 46.2405f, 1) < 250f)
							{
						...
						case 1:
							...
							if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2460.073f, 4964.176f, 46.2405f, 1) > 300f)
							{
				...
				case 7:
					if (Local_2515[iVar0 /*6*/].f_2 == 0)
					{
						...
						if (iVar2 != -1)
						{
							...
							{
								if (AI::GET_SCRIPT_TASK_STATUS(Local_755[iVar2 /*33*/], 1785177548) == 7)
								{
									iVar2 = func_18(9);
									if (iVar2 != -1)
									{
				...
				case 8:
					switch (Local_2515[iVar0 /*6*/].f_2)
					{
						...
						case 1:
							if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
							{
								if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 2473.061f, 4981.482f, 24.64584f, 1) < 250f)
								{
									Local_2515[iVar0 /*6*/].f_2++;
								}
							}
				...
				case 14:
					...
					{
						case 0:
							Local_2515[iVar0 /*6*/].f_5 = GAMEPLAY::GET_GAME_TIMER() + 7000;
							Local_2515[iVar0 /*6*/].f_2++;
							break;
				...
				case 16:
					if (Local_2515[iVar0 /*6*/].f_2 != -1)
					{
						if (!WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_petrolcan"), 0) || !OBJECT::DOES_PICKUP_EXIST(uLocal_2675))
						{
							...
							if (iLocal_2679 != 0)
							{
								if (UI::DOES_BLIP_EXIST(uLocal_2677))
								{
									UI::REMOVE_BLIP(&uLocal_2677);
								}
				...
				case 17:
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2447.671f, 4951.438f, 43.25576f, 2454.664f, 4957.856f, 47.89117f, 6.8125f, 0, 1, 0) && GAMEPLAY::GET_GAME_TIMER() > Local_2515[iVar0 /*6*/].f_5)
					{
						if (UI::DOES_BLIP_EXIST(uLocal_2677))
						{
							UI::REMOVE_BLIP(&uLocal_2677);
						...
						switch (Local_2515[iVar0 /*6*/].f_2)
						{
							case 0:
								if (!func_59())
								{
									...
									Local_2515[iVar0 /*6*/].f_5 = GAMEPLAY::GET_GAME_TIMER() + 2000;
				...
				case 20:
					if (!GAMEPLAY::IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 0))
					{
						iLocal_2885 = func_18(4);
						if (iLocal_2885 != -1)
						{
							GAMEPLAY::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 0);
						}
					}
					else if (!GAMEPLAY::IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 1))
					{
						if (!PED::IS_PED_INJURED(Local_755[iLocal_2885 /*33*/]) && ENTITY::DOES_ENTITY_EXIST(Local_755[iLocal_2885 /*33*/].f_20))
						{
							...
							{
								GAMEPLAY::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 1);
							}
						}
					}
					else if (!GAMEPLAY::IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 2))
					{
						if (PED::IS_PED_INJURED(Local_755[iLocal_2885 /*33*/]))
						{
							GAMEPLAY::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 2);
						}
						if (!PED::IS_PED_INJURED(Local_755[iLocal_2885 /*33*/]))
						{
							...
							if (AI::GET_SCRIPT_TASK_STATUS(Local_755[iLocal_2885 /*33*/], -2017877118) == 2 || AI::GET_SCRIPT_TASK_STATUS(Local_755[iLocal_2885 /*33*/], -2017877118) == 7)
							{
								GAMEPLAY::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 2);
							}
					...
					if (!GAMEPLAY::IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 4))
					{
						iLocal_2886 = func_18(5);
						if (iLocal_2886 != -1)
						{
							GAMEPLAY::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 4);
						}
					}
					else if (!GAMEPLAY::IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 5))
					{
						if (!PED::IS_PED_INJURED(Local_755[iLocal_2886 /*33*/]))
						{
							if (ENTITY::DOES_ENTITY_EXIST(Local_755[iLocal_2886 /*33*/].f_20))
							{
								if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_755[iLocal_2886 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", 3))
								{
									...
									{
										GAMEPLAY::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 5);
									}
								}
							}
						}
					}
					else if (!GAMEPLAY::IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 6))
					{
						if (PED::IS_PED_INJURED(Local_755[iLocal_2886 /*33*/]))
						{
							GAMEPLAY::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 6);
						}
						if (!PED::IS_PED_INJURED(Local_755[iLocal_2886 /*33*/]))
						{
							if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_755[iLocal_2886 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", 3))
							...
							if (AI::GET_SCRIPT_TASK_STATUS(Local_755[iLocal_2886 /*33*/], -2017877118) == 2 || AI::GET_SCRIPT_TASK_STATUS(Local_755[iLocal_2886 /*33*/], -2017877118) == 7)
							{
								GAMEPLAY::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 6);
							}
				...
				case 23:
					...
					switch (Local_2515[iVar0 /*6*/].f_2)
					{
						...
						case 0:
							if (!ENTITY::DOES_ENTITY_EXIST(uLocal_2680) && !ENTITY::DOES_ENTITY_EXIST(uLocal_2681))
							{
								...
								{
									uLocal_2680 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2493.5f, 4969.2f, 43.9f, 1f, -921781850, 1, 0, 1);
									ENTITY::FREEZE_ENTITY_POSITION(uLocal_2680, 1);
									ENTITY::CREATE_MODEL_HIDE(2493.4f, 4971.8f, 43.6f, 1f, -1853453107, 0);
									uLocal_2681 = OBJECT::CREATE_OBJECT(-1853453107, 2493.427f, 4971.729f, 43.54362f, 1, 1, 0);
									ENTITY::SET_ENTITY_ROTATION(uLocal_2681, -1.436373f, 0.176147f, -36.6601f, 2, 1);
									ENTITY::FREEZE_ENTITY_POSITION(uLocal_2681, 1);
									func_32(24, 0);
									Local_2515[iVar0 /*6*/].f_2++;
								}
							}
							...
							{
								OBJECT::DELETE_OBJECT(&uLocal_2681);
								uLocal_2681 = OBJECT::CREATE_OBJECT(-1853453107, 2493.427f, 4971.729f, 43.54362f, 1, 1, 0);
								ENTITY::SET_ENTITY_ROTATION(uLocal_2681, -1.436373f, 0.176147f, -36.6601f, 2, 1);
								ENTITY::FREEZE_ENTITY_POSITION(uLocal_2681, 1);
								func_32(24, 0);
				...
				case 24:
					if (!GAMEPLAY::IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 0))
					{
						if (ENTITY::DOES_ENTITY_EXIST(uLocal_2680))
						{
							if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
							{
								if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_2680, PLAYER::PLAYER_PED_ID(), 1) || func_4(PLAYER::PLAYER_PED_ID(), uLocal_2680, 1) < 30f)
								{
									ENTITY::FREEZE_ENTITY_POSITION(uLocal_2680, 0);
									GAMEPLAY::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 0);
								}
							}
						}
					}
					if (!GAMEPLAY::IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 1))
					{
						if (ENTITY::DOES_ENTITY_EXIST(uLocal_2681))
						{
							if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
							{
								if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_2681, PLAYER::PLAYER_PED_ID(), 1) || func_4(PLAYER::PLAYER_PED_ID(), uLocal_2681, 1) < 30f)
								{
									ENTITY::FREEZE_ENTITY_POSITION(uLocal_2681, 0);
									GAMEPLAY::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 1);
								}
							}
						}
					}
					if ((GAMEPLAY::IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 0) && GAMEPLAY::IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 1)) || iLocal_2511 == 6)
					{
						if (ENTITY::DOES_ENTITY_EXIST(uLocal_2680))
						{
							ENTITY::FREEZE_ENTITY_POSITION(uLocal_2680, 0);
					...
					switch (Local_2515[iVar0 /*6*/].f_2)
					{
						...
						case 2:
							if (AI::DOES_SCENARIO_EXIST_IN_AREA(1984.89f, 3052.46f, 46.98f, 0.3f, 1) && AI::DOES_SCENARIO_EXIST_IN_AREA(1985.322f, 3053.087f, 46.98f, 0.3f, 1))
							{
								...
								GAMEPLAY::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 1);
								AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_755[14 /*33*/], 1984.89f, 3052.46f, 46.98f, 0.3f, 0);
								PED::_0x2208438012482A1A(Local_755[14 /*33*/], 1, 1);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_755[14 /*33*/], 0);
								GAMEPLAY::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 0);
								AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_755[13 /*33*/], 1985.322f, 3053.087f, 46.98f, 0.3f, 0);
								...
								AI::TASK_SYNCHRONIZED_SCENE(Local_755[12 /*33*/], Local_2515[iVar0 /*6*/].f_5, "MISSChinese2_crystalMazeMCS1_IG", "bar_peds_action_janet", 1000f, -1000f, 1, 0, 1148846080, 0);
						...
						case 3:
							...
							if (!PED::IS_PED_INJURED(Local_755[13 /*33*/]) && !PED::IS_PED_INJURED(Local_755[14 /*33*/]))
							{
								...
								if (GAMEPLAY::IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 0) && GAMEPLAY::IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 1))
								{
									Local_2515[iVar0 /*6*/].f_2++;
								}
								else
								{
									if (AI::GET_SCRIPT_TASK_STATUS(Local_755[13 /*33*/], 993674639) != 1)
									{
										if (AI::DOES_SCENARIO_EXIST_IN_AREA(1984.89f, 3052.46f, 46.98f, 0.3f, 1))
										{
											GAMEPLAY::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 0);
											AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_755[13 /*33*/], 1984.89f, 3052.46f, 46.98f, 0.3f, 0);
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_755[13 /*33*/], 0);
										}
									}
									else
									...
									if (AI::GET_SCRIPT_TASK_STATUS(Local_755[14 /*33*/], 993674639) != 1)
									{
										if (AI::DOES_SCENARIO_EXIST_IN_AREA(1985.322f, 3053.087f, 46.98f, 0.3f, 1))
										{
											GAMEPLAY::SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 1);
											AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_755[14 /*33*/], 1985.322f, 3053.087f, 46.98f, 0.3f, 0);
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_755[14 /*33*/], 0);
										}
									}
									else
						...
						case 6:
							...
							{
								AI::TASK_SMART_FLEE_PED(Local_755[12 /*33*/], PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
							...
							{
								AI::TASK_SMART_FLEE_PED(Local_755[13 /*33*/], PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
							...
							{
								AI::TASK_SMART_FLEE_PED(Local_755[14 /*33*/], PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
...
void func_12(int iParam0)
{
	...
	if (iParam0 == 1)
	{
		if (iLocal_262 == 0)
		{
			...
			{
				if (UI::DOES_BLIP_EXIST(Local_444[iVar0 /*5*/].f_3))
				{
					if (UI::GET_BLIP_ALPHA(Local_444[iVar0 /*5*/].f_3) < 255)
					{
						UI::REMOVE_BLIP(&(Local_444[iVar0 /*5*/].f_3));
					}
					else
					{
						UI::SET_BLIP_ALPHA(Local_444[iVar0 /*5*/].f_3, 0);
					}
				}
				iVar0++;
			}
	...
	else if (iLocal_262)
	{
		...
		while (iVar0 < Local_444)
		{
			if (UI::DOES_BLIP_EXIST(Local_444[iVar0 /*5*/].f_3))
			{
				UI::SET_BLIP_ALPHA(Local_444[iVar0 /*5*/].f_3, 255);
			}
			else
			{
				Local_444[iVar0 /*5*/].f_3 = func_5(Local_444[iVar0 /*5*/], 0);
				UI::_0x54318C915D27E4CE(Local_444[iVar0 /*5*/].f_3, 1);
				UI::SET_BLIP_SCALE(Local_444[iVar0 /*5*/].f_3, 0.4f);
				UI::SET_BLIP_ALPHA(Local_444[iVar0 /*5*/].f_3, 0);
				UI::SET_BLIP_COLOUR(Local_444[iVar0 /*5*/].f_3, 5);
				UI::_0x75A16C3DA34F1245(Local_444[iVar0 /*5*/].f_3, 0);
			}
			iVar0++;
		}
		iLocal_262 = 0;
...
int func_14(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_6(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
void func_27()
{
	...
	func_32(27, 0);
	GAMEPLAY::CLEAR_AREA(2479.875f, 4980.868f, 44.82052f, 60f, 1, 0, 0, 0);
	...
	if (iLocal_2511 == 7)
	{
		...
		AI::TASK_PLAY_ANIM(Local_755[15 /*33*/], "DEAD", "DEAD_C", 1000f, -1000f, -1, 1, 0, 0, 0, 0);
		...
		AI::TASK_PLAY_ANIM(Local_755[16 /*33*/], "DEAD", "DEAD_D", 1000f, -1000f, -1, 1, 0, 0, 0, 0);
		...
		AI::TASK_PLAY_ANIM(Local_755[17 /*33*/], "DEAD", "DEAD_E", 1000f, -1000f, -1, 1, 0, 0, 0, 0);
		...
		AI::TASK_PLAY_ANIM(Local_755[18 /*33*/], "DEAD", "DEAD_G", 1000f, -1000f, -1, 1, 0, 0, 0, 0);
	...
	if (!PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(uLocal_2510))
	{
		uLocal_2510 = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(2464.956f, 4990.051f, 44.48415f, 2.5f, 3.125f, 2.0625f, 0f, 0, 7);
	}
...
void func_58(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(uLocal_51) || !GAMEPLAY::ARE_STRINGS_EQUAL(uLocal_51, uParam0))
	{
		uLocal_51 = uParam0;
		iVar0 = 0;
		while (iVar0 <= 15)
							...
							switch (Local_755[iVar0 /*33*/].f_2)
							{
								...
								case 8:
									if (func_101(iVar0, joaat("a_m_m_hillbilly_02"), 2505.451f, 4970.663f, 43.548f, 49.5021f, joaat("weapon_pistol"), 1, 0))
									{
										...
										AI::TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], Local_755[iVar0 /*33*/].f_14, "misschinese2_bank5", "peds_shootcans_a", 1000f, -4f, 1, 0, 1148846080, 0);
								...
								case 9:
									if (func_101(iVar0, joaat("a_m_m_hillbilly_01"), 2505.451f, 4970.663f, 43.548f, 49.5021f, joaat("weapon_pistol"), 1, 0))
									{
										...
										PED::SET_SYNCHRONIZED_SCENE_LOOPED(Local_755[iVar0 /*33*/].f_14, 1);
										func_100(&Local_1619, iVar0, Local_755[iVar0 /*33*/], 0, 0, 0);
										AI::TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], Local_755[iVar0 /*33*/].f_14, "misschinese2_bank5", "peds_shootcans_b", 1000f, -4f, 1, 0, 1148846080, 0);
										PED::_0x2208438012482A1A(Local_755[iVar0 /*33*/], 0, 0);
										func_99(iVar0, 4, 0, Local_755[iVar0 /*33*/].f_14);
									}
									break;
						...
						switch (Local_755[iVar0 /*33*/].f_3)
						{
									...
									case 0:
										if (ENTITY::DOES_ENTITY_EXIST(Local_755[iVar0 /*33*/].f_20))
										{
											...
											if (ENTITY::DOES_ENTITY_EXIST(Local_755[iVar0 /*33*/].f_20))
											{
												...
												{
													AI::TASK_PLAY_ANIM(Local_755[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_B", 1000f, -1f, -1, 1, 0, 0, 0, 0);
												}
												else
												{
													AI::TASK_PLAY_ANIM(Local_755[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", 1000f, -1f, -1, 1, 0, 0, 0, 0);
												}
												ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_755[iVar0 /*33*/], 1, 1);
												PED::_0x2208438012482A1A(Local_755[iVar0 /*33*/], 0, 0);
												Local_755[iVar0 /*33*/].f_5++;
							...
							case 2:
								...
								if (ENTITY::DOES_ENTITY_EXIST(Local_755[iVar0 /*33*/].f_20))
								{
									if (Local_755[iVar0 /*33*/].f_5 > 2 && Local_755[iVar0 /*33*/].f_5 <= 6)
									{
										...
										{
											Local_755[iVar0 /*33*/].f_12 = (func_96(ENTITY::GET_ENTITY_COORDS(Local_755[iVar0 /*33*/], 1), Local_755[iVar0 /*33*/].f_6, 1) - ENTITY::GET_ENTITY_HEADING(Local_755[iVar0 /*33*/]));
								...
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									...
									case 6:
										if (ENTITY::IS_ENTITY_AT_COORD(Local_755[iVar0 /*33*/], Local_755[iVar0 /*33*/].f_6, 1.5f, 1.5f, 2f, 0, 1, 0))
										{
											if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_755[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_B", 3))
											{
												AI::STOP_ANIM_TASK(Local_755[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_B", -1.5f);
											}
											if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_755[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", 3))
											{
												AI::STOP_ANIM_TASK(Local_755[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", -1.5f);
											}
											...
											if (func_68(iLocal_2507))
											{
												if (Local_755[iVar0 /*33*/].f_2 == 4)
												{
													...
													AI::TASK_ENTER_VEHICLE(Local_755[iVar0 /*33*/], iLocal_2507, -1, -1, 1f, 1, 0);
												...
												else
												{
													...
													AI::TASK_ENTER_VEHICLE(Local_755[iVar0 /*33*/], iLocal_2507, -1, 0, 1f, 1, 0);
												}
											}
											Local_755[iVar0 /*33*/].f_5++;
													...
													if (!VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_2507, 0, 0))
													{
														...
														if (iVar1 >= 0)
														{
															if (!PED::IS_PED_INJURED(Local_755[iVar1 /*33*/]))
															{
																...
																{
																	func_93();
																	AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_2507, 2367.668f, 5098.645f, 46.8185f, 12f, 0, joaat("burrito"), 786599, 5f, 5f);
																	AI::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_2507, 19f, 786599);
							...
							case 5:
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									...
									case 1:
										if (AI::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], 242628503) == 7)
										{
							...
							case 6:
								if (AI::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], 993674639) == 7 && Local_755[iVar0 /*33*/].f_5 > 1)
								{
									Local_755[iVar0 /*33*/].f_5 = 0;
								}
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									case 0:
										...
										AI::TASK_ACHIEVE_HEADING(Local_755[iVar0 /*33*/], 219f, 1500);
										Local_755[iVar0 /*33*/].f_5++;
										break;
									
									case 1:
										if (AI::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], 1920390111) == 7)
										{
											AI::TASK_START_SCENARIO_IN_PLACE(Local_755[iVar0 /*33*/], "WORLD_HUMAN_GUARD_STAND_ARMY", 0, 0);
											Local_755[iVar0 /*33*/].f_5++;
										}
										break;
								}
							...
							case 32:
								if (!PED::IS_PED_INJURED(Local_755[iVar0 /*33*/]))
								{
									...
									{
										case 0:
											AI::TASK_START_SCENARIO_IN_PLACE(Local_755[iVar0 /*33*/], "WORLD_HUMAN_AA_SMOKE", Local_755[iVar0 /*33*/].f_14, 0);
											Local_755[iVar0 /*33*/].f_5++;
											break;
										...
										case 1:
											if (func_4(PLAYER::PLAYER_PED_ID(), Local_755[iVar0 /*33*/], 1) < 10f)
											{
												...
												Local_755[iVar0 /*33*/].f_5++;
												Local_755[iVar0 /*33*/].f_14 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 10000));
											}
											break;
										
										case 2:
											if (GAMEPLAY::GET_GAME_TIMER() > Local_755[iVar0 /*33*/].f_14)
											{
												Local_755[iVar0 /*33*/].f_5 = 1;
											}
											break;
										...
										case 10:
											...
											{
												Local_755[iVar0 /*33*/].f_5++;
												Local_755[iVar0 /*33*/].f_14 = GAMEPLAY::GET_GAME_TIMER() + 1000;
											}
											break;
										...
										case 11:
											if (GAMEPLAY::GET_GAME_TIMER() > Local_755[iVar0 /*33*/].f_14)
											{
												AI::TASK_TURN_PED_TO_FACE_COORD(Local_755[iVar0 /*33*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 5000);
												Local_755[iVar0 /*33*/].f_5++;
												Local_755[iVar0 /*33*/].f_14 = GAMEPLAY::GET_GAME_TIMER() + 5000;
											}
											break;
										...
										case 12:
											...
											{
												if (GAMEPLAY::GET_GAME_TIMER() > (Local_755[iVar0 /*33*/].f_14 - 3000))
												{
													AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_755[iVar0 /*33*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1f, 20000, 1048576000, 0, 1193033728);
													Local_755[iVar0 /*33*/].f_5 = 15;
												}
											}
											else if (GAMEPLAY::GET_GAME_TIMER() > Local_755[iVar0 /*33*/].f_14)
											{
										...
										case 13:
											...
											func_92(&(Local_755[iVar0 /*33*/]), 0);
											Local_755[iVar0 /*33*/].f_14 = GAMEPLAY::GET_GAME_TIMER() + 3000;
											Local_755[iVar0 /*33*/].f_5++;
											break;
										
										case 14:
											if (GAMEPLAY::GET_GAME_TIMER() > Local_755[iVar0 /*33*/].f_14 || AI::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], 242628503) == 7)
											{
												Local_755[iVar0 /*33*/].f_5 = 0;
											}
											break;
										...
										case 16:
											if (AI::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], 713668775) == 7)
											{
												Local_755[iVar0 /*33*/].f_14 = GAMEPLAY::GET_GAME_TIMER() + 3000;
								...
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									...
									case 1:
										if (GAMEPLAY::GET_GAME_TIMER() > Local_755[iVar0 /*33*/].f_14)
										{
											if (func_68(iLocal_2507))
											{
												AI::TASK_ENTER_VEHICLE(Local_755[iVar0 /*33*/], iLocal_2507, 20000, 1, 1f, 1, 0);
												Local_755[iVar0 /*33*/].f_5++;
												Local_755[iVar0 /*33*/].f_14 = 0;
												Local_755[iVar0 /*33*/].f_15 = 0;
											}
							...
							case 7:
								...
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									case 0:
										...
										{
											AI::TASK_SWAP_WEAPON(Local_755[iVar0 /*33*/], 0);
										}
										Local_755[iVar0 /*33*/].f_5++;
										break;
									...
									case 1:
										if (!WEAPON::GET_CURRENT_PED_WEAPON(Local_755[iVar0 /*33*/], &iVar4, 1))
										{
											...
											if (iVar0 == 1)
											{
												...
												{
													AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_755[2 /*33*/], 2000);
												}
											}
											else if (iVar0 == 2)
											{
												...
												{
													AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_755[1 /*33*/], 2000);
												}
											}
											else if (iVar0 == 6)
											{
												...
												{
													AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_755[7 /*33*/], 2000);
												}
											}
											else if (iVar0 == 7)
											{
												...
												{
													AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_755[6 /*33*/], 2000);
												}
											}
											if (Local_755[iVar0 /*33*/].f_14 != 0)
											{
												AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", Local_755[iVar0 /*33*/].f_14, 0);
											}
											else
											{
											...
											func_92(&(Local_755[iVar0 /*33*/]), 0);
											Local_755[iVar0 /*33*/].f_5++;
											Local_755[iVar0 /*33*/].f_15 = GAMEPLAY::GET_GAME_TIMER() + 15000;
										}
										break;
									
									case 2:
										if (AI::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], 242628503) == 7 || GAMEPLAY::GET_GAME_TIMER() > Local_755[iVar0 /*33*/].f_15)
										{
											AI::CLEAR_PED_TASKS(Local_755[iVar0 /*33*/]);
											Local_755[iVar0 /*33*/].f_5++;
										}
										break;
									...
									case 3:
										if (AI::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], 242628503) == 7)
										{
											...
											{
												AI::TASK_SWAP_WEAPON(Local_755[iVar0 /*33*/], 1);
												Local_755[iVar0 /*33*/].f_5++;
											}
											else
											{
									...
									case 4:
										if (AI::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], 716706914) == 7)
										{
											if (Local_755[iVar0 /*33*/].f_4 == 5)
											{
							...
							case 13:
								...
								{
									case 0:
										AI::TASK_START_SCENARIO_IN_PLACE(Local_755[iVar0 /*33*/], "WORLD_HUMAN_GUARD_STAND", 0, 0);
										PED::_0x2208438012482A1A(Local_755[iVar0 /*33*/], 0, 0);
										Local_755[iVar0 /*33*/].f_5++;
										break;
								}
							...
							case 14:
								...
								{
									case 0:
										AI::TASK_START_SCENARIO_IN_PLACE(Local_755[iVar0 /*33*/], "WORLD_HUMAN_AA_SMOKE", 0, 0);
										PED::_0x2208438012482A1A(Local_755[iVar0 /*33*/], 0, 0);
										Local_755[iVar0 /*33*/].f_5++;
										break;
									
									case 1:
										if (AI::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], 993674639) == 7)
										{
											Local_755[iVar0 /*33*/].f_5 = 0;
										}
										break;
							...
							case 15:
								...
								{
									case 0:
										AI::TASK_START_SCENARIO_IN_PLACE(Local_755[iVar0 /*33*/], "WORLD_HUMAN_BINOCULARS", 0, 0);
										PED::_0x2208438012482A1A(Local_755[iVar0 /*33*/], 0, 0);
										Local_755[iVar0 /*33*/].f_5++;
										break;
								}
							...
							case 16:
								...
								{
									case 0:
										AI::TASK_START_SCENARIO_IN_PLACE(Local_755[iVar0 /*33*/], "WORLD_HUMAN_DRINKING", 0, 0);
										PED::_0x2208438012482A1A(Local_755[iVar0 /*33*/], 0, 0);
										Local_755[iVar0 /*33*/].f_5++;
										break;
								}
							...
							case 17:
								...
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									...
									case 1:
										...
										{
											AI::TASK_START_SCENARIO_IN_PLACE(Local_755[iVar0 /*33*/], "WORLD_HUMAN_DRINKING", 0, 1);
											Local_755[iVar0 /*33*/].f_5++;
										}
										break;
									...
									case 2:
										...
										{
											AI::TASK_PLAY_ANIM(Local_755[iVar0 /*33*/], "misscarsteal2peeing", "peeing_loop", 8f, -8f, 25000, 1, 0, 0, 0, 0);
											Local_755[iVar0 /*33*/].f_5++;
											Local_755[iVar0 /*33*/].f_14 = GAMEPLAY::GET_GAME_TIMER() + 23000;
										}
										break;
							...
							case 25:
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									case 0:
										switch (Local_755[iVar0 /*33*/].f_2)
										{
											case 12:
												...
												{
													AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_755[iVar0 /*33*/], 2433.04f, 4967.87f, 46.28f, 0.8f, 0);
													Local_755[iVar0 /*33*/].f_5++;
												}
												break;
											...
											case 13:
												...
												{
													AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_755[iVar0 /*33*/], 2432.56f, 4968.38f, 46.27f, 0.8f, 0);
													Local_755[iVar0 /*33*/].f_5++;
												}
												break;
											...
											case 14:
												...
												{
													AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_755[iVar0 /*33*/], 2433.12f, 4965.59f, 46.27f, 0.8f, 0);
													Local_755[iVar0 /*33*/].f_5++;
												}
												break;
											...
											case 15:
												...
												{
													AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_755[iVar0 /*33*/], 2439.697f, 4960.996f, 46.28f, 0.4f, 0);
													Local_755[iVar0 /*33*/].f_5++;
												}
												break;
											...
											case 16:
												...
												{
													AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_755[iVar0 /*33*/], 2440.16f, 4962.99f, 46.27f, 0.4f, 0);
													Local_755[iVar0 /*33*/].f_5++;
												}
												break;
											...
											case 17:
												...
												{
													AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_755[iVar0 /*33*/], 2438.23f, 4962.25f, 46.27f, 0.4f, 0);
													Local_755[iVar0 /*33*/].f_5++;
												}
												break;
										}
									...
									case 1:
										if (AI::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], 1647992574) == 7)
										{
											Local_755[iVar0 /*33*/].f_5 = 0;
										}
										break;
							...
							case 28:
								...
								{
									case 0:
										if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_755[iVar0 /*33*/]) || (func_90(ENTITY::GET_ENTITY_COORDS(Local_755[iVar0 /*33*/], 1), 1f, 1120403456) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2448.583f, 4969.292f, 45.1856f, 2439.538f, 4978.061f, 46.82762f, 5.75f, 0, 1, 0)))
										{
											AI::TASK_HANDS_UP(Local_755[iVar0 /*33*/], 20000, 0, -1, 0);
									...
									case 3:
										if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_755[iVar0 /*33*/]) || (func_90(ENTITY::GET_ENTITY_COORDS(Local_755[iVar0 /*33*/], 1), 1f, 1120403456) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2448.583f, 4969.292f, 45.1856f, 2439.538f, 4978.061f, 46.82762f, 5.75f, 0, 1, 0)))
										{
											...
											{
												Local_755[iVar0 /*33*/].f_5++;
												Local_755[iVar0 /*33*/].f_14 = GAMEPLAY::GET_GAME_TIMER() + 2000;
											}
										}
										else
										{
									...
									case 4:
										if (GAMEPLAY::GET_GAME_TIMER() > Local_755[iVar0 /*33*/].f_14)
										{
											AI::TASK_SMART_FLEE_PED(Local_755[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 200f, 200000, 0, 0);
							...
							case 30:
									...
									if (Local_755[iVar0 /*33*/].f_5 < 8)
									{
										if (WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(Local_755[iVar0 /*33*/], 0, 2))
										{
											if (!WEAPON::HAS_PED_GOT_WEAPON(Local_755[iVar0 /*33*/], 0, 2))
											{
												...
												AI::TASK_COMBAT_PED(Local_755[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
												func_88();
								...
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									...
									case 1:
										if (STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze") && WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("weapon_sawnoffshotgun")))
										{
											if (!PED::IS_PED_INJURED(Local_755[iVar0 /*33*/]))
											{
												...
												AI::TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], uLocal_2875, "misschinese2_crystalmaze", "_cower_loop", 1000f, -8f, 0, 0, 1148846080, 0);
												if (!ENTITY::DOES_ENTITY_EXIST(uLocal_2878))
												{
													uLocal_2878 = WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_sawnoffshotgun"), 40, 2433.59f, 4969.7f, 42.1854f, 1, 1065353216, 0, 0, 1);
													ENTITY::SET_ENTITY_ROTATION(uLocal_2878, 90f, 0f, 0f, 2, 1);
												}
												AI::TASK_LOOK_AT_ENTITY(Local_755[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
												Local_755[iVar0 /*33*/].f_5++;
											}
										}
										break;
									...
									case 3:
										...
										AI::TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], uLocal_2874, "misschinese2_crystalmaze", "_cower_to_stand", 4f, -8f, 0, 0, 1148846080, 0);
										AI::TASK_LOOK_AT_ENTITY(Local_755[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
										Local_755[iVar0 /*33*/].f_5++;
										break;
									...
									case 4:
										...
										if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_2874) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_2874) > 0.98f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_2874))
										{
									...
									case 5:
										if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_2874) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_2874) > 0.98f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_2874))
										{
											...
											AI::TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], iLocal_2873, "misschinese2_crystalmaze", "_stand_loop", 4f, -8f, 0, 0, 1148846080, 0);
											Local_755[iVar0 /*33*/].f_5++;
											Local_755[iVar0 /*33*/].f_14 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 2000));
										}
										break;
									...
									case 6:
										if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_2876) || iLocal_2876 == 0)
										{
											if (GAMEPLAY::GET_GAME_TIMER() > Local_755[iVar0 /*33*/].f_14)
											{
												...
												{
													AI::TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], iLocal_2876, "misschinese2_crystalmaze", "_stand_loop_a", 4f, -8f, 0, 0, 1148846080, 0);
												}
												else
												{
													AI::TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], iLocal_2876, "misschinese2_crystalmaze", "_stand_loop_b", 4f, -8f, 0, 0, 1148846080, 0);
												}
											}
										}
									...
									case 8:
										uLocal_2877 = PED::CREATE_SYNCHRONIZED_SCENE(2435.312f, 4967.087f, 41.35f, 0f, 0f, 11.4f, 2);
										AI::TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], uLocal_2877, "misschinese2_crystalmaze", "_stand_to_aim", 4f, -8f, 0, 0, 1148846080, 0);
										WEAPON::GIVE_WEAPON_OBJECT_TO_PED(uLocal_2878, Local_755[iVar0 /*33*/]);
										Local_755[iVar0 /*33*/].f_5++;
										break;
									
									case 9:
										if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_2877) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_2877) > 0.98f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_2877))
										{
											PED::SET_PED_TARGET_LOSS_RESPONSE(Local_755[iVar0 /*33*/], 1);
											AI::CLEAR_PED_TASKS(Local_755[iVar0 /*33*/]);
											AI::TASK_AIM_GUN_AT_ENTITY(Local_755[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 1);
											Local_755[iVar0 /*33*/].f_5++;
										}
										break;
									...
									case 10:
										if (!func_59())
										{
											if (func_35("CHI2_DALEA", 4, Local_755[iVar0 /*33*/], "ONEIL", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
											{
												PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_755[iVar0 /*33*/], 0);
												AI::TASK_COMBAT_PED(Local_755[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
												Local_755[iVar0 /*33*/].f_14 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 4000));
												Local_755[iVar0 /*33*/].f_15 = 0;
												Local_755[iVar0 /*33*/].f_5++;
											}
										}
							...
							case 31:
								if (!PED::IS_PED_INJURED(Local_755[iVar0 /*33*/]))
								{
									if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_755[iVar0 /*33*/], 1), 2f, 1))
									{
										Local_755[iVar0 /*33*/].f_5 = 5;
									}
								}
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									...
									case 1:
										...
										{
											Local_755[iVar0 /*33*/].f_5++;
											Local_755[iVar0 /*33*/].f_14 = GAMEPLAY::GET_GAME_TIMER() + 1300;
										}
										break;
									...
									case 5:
										AI::TASK_SMART_FLEE_PED(Local_755[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 50f, 1000, 0, 0);
										Local_755[iVar0 /*33*/].f_5++;
										break;
							...
							case 27:
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									case 0:
										...
										PED::SET_PED_KEEP_TASK(Local_755[iVar0 /*33*/], 1);
										ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(Local_755[iVar0 /*33*/]));
										if (UI::DOES_BLIP_EXIST(Local_755[iVar0 /*33*/].f_19))
										{
											UI::REMOVE_BLIP(&(Local_755[iVar0 /*33*/].f_19));
										}
										Local_755[iVar0 /*33*/].f_5++;
										break;
								}
							...
							case 4:
								...
								if (Local_755[iVar0 /*33*/].f_2 == 8)
								{
									if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_755[iVar0 /*33*/].f_14))
									{
										if (Local_755[iVar0 /*33*/].f_5 == 0)
										{
											...
											{
												if (AI::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], 1785177548) == 1)
												{
								...
								{
									if (AI::GET_SCRIPT_TASK_STATUS(Local_755[iVar0 /*33*/], 2106541073) == 7)
									{
										func_99(iVar0, 7, 0, 0);
									}
								}
							...
							case 11:
								switch (Local_1619[iVar0 /*24*/].f_4)
								{
									case 1:
										...
										{
											Local_1619[iVar0 /*24*/].f_4 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_1614 * 4000);
											iLocal_1614++;
										}
									...
									default:
										if (GAMEPLAY::GET_GAME_TIMER() > Local_1619[iVar0 /*24*/].f_4)
										{
											PED::REMOVE_PED_DEFENSIVE_AREA(Local_755[iVar0 /*33*/], 0);
											PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_755[iVar0 /*33*/], 2451.677f, 4954.251f, 44.988f, 3f, 0, 0);
...
int func_90(vector3 vParam0, float fParam3, float fParam4)
{
	...
	{
		if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vParam0, fParam4, fParam4, fParam4, 0, 0, 0))
		{
			return 0;
		}
...
void func_92(var uParam0, bool bParam1)
{
	if (bParam1)
	{
		AI::SET_SEQUENCE_TO_REPEAT(uLocal_257, 1);
	}
	AI::CLOSE_SEQUENCE_TASK(uLocal_257);
	if (!PED::IS_PED_DEAD_OR_DYING(*uParam0, 1))
	{
		AI::TASK_PERFORM_SEQUENCE(*uParam0, uLocal_257);
	}
	AI::CLEAR_SEQUENCE_TASK(&uLocal_257);
}

void func_93()
{
	AI::OPEN_SEQUENCE_TASK(&uLocal_257);
}
...
void func_94(int iParam0)
{
	...
	{
		case 7:
			if (Local_755[iParam0 /*33*/].f_15 > 2000 && !GAMEPLAY::IS_BIT_SET(Local_755[iParam0 /*33*/].f_14, 0))
			{
				AI::TASK_LOOK_AT_COORD(Local_755[iParam0 /*33*/], 2505.634f, 4996.994f, 46.6624f, 4000, 0, 2);
				GAMEPLAY::SET_BIT(&(Local_755[iParam0 /*33*/].f_14), 0);
			}
			else if (Local_755[iParam0 /*33*/].f_15 > 8000 && !GAMEPLAY::IS_BIT_SET(Local_755[iParam0 /*33*/].f_14, 1))
			{
				AI::TASK_LOOK_AT_COORD(Local_755[iParam0 /*33*/], 2472.297f, 4962.687f, 47.2297f, 6000, 0, 2);
				GAMEPLAY::SET_BIT(&(Local_755[iParam0 /*33*/].f_14), 1);
			}
			break;
		
		case 5:
			if (Local_755[iParam0 /*33*/].f_15 > 3000 && !GAMEPLAY::IS_BIT_SET(Local_755[iParam0 /*33*/].f_14, 0))
			{
				if (!PED::IS_PED_INJURED(Local_755[6 /*33*/]))
				{
					AI::TASK_LOOK_AT_ENTITY(Local_755[iParam0 /*33*/], Local_755[6 /*33*/], 4000, 0, 2);
					GAMEPLAY::SET_BIT(&(Local_755[iParam0 /*33*/].f_14), 0);
				}
			}
			else if (Local_755[iParam0 /*33*/].f_15 > 11000 && !GAMEPLAY::IS_BIT_SET(Local_755[iParam0 /*33*/].f_14, 1))
			{
				AI::TASK_LOOK_AT_COORD(Local_755[iParam0 /*33*/], 2494.634f, 5001.994f, 46.6624f, 7000, 0, 2);
				GAMEPLAY::SET_BIT(&(Local_755[iParam0 /*33*/].f_14), 1);
			}
			else if (Local_755[iParam0 /*33*/].f_15 > 20000 && !GAMEPLAY::IS_BIT_SET(Local_755[iParam0 /*33*/].f_14, 2))
			{
				AI::TASK_LOOK_AT_COORD(Local_755[iParam0 /*33*/], 2477.634f, 4966.994f, 46.6624f, 7000, 0, 2);
				GAMEPLAY::SET_BIT(&(Local_755[iParam0 /*33*/].f_14), 2);
			}
			break;
		...
		case 4:
			if (Local_755[iParam0 /*33*/].f_15 > 3000 && !GAMEPLAY::IS_BIT_SET(Local_755[iParam0 /*33*/].f_14, 0))
			{
				AI::TASK_LOOK_AT_COORD(Local_755[iParam0 /*33*/], 2505.634f, 4996.994f, 46.6624f, 5000, 0, 2);
				GAMEPLAY::SET_BIT(&(Local_755[iParam0 /*33*/].f_14), 0);
			}
			else if (Local_755[iParam0 /*33*/].f_15 > 10000 && !GAMEPLAY::IS_BIT_SET(Local_755[iParam0 /*33*/].f_14, 1))
			{
				AI::TASK_LOOK_AT_COORD(Local_755[iParam0 /*33*/], 2461.449f, 4977.48f, 51.7483f, 6000, 0, 2);
				GAMEPLAY::SET_BIT(&(Local_755[iParam0 /*33*/].f_14), 1);
			}
			else if (Local_755[iParam0 /*33*/].f_15 > 18000 && !GAMEPLAY::IS_BIT_SET(Local_755[iParam0 /*33*/].f_14, 2))
			{
				AI::TASK_LOOK_AT_COORD(Local_755[iParam0 /*33*/], 2505.634f, 4996.994f, 46.6624f, 6000, 0, 2);
				GAMEPLAY::SET_BIT(&(Local_755[iParam0 /*33*/].f_14), 2);
			}
			break;
	}
...
int func_101(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8)
{
	...
	{
		case 0:
			Local_755[iParam0 /*33*/] = PED::CREATE_PED(26, joaat("a_m_m_hillbilly_01"), vParam2, fParam5, 1, 1);
		...
		case 1:
			Local_755[iParam0 /*33*/] = PED::CREATE_PED(26, joaat("a_m_m_hillbilly_02"), vParam2, fParam5, 1, 1);
			PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_755[iParam0 /*33*/]);
		...
		case 2:
			Local_755[iParam0 /*33*/] = PED::CREATE_PED(26, joaat("a_m_y_methhead_01"), vParam2, fParam5, 1, 1);
			PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_755[iParam0 /*33*/]);
			PED::SET_PED_COMPONENT_VARIATION(Local_755[iParam0 /*33*/], 0, 0, 1, 0);
	...
	if (Local_755[iParam0 /*33*/].f_1 == 5)
	{
		...
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[iParam0 /*33*/], uLocal_1617);
	}
	else
	{
...
int func_105(char* sParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, char* sParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, char* sParam12, int iParam13)
{
	...
	if (!func_53())
	{
		if (!UI::IS_MESSAGE_BEING_DISPLAYED())
		{
			...
			else if (iLocal_255 != GAMEPLAY::GET_GAME_TIMER())
			{
				iLocal_256++;
							...
							switch ((uParam0[iVar0 /*24*/])->f_4)
							{
								case 0:
									...
									if (!PED::IS_PED_USING_SCENARIO((*uParam0)[iVar0 /*24*/], "PROP_HUMAN_SEAT_CHAIR") && !PED::IS_PED_USING_SCENARIO((*uParam0)[iVar0 /*24*/], "PROP_HUMAN_SEAT_ARMCHAIR"))
									{
										...
										{
											uVar2 = PED::GET_VEHICLE_PED_IS_USING((*uParam0)[iVar0 /*24*/]);
											if (VEHICLE::IS_VEHICLE_DRIVEABLE(uVar2, 0))
											{
												if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uVar2))
												{
													vVar3 = { ENTITY::GET_ENTITY_VELOCITY(uVar2) };
													VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(uVar2);
													ENTITY::SET_ENTITY_VELOCITY(uVar2, vVar3);
													...
													switch ((uParam0[iVar0 /*24*/])->f_5)
													{
														...
														case 1:
															if (GAMEPLAY::GET_GAME_TIMER() > (uParam0[iVar0 /*24*/])->f_11)
															{
																func_93();
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
																AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "react_forward_small_intro_a", 4f, -4f, -1, 0, 0, 0, 0, 0);
														...
														case 2:
															if (GAMEPLAY::GET_GAME_TIMER() > (uParam0[iVar0 /*24*/])->f_11)
															{
																func_93();
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
																AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "react_left_small_intro_a", 4f, -4f, -1, 0, 0, 0, 0, 0);
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 0);
																func_92(uParam0[iVar0 /*24*/], 0);
																(uParam0[iVar0 /*24*/])->f_4++;
															}
														...
														case 3:
															if (GAMEPLAY::GET_GAME_TIMER() > (uParam0[iVar0 /*24*/])->f_11)
															{
																func_93();
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
																AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "react_right_small_intro_a", 4f, -4f, -1, 0, 0, 0, 0, 0);
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 0);
																func_92(uParam0[iVar0 /*24*/], 0);
																(uParam0[iVar0 /*24*/])->f_4++;
															}
														...
														case 4:
															if (GAMEPLAY::GET_GAME_TIMER() > (uParam0[iVar0 /*24*/])->f_11)
															{
																func_93();
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
																AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "react_backward_small_intro_a", 4f, -4f, -1, 0, 0, 0, 0, 0);
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 0);
																func_92(uParam0[iVar0 /*24*/], 0);
																(uParam0[iVar0 /*24*/])->f_4++;
															}
												...
												case 7:
													...
													switch ((uParam0[iVar0 /*24*/])->f_5)
													{
														case 0:
															...
															{
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
																AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "buddy_shot_b", 4f, -4f, -1, 0, 0, 0, 0, 0);
																AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 0);
															}
															else
															{
														...
														case 1:
															...
															AI::TASK_COMBAT_HATED_TARGETS_AROUND_PED(0, 200f, 0);
															func_92(uParam0[iVar0 /*24*/], 0);
															(uParam0[iVar0 /*24*/])->f_5 = (GAMEPLAY::GET_GAME_TIMER() + iVar6);
															break;
													...
													if (!PED::IS_PED_IN_ANY_VEHICLE((*uParam0)[iVar0 /*24*/], 1))
													{
														switch ((uParam0[iVar0 /*24*/])->f_5)
														{
															case 0:
																...
																AI::TASK_PLAY_ANIM((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "alert_gunshot", 4f, -4f, -1, 8, 0, 0, 0, 0);
																(uParam0[iVar0 /*24*/])->f_5 = 3;
																break;
															
															case 1:
																PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS((*uParam0)[iVar0 /*24*/], 1);
																AI::TASK_PLAY_ANIM((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "buddy_shot_b", 4f, -4f, -1, 8, 0, 0, 0, 0);
																WEAPON::SET_CURRENT_PED_WEAPON((*uParam0)[iVar0 /*24*/], WEAPON::GET_BEST_PED_WEAPON((*uParam0)[iVar0 /*24*/], 0), 1);
																(uParam0[iVar0 /*24*/])->f_5 = 3;
																break;
															...
															case 3:
																if (ENTITY::IS_ENTITY_PLAYING_ANIM((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "alert_gunshot", 3))
																{
																	if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "alert_gunshot") > 0.95f)
																	{
																		...
																		{
																			AI::TASK_PLAY_ANIM((*uParam0)[iVar0 /*24*/], "reaction@male_stand@big_variations@b", "react_big_variations_d", 4f, -2f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(4000, 6000), 8, 0, 0, 0, 0);
																...
																if (ENTITY::IS_ENTITY_PLAYING_ANIM((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "buddy_shot_b", 3))
																{
																	if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "buddy_shot_b") > 0.95f)
																	{
																		...
																		{
																			AI::TASK_PLAY_ANIM((*uParam0)[iVar0 /*24*/], "reaction@male_stand@big_variations@b", "react_big_variations_e", 4f, -2f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(4000, 6000), 8, 0, 0, 0, 0);
																			(uParam0[iVar0 /*24*/])->f_5 = 6;
																		}
																	}
																}
															...
															case 4:
																...
																{
																	AI::TASK_PLAY_ANIM((*uParam0)[iVar0 /*24*/], "reaction@male_stand@big_variations@b", "react_big_variations_d", 4f, -2f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(6000, 9000), 8, 0, 0, 0, 0);
																	(uParam0[iVar0 /*24*/])->f_5 = 6;
																}
																break;
															...
															case 5:
																if (GAMEPLAY::ABSF((ENTITY::GET_ENTITY_HEADING((*uParam0)[iVar0 /*24*/]) - (uParam0[iVar0 /*24*/])->f_18)) < 10f)
																{
																	AI::TASK_PLAY_ANIM((*uParam0)[iVar0 /*24*/], "reaction@male_stand@big_variations@b", "react_big_variations_f", 4f, -2f, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(6000, 9000), 8, 0, 0, 0, 0);
																	(uParam0[iVar0 /*24*/])->f_5 = 6;
																}
																break;
													...
													switch ((uParam0[iVar0 /*24*/])->f_5)
													{
														case 0:
															if (iLocal_65 == 0)
															{
																if (!PED::IS_PED_IN_ANY_VEHICLE((*uParam0)[iVar0 /*24*/], 1))
																{
																	vVar7 = { ENTITY::GET_ENTITY_COORDS((*uParam0)[iVar0 /*24*/], 1) };
																	vVar10 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
																	fVar13 = GAMEPLAY::ATAN(((vVar10.z - vVar7.z) / func_4((*uParam0)[iVar0 /*24*/], PLAYER::PLAYER_PED_ID(), 0)));
																	if (fVar13 > 20f)
																	{
																		(uParam0[iVar0 /*24*/])->f_5 = 1;
																	}
														...
														case 1:
															...
															AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "spot_high", 4f, -8f, -1, 0, 0, 0, 0, 0);
															AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 0);
															func_92(uParam0[iVar0 /*24*/], 0);
															(uParam0[iVar0 /*24*/])->f_5 = 4;
															break;
														...
														case 2:
															...
															AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
															AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1000);
															AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "spot_low", 4f, -8f, -1, 0, 0, 0, 0, 0);
															AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 0);
															func_92(uParam0[iVar0 /*24*/], 0);
															(uParam0[iVar0 /*24*/])->f_5 = 4;
															break;
														...
														case 3:
															...
															AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
															AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1000);
															AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "spot_mid", 4f, -8f, -1, 0, 0, 0, 0, 0);
															AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 0);
															func_92(uParam0[iVar0 /*24*/], 0);
															(uParam0[iVar0 /*24*/])->f_5 = 4;
															break;
...
int func_109(int iParam0, var uParam1, char* sParam2, vector3 vParam3, vector3 vParam6, vector3 vParam9, bool bParam12)
{
	switch ((uParam1[iParam0 /*24*/])->f_5)
	{
		...
		case 1:
			...
			{
				AI::TASK_TURN_PED_TO_FACE_COORD((*uParam1)[iParam0 /*24*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 5000);
				(uParam1[iParam0 /*24*/])->f_5++;
		...
		case 2:
			if (!GAMEPLAY::ARE_STRINGS_EQUAL("chi2_hear", vParam3.y))
			{
				if ((PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), (*uParam1)[iParam0 /*24*/]) || iLocal_75 == 1) && func_67((*uParam1)[iParam0 /*24*/], (uParam1[iParam0 /*24*/])->f_12, 1) < (uParam1[iParam0 /*24*/])->f_19)
				{
					...
					{
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD((*uParam1)[iParam0 /*24*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1f, 20000, 0.1f, 0, 1193033728);
...
int func_112()
{
	...
	iVar1 = -1;
	AI::TASK_PLAY_ANIM(0, "misschinese2_bank1", "reaction_forward_big_intro_a", 4f, -2f, 1400, 0, 0, 0, 0, 0);
	iVar0 = 0;
	while (iVar0 <= 3)
	{
		...
		switch (iVar2)
		{
			case 0:
				...
				{
					case 0:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@left", "reaction_left_big_intro_a", 4f, -2f, iVar3, 0, 0, 0, 0, 0);
						break;
					
					case 1:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@left", "reaction_left_big_intro_b", 4f, -2f, iVar3, 0, 0, 0, 0, 0);
						break;
					
					case 2:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@left", "reaction_left_big_intro_c", 4f, -2f, iVar3, 0, 0, 0, 0, 0);
						break;
				}
				break;
			...
			case 1:
				...
				{
					case 0:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@right", "reaction_right_big_intro_a", 4f, -2f, iVar3, 0, 0, 0, 0, 0);
						break;
					
					case 1:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@right", "reaction_right_big_intro_b", 4f, -2f, iVar3, 0, 0, 0, 0, 0);
						break;
					
					case 2:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@right", "reaction_right_big_intro_c", 4f, -2f, iVar3, 0, 0, 0, 0, 0);
						break;
				}
				break;
			...
			case 2:
				...
				{
					case 0:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@backward", "reaction_backward_big_intro_a", 4f, -2f, iVar3, 0, 0, 0, 0, 0);
						break;
					
					case 1:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@backward", "reaction_backward_big_intro_b", 4f, -2f, iVar3, 0, 0, 0, 0, 0);
						break;
					
					case 2:
						AI::TASK_PLAY_ANIM(0, "reaction@male_stand@big_intro@backward", "reaction_backward_big_intro_c", 4f, -2f, iVar3, 0, 0, 0, 0, 0);
						break;
				}
				break;
		}
...
float func_113(var uParam0, var uParam1)
{
	...
	{
		return func_114(uParam0, ENTITY::GET_ENTITY_COORDS(uParam1, 0));
	}
	return 0f;
}
...
float func_114(var uParam0, vector3 vParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
		{
			fVar0 = func_96(ENTITY::GET_ENTITY_COORDS(uParam0, 0), vParam1, 1);
			return (fVar0 - ENTITY::GET_ENTITY_HEADING(uParam0));
		}
	}
	return 0f;
}
...
void func_115(var uParam0, struct<2> Param1, var uParam3, struct<2> Param4, var uParam6, struct<2> Param7, var uParam9, struct<2> Param10, var uParam12)
{
								...
								if ((uParam0[iVar0 /*24*/])->f_3 <= 4)
								{
									if (func_4((*uParam0)[iVar0 /*24*/], (*uParam0)[iLocal_58 /*24*/], 1) < 8f)
									{
										if ((INTERIOR::GET_INTERIOR_FROM_ENTITY((*uParam0)[iLocal_58 /*24*/]) != 0 && INTERIOR::GET_INTERIOR_FROM_ENTITY((*uParam0)[iVar0 /*24*/]) != 0) || (INTERIOR::GET_INTERIOR_FROM_ENTITY((*uParam0)[iLocal_58 /*24*/]) == 0 && INTERIOR::GET_INTERIOR_FROM_ENTITY((*uParam0)[iVar0 /*24*/]) == 0))
										{
											...
											vVar6 = { ENTITY::GET_ENTITY_COORDS((*uParam0)[iLocal_58 /*24*/], 0) };
											if (GAMEPLAY::ABSF((vVar3.z - vVar6.z)) < 2f)
											{
	...
	{
		uVar13 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(uVar13, 0))
		{
			if (VEHICLE::GET_IS_VEHICLE_ENGINE_RUNNING(uVar13))
			{
				iVar14 = 1;
			}
		}
	}
	if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, vLocal_71, uLocal_74))
	{
		bLocal_54 = true;
	}
	if (!iLocal_55)
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		uVar17 = PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID());
	}
	if (iLocal_62 == -1)
	{
		iLocal_75 = 0;
		...
		if (!PED::IS_PED_DEAD_OR_DYING((*uParam0)[iVar0 /*24*/], 1))
		{
			if ((uParam0[iVar0 /*24*/])->f_3 != 7)
			{
				...
				if ((uParam0[iVar0 /*24*/])->f_3 <= 4)
				{
					if (iLocal_62 == -1)
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(uVar17, 0))
						{
							if (VEHICLE::GET_IS_VEHICLE_ENGINE_RUNNING(uVar17))
							{
								iLocal_75 = 1;
								fVar16 = 20f;
							}
							if (VEHICLE::IS_VEHICLE_SIREN_ON(uVar17))
							{
								iLocal_75 = 1;
								fVar16 = 50f;
							}
						}
						if (PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), (*uParam0)[iVar0 /*24*/]) || (VEHICLE::IS_VEHICLE_DRIVEABLE(uVar17, 0) && VEHICLE::GET_IS_VEHICLE_ENGINE_RUNNING(uVar17)))
						{
					...
					if (!bLocal_258 && !PED::IS_PED_RAGDOLL((*uParam0)[iVar0 /*24*/]))
					{
						...
						{
							if (GAMEPLAY::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS((*uParam0)[iVar0 /*24*/], 1), 4f, 1, 1))
							{
								(uParam0[iVar0 /*24*/])->f_1 = 7;
							}
						}
						else if (GAMEPLAY::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS((*uParam0)[iVar0 /*24*/], 1), 6f, 1, 1))
						{
							(uParam0[iVar0 /*24*/])->f_1 = 7;
						}
						...
						if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS((*uParam0)[iVar0 /*24*/], 1), 1f, 1))
						{
							(uParam0[iVar0 /*24*/])->f_1 = 7;
						}
					}
...
void func_117()
{
	if (iLocal_3491)
	{
		if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&vLocal_3498))
		{
			if (func_59())
			{
				if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
				{
					if (!UI::IS_MESSAGE_BEING_DISPLAYED())
					{
						...
						if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&cLocal_3492) && !GAMEPLAY::ARE_STRINGS_EQUAL(&cLocal_3492, "NULL"))
						{
							vLocal_3498 = { func_83() };
							func_85();
						}
...
void func_120()
{
	...
	if (iLocal_437 == 0)
	{
		if (FIRE::GET_CLOSEST_FIRE_POS(&vVar1, Local_444[0 /*5*/]))
		{
			...
			while (iVar0 < Local_444)
			{
				if (iVar0 > 0)
				{
					fVar4 = (fVar4 + GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Local_444[(iVar0 - 1) /*5*/], Local_444[iVar0 /*5*/], 1));
				}
				if (Local_444[iVar0 /*5*/].f_4)
				{
					if (FIRE::GET_CLOSEST_FIRE_POS(&vVar1, Local_444[iVar0 /*5*/]))
					{
						fVar6 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Local_444[iVar0 /*5*/], vVar1, 1);
						if (fVar6 < fVar7)
						{
							fVar7 = fVar6;
							fVar8 = fVar4;
			...
			if (fVar7 < fLocal_272)
			{
				iVar5 = iVar5;
				iLocal_437 = 1;
				iLocal_439 = GAMEPLAY::GET_GAME_TIMER();
				fVar8 = fVar8;
	...
	if (iLocal_437 == 1)
	{
		...
		fVar9 = (SYSTEM::TO_FLOAT((GAMEPLAY::GET_GAME_TIMER() - iLocal_439)) / fLocal_750);
		...
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - Local_281[iVar0 /*5*/].f_4) > 1000)
			{
				GRAPHICS::FADE_DECALS_IN_RANGE(Local_281[iVar0 /*5*/].f_1, 0.4f, 1f);
			}
			if ((GAMEPLAY::GET_GAME_TIMER() - Local_281[iVar0 /*5*/].f_4) > 6000)
			{
...
void func_122(vector3 vParam0, int iParam3)
{
	...
	Local_281[iLocal_441 /*5*/].f_4 = GAMEPLAY::GET_GAME_TIMER();
	Local_281[iLocal_441 /*5*/].f_1 = { vParam0 };
	Local_281[iLocal_441 /*5*/] = FIRE::START_SCRIPT_FIRE(vParam0, uLocal_270, iParam3);
	iLocal_441++;
	if (iLocal_441 >= 31)
	{
		iLocal_441 = 0;
		...
		if (iVar1 == joaat("weapon_petrolcan"))
		{
			if (CONTROLS::IS_CONTROL_PRESSED(0, 24) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
			{
				if (iLocal_271 == 0)
				{
					...
					iLocal_271 = GAMEPLAY::GET_GAME_TIMER() + 250;
				}
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_271)
				{
					if (!bLocal_261)
					{
						fVar4 = 9999.9f;
						...
						while (iVar0 < Local_444)
						{
							if (UI::DOES_BLIP_EXIST(Local_444[iVar0 /*5*/].f_3))
							{
								fVar2 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_274, UI::GET_BLIP_COORDS(Local_444[iVar0 /*5*/].f_3), 1);
								fVar3 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Local_444[iVar0 /*5*/], UI::GET_BLIP_COORDS(Local_444[iVar0 /*5*/].f_3), 1);
						...
						if (fVar4 < 2f)
						{
							if (iLocal_267 != -1)
							{
								if (GAMEPLAY::ABSI((iLocal_268 - iVar5)) > 1)
								{
									iLocal_268 = -1;
								}
								if (iLocal_268 == -1)
								...
								if (GAMEPLAY::ABSI((iLocal_268 - iVar5)) < 3 && GAMEPLAY::ABSI((iLocal_268 - iVar5)) > 0)
								{
									if (iLocal_268 < iVar5)
									{
										iVar6 = iLocal_268;
										while (iVar6 <= (iVar5 - 1))
										{
											if (UI::DOES_BLIP_EXIST(Local_444[iVar6 /*5*/].f_3))
											{
												if (UI::GET_BLIP_ALPHA(Local_444[iVar6 /*5*/].f_3) > 0)
												{
													UI::SET_BLIP_ALPHA(Local_444[iVar6 /*5*/].f_3, 0);
								...
								if (iVar5 == 0)
								{
									if (UI::DOES_BLIP_EXIST(Local_444[iVar5 /*5*/].f_3))
									{
										if (UI::GET_BLIP_ALPHA(Local_444[iVar5 /*5*/].f_3) > 0)
										{
											UI::SET_BLIP_ALPHA(Local_444[iVar5 /*5*/].f_3, 0);
...
Vector3 func_124()
{
	...
	uVar0 = WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(PLAYER::PLAYER_PED_ID());
	if (ENTITY::DOES_ENTITY_EXIST(uVar0))
	{
		iVar1 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(uVar0, "Gun_Nuzzle");
		iVar1 = 1;
		vVar2 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(uVar0, iVar1) };
		vVar2 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vVar2, ENTITY::GET_ENTITY_HEADING(uVar0), 0.35f, 0f, -0.15f) };
		GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vVar2, &uVar8, 0, 0);
...
void func_130(char* sParam0)
{
	...
	if (GAMEPLAY::IS_STRING_NULL(sLocal_2513))
	{
		sLocal_2513 = "CHFAIL";
	}
		...
		if (func_152(iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1, 0))
		{
			switch (Local_3337[iParam0 /*4*/])
			{
				...
				case 11:
					switch (Local_3337[iParam0 /*4*/].f_2)
					{
						case 0:
							...
							{
								Local_3337[iParam0 /*4*/].f_3 = GAMEPLAY::GET_GAME_TIMER() + 1000;
								Local_3337[iParam0 /*4*/].f_2++;
							}
							break;
						
						case 1:
							if (GAMEPLAY::GET_GAME_TIMER() > Local_3337[iParam0 /*4*/].f_3)
							{
								if (CONTROLS::_IS_INPUT_DISABLED(0))
								{
				...
				case 6:
					switch (Local_3337[iParam0 /*4*/].f_2)
					{
						case 0:
							...
							{
								Local_3337[iParam0 /*4*/].f_3 = GAMEPLAY::GET_GAME_TIMER() + 4000;
								Local_3337[iParam0 /*4*/].f_2++;
							}
							break;
				...
				case 7:
					...
					UI::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_2677, "FRMBLIPB");
					Local_3337[iParam0 /*4*/].f_1 = 1;
					break;
		...
		if (func_152(iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9))
		{
			...
			switch (Local_3358[iParam0 /*7*/])
			{
				...
				case 2:
					...
					{
						case 0:
							Local_3358[iParam0 /*7*/].f_4 = GAMEPLAY::GET_GAME_TIMER() + 2000;
							Local_3358[iParam0 /*7*/].f_3++;
							break;
						
						case 1:
							if (GAMEPLAY::GET_GAME_TIMER() > Local_3358[iParam0 /*7*/].f_4)
							{
								if (func_59())
								{
									Local_3358[iParam0 /*7*/].f_4 = GAMEPLAY::GET_GAME_TIMER() + 2000;
								...
								else
								{
									...
									if (func_159(&iVar0, 2, 1))
									{
										...
										{
											Local_3358[iParam0 /*7*/].f_4 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(8000, 14000));
										}
									}
									else
									{
				...
				case 9:
					switch (Local_3358[iParam0 /*7*/].f_3)
					{
						case 0:
							if (!PED::IS_PED_INJURED(Local_755[Local_3358[iParam0 /*7*/].f_4 /*33*/]))
							{
								Local_3358[iParam0 /*7*/].f_3 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 3);
							}
							break;
						...
						case 1:
							if (!PED::IS_PED_INJURED(Local_755[Local_3358[iParam0 /*7*/].f_5 /*33*/]))
							{
								if (Local_3358[iParam0 /*7*/].f_6 < 3)
								{
									...
									{
										Local_3358[iParam0 /*7*/].f_4 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(7000, 12000));
							...
							if (!PED::IS_PED_INJURED(Local_755[Local_3358[iParam0 /*7*/].f_5 /*33*/]))
							{
								switch (Local_3358[iParam0 /*7*/].f_6)
								{
									...
									case 9:
										...
										{
											Local_3358[iParam0 /*7*/].f_4 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(6000, 10000));
											Local_3358[iParam0 /*7*/].f_6++;
											Local_3358[iParam0 /*7*/].f_3 = 0;
										}
										break;
				...
				case 20:
					...
					{
						case 0:
							if (GAMEPLAY::GET_GAME_TIMER() > Local_3358[iParam0 /*7*/].f_5)
							{
								fVar4 = 999f;
						...
						case 1:
							...
							{
								Local_3358[iParam0 /*7*/].f_5 = GAMEPLAY::GET_GAME_TIMER() + 6000;
								Local_3358[iParam0 /*7*/].f_3 = 0;
							}
							break;
					}
					...
					switch (Local_3358[iParam0 /*7*/].f_3)
					{
						...
						case 2:
							if (Local_3358[iParam0 /*7*/].f_5 < 14)
							{
								...
								{
									Local_3358[iParam0 /*7*/].f_3 = 1;
									Local_3358[iParam0 /*7*/].f_4 = (12000 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 5000));
		...
		if (bVar0 == 1)
		{
			...
			switch (Local_2917[iParam0 /*10*/])
			{
				...
				case 7:
					if ((!PED::IS_PED_INJURED(Local_755[12 /*33*/]) && !PED::IS_PED_INJURED(Local_755[13 /*33*/])) && !PED::IS_PED_INJURED(Local_755[14 /*33*/]))
					{
						if (func_169(6, 6) < 2)
						{
							...
							{
								if (AI::GET_SCRIPT_TASK_STATUS(Local_755[12 /*33*/], 150319005) == 7)
								{
									AI::TASK_LOOK_AT_ENTITY(Local_755[13 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
									AI::TASK_LOOK_AT_ENTITY(Local_755[14 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
									AI::TASK_LOOK_AT_ENTITY(Local_755[12 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
								}
							}
						}
					}
				...
				case 8:
					...
					if (fVar1 < 900f)
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							...
							{
								if (VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(uVar4)) || VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(uVar4)))
								{
									fVar2 = (900f - fVar1);
									if (fVar2 < 0f)
									{
									...
									fVar2 = (fVar2 / 900f);
									fVar2 = (fVar2 * 10000f);
									fVar3 = ENTITY::GET_ENTITY_SPEED(uVar4);
									fVar2 = (fVar2 * (fVar3 / 35f));
									if (fVar3 > 35f)
									{
										ENTITY::APPLY_FORCE_TO_ENTITY_CENTER_OF_MASS(uVar4, 1, 0f, -fVar2, 0f, 0, 1, 0, 0);
									}
								}
							}
						}
					...
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						case 0:
							if ((!PED::IS_PED_INJURED(Local_755[12 /*33*/]) && !PED::IS_PED_INJURED(Local_755[13 /*33*/])) && !PED::IS_PED_INJURED(Local_755[14 /*33*/]))
							{
								...
								PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[13 /*33*/], uLocal_2636);
								PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[14 /*33*/], uLocal_2636);
				...
				case 11:
					...
					{
						case 1:
							if (GAMEPLAY::GET_GAME_TIMER() > Local_2917[iParam0 /*10*/].f_7)
							{
								if (INTERIOR::IS_VALID_INTERIOR(INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())))
								{
									FIRE::ADD_EXPLOSION(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) + Vector(0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 4f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 4f)), 16, 1.5f, 1, 0, 1065353216, 0);
									Local_2917[iParam0 /*10*/].f_9 = (Local_2917[iParam0 /*10*/].f_9 - 1f);
									Local_2917[iParam0 /*10*/].f_7 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 520));
								}
								else
								{
									Local_2917[iParam0 /*10*/].f_6 = 2;
						...
						default:
							...
							{
								if (!GAMEPLAY::IS_BIT_SET(Local_2917[iParam0 /*10*/].f_7, iVar5))
								{
									if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, vLocal_2889[iVar5 /*3*/], 5f))
									{
										GAMEPLAY::SET_BIT(&(Local_2917[iParam0 /*10*/].f_7), iVar5);
										if (Local_2917[iParam0 /*10*/].f_6 == 0)
										{
											Local_2917[iParam0 /*10*/].f_6 = GAMEPLAY::GET_GAME_TIMER() + 1500;
										}
									}
								}
								iVar5++;
							}
							if (GAMEPLAY::GET_GAME_TIMER() > Local_2917[iParam0 /*10*/].f_8)
							{
								Local_2917[iParam0 /*10*/].f_8 = 0;
								iVar5 = 0;
								while (iVar5 < vLocal_2889.x)
								{
									if (!GAMEPLAY::IS_BIT_SET(Local_2917[iParam0 /*10*/].f_7, iVar5 + 9) && GAMEPLAY::IS_BIT_SET(Local_2917[iParam0 /*10*/].f_7, iVar5))
									{
										FIRE::ADD_EXPLOSION(vLocal_2889[iVar5 /*3*/], 16, 1.5f, 1, 0, 1065353216, 0);
										GAMEPLAY::SET_BIT(&(Local_2917[iParam0 /*10*/].f_7), iVar5 + 9);
										iVar5 = 8;
										Local_2917[iParam0 /*10*/].f_8 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(150, 320));
									}
									iVar5++;
								}
							}
							if (Local_2917[iParam0 /*10*/].f_6 != 0)
							{
								if (GAMEPLAY::GET_GAME_TIMER() > Local_2917[iParam0 /*10*/].f_6)
								{
									Local_2917[iParam0 /*10*/].f_6 = 1;
									Local_2917[iParam0 /*10*/].f_7 = GAMEPLAY::GET_GAME_TIMER() + 300;
						...
						case 4:
							if (func_68(iLocal_2506))
							{
								if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_2506, 0))
								{
									if (VEHICLE::GET_IS_VEHICLE_ENGINE_RUNNING(iLocal_2506))
									{
										Local_2917[iParam0 /*10*/].f_7 = (Local_2917[iParam0 /*10*/].f_7 + GAMEPLAY::GET_GAME_TIMER() + 7000);
										Local_2917[iParam0 /*10*/].f_6++;
									}
								}
							}
							...
							if (func_68(iLocal_2506))
							{
								if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_2506, 0))
								{
									if (GAMEPLAY::GET_GAME_TIMER() > Local_2917[iParam0 /*10*/].f_7)
									{
										...
										{
											Local_2917[iParam0 /*10*/].f_7 = GAMEPLAY::GET_GAME_TIMER() + 5000;
										}
									}
								}
							}
					...
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						...
						case 1:
							if (PED::IS_PED_INJURED(Local_755[23 /*33*/]))
							{
								if (ENTITY::DOES_ENTITY_EXIST(uLocal_2878))
								{
									ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_2878);
						...
						if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_755[11 /*33*/]))
						{
							if (GAMEPLAY::GET_GAME_TIMER() > Local_2917[iParam0 /*10*/].f_7)
							{
								if (!PED::IS_PED_INJURED(Local_755[11 /*33*/]))
								{
									...
									Local_2917[iParam0 /*10*/].f_7 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3500, 5000));
								}
							}
						}
					}
				...
				case 41:
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						...
						case 1:
							if ((STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze") && STREAMING::HAS_MODEL_LOADED(joaat("ig_taocheng"))) && STREAMING::HAS_MODEL_LOADED(joaat("ig_taostranslator")))
							{
								if (!ENTITY::DOES_ENTITY_EXIST(Local_755[11 /*33*/]))
								{
									...
									PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[11 /*33*/], uLocal_1618);
								...
								if (!ENTITY::DOES_ENTITY_EXIST(Local_755[10 /*33*/]))
								{
									...
									PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[10 /*33*/], uLocal_1618);
									PED::SET_PED_CAN_BE_TARGETTED(Local_755[10 /*33*/], 0);
									PED::SET_PED_PROP_INDEX(Local_755[10 /*33*/], 1, 0, 1, 0);
								}
								...
								if (!PED::IS_PED_INJURED(Local_755[11 /*33*/]))
								{
									...
									AI::TASK_SYNCHRONIZED_SCENE(Local_755[11 /*33*/], Local_2917[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_A_TaoCheng", 1000f, -4f, 257, 16, 1148846080, 0);
								}
								if (!PED::IS_PED_INJURED(Local_755[10 /*33*/]))
								{
									...
									AI::TASK_SYNCHRONIZED_SCENE(Local_755[10 /*33*/], Local_2917[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_A_taotranslator", 1000f, -4f, 257, 16, 1148846080, 0);
								}
								Local_2917[iParam0 /*10*/].f_6++;
							}
							break;
						...
						case 900:
								...
								if (!PED::IS_PED_RAGDOLL(Local_755[11 /*33*/]))
								{
									if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_2917[iParam0 /*10*/].f_7))
									{
										if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Local_2917[iParam0 /*10*/].f_7) == 1f)
										{
											...
											{
												AI::TASK_SYNCHRONIZED_SCENE(Local_755[11 /*33*/], Local_2917[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_Base_TaoCheng", 1000f, -4f, 257, 16, 1148846080, 0);
												if (!PED::IS_PED_INJURED(Local_755[10 /*33*/]))
												{
													if (!PED::IS_PED_RAGDOLL(Local_755[10 /*33*/]))
													{
														if (!GAMEPLAY::IS_BIT_SET(Local_2917[iParam0 /*10*/].f_8, 0))
														{
															AI::TASK_SYNCHRONIZED_SCENE(Local_755[10 /*33*/], Local_2917[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_Base_taotranslator", 1000f, -4f, 257, 16, 1148846080, 0);
														}
													}
												}
											}
							...
							if (!PED::IS_PED_INJURED(Local_755[10 /*33*/]))
							{
								if (((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_755[10 /*33*/], PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_RAGDOLL(Local_755[10 /*33*/])) || PED::IS_PED_INJURED(Local_755[11 /*33*/])) || (!PED::IS_PED_INJURED(Local_755[10 /*33*/]) && AI::GET_SCRIPT_TASK_STATUS(Local_755[10 /*33*/], 1785177548) == 2))
								{
									if (!GAMEPLAY::IS_BIT_SET(Local_2917[iParam0 /*10*/].f_8, 0))
									{
										AI::CLEAR_PED_TASKS(Local_755[10 /*33*/]);
										func_93();
										AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 30f, 20000, 0, 0);
										AI::TASK_COWER(0, -1);
										func_92(&(Local_755[10 /*33*/]), 0);
										GAMEPLAY::SET_BIT(&(Local_2917[iParam0 /*10*/].f_8), 0);
									}
								}
							}
							if (!PED::IS_PED_INJURED(Local_755[11 /*33*/]))
							{
								if (((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_755[11 /*33*/], PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_RAGDOLL(Local_755[11 /*33*/])) || GAMEPLAY::IS_BIT_SET(Local_2917[iParam0 /*10*/].f_8, 1)) || (!PED::IS_PED_INJURED(Local_755[11 /*33*/]) && AI::GET_SCRIPT_TASK_STATUS(Local_755[11 /*33*/], 1785177548) == 2))
								{
					...
					if (func_67(PLAYER::PLAYER_PED_ID(), 1995.169f, 3062.162f, 46.049f, 1) < 7f)
					{
						if (!PED::IS_PED_INJURED(Local_755[11 /*33*/]))
						{
							if (AI::GET_SCRIPT_TASK_STATUS(Local_755[11 /*33*/], 150319005) != 1)
							{
								AI::TASK_LOOK_AT_ENTITY(Local_755[11 /*33*/], PLAYER::PLAYER_PED_ID(), 4000, 2096, 2);
							}
						}
						if (!PED::IS_PED_INJURED(Local_755[10 /*33*/]))
						{
							if (AI::GET_SCRIPT_TASK_STATUS(Local_755[10 /*33*/], 150319005) != 1)
							{
								AI::TASK_LOOK_AT_ENTITY(Local_755[10 /*33*/], PLAYER::PLAYER_PED_ID(), 4000, 2096, 2);
							}
						}
					}
					break;
				...
				case 16:
					...
					if (!OBJECT::DOES_PICKUP_EXIST(uLocal_2675))
					{
						...
						UI::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_2677, "FRMBLIP");
					}
					Local_2917[iParam0 /*10*/].f_3 = 1;
					break;
				...
				case 20:
					...
					{
						case 0:
							Local_2917[iParam0 /*10*/].f_7 = GAMEPLAY::GET_GAME_TIMER() + 4000;
							Local_2917[iParam0 /*10*/].f_6++;
							break;
								...
								while (Local_2917[iParam0 /*10*/].f_7 < Local_755)
								{
									if (!PED::IS_PED_INJURED(Local_755[Local_2917[iParam0 /*10*/].f_7 /*33*/]))
									{
										if (INTERIOR::GET_INTERIOR_FROM_ENTITY(Local_755[Local_2917[iParam0 /*10*/].f_7 /*33*/]) == 0)
										{
											...
											PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[Local_2917[iParam0 /*10*/].f_7 /*33*/], uLocal_1617);
				...
				case 23:
					...
					while (iVar15 < Local_755)
					{
						...
						{
							if (INTERIOR::GET_ROOM_KEY_FROM_ENTITY(Local_755[iVar15 /*33*/]) != GAMEPLAY::GET_HASH_KEY("V_8_BasementRm"))
							{
						...
						case 1:
							if (STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze"))
							{
								if (!PED::IS_PED_INJURED(Local_755[23 /*33*/]))
								{
									...
									AI::TASK_SYNCHRONIZED_SCENE(Local_755[Local_2917[iParam0 /*10*/].f_7 /*33*/], Local_2917[iParam0 /*10*/].f_8, "misschinese2_crystalmaze", "_stand_to_aim", 1000f, -8f, 0, 0, 1148846080, 0);
									Local_2917[iParam0 /*10*/].f_6++;
								}
							}
							break;
				...
				case 30:
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						...
						case 1:
							...
							{
								uLocal_2508 = VEHICLE::CREATE_VEHICLE(joaat("blazer"), 2478.587f, 4941.803f, 43.6736f, 227.2903f, 1, 1, 0);
								VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_2508, 1084227584);
								Local_2917[iParam0 /*10*/].f_3 = 1;
							}
							break;
					}
				...
				case 36:
					...
					AUDIO::PLAY_SOUND_FROM_COORD(uLocal_2668, "FarmhouseFire_Ignite", vLocal_2669, "CHINESE2_SOUNDS", 0, 0, 0);
					Local_2917[iParam0 /*10*/].f_3 = 1;
					break;
				...
				case 40:
					if (func_101(24, joaat("a_m_m_hillbilly_01"), 2433.123f, 4960.47f, 45.8218f, 301f, joaat("weapon_smg"), 1, 1))
					{
						...
						AI::TASK_COMBAT_PED(Local_755[24 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
...
void func_161()
{
	...
	while (iVar0 < Local_444)
	{
		if (!func_162(Local_444[iVar0 /*5*/], 0f, 0f, 0f, 0))
		{
			...
			GAMEPLAY::CLEAR_AREA(Local_444[iVar0 /*5*/], 2f, 1, 0, 0, 0);
			iVar1 = 0;
			while (iVar1 < Local_755)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_755[iVar1 /*33*/]))
				{
					vVar2 = { ENTITY::GET_ENTITY_COORDS(Local_755[iVar1 /*33*/], 0) };
...
void func_163(bool bParam0)
{
	...
	while (iVar0 < Local_444)
	{
		...
		{
			Local_444[iVar0 /*5*/] = { UI::GET_BLIP_COORDS(Local_444[iVar0 /*5*/].f_3) };
			if (!bParam0)
			{
				UI::SET_BLIP_ALPHA(Local_444[iVar0 /*5*/].f_3, 0);
			}
	...
	while (iVar3 < Local_3120)
	{
		switch (Local_3120[iVar3 /*8*/])
		{
			...
			case 24:
				switch (Local_3120[iVar3 /*8*/].f_4)
				{
					...
					case 1:
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							uVar9 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
							if (VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(uVar9)) || VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(uVar9)))
							{
			...
			case 27:
				switch (Local_3120[iVar3 /*8*/].f_4)
				{
					case 0:
						...
						Local_3120[iVar3 /*8*/].f_5 = GAMEPLAY::GET_GAME_TIMER() + 8000;
						break;
					
					case 1:
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_2507, 0))
						{
							if (func_90(ENTITY::GET_ENTITY_COORDS(iLocal_2507, 1), 5f, 150f))
							{
						...
						if (GAMEPLAY::GET_GAME_TIMER() > Local_3120[iVar3 /*8*/].f_5)
						{
							Local_3120[iVar3 /*8*/].f_4++;
						}
						break;
			...
			case 47:
				...
				{
					case 0:
						Local_3120[iVar3 /*8*/].f_5 = GAMEPLAY::GET_GAME_TIMER() + 30000;
						Local_3120[iVar3 /*8*/].f_4++;
						break;
...
void func_175()
{
	...
	if ((func_195() && iLocal_2512 > 0) && GAMEPLAY::GET_GAME_TIMER() > iLocal_2641)
	{
	...
	switch (iLocal_2512)
	{
		case 0:
			...
			iLocal_2641 = GAMEPLAY::GET_GAME_TIMER() + 1000;
			GAMEPLAY::CLEAR_AREA(2570.53f, 4982.057f, 50.6819f, 100f, 1, 0, 0, 0);
	...
	if (iLocal_2340)
	{
		...
		bLocal_2341 = false;
		iLocal_2673 = 0;
		GAMEPLAY::CLEAR_AREA(2431.097f, 4967.043f, 41.3476f, 20f, 1, 0, 0, 0);
		func_184();
	}
	if (!bLocal_2341)
	{
		...
		if (iLocal_2454 == -1 || ((iLocal_2454 != -1 && iLocal_2454 < 4) && fLocal_2453 > (Local_2380[iLocal_2454 /*18*/].f_13 / 1000f)))
		{
			...
			if (iLocal_2454 == 3)
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze"))
				{
					...
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_2638, "misschinese2_crystalmaze", "trevor_barn_walk", 1000f, -8f, 0, 0, 1148846080, 0);
					}
					...
					switch (iVar3)
					{
						case 0:
							switch (Local_2343[iVar3 /*6*/].f_4)
							{
								case 0:
									iLocal_2505 = 0;
									if (GAMEPLAY::GET_GAME_TIMER() > Local_2343[iVar3 /*6*/].f_5)
									{
										func_122(vLocal_2465[iLocal_2505 /*3*/], 0);
										Local_2343[iVar3 /*6*/].f_5 = GAMEPLAY::GET_GAME_TIMER() + 200;
						...
						case 5:
							switch (Local_2343[iVar3 /*6*/].f_4)
							{
								case 0:
									fLocal_2674 = 1f;
									Local_2343[iVar3 /*6*/].f_4++;
									Local_2343[iVar3 /*6*/].f_5 = GAMEPLAY::GET_GAME_TIMER() + 1300;
								...
								case 1:
									...
									GAMEPLAY::SET_TIME_SCALE(fLocal_2674);
									if (GAMEPLAY::GET_GAME_TIMER() > Local_2343[iVar3 /*6*/].f_5)
									{
										Local_2343[iVar3 /*6*/].f_4++;
									}
...
void func_201()
{
	...
	if (((func_195() && iLocal_2512 > 0) && iLocal_2512 < 7) && GAMEPLAY::GET_GAME_TIMER() > iLocal_2641)
	{
		iLocal_2512 = 10;
		iLocal_2640 = 0;
		bLocal_2647 = true;
	...
	switch (iLocal_2512)
	{
		case 0:
			if (STREAMING::IS_SRL_LOADED())
			{
				...
				if (((VEHICLE::IS_VEHICLE_DRIVEABLE(uVar4, 0) && VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(uVar4))) && ENTITY::IS_ENTITY_IN_AIR(uVar4)) || ((VEHICLE::IS_VEHICLE_DRIVEABLE(uVar4, 0) && VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(uVar4))) && ENTITY::IS_ENTITY_IN_AIR(uVar4)))
				{
				...
				else
				{
					if (ENTITY::DOES_ENTITY_EXIST(uVar4))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(uVar4, 0))
						{
							if (!(VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(uVar4)) && ENTITY::IS_ENTITY_IN_AIR(uVar4)) && !(VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(uVar4)) && ENTITY::IS_ENTITY_IN_AIR(uVar4)))
							{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					uLocal_260 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
					vLocal_752 = { ENTITY::GET_ENTITY_VELOCITY(uLocal_260) };
					ENTITY::FREEZE_ENTITY_POSITION(uLocal_260, 1);
					ENTITY::SET_ENTITY_VISIBLE(uLocal_260, 0, 0);
				}
				AUDIO::PLAY_STREAM_FRONTEND();
				if (iLocal_2512 == 1)
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(uVar4))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(uVar4, 0))
						{
							VEHICLE::SET_VEHICLE_ENGINE_ON(uVar4, 0, 1, 0);
						}
					}
					GAMEPLAY::CLEAR_AREA(2445.139f, 4978.642f, 52.1489f, 150f, 1, 1, 0, 0);
					GAMEPLAY::CLEAR_AREA(2578.523f, 4982.284f, 51.4416f, 13f, 1, 0, 0, 0);
					...
					AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uVar5);
					...
					CAM::_0xD1B0F412F109EA5D(uLocal_2637, 0);
				}
				else
				{
					switch (iLocal_2512)
				...
				uLocal_2642 = PED::CREATE_PED(26, joaat("a_m_y_methhead_01"), 2460.449f, 4976.938f, 45.5765f, 243.4917f, 1, 1);
				WEAPON::GIVE_WEAPON_TO_PED(uLocal_2642, joaat("weapon_microsmg"), -1, 1, 1);
				if (!PED::IS_PED_INJURED(uLocal_2642))
				{
					func_93();
					AI::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
		...
		case 10:
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_260) && VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_260, 0))
			{
				VEHICLE::REQUEST_VEHICLE_HIGH_DETAIL_MODEL(uLocal_260);
			}
		...
		case 11:
			...
			if ((CAM::IS_SCREEN_FADED_OUT() && !CUTSCENE::IS_CUTSCENE_PLAYING()) || (CUTSCENE::IS_CUTSCENE_ACTIVE() && CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(1)))
			{
				...
				func_186(0, 1, 1, 0, 0, 0);
				if (ENTITY::DOES_ENTITY_EXIST(uLocal_2642))
				{
					PED::DELETE_PED(&uLocal_2642);
				}
				iLocal_2885 = func_18(4);
				if (iLocal_2885 != -1)
				{
				...
				func_31(20, 0);
				if (!PED::IS_PED_INJURED(uLocal_2643))
				{
					PED::DELETE_PED(&uLocal_2643);
				}
				if (!PED::IS_PED_INJURED(uLocal_2644))
				{
					PED::DELETE_PED(&uLocal_2644);
				}
				if (func_68(iLocal_2509))
				{
					VEHICLE::DELETE_VEHICLE(&iLocal_2509);
				}
				if (ENTITY::DOES_ENTITY_EXIST(uLocal_2682))
				{
					OBJECT::DELETE_OBJECT(&uLocal_2682);
				}
				func_202();
				iLocal_751 = 0;
				func_27();
				...
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_260, 0))
					{
						ENTITY::FREEZE_ENTITY_POSITION(uLocal_260, 0);
						if (VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(uLocal_260)))
						{
							ENTITY::SET_ENTITY_VELOCITY(uLocal_260, vLocal_752);
							PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_260, -1);
						}
						VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_260, 1, 1, 0);
						if (VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(uLocal_260)))
						{
							ENTITY::SET_ENTITY_ROTATION(uLocal_260, 0f, 0f, ENTITY::GET_ENTITY_HEADING(uLocal_260), 2, 1);
							VEHICLE::SET_HELI_BLADES_FULL_SPEED(uLocal_260);
							ENTITY::SET_ENTITY_VELOCITY(uLocal_260, 1f, 1f, 1f);
							PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_260, -1);
						}
						if (iLocal_2883 == 0)
						{
						...
						ENTITY::SET_ENTITY_VISIBLE(uLocal_260, 1, 0);
					}
				}
...
void func_211(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
		{
			...
			if (bParam1)
			{
				if (PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_212()) && uParam0->f_17[iVar0] != PLAYER::PLAYER_PED_ID())
				{
...
void func_217()
{
	...
	{
		if (UI::DOES_BLIP_EXIST(Local_2683.f_5))
		{
			UI::SET_BLIP_ROUTE(Local_2683.f_6, 0);
		}
		func_176(11);
	}
	else
		...
		if (CAM::IS_SCREEN_FADED_IN())
		{
			...
			if (bVar1)
			{
				...
				if (bParam26 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					if ((!func_235(uParam0, 1) && !func_234(uParam0)) && !GAMEPLAY::IS_BIT_SET(uParam0->f_13, 0))
					{
						if (bParam30)
						{
				...
				else
				{
					...
					else if (!func_229(vVar3, UI::GET_BLIP_COORDS(uParam0->f_5), 0.1f, 0))
					{
					...
					if (bVar1)
					{
						...
						while (iVar2 < 3)
						{
							if (!PED::IS_PED_INJURED(uParam0->f_17[iVar2]))
							{
								...
								else if (!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar2], func_212()) || !func_227(uParam0->f_17[iVar2], 1))
								{
									bVar1 = false;
								}
							}
...
int func_224(var uParam0)
{
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_13, 12))
	{
		...
		{
			if (func_225(1, 0, 1) || GAMEPLAY::IS_BIT_SET(uParam0->f_13, 7))
			{
				return 1;
			}
		}
	}
	else if (func_225(1, 0, 1) || GAMEPLAY::IS_BIT_SET(uParam0->f_13, 7))
	{
		return 1;
	}
	return 0;
...
int func_227(var uParam0, int iParam1)
{
	if (!PED::IS_PED_INJURED(uParam0))
	{
		...
		{
			if (func_228(PLAYER::PLAYER_PED_ID(), uParam0))
			{
				PED::SET_GROUP_SEPARATION_RANGE(func_212(), 50f);
				return 1;
			}
		}
		else if (PED::IS_PED_GROUP_MEMBER(uParam0, func_212()))
		{
			PED::SET_GROUP_SEPARATION_RANGE(func_212(), 50f);
			return 1;
		}
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_232(iParam2), 1);
}
...
int func_247(var uParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(uParam0))
	{
		if (!PED::IS_PED_GROUP_MEMBER(uParam0, func_212()))
		{
		...
		case 2:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("tao", 0))
			{
				if (!PED::IS_PED_INJURED(Local_755[11 /*33*/]))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(Local_755[11 /*33*/], uVar0, "misschinese2_crystalmaze", "2int_Loop_A_TaoCheng", 1000f, -4f, 1, 16, 1148846080, 0);
				}
			}
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Taos_Translator", 0))
			{
				if (!PED::IS_PED_INJURED(Local_755[10 /*33*/]))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(Local_755[10 /*33*/], uVar1, "misschinese2_crystalmaze", "2int_Loop_A_taotranslator", 1000f, -4f, 1, 16, 1148846080, 0);
				}
			}
...
void func_264()
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_91081[iVar0]))
		{
			...
			{
				ENTITY::SET_ENTITY_PROOFS(Global_91081[iVar0], 0, 0, 0, 0, 0, 0, 0, 0);
				ENTITY::SET_ENTITY_INVINCIBLE(Global_91081[iVar0], 0);
			}
		}
		iVar0++;
	}
...
void func_265()
{
	...
	switch (iLocal_2512)
	{
		case 0:
			...
			PED::ADD_RELATIONSHIP_GROUP("TAOGROUP", &uLocal_1618);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_1618, 1862763509);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, 1862763509, uLocal_1618);
			func_17(0, -1);
			AI::SET_SCENARIO_GROUP_ENABLED("Chinese2_Lunch", 0);
			AI::SET_SCENARIO_GROUP_ENABLED("CHINESE2_HILLBILLIES", 0);
			if (func_359())
			{
				iVar0 = func_358();
				if (Global_87889 == 1)
...
void func_266(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			PED::ADD_SCENARIO_BLOCKING_AREA(Vector(50.27741f, 3054.884f, 1991.22f) - Vector(40f, 40f, 40f), Vector(50.27741f, 3054.884f, 1991.22f) + Vector(40f, 40f, 40f), 0, 1, 1, 1);
			PED::SET_PED_NON_CREATION_AREA(Vector(50.27741f, 3054.884f, 1991.22f) - Vector(40f, 40f, 40f), Vector(50.27741f, 3054.884f, 1991.22f) + Vector(0f, 40f, 40f));
			GAMEPLAY::CLEAR_AREA(1984.997f, 3052.905f, 46.8556f, 10f, 1, 0, 0, 0);
		...
		case 4:
			...
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				func_269(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
			}
			break;
...
int func_314(var uParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_315(uParam0, uVar1[iVar6], 1) && func_229(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_162(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_318(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_326(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_325())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
int func_319(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_323(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_322(*uParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_322(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_321(uParam0);
	if (func_320(*uParam0))
	{
...
int func_350(var uParam0, int iParam1, vector3 vParam2, int iParam5, bool bParam6)
{
	...
	if (!func_45(iParam1))
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(iVar0))
		{
			...
			*uParam0 = PED::CREATE_PED(26, iVar0, vParam2, iParam5, 0, 0);
...
void func_353(int iParam0)
{
	...
	if (iParam0 != 3)
	{
		AI::SET_SCENARIO_GROUP_ENABLED("Chinese2_Lunch", 1);
		AI::SET_SCENARIO_GROUP_ENABLED("CHINESE2_HILLBILLIES", 0);
	}
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 1, 0);
	if (iLocal_2884 != -1)
	...
	while (iVar0 < Local_755)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Local_755[iVar0 /*33*/]))
		{
			if (!PED::IS_PED_INJURED(Local_755[iVar0 /*33*/]))
			{
				if (iParam0 == 3)
				{
					AI::CLEAR_PED_TASKS_IMMEDIATELY(Local_755[iVar0 /*33*/]);
				}
			}
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_2878))
	{
		OBJECT::DELETE_OBJECT(&uLocal_2878);
	}
	if (iParam0 != 0 && iParam0 != 2)
	{
		GAMEPLAY::CLEAR_AREA(2438.433f, 4970.416f, 53.1778f, 450f, 1, 0, 0, 0);
		FIRE::STOP_FIRE_IN_RANGE(2442.69f, 4970.348f, 46.33f, 30f);
	}
	iVar0 = 0;
	while (iVar0 < Local_2515)
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_2508))
	{
		if (func_68(uLocal_2508))
		{
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_2508);
		}
	}
	if (OBJECT::DOES_PICKUP_EXIST(uLocal_2675))
	{
	...
	if (iParam0 == 0)
	{
		...
		{
			ENTITY::FREEZE_ENTITY_POSITION(uLocal_2680, 0);
			ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_2680);
		}
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_2681))
		{
			ENTITY::FREEZE_ENTITY_POSITION(uLocal_2681, 0);
			ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_2681);
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_2642))
	{
...
void func_361()
{
	PED::ADD_RELATIONSHIP_GROUP("MYFRIEND", &uLocal_1615);
	PED::ADD_RELATIONSHIP_GROUP("FOE", &iLocal_1616);
	PED::ADD_RELATIONSHIP_GROUP("IGNORE", &uLocal_1617);
	PED::ADD_RELATIONSHIP_GROUP("BARpeds", &uLocal_2636);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, uLocal_2636, 1862763509);
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_1615, uLocal_1617);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_1616, uLocal_1617);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_1617, PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID()));
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_1617, iLocal_1616);
}
...
void func_382(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_384(Var11.f_1)) && iVar72 < 51)
			{
...
void func_388(var uParam0)
{
	...
	if (func_45(iVar0) && !PED::IS_PED_INJURED(uParam0))
	{
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_420(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_437(int iParam0)
{
	...
	if (PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(uLocal_2510))
	{
		PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(uLocal_2510);
	}
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		WEAPON::REMOVE_WEAPON_FROM_PED(PLAYER::PLAYER_PED_ID(), joaat("weapon_petrolcan"));
