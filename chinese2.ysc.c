...
void func_135(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_137(Global_106070.f_18505[iVar0], &vVar2, &fVar5))
			{
	...
	switch (iLocal_2512)
	{
		case 0:
			...
			if (func_204())
			{
				...
				{
					Local_755[14 /*33*/] = Global_89824.f_9[2];
					Local_755[13 /*33*/] = Global_89824.f_9[1];
					Local_755[11 /*33*/] = Global_89824.f_9[4];
					Local_755[10 /*33*/] = Global_89824.f_9[3];
					Local_755[12 /*33*/] = Global_89824.f_9[0];
...
{
	return func_280(&(Global_99633.f_2875), vParam0, fParam3, 0);
}
...
int func_314(var uParam0, vector3 vParam1, bool bParam4)
{
	...
	{
		case joaat("cargobob"):
			if (func_315(uParam0, Global_70024.f_139[38], 0))
			{
				func_306(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_315(uParam0, Global_70024.f_139[43], 1))
			{
				func_306(43);
				return 1;
			}
...
{
	return func_280(&(Global_96664.f_2875), vParam0, fParam3, 0);
}
...
void func_363(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_425(&(Global_93232.f_3));
				if (iVar10 > -1)
				{
...
int func_375(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2535519[iParam0 /*3*/][func_376(iParam1)];
...
void func_382(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_384(Var11.f_1)) && iVar72 < 50)
			{
