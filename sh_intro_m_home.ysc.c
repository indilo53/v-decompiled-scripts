		...
		switch (iLocal_38)
		{
			case 0:
				if (func_198(0, 1093140480, 0))
				{
					...
					if (CAM::DOES_CAM_EXIST(uLocal_46))
					{
						CAM::SET_CAM_PARAMS(uLocal_46, vVar0[0 /*3*/], vVar7[0 /*3*/], fVar14[0], iVar21, 1, 1, 2);
						CAM::SET_CAM_PARAMS(uLocal_46, vVar0[1 /*3*/], vVar7[1 /*3*/], fVar14[1], iVar21, 0, 0, 2);
					}
			...
			case 2:
				...
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_48) > iVar21) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_50) > iVar22)
				{
					...
					{
						CAM::SET_CAM_PARAMS(uLocal_46, vVar0[0 /*3*/], vVar7[0 /*3*/], fVar14[0], iVar21, 1, 1, 2);
						CAM::SET_CAM_PARAMS(uLocal_46, vVar0[1 /*3*/], vVar7[1 /*3*/], fVar14[1], iVar21, 1, 1, 2);
						STREAMING::NEW_LOAD_SCENE_STOP();
			...
			case 3:
				...
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_48) > iVar21) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_50) > iVar22)
				{
					if (CAM::DOES_CAM_EXIST(uLocal_46))
					{
						CAM::SET_CAM_PARAMS(uLocal_46, vVar0[0 /*3*/], vVar7[0 /*3*/], fVar14[0], (iVar21 / 2), 1, 1, 2);
						CAM::SET_CAM_PARAMS(uLocal_46, vVar0[1 /*3*/], vVar7[1 /*3*/], fVar14[1], (iVar21 / 2), 1, 1, 2);
						STREAMING::NEW_LOAD_SCENE_STOP();
...
void func_85(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_86(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
...
int func_90(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_92(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_92(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 4);
		}
	}
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_87(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_87(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_87(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_87(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_126(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_119(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_119(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
int func_198(int iParam0, int iParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_205(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
