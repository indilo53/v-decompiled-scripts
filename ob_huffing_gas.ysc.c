...
void __EntryFunction__()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uScriptParam_0))
	{
		...
		iLocal_40 = ENTITY::GET_ENTITY_MODEL(uLocal_41);
	}
	if (!func_70())
	{
		func_95();
...
void func_4()
{
	...
	switch (iLocal_293)
	{
		...
		case 2:
			...
			uLocal_297 = PED::CREATE_SYNCHRONIZED_SCENE(func_41(), func_40(), 2);
			AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_297, func_69(), func_39(0), 1000f, -8f, 0, 0, 1148846080, 0);
			ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_41, uLocal_297, func_38(0), func_69(), 1000f, -8f, 0, 1148846080);
			...
			if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
			{
				...
				CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_296, uLocal_297, func_35(0), func_69());
		...
		case 4:
			...
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vLocal_302, 1, 0, 0, 1);
		...
		case 5:
			...
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_297))
			{
				...
				uLocal_297 = PED::CREATE_SYNCHRONIZED_SCENE(vVar9.x, vVar9.y, vVar9.z, 0f, 0f, fLocal_305, 2);
				AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_297, func_69(), sLocal_300, 1000f, -4f, 0, 0, 1148846080, 0);
				if (PED::_0x7F2F4F13AC5257EF(uLocal_297))
				{
				...
				{
					uLocal_296 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
					CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_296, uLocal_297, sLocal_301, func_69());
					CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
				}
				else
				{
...
char* func_36()
{
	...
	fVar4 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar1, vLocal_273[0 /*3*/], 1);
	fVar5 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar1, vLocal_273[1 /*3*/], 1);
	if (fVar4 < fVar5)
	{
		...
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				if ((((CAM::IS_GAMEPLAY_CAM_RENDERING() && !CUTSCENE::IS_CUTSCENE_PLAYING()) && !CAM::IS_CINEMATIC_CAM_RENDERING()) && !func_62(0)) && !func_61())
				{
					...
					if (func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vParam0, fParam3, 0))
					{
						return 1;
					}
				}
...
int func_67()
{
	...
	if (!iLocal_294)
	{
		...
		if (!BRAIN::IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE(uLocal_41))
		{
			return 0;
		}
	}
...
int func_68()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_41))
	{
		vVar0 = { ENTITY::GET_ENTITY_COORDS(uLocal_41, 1) };
		if (!ENTITY::IS_ENTITY_DEAD(uLocal_41, 0) && vVar0.z > 33f)
		{
			return 1;
		}
	}
...
int func_80(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_82(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_82(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 4);
		}
	}
...
int func_84(int iParam0)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		{
			if (func_59(ENTITY::GET_ENTITY_COORDS(uLocal_41, 0), func_63(), 5f, 0))
			{
				return 1;
			}
		}
