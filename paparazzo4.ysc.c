...
void func_1()
{
	switch (iLocal_327)
	{
		case 0:
			...
			iLocal_338 = GAMEPLAY::GET_GAME_TIMER() + 500;
			iLocal_327 = 1;
			break;
			...
			if (func_205(Local_98.f_28[1]) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[1]))
			{
				if (func_205(PLAYER::PLAYER_PED_ID()))
				{
					if (!PED::IS_PED_FLEEING(Local_98.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 1))
					{
						...
						AI::TASK_SMART_FLEE_PED(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
					}
				}
				else
				{
					AI::TASK_WANDER_STANDARD(Local_98.f_28[1], 1193033728, 0);
				}
			}
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_338)
			{
				iLocal_327 = 2;
			}
			break;
...
int func_33(var uParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(uParam0, func_76(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(uParam0, func_76(iParam1), Global_71402[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_76(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, 0);
		}
	}
...
int func_36(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_76(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_76(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_76(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_67(iVar0);
						if (Global_71400 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_76(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_76(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_76(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
void func_52(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_53(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_54(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_54(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_54(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_54(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_87(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_87(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_76(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_149(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_76(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_76(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_207()
{
	if (!bLocal_491)
	{
		if (iLocal_492 == -1)
		{
			...
			{
				iLocal_492 = GAMEPLAY::GET_GAME_TIMER() + 500;
			}
		}
		else if (iLocal_492 > GAMEPLAY::GET_GAME_TIMER())
		{
			if ((!func_205(Local_98.f_28[0]) && !func_205(Local_98.f_28[1])) && !func_205(Local_98.f_28[2]))
			{
				bLocal_491 = true;
...
void func_213()
{
	if ((func_205(Local_98.f_28[0]) && func_214(Local_98.f_35[0])) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_480))
	{
		if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_98.f_35[0]))
		{
			if (AI::GET_VEHICLE_WAYPOINT_PROGRESS(Local_98.f_35[0]) >= iLocal_482)
			{
				if (bLocal_407)
				{
					AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_98.f_28[0], Local_98.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 15f, 786468, 100f, 1f, 1);
				}
				else
				{
					AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_98.f_28[0], Local_98.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 40f, 786468, 100f, 1f, 1);
				}
			}
		}
	}
	if ((func_205(Local_98.f_28[1]) && func_214(Local_98.f_35[1])) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_481))
	{
		if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_98.f_35[1]))
		{
			if (AI::GET_VEHICLE_WAYPOINT_PROGRESS(Local_98.f_35[1]) >= iLocal_483)
			{
				if (func_205(Local_98.f_28[0]))
				{
					if (bLocal_407)
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_98.f_28[1], Local_98.f_35[1], Local_98.f_28[0], 7, 15f, 786468, 100f, 1f, 1);
					}
					else
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_98.f_28[1], Local_98.f_35[1], Local_98.f_28[0], 7, 40f, 786468, 100f, 1f, 1);
					}
				}
				else
				{
					AI::TASK_VEHICLE_DRIVE_WANDER(Local_98.f_28[1], Local_98.f_35[1], 15f, 786597);
				}
			}
		}
	}
...
void func_215()
{
	...
	{
		if (((((!PED::IS_PED_FLEEING(Local_98.f_28[2]) && !AI::IS_PED_GETTING_UP(Local_98.f_28[2])) && !PED::IS_PED_PRONE(Local_98.f_28[2])) && !PED::IS_PED_RAGDOLL(Local_98.f_28[2])) && !func_217(Local_98.f_28[2], 63541484)) && !func_217(Local_98.f_28[2], 242628503))
		{
			if ((!PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[2], 1) || (func_214(Local_98.f_35[1]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[1], 1))) || (func_214(Local_98.f_35[0]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[0], 1)))
			{
				...
				AI::TASK_SMART_FLEE_PED(Local_98.f_28[2], PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
			}
		}
	}
}
...
void func_216(bool bParam0)
{
	if (bParam0)
	{
		PATHFIND::SET_PED_PATHS_IN_AREA(vLocal_467, vLocal_470, 1, 0);
	}
	else
	{
		PATHFIND::SET_PED_PATHS_IN_AREA(vLocal_467, vLocal_470, 0, 0);
	}
}
...
void func_218()
{
	...
	{
		if ((((((!PED::IS_PED_FLEEING(Local_98.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 1)) && !AI::IS_PED_GETTING_UP(Local_98.f_28[1])) && !PED::IS_PED_PRONE(Local_98.f_28[1])) && !PED::IS_PED_RAGDOLL(Local_98.f_28[1])) && !func_217(Local_98.f_28[1], 63541484)) && !func_217(Local_98.f_28[1], 242628503))
		{
			func_216(1);
			PED::SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[1], 128, 1);
			AI::TASK_SMART_FLEE_PED(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
	...
	if (func_205(Local_98.f_28[1]) && ENTITY::DOES_ENTITY_EXIST(Local_98.f_41[1]))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_98.f_28[1], sLocal_377, sLocal_393, 3))
		{
			if (PED::IS_PED_BEING_STEALTH_KILLED(Local_98.f_28[1]))
			{
				...
				{
					AI::STOP_ANIM_TASK(Local_98.f_28[1], sLocal_377, sLocal_393, -1056964608);
				}
			}
		...
		{
			AI::TASK_PLAY_ANIM(Local_98.f_28[1], sLocal_377, sLocal_393, 1000f, -8f, -1, 57, 0, 0, 0, 0);
		}
	}
}
...
void func_230()
{
	...
	{
		if (((((((iLocal_344 < 4 && !PED::IS_PED_FLEEING(Local_98.f_28[1])) && !func_242()) && GAMEPLAY::GET_GAME_TIMER() > iLocal_345) && func_225(Local_98.f_28[1], PLAYER::PLAYER_PED_ID()) < 10f) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 1)) && !PED::IS_PED_FLEEING(Local_98.f_28[1]))
		{
			if (func_231(&uLocal_160, "PAP4AUD", "PAP4_CAMERA", sLocal_339[iLocal_344], 7, 0, 0))
			{
				iLocal_344++;
				iLocal_345 = GAMEPLAY::GET_GAME_TIMER() + 15000;
			}
		}
	}
}
		...
		if (PED::IS_PED_IN_VEHICLE(Local_98.f_28[0], Local_98.f_35[0], 0))
		{
			if (AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_98.f_35[0]))
			{
				if (func_244(&uLocal_160, "PAP4AUD", "PAP4_BLOCKED", 7, 0, 0, 0))
				{
					...
					{
						AI::TASK_COMBAT_PED(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), 0, 16);
						func_223(&(Local_98.f_41[0]), 0);
					}
					if (UI::DOES_BLIP_EXIST(uLocal_159))
					{
						UI::SET_BLIP_SCALE(uLocal_159, 0.7f);
					}
				}
			}
		}
...
void func_246()
{
	if (((!bLocal_408 && func_205(PLAYER::PLAYER_PED_ID())) && func_205(Local_98.f_28[0])) && func_266(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 5f, 1))
	{
		...
		{
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_373)
			{
				if (!func_242())
				{
					if (iLocal_372 < 3)
					{
						if (func_231(&uLocal_160, "PAP4AUD", "PAP4_ATTACK", sLocal_368[iLocal_372], 7, 0, 0))
						{
							...
							iLocal_372++;
							iLocal_373 = GAMEPLAY::GET_GAME_TIMER() + 15000;
						}
					}
	...
	if (func_206(PLAYER::PLAYER_PED_ID()) && func_206(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_260(PLAYER::PLAYER_PED_ID(), iParam0, iParam2);
				}
			}
		}
		if (bParam4)
...
int func_264(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_256(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_256(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_255(vVar3, vVar0);
...
void func_267()
{
	if (func_205(Local_98.f_28[1]) && func_214(Local_98.f_35[1]))
	{
		...
		{
			AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_98.f_28[1], Local_98.f_35[1], sLocal_481, 786597, 0, 8, -1, -1082130432, 0, 1073741824);
		}
	}
}
...
void func_268()
{
	if ((func_214(Local_98.f_35[1]) && (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[1]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[1], PLAYER::PLAYER_PED_ID(), 1))) && !bLocal_388)
	{
		if ((func_205(Local_98.f_28[1]) && !PED::IS_PED_FLEEING(Local_98.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0))
		{
			...
			AI::TASK_COMBAT_PED(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), 0, 16);
			bLocal_388 = true;
		}
		...
		if (func_205(Local_98.f_28[0]))
		{
			if ((!PED::IS_PED_IN_COMBAT(Local_98.f_28[0], 0) && !PED::IS_PED_IN_MELEE_COMBAT(Local_98.f_28[0])) && !PED::IS_PED_FLEEING(Local_98.f_28[0]))
			{
				...
				{
					AI::STOP_ANIM_TASK(Local_98.f_28[0], sLocal_377, sLocal_378, -1056964608);
					AI::TASK_SMART_FLEE_PED(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
					func_223(&(Local_98.f_41[0]), 0);
				}
				else
				{
	...
	if (func_205(Local_98.f_28[0]))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], 1))
		{
			if ((((!bLocal_386 && iLocal_385) && !func_271(Local_98.f_28[0])) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[0])) && !PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					AI::CLEAR_PED_TASKS(Local_98.f_28[0]);
				}
				PED::SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[0], 2, 0);
				func_223(&(Local_98.f_41[0]), 0);
				iLocal_389 = 1;
				AI::TASK_SMART_FLEE_PED(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), 400f, -1, 1, 0);
				func_219();
				iLocal_460 = 3;
				iLocal_385 = 0;
				bLocal_386 = true;
...
{
	if (func_205(PLAYER::PLAYER_PED_ID()) && func_205(uParam0))
	{
	...
	switch (iLocal_436)
	{
		case 1:
			...
			if (bVar0)
			{
				...
				{
					AI::CLEAR_PED_TASKS(Local_98.f_28[0]);
					AI::CLEAR_PED_SECONDARY_TASK(Local_98.f_28[0]);
				...
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_438, 2f, 20000, 1048576000, 0, 1193033728);
				}
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
				AI::CLOSE_SEQUENCE_TASK(uVar1);
				AI::TASK_PERFORM_SEQUENCE(Local_98.f_28[0], uVar1);
				...
				if (func_205(Local_98.f_28[1]) && !PED::IS_PED_FLEEING(Local_98.f_28[1]))
				{
					...
					{
						AI::TASK_LEAVE_ANY_VEHICLE(Local_98.f_28[1], 0, 0);
					}
					else
					{
						AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_98.f_28[1], Local_98.f_28[0], -1);
					}
				}
				if ((((func_205(Local_98.f_28[2]) && !PED::IS_PED_FLEEING(Local_98.f_28[2])) && !iLocal_387) && !iLocal_465) && !PED::IS_PED_RAGDOLL(Local_98.f_28[2]))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[0], PLAYER::PLAYER_PED_ID(), 1))
					{
						AI::TASK_SMART_FLEE_PED(Local_98.f_28[2], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
					}
					else if (PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[2], 0))
					{
						AI::TASK_LEAVE_ANY_VEHICLE(Local_98.f_28[2], 0, 4416);
					}
					else
					{
						AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_98.f_28[2], PLAYER::PLAYER_PED_ID(), -1);
					}
				}
				iLocal_437 = GAMEPLAY::GET_GAME_TIMER() + 3000;
				if (UI::DOES_BLIP_EXIST(uLocal_159))
				{
					UI::SET_BLIP_SCALE(uLocal_159, 0.7f);
				}
		...
		case 2:
			...
			else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_437)
			{
				if ((func_205(Local_98.f_28[0]) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[0], 0)) && iLocal_385)
				{
					...
					if ((((func_205(Local_98.f_28[2]) && !PED::IS_PED_FLEEING(Local_98.f_28[2])) && !iLocal_387) && !iLocal_465) && !PED::IS_PED_RAGDOLL(Local_98.f_28[2]))
					{
						...
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_441, 2f, 20000, 1048576000, 0, 1193033728);
						AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
						AI::CLOSE_SEQUENCE_TASK(uVar2);
						AI::TASK_PERFORM_SEQUENCE(Local_98.f_28[2], uVar2);
		...
		case 3:
			if (func_225(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0]) > 20f)
			{
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_438, 1f, 20000, 1048576000, 0, 1193033728);
				if (func_205(Local_98.f_28[1]))
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_98.f_28[1], -1);
				}
				else
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
				...
				AI::TASK_PERFORM_SEQUENCE(Local_98.f_28[0], uVar3);
...
void func_274()
{
	AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), -1);
	iLocal_437 = GAMEPLAY::GET_GAME_TIMER() + 3000;
	if (UI::DOES_BLIP_EXIST(uLocal_159))
	{
		UI::SET_BLIP_SCALE(uLocal_159, 0.7f);
...
void func_275()
{
	...
	if (((func_205(Local_98.f_28[1]) && func_205(Local_98.f_28[0])) && !PED::IS_PED_FLEEING(Local_98.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0))
	{
		...
		if (fVar0 > 20f)
		{
			...
			{
				AI::TASK_GOTO_ENTITY_OFFSET(Local_98.f_28[1], Local_98.f_28[0], 20000, 0.5f, 0f, 2f, 2);
			}
		}
		else if (fVar0 < 10f)
		{
...
int func_276(var uParam0)
{
	...
	if ((func_205(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_214(uParam0))
	{
...
void func_278()
{
	if ((((func_205(Local_98.f_28[0]) && func_205(Local_98.f_28[1])) && func_205(PLAYER::PLAYER_PED_ID())) && !bLocal_388) && ENTITY::DOES_ENTITY_EXIST(Local_98.f_41[1]))
	{
		...
		{
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_409)
			{
				func_279();
				iLocal_409 = GAMEPLAY::GET_GAME_TIMER() + 10000;
			}
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 3))
		{
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_410)
			{
				if (iLocal_411)
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_98.f_28[1], Local_98.f_28[0], -1);
				...
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), -1);
					iLocal_411 = 1;
				}
				iLocal_410 = (GAMEPLAY::GET_GAME_TIMER() + 4000 + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 20) * 100);
			}
		}
	}
}
...
void func_279()
{
	...
	if ((((!bLocal_464 && func_205(PLAYER::PLAYER_PED_ID())) && func_205(Local_98.f_28[1])) && func_205(Local_98.f_28[0])) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0))
	{
		...
		AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar8, 3f, 20000, 1048576000, 0, 1193033728);
		AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_98.f_28[0], 0);
		AI::CLOSE_SEQUENCE_TASK(uVar11);
		AI::TASK_PERFORM_SEQUENCE(Local_98.f_28[1], uVar11);
...
void func_281()
{
	...
	{
		if ((((((!AI::IS_PED_GETTING_UP(Local_98.f_28[0]) && !PED::IS_PED_PRONE(Local_98.f_28[0])) && !PED::IS_PED_RAGDOLL(Local_98.f_28[0])) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], 1)) && !func_217(Local_98.f_28[0], -1794415470)) && !PED::IS_PED_FLEEING(Local_98.f_28[0])) || PED::IS_PED_BEING_STEALTH_KILLED(Local_98.f_28[0]))
		{
			if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 3) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_377))
			{
				AI::TASK_PLAY_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 4f, -8f, -1, 57, 0, 0, 0, 0);
			}
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 3))
		{
...
int func_284()
{
	...
	vVar0 = { ENTITY::GET_ENTITY_COORDS(Local_98.f_28[0], 1) + Vector(1f, 0f, 0f) };
	vVar3 = { ENTITY::GET_ENTITY_COORDS(Local_98.f_28[1], 1) - Vector(1f, 0f, 0f) };
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar0, vVar3, 0.5f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
void func_285(bool bParam0)
{
	...
	if (bLocal_391)
	{
		if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_390))
		{
			uLocal_390 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_401, vLocal_404, 2);
			PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_390, 0);
			PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_390, 0);
			...
			if (func_205(Local_98.f_28[0]))
			{
				AI::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[0], uLocal_390, sLocal_377, sVar1, fVar4, -4f, 1, 16, 1148846080, 0);
			}
			if (func_205(Local_98.f_28[1]))
			{
				AI::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[1], uLocal_390, sLocal_377, sVar2, 1000f, -2f, 1, 16, 1148846080, 0);
			}
			if (func_205(Local_98.f_28[2]))
			{
				AI::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[2], uLocal_390, sLocal_377, sVar3, fVar4, -4f, 1, 16, 1148846080, 0);
			}
		}
	}
	else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_390))
	{
...
void func_286()
{
	if (func_205(Local_98.f_28[0]) && func_205(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_COMBAT(Local_98.f_28[0], 0))
		{
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_374)
			{
				if (func_244(&uLocal_160, "PAP4AUD", "PAP4_FIST", 7, 0, 0, 0))
				{
					iLocal_374 = GAMEPLAY::GET_GAME_TIMER() + 5000;
				}
			}
		}
	}
		...
		if (bLocal_407)
		{
			if ((((PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()) && func_295()) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vLocal_484, fLocal_487)) || !func_205(Local_98.f_28[1])) || !func_205(Local_98.f_28[2]))
			{
				...
				if (func_242())
				{
					Var0 = { func_294() };
					uVar6 = func_293(&Var0);
					if (!GAMEPLAY::ARE_STRINGS_EQUAL(uVar6, "PAP4_THREAT"))
					{
						func_219();
					}
				}
			...
			else if ((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[2], PLAYER::PLAYER_PED_ID(), 1)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), 1)) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("object"))
			{
				...
				if (func_242())
				{
					...
					if (!GAMEPLAY::ARE_STRINGS_EQUAL(uVar13, "PAP4_THREAT"))
					{
						func_219();
					}
				}
			...
			else if ((((func_248(Local_98.f_28[0], 1126825984) && func_295()) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("object")) || PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
			{
				if (func_217(Local_98.f_28[0], 780511057))
				{
					...
					if (func_242())
					{
						...
						if (!GAMEPLAY::ARE_STRINGS_EQUAL(uVar20, "PAP4_THREAT"))
						{
							func_219();
						}
					}
				...
				else
				{
					...
					if (func_242())
					{
						...
						if (!GAMEPLAY::ARE_STRINGS_EQUAL(uVar27, "PAP4_THREAT"))
						{
							func_219();
						}
					}
			...
			else if ((func_205(Local_98.f_28[0]) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[0])) && (((((((ENTITY::GET_ENTITY_HEALTH(Local_98.f_28[0]) < 150 || (func_261(Local_98.f_28[0], 0, 0, 0, 0) && func_295())) || (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), 1) && func_292(PLAYER::PLAYER_PED_ID()) == joaat("weapon_stungun"))) || !func_266(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 20f, 1)) || (func_205(Local_98.f_28[1]) && PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0))) || (func_205(Local_98.f_28[1]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), 1))) || (func_205(Local_98.f_28[2]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[2], PLAYER::PLAYER_PED_ID(), 1))) || iLocal_384))
			{
				...
				switch (iLocal_383)
				{
					case 0:
						...
						{
							AI::TASK_PLAY_ANIM(Local_98.f_28[0], sLocal_379, "flinch_additive_a", 4f, -8f, -1, 272, 0, 0, 0, 0);
						}
						else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_98.f_28[0], sLocal_379, "flinch_additive_a") > 0.7f)
						{
							AI::STOP_ANIM_TASK(Local_98.f_28[0], sLocal_379, "flinch_additive_a", -1056964608);
							iLocal_383++;
						}
						break;
			...
			if (((((((((func_261(Local_98.f_28[1], 0, 0, 0, 0) && func_295()) || ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), 1) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("object"))) || ((func_248(Local_98.f_28[1], 1126825984) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("object"))) || !func_214(Local_98.f_35[1])) || PED::IS_PED_RAGDOLL(Local_98.f_28[1])) || func_289(Local_98.f_28[1])) || func_271(Local_98.f_28[0])) || func_271(Local_98.f_28[2])) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vLocal_484, fLocal_487))
			{
				if (!PED::IS_PED_FLEEING(Local_98.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 0))
				{
					if (func_242())
					{
						...
						if (!GAMEPLAY::ARE_STRINGS_EQUAL(uVar34, "PAP4_THREAT") && !GAMEPLAY::ARE_STRINGS_EQUAL(uVar34, "PAP4_ATTACK"))
						{
							func_219();
						}
					}
			...
			if (((((((((((func_247(Local_98.f_28[2], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_295()) || (func_247(Local_98.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_295())) || (func_247(Local_98.f_28[1], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_295())) || func_289(Local_98.f_28[2])) || func_289(Local_98.f_28[0])) || func_289(Local_98.f_28[1])) || PED::IS_PED_RAGDOLL(Local_98.f_28[2])) || !func_214(Local_98.f_35[1])) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vLocal_484, fLocal_487)) || func_271(Local_98.f_28[0])) || func_271(Local_98.f_28[1]))
			{
				if (!PED::IS_PED_FLEEING(Local_98.f_28[2]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[2], 0))
				{
					if (func_242())
					{
						...
						if (!GAMEPLAY::ARE_STRINGS_EQUAL(uVar41, "PAP4_THREAT") && !GAMEPLAY::ARE_STRINGS_EQUAL(uVar41, "PAP4_ATTACK"))
						{
							func_219();
						}
					}
...
int func_289(var uParam0)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (func_214(uVar0))
		{
			if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(uParam0, uVar0) && !func_290(uVar0))
			{
				AI::TASK_SMART_FLEE_PED(uParam0, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
				return 1;
			}
		}
	}
...
void func_296()
{
	...
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_337)
		{
			func_297();
			iLocal_337 = GAMEPLAY::GET_GAME_TIMER() + 1000;
		}
	}
}
...
int func_297()
{
	...
	bVar0 = VEHICLE::_0x639431E895B9AA57(Local_98.f_28[0], Local_98.f_35[0], -1, 0, 0);
	bVar1 = VEHICLE::_0x639431E895B9AA57(Local_98.f_28[0], Local_98.f_35[0], 0, 0, 0);
	if (!bVar0 && !bVar1)
	{
		iLocal_461 = 0;
		iLocal_460 = 3;
		...
		{
			AI::TASK_SMART_FLEE_PED(Local_98.f_28[2], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
		}
		return 1;
	}
	return 0;
...
void func_298()
{
	if (func_205(Local_98.f_28[0]))
	{
		if (func_214(Local_98.f_35[0]) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_480))
		{
			if (PED::IS_PED_SITTING_IN_VEHICLE(Local_98.f_28[0], Local_98.f_35[0]) && !func_217(Local_98.f_28[0], -1273030092))
			{
				PATHFIND::SET_ROADS_IN_ANGLED_AREA(vLocal_473, vLocal_476, fLocal_479, 0, 1, 1);
				AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_98.f_28[0], Local_98.f_35[0], sLocal_480, 786597, 0, 8, -1, -1082130432, 0, 1073741824);
				if (UI::DOES_BLIP_EXIST(uLocal_159))
				{
					UI::SET_BLIP_SCALE(uLocal_159, 1f);
				}
				func_212(0);
			}
...
void func_299(bool bParam0, bool bParam1)
{
	...
	{
		if (iLocal_376 && GAMEPLAY::GET_GAME_TIMER() > iLocal_375)
		{
			if (iLocal_436 == 0)
			{
				func_300();
			...
			if (((((iLocal_461 && !func_217(Local_98.f_28[0], -1794415470)) && !func_217(Local_98.f_28[0], 355471868)) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_98.f_35[0], -1, 0)) && !PED::IS_PED_FLEEING(Local_98.f_28[0])) && !iLocal_389)
			{
				if (!func_297() && !func_243())
				{
					...
					if (bVar0 || bParam0)
					{
						...
						if (bParam1)
						{
							AI::TASK_ENTER_VEHICLE(Local_98.f_28[0], Local_98.f_35[0], 20000, -1, 2f, 1, 0);
						}
						else
						{
							AI::TASK_ENTER_VEHICLE(Local_98.f_28[0], Local_98.f_35[0], 20000, -1, 1f, 1, 0);
						}
						if (func_205(Local_98.f_28[1]))
						{
							AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_98.f_28[1], Local_98.f_28[0], -1);
						...
						if ((((func_205(Local_98.f_28[2]) && !PED::IS_PED_FLEEING(Local_98.f_28[2])) && !iLocal_387) && !iLocal_465) && !PED::IS_PED_RAGDOLL(Local_98.f_28[2]))
						{
							if (bParam0 || (func_214(Local_98.f_35[1]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[1], 1)))
							{
								...
								else if (func_214(Local_98.f_35[0]))
								{
									...
									AI::TASK_ENTER_VEHICLE(0, Local_98.f_35[0], 20000, 0, 1073741824, 1, 0);
									AI::CLOSE_SEQUENCE_TASK(uVar2);
									AI::TASK_PERFORM_SEQUENCE(Local_98.f_28[2], uVar2);
									AI::CLEAR_SEQUENCE_TASK(&uVar2);
								}
							...
							{
								AI::TASK_ENTER_VEHICLE(Local_98.f_28[2], Local_98.f_35[1], 20000, 0, 1f, 1, 0);
							}
						}
						iLocal_375 = GAMEPLAY::GET_GAME_TIMER() + 1500;
						iLocal_376 = 1;
						iLocal_460 = 3;
						bLocal_391 = false;
					}
...
void func_300()
{
	...
	if (func_205(Local_98.f_28[1]))
	{
		if ((((!func_217(Local_98.f_28[1], 242628503) && !PED::IS_PED_FLEEING(Local_98.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0)) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_481)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 0))
		{
			AI::OPEN_SEQUENCE_TASK(&uVar0);
			if (func_205(Local_98.f_28[0]))
			{
				AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_98.f_28[0], 6000);
			}
			if (func_214(Local_98.f_35[1]) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_98.f_35[1], -1, 0))
			{
				PATHFIND::SET_ROADS_IN_ANGLED_AREA(vLocal_473, vLocal_476, fLocal_479, 0, 1, 1);
				AI::TASK_ENTER_VEHICLE(0, Local_98.f_35[1], 20000, -1, 2f, 1, 0);
			}
			AI::CLOSE_SEQUENCE_TASK(uVar0);
			AI::TASK_PERFORM_SEQUENCE(Local_98.f_28[1], uVar0);
...
void func_303()
{
	switch (iLocal_327)
	{
		case 0:
			...
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_358)
			{
				...
				if (func_338(1, 1093140480, 0))
				{
					if (func_205(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_359, vLocal_362, fLocal_365, 0, 1, 0))
						{
							iLocal_366 = 1;
						}
		...
		case 1:
			...
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				...
				if (iLocal_366 && GAMEPLAY::GET_GAME_TIMER() > iLocal_367)
				{
					if (iLocal_367 < 0)
					{
						iLocal_367 = GAMEPLAY::GET_GAME_TIMER() + 4000;
					}
					else
					{
						ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), 1, 0);
...
void func_313()
{
	...
	if (func_205(Local_98.f_28[0]))
	{
		AI::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[0], uLocal_390, sLocal_377, sLocal_392, 1000f, -4f, 1, 16, 1148846080, 0);
	}
	if (func_205(Local_98.f_28[1]))
	{
		AI::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[1], uLocal_390, sLocal_377, sLocal_393, 1000f, -4f, 1, 16, 1148846080, 0);
	}
	if (func_205(Local_98.f_28[2]))
	{
		AI::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[2], uLocal_390, sLocal_377, sLocal_394, 1000f, -4f, 1, 16, 1148846080, 0);
	}
	bLocal_391 = true;
}
...
int func_338(int iParam0, int iParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_316(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_341()
{
	switch (iLocal_327)
	{
		case 0:
			...
			AI::REQUEST_WAYPOINT_RECORDING(sLocal_480);
			AI::REQUEST_WAYPOINT_RECORDING(sLocal_481);
			...
			if (UI::HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				...
				func_353();
				PATHFIND::SET_ROADS_IN_ANGLED_AREA(vLocal_473, vLocal_476, fLocal_479, 0, 0, 1);
				GAMEPLAY::_REMOVE_STEALTH_KILL(GAMEPLAY::GET_HASH_KEY("ACT_takedown_a"), 0);
				GAMEPLAY::_REMOVE_STEALTH_KILL(GAMEPLAY::GET_HASH_KEY("ACT_takedown_heavy"), 0);
				GAMEPLAY::_REMOVE_STEALTH_KILL(GAMEPLAY::GET_HASH_KEY("ACT_armed_takedown"), 0);
		...
		case 2:
			...
			else
			{
				...
				if ((CAM::IS_SCREEN_FADED_IN() && func_206(Local_98.f_28[0])) && func_226(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 1) > 6f)
				{
					...
					AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], -1, 0, 2);
					iLocal_358 = GAMEPLAY::GET_GAME_TIMER() + 3000;
				}
				else
				{
					iLocal_358 = -1;
...
void func_342()
{
	...
	GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_412, 50f, 0, 0, 0, 0, 0, 0);
	func_313();
	if (func_349())
	{
		func_346(0, -1, 1);
	...
	{
		func_344(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
	}
	func_343(1, 1, 1);
}
...
void func_395()
{
	...
	if (func_205(Local_98.f_28[0]))
	{
		...
		if (!PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], 0))
		{
			AI::TASK_WANDER_STANDARD(Local_98.f_28[0], 1193033728, 0);
		}
	}
	if (func_205(Local_98.f_28[1]) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[1]))
	{
		if (func_205(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				AI::TASK_VEHICLE_DRIVE_WANDER(Local_98.f_28[1], Local_98.f_35[1], 20f, 786597);
			}
	...
	if (func_205(Local_98.f_28[2]) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[2]))
	{
		...
		if (func_205(PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[2], 1))
			{
				...
				if (func_214(uVar0) && (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uVar0, 1) || !func_205(Local_98.f_28[0])))
				{
					AI::OPEN_SEQUENCE_TASK(&uVar1);
					AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 320);
					AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uVar1);
					AI::TASK_PERFORM_SEQUENCE(Local_98.f_28[2], uVar1);
					AI::CLEAR_SEQUENCE_TASK(&uVar1);
				}
			}
		...
		{
			AI::TASK_WANDER_STANDARD(Local_98.f_28[2], 1193033728, 0);
		}
	}
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
	GAMEPLAY::_REMOVE_STEALTH_KILL(GAMEPLAY::GET_HASH_KEY("ACT_takedown_a"), 1);
	GAMEPLAY::_REMOVE_STEALTH_KILL(GAMEPLAY::GET_HASH_KEY("ACT_takedown_heavy"), 1);
	GAMEPLAY::_REMOVE_STEALTH_KILL(GAMEPLAY::GET_HASH_KEY("ACT_armed_takedown"), 1);
	STREAMING::REMOVE_ANIM_DICT(sLocal_377);
	STREAMING::REMOVE_ANIM_DICT(sLocal_380);
	if (AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_480))
	{
		AI::REMOVE_WAYPOINT_RECORDING(sLocal_480);
	}
	if (AI::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_481))
	{
		AI::REMOVE_WAYPOINT_RECORDING(sLocal_481);
	}
	AUDIO::STOP_SOUND(uLocal_488);
	func_211(&uLocal_159);
	func_223(&(Local_98.f_41[0]), 0);
...
void func_396(var uParam0, int iParam1, int iParam2)
{
	...
	{
		AI::TASK_PLAY_ANIM(0, sLocal_380, sLocal_382, 8f, -8f, -1, 8192, 0, 0, 0, 0);
		iLocal_466 = 0;
	}
	AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
	AI::CLOSE_SEQUENCE_TASK(uVar0);
