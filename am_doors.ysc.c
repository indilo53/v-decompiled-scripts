...
void func_1()
{
	...
	while (iLocal_173 < 6)
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(Local_225[iLocal_172 /*4*/].f_2, iLocal_173))
			{
...
void func_9()
{
	...
	if ((GAMEPLAY::IS_BIT_SET(Global_2533185, iLocal_174) || GAMEPLAY::IS_BIT_SET(Global_2533185.f_1, iLocal_174)) || GAMEPLAY::IS_BIT_SET(Global_2533185.f_2, iLocal_174))
	{
		if (GAMEPLAY::IS_BIT_SET(Global_2533185, iLocal_174))
		{
			GAMEPLAY::SET_BIT(&(Local_225[PLAYER::PLAYER_ID() /*4*/].f_2), iLocal_174);
		}
		if (GAMEPLAY::IS_BIT_SET(Global_2533185.f_1, iLocal_174))
		{
			GAMEPLAY::CLEAR_BIT(&(Local_225[PLAYER::PLAYER_ID() /*4*/].f_2), iLocal_174);
		}
		if (GAMEPLAY::IS_BIT_SET(Global_2533185.f_2, iLocal_174))
		{
			GAMEPLAY::SET_BIT(&(Local_225[PLAYER::PLAYER_ID() /*4*/].f_3), iLocal_174);
		}
	}
	else if (fVar0 <= 20f)
	{
		...
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_225[PLAYER::PLAYER_ID() /*4*/].f_2, iLocal_174))
			{
				GAMEPLAY::SET_BIT(&(Local_225[PLAYER::PLAYER_ID() /*4*/].f_2), iLocal_174);
			}
		}
		...
		if ((iLocal_174 == 2 || iLocal_174 == 3) || iLocal_174 == 4)
		{
			if (func_11() >= 0)
			{
				...
				else if (GAMEPLAY::IS_BIT_SET(Local_225[PLAYER::PLAYER_ID() /*4*/].f_2, iLocal_174) && !OBJECT::IS_POINT_IN_ANGLED_AREA(vVar1, Local_69[iLocal_174 /*17*/].f_3, Local_69[iLocal_174 /*17*/].f_6, Local_69[iLocal_174 /*17*/].f_9, 0, 1))
				{
					GAMEPLAY::CLEAR_BIT(&(Local_225[PLAYER::PLAYER_ID() /*4*/].f_2), iLocal_174);
				}
			}
	...
	else if (GAMEPLAY::IS_BIT_SET(Local_225[PLAYER::PLAYER_ID() /*4*/].f_2, iLocal_174))
	{
		GAMEPLAY::CLEAR_BIT(&(Local_225[PLAYER::PLAYER_ID() /*4*/].f_2), iLocal_174);
	}
	iLocal_174++;
