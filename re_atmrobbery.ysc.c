				...
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_100, fLocal_135, fLocal_135, fLocal_135, 0, 1, 0) && !func_97())
				{
					...
					if (!func_121())
					{
						if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
						{
							if (func_93(1, 0, 1))
							{
								if (!GAMEPLAY::IS_BIT_SET(Global_2423, 11) || func_92())
								{
									if (!PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
									{
										...
										if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
										{
											...
											{
												while ((!func_80(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), uLocal_136, 1, 1056964608, 0, 1, 0) || func_91()) || !ENTITY::DOES_ENTITY_HAVE_DRAWABLE(uLocal_101))
												{
													if (!func_80(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), uLocal_136, 1, 1056964608, 0, 1, 0))
													{
													}
													if (func_91())
													{
										...
										{
											while (func_91() || !ENTITY::DOES_ENTITY_HAVE_DRAWABLE(uLocal_101))
											{
												SYSTEM::WAIT(0);
											}
										}
					...
					if (((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_PRONE(PLAYER::PLAYER_PED_ID())) && !AI::IS_PED_GETTING_UP(PLAYER::PLAYER_PED_ID()))
					{
						...
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
						{
							if (!VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
							{
								...
								{
									if (func_67(vLocal_95, -526.58f, -1222.79f, 17.46f, 10f, 0) && (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -529.7477f, -1218.399f, 16.78482f, -538.9778f, -1213.756f, 20.53685f, 7.5f, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -529.7477f, -1218.399f, 16.78482f, -520.9798f, -1222.305f, 20.55204f, 7.5f, 0, 1, 0)))
									{
...
void func_110()
{
	...
	switch (iLocal_109)
	{
		...
		case 2:
			...
			else if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_117, 0) || !func_175(iLocal_99, -1273030092))
			{
				bVar0 = true;
			}
...
void func_116(var uParam0, var uParam1)
{
	if (UI::DOES_BLIP_EXIST(uParam0))
	{
		...
		if (!UI::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_117(0))
		{
			func_99(1);
		}
	}
	...
	if (func_109(PLAYER::PLAYER_PED_ID()) && func_109(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_138(PLAYER::PLAYER_PED_ID(), iParam0, iParam2);
				}
			}
		}
		if (bParam4)
...
int func_132(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_134(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_139(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_109(PLAYER::PLAYER_PED_ID()) && func_109(uParam0))
	{
...
int func_142(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_134(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_134(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_133(vVar3, vVar0);
...
void func_148(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_171(uParam1) && ENTITY::IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
int func_152(char* sParam0)
{
	if (!func_153(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_95(sParam0)) || func_95("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_153(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_161() || func_160(Global_4456448.f_161209)) || func_159())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_157(uVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_217()
{
	if ((Global_106554 == func_218() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_242(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_245()
{
	...
	func_251(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_250(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_249(&uVar0, TIME::GET_CLOCK_HOURS());
	func_248(&uVar0, TIME::GET_CLOCK_DAY_OF_MONTH());
	func_247(&uVar0, TIME::GET_CLOCK_MONTH());
	func_246(&uVar0, TIME::GET_CLOCK_YEAR());
	return uVar0;
}
