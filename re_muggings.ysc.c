	...
	if (!PED::IS_PED_INJURED(uLocal_62))
	{
		if (!bLocal_152)
		{
			if (iLocal_153)
			{
						...
						if (func_118(1, 0, 1))
						{
							if (!func_117())
							{
								if (!PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
								{
									...
									if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
									{
										while (!func_107(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), uLocal_77, 1, 1056964608, 0, 1, 0) || func_161())
										{
				...
				{
					func_103(ENTITY::GET_ENTITY_COORDS(uLocal_62, 1), &uLocal_76, &uLocal_77);
				}
			}
		...
		if (bLocal_152)
		{
			switch (iLocal_151)
			{
				...
				case 1:
					if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_131) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_131) > 0.9f) || func_96(1000))
					{
						PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 1, 0);
...
void func_64(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_66() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_66() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
int func_72(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_66() /*10778*/].f_6165.f_10, iParam0);
}
...
void func_100(var uParam0, var uParam1, var uParam2, char[4] cParam3, char* sParam4)
{
	...
	*uParam1 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0) };
	uParam2->f_2 = func_102(uParam0, PLAYER::PLAYER_PED_ID(), 1);
	fVar3 = func_102(uParam0, PLAYER::PLAYER_PED_ID(), 1);
	fVar4 = func_102(uParam0, PLAYER::PLAYER_PED_ID(), 1);
	...
	while (iVar0 < 2)
	{
		switch (iVar0)
		{
			case 0:
				if (iVar1 > 20)
				{
					uParam2->f_2 = func_101(ENTITY::GET_ENTITY_COORDS(uParam0, 0), *uParam1, 1);
...
int func_139(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (ENTITY::IS_ENTITY_A_VEHICLE(uParam0))
	{
		UI::SET_BLIP_SCALE(uVar0, func_140(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_140(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
	else if (ENTITY::IS_ENTITY_AN_OBJECT(uParam0))
	{
...
void func_143(var uParam0, var uParam1)
{
	if (UI::DOES_BLIP_EXIST(uParam0))
	{
		...
		if (!UI::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_144(0))
		{
			func_134(1);
		}
	}
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_158(iParam2), 1);
}
...
int func_190()
{
	if ((Global_106554 == func_191() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
void func_199()
{
	...
	if (iLocal_190 && !bLocal_137)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_63) && ENTITY::DOES_ENTITY_EXIST(uLocal_63))
		{
			if (!PED::IS_PED_INJURED(uLocal_62) && !PED::IS_PED_INJURED(uLocal_63))
			{
				if ((((iLocal_188 - iLocal_187) > 12000 && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_63, 3f, 3f, 35f, 0, 1, 0)) && ENTITY::IS_ENTITY_ON_SCREEN(uLocal_63)) && !func_161())
				{
