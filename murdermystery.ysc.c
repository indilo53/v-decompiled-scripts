...
bool func_16(int iParam0)
{
	...
	iVar1 = GAMEPLAY::GET_BITS_IN_RANGE(Global_106565.f_10043.f_133, 0, (iVar0 - 1));
...
void func_27(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		GAMEPLAY::SET_BIT(&uLocal_92, iParam0);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&uLocal_92, iParam0);
	}
}

bool func_28(int iParam0)
{
	return GAMEPLAY::IS_BIT_SET(uLocal_92, iParam0);
}
	...
	switch (iLocal_72)
	{
		...
		case 2:
			...
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				while ((!STREAMING::IS_NEW_LOAD_SCENE_LOADED() || !INTERIOR::IS_INTERIOR_READY(iLocal_71)) && iLocal_86 > GAMEPLAY::GET_GAME_TIMER())
				{
					SYSTEM::WAIT(0);
				}
...
void func_61(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
		GAMEPLAY::SET_BIT(&(Global_106565.f_10043.f_133), iParam0);
		if (!bParam2)
		{
	...
	{
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_10043.f_133), iParam0);
	}
}
...
{
	return GAMEPLAY::IS_BIT_SET(Global_106565.f_10043.f_133, iParam0);
}
...
void func_77()
{
	switch (iLocal_85)
	{
		...
		case 4:
			func_79(-671910391);
			func_78(sLocal_88);
			uLocal_78 = PED::CREATE_PED(26, -671910391, func_68(4), 184.5548f, 1, 1);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-671910391);
			AI::TASK_PLAY_ANIM(uLocal_78, sLocal_88, sLocal_89, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
			...
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_78, 1862763509);
			break;
		...
		case 6:
			func_79(732742363);
			uLocal_76 = PED::CREATE_PED(26, 732742363, func_68(6), 22.9631f, 1, 1);
			PED::SET_PED_PROP_INDEX(uLocal_76, 0, 0, 0, 0);
			...
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_76, 1862763509);
			uLocal_77 = OBJECT::CREATE_OBJECT_NO_OFFSET(130556722, -543.71f, 1986.2f, 126.05f, 1, 1, 0);
			break;
	}
}
...
void func_84()
{
	switch (iLocal_85)
	{
		...
		case 4:
			...
			{
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uLocal_78);
			}
		...
		case 6:
			...
			{
				ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_77);
			}
			if (func_28(2))
			{
