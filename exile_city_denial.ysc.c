	...
	while (true)
	{
		...
		if (bLocal_30 != bLocal_29)
		{
			...
			if (bLocal_29 && !bVar6)
			{
				...
				if (bVar7)
				{
					...
					{
						if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_7682.f_923, 0))
						{
							func_10(1628462442, 7, 1, 31, 3, 10000, 20000, -1, -1, 150, -1, 1024);
						}
						else if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_7682.f_923, 1))
						{
							func_10(1791324372, 7, 1, 31, 3, 10000, 20000, -1, -1, 150, -1, 1024);
						}
						else if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_7682.f_923, 2))
						{
					...
					{
						if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_7682.f_923, 3))
						{
							func_10(1806999335, 7, 4, 31, 3, 10000, 20000, -1, -1, 151, -1, 1024);
						}
						else if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_7682.f_923, 4))
						{
					...
					if (iVar1 == 0 && !bVar6)
					{
						...
						{
							if (GAMEPLAY::_GET_NUMBER_OF_DISPATCHED_UNITS_FOR_PLAYER(11) < 256)
							{
								if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
								{
									if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		...
		if (bLocal_29 && SYSTEM::TIMERB() > 60000)
		{
			...
			if (iVar0 < 8)
			{
				...
				else if (GAMEPLAY::_GET_NUMBER_OF_DISPATCHED_UNITS_FOR_PLAYER(11) < 256)
				{
					if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_5(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		GAMEPLAY::SET_BIT(&(Global_106565.f_7223.f_17[iParam0]), 0);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_7223.f_17[iParam0]), 0);
	}
	GAMEPLAY::DISABLE_POLICE_RESTART(Global_88851[iParam0 /*9*/].f_8, !bParam1);
...
void func_7(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		GAMEPLAY::SET_BIT(&(Global_106565.f_7223.f_11[iParam0]), 0);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_7223.f_11[iParam0]), 0);
	}
	GAMEPLAY::DISABLE_HOSPITAL_RESTART(Global_88915[iParam0 /*9*/].f_8, !bParam1);
