			...
			switch (iLocal_95)
			{
				...
				case 3:
					...
					if (!func_85(iLocal_100))
					{
						...
						{
							bVar1 = true;
							if (GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_93682.f_3), &cLocal_69))
							{
								cLocal_69 = { Local_53 };
								bVar1 = false;
							}
					...
					else
					{
						...
						if (bVar2)
						{
							...
							{
								if (!ENTITY::IS_ENTITY_AT_COORD(PED::GET_VEHICLE_PED_IS_IN(uLocal_85, 0), ScriptParam_0.f_1[0 /*3*/], fLocal_117, fLocal_117, 20f, 0, 0, iLocal_103))
								{
									bVar2 = false;
								}
							}
							else if (!ENTITY::IS_ENTITY_AT_COORD(uLocal_85, ScriptParam_0.f_1[0 /*3*/], fLocal_117, fLocal_117, 2f, 0, 1, iLocal_103))
							{
								bVar2 = false;
							}
							if (!ENTITY::IS_ENTITY_AT_COORD(uLocal_85, ScriptParam_0.f_1[0 /*3*/], fLocal_117, fLocal_117, 2f, 0, 1, 0))
							{
								func_59(&uLocal_94, 128);
								bVar2 = false;
							}
...
void func_23()
{
	...
	if (PED::GET_CLOSEST_PED(-1370.625f, 56.1227f, 52.7033f, 100f, 1, 1, &uVar0, 0, 0, -1))
	{
		...
		{
			iVar102 = PED::GET_PED_NEARBY_PEDS(uVar0, &uVar1, -1);
...
void func_37()
{
	if (ENTITY::IS_ENTITY_AT_COORD(uLocal_85, vLocal_90, fLocal_117, fLocal_117, 2f, 0, 1, iLocal_103))
	{
