...
int func_1(var uParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		switch (uParam0->f_6)
		{
			...
			case 2:
				if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
				{
					...
					else if (AUDIO::PREPARE_MUSIC_EVENT("FM_INTRO_START") && (STREAMING::IS_NEW_LOAD_SCENE_LOADED() || func_127(&(uParam0->f_17), 5000, 0)))
					{
			...
			case 19:
				...
				func_88(uParam0);
				func_125(uParam0, 19);
				if (func_123(uParam0, 19, 0) && GAMEPLAY::IS_BIT_SET(uParam0->f_3, 0))
				{
			...
			case 28:
				...
				func_125(uParam0, 28);
				if ((AUDIO::PREPARE_MUSIC_EVENT("FM_INTRO_DRIVE_START") && GAMEPLAY::IS_BIT_SET(uParam0->f_3, 3)) && func_123(uParam0, 28, 0))
				{
					uParam0->f_6 = 29;
				}
				break;
			...
			case 31:
				...
				if ((func_66(uParam0) && func_65(uParam0)) && !CUTSCENE::IS_CUTSCENE_PLAYING())
				{
					if (uParam0->f_293)
					{
			...
			case 49:
				...
				func_125(uParam0, 49);
				if (AUDIO::PREPARE_MUSIC_EVENT("FM_INTRO_DRIVE_END") && func_123(uParam0, 49, 0))
				{
			...
			case 50:
				...
				if (func_123(uParam0, 50, 0) && GAMEPLAY::IS_BIT_SET(*uParam0, 20))
				{
			...
			case 56:
				...
				else if (func_127(&(uParam0->f_17), 10000, 0))
				{
					if (func_101(uParam0))
					{
						...
						NETWORK::NETWORK_OVERRIDE_CLOCK_TIME(0, 0, 0);
						GAMEPLAY::SET_BIT(&(Global_1589819[PLAYER::PLAYER_ID() /*818*/].f_142), 3);
						uParam0->f_13 = (GAMEPLAY::GET_GAME_TIMER() - func_28(uParam0, 48, 0));
						uParam0->f_293 = 1;
						func_39(uParam0, 10177.75f);
						GAMEPLAY::SET_BIT(uParam0, 15);
						uParam0->f_6 = 49;
		...
		if (!uParam0->f_291)
		{
			...
			{
				uParam0->f_289 = SYSTEM::TO_FLOAT(func_36(uParam0));
			}
		...
		while (iVar0 < 1)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_98[iVar0]))
			{
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_92[iVar0]))
				{
					...
					{
						uParam0->f_98[iVar0] = PED::CREATE_PED_INSIDE_VEHICLE(uParam0->f_92[iVar0], 4, func_62(), -1, 0, 0);
...
void func_78(var uParam0)
{
	...
	while (iVar0 < 7)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_104[iVar0], 0))
		{
			...
			CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uParam0->f_104[iVar0], func_79(iVar0), 0, 0, 64);
		}
		iVar0++;
	}
}
			...
			while (iVar1 <= 4)
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_98[iVar1]))
				{
					if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_92[iVar1]))
					{
						...
						{
							uParam0->f_98[iVar1] = PED::CREATE_PED_INSIDE_VEHICLE(uParam0->f_92[iVar1], 4, func_62(), -1, 0, 0);
		...
		if ((STREAMING::HAS_MODEL_LOADED(joaat("asterope")) && STREAMING::HAS_MODEL_LOADED(joaat("sentinel"))) && STREAMING::HAS_MODEL_LOADED(func_62()))
		{
			...
			while (iVar0 < 15)
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_58[iVar0]))
				{
					...
					{
						uParam0->f_74[iVar0] = PED::CREATE_PED_INSIDE_VEHICLE(uParam0->f_58[iVar0], 4, func_62(), -1, 0, 0);
...
void func_125(var uParam0, int iParam1)
{
	if (func_123(uParam0, iParam1, 0))
	{
		if (uParam0->f_293)
		{
			uParam0->f_13 = (GAMEPLAY::GET_GAME_TIMER() - func_28(uParam0, iParam1, 0));
		}
		else
		{
			uParam0->f_291 = 1;
...
{
	if (func_166(PLAYER::PLAYER_ID()) && GAMEPLAY::IS_BIT_SET(Global_1671295.f_4, 22))
	{
		return 0;
	}
	if (Global_1315680)
...
void func_178(int iParam0)
{
	...
	if (func_180() == 0 || UI::IS_PAUSE_MENU_ACTIVE())
	{
		func_179(1);
...
void func_182(int iParam0)
{
	...
	if ((func_180() == 1 || UI::IS_PAUSE_MENU_ACTIVE()) || iParam0)
	{
		func_179(0);
...
void func_189(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (bParam1)
			{
				if (!func_193(uVar25) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar25))
				{
					if (!bVar21)
					{
