...
int func_2()
{
	...
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_237, 1) > 100f)
	{
		return 1;
	}
	return 0;
...
void func_14(var uParam0, var uParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { 0f, fParam2, 0f };
	vVar3 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam1, vVar0) };
	AI::OPEN_SEQUENCE_TASK(&uVar6);
	AI::TASK_VEHICLE_DRIVE_TO_COORD(0, uParam1, vVar3, fParam2, 0, ENTITY::GET_ENTITY_MODEL(uParam1), iParam3, 2f, 5f);
...
void func_32()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < 12)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_77[iVar0]))
			{
				...
				{
					GAMEPLAY::CLEAR_AREA(vLocal_237 + vLocal_103[iVar0 /*3*/], 10f, 1, 0, 0, 0);
					iLocal_77[iVar0] = VEHICLE::CREATE_VEHICLE(iLocal_90[iVar0], vLocal_237 + vLocal_103[iVar0 /*3*/], (fLocal_240 + uLocal_140[iVar0]), 1, 1, 0);
		...
		while (iVar0 < 4)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_153[iVar0]))
			{
				...
				{
					GAMEPLAY::CLEAR_AREA(vLocal_237 + vLocal_163[iVar0 /*3*/], 10f, 1, 0, 0, 0);
					iLocal_153[iVar0] = VEHICLE::CREATE_VEHICLE(iLocal_158[iVar0], vLocal_237 + vLocal_163[iVar0 /*3*/], (fLocal_240 + uLocal_176[iVar0]), 1, 1, 0);
		...
		while (iVar0 < 4)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_181[iVar0]))
			{
				...
				{
					GAMEPLAY::CLEAR_AREA(vLocal_237 + vLocal_191[iVar0 /*3*/], 10f, 1, 0, 0, 0);
					iLocal_181[iVar0] = VEHICLE::CREATE_VEHICLE(iLocal_186[iVar0], vLocal_237 + vLocal_191[iVar0 /*3*/], (fLocal_240 + uLocal_204[iVar0]), 1, 1, 0);
		...
		while (iVar0 < 4)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_209[iVar0]))
			{
				...
				{
					GAMEPLAY::CLEAR_AREA(vLocal_237 + vLocal_219[iVar0 /*3*/], 10f, 1, 0, 0, 0);
					iLocal_209[iVar0] = VEHICLE::CREATE_VEHICLE(iLocal_214[iVar0], vLocal_237 + vLocal_219[iVar0 /*3*/], (fLocal_240 + uLocal_232[iVar0]), 1, 1, 0);
	...
	while (iVar0 < 12)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_77[iVar0], 0))
		{
			uVar3 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_77[iVar0], 4, iLocal_72[func_35()], -1, 1, 1);
			func_33(uVar3);
			ENTITY::_SET_ENTITY_SOMETHING(iLocal_77[iVar0], 1);
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_153[iVar0], 0))
		{
			...
			{
				uVar4 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_153[iVar0], 4, iLocal_72[func_35()], -1, 1, 1);
				func_33(uVar4);
				ENTITY::_SET_ENTITY_SOMETHING(iLocal_77[iVar0], 1);
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_181[iVar0], 0))
		{
			...
			{
				uVar5 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_181[iVar0], 4, iLocal_72[func_35()], -1, 1, 1);
				func_33(uVar5);
				ENTITY::_SET_ENTITY_SOMETHING(iLocal_77[iVar0], 1);
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_209[iVar0], 0))
		{
			...
			{
				uVar6 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_209[iVar0], 4, iLocal_72[func_35()], -1, 1, 1);
				func_33(uVar6);
				ENTITY::_SET_ENTITY_SOMETHING(iLocal_77[iVar0], 1);
...
void func_33(var uParam0)
{
	...
	{
		if (PED::GET_PED_DRAWABLE_VARIATION(uParam0, 3) == 1)
		{
			if (func_34())
			{
				PED::SET_PED_COMPONENT_VARIATION(uParam0, 3, 0, PED::GET_PED_TEXTURE_VARIATION(uParam0, 3), 0);
			}
			else
			{
				PED::SET_PED_COMPONENT_VARIATION(uParam0, 3, 2, PED::GET_PED_TEXTURE_VARIATION(uParam0, 3), 0);
			}
		}
	}
}
...
{
	return GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(iParam0, iParam1), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(iParam0, iParam1), 0f;
}
