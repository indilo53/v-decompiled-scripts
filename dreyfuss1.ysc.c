...
void __EntryFunction__()
{
	...
	if (func_431(Local_86.f_28[0]))
	{
		...
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uLocal_156, 1, 1);
	}
	func_430();
	if (func_441())
	{
...
{
	if (GAMEPLAY::IS_BIT_SET(Global_93682.f_20, 17))
	{
		return 0;
	}
...
void func_240()
{
	switch (iLocal_155)
	{
		case 0:
			...
			if (UI::DOES_BLIP_EXIST(uLocal_157))
			{
				UI::SET_BLIP_SCALE(uLocal_157, 0.7f);
			}
			if (func_431(uLocal_156))
			{
				AI::OPEN_SEQUENCE_TASK(&uLocal_160);
				if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_156, 0))
				{
					AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
				}
				AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(uLocal_160);
				AI::TASK_PERFORM_SEQUENCE(uLocal_156, uLocal_160);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_160);
			}
			func_237();
			iLocal_537 = 0;
			iLocal_155 = 1;
		...
		case 1:
			...
			if (!func_431(uLocal_156))
			{
				...
				if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_18568.f_382, 0))
				{
					GAMEPLAY::SET_BIT(&(Global_106565.f_18568.f_382), 0);
				}
				func_290(4);
			}
			else if (func_288(PLAYER::PLAYER_PED_ID(), uLocal_156) > 250f)
			{
			...
			else
			{
				...
				func_241();
				AI::SET_PED_DESIRED_MOVE_BLEND_RATIO(uLocal_156, 1.8f);
			}
			break;
...
void func_241()
{
	if (!bLocal_507)
	{
		if (func_253(PLAYER::PLAYER_PED_ID(), uLocal_156, fLocal_334, 1))
		{
			if (PED::IS_PED_BEING_JACKED(uLocal_156))
			{
...
void func_242(int iParam0, int iParam1, int iParam2, var uParam3, char* sParam4, char* sParam5, bool bParam6)
{
	...
	if (!*uParam3)
	{
		if (!iLocal_537)
		{
			if (!*iParam0)
			{
				if ((func_243(uLocal_156) && !PED::IS_PED_RAGDOLL(uLocal_156)) && !AI::IS_PED_IN_WRITHE(uLocal_156))
				{
					if (func_253(PLAYER::PLAYER_PED_ID(), uLocal_156, fLocal_334, 1))
					{
						if (!func_236())
	...
	else if ((bParam6 && !iLocal_548 == 0) && !func_236())
	{
		...
		if (iLocal_548 == 1 && ENTITY::DOES_ENTITY_EXIST(uLocal_156))
		{
			ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_156);
		}
		iLocal_548 = 0;
	}
}
...
int func_244(int iParam0)
{
	if (iLocal_548 == 0)
	{
		...
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_156, PLAYER::PLAYER_PED_ID(), iParam0) && iLocal_519 < 4)
		{
			func_237();
			iLocal_548 = 1;
		}
...
int func_245(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_431(PLAYER::PLAYER_PED_ID()) && func_431(uParam0))
	{
...
int func_248(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_250(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_250(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_266(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_274() || func_273(Global_4456448.f_161209)) || func_272())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_270(uVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_292()
{
	if (func_431(uLocal_156))
	{
		if (WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(uLocal_156, joaat("weapon_stungun"), 0))
		{
			if (func_431(uLocal_156))
			{
				ENTITY::SET_ENTITY_HEALTH(uLocal_156, 99, 0);
			}
		}
	}
}
	...
	switch (iLocal_155)
	{
		case 0:
			...
			if (func_431(Local_86.f_35[0]))
			{
				...
				while (iVar0 < 3)
				{
					vLocal_526[iVar0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Local_86.f_35[0], 1) };
					iVar0++;
				}
			}
			iLocal_536 = GAMEPLAY::GET_GAME_TIMER();
			iLocal_333 = 0;
			iLocal_537 = 0;
			iLocal_155 = 1;
			break;
		...
		case 1:
			...
			else
			{
				if (func_431(Local_86.f_35[0]))
				{
					...
					if (((!iLocal_332 && !iLocal_333) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(uLocal_156)) && !ENTITY::IS_ENTITY_AT_COORD(Local_86.f_35[0], -1474.445f, 519.4703f, 117.0069f, 15f, 15f, 15f, 0, 1, 0))
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_156, Local_86.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 90f, 786469, 100f, 1f, 1);
						iLocal_333 = 1;
					}
				}
				func_244(0);
				func_257(&uLocal_549, uLocal_156, 0, 0, 1, 1, 1);
				if (((!iLocal_332 && func_253(PLAYER::PLAYER_PED_ID(), uLocal_156, 10f, 1)) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID())) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(uLocal_156))
				{
					AI::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_156, Local_86.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 90f, 786468, 100f, 1f, 1);
					iLocal_332 = 1;
				}
				if (!func_299())
				{
...
void func_294()
{
	if (func_431(Local_86.f_35[0]))
	{
		...
		else if (PED::IS_PED_BEING_JACKED(uLocal_156) || !func_3(Local_86.f_35[0]))
		{
			iLocal_332 = 1;
			func_290(3);
		}
...
int func_295()
{
	if (func_431(Local_86.f_35[0]))
	{
		if (PED::IS_PED_IN_VEHICLE(uLocal_156, Local_86.f_35[0], 0))
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_536) > 3000)
			{
				func_297();
...
void func_297()
{
	...
	vLocal_526[2 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Local_86.f_35[0], 1) };
}
...
int func_300(int iParam0)
{
	...
	uVar0 = VEHICLE::GET_CLOSEST_VEHICLE(ENTITY::GET_ENTITY_COORDS(Local_86.f_35[0], 1), 20f, iParam0, 6);
	if (ENTITY::DOES_ENTITY_EXIST(uVar0))
	{
		if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uVar0, Local_86.f_35[0]))
		{
...
void func_301()
{
	switch (iLocal_155)
	{
		case 0:
			...
			if (func_431(uLocal_156))
			{
				PED::SET_PED_MIN_MOVE_BLEND_RATIO(uLocal_156, 3f);
				if (!UI::DOES_BLIP_EXIST(uLocal_157))
				{
				...
				if (func_3(Local_86.f_35[0]))
				{
					...
					AI::TASK_ENTER_VEHICLE(0, Local_86.f_35[0], 20000, -1, 3f, 1, 0);
					AI::TASK_VEHICLE_DRIVE_WANDER(0, Local_86.f_35[0], 15f, 262144);
					AI::CLOSE_SEQUENCE_TASK(uLocal_159);
					AI::TASK_PERFORM_SEQUENCE(uLocal_156, uLocal_159);
					uLocal_330 = VEHICLE::_ADD_SPEED_ZONE_FOR_COORD(ENTITY::GET_ENTITY_COORDS(Local_86.f_35[0], 1), 100f, 10f, 0);
				}
				else
				{
					AI::TASK_SMART_FLEE_PED(uLocal_156, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_161))
			{
				...
				uLocal_161 = VEHICLE::CREATE_VEHICLE(iLocal_162, -1482.366f, 529.0344f, 117.2725f, 201.5764f, 1, 1, 0);
		...
		case 1:
			...
			else
			{
				...
				if (iLocal_331)
				{
					if (func_431(uLocal_156))
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_158) > 3000)
						{
							PED::SET_PED_MIN_MOVE_BLEND_RATIO(uLocal_156, 3f);
						}
						else
				...
				if ((func_302(242628503) && AI::GET_SEQUENCE_PROGRESS(uLocal_156) > 0) && func_298())
				{
					func_290(3);
				}
			}
...
{
	if (AI::GET_SCRIPT_TASK_STATUS(uLocal_156, iParam0) == 1 || AI::GET_SCRIPT_TASK_STATUS(uLocal_156, iParam0) == 0)
	{
		return 1;
	}
	return 0;
...
int func_303()
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_86.f_35[0]))
	{
		...
		{
			if (AI::GET_SEQUENCE_PROGRESS(uLocal_156) > 0)
			{
				if (!ENTITY::IS_ENTITY_AT_COORD(Local_86.f_35[0], vLocal_82, 20f, 20f, 100f, 0, 1, 0))
				{
					sLocal_423 = "DREY1_CGONE";
					iLocal_332 = 1;
					func_290(3);
				...
				else if (!ENTITY::IS_ENTITY_AT_COORD(Local_86.f_35[0], vLocal_82, 5f, 5f, 100f, 0, 1, 0))
				{
...
int func_304(var uParam0, var uParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_250(ENTITY::GET_ENTITY_COORDS(uParam1, 1) - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
...
void func_305()
{
	...
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(uLocal_156, Local_86.f_35[0]))
		{
			if (UI::DOES_BLIP_EXIST(uLocal_157))
			{
				UI::SET_BLIP_SCALE(uLocal_157, 1f);
			}
			iLocal_155 = 2;
		}
	}
...
void func_311()
{
	switch (iLocal_155)
	{
		case 0:
			...
			if (((CAM::IS_SCREEN_FADED_IN() && !func_441()) && func_431(uLocal_156)) && func_289(PLAYER::PLAYER_PED_ID(), Local_86.f_28[0], 1) > 4f)
			{
				CAM::SET_GAMEPLAY_ENTITY_HINT(uLocal_156, 0f, 0f, -0.5f, 1, -1, 3000, 2000, 0);
			...
			uLocal_565 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1459.57f, 485.16f, 115.2f, 10f, joaat("prop_yoga_mat_02"), 1, 0, 1);
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_565))
			{
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_565, 1);
			}
			iLocal_155 = 1;
			iLocal_564 = 0;
			break;
			...
			switch (iLocal_562)
			{
				case 0:
					if (func_431(PLAYER::PLAYER_PED_ID()))
					{
						...
						{
							AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_156, -1, 0, 2);
							iLocal_562++;
						}
					}
					break;
				...
				case 1:
					if (func_431(PLAYER::PLAYER_PED_ID()))
					{
						...
						if (!func_236() && func_382(1, 1093140480, 0))
						{
							if (func_431(uLocal_156))
							{
								CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_156, sLocal_164, 0, 0, 0);
							}
							func_381();
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-1473.376f, 517.8441f, 116.8854f, 30f, 0, 0, 0, 0, 0, 0);
						func_306(500, 0);
						iLocal_562++;
					}
					break;
				...
				case 3:
					...
					else
					{
						...
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Dreyfuss", 0) && func_431(uLocal_156))
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_156, -1475.366f, 500.3797f, 116.6013f, 3f, 20000, 0.25f, 1, 1193033728);
						}
					}
					break;
			}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_371(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_368(ENTITY::GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_351(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_388()
{
	...
	if (iLocal_564 == 0)
	{
		if (func_431(uLocal_156))
		{
			if (func_289(PLAYER::PLAYER_PED_ID(), uLocal_156, 1) < 3f)
			{
				iLocal_564 = 1;
				PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 0);
				AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
				AI::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_156, 0);
			}
		}
	}
}
...
void func_413(int iParam0)
{
	...
	GAMEPLAY::CLEAR_AREA(-1462.177f, 485.6856f, 115.2016f, 200f, 1, 0, 0, 0);
	if (!func_424())
	{
	...
	if (!func_424())
	{
		func_416(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f, 12, 5000, 0, 0);
	}
	func_415(0, -1, 1);
	if (iParam0 == 1)
	{
...
void func_419()
{
	...
	if (func_431(uLocal_156))
	{
		...
		PED::SET_PED_CONFIG_FLAG(uLocal_156, 177, 1);
		PED::SET_PED_CAN_BE_TARGETTED(uLocal_156, 1);
		ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(uLocal_156, 1, 0);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_156, 1, 1);
		AI::SET_PED_PATHS_WIDTH_PLANT(uLocal_156, 0);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_156, 1);
		PED::SET_PED_CONFIG_FLAG(uLocal_156, 281, 1);
		PED::SET_PED_CONFIG_FLAG(uLocal_156, 42, 1);
	}
}
...
int func_421(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	...
	if (!func_159(iParam1))
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(iVar0))
		{
			...
			*uParam0 = PED::CREATE_PED(26, iVar0, vParam2, fParam5, 0, 0);
...
void func_430()
{
	...
	func_426();
	GAMEPLAY::CLEAR_BIT(&(Global_106565.f_18568.f_382), 0);
...
int func_434(var uParam0)
{
	...
	switch (iLocal_79)
	{
		...
		case 3:
			...
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-1471.166f, 510.6191f, 115.8419f, 4f, 0, 0, 0, 0, 0, 0);
			func_432(0);
			return 1;
			break;
	}
...
void func_453()
{
	...
	{
		PED::SET_PED_KEEP_TASK(uLocal_156, 1);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_156, 0, 1);
	}
