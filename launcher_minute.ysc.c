...
void __EntryFunction__()
{
	...
	if (Var0 == 32)
	{
		...
		GAMEPLAY::CLEAR_AREA(vVar61, 40f, 1, 0, 0, 0);
	}
	else if (Var0 == 34)
	{
		uLocal_97 = func_243();
	...
	while (true)
	{
		...
		if (Var0 == 32)
		{
			...
			{
				if (!func_205(329.513f, 3402.691f, 36.258f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[1], 1), 1056964608))
				{
...
int func_185(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_126(PLAYER::PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && !func_145()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_189(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_233(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_226(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_226(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_225(vVar3, vVar0);
