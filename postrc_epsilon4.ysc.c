...
void func_1()
{
	...
	{
		if (((((!func_22() && !PED::IS_PED_FLEEING(uLocal_205)) && !PED::IS_PED_RAGDOLL(uLocal_205)) && !PED::IS_PED_PRONE(uLocal_205)) && !PED::IS_PED_INJURED(uLocal_205)) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_205, 0))
		{
			if (func_21(uLocal_205, PLAYER::PLAYER_PED_ID(), 1) <= 2.3f)
			{
		...
		if (func_21(uLocal_205, PLAYER::PLAYER_PED_ID(), 1) > 150f)
		{
			func_3(&uLocal_205);
		}
	}
	...
	if (func_23(uLocal_204))
	{
		...
		{
			if (func_21(uLocal_204, PLAYER::PLAYER_PED_ID(), 1) <= 2.7f)
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_203) > 8000)
				{
