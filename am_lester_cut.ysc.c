		...
		switch (func_202(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			...
			case 2:
				if (func_201() == 2)
				{
					...
					else if (UI::DOES_BLIP_EXIST(Global_1657032))
					{
						func_12();
						UI::SET_BLIP_ROUTE(Global_1657032, 0);
						UI::REMOVE_BLIP(&Global_1657032);
						if (GAMEPLAY::IS_BIT_SET(uLocal_452, 3))
						{
							CUTSCENE::REMOVE_CUTSCENE();
						}
						GAMEPLAY::SET_BIT(&(vLocal_183[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
					}
...
void func_3()
{
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (iLocal_182 == 0)
		{
			GAMEPLAY::CLEAR_BIT(&uLocal_452, 0);
			GAMEPLAY::SET_BIT(&uLocal_452, 1);
			if (Local_103.f_2 != -1)
			{
		...
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar0))
		{
			...
			if (!GAMEPLAY::IS_BIT_SET(vLocal_183[iLocal_182 /*3*/].f_2, 0))
			{
				GAMEPLAY::CLEAR_BIT(&uLocal_452, 1);
			}
			if (func_4(uVar1, 0, 1))
			{
				if (GAMEPLAY::IS_BIT_SET(vLocal_183[iLocal_182 /*3*/].f_2, 1))
				{
					GAMEPLAY::SET_BIT(&uLocal_452, 12);
					if (Local_103.f_2 == -1)
					{
		...
		if (iLocal_182 == 32)
		{
			if (GAMEPLAY::IS_BIT_SET(uLocal_452, 1))
			{
				GAMEPLAY::SET_BIT(&(Local_103.f_1), 0);
			}
			if (!GAMEPLAY::IS_BIT_SET(uLocal_452, 12))
			{
				if (Local_103.f_2 != -1)
				{
					Local_103.f_2 = -1;
...
void func_19()
{
	...
	{
		case 0:
			if (!GAMEPLAY::IS_BIT_SET(uLocal_452, 2))
			{
				if (!GAMEPLAY::IS_BIT_SET(uLocal_452, 5))
				{
					if (!func_199())
					{
						if (!func_198())
			...
			if (!GAMEPLAY::IS_BIT_SET(uLocal_452, 5))
			{
				...
				{
					GAMEPLAY::SET_BIT(&uLocal_452, 5);
					func_12();
					if (UI::DOES_BLIP_EXIST(Global_1657032))
					{
						UI::SET_BLIP_ROUTE(Global_1657032, 0);
						UI::REMOVE_BLIP(&Global_1657032);
					}
				...
				else
				{
					if (UI::DOES_BLIP_EXIST(Global_1657032))
					{
						if (!GAMEPLAY::IS_BIT_SET(uLocal_452, 14))
						{
							if (Local_103.f_2 != -1)
							{
								if (Local_103.f_2 != NETWORK::PARTICIPANT_ID_TO_INT())
								{
									UI::SET_BLIP_COLOUR(Global_1657032, 39);
									UI::SET_BLIP_SCALE(Global_1657032, 0.7f);
									GAMEPLAY::SET_BIT(&uLocal_452, 14);
								}
							}
						}
						else if (Local_103.f_2 == -1 || Local_103.f_2 == NETWORK::PARTICIPANT_ID_TO_INT())
						{
							UI::SET_BLIP_COLOUR(Global_1657032, 0);
							UI::SET_BLIP_SCALE(Global_1657032, 1f);
							GAMEPLAY::CLEAR_BIT(&uLocal_452, 14);
						}
					}
					if (GAMEPLAY::IS_BIT_SET(uLocal_452, 8))
					{
						GAMEPLAY::CLEAR_BIT(&uLocal_452, 8);
					}
					if (func_185())
					{
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
						{
							...
							{
								if (!GAMEPLAY::IS_BIT_SET(vLocal_183[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
								{
									GAMEPLAY::SET_BIT(&(vLocal_183[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 1);
								}
								if (GAMEPLAY::IS_BIT_SET(vLocal_183[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
								{
									if (Local_103.f_2 == NETWORK::PARTICIPANT_ID_TO_INT())
									{
										...
										GAMEPLAY::SET_BIT(&uLocal_452, 25);
										GAMEPLAY::CLEAR_AREA(1274.854f, -1721.154f, 53.6808f, 2f, 1, 0, 0, 1);
										if (bLocal_451)
										{
											func_181();
									...
									{
										if (!GAMEPLAY::IS_BIT_SET(uLocal_452, 13))
										{
											if (func_175(1, 1, 1, 1))
											{
												func_174("FM_LCUT_LRB", -1);
												GAMEPLAY::SET_BIT(&uLocal_452, 13);
											}
										}
									}
								}
					...
					{
						if (!GAMEPLAY::IS_BIT_SET(uLocal_452, 9))
						{
							if (func_175(0, 1, 1, 1))
							{
								if (!func_189())
								{
									...
									if (!UI::DOES_BLIP_EXIST(Global_1657032))
									{
										Global_1657032 = UI::ADD_BLIP_FOR_COORD(Global_1657033);
										UI::SET_BLIP_SPRITE(Global_1657032, 77);
										UI::SET_BLIP_FLASHES(Global_1657032, 1);
										UI::SET_BLIP_FLASH_TIMER(Global_1657032, 7000);
									}
									GAMEPLAY::SET_BIT(&uLocal_452, 2);
									GAMEPLAY::SET_BIT(&uLocal_452, 9);
								}
							}
						}
						if (GAMEPLAY::IS_BIT_SET(vLocal_183[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
						{
							GAMEPLAY::CLEAR_BIT(&(vLocal_183[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 1);
						}
						if (GAMEPLAY::IS_BIT_SET(uLocal_452, 13))
						{
							GAMEPLAY::CLEAR_BIT(&uLocal_452, 13);
						}
					}
				}
			}
				...
				if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
				{
					if (CAM::IS_SCREEN_FADED_IN())
					{
						if ((((!func_192(PLAYER::PLAYER_ID(), 1) && !func_191()) && func_190() == 0) && !func_189()) && !func_187())
						{
							...
							{
								GAMEPLAY::CLEAR_BIT(&uLocal_452, 5);
								GAMEPLAY::CLEAR_BIT(&uLocal_452, 2);
								GAMEPLAY::CLEAR_BIT(&uLocal_452, 3);
								GAMEPLAY::CLEAR_BIT(&uLocal_452, 8);
								func_170(&uLocal_455);
								if (!UI::DOES_BLIP_EXIST(Global_1657032))
								{
		...
		case 3:
			if (!GAMEPLAY::IS_BIT_SET(vLocal_183[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
			{
				GAMEPLAY::SET_BIT(&(vLocal_183[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
			}
			break;
...
int func_83()
{
	...
	{
		case 0:
			if (!GAMEPLAY::IS_BIT_SET(uLocal_452, 18))
			{
				if (!PED::IS_PED_INJURED(uLocal_281))
				{
					uLocal_454 = UI::ADD_BLIP_FOR_ENTITY(uLocal_281);
					UI::SET_BLIP_AS_FRIENDLY(uLocal_454, 1);
					UI::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_454, "FM_LEST_BLP");
					func_127("FM_LEST_GTL", 0);
					GAMEPLAY::SET_BIT(&uLocal_452, 18);
				}
			}
			if (!GAMEPLAY::IS_BIT_SET(uLocal_452, 20))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (!PED::IS_PED_INJURED(uLocal_281))
					{
						...
						{
							uLocal_284 = PED::CREATE_SYNCHRONIZED_SCENE(1276.39f, -1712.845f, 54.372f, 0f, 0f, -155.52f, 2);
							AI::TASK_SYNCHRONIZED_SCENE(uLocal_281, uLocal_284, "missfinale_c2leadinoutfin_c_int", "_LEADIN_ACTION_LESTER", 1000f, -8f, 5, 16, 1148846080, 0);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_283, uLocal_284, "_LEADIN_ACTION_WCHAIR", "missfinale_c2leadinoutfin_c_int", 1000f, 8f, 4, 1148846080);
							GAMEPLAY::SET_BIT(&uLocal_452, 20);
						}
					}
				}
			}
			if (!GAMEPLAY::IS_BIT_SET(uLocal_452, 3))
			{
				...
				GAMEPLAY::SET_BIT(&uLocal_452, 3);
			}
			else if (!GAMEPLAY::IS_BIT_SET(uLocal_452, 10))
			{
				if (CUTSCENE::_0xB56BBBCC2955D9CB())
				{
					CUTSCENE::_0x4C61C75BEE8184C2("MP_1", 0, 1);
					GAMEPLAY::SET_BIT(&uLocal_452, 10);
				}
			}
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					if (GAMEPLAY::IS_BIT_SET(uLocal_452, 10))
					{
						iLocal_280++;
					}
				}
		...
		case 4:
			...
			else if (CUTSCENE::HAS_CUTSCENE_FINISHED())
			{
				...
				if (GAMEPLAY::IS_BIT_SET(uLocal_452, 25))
				{
	...
	if (!GAMEPLAY::IS_BIT_SET(uLocal_452, 11))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("MP_1", 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				GAMEPLAY::SET_BIT(&uLocal_452, 11);
			}
		}
	}
	if (!GAMEPLAY::IS_BIT_SET(uLocal_452, 26))
	{
		if (iLocal_280 > 2)
		{
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(0))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					...
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					GAMEPLAY::SET_BIT(&uLocal_452, 26);
				}
			}
		}
	}
	if (GAMEPLAY::IS_BIT_SET(uLocal_452, 19))
	{
...
void func_114()
{
	...
	if (UI::DOES_BLIP_EXIST(uLocal_454))
	{
		UI::REMOVE_BLIP(&uLocal_454);
	}
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_281))
	{
		uVar0 = uLocal_281;
		ENTITY::DELETE_ENTITY(&uVar0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_283))
	{
		uVar0 = uLocal_283;
		ENTITY::DELETE_ENTITY(&uVar0);
	}
...
void func_120(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (bParam1)
			{
				if (!func_124(uVar25) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar25))
				{
					if (!bVar21)
					{
...
int func_133()
{
	switch (iLocal_459)
	{
		case 0:
			...
			if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_460) && func_181())
			{
				...
				func_155(1, 1);
				if (!PED::IS_PED_INJURED(uLocal_282))
				{
					GAMEPLAY::CLEAR_AREA(1273.885f, -1718.004f, 53.7715f, 3f, 1, 0, 0, 0);
					AI::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_282);
					ENTITY::SET_ENTITY_COORDS(uLocal_282, 1275.256f, -1722.368f, 53.655f, 1, 0, 0, 1);
					ENTITY::SET_ENTITY_HEADING(uLocal_282, 12.6638f);
					PED::FORCE_PED_MOTION_STATE(uLocal_282, -668482597, 0, 0, 0);
					PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
					WEAPON::SET_CURRENT_PED_WEAPON(uLocal_282, joaat("weapon_unarmed"), 1);
				}
				uLocal_461 = CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 0);
				CAM::SET_CAM_ACTIVE(uLocal_461, 1);
				CAM::SET_CAM_PARAMS(uLocal_461, 1276.409f, -1719.918f, 56.1054f, -29.932f, 0f, 137.9132f, 50f, 0, 1, 1, 2);
				CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_460, "SET_DETAILS");
				func_154("FM_LEST_CAM");
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_460, "SET_LOCATION");
				...
				GAMEPLAY::SET_BIT(&uLocal_452, 15);
				...
				GAMEPLAY::SET_BIT(&uLocal_452, 23);
				if (!GAMEPLAY::IS_BIT_SET(uLocal_452, 17))
				{
					if (OBJECT::_DOES_DOOR_EXIST(208246292))
					{
						OBJECT::_SET_DOOR_ACCELERATION_LIMIT(208246292, 0, 0, 0);
						GAMEPLAY::SET_BIT(&uLocal_452, 17);
					}
				}
				iLocal_459 = 1;
			}
		...
		case 1:
			if (!PED::IS_PED_INJURED(uLocal_282))
			{
				if (!GAMEPLAY::IS_BIT_SET(uLocal_452, 21))
				{
					if (func_171(&uLocal_462, 1000, 0))
					{
						AI::TASK_LOOK_AT_COORD(uLocal_282, 1276.409f, -1719.918f, 56.1054f, -1, 0, 2);
						GAMEPLAY::SET_BIT(&uLocal_452, 21);
					}
				}
			}
		...
		case 2:
			if (!PED::IS_PED_INJURED(uLocal_282))
			{
				if (!func_199())
				{
					PED::SET_PED_CONFIG_FLAG(uLocal_282, 104, 1);
					GAMEPLAY::SET_BIT(&uLocal_452, 22);
					AI::TASK_CLEAR_LOOK_AT(uLocal_282);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_282, 1273.576f, -1718.459f, 53.7715f, 1f, 20000, 1048576000, 0, 1193033728);
					func_170(&uLocal_462);
					func_7(&uLocal_462, 0, 0);
					iLocal_459++;
				}
		...
		case 3:
			if (!PED::IS_PED_INJURED(uLocal_282))
			{
				if (func_171(&uLocal_462, 5000, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_282, 1275.138f, -1718.426f, 53.72994f, 1272.451f, -1719.627f, 55.45897f, 1.5625f, 0, 1, 0))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
					...
					func_138();
					func_86(1, 1, 0, 1);
					GAMEPLAY::CLEAR_BIT(&uLocal_452, 22);
					...
					GAMEPLAY::SET_BIT(&uLocal_452, 24);
					iLocal_459 = 99;
				}
			}
			break;
		...
		case 99:
			if (OBJECT::_DOES_DOOR_EXIST(208246292))
			{
				...
				GAMEPLAY::SET_BIT(&uLocal_452, 19);
				iLocal_459 = 100;
			}
			break;
	...
	if (GAMEPLAY::IS_BIT_SET(uLocal_452, 15))
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_460))
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_460, "SET_TIME");
			if (TIME::GET_CLOCK_HOURS() >= 0 && TIME::GET_CLOCK_HOURS() <= 12)
			{
				GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(TIME::GET_CLOCK_HOURS());
			}
			else
			{
				GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT((TIME::GET_CLOCK_HOURS() - 12));
			}
			GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(TIME::GET_CLOCK_MINUTES());
	...
	if (GAMEPLAY::IS_BIT_SET(uLocal_452, 22))
	{
		if (!PED::IS_PED_INJURED(uLocal_282))
		{
			PED::SET_PED_CONFIG_FLAG(uLocal_282, 104, 1);
			PED::SET_PED_RESET_FLAG(uLocal_282, 60, 1);
			PED::SET_PED_RESET_FLAG(uLocal_282, 342, 1);
			PED::SET_PED_RESET_FLAG(uLocal_282, 348, 1);
		}
	}
	if (GAMEPLAY::IS_BIT_SET(uLocal_452, 23))
	{
		if (func_134())
		{
			GAMEPLAY::CLEAR_BIT(&uLocal_452, 23);
		}
	}
	return 0;
}
...
int func_134()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_281))
	{
		if (STREAMING::HAS_MODEL_LOADED(func_115(12)))
		{
			...
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_281, 1);
				ENTITY::SET_ENTITY_INVINCIBLE(uLocal_281, 1);
				func_135(&uLocal_285, 8, uLocal_281, "Lester", 0, 1);
				PED::SET_PED_PROP_INDEX(uLocal_281, 1, 0, 0, 0);
			}
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_283))
	{
		...
		{
			uLocal_283 = OBJECT::CREATE_OBJECT(joaat("prop_wheelchair_01_s"), 1276.39f, -1712.845f, 54.372f, 0, 0, 0);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_281))
	{
	...
	if (!PED::IS_PED_INJURED(uLocal_281))
	{
		if (!PED::_0x7350823473013C02(uLocal_281))
		{
			return 0;
		}
	}
	...
	{
		uLocal_284 = PED::CREATE_SYNCHRONIZED_SCENE(1276.39f, -1712.845f, 54.372f, 0f, 0f, -155.52f, 2);
		AI::TASK_SYNCHRONIZED_SCENE(uLocal_281, uLocal_284, "missfinale_c2leadinoutfin_c_int", "_LEADIN_LOOP1_LESTER", 1000f, -8f, 5, 0, 1148846080, 0);
		ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_283, uLocal_284, "_LEADIN_LOOP1_WCHAIR", "missfinale_c2leadinoutfin_c_int", 1000f, -8f, 4, 1148846080);
		PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_284, 1);
		bVar0 = true;
	}
	if (!bVar0)
	{
...
void func_138()
{
	...
	GAMEPLAY::CLEAR_BIT(&uLocal_452, 15);
	CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_282))
	{
		uVar0 = uLocal_282;
		ENTITY::DELETE_ENTITY(&uVar0);
	}
...
int func_181()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_282))
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			uLocal_282 = PED::CREATE_PED(4, uVar0, 1273.827f, -1717.873f, 53.7715f, 19.2225f, 0, 0);
			ENTITY::SET_ENTITY_INVINCIBLE(uLocal_282, 1);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_282, 1);
			PED::CLONE_PED_TO_TARGET(PLAYER::PLAYER_PED_ID(), uLocal_282);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_282))
	{
	...
	if (!PED::IS_PED_INJURED(uLocal_282))
	{
		if (!PED::_0x7350823473013C02(uLocal_282))
		{
			return 0;
		}
	}
...
void func_203(var uParam0)
{
	...
	else if (UI::DOES_BLIP_EXIST(*uParam0) && (UI::IS_BLIP_SHORT_RANGE(*uParam0) && !func_204()))
	{
...
void func_209()
{
	...
	if (GAMEPLAY::IS_BIT_SET(uLocal_452, 24))
	{
