...
int func_5(var uParam0, float fParam1)
{
	...
	if (func_23(uParam0))
	{
		if (func_6(ENTITY::GET_ENTITY_COORDS(uParam0, 1), &vVar0, fParam1, 0))
		{
			ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vVar0, 1, 0, 0, 1);
			func_19(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(uParam0, 1));
			return 1;
		}
	}
	return 0;
			...
			if (func_59(vLocal_628, Local_356.f_1, 150f))
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_356.f_1, 10f, func_48(), 0))
				{
					...
					if (func_421(Local_356))
					{
						...
						ENTITY::FREEZE_ENTITY_POSITION(Local_356, 1);
					}
				}
			}
		}
	...
	if (func_23(Local_336))
	{
		if (func_421(Local_344))
		{
			if (func_58(3))
			{
				...
				AI::TASK_SYNCHRONIZED_SCENE(Local_336, uVar0, func_41(), func_51(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_344, uVar0, func_50(), func_41(), 1000f, -8f, iVar1, 1148846080);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_336, 1);
				PED::SET_PED_MONEY(Local_336, 0);
				PED::SET_PED_CAN_BE_TARGETTED(Local_336, 0);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_336, 1862763509);
				AI::SET_PED_PATH_CAN_USE_CLIMBOVERS(Local_336, 0);
				AI::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(Local_336, 0);
				PED::SET_PED_KEEP_TASK(Local_336, 1);
				PED::SET_PED_CONFIG_FLAG(Local_336, 118, 0);
			}
		}
	}
}
			...
			if (iLocal_102 == 4)
			{
				if (func_23(Local_336))
				{
					...
					if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_336))
					{
						...
						{
							AUDIO::STOP_PED_SPEAKING(Local_336, 0);
				...
				{
					ENTITY::FREEZE_ENTITY_POSITION(Local_350, 0);
				}
				if (ENTITY::DOES_ENTITY_EXIST(Local_356))
				{
					ENTITY::FREEZE_ENTITY_POSITION(Local_356, 0);
				}
					...
					else if (func_23(Local_336))
					{
						if (!func_64(Local_336, 1805844857))
						{
							if (!PED::IS_PED_FLEEING(Local_336))
							{
								...
								{
									func_73(&Local_336);
									AI::TASK_SMART_FLEE_PED(Local_336, PLAYER::PLAYER_PED_ID(), 50f, -1, 0, 0);
									PED::SET_PED_KEEP_TASK(Local_336, 1);
								}
							}
						}
...
void func_112()
{
	...
	switch (iLocal_100)
	{
		case 0:
			...
			iLocal_425 = GAMEPLAY::GET_GAME_TIMER();
			iLocal_100 = 1;
			break;
...
void func_114(int iParam0)
{
	...
	{
		AI::CLEAR_PED_SECONDARY_TASK(Local_133[iParam0 /*19*/]);
		AI::CLEAR_PED_TASKS(Local_133[iParam0 /*19*/]);
		AI::TASK_CLEAR_LOOK_AT(Local_133[iParam0 /*19*/]);
		if (func_115(1, 0, 1))
		{
		...
		else if (PED::GET_PED_RELATIONSHIP_GROUP_HASH(Local_133[iParam0 /*19*/]) == iLocal_612)
		{
			...
			AI::TASK_LOOK_AT_ENTITY(Local_133[iParam0 /*19*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_133[iParam0 /*19*/], PLAYER::PLAYER_PED_ID(), -1);
	...
	switch (iLocal_100)
	{
		...
		case 2:
			...
			else
			{
				...
				if (func_23(Local_336))
				{
					AI::TASK_LOOK_AT_ENTITY(Local_336, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					PED::SET_PED_KEEP_TASK(Local_336, 1);
				}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_153(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_193(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_203(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_203(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_203(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_235(iVar0);
						if (Global_71400 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_203(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_203(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_203(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
void func_213(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_214(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_203(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_218(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_220(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_220(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 4);
		}
	}
...
int func_220(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_203(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_215(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_215(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_215(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_215(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_252(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_246(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_246(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_203(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_307(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_203(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_203(iParam1)))
	{
		return 1;
	}
	return 0;
			...
			case 1:
				if (!iLocal_397)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						if (iLocal_423 == -1)
						{
							iLocal_423 = GAMEPLAY::GET_GAME_TIMER();
						}
						if (iLocal_422 == -1)
						{
							iLocal_422 = GAMEPLAY::GET_GAME_TIMER();
						}
						...
						else
						{
							...
							{
								if (func_113(iLocal_410, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_105(Local_112.f_9, vLocal_628, 30f))
									{
...
void func_320()
{
	if (func_23(Local_112.f_9))
	{
		if (((Local_112.f_10 != 23 && Local_112.f_10 != 24) && Local_112.f_10 != 21) && Local_112.f_10 != 22)
		{
			...
			iLocal_429 = GAMEPLAY::GET_GAME_TIMER();
			Local_112.f_10 = 23;
		}
	}
}
...
void func_327(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_351(uParam1) && ENTITY::IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
int func_333(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_341() || func_340(Global_4456448.f_161209)) || func_339())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_337(uVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_112.f_10)
			{
				...
				case 1:
					...
					{
						func_38(&Local_285, 1);
						if (!AI::IS_PED_ACTIVE_IN_SCENARIO(Local_112.f_9))
						{
							AI::TASK_START_SCENARIO_IN_PLACE(Local_112.f_9, "WORLD_HUMAN_SMOKING", 0, 1);
				...
				case 30:
					if (!func_64(Local_112.f_9, 242628503))
					{
						...
						AI::TASK_PERFORM_SEQUENCE(Local_112.f_9, uLocal_432);
					...
					if (func_7(Local_248[0 /*6*/]))
					{
						if (((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_248[0 /*6*/], 0) && func_105(Local_248[0 /*6*/], Local_248[0 /*6*/].f_1, 3f)) && func_364(ENTITY::GET_ENTITY_HEADING(Local_248[0 /*6*/]), Local_248[0 /*6*/].f_4, 20f)) && !func_363(Local_248[0 /*6*/], 2))
						{
							...
							else if (func_113(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 350)))
							{
								...
								AI::TASK_ENTER_VEHICLE(Local_112.f_9, Local_248[0 /*6*/], 25000, -1, 3f, 8388608, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
								Local_112.f_10 = 16;
							}
						}
				...
				case 17:
					...
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_112.f_9, Local_248[0 /*6*/], PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 350f, 30f, 1);
				...
				case 33:
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
					iLocal_424 = GAMEPLAY::GET_GAME_TIMER();
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_112.f_9, 1, 1);
					Local_112.f_10 = 34;
					break;
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_112.f_9, 0) && PED::GET_VEHICLE_PED_IS_IN(Local_112.f_9, 0) == iVar0)
			{
				if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_409) > 7500)
						{
							func_384(0);
						}
					}
					...
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_409) > 10000)
						{
							func_384(1);
						}
					}
			...
			else
			{
				...
				else if (Local_112.f_10 == 24 && func_64(Local_112.f_9, -1519143300))
				{
					if (func_105(Local_112.f_9, vLocal_628, 25f))
					{
						...
						{
							if (func_113(iLocal_411, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_62())
								{
									func_3();
				...
				else
				{
					...
					if (!func_62())
					{
						if (func_113(iLocal_410, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_105(Local_112.f_9, vLocal_628, 20f))
							{
		...
		switch (iLocal_100)
		{
			...
			case 1:
				if (!iLocal_398)
				{
					...
					{
						if (!UI::DOES_BLIP_EXIST(uLocal_404))
						{
							if (iLocal_386)
							{
...
void func_389(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	...
	GAMEPLAY::SET_BIT(&Global_14732, 0);
...
void func_393(int iParam0, var uParam1, vector3 vParam2)
{
	...
	if (fVar4 > fVar3 && !ENTITY::IS_ENTITY_ON_SCREEN(uParam1))
	{
		fVar0 = 12f;
	}
	else if (fVar4 > fVar2)
...
int func_395(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	if (!func_105(uParam1, *(uParam3[*iParam4 /*3*/]), 15f))
	{
		if (!func_64(uParam0, -1817882002) && !func_64(uParam0, -72074166))
		{
			if (iLocal_408 < 7)
			{
				AI::TASK_VEHICLE_DRIVE_TO_COORD(uParam0, uParam1, *(uParam3[*iParam4 /*3*/]), 35f, 0, uParam2, 786468, 0f, 2f);
			}
			else
			{
				AI::TASK_VEHICLE_GOTO_NAVMESH(uParam0, uParam1, *(uParam3[*iParam4 /*3*/]), 35f, 4980772, 0f);
			}
		}
	}
	else
...
int func_396(var uParam0, var uParam1, int iParam2, int iParam3)
{
	if (func_23(uParam0))
	{
		if (func_7(uParam1))
		{
			...
			{
				AI::TASK_VEHICLE_TEMP_ACTION(uParam0, uParam1, 4, 2000);
				return (1 || ENTITY::GET_ENTITY_HEALTH(uParam1) < 150);
				VEHICLE::SET_VEHICLE_ENGINE_ON(uParam1, 0, 1, 0);
				if (VEHICLE::GET_VEHICLE_ENGINE_HEALTH(uParam1) > 100f)
				{
					VEHICLE::SET_VEHICLE_ENGINE_HEALTH(uParam1, 100f);
				}
				VEHICLE::SET_VEHICLE_UNDRIVEABLE(uParam1, 1);
				return 1;
			}
			else if (!PED::IS_PED_IN_VEHICLE(uParam0, uParam1, 0))
			{
				return 1;
			}
			else if (PED::IS_PED_BEING_STUNNED(uParam0, 0))
			{
				return 1;
			}
			else if (((VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(uParam1, 2, 10000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(uParam1, 3, 20000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(uParam1, 0, 10000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(uParam1, 1, 10000))
			{
				return 1;
			}
			if (VEHICLE::IS_VEHICLE_STOPPED(uParam1))
			{
	...
	if (func_23(Local_112.f_9))
	{
		...
		switch (iLocal_100)
		{
			...
			case 2:
				...
				iLocal_414 = GAMEPLAY::GET_GAME_TIMER();
				func_125(2);
				break;
			}
	}
...
int func_415(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_184(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_184(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_375(vVar3, vVar0);
...
void func_437(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if ((func_84(iParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_441(*uParam1, 0, &uVar0))
		{
...
int func_471(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_462(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_474(*uParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_474(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_473(uParam0);
	if (func_472(*uParam0))
	{
...
int func_484(var uParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_486(uParam0, uVar1[iVar6], 1) && func_485(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_168(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&uParam0);
						return 1;
					}
...
void func_487(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_490(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_489())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
void func_509()
{
	...
	PED::SET_PED_NON_CREATION_AREA(vVar0, vVar3);
	uLocal_430 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar3, 0, 1, 1, 1);
...
void func_510()
{
	...
	if (func_23(Local_112.f_9))
	{
		...
		AI::TASK_PLAY_ANIM(Local_112.f_9, "ODDJOBS@BAILBOND_QUARRY", "prem_producer_argue_a", 8f, -2f, -1, 1, 0, 0, 0, 0);
		if (!ENTITY::DOES_ENTITY_EXIST(Local_285))
		{
			Local_285 = OBJECT::CREATE_OBJECT(joaat("prop_phone_ing"), ENTITY::GET_ENTITY_COORDS(Local_112.f_9, 0), 1, 1, 0);
		}
...
int func_535()
{
	if (Global_90634 != -1)
	{
		return GAMEPLAY::IS_BIT_SET(Global_84500[Global_90634 /*34*/].f_15, 13);
	}
	return 0;
}
