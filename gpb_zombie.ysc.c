		...
		switch (iLocal_250)
		{
			...
			case 8:
				...
				else if (iLocal_440 == 1)
				{
					...
					{
						func_47(Global_106015[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_240, &Local_372, &Local_356));
					}
				}
				break;
...
int func_8()
{
	if (Global_106015[iLocal_251] == 3 && (iLocal_297 >= 4 && iLocal_297 <= 12))
	{
		return 1;
	}
	return 0;
