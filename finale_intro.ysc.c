...
void func_6()
{
	...
	while (CUTSCENE::IS_CUTSCENE_PLAYING() || !bVar1)
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_30))
		{
			iVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
...
void func_9(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if ((func_75(iParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_14(*uParam1, 0, &uVar0))
		{
...
int func_69(var uParam0, var uParam1, var uParam2)
{
	...
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_72(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_71(uParam0);
	if (func_70(*uParam0))
	{
	...
	if (iVar99 != 0)
	{
		...
		while (iVar0 < 9)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_91043[iVar0]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_91043[iVar0], 0))
			{
				...
				{
					if (fParam5 == -1f || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Global_91043[iVar0], 0), vParam2, 1) <= fParam5)
					{
						return 1;
					}
				}
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_113(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_132(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_121(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_121(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_113(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_195()
{
	ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_30);
