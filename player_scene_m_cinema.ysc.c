...
int func_2()
{
	...
	if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_104) > 100f)
	{
		return 1;
	}
	return 0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		switch (iLocal_82[iParam1])
		{
			...
			case 1:
				...
				if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_87[iParam1 /*4*/])))
				{
...
void func_20()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_77)
		{
			...
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_87[iVar0 /*4*/])))
			{
	...
	while (iVar0 < iLocal_72)
	{
		if (iLocal_77[iVar0] != 0)
		{
			iLocal_72[iVar0] = PED::CREATE_PED(4, iLocal_77[iVar0], vLocal_104 + vLocal_108[iVar0 /*3*/], 0, 1, 1);
...
void func_21()
{
	...
	switch (iLocal_70)
	{
		case 97:
			...
			vLocal_108[3 /*3*/] = { Vector(45.5004f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-205.8167f, -210.4254f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1416.54f, -1428.501f)) - vLocal_104 };
