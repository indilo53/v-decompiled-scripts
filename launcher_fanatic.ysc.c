...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_187(iParam3), 0);
}
...
int func_188(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_196(PLAYER::PLAYER_PED_ID()) && func_196(iParam0->f_28[0])) && !func_144()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_192(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_193(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	...
	if (func_176(2))
	{
		if (!func_144())
		{
			if (((func_196(PLAYER::PLAYER_PED_ID()) && func_196(iParam0->f_28[0])) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_192(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_191(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
				func_189(&uVar0, cParam4, sParam5, 7, 0, 0);
...
int func_229(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_196(PLAYER::PLAYER_PED_ID()) && func_196(uParam0))
	{
...
int func_232(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_225(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_225(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_224(vVar3, vVar0);
