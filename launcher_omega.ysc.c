...
void func_182(int iParam0)
{
	...
	if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_98) > 1250)
	{
		if (func_126(iParam0->f_28[0]) && !ENTITY::IS_ENTITY_ON_SCREEN(iParam0->f_28[0]))
		{
			if (func_126(PLAYER::PLAYER_PED_ID()) && !func_183(PLAYER::PLAYER_PED_ID(), iParam0->f_28[0], 50f, 1))
			{
				...
				if (fVar8 != 0f)
				{
					fVar6 = GAMEPLAY::ATAN2(fVar7, fVar8);
				}
				else if (fVar7 < 0f)
				{
					fVar6 = -90f;
...
void func_184()
{
	...
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	UI::SET_TEXT_RENDER_ID(uLocal_97);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
...
int func_219(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_221(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_228(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_221(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_221(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_220(vVar3, vVar0);
...
void func_240()
{
	uLocal_96 = unk_0x67D02A194A2FC2BD("digiscanner");
	...
	if (UI::IS_NAMED_RENDERTARGET_REGISTERED("digiscanner"))
	{
		uLocal_97 = UI::GET_NAMED_RENDERTARGET_RENDER_ID("digiscanner");
	}
