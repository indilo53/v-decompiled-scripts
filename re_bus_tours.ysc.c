					...
					if (func_222())
					{
						switch (iLocal_48)
						{
							...
							case 1:
								if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0))
								{
									if (PED::IS_PED_INJURED(uLocal_285) || PED::IS_PED_INJURED(uLocal_286))
									{
										func_223();
									}
									else
...
void func_2()
{
	...
	if (!PED::IS_PED_INJURED(uLocal_286) && !PED::IS_PED_INJURED(uLocal_285))
	{
		if (iLocal_537)
		{
			if (!func_83())
...
void func_22(vector3 vParam0, var uParam3)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0))
	{
		if (!CAM::DOES_CAM_EXIST(uLocal_328) && !CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				CAM::SET_GAMEPLAY_COORD_HINT(vParam0, uParam3, 3000, 3000, 0);
				func_23(vParam0);
				iLocal_314 = GAMEPLAY::GET_GAME_TIMER();
			}
		}
		if (!PED::IS_PED_INJURED(uLocal_285))
		{
			AI::SET_DRIVE_TASK_CRUISE_SPEED(uLocal_285, 3f);
		}
		iLocal_317 = 1;
	}
}
...
void func_23(vector3 vParam0)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		uVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(6000, 16000);
		AI::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), vParam0, uVar1, 0, 2);
	}
	iVar0 = 0;
	while (iVar0 < 5)
	{
...
void func_24()
{
	...
	if (CAM::DOES_CAM_EXIST(uLocal_328))
	{
		...
		func_25(PLAYER::PLAYER_PED_ID(), &uLocal_328, fLocal_342, 0f, fLocal_341);
		CAM::SET_CAM_FOV(uLocal_328, fVar1);
		CAM::ATTACH_CAM_TO_ENTITY(uLocal_328, PLAYER::PLAYER_PED_ID(), vVar7.x, (vVar7.y - 1f), (vVar7.z + 1f), 1);
	}
	else
	{
...
void func_25(var uParam0, var uParam1, vector3 vParam2)
{
	...
	if (!PED::IS_PED_INJURED(uParam0))
	{
		...
		{
			uVar0 = ENTITY::GET_ENTITY_HEADING(uParam0);
			vVar1.x = 0f;
			vVar1.y = 0f;
			vVar1.z = uVar0;
			vVar1 = { vVar1 + vParam2 };
			CAM::SET_CAM_ROT(*uParam1, vVar1.x, vVar1.y, vVar1.z, 2);
		}
	}
}
	...
	if (!PED::IS_PED_INJURED(uLocal_287[2]))
	{
		if (AI::GET_SCRIPT_TASK_STATUS(uLocal_287[2], -880529684) == 7)
		{
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_336 + 8000)
			{
				...
				vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_287[2], GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 2f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 2f), 0.5f) };
				uVar3 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 6000);
				AI::TASK_LOOK_AT_COORD(uLocal_287[2], vVar0, uVar3, 2049, 2);
...
void func_28()
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0))
	{
		if (!PED::IS_PED_INJURED(uLocal_285))
		{
			AI::CLEAR_PED_TASKS(uLocal_285);
			AI::OPEN_SEQUENCE_TASK(&uLocal_326);
			AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_306, 120.8878f, 239.3244f, 106.5131f, 3f, 0, joaat("tourbus"), iLocal_511, 5f, 15f);
			...
			AI::TASK_PERFORM_SEQUENCE(uLocal_285, uLocal_326);
...
void func_30(vector3 vParam0, var uParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0))
	{
		GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vParam0.x, vParam0.y, vParam0.z, 5f, 0, 0, 0, 0, 0, 0);
		ENTITY::SET_ENTITY_COORDS(iLocal_306, vParam0.x, vParam0.y, vParam0.z, 1, 0, 0, 1);
		ENTITY::SET_ENTITY_HEADING(iLocal_306, uParam3);
		VEHICLE::SET_VEHICLE_FORWARD_SPEED(iLocal_306, 0f);
		AI::TASK_VEHICLE_DRIVE_TO_COORD(uLocal_285, iLocal_306, ENTITY::GET_ENTITY_COORDS(iLocal_306, 1), 0f, 0, joaat("tourbus"), iLocal_511, 5f, 15f);
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0))
	{
		...
		if (iVar0 < 13)
		{
			if (!PED::IS_PED_INJURED(uLocal_285))
			{
				AI::TASK_VEHICLE_DRIVE_TO_COORD(uLocal_285, iLocal_306, Local_52[iVar0 /*15*/].f_1, Local_52[iVar0 /*15*/].f_8, 0, joaat("tourbus"), iLocal_511, 5f, 15f);
			}
		}
		else if (!PED::IS_PED_INJURED(uLocal_285))
		{
			AI::TASK_VEHICLE_DRIVE_TO_COORD(uLocal_285, iLocal_306, Local_263.f_1, Local_52[iVar0 /*15*/].f_8, 0, joaat("tourbus"), iLocal_511, 5f, 15f);
		}
		...
		switch (iLocal_50)
		{
			case 0:
				...
				while (iVar0 < 14)
				{
					if (!Local_52[iVar0 /*15*/].f_9)
					{
						...
						else if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_52[iVar0 /*15*/].f_1, 40f, 40f, 12f, 0, 1, 0))
						{
							if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_306, 0))
							{
			...
			case 1:
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0))
				{
					if (iVar1 <= 13)
					{
						func_78(ENTITY::GET_ENTITY_COORDS(iLocal_306, 1), Local_52[iVar1 /*15*/].f_1, &vLocal_320, &vLocal_323, 500);
					}
							...
							if (func_77(&uLocal_343, "BUSTOAU", Local_52[iLocal_278 /*15*/], 4, 0, 0, 0))
							{
								if (iVar1 <= 13)
								{
									if (iVar1 == 11)
									{
										...
										AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_306, -100.461f, -206.1412f, 44.4215f, Local_52[iVar1 /*15*/].f_8, 0, joaat("tourbus"), iLocal_511, 4f, 15f);
										AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_306, Local_52[iVar1 /*15*/].f_1, Local_52[iVar1 /*15*/].f_8, 0, joaat("tourbus"), iLocal_511, 4f, 15f);
										AI::CLOSE_SEQUENCE_TASK(uVar2);
										AI::TASK_PERFORM_SEQUENCE(uLocal_285, uVar2);
										AI::CLEAR_SEQUENCE_TASK(&uVar2);
									}
									else
									{
										AI::TASK_VEHICLE_DRIVE_TO_COORD(uLocal_285, iLocal_306, Local_52[iVar1 /*15*/].f_1, Local_52[iVar1 /*15*/].f_8, 0, joaat("tourbus"), iLocal_511, 4f, 15f);
									}
								}
								iLocal_314 = GAMEPLAY::GET_GAME_TIMER();
				...
				if ((iLocal_313 - iLocal_314) > 5000)
				{
					if (!func_83())
					{
						...
						else
						{
							if (!PED::IS_PED_INJURED(uLocal_285))
							{
								AI::SET_DRIVE_TASK_CRUISE_SPEED(uLocal_285, 15f);
							}
							iLocal_50 = 0;
						}
					}
...
int func_42()
{
	...
	switch (iLocal_333)
	{
		case 0:
			...
			{
				AI::CLEAR_PED_TASKS(uLocal_285);
				AI::SET_DRIVE_TASK_CRUISE_SPEED(uLocal_285, 0f);
				AI::OPEN_SEQUENCE_TASK(&uLocal_326);
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_306, 0))
					{
						if (!PED::IS_PED_INJURED(uLocal_285))
						{
							AI::TASK_VEHICLE_TEMP_ACTION(uLocal_285, iLocal_306, 24, 5000);
							...
							func_29();
							CAM::SET_FOLLOW_VEHICLE_CAM_ZOOM_LEVEL(uLocal_510);
							PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(PLAYER::PLAYER_PED_ID(), 1);
							AUDIO::STOP_AUDIO_SCENE("RE_BUS_TOUR_SCENE");
							AUDIO::_0x18EB48CFC41F2EA0(iLocal_306, 0);
							if (CAM::DOES_CAM_EXIST(uLocal_328))
	...
	if (!PED::IS_PED_INJURED(uLocal_286) && !PED::IS_PED_INJURED(uLocal_285))
	{
		switch (iLocal_51)
		{
			case 0:
				...
				PED::SET_PED_CAN_BE_DRAGGED_OUT(uLocal_285, 0);
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_306, 0))
				{
					func_78(ENTITY::GET_ENTITY_COORDS(iLocal_306, 1), Local_52[0 /*15*/].f_1, &vLocal_320, &vLocal_323, 500);
			...
			case 1:
				...
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if ((PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_306) && PED::IS_PED_SITTING_IN_VEHICLE(uLocal_286, iLocal_306)) && PED::IS_PED_SITTING_IN_VEHICLE(uLocal_285, iLocal_306))
					{
						iLocal_51 = 2;
					}
					else if (func_75(1000))
					{
						...
						{
							PED::SET_PED_INTO_VEHICLE(uLocal_286, iLocal_306, 0);
						}
						iLocal_51 = 2;
					}
				}
			...
			case 2:
				AI::TASK_VEHICLE_DRIVE_TO_COORD(uLocal_285, iLocal_306, Local_52[0 /*15*/].f_1, Local_52[0 /*15*/].f_8, 0, joaat("tourbus"), iLocal_511, 5f, 15f);
				CAM::SET_CAM_ACTIVE(uLocal_329, 0);
				...
				uLocal_510 = CAM::GET_FOLLOW_VEHICLE_CAM_ZOOM_LEVEL();
				if (!iLocal_319)
				{
					CAM::SET_FOLLOW_VEHICLE_CAM_ZOOM_LEVEL(3);
				}
...
void func_119()
{
	if (!PED::IS_PED_INJURED(uLocal_286))
	{
		AI::CLEAR_PED_TASKS(uLocal_286);
		AI::TASK_ENTER_VEHICLE(uLocal_286, iLocal_306, 10000, 0, 2f, 262144, 0);
		PED::SET_PED_KEEP_TASK(uLocal_286, 1);
		iLocal_340 = 1;
	}
}
			...
			if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_306, 5f, 5f, 5f, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !func_118("TX_H02"))
			{
				if (func_149())
				{
					...
					if (!UI::DOES_BLIP_EXIST(uLocal_310))
					{
						...
						UI::SET_BLIP_SCALE(uLocal_310, Global_25811);
						if (!PED::IS_PED_INJURED(uLocal_286))
						{
							AI::TASK_LOOK_AT_ENTITY(uLocal_286, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						}
						if (!func_148())
						{
							if (func_136())
		...
		if (!PED::IS_PED_INJURED(*uParam0))
		{
			if (func_123(*uParam0))
			{
				if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*uParam0))
				{
					...
					uVar0 = func_122(PED::IS_PED_MALE(*uParam0));
					AUDIO::SET_AMBIENT_VOICE_NAME(*uParam0, uVar0);
					return 1;
				}
			}
		}
...
int func_123(var uParam0)
{
	...
	iVar0 = 1;
	if (((((ENTITY::GET_ENTITY_MODEL(uParam0) == joaat("a_m_m_tramp_01") || ENTITY::GET_ENTITY_MODEL(uParam0) == joaat("a_f_m_tramp_01")) || ENTITY::GET_ENTITY_MODEL(uParam0) == joaat("a_m_o_tramp_01")) || ENTITY::GET_ENTITY_MODEL(uParam0) == joaat("s_m_y_cop_01")) || ENTITY::GET_ENTITY_MODEL(uParam0) == joaat("s_m_y_fireman_01")) || ENTITY::GET_ENTITY_MODEL(uParam0) == joaat("a_f_y_hiker_01"))
	{
		iVar0 = 0;
	}
	return iVar0;
...
int func_148()
{
	if ((Global_106554 == func_65() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
int func_160()
{
	...
	if (!PED::IS_PED_INJURED(uLocal_285))
	{
		if (((func_165(uLocal_285) || !PED::IS_PED_IN_ANY_VEHICLE(uLocal_285, 0)) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_285)) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_285))
		{
			func_161(uLocal_286);
			return 1;
		}
...
void func_162()
{
	if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_286, 40f, 40f, 5f, 0, 1, 0))
	{
		iLocal_313 = GAMEPLAY::GET_GAME_TIMER();
		if ((iLocal_313 - iLocal_314) > 10000)
		{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_164(iParam2), 1);
}
...
{
	if (func_166(uParam0, &uLocal_337, &uLocal_334, uLocal_332, bLocal_338, 1077936128, 0) || PED::IS_PED_RAGDOLL(uParam0))
	{
		func_161(uParam0);
		return 1;
	}
					...
					if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uParam0) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uParam0))
					{
						if (fVar9 < fVar0)
						{
							if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(uParam0, PLAYER::PLAYER_PED_ID(), 17))
							{
								...
								func_171("\n");
								func_167("		time since not LockedOn = ", (GAMEPLAY::GET_GAME_TIMER() - iLocal_43));
								func_171("\n");
								bVar2 = true;
...
void func_178()
{
	...
	else
	{
		...
		if ((((STREAMING::HAS_MODEL_LOADED(iVar0) && STREAMING::HAS_MODEL_LOADED(iVar1)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_509)) && STREAMING::HAS_MODEL_LOADED(joaat("tourbus"))) && UI::HAS_ADDITIONAL_TEXT_LOADED(2))
		{
			...
			uLocal_285 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_306, 26, iVar1, -1, 1, 1);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_285, 1);
			PED::SET_PED_CONFIG_FLAG(uLocal_285, 251, 1);
			PED::SET_PED_STAY_IN_VEHICLE_WHEN_JACKED(uLocal_285, 1);
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_285))
			{
				if (!PED::IS_PED_INJURED(uLocal_285))
				{
					PED::SET_PED_COMPONENT_VARIATION(uLocal_285, 3, 1, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(uLocal_285, 4, 0, 2, 0);
				}
			}
			uLocal_286 = PED::CREATE_PED(26, iVar0, 102.9893f, 248.5367f, 107.1759f, 329f, 1, 1);
			AUDIO::SET_AMBIENT_VOICE_NAME(uLocal_286, "A_F_M_BEVHILLS_02_WHITE_FULL_02");
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_286, 1);
			PED::SET_PED_CAN_BE_TARGETTED(uLocal_286, 0);
			PED::SET_PED_COMPONENT_VARIATION(uLocal_286, 0, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(uLocal_286, 2, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(uLocal_286, 3, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(uLocal_286, 4, 1, 0, 0);
			...
			AI::TASK_PERFORM_SEQUENCE(uLocal_286, uLocal_327);
...
void func_179()
{
	PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_285, 17, 1);
	PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_286, 17, 1);
	PED::ADD_RELATIONSHIP_GROUP("re_bus_tours1", &uLocal_309);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_285, uLocal_309);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_286, uLocal_309);
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_203(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_223()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_285))
	{
		if (!PED::IS_PED_INJURED(uLocal_285))
		{
			PED::SET_PED_CONFIG_FLAG(uLocal_285, 251, 0);
			PED::SET_PED_CAN_BE_DRAGGED_OUT(uLocal_285, 1);
			PED::SET_PED_KEEP_TASK(uLocal_285, 1);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_285, 0);
		}
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uLocal_285);
	}
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_286))
	{
		if (!PED::IS_PED_INJURED(uLocal_286))
		{
			PED::SET_PED_CAN_BE_TARGETTED(uLocal_286, 1);
			PED::SET_PED_KEEP_TASK(uLocal_286, 1);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_286, 0);
		}
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uLocal_286);
	}
	iVar0 = 0;
	while (iVar0 < 5)
	{
...
void func_235()
{
	func_226(30000);
	func_234(&Global_25824);
	Global_25812 = GAMEPLAY::GET_GAME_TIMER();
}
