...
void func_1()
{
	switch (iLocal_81)
	{
		case 0:
			...
			UI::CLEAR_HELP(1);
			func_32();
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_353))
			{
				func_30(sLocal_353);
			}
			else
		...
		case 1:
			if (func_14())
			{
				...
				else if (func_12(&uLocal_196, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
				{
					func_10(408.3364f, -1567.429f, 28.2723f, 128.2512f);
					func_8(471.5946f, -1412.737f, 28.1562f, 68.5531f);
				}
				GAMEPLAY::CLEAR_AREA(372.9868f, -1623.531f, 28.2928f, 100f, 1, 0, 0, 0);
				func_2();
				func_389();
			}
			break;
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_81(1, vLocal_361, 0))
			{
				...
				{
					uLocal_371 = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_80(229.3746f), 0, 7);
					if (UI::GET_BLIP_FROM_ENTITY(Local_456) != 0)
					{
						uVar0 = UI::GET_BLIP_FROM_ENTITY(Local_456);
		...
		case 1:
			if (bParam1)
			{
				if (((func_81(2, Local_456.f_1, Local_456.f_4) && func_81(4, vLocal_361, 0)) && func_81(3, vLocal_361, 0)) && func_81(5, vLocal_361, 0))
				{
					...
					GAMEPLAY::CLEAR_AREA_OF_PEDS(Local_389[0 /*22*/].f_1, 5f, 0);
					func_76();
					func_74();
					bLocal_28 = false;
					func_35(1, 1, 1);
...
void func_72()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (iVar0 <= (15 - 1))
		{
			GAMEPLAY::CLEAR_BIT(&(Local_389[iVar1 /*22*/].f_15), iVar0);
			iVar0++;
		}
...
void func_76()
{
	...
	while (iVar0 <= 2)
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_389[iVar0 /*22*/], 0);
		if (!func_77(Local_389[iVar0 /*22*/], -1098463898))
		{
			switch (iVar0)
			{
				case 0:
				case 1:
					AI::TASK_START_SCENARIO_AT_POSITION(Local_389[iVar0 /*22*/], "WORLD_HUMAN_HANG_OUT_STREET", Local_389[iVar0 /*22*/].f_1, Local_389[iVar0 /*22*/].f_4, 0, 0, 1);
					break;
				
				case 2:
					AI::TASK_USE_MOBILE_PHONE(Local_389[iVar0 /*22*/], 1, 1);
					break;
				}
		}
...
int func_81(int iParam0, vector3 vParam1, float fParam4)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			UI::REQUEST_ADDITIONAL_TEXT(sLocal_354, 0);
			UI::REQUEST_ADDITIONAL_TEXT(cLocal_482, 6);
		...
		case 2:
			if (func_7(Global_90209[0]))
			{
				...
				if (func_7(Local_456))
				{
					...
					VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(Local_456, 2, 0);
					VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(Local_456, 3, 0);
					func_88(Local_456, 0);
					VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_456, 1);
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_90209.f_9[iVar0]))
				{
					...
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_9[iVar0], 1, 1);
		...
		case 4:
			...
			while (iVar6 <= 3)
			{
				...
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_90209[iVar6], 1, 1);
		...
		case 5:
			if (func_82(&uLocal_358, joaat("prop_box_guncase_03a"), 354.6938f, -1634.783f, 22.7849f, 299.1508f, 1))
			{
				if (func_7(Local_456))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_358, Local_456, 0, 0f, -1.85f, 0.05f, ENTITY::GET_ENTITY_ROTATION(Local_456, 2), 0, 0, 0, 0, 2, 1);
					if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_456, uLocal_358))
					{
						return 1;
					}
				}
...
int func_87(int iParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_84(uParam1, "Loading", 0))
		{
			*iParam0 = VEHICLE::CREATE_VEHICLE(uParam1, vParam2, uParam5, 1, 1, 0);
			if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
			{
		...
		switch (*iParam2)
		{
			case 0:
				...
				else
				{
					...
					{
						UI::CLEAR_THIS_PRINT(func_60(func_68(), bParam9));
					}
					if (func_68() != 33)
					{
						func_93(iParam0);
...
int func_106(int iParam0, int iParam1)
{
	...
	{
		case 0:
			AI::TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, PED::GET_VEHICLE_PED_IS_IN(iParam1, 0), vLocal_364, 4, 20f, 786469, 3.5f, 5f, 1);
			iLocal_83[iParam0] = 3;
			break;
...
int func_108(int iParam0, int iParam1)
{
	...
	{
		case 0:
			if (!GAMEPLAY::IS_POSITION_OCCUPIED(Local_300[iLocal_665 /*4*/], 1.5f, 0, 0, 1, 0, 0, iParam1, 0))
			{
				...
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam1, Local_300[iLocal_665 /*4*/], fVar0, 20000, 0.25f, 0, Local_300[iLocal_665 /*4*/].f_3);
				iLocal_83[iParam0] = 1;
			}
			break;
...
int func_110(int iParam0, int iParam1)
{
	if (!func_111())
	{
		if ((ENTITY::DOES_ENTITY_EXIST(Local_456) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_456, 0)) && !ENTITY::IS_ENTITY_AT_COORD(Local_456, vLocal_364, 2f, 2f, 2f, 0, 1, 0))
		{
...
void func_119(int iParam0)
{
	...
	switch (Local_389[iParam0 /*22*/].f_20)
	{
			...
			if (func_143(iParam0) && func_62(Local_389[iParam0 /*22*/], Local_389[iParam0 /*22*/].f_1, 3f))
			{
				if (GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1000, 1500)
				{
					if (!func_77(Local_389[iParam0 /*22*/], -875674219))
					{
						...
						AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_389[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 0);
					}
					Local_389[iParam0 /*22*/].f_14 = GAMEPLAY::GET_GAME_TIMER();
				}
			}
			else
			{
		...
		case 4:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 8))
				{
					...
					else if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 9) && !bLocal_372)
					{
						func_126(iParam0);
						func_124();
						return;
		...
		case 6:
			...
			if ((GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > iVar0)
			{
				if (!PED::IS_PED_BEING_STUNNED(Local_389[iParam0 /*22*/], 0) && !AI::IS_PED_IN_WRITHE(Local_389[iParam0 /*22*/]))
				{
					Local_389[iParam0 /*22*/].f_14 = GAMEPLAY::GET_GAME_TIMER();
					func_126(iParam0);
				}
		...
		case 7:
			if ((GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > 350)
			{
				if (!bLocal_374 && func_123(iParam0, 15))
				{
					func_72();
					func_133(iParam0);
					UI::_0xC594B315EDF2D4AF(Local_389[iParam0 /*22*/]);
					return;
				}
				else
				{
					if (iLocal_660 != -1)
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_660) > 12000)
						{
							func_122(-1);
						}
						...
						else if (PLAYER::GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(PLAYER::PLAYER_ID(), &uVar1))
						{
							if (ENTITY::IS_ENTITY_A_PED(uVar1))
							{
								iVar2 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(uVar1);
					...
					if ((func_77(Local_389[iParam0 /*22*/], -2128726980) || func_77(Local_389[iParam0 /*22*/], -982327190)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 2)
					{
						...
						{
							AI::TASK_ARREST_PED(Local_389[iParam0 /*22*/], PLAYER::PLAYER_PED_ID());
						}
					}
				}
			}
			if (!iLocal_658)
			{
				if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 1) && GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 14))
				{
					if (iParam0 == 0)
					{
						sVar3 = "PRA_COPSHT1";
...
void func_122(int iParam0)
{
	...
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_389[0 /*22*/], 0);
	}
	if (func_370(Local_389[1 /*22*/]))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_389[1 /*22*/], 0);
	}
	if (func_370(Local_389[2 /*22*/]))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_389[2 /*22*/], 0);
	}
	if (iParam0 != -1)
	{
...
int func_123(int iParam0, int iParam1)
{
	...
	while (iVar0 <= 14)
	{
		if (iVar0 != iParam1)
		{
			if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, iVar0))
			{
				return 0;
			}
		}
...
void func_124()
{
	...
	while (iVar0 <= 2)
	{
		...
		{
			func_189(&(Local_389[iVar0 /*22*/].f_6));
			Local_389[iVar0 /*22*/].f_14 = GAMEPLAY::GET_GAME_TIMER();
...
void func_125()
{
	if (!iLocal_375)
	{
		iLocal_660 = GAMEPLAY::GET_GAME_TIMER();
		if (!iLocal_659)
		{
			func_103();
		}
...
void func_126(int iParam0)
{
	if (Local_389[iParam0 /*22*/].f_20 != 7)
	{
		if (func_370(Local_389[iParam0 /*22*/]))
		{
			...
			{
				AI::CLEAR_PED_TASKS(Local_389[iParam0 /*22*/]);
			}
...
void func_127(int iParam0)
{
	...
	if ((iLocal_80 != 2 && !iLocal_659) && !ENTITY::IS_ENTITY_DEAD(Local_389[iParam0 /*22*/], 0))
	{
		if (func_132(iParam0) && func_130(Local_389[iParam0 /*22*/], 30f))
		{
			...
			if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 3))
			{
				iLocal_659 = 1;
			}
			else if (!func_123(iParam0, 15) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, 1, 0))
			{
				func_128();
				iLocal_656 = 0;
				if (iParam0 == 2)
...
void func_133(int iParam0)
{
	...
	if (Local_389[iParam0 /*22*/].f_18 != 1 && !func_77(Local_389[iParam0 /*22*/], 242628503))
	{
		...
		if (iParam0 == 2)
		{
			...
			{
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_389[iParam0 /*22*/].f_1, 1f, 120000, 0.25f, 0, Local_389[iParam0 /*22*/].f_4);
			}
			else
			{
				AI::TASK_ACHIEVE_HEADING(0, Local_389[iParam0 /*22*/].f_4, 0);
			}
			if (iLocal_648[2] && GAMEPLAY::IS_STRING_NULL_OR_EMPTY("sResumeRoot"))
			{
			...
			AI::TASK_PERFORM_SEQUENCE(Local_389[iParam0 /*22*/], uVar0);
		...
		func_134();
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_389[iParam0 /*22*/], 0);
	...
	switch (Local_389[iParam0 /*22*/].f_21)
	{
		case 0:
			...
			else if (iParam0 == 2)
			{
				...
				{
					AI::CLEAR_PED_TASKS(Local_389[iParam0 /*22*/]);
					AI::TASK_START_SCENARIO_IN_PLACE(Local_389[iParam0 /*22*/], "WORLD_HUMAN_STAND_MOBILE", 0, 1);
				}
			}
			break;
...
void func_146(int iParam0)
{
	...
	if (!func_167(iParam0))
	{
		if (func_148(Local_389[iParam0 /*22*/], 1, 50f, 140f, 0, 1, 1, 1) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_389[iParam0 /*22*/], 1), 100f))
		{
...
int func_165(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_157(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_157(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_156(vVar3, vVar0);
...
void func_171(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_143(iParam0) || iParam2)
	{
		...
		{
			if (Local_389[func_144(iParam0) /*22*/].f_20 != 3 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_376) > 7500)
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 9))
				{
					if (iParam0 == 0)
					{
						sVar0 = "PRA_CWCAR1";
		...
		{
			if (Local_389[func_144(iParam0) /*22*/].f_20 != 4 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_376) > 7500)
			{
				if (!bLocal_373)
				{
					if (iParam0 == 0)
		...
		Local_389[iParam0 /*22*/].f_14 = GAMEPLAY::GET_GAME_TIMER();
		Local_389[func_144(iParam0) /*22*/].f_14 = GAMEPLAY::GET_GAME_TIMER();
...
void func_172(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 12))
		{
			return;
		}
	}
	...
	if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam1) || GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Var0))
	{
		...
		if (bParam2)
		{
			iLocal_376 = GAMEPLAY::GET_GAME_TIMER();
		}
		return;
	}
...
void func_176(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_143(iParam0) || iParam2)
	{
		if (iParam1 == 1)
		{
			if (Local_389[iParam0 /*22*/].f_19 != 1 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_376) > 7500)
			{
				if (!bLocal_372)
				{
					if (iParam0 == 0)
		...
		{
			if (Local_389[iParam0 /*22*/].f_19 != 2 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_376) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPPLY1";
		...
		{
			if (Local_389[iParam0 /*22*/].f_19 != 4 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_376) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPST1";
		...
		if (bLocal_372)
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 12))
			{
				GAMEPLAY::SET_BIT(&(Local_389[iParam0 /*22*/].f_15), 12);
			}
		}
	}
}
		...
		if (iParam0 == 0 || iParam0 == 1)
		{
			if (!iLocal_382)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 340.0758f, -1598.255f, 28.29322f, 346.4939f, -1603.684f, 38.29278f, 6.22f, 0, 1, 0))
				{
					...
					else if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 11))
					{
						if ((((fVar0 > 16f && !Local_389[iParam0 /*22*/].f_16) && !GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 10)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_389[iParam0 /*22*/], Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0))
						{
							func_180(iParam0, 11);
							return;
						}
				...
				if (((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_389[iParam0 /*22*/], Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0)) && !GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 10)) && !GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 11))
				{
			...
			else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_381) > 4000)
			{
				iLocal_382 = 0;
			}
		}
		else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[5 /*7*/], Local_309[5 /*7*/].f_3, Local_309[5 /*7*/].f_6, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_389[iParam0 /*22*/], Local_309[5 /*7*/], Local_309[5 /*7*/].f_3, Local_309[5 /*7*/].f_6, 0, 1, 0))
		{
...
{
	if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, iParam1))
	{
		GAMEPLAY::CLEAR_BIT(&(Local_389[iParam0 /*22*/].f_15), iParam1);
		Local_389[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_180(int iParam0, int iParam1)
{
	if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, iParam1))
	{
		GAMEPLAY::SET_BIT(&(Local_389[iParam0 /*22*/].f_15), iParam1);
		Local_389[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_184(int iParam0)
{
	...
	if (Local_389[iParam0 /*22*/].f_20 != 6 && Local_389[iParam0 /*22*/].f_20 != 7)
	{
		...
		while (iVar0 <= 5)
		{
			...
			else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[iVar0 /*7*/], Local_309[iVar0 /*7*/].f_3, Local_309[iVar0 /*7*/].f_6, 0, 1, 0) || GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 12))
			{
				func_185(iParam0, iVar0);
			}
			iVar0++;
	...
	else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_309[3 /*7*/], Local_309[3 /*7*/].f_3, Local_309[3 /*7*/].f_6, 0, 1, 0))
	{
		func_187(iParam0, 3);
	}
	else
		...
		case 4:
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				if (func_7(iVar0))
				{
					...
					else if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 7))
					{
						func_180(iParam0, 7);
					}
				}
...
void func_187(int iParam0, int iParam1)
{
	...
	{
		case 1:
			if ((!GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 6) && !GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 1)) && !GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 9))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 10))
				{
					func_180(iParam0, 10);
				}
			}
		...
		case 2:
			if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 1))
			{
				if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 6))
				{
					func_180(iParam0, 6);
				}
			}
		...
		case 3:
			if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 14))
			{
				func_180(iParam0, 14);
			}
			break;
		...
		case 4:
			if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 8))
			{
				...
				{
					GAMEPLAY::SET_BIT(&(Local_389[iParam0 /*22*/].f_15), 9);
					func_180(iParam0, 8);
				}
				else
				{
					GAMEPLAY::CLEAR_BIT(&(Local_389[iParam0 /*22*/].f_15), 9);
					func_180(iParam0, 8);
				}
			}
			break;
		...
		case 5:
			if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 4))
			{
				if ((!PED::IS_PED_BEING_STEALTH_KILLED(Local_389[iParam0 /*22*/]) && !PED::WAS_PED_KILLED_BY_STEALTH(Local_389[iParam0 /*22*/])) && !PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_389[iParam0 /*22*/]))
				{
					func_180(iParam0, 4);
	...
	switch (Local_389[iParam0 /*22*/].f_19)
	{
		case 1:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				...
				{
					if ((GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 13) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_376) > 2500) && !iLocal_661)
					{
						if (iParam0 == 0)
						{
							sVar0 = "PRA_COPST1";
						...
						func_120(&uLocal_483, cLocal_482, sVar0, 7, 0, 0);
						GAMEPLAY::CLEAR_BIT(&(Local_389[iParam0 /*22*/].f_15), 13);
						GAMEPLAY::CLEAR_BIT(&(Local_389[func_144(iParam0) /*22*/].f_15), 13);
						iLocal_661 = 1;
					}
					Local_389[iParam0 /*22*/].f_17 = 1;
				}
		...
		case 5:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				...
				{
					GAMEPLAY::CLEAR_BIT(&(Local_389[iParam0 /*22*/].f_15), 5);
				}
				if (func_123(iParam0, 12))
				{
					func_133(iParam0);
		...
		case 7:
			if (GAMEPLAY::GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				...
				{
					GAMEPLAY::CLEAR_BIT(&(Local_389[iParam0 /*22*/].f_15), 11);
				}
				if (func_123(iParam0, 12))
				{
					func_133(iParam0);
...
void func_195(int iParam0)
{
	...
	if (!iLocal_661)
	{
		...
		if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 13))
		{
			if (GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 10))
			{
				if (Local_389[iParam0 /*22*/].f_16)
		...
		else if (func_132(iParam0))
		{
			if (bVar0)
			{
				...
				{
					if (!GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 10) && !GAMEPLAY::IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 6))
					{
						GAMEPLAY::CLEAR_BIT(&(Local_389[iParam0 /*22*/].f_15), 13);
					}
				}
...
void func_197(int iParam0)
{
	if (!func_167(iParam0))
	{
		...
		else if (func_148(Local_389[iParam0 /*22*/], 1, 70f, 150f, 0, 1, 0, 1) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_389[iParam0 /*22*/], 1), 100f))
		{
			func_124();
		}
...
void func_199()
{
	...
	{
		if ((((func_370(Local_389[0 /*22*/]) && func_370(Local_389[1 /*22*/])) && func_12(&uLocal_92, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))) && func_62(Local_389[0 /*22*/], Local_389[0 /*22*/].f_1, 3f)) && func_62(Local_389[1 /*22*/], Local_389[1 /*22*/].f_1, 3f))
		{
		...
		else if ((func_370(Local_389[2 /*22*/]) && func_12(&uLocal_144, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))) && func_62(Local_389[2 /*22*/], Local_389[2 /*22*/].f_1, 3f))
		{
			if (!GAMEPLAY::IS_BIT_SET(Local_389[2 /*22*/].f_15, 2) && !GAMEPLAY::IS_BIT_SET(Local_389[2 /*22*/].f_15, 4))
			{
...
void func_217()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		{
			func_218(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, 1), ENTITY::GET_ENTITY_HEADING(iVar0), 24, 0);
		}
	}
}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_245(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_266(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_267(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_267(iParam1)))
	{
		return 1;
	}
	return 0;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_272(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_272(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_272(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_272(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_272(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_267(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_280(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_267(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_299(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_289(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_289(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_267(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_358(var uParam0, float fParam1)
{
	if (OBJECT::_DOES_DOOR_EXIST(uParam0))
	{
		if (*fParam1 != 0f)
		{
			...
			OBJECT::_SET_DOOR_AJAR_ANGLE(uParam0, *fParam1, 1, 1);
			*fParam1 = (*fParam1 - (0.2f * SYSTEM::TIMESTEP()));
			if (*fParam1 <= 0f)
			{
				OBJECT::_SET_DOOR_ACCELERATION_LIMIT(uParam0, 1, 1, 0);
...
void func_384()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (iVar2 <= (15 - 1))
		{
			GAMEPLAY::CLEAR_BIT(&(Local_389[iVar1 /*22*/].f_15), iVar2);
			iVar2++;
		}
		iVar1++;
	}
