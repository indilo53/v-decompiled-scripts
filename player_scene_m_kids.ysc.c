		...
		switch (iLocal_243[iParam1])
		{
						...
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_253[iParam1], 0))
						{
							if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_253[iParam1], &sLocal_349, &(Local_302[iParam1 /*16*/]), 2))
							{
								if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_91042) > 0.817f)
								{
									...
									vVar38.x = -824.333f;
									fVar41 = 140.49f;
									ENTITY::SET_ENTITY_COORDS(iLocal_253[iParam1], vVar38, 1, 0, 0, 1);
			...
			case 10:
				...
				if (func_6(iLocal_246[iParam1], iLocal_249[iParam1], &sVar42, &cVar58, &iVar74, &iVar75) && func_4(iLocal_246[iParam1], iLocal_249[iParam1], &vVar76, &fVar79))
				{
					...
					{
						uLocal_480 = PED::CREATE_SYNCHRONIZED_SCENE(vVar0 + vVar76, 0f, 0f, (fVar3 + fVar79), 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_480, 1);
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_480, 0);
					}
					AI::TASK_SYNCHRONIZED_SCENE(uParam0, uLocal_480, &sVar42, &cVar58, 1000f, -8f, 0, 0, 1000f, 0);
					PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_480, 1);
					iLocal_243[iParam1] = 1;
				}
				break;
...
int func_9()
{
	...
	if (!func_28())
	{
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
		{
			if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_463))
			{
			}
			else if (!iLocal_468)
			{
...
int func_29()
{
	...
	if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_463) && !iLocal_468)
	{
		if (func_11(&uLocal_71, "PRSAUD", &Local_463, 3, 0, 0, 0, 0))
		{
			iLocal_468 = 1;
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
		{
			...
			while (iVar0 < iLocal_237)
			{
				if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_91042, &sLocal_349, &(Local_430[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
					iLocal_243[iVar0] = 0;
				}
				else
				{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_253[iVar0], 0))
				{
					...
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_91042, &(Local_302[iVar0 /*16*/]), &sLocal_349, 8f, 1090519040, 0, 1148846080);
				}
				iVar0++;
			}
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_463) && iLocal_468)
...
int func_30()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_91041))
	{
		...
		while (iVar0 < iLocal_237)
		{
			if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
			{
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_91041, &sLocal_349, &(Local_397[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_253[iVar0], 0))
			{
				if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_269[iVar0 /*16*/])))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_91041, &(Local_269[iVar0 /*16*/]), &sLocal_349, 8f, 1090519040, 0, 1148846080);
				}
				else
				{
					if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_253[iVar0]))
...
void func_40()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_237)
		{
			...
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_470) && iLocal_474[iVar0] > 0)
			{
		...
		if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&sLocal_349))
		{
	...
	while (iVar0 < iLocal_253)
	{
		if (iLocal_256[iVar0] != 0)
		{
			iLocal_253[iVar0] = VEHICLE::CREATE_VEHICLE(iLocal_256[iVar0], vLocal_335 + vLocal_259[iVar0 /*3*/], (fLocal_338 + uLocal_266[iVar0]), 0, 0, 0);
	...
	while (iVar0 < iLocal_237)
	{
		if (iLocal_240[iVar0] != 145)
		{
			if (func_165(&(iLocal_237[iVar0]), iLocal_240[iVar0], vLocal_335 + vLocal_339[iVar0 /*3*/], (fLocal_338 + fLocal_346[iVar0]), 1))
			{
				...
				if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_397[iVar0 /*16*/])))
				{
					AI::TASK_PLAY_ANIM(iLocal_237[iVar0], &sLocal_349, &(Local_397[iVar0 /*16*/]), 8f, -8f, -1, 9, 0, 0, 0, 0);
					iLocal_243[iVar0] = 0;
				}
...
int func_42(var uParam0, int iParam1, int iParam2)
{
	...
	switch (iParam1)
	{
		case 4:
			...
			PED::SET_PED_PROP_INDEX(uParam0, 0, 0, 1, 0);
			return 1;
			break;
		...
		case 9:
			if (iParam2 == 108)
			{
				iVar0 = 12;
				iVar1 = 32;
				if (GAMEPLAY::IS_BIT_SET(Global_106565.f_2357.f_539.f_3816[0 /*166*/][iVar0 /*11*/][(iVar1 / 32)], (iVar1 % 32)))
				{
...
int func_43(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_44(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_44(iParam1)))
	{
		return 1;
	}
	return 0;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_49(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_49(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_49(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_49(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_44(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_44(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_77(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_66(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_66(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_44(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_132(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_44(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_44(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_44(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_155(iVar0);
						if (Global_71400 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_44(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_44(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_44(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
void func_149(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_150(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
...
void func_170()
{
	...
	{
		case 86:
			vLocal_339[0 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), 0f };
			fLocal_346[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			iLocal_240[0] = 14;
			iLocal_246[0] = 0;
			iLocal_249[0] = 19;
		...
		case 168:
			vLocal_339[0 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), 0f };
			fLocal_346[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			vLocal_339[1 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), 0f };
			fLocal_346[1] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			iLocal_240[0] = 14;
			iLocal_240[1] = 15;
			iLocal_246[0] = 0;
			iLocal_246[1] = 1;
		...
		case 173:
			...
			vLocal_259[0 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), 0f };
			uLocal_266[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
		...
		default:
			vLocal_339[0 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_339[1 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			fLocal_346[0] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_346[1] = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			iLocal_240[0] = 145;
			iLocal_240[1] = 145;
...
bool func_176(var uParam0)
{
	...
	*uParam0 = 5;
	...
	while (iVar5 < 5)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_106565.f_7223.f_11[iVar5], 0))
		{
