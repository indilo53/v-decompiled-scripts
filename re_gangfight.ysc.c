...
void func_1()
{
	...
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_2(PLAYER::PLAYER_ID()), vLocal_50, 1) > 50f)
	{
		func_140();
	}
}
...
void func_53()
{
	...
	switch (iLocal_48)
	{
		...
		case 4:
			if (!PED::IS_PED_INJURED(uLocal_68))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(uLocal_68, 916.5764f, 3602.146f, 31.9262f, 3.3f, 3.3f, 3.3f, 0, 1, 0))
				{
					if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_68, 8f, 8f, 8f, 0, 1, 0))
					{
						if (!func_8())
						{
							if (func_41(&uLocal_85, "RECGFAU", "RECGF_STASH", 4, 0, 0, 0))
							{
								AI::TASK_TURN_PED_TO_FACE_ENTITY(uLocal_68, PLAYER::PLAYER_PED_ID(), -1);
								if (!ENTITY::IS_ENTITY_DEAD(uLocal_76, 0))
								{
									ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_76);
								}
			...
			if (!PED::IS_PED_INJURED(uLocal_68))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_68, 8f, 8f, 8f, 0, 1, 0))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) || PED::IS_PED_ON_ANY_BIKE(PLAYER::PLAYER_PED_ID()))
					{
						...
						{
							func_40(1000);
							if ((!PED::IS_PED_INJURED(uLocal_68) && !PED::IS_PED_INJURED(iLocal_69[2])) && !ENTITY::IS_ENTITY_DEAD(uLocal_76, 0))
							{
								AI::OPEN_SEQUENCE_TASK(&uLocal_84);
								...
								if ((!PED::IS_PED_INJURED(uLocal_68) && !ENTITY::IS_ENTITY_DEAD(uLocal_76, 0)) && PED::IS_PED_IN_ANY_VEHICLE(uLocal_68, 0))
								{
									iLocal_48++;
								}
								else
								{
									if (!PED::IS_PED_INJURED(uLocal_68) && !PED::IS_PED_INJURED(iLocal_69[2]))
									{
										AI::OPEN_SEQUENCE_TASK(&uLocal_84);
										AI::TASK_COWER(0, -1);
										AI::CLOSE_SEQUENCE_TASK(uLocal_84);
		...
		case 7:
			if ((((!PED::IS_PED_INJURED(uLocal_68) && !ENTITY::IS_ENTITY_DEAD(uLocal_76, 0)) && !PED::IS_PED_IN_VEHICLE(uLocal_68, uLocal_76, 0)) && !PED::IS_PED_IN_COVER(uLocal_68, 0)) && !PED::IS_PED_GOING_INTO_COVER(uLocal_68))
			{
			}
			iVar0 = 0;
			while (iVar0 < iLocal_69)
			...
			if (ENTITY::IS_ENTITY_AT_COORD(iLocal_69[2], 970.3641f, 3629.886f, 31.3694f, 5f, 5f, 5f, 0, 1, 0) || SYSTEM::TIMERB() > 13000)
			{
				...
				if (!PED::IS_PED_INJURED(uLocal_68))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_68, 15f, 15f, 15f, 0, 1, 0))
					{
						func_54();
						func_40(0);
		...
		if ((STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_lost_01")) && STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_lost_02"))) && AUDIO::IS_AUDIO_SCENE_ACTIVE("RE_COUNTRYSIDE_GANG_FIGHT_SCENE"))
		{
			...
			while (iVar0 < iLocal_69)
			{
				if (!PED::IS_PED_INJURED(iLocal_69[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_77[iVar0], 0))
				{
					...
					AI::OPEN_SEQUENCE_TASK(&uLocal_84);
					AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_77[2], 966.7098f, 3633.926f, 31.3974f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					AI::TASK_LOOK_AT_COORD(0, vLocal_50, 5000, 0, 2);
					AI::CLOSE_SEQUENCE_TASK(uLocal_84);
					AI::TASK_PERFORM_SEQUENCE(iLocal_69[2], uLocal_84);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_84);
					AI::OPEN_SEQUENCE_TASK(&uLocal_84);
					AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_77[3], 970.6208f, 3636.743f, 31.3666f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					AI::TASK_LOOK_AT_COORD(0, vLocal_50, 5000, 0, 2);
					AI::CLOSE_SEQUENCE_TASK(uLocal_84);
					...
					AI::OPEN_SEQUENCE_TASK(&uLocal_84);
					AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_77[4], 971.023f, 3631.225f, 31.3807f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					AI::TASK_LOOK_AT_COORD(0, vLocal_50, 5000, 0, 2);
					AI::CLOSE_SEQUENCE_TASK(uLocal_84);
					AI::TASK_PERFORM_SEQUENCE(iLocal_69[4], uLocal_84);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_84);
					AI::OPEN_SEQUENCE_TASK(&uLocal_84);
					AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_77[5], 974.8073f, 3633.771f, 31.3818f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					AI::TASK_LOOK_AT_COORD(0, vLocal_50, 5000, 0, 2);
					AI::CLOSE_SEQUENCE_TASK(uLocal_84);
...
void func_58()
{
	if (!PED::IS_PED_INJURED(uLocal_68))
	{
		AI::TASK_SMART_FLEE_PED(uLocal_68, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
		PED::SET_PED_KEEP_TASK(uLocal_68, 1);
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_69[0], 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_69[1], 0))
		{
			ENTITY::SET_ENTITY_HEALTH(uLocal_68, 101, 0);
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_68, 0);
			AI::TASK_SHOOT_AT_ENTITY(iLocal_69[0], uLocal_68, 1000, 0);
			AI::TASK_SHOOT_AT_ENTITY(iLocal_69[1], uLocal_68, 1000, 0);
		}
		else
		{
			func_4();
...
void func_61()
{
	...
	{
		case 0:
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_68, 45f, 45f, 20f, 0, 1, 0))
			{
				if (!func_8())
				{
					if (func_48() == 0)
		...
		case 1:
			if (!PED::IS_PED_INJURED(uLocal_68))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_68, 40f, 40f, 20f, 0, 1, 0))
				{
		...
		case 3:
			if ((!PED::IS_PED_INJURED(uLocal_68) && !PED::IS_PED_INJURED(iLocal_69[0])) && !PED::IS_PED_INJURED(iLocal_69[1]))
			{
				...
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_68, 12f, 12f, 2.5f, 0, 1, 0))
					{
					...
					{
						if (!PED::IS_PED_FACING_PED(iLocal_69[0], uLocal_68, 10f))
						{
							AI::TASK_AIM_GUN_AT_ENTITY(iLocal_69[0], uLocal_68, -1, 0);
						}
					}
				}
...
int func_75(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_76(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_76(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
int func_77()
{
	...
	if (!bLocal_55)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_69[0]))
		{
			...
			if (((GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(vVar3, vVar0, joaat("weapon_smokegrenade"), 1) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(vVar3, vVar0, joaat("weapon_grenade"), 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(vVar3, vVar0, joaat("weapon_grenadelauncher"), 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(vVar3, vVar0, joaat("weapon_stickybomb"), 1))
			{
				func_4();
				return 1;
			}
...
void func_78()
{
	...
	{
		if ((!ENTITY::IS_ENTITY_AT_COORD(uLocal_76, 915.7905f, 3603.449f, 31.9111f, 5f, 5f, 5f, 0, 1, 0) && !PED::IS_PED_IN_VEHICLE(uLocal_68, uLocal_76, 0)) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_76, 1))
		{
			func_58();
		}
	}
...
int func_79()
{
	...
	if (((((!ENTITY::DOES_ENTITY_EXIST(uLocal_68) && !ENTITY::DOES_ENTITY_EXIST(iLocal_69[0])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_69[1])) && !ENTITY::DOES_ENTITY_EXIST(uLocal_76)) && !ENTITY::DOES_ENTITY_EXIST(iLocal_77[0])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_77[1]))
	{
		...
		if (((((((STREAMING::HAS_MODEL_LOADED(joaat("a_m_m_skidrow_01")) && STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_lost_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_lost_02"))) && STREAMING::HAS_MODEL_LOADED(joaat("picador"))) && STREAMING::HAS_MODEL_LOADED(joaat("hexer"))) && STREAMING::HAS_ANIM_DICT_LOADED("random@countryside_gang_fight")) && STREAMING::HAS_ANIM_DICT_LOADED("veh@drivebystd_ds_grenades")) && STREAMING::HAS_ANIM_SET_LOADED("move_m@gangster@var_i"))
		{
			...
			uLocal_68 = PED::CREATE_PED(26, joaat("a_m_m_skidrow_01"), 973.053f, 3616.738f, 31.6181f, 110.2753f, 1, 1);
			PED::SET_PED_COMPONENT_VARIATION(uLocal_68, 0, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(uLocal_68, 2, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(uLocal_68, 3, 1, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION(uLocal_68, 4, 0, 0, 0);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("a_m_m_skidrow_01"));
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_68, 1);
			PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_68, 17, 1);
			PED::SET_PED_CAN_BE_TARGETTED(uLocal_68, 0);
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_68, 1);
			PED::SET_PED_CONFIG_FLAG(uLocal_68, 185, 1);
			PED::_SET_PED_RAGDOLL_BLOCKING_FLAGS(uLocal_68, 16);
			AUDIO::SET_AMBIENT_VOICE_NAME(uLocal_68, "A_M_M_TRAMP_01_BLACK_MINI_01");
			func_57(&uLocal_85, 1, uLocal_68, "RECGFDealer", 0, 1);
			AUDIO::STOP_PED_SPEAKING(uLocal_68, 1);
			AI::TASK_PLAY_ANIM(uLocal_68, "random@countryside_gang_fight", "gangmember_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
			PED::SET_PED_MOVEMENT_CLIPSET(uLocal_68, "move_m@gangster@var_i", 1048576000);
			uLocal_76 = VEHICLE::CREATE_VEHICLE(joaat("picador"), 915.7905f, 3603.449f, 31.9111f, 111.9593f, 1, 1, 0);
			VEHICLE::SET_VEHICLE_COLOURS(uLocal_76, 37, 0);
			VEHICLE::SET_VEHICLE_EXTRA_COLOURS(uLocal_76, 4, 0);
			VEHICLE::SET_VEHICLE_PROVIDES_COVER(uLocal_76, 1);
			VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(uLocal_76, "WDU 696");
...
int func_93()
{
	if ((Global_106554 == func_37() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
void func_140()
{
	...
	if (iLocal_53 && !iLocal_58)
	{
		...
		if (!PED::IS_PED_INJURED(uLocal_68))
		{
			PED::SET_PED_CONFIG_FLAG(uLocal_68, 317, 1);
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_68, 0);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_68, 0);
		}
		iVar0 = 0;
