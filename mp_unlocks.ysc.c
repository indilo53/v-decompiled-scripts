...
int func_1(var uParam0)
{
	...
	if (iVar0 > 16)
	{
		...
		UI::PAUSE_MENU_ACTIVATE_CONTEXT(-1871331138);
	}
	else
	{
		iLocal_118 = 0;
...
void func_3(int iParam0, bool bParam1)
{
	if (GRAPHICS::_BEGIN_SCALEFORM_MOVIE_METHOD_N("SHOW_COLUMN"))
	{
		...
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(bParam1);
...
{
	func_17(1, *iParam0, uLocal_112, *iParam0, cParam1, bParam2, 1);
	*iParam0++;
}
...
void func_27(int iParam0, int iParam1)
{
	...
	func_17(1, *iParam0, uLocal_112, *iParam0, &cVar0, iParam1, 0);
	*iParam0++;
}
...
void func_37(int iParam0, int iParam1, int iParam2)
{
	...
	StringIntConCat(&cVar0, *iParam0, 16);
	func_38(1, *iParam0, uLocal_112, *iParam0, &cVar0, "PM_UGEN_NUM", iParam1, iParam2);
	*iParam0++;
}
...
void func_38(int iParam0, var uParam1, var uParam2, var uParam3, char[4] cParam4, char* sParam5, var uParam6, var uParam7)
{
	if (GRAPHICS::_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_DATA_SLOT"))
	{
		...
		UI::ADD_TEXT_COMPONENT_INTEGER(uParam6);
		UI::ADD_TEXT_COMPONENT_INTEGER(uParam7);
		GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	}
}
...
void func_44(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (GRAPHICS::_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_COLUMN_HIGHLIGHT"))
	{
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam0);
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iParam1);
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(iParam2);
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(iParam3);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	}
}
...
void func_45()
{
	...
	func_43(0);
	iLocal_117 = 0;
	func_47(0, 0, uLocal_111, 0, 1, "PM_UL_D0", 0, 0, 0);
	func_47(0, 1, uLocal_111, 1, 1, "PM_UL_D1", 0, 0, 0);
	func_47(0, 2, uLocal_111, 2, 1, "PM_UL_D2", 0, 0, 0);
	func_2(0);
	func_46(2);
	func_46(3);
	func_46(4);
...
void func_47(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4, char* sParam5, bool bParam6, int iParam7, bool bParam8)
{
	if (GRAPHICS::_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_DATA_SLOT"))
	{
		...
		if (bParam8)
		{
			GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(21);
			GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(bParam8);
		}
