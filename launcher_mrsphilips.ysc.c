...
void __EntryFunction__()
{
	...
	func_229(&Var0);
	uLocal_92 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar61 - Vector(20f, 20f, 20f), vVar61 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_194(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_194(uParam1) && uParam1->f_4 == 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_209(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_211(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_218(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_211(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_211(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_210(vVar3, vVar0);
