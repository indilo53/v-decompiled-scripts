...
void __EntryFunction__()
{
	...
	if (func_69(PLAYER::PLAYER_PED_ID()))
	{
		while (bVar0 == 0)
		{
			bVar0 = ((GAMEPLAY::GET_MISSION_FLAG() == 0 && func_65() == 0) && func_64(PLAYER::PLAYER_PED_ID(), vLocal_64, fLocal_67));
			func_62();
		}
	}
	func_61(65, 0);
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				uVar1 = GAMEPLAY::ACOS(func_51(vLocal_250, 0.73f, 0.683f, -0.013f));
...
{
	uParam0->f_1 = VEHICLE::CREATE_VEHICLE(joaat("akuma"), vParam1, fParam4, 1, 1, 0);
...
int func_52(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	...
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(uParam0, vParam1, vParam4, fParam7, 0, 1, 0))
	{
		return 1;
	}
	...
	vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, Var3, Var6.f_1, 0f) };
	if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam4, fParam7, 0, 1))
	{
		return 1;
	}
	vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, 0f, Var6.f_1, 0f) };
	if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam4, fParam7, 0, 1))
	{
		return 1;
	}
	vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, Var6, Var6.f_1, 0f) };
	if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam4, fParam7, 0, 1))
	{
		return 1;
	}
	vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, Var3, Var3.f_1, 0f) };
	if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam4, fParam7, 0, 1))
	{
		return 1;
	}
	vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, 0f, Var3.f_1, 0f) };
	if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam4, fParam7, 0, 1))
	{
		return 1;
	}
	vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, Var6, Var3.f_1, 0f) };
	if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam4, fParam7, 0, 1))
	{
		return 1;
	}
...
void func_58(var uParam0)
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			{
				uVar2 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
				uVar1 = GAMEPLAY::ACOS(func_51(vLocal_250, -0.37f, -0.927f, -0.053f));
