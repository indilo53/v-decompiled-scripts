					...
					case 1:
						switch (iLocal_46)
						{
							case 0:
								...
								{
									func_176();
									if (INTERIOR::IS_INTERIOR_READY(uLocal_153))
									{
										func_170();
										iLocal_137 = 1;
									}
								...
								else
								{
									...
									func_167();
									INTERIOR::UNPIN_INTERIOR(uLocal_153);
									if (func_166())
									{
										if (!iLocal_159)
										{
									...
									if (func_164())
									{
										...
										OBJECT::DELETE_OBJECT(&uLocal_167);
										bLocal_140 = true;
										iLocal_46 = 1;
										iLocal_47 = 3;
									}
									if (func_162())
									{
										func_155(1);
										SYSTEM::SETTIMERA(0);
										DECISIONEVENT::ADD_SHOCKING_EVENT_AT_POSITION(88, vLocal_194, 15000f);
										iLocal_46 = 1;
									}
								}
								break;
								...
								switch (iLocal_47)
								{
									...
									case 2:
										...
										if (SYSTEM::TIMERB() > 500)
										{
											...
											{
												if (!ENTITY::IS_ENTITY_ATTACHED(uLocal_167))
												{
													func_143();
													WEAPON::SET_CURRENT_PED_WEAPON(iLocal_114[0], joaat("weapon_unarmed"), 1);
													ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_167, iLocal_114[0], PED::GET_PED_BONE_INDEX(iLocal_114[0], 57005), 0.3f, 0f, 0f, 80f, -90f, 0f, 1, 1, 0, 0, 2, 1);
												}
											}
										}
										if (GAMEPLAY::IS_PROJECTILE_IN_AREA(vLocal_194 - Vector(20f, 20f, 20f), vLocal_194 + Vector(20f, 20f, 20f), 0))
										{
											if (!PED::IS_PED_INJURED(iLocal_117[1]))
											{
												AI::TASK_SMART_FLEE_COORD(iLocal_117[1], vLocal_103, 150f, -1, 0, 0);
											...
											{
												AI::TASK_SMART_FLEE_COORD(iLocal_117[2], vLocal_103, 150f, -1, 0, 0);
											...
											while (iVar2 <= (iLocal_113 - 1))
											{
												if (!PED::IS_PED_INJURED(iLocal_121[iVar2]))
												{
													...
													AI::TASK_SMART_FLEE_COORD(0, vLocal_103, 150f, -1, 0, 0);
											...
											if (!iLocal_164)
											{
												if (!ENTITY::IS_ENTITY_DEAD(iLocal_114[0], 0))
												{
													...
													if (iLocal_49 == 1)
													{
														if (ENTITY::DOES_ENTITY_EXIST(uLocal_167))
														{
															ENTITY::SET_ENTITY_VISIBLE(uLocal_167, 0, 0);
															ENTITY::SET_ENTITY_COLLISION(uLocal_167, 0, 0);
														}
													}
													else if (iLocal_49 == 2)
													{
													...
													if (!PED::IS_PED_INJURED(iLocal_117[0]))
													{
														...
														AI::OPEN_SEQUENCE_TASK(&uLocal_152);
														AI::TASK_PLAY_ANIM(0, "random@robbery", "f_distressed_loop", 2f, -2f, -1, 9, 0, 0, 0, 0);
														AI::CLOSE_SEQUENCE_TASK(uLocal_152);
										...
										if (iLocal_49 == 1)
										{
											...
											if (!PED::IS_PED_INJURED(iLocal_114[0]) && VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_175, 0))
											{
												if (PED::IS_PED_IN_VEHICLE(iLocal_114[0], uLocal_175, 0))
												{
													if (ENTITY::DOES_ENTITY_EXIST(uLocal_167))
													{
														OBJECT::DELETE_OBJECT(&uLocal_167);
											...
											if (func_113() && !iLocal_162)
											{
												...
												bLocal_161 = true;
												if (!PED::IS_PED_INJURED(uLocal_184))
												{
													PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_184, 17, 1);
													PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_184, 6, 1);
													PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_184, 1, 1);
													AI::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_184, uLocal_175, PLAYER::PLAYER_PED_ID(), 8, 16f, 786469, -1f, -1f, 1);
													PED::SET_PED_KEEP_TASK(uLocal_184, 1);
													iLocal_162 = 1;
												}
											}
											if (iLocal_162 && !iLocal_224)
											{
												if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_175, 0) && !PED::IS_PED_INJURED(uLocal_184))
												{
													if (!ENTITY::IS_ENTITY_AT_COORD(uLocal_175, vLocal_55[0 /*3*/], 20f, 20f, 10f, 0, 1, 0))
													{
														AI::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_184, uLocal_175, PLAYER::PLAYER_PED_ID(), 8, 19f, 786469, -1f, -1f, 1);
														iLocal_224 = 1;
													}
												}
											}
											if (func_110())
											{
												if (!PED::IS_PED_INJURED(uLocal_184))
												{
													if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_175, 0))
													{
														if (!iLocal_163)
														{
															PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_184, 17, 1);
															PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_184, 6, 1);
															PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_184, 1, 1);
															AI::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_184, uLocal_175, PLAYER::PLAYER_PED_ID(), 8, 17f, 786469, -1f, -1f, 1);
															iLocal_163 = 1;
														}
												...
												while (iVar3 <= (iLocal_111 - 1))
												{
													if (!iLocal_141[iVar3])
													{
														...
														{
															if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_114[iVar3], 0) && !PED::IS_PED_INJURED(uLocal_184))
															{
													...
													if (!iLocal_144[iVar3])
													{
														if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_175, 0))
														{
															if (!PED::IS_PED_INJURED(iLocal_114[iVar3]))
															{
																if ((PED::IS_PED_INJURED(uLocal_184) || VEHICLE::IS_VEHICLE_SEAT_FREE(uLocal_175, -1, 0)) || FIRE::IS_ENTITY_ON_FIRE(iLocal_114[iVar3]))
																{
																	...
																	if (!PED::IS_PED_INJURED(uLocal_184))
																	{
																		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_184, 1, 1);
																		AI::OPEN_SEQUENCE_TASK(&uLocal_152);
																		AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
																		AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
																		AI::CLOSE_SEQUENCE_TASK(uLocal_152);
																		AI::TASK_PERFORM_SEQUENCE(uLocal_184, uLocal_152);
																		AI::CLEAR_SEQUENCE_TASK(&uLocal_152);
																		PED::SET_PED_KEEP_TASK(uLocal_184, 1);
																	}
										...
										else if (iLocal_49 == 2)
										{
											...
											if (PED::IS_PED_INJURED(iLocal_114[0]))
											{
												if (ENTITY::DOES_ENTITY_EXIST(uLocal_167))
												{
													if (ENTITY::IS_ENTITY_ATTACHED(uLocal_167))
													{
														ENTITY::DETACH_ENTITY(uLocal_167, 1, 1);
													}
													OBJECT::DELETE_OBJECT(&uLocal_167);
													func_108();
													func_105();
									...
									case 10:
											...
											if (!iLocal_160)
											{
												...
												else if (!PED::IS_PED_INJURED(iLocal_117[0]))
												{
													...
													while (iVar5 <= (iLocal_113 - 1))
													{
														...
														{
															AI::TASK_SMART_FLEE_COORD(iLocal_121[iVar5], vLocal_103, 150f, -1, 0, 0);
										...
										if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_242()) > (fLocal_197 + 150f))
										{
											iLocal_47 = 12;
										}
...
void func_1()
{
	...
	if (bLocal_181)
	{
		if (!iLocal_183)
		{
			...
			uLocal_216 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_198, vLocal_204, 2);
			...
			uLocal_167 = OBJECT::CREATE_OBJECT(joaat("prop_cs_duffel_01"), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1, 1, 0);
			ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_167, uLocal_216, sLocal_214, sLocal_211, 1000f, 1090519040, 0, 1148846080);
			if (!PED::IS_PED_INJURED(iLocal_117[0]))
			{
				func_52();
	...
	if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_216) > fLocal_217 && iLocal_183)
	{
		if (!PED::IS_PED_INJURED(iLocal_117[0]))
		{
			...
			AI::CLEAR_PED_TASKS(iLocal_117[0]);
			AI::OPEN_SEQUENCE_TASK(&uLocal_152);
			AI::TASK_PLAY_ANIM(0, "random@robbery", "stand_worried_female", 2f, -2f, -1, 1, 0, 0, 0, 0);
			AI::CLOSE_SEQUENCE_TASK(uLocal_152);
			AI::TASK_PERFORM_SEQUENCE(iLocal_117[0], uLocal_152);
			AI::CLEAR_SEQUENCE_TASK(&uLocal_152);
			PED::SET_PED_KEEP_TASK(iLocal_117[0], 1);
...
void func_16(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_18() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_18() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
int func_21(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_18() /*10778*/].f_6165.f_10, iParam0);
}
...
void func_102()
{
	if (OBJECT::HAS_PICKUP_BEEN_COLLECTED(uLocal_110))
	{
		...
		func_103(&uLocal_229);
		fLocal_197 = SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_242());
		SYSTEM::SETTIMERA(0);
		iLocal_47 = 10;
	}
...
void func_105()
{
	...
	if (!OBJECT::DOES_PICKUP_EXIST(uLocal_110))
	{
		...
		if (!bLocal_161)
		{
			...
			{
				vLocal_107 = { OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_114[0], 1), 1067030938, 1069547520) };
			}
		}
		else if (ENTITY::DOES_ENTITY_EXIST(uLocal_175))
		{
			vLocal_107 = { OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_175, 0), 1067030938, 1069547520) };
		}
		vLocal_107 = { vLocal_107.x, vLocal_107.y, (vLocal_107.z + 0.25f) };
		uLocal_110 = OBJECT::CREATE_PICKUP(joaat("pickup_money_med_bag"), vLocal_107, uLocal_106, iLocal_189, 1, joaat("prop_cs_duffel_01"));
...
int func_106(var uParam0)
{
	...
	UI::SET_BLIP_SCALE(uVar0, func_107(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
	return uVar0;
}
...
int func_109()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_184))
	{
		iLocal_151 = 1;
	}
	else if (PED::IS_PED_INJURED(uLocal_184) || !PED::IS_PED_IN_ANY_VEHICLE(uLocal_184, 0))
	{
		iLocal_151 = 1;
	}
...
int func_110()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_184))
	{
		if (!PED::IS_PED_INJURED(uLocal_184) || ENTITY::IS_ENTITY_DEAD(uLocal_184, 0))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_184, PLAYER::PLAYER_PED_ID(), 1))
			{
				return 1;
			}
		}
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_184))
	{
		if (!PED::IS_PED_INJURED(uLocal_184))
		{
			if (PED::IS_PED_BEING_JACKED(uLocal_184))
			{
				if (PED::GET_PEDS_JACKER(uLocal_184) == PLAYER::PLAYER_PED_ID())
				{
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_184, 1, 1);
					AI::TASK_SMART_FLEE_PED(uLocal_184, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
					PED::SET_PED_KEEP_TASK(uLocal_184, 1);
					SYSTEM::WAIT(0);
					ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uLocal_184);
					return 1;
				}
			}
		}
	...
	{
		if (!ENTITY::IS_ENTITY_DEAD(uLocal_175, 0) || ENTITY::IS_ENTITY_DEAD(uLocal_175, 0))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_175, PLAYER::PLAYER_PED_ID(), 1))
			{
				return 1;
			}
		}
...
int func_112(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_107(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_175, 0))
	{
		if (!PED::IS_PED_INJURED(iLocal_114[0]))
		{
			if (PED::IS_PED_IN_VEHICLE(iLocal_114[0], uLocal_175, 0))
			{
				if (!PED::IS_PED_INJURED(iLocal_114[1]))
				{
					if (PED::IS_PED_IN_VEHICLE(iLocal_114[1], uLocal_175, 0))
					{
						return 1;
					}
				}
...
void func_143()
{
	...
	vVar0 = { ENTITY::GET_ENTITY_COORDS(uLocal_167, 1) };
	vVar3 = { ENTITY::GET_ENTITY_ROTATION(uLocal_167, 2) };
	OBJECT::DELETE_OBJECT(&uLocal_167);
	uLocal_167 = OBJECT::CREATE_OBJECT(joaat("prop_cs_duffel_01"), vVar0, 1, 1, 0);
	ENTITY::SET_ENTITY_ROTATION(uLocal_167, vVar3, 2, 1);
}
...
void func_144()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_175))
	{
		if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(uLocal_175, 0)) > 200f && ENTITY::IS_ENTITY_OCCLUDED(uLocal_175))
		{
			if (UI::DOES_BLIP_EXIST(uLocal_191))
			{
				UI::REMOVE_BLIP(&uLocal_191);
			}
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_175);
			bLocal_148 = true;
		}
	}
	else
...
void func_145()
{
	if (!ENTITY::IS_ENTITY_DEAD(uLocal_175, 0))
	{
		if (ENTITY::GET_ENTITY_HEALTH(uLocal_175) < 800)
		{
			ENTITY::SET_ENTITY_HEALTH(uLocal_175, 0, 0);
			VEHICLE::SET_VEHICLE_ENGINE_HEALTH(uLocal_175, 10f);
		}
	}
}
...
void func_147()
{
	...
	if (!bLocal_140)
	{
		...
		else if (iLocal_49 == 2)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_167) && !PED::IS_PED_INJURED(iLocal_114[0]))
			{
				if (!iLocal_178)
				{
					iLocal_178 = 1;
				...
				if (SYSTEM::TIMERA() > 14100)
				{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_175, 0))
					{
						if (!PED::IS_PED_INJURED(iLocal_114[0]))
						{
							...
							AI::TASK_ENTER_VEHICLE(0, uLocal_175, -1, 0, 2f, 1, 0);
							AI::CLOSE_SEQUENCE_TASK(uLocal_152);
						...
						if (!PED::IS_PED_INJURED(iLocal_114[1]))
						{
							...
							AI::OPEN_SEQUENCE_TASK(&uLocal_152);
							AI::TASK_CLEAR_LOOK_AT(0);
							AI::TASK_ENTER_VEHICLE(0, uLocal_175, -1, 1, 2f, 1, 0);
							AI::CLOSE_SEQUENCE_TASK(uLocal_152);
			...
			else if (iLocal_49 == 2)
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_216) > 0.453f)
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_114[0]))
					{
						...
						ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_114[0], 1, 1);
						AI::OPEN_SEQUENCE_TASK(&uLocal_152);
						AI::TASK_PLAY_ANIM(0, "random@robbery", "run", 2f, -2f, -1, 49, 0, 0, 0, 0);
...
void func_150()
{
	...
	if (!iLocal_136 && func_153(1, 0, 1))
	{
		...
		if (iLocal_49 == 1)
		{
			if (!iLocal_177)
			{
				uLocal_216 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_201, vLocal_207, 2);
				AI::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				...
				if (((!PED::IS_PED_INJURED(iLocal_114[0]) && !PED::IS_PED_INJURED(iLocal_114[1])) && !PED::IS_PED_INJURED(iLocal_117[0])) && ENTITY::DOES_ENTITY_EXIST(uLocal_167))
				{
					...
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_167, uLocal_216, "robbery_action_bag", "random@shop_robbery", 8f, -8f, 0, 1148846080);
				}
		...
		else if (iLocal_49 == 2)
		{
			...
			AI::TASK_PLAY_ANIM(0, "random@shop_robbery", "kneel_loop_p", 2f, -4f, -1, 134217737, 0, 0, 0, 0);
			AI::CLOSE_SEQUENCE_TASK(uLocal_152);
	...
	if ((iLocal_49 == 1 && ENTITY::DOES_ENTITY_EXIST(uLocal_175)) || iLocal_49 == 2)
	{
		SYSTEM::SETTIMERA(0);
		iLocal_47 = 1;
	}
...
void func_151()
{
	...
	else if (STREAMING::HAS_MODEL_LOADED(iVar0))
	{
		...
		uLocal_175 = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_172, 31.9252f, 1, 1, 0);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_175, 1, 1);
		VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_175, 1084227584);
		VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_175, 1, 1, 0);
		uLocal_184 = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_175, 26, joaat("g_m_y_korean_01"), -1, 1, 1);
		PED::SET_PED_CONFIG_FLAG(uLocal_184, 134, 1);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_184, 1);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_184, uLocal_190);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_184, 8, 0);
		PED::SET_PED_COMBAT_ABILITY(uLocal_184, 0);
		PED::SET_PED_ACCURACY(uLocal_184, 13);
		WEAPON::GIVE_WEAPON_TO_PED(uLocal_184, joaat("weapon_pistol"), -1, 1, 1);
		ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(uLocal_184, 1, 0);
		PED::SET_PED_CONFIG_FLAG(uLocal_184, 42, 1);
		iLocal_176 = 1;
	}
}
...
int func_152()
{
	...
	{
		if (ENTITY::IS_ENTITY_AT_COORD(uVar0, -829.3693f, -191.9869f, 36.4616f, 15f, 15f, 5f, 0, 1, 0))
		{
			uLocal_171 = uVar0;
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_169(iParam3), 0);
}
...
void func_170()
{
	...
	PED::ADD_RELATIONSHIP_GROUP("ROBBERS", &uLocal_190);
	iVar0 = 0;
	while (iVar0 <= (iLocal_111 - 1))
	{
		iLocal_114[iVar0] = PED::CREATE_PED(26, iLocal_222, vLocal_55[iVar0 /*3*/], fLocal_62[iVar0], 1, 1);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_114[iVar0], 1);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_114[iVar0], uLocal_190);
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_190, 1862763509);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_190);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_190, -1533126372);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, -1533126372, uLocal_190);
	if (func_43() == 0)
	{
	...
	uLocal_167 = OBJECT::CREATE_OBJECT(iLocal_188, vLocal_97, 1, 1, 0);
	if (iLocal_49 == 1)
	{
		...
		uLocal_168[0] = OBJECT::CREATE_OBJECT(joaat("prop_anim_cash_pile_01"), vLocal_97, 1, 1, 0);
		uLocal_168[1] = OBJECT::CREATE_OBJECT(joaat("prop_anim_cash_pile_01"), vLocal_97 - Vector(0.1f, 0f, 0f), 1, 1, 0);
		...
		ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_167, uLocal_216, "robbery_intro_loop_bag", "random@shop_robbery", 1000f, 1090519040, 0, 1148846080);
		iVar0 = 0;
		while (iVar0 <= (iLocal_112 - 1))
		{
			iLocal_117[iVar0] = PED::CREATE_PED(26, iLocal_219, vLocal_65[iVar0 /*3*/], fLocal_75[iVar0], 1, 1);
		...
		iLocal_121[0] = PED::CREATE_PED(26, iLocal_220, vLocal_79[0 /*3*/], fLocal_92[0], 1, 1);
		...
		while (iVar0 <= 2)
		{
			iLocal_121[iVar0] = PED::CREATE_PED(26, iLocal_221, vLocal_79[iVar0 /*3*/], fLocal_92[iVar0], 1, 1);
	...
	else if (iLocal_49 == 2)
	{
		...
		ENTITY::SET_ENTITY_ROTATION(uLocal_167, vLocal_100, 2, 1);
		iLocal_117[0] = PED::CREATE_PED(26, iLocal_219, vLocal_65[0 /*3*/], fLocal_75[0], 1, 1);
		PED::SET_PED_NAME_DEBUG(iLocal_117[0], "pedWorker[0]");
		...
		iLocal_117[1] = PED::CREATE_PED(26, iLocal_218, vLocal_65[1 /*3*/], fLocal_75[1], 1, 1);
		PED::SET_PED_NAME_DEBUG(iLocal_117[1], "pedWorker[1]");
		iVar0 = 0;
		while (iVar0 <= (iLocal_112 - 1))
		{
		...
		iLocal_121[0] = PED::CREATE_PED(26, iLocal_220, vLocal_79[0 /*3*/], fLocal_92[0], 1, 1);
		PED::SET_PED_NAME_DEBUG(iLocal_121[0], "pedShopper[0]");
		iLocal_121[1] = PED::CREATE_PED(26, iLocal_221, vLocal_79[1 /*3*/], fLocal_92[1], 1, 1);
		PED::SET_PED_NAME_DEBUG(iLocal_121[1], "pedShopper[1]");
		iVar0 = 0;
...
void func_176()
{
	if (!iLocal_135)
	{
		uLocal_153 = INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_55[0 /*3*/]);
		INTERIOR::_LOAD_INTERIOR(uLocal_153);
		iLocal_135 = 1;
	}
}
...
void func_177()
{
	...
	if ((((((((((STREAMING::HAS_MODEL_LOADED(iLocal_219) && STREAMING::HAS_MODEL_LOADED(iLocal_220)) && STREAMING::HAS_MODEL_LOADED(iLocal_221)) && STREAMING::HAS_MODEL_LOADED(iLocal_222)) && STREAMING::HAS_MODEL_LOADED(joaat("prop_anim_cash_pile_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("prop_cs_duffel_01"))) && AI::GET_IS_WAYPOINT_RECORDING_LOADED("re_shoprobbery")) && AI::GET_IS_WAYPOINT_RECORDING_LOADED("re_shoprobbery2")) && STREAMING::HAS_ANIM_DICT_LOADED("random@robbery")) && STREAMING::HAS_ANIM_DICT_LOADED("random@shop_robbery")) && AUDIO::PREPARE_MUSIC_EVENT("RE51A_SHOP"))
	{
		iLocal_53 = 1;
	}
	else
...
int func_192()
{
	if ((Global_106554 == func_70() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
	...
	if (iLocal_223)
	{
		...
		while (iVar0 <= (iLocal_111 - 1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_114[iVar0]))
			{
				...
				{
					AI::TASK_SMART_FLEE_COORD(iLocal_114[iVar0], vLocal_103, 150f, -1, 0, 0);
					PED::SET_PED_KEEP_TASK(iLocal_114[iVar0], 1);
				}
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_114[iVar0]));
			}
				...
				if (!PED::IS_PED_INJURED(iLocal_117[iVar0]))
				{
					...
					if (iVar0 == 0)
					{
						if (!iLocal_183)
						{
							...
							AI::TASK_SMART_FLEE_COORD(iLocal_117[iVar0], vLocal_103, 150f, -1, 0, 0);
						}
						else
						{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_167))
		{
			...
			ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_167);
		}
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_175))
		{
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_175);
...
Vector3 func_242()
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_128, 1);
		iLocal_127 = 1;
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_131, 1) < fVar0)
		{
			fVar0 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_131, 1);
			iLocal_127 = 2;
		}
		if (iLocal_127 == 1)
		{
