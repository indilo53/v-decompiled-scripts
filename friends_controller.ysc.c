...
void __EntryFunction__()
{
	...
	while (iVar0 < 9)
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(Global_106565.f_18097.f_175[iVar0 /*19*/].f_18, 1))
			{
				func_457(iVar0, 0);
				Global_89447++;
			}
...
void func_2(var uParam0, var uParam1)
{
	...
	if (func_393() || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		if (uParam0->f_49 == 0)
		{
			...
			{
				AI::CLEAR_PED_TASKS((uParam0[Global_91190.f_45 /*15*/])->f_2);
			}
			func_391(uParam0);
			func_390(uParam0, 0);
			iVar0 = 0;
...
int func_37(var uParam0)
{
	...
	if (func_50(Global_89446, uParam0->f_1, &iVar0))
	{
		...
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_18097.f_410, 0))
			{
				return 4;
			}
			else
		...
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_18097.f_410, 1))
			{
				return 6;
			}
			else
		...
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_18097.f_410, 2))
			{
				return 10;
			}
			else
		...
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_18097.f_410, 3))
			{
				return 8;
			}
			else
...
int func_38(var uParam0)
{
	...
	if ((((Global_89558 == 0 || GAMEPLAY::IS_BIT_SET(Global_89560, uParam0->f_1)) && !func_45(Global_89446, uParam0->f_1, 1)) && !func_45(Global_89446, uParam0->f_1, 2)) && Global_106565.f_7682.f_919[Global_89446] != 5)
	{
		if (func_50(Global_89446, uParam0->f_1, &iVar0))
		{
			iVar2 = func_41(&iVar1);
...
int func_45(int iParam0, int iParam1, int iParam2)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_106565.f_18097.f_175[iVar2 /*19*/].f_2, iParam2);
}
...
int func_66(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (uParam0->f_52)
	{
		...
		{
			GAMEPLAY::SET_BIT(&(Global_106565.f_18097.f_410), iParam5);
			uParam0->f_52 = 0;
		}
	}
	else if (!func_67())
	...
	else if (*uParam1 != 0 && *uParam1 != 1)
	{
		if (PED::IS_PED_INJURED(uParam1->f_2))
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam1->f_2) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				vVar6 = { ENTITY::GET_ENTITY_COORDS(uParam1->f_2, 0) };
	...
	if (uParam1->f_4 == 0)
	{
		...
		else
		{
			...
			if ((STREAMING::HAS_ANIM_DICT_LOADED(&cVar0) && STREAMING::HAS_ANIM_DICT_LOADED(&sVar40)) && STREAMING::HAS_ANIM_DICT_LOADED(&cVar64))
			{
				...
				{
					vVar115 = { ENTITY::GET_ENTITY_COORDS(uParam1->f_2, 1) - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
					vVar118 = { 0f, 0f, GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(vVar115.x, vVar115.y) };
					vVar121 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
					GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vVar121, &(vVar121.f_2), 0, 0);
					...
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vVar121, 10f, 0, 0, 1, 1, 0, 0);
					GAMEPLAY::CLEAR_AREA_OF_PEDS(vVar121, 5f, 0);
					...
					PATHFIND::SET_ROADS_IN_AREA(vVar125, vVar128, 0, 1);
					PATHFIND::SET_PED_PATHS_IN_AREA(vVar125, vVar128, 0, 0);
...
int func_100(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_110(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_110(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_110(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_142(iVar0);
						if (Global_71400 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_110(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_110(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_110(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
void func_120(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_121(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
...
int func_122(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_110(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_125(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_127(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_127(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 4);
		}
	}
...
int func_127(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_110(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_122(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_122(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_122(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_122(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_159(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_153(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_153(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_110(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_214(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_110(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_110(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_224(var uParam0, var uParam1)
{
	...
	vVar3 = { ENTITY::GET_ENTITY_COORDS(uParam1->f_2, 1) - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
	uVar6 = GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(vVar3.x, vVar3.y);
	iVar7 = 0;
	...
	while (iVar36 < 3)
	{
		if (uParam0->f_61[iVar36] == 0)
		{
			...
			{
				vVar37 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vVar0, uVar6, vVar16[iVar36 /*3*/]) };
				iVar40 = 338;
				if (iVar36 == 0)
				{
					vVar37 = { vVar37 + Vector(0.1f, 0f, 0f) };
				}
				uParam0->f_61[iVar36] = WORLDPROBE::START_SHAPE_TEST_BOX(vVar37, vVar26[iVar36 /*3*/], 0f, 0f, uVar6, 2, iVar40, iVar7, 7);
			}
		}
		else
		{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_243(iParam2), 1);
}
...
void func_260(var uParam0, var uParam1)
{
	...
	if (!PED::IS_PED_IN_ANY_VEHICLE(uParam1->f_2, 0))
	{
		...
		{
			uParam1->f_4++;
			vVar3 = { ENTITY::GET_ENTITY_COORDS(uParam1->f_2, 1) };
			iVar9 = 1 | 2 | 4 | 8;
			if (PATHFIND::GET_SAFE_COORD_FOR_PED(vVar3, 1, &vVar6, iVar9))
			{
				...
				if (iVar10 == 0)
				{
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(uParam1->f_2, vVar6, 1f, -1, 1048576000, 0, 1193033728);
					uParam1->f_4 = 60;
				}
			}
		}
	...
	else
	{
		...
		if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(uVar13, -1, 0) == uParam1->f_2)
		{
			...
			{
				AI::CLEAR_PED_TASKS(uParam1->f_2);
				AI::TASK_VEHICLE_DRIVE_WANDER(uParam1->f_2, uVar13, 7.5f, 786603);
			}
		}
		else if (GAMEPLAY::ABSF(ENTITY::GET_ENTITY_SPEED(uVar13)) < 10f)
		{
...
int func_262(var uParam0, int iParam1, int iParam2)
{
	...
	if ((iParam1 && PED::_IS_ENEMY_IN_RANGE(uParam0->f_2, ENTITY::GET_ENTITY_COORDS(uParam0->f_2, 1), 75f) > 0) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_2))
	{
...
int func_263(var uParam0)
{
	...
	if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_2, PLAYER::PLAYER_PED_ID(), 1)) || ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && ENTITY::DOES_ENTITY_EXIST(uVar0)) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uVar0, PLAYER::PLAYER_PED_ID(), 1))) || func_264(uParam0->f_2, 0, 0, 0, 0)) || FIRE::IS_ENTITY_ON_FIRE(uParam0->f_2)) || (FIRE::IS_EXPLOSION_IN_SPHERE(-1, vVar1, 20f) && !((FIRE::IS_EXPLOSION_IN_SPHERE(11, vVar1, 20f) || FIRE::IS_EXPLOSION_IN_SPHERE(13, vVar1, 20f)) || FIRE::IS_EXPLOSION_IN_SPHERE(14, vVar1, 20f))))
	{
		if (ENTITY::DOES_ENTITY_EXIST(uVar0))
		{
...
int func_271(var uParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (uParam1->f_9 == 0)
		{
			...
			uParam1->f_9 = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(vVar1, vVar4, iVar0, iVar7, 7);
		}
		else
		{
...
int func_276(var uParam0, var uParam1, var uParam2)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		else
		{
			...
			if (!PED::IS_PED_INJURED(uParam1->f_2))
			{
				if (GAMEPLAY::IS_BIT_SET(Global_91190.f_47, iVar0))
				{
				}
				else if (func_275(uParam1->f_2))
				{
				...
				else if (func_50(Global_89446, uParam1->f_1, &iVar1) && func_49(iVar1) == 0)
				{
					...
					if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sVar2))
					{
						...
						vVar7 = { ENTITY::GET_ENTITY_COORDS(uParam1->f_2, 1) };
...
void func_285(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_287() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_287() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
int func_290(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_287() /*10778*/].f_6165.f_10, iParam0);
}
						...
						if (Global_2992[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_320(Global_14534, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(uVar6), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
...
int func_329(var uParam0, int iParam1)
{
	...
	while (iVar0 < 35)
	{
		...
		{
			if (GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_106565.f_14135[iVar0 /*104*/]), uParam0))
			{
...
int func_350(vector3 vParam0, bool bParam3)
{
	...
	while (iVar0 <= (5 - 1))
	{
		...
		{
			if (!bParam3 || GAMEPLAY::IS_BIT_SET(Global_106565.f_7223.f_11[iVar0], 0))
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_88915[iVar0 /*9*/].f_3, 1);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_367(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_372(int iParam0)
{
	...
	{
		fVar9 = GAMEPLAY::ABSF((Global_106565.f_2357.f_539.f_2300[iVar0 /*3*/].f_2 - vVar1.z));
...
void func_377(int iParam0)
{
	...
	if (func_392(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		...
		Global_106565.f_2357.f_539.f_2300[iVar0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(iParam0, 1) };
...
void func_381(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_383(Var11.f_1)) && iVar72 < 51)
			{
...
void func_387(var uParam0)
{
	...
	if (func_392(iVar0) && !PED::IS_PED_INJURED(uParam0))
	{
...
{
	if (GAMEPLAY::ARE_STRINGS_EQUAL(sParam0, &Global_105208))
	{
		return 1;
	}
	if (func_405(sParam0))
...
int func_405(var uParam0)
{
	...
	while (iVar0 < Global_106565.f_20404.f_145)
	{
		if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam0, &(Global_106565.f_20404[iVar0 /*16*/])))
		{
			return 1;
		}
		iVar0++;
...
int func_414(int iParam0, int iParam1)
{
	if (iParam0 < 9)
	{
		return GAMEPLAY::IS_BIT_SET(Global_106565.f_18097.f_175[iParam0 /*19*/].f_18, iParam1);
	}
	return 0;
}
...
void func_415(int iParam0, int iParam1, bool bParam2)
{
	if (iParam0 < 9)
	{
		if (bParam2)
		{
			GAMEPLAY::SET_BIT(&(Global_106565.f_18097.f_175[iParam0 /*19*/].f_18), iParam1);
		}
		else
		{
			GAMEPLAY::CLEAR_BIT(&(Global_106565.f_18097.f_175[iParam0 /*19*/].f_18), iParam1);
		}
	}
}
...
int func_428(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4)
{
	...
	else if (((((iParam4 && GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 100) < 15) && !(iParam0 == 2 && iParam1 == 0)) && !(iParam0 == 0 && iParam1 == 5)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && func_429(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
	{
		*uParam2 = 12;
		*uParam3 = 14;
		return 1;
...
int func_429(vector3 vParam0)
{
	...
	if (func_433())
	{
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_89013[0 /*18*/], 1) < 10f)
		{
			return 1;
		}
		else
	...
	if (!func_431())
	{
		if (Global_90640 == 0)
		{
			if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(vParam0, 1, &vVar0, &fVar3, &uVar4, 4, 1077936128, 0))
			{
				if ((PATHFIND::_0x16F46FB18C8009E4(vVar0, 0, &vVar8) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, vVar8, 1) < 10f) && GAMEPLAY::ABSF((vParam0.z - vVar8.z)) < 2.5f)
				{
					vVar5 = { vVar8 };
				}
				else if ((PATHFIND::_0x16F46FB18C8009E4(vVar0, 1, &vVar8) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, vVar8, 1) < 10f) && GAMEPLAY::ABSF((vParam0.z - vVar8.z)) < 2.5f)
				{
					vVar5 = { vVar8 };
				}
				else
				...
				if ((PATHFIND::GET_SAFE_COORD_FOR_PED(vVar5 + vVar11 * Vector(1f, 1f, 1f), 1, &vVar26, 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar5, vVar26, 1) < 10f) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar23, vVar26, 1) > 2f)
				{
					vVar26 = { vVar26 };
				}
				else
				...
				if ((PATHFIND::GET_SAFE_COORD_FOR_PED(vVar5 + vVar11 * Vector(1f, 1f, 1f), 1, &vVar29, 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar5, vVar29, 1) < 10f) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar23, vVar29, 1) > 2f)
				{
					vVar29 = { vVar29 };
				}
				else
