...
void func_1()
{
	switch (iLocal_321)
	{
		case 0:
			...
			UI::CLEAR_HELP(1);
			func_7();
			if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_738))
			{
				func_531(1);
			}
			else
...
void func_58(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_59(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_60(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_60(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_60(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_60(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_93(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_93(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_82(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (func_302(PLAYER::PLAYER_PED_ID()))
				{
					...
					{
						AI::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_734, -1, 0, 2);
					}
					func_222(1);
					func_220(0);
				}
...
void func_251(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_253(Var11.f_1)) && iVar72 < 51)
			{
...
void func_257(var uParam0)
{
	...
	if (func_158(iVar0) && !PED::IS_PED_INJURED(uParam0))
	{
...
int func_267(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_283(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_268(iVar0, 0), 1);
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_291(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_304()
{
	...
	if (iLocal_724 < 3)
	{
		if (!bLocal_641)
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_769, vLocal_772, 20f, 0, 1, 0))
			{
				func_315();
				if (iLocal_659[17])
				{
...
void func_305()
{
	...
	while (iVar23 < 4)
	{
		...
		{
			uLocal_975[iVar23] = VEHICLE::CREATE_VEHICLE(iVar18[iVar23], vVar0[iVar23 /*3*/], fVar13[iVar23], 1, 1, 0);
		}
		iVar23++;
	}
...
{
	if (!UI::DOES_BLIP_EXIST(uLocal_610))
	{
	...
	if (UI::DOES_BLIP_EXIST(uLocal_610))
	{
		if (!bParam0)
		{
			UI::SET_BLIP_SCALE(uLocal_610, 0.75f);
		}
		UI::SET_BLIP_FLASHES(uLocal_610, iParam1);
	}
}
			...
			if (((Local_499[iVar0 /*54*/][iVar1 /*17*/].f_3 != 1 && Local_499[iVar0 /*54*/][iVar1 /*17*/].f_3 != 0) && Local_499[iVar0 /*54*/].f_52 != 4) && Local_499[iVar0 /*54*/].f_52 != 5)
			{
				if (!func_302(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6))
				{
					if (!Local_499[iVar0 /*54*/][iVar1 /*17*/].f_1)
					{
						...
						vLocal_959[iVar0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6, 1) };
						iLocal_687[iVar0] = 1;
				...
				else if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6, 1), 2f, 0))
				{
					iLocal_624 = 0;
					iLocal_628 = 1;
					iLocal_716 = 0;
					...
					while (iLocal_716 < 3)
					{
						...
						{
							Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_14 = { ENTITY::GET_ENTITY_COORDS(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6, 1) };
							Local_499[iVar0 /*54*/].f_52 = 4;
						}
				...
				case 2:
					...
					while (iLocal_716 < 3)
					{
						if (!Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_1)
						{
							...
							{
								AI::TASK_GO_TO_COORD_ANY_MEANS(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6, vLocal_959[iVar0 /*3*/], GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(1f, 2.5f), 0, 0, 786603, -1082130432);
...
void func_317(int iParam0, int iParam1)
{
	...
	switch (Local_499[iParam0 /*54*/][iParam1 /*17*/].f_3)
	{
		...
		case 3:
			...
			{
				Local_499[iParam0 /*54*/][iParam1 /*17*/].f_7 = (GAMEPLAY::GET_GAME_TIMER() + GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 8000));
		...
		case 4:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (GAMEPLAY::GET_GAME_TIMER() > Local_499[iParam0 /*54*/][iParam1 /*17*/].f_7 && Local_499[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0)
				{
		...
		case 5:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 8);
				if (!iLocal_650[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10])
				{
					...
					{
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], 1f, -1, 0.25f, 512, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f));
					}
					...
					{
						AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6, Local_499[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
					}
		...
		case 6:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (Local_499[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0 && ENTITY::IS_ENTITY_AT_COORD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], func_320(iParam0), 0, 0, 0))
				{
					iVar1 = 0;
					iVar1 = 0;
					while (iVar1 < 3)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
						{
							AI::CLEAR_PED_TASKS(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6);
							AI::TASK_WANDER_IN_AREA(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], 7.5f, 0f, 1f);
		...
		case 11:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				...
				{
					AI::TASK_SMART_FLEE_COORD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_959[iParam0 /*3*/], 50f, -1, 0, 0);
				}
				else
				{
					AI::TASK_SMART_FLEE_COORD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_499[iParam0 /*54*/][iParam1 /*17*/].f_14, 50f, -1, 0, 0);
				}
		...
		case 12:
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
				if (iLocal_687[iParam0])
				{
					...
					{
						AI::TASK_GO_TO_COORD_ANY_MEANS(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_959[iParam0 /*3*/], GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(1f, 2.5f), 0, 0, 786603, -1082130432);
...
{
	if ((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_769, vLocal_772, 20f, 0, 1, 0) && ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6)) && !ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)) && iLocal_633) && iLocal_724 < 3)
	{
		if (!UI::DOES_BLIP_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/]))
		{
			Local_499[iParam0 /*54*/][iParam1 /*17*/] = func_309(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 1, 0, 5);
			if (UI::DOES_BLIP_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/]))
			{
				UI::SET_BLIP_SCALE(Local_499[iParam0 /*54*/][iParam1 /*17*/], 0.7f);
			}
			if (!ENTITY::IS_ENTITY_DEAD(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0))
			{
...
void func_336(int iParam0, int iParam1)
{
	...
	if (!func_302(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6 = PED::CREATE_PED(26, iLocal_727, vVar0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f), 1, 1);
		if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
		{
...
void func_337(int iParam0, int iParam1)
{
	if (!func_302(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		...
		if (!iLocal_650[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10])
		{
			Local_499[iParam0 /*54*/][iParam1 /*17*/].f_5 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f);
			Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6 = PED::CREATE_PED(26, iLocal_727, vLocal_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], Local_499[iParam0 /*54*/][iParam1 /*17*/].f_5, 1, 1);
			if (ENTITY::DOES_ENTITY_EXIST(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				ENTITY::SET_ENTITY_HEALTH(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
...
void func_346()
{
	...
	while (iVar0 < 3)
	{
		if (UI::DOES_BLIP_EXIST(Local_322[iVar0 /*10*/].f_9))
		{
			UI::REMOVE_BLIP(&(Local_322[iVar0 /*10*/].f_9));
		}
...
void func_353()
{
	...
	func_354();
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_907, vLocal_910, 3.5f, 0, 1, 0) || iLocal_659[16])
	{
		func_348();
		func_341();
		iLocal_318 = 15;
...
void func_354()
{
	...
	while (iVar0 < 5)
	{
		if (Local_353[iVar0 /*29*/].f_13 != 0)
		{
			...
			{
				if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_763, vLocal_766, 10f, 0, 1, 0))
				{
					if (!bLocal_636)
					{
		...
		switch (Local_353[iVar0 /*29*/].f_13)
		{
			...
			case 2:
				Local_353[iVar0 /*29*/].f_7 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 5);
					...
					if (ENTITY::DOES_ENTITY_EXIST(Local_353[iVar0 /*29*/].f_28) && !ENTITY::IS_ENTITY_DEAD(Local_353[iVar0 /*29*/].f_28, 0))
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(Local_353[iVar0 /*29*/].f_12))
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(Local_353[iVar0 /*29*/].f_11))
							{
								...
								AI::TASK_VEHICLE_DRIVE_TO_COORD(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, Local_353[iVar0 /*29*/].f_19, 8f, 0, 0, 786599, 5f, 2f);
								iLocal_705++;
			...
			case 4:
				if (func_302(Local_353[iVar0 /*29*/].f_12) && func_367(Local_353[iVar0 /*29*/].f_28))
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(Local_353[iVar0 /*29*/].f_28, Local_353[iVar0 /*29*/].f_19, 10f, 10f, 10f, 0, 0, 0))
					{
						...
						{
							if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_353[iVar0 /*29*/].f_28, 1), 5f, 1))
							{
								iLocal_629 = 1;
							}
						}
					...
					{
						AI::CLEAR_PED_TASKS(Local_353[iVar0 /*29*/].f_12);
						VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(Local_353[iVar0 /*29*/].f_28, 0);
						AI::TASK_VEHICLE_DRIVE_WANDER(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, 8f, 786599);
			...
			case 5:
				if (func_302(Local_353[iVar0 /*29*/].f_12) && func_367(Local_353[iVar0 /*29*/].f_28))
				{
					...
					{
						AI::TASK_VEHICLE_PARK(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, vVar1, ENTITY::GET_ENTITY_HEADING(Local_353[iVar0 /*29*/].f_28), 3, 270f, 1);
					}
					else if (func_339())
					{
						AI::TASK_VEHICLE_TEMP_ACTION(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, 5, 2000);
					}
					else
					{
						AI::TASK_VEHICLE_TEMP_ACTION(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, 4, 2000);
					}
					func_2();
			...
			case 6:
				if ((func_224(Local_353[iVar0 /*29*/].f_28) && func_302(Local_353[iVar0 /*29*/].f_12)) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					if (VEHICLE::IS_VEHICLE_STOPPED(Local_353[iVar0 /*29*/].f_28))
					{
						...
						{
							AI::TASK_LEAVE_VEHICLE(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, 1);
						}
						else
						{
							func_359(iVar0);
			...
			case 8:
				...
				{
					vVar4 = { ENTITY::GET_ENTITY_COORDS(Local_353[iVar0 /*29*/].f_12, 1) };
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_353[iVar0 /*29*/].f_12, 0))
					{
						if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !GAMEPLAY::IS_BULLET_IN_AREA(vVar4, 3f, 1))
						{
							...
							AI::CLEAR_PED_TASKS(Local_353[iVar0 /*29*/].f_12);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_353[iVar0 /*29*/].f_12, 1);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_25, 1f, -1, 0.25f, 0, Local_353[iVar0 /*29*/].f_6);
				...
				if (func_302(Local_353[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !GAMEPLAY::IS_BULLET_IN_AREA(vVar4, 3f, 1))
					{
						if (ENTITY::IS_ENTITY_AT_COORD(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_25, 1f, 1f, 1f, 0, 0, 1))
						{
							AI::CLEAR_PED_TASKS(Local_353[iVar0 /*29*/].f_12);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_353[iVar0 /*29*/].f_12, 1);
							AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, 0);
			...
			case 10:
				if (func_302(Local_353[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !GAMEPLAY::IS_BULLET_IN_AREA(vVar4, 3f, 1))
					{
						Local_353[iVar0 /*29*/].f_15 = AI::GET_SCRIPT_TASK_STATUS(Local_353[iVar0 /*29*/].f_12, -875674219);
			...
			case 11:
				if (func_302(Local_353[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !GAMEPLAY::IS_BULLET_IN_AREA(vVar4, 3f, 1))
					{
						AI::OPEN_SEQUENCE_TASK(&(Local_353[iVar0 /*29*/].f_14));
						AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "enter", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "idle_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "exit", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "enter_call", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
						AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "idle_a_call", 8f, -8f, -1, 1, 0, 0, 0, 0);
						AI::CLOSE_SEQUENCE_TASK(Local_353[iVar0 /*29*/].f_14);
						AI::TASK_PERFORM_SEQUENCE(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_14);
						AI::CLEAR_SEQUENCE_TASK(&(Local_353[iVar0 /*29*/].f_14));
						Local_353[iVar0 /*29*/].f_8 = GAMEPLAY::GET_GAME_TIMER() + 20000;
			...
			case 12:
				if (func_302(Local_353[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !GAMEPLAY::IS_BULLET_IN_AREA(vVar4, 3f, 1))
					{
						if (GAMEPLAY::GET_GAME_TIMER() > Local_353[iVar0 /*29*/].f_8)
						{
			...
			case 13:
				if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_353[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_353[iVar0 /*29*/].f_28, 0), ENTITY::GET_ENTITY_COORDS(Local_353[iVar0 /*29*/].f_12, 1), 0) > 100f)
					{
						Local_353[iVar0 /*29*/].f_13 = 15;
					}
				}
		...
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_800, ENTITY::GET_ENTITY_COORDS(Local_353[iVar0 /*29*/].f_28, 1), 1) > 450f)
			{
				Local_353[iVar0 /*29*/].f_13 = 15;
			}
		}
...
void func_357(int iParam0)
{
	...
	if (func_302(iVar0))
	{
		if (func_367(Local_353[iParam0 /*29*/].f_28))
		{
			...
			AI::OPEN_SEQUENCE_TASK(&(Local_353[iParam0 /*29*/].f_14));
			AI::TASK_ENTER_VEHICLE(0, Local_353[iParam0 /*29*/].f_28, 60000, -1, 1f, 1, 0);
			AI::TASK_VEHICLE_DRIVE_WANDER(0, Local_353[iParam0 /*29*/].f_28, 60f, 786468);
			AI::CLOSE_SEQUENCE_TASK(Local_353[iParam0 /*29*/].f_14);
			AI::TASK_PERFORM_SEQUENCE(iVar0, Local_353[iParam0 /*29*/].f_14);
			PED::SET_PED_KEEP_TASK(iVar0, 1);
			AI::CLEAR_SEQUENCE_TASK(&(Local_353[iParam0 /*29*/].f_14));
		}
...
Vector3 func_358(var uParam0)
{
	...
	if (func_367(uParam0))
	{
		vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, 5f, 25f, 0f) };
...
void func_359(int iParam0)
{
	...
	{
		AI::CLEAR_PED_TASKS(Local_353[iParam0 /*29*/].f_12);
		...
		if (func_367(Local_353[iParam0 /*29*/].f_28))
		{
			...
			{
				AI::TASK_VEHICLE_DRIVE_TO_COORD(Local_353[iParam0 /*29*/].f_12, Local_353[iParam0 /*29*/].f_28, Local_353[iParam0 /*29*/].f_19, 80f, 1, 0, 786469, 5f, 2f);
				Local_353[iParam0 /*29*/].f_13 = 14;
			}
			else
			{
				AI::TASK_SMART_FLEE_COORD(Local_353[iParam0 /*29*/].f_12, vLocal_748, 10000f, -1, 0, 0);
...
void func_360()
{
	if (!iLocal_625)
	{
		if (func_339())
		{
			iLocal_704 = GAMEPLAY::GET_GAME_TIMER() + 1000;
			iLocal_625 = 1;
		}
	}
	else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_704)
	{
...
int func_362()
{
	...
	if (func_302(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_302(iLocal_734))
		{
			vVar3 = { ENTITY::GET_ENTITY_COORDS(iLocal_734, 1) };
			if (func_363(PLAYER::PLAYER_PED_ID(), iLocal_734, 0) <= 10f && GAMEPLAY::ABSF((vVar0.z - vVar3.z)) < 1.5f)
			{
				return 1;
			}
		}
	...
	switch (iLocal_321)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				iLocal_319 = 13;
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_800, 50f, 0, 0, 0, 0, 0, 0);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_794, 50f, 0, 0, 0, 0, 0, 0);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_797, 50f, 0, 0, 0, 0, 0, 0);
				AI::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				func_370();
				func_344();
				func_343();
...
void func_383()
{
	...
	if (!iLocal_640)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_745, 50f, 50f, 50f, 0, 1, 0))
		{
			func_385();
			iLocal_640 = 1;
		}
	...
	if (!bLocal_630)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_745, 5f, 5f, 5f, 0, 1, 0) && func_384(1077936128, 1))
		{
			VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_794, vLocal_797, 0, 1);
			func_8(&uLocal_609);
			func_375();
			func_2();
			func_341();
...
void func_385()
{
	...
	GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_904, 5f, 0);
}
...
void func_387()
{
	...
	OBJECT::SET_FORCE_OBJECT_THIS_FRAME(vLocal_751, fLocal_701);
	OBJECT::SET_FORCE_OBJECT_THIS_FRAME(vLocal_754, fLocal_701);
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_757, vLocal_760, 7f, 1, 1, 0))
	{
		if (iLocal_659[1])
		{
			iLocal_637 = 0;
...
void func_389()
{
	...
	OBJECT::SET_FORCE_OBJECT_THIS_FRAME(vLocal_751, fLocal_701);
	OBJECT::SET_FORCE_OBJECT_THIS_FRAME(vLocal_754, fLocal_701);
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_757, vLocal_760, 7f, 0, 1, 0))
	{
		func_315();
		func_394();
		func_373();
		...
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && (ENTITY::IS_ENTITY_AT_COORD(iLocal_734, vLocal_778, 2f, 2f, 2f, 0, 1, 0) || iLocal_724 >= 3))
		{
			if (!bLocal_641)
			{
				if (iLocal_724 >= 3)
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_734, vLocal_778, 2f, 2f, 2f, 0, 1, 0))
					{
						func_220(1);
					}
					iLocal_318 = 8;
		...
		if (!UI::DOES_BLIP_EXIST(Local_322[iVar0 /*10*/].f_9))
		{
			if (func_224(Local_322[iVar0 /*10*/]))
			{
				if (!Local_322[iVar0 /*10*/].f_7)
				{
					...
					UI::SET_BLIP_COLOUR(Local_322[iVar0 /*10*/].f_9, 1);
				}
			}
		}
		iVar0++;
...
int func_392(var uParam0, int iParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_393(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_393(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, iParam1);
	}
...
void func_397()
{
	GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_877, 3f, 0);
	PED::SET_PED_NON_CREATION_AREA(vLocal_880, vLocal_883);
	GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_886, 3f, 0);
	PED::SET_PED_NON_CREATION_AREA(vLocal_889, vLocal_892);
	GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_895, 3f, 0);
...
int func_398()
{
	...
	else
	{
		...
		while (iVar0 < 3)
		{
			GAMEPLAY::CLEAR_AREA_OF_OBJECTS(Local_322[iVar0 /*10*/].f_1, 2f, 0);
...
int func_399()
{
	iLocal_721 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3);
...
void func_401()
{
	...
	else
	{
		...
		if (UI::DOES_BLIP_EXIST(uLocal_610))
		{
			if (!UI::IS_BLIP_FLASHING(uLocal_610))
			{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				if (CUTSCENE::IS_CUTSCENE_PLAYING())
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_733))
					{
						OBJECT::DELETE_OBJECT(&uLocal_733);
					}
				}
				...
				func_222(1);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_807, 2f, 0, 0, 0, 0, 0, 0);
				func_7();
				iLocal_321 = 2;
			}
			break;
			...
			switch (iLocal_706)
			{
				case 0:
					if (func_430(1, 1093140480, 0))
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(uLocal_733))
						{
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_733, "Daves_Rifle", 0, 0, 0);
						}
						func_425();
				...
				case 1:
					...
					{
						WEAPON::GIVE_WEAPON_OBJECT_TO_PED(uLocal_733, PLAYER::PLAYER_PED_ID());
					}
...
int func_426(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_254(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_254(iVar2, iVar8)))
			{
				...
				{
					uVar9 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_254(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_254(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_254(iVar2, iVar8)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_254(iVar2, iVar8));
...
int func_430(int iParam0, int iParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_433(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_436()
{
	...
	{
		iLocal_711 = GAMEPLAY::GET_GAME_TIMER() + 2000;
		if (func_302(iLocal_734))
		{
			if (func_302(PLAYER::PLAYER_PED_ID()))
			{
	...
	{
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_711 || func_363(PLAYER::PLAYER_PED_ID(), iLocal_734, 1) <= 3f)
		{
...
void func_437()
{
	...
	if (func_302(iLocal_734))
	{
		...
		AI::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_734, 0);
...
void func_446()
{
	if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
	{
		if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_859, vLocal_862, 16f, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_865, vLocal_868, 19f, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_871, vLocal_874, 19f, 0, 1, 0))
		{
...
void func_447()
{
	...
	if (func_302(PLAYER::PLAYER_PED_ID()))
	{
		...
		switch (iLocal_319)
		{
			...
			case 3:
				func_308(1, 0);
				iLocal_720 = GAMEPLAY::GET_GAME_TIMER() + 2000;
				ENTITY::SET_ENTITY_COORDS(iLocal_734, vLocal_791, 1, 0, 0, 1);
			...
			case 2:
				if (func_302(iLocal_734))
				{
					...
					{
						bLocal_623 = true;
						iLocal_720 = GAMEPLAY::GET_GAME_TIMER() + 5000;
						WEAPON::REMOVE_WEAPON_FROM_PED(iLocal_734, joaat("weapon_sniperrifle"));
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, vLocal_778, 1f, 60000, 0.25f, 512, Local_322[iLocal_721 /*10*/].f_6);
						PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_734, 0);
						iLocal_319 = 4;
					}
				}
			...
			case 4:
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_734, 713668775) == 7)
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_734, vLocal_778, 1.5f, 1.5f, 1.5f, 0, 1, 0))
					{
						AI::CLEAR_PED_TASKS(iLocal_734);
						AI::TASK_LOOK_AT_ENTITY(iLocal_734, PLAYER::PLAYER_PED_ID(), -1, 1024, 2);
				...
				{
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_720)
					{
			...
			case 5:
				if (!PED::IS_PED_INJURED(iLocal_734))
				{
					...
					if (func_478())
					{
						if (ENTITY::IS_ENTITY_VISIBLE(uLocal_732))
						{
						...
						func_343();
						func_8(&uLocal_610);
						AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_734);
						ENTITY::SET_ENTITY_COORDS(iLocal_734, vLocal_778, 1, 0, 0, 1);
			...
			case 6:
				...
				else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_757, vLocal_760, 7f, 0, 1, 0) && func_362())
				{
					if (func_475())
					{
						func_370();
			...
			case 12:
				if (func_361(&uLocal_153, cLocal_739, "HUNT1_TYARR", 7, 0, 0, 0))
				{
					...
					iLocal_714 = 0;
					AI::TASK_LOOK_AT_ENTITY(iLocal_734, PLAYER::PLAYER_PED_ID(), -1, 1024, 2);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, vLocal_781, 1f, 60000, 0.25f, 512, fLocal_691);
					PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_734, 0);
					iLocal_319 = 14;
				}
				break;
			...
			case 13:
				if (!PED::IS_PED_INJURED(iLocal_734))
				{
					if (func_478())
					{
						...
						AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_734);
						ENTITY::SET_ENTITY_COORDS(iLocal_734, vLocal_781, 1, 0, 0, 1);
			...
			case 14:
				if (AI::GET_SCRIPT_TASK_STATUS(iLocal_734, 713668775) == 7)
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_734, vLocal_781, 1.25f, 1.25f, 2.5f, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_763, vLocal_766, 10f, 0, 1, 0))
					{
						if (func_475())
						{
			...
			case 16:
				if (func_467())
				{
					iLocal_717 = 0;
					func_448();
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, vLocal_946[0 /*3*/], 1f, 60000, 0.25f, 0, 1193033728);
					PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_734, 1);
					func_308(0, 0);
					iLocal_319 = 17;
				}
			...
			case 17:
				...
				if (!iLocal_659[15])
				{
					if (func_362())
					{
						if (!func_217())
						{
							if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), vLocal_748, 1) > 10f)
							{
				...
				switch (iLocal_717)
				{
					case 0:
						...
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, vLocal_946[1 /*3*/], 1f, 60000, 0.25f, 0, 1193033728);
							iLocal_717++;
						}
						break;
					...
					case 1:
						...
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, vLocal_946[2 /*3*/], 1f, 60000, 0.25f, 0, 1193033728);
							iLocal_717++;
						}
						break;
					...
					case 2:
						...
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, vLocal_946[3 /*3*/], 1f, 60000, 0.25f, 0, 1193033728);
							iLocal_717++;
						}
						break;
					...
					case 3:
						...
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, vLocal_784, 1f, 60000, 0.25f, 512, fLocal_697);
							iLocal_717++;
						}
						break;
					
					case 4:
						if (AI::GET_SCRIPT_TASK_STATUS(iLocal_734, 713668775) == 7 || (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_907, vLocal_910, 3.5f, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_734, vLocal_907, vLocal_910, 3.5f, 0, 1, 0)))
						{
							PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_734, 0);
							iLocal_319 = 18;
						}
			...
			case 20:
				if (!PED::IS_PED_INJURED(iLocal_734))
				{
					if (func_478())
					{
						...
						AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_734);
						ENTITY::SET_ENTITY_COORDS(iLocal_734, vLocal_784, 1, 0, 0, 1);
			...
			case 18:
				...
				{
					vVar0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_907, vLocal_910, 3.5f, 0, 1, 0) || vVar0.z > 41f)
					{
						if (func_361(&uLocal_153, cLocal_739, "HUNT_ROOF", 7, 0, 0, 0))
						{
							AI::CLEAR_PED_TASKS(iLocal_734);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_734, vLocal_788, 1f, 60000, 0.25f, 512, fLocal_699);
							iLocal_659[16] = 1;
							PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_734, 0);
							iLocal_319 = 21;
						}
					}
					else if (AI::GET_SCRIPT_TASK_STATUS(iLocal_734, -875674219) != 1)
					{
						AI::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_734, PLAYER::PLAYER_PED_ID(), -1);
					}
				}
				break;
			...
			case 22:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_769, vLocal_772, 20f, 0, 1, 0))
				{
					...
					{
						func_310();
						iLocal_708 = GAMEPLAY::GET_GAME_TIMER() + 2000;
						bLocal_626 = true;
					}
					if (func_475())
					{
				...
				if (bLocal_626)
				{
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_708)
					{
						func_310();
			...
			case 24:
				...
				{
					AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_734);
					ENTITY::SET_ENTITY_COORDS(iLocal_734, vLocal_917, 1, 0, 0, 1);
					ENTITY::SET_ENTITY_HEADING(iLocal_734, fLocal_920);
					AI::TASK_LOOK_AT_ENTITY(iLocal_734, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				...
				if (!func_217())
				{
					...
					else if (!func_217())
					{
						if (func_302(iLocal_734))
						{
							...
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_966, 1f, 60000, 0.25f, 0, 1193033728);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_969, 1f, 60000, 0.25f, 0, 1193033728);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_972, 1f, 60000, 0.25f, 0, 1193033728);
							AI::TASK_WANDER_STANDARD(0, 1193033728, 0);
							AI::CLOSE_SEQUENCE_TASK(uLocal_737);
							AI::TASK_PERFORM_SEQUENCE(iLocal_734, uLocal_737);
							AI::CLEAR_SEQUENCE_TASK(&uLocal_737);
		...
		if (((iLocal_318 != 21 && !iLocal_659[20]) && iLocal_319 != 25) && iLocal_319 != 0)
		{
			if (!iLocal_627)
			{
				if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()) || PED::_0xDCCA191DF9980FD7(PLAYER::PLAYER_PED_ID()))
				{
					...
					{
						func_2();
						iLocal_710 = GAMEPLAY::GET_GAME_TIMER() + 2400;
						iLocal_627 = 1;
					}
				}
			...
			else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_710)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_734))
				{
					...
					{
						AI::CLEAR_PED_TASKS(iLocal_734);
						AI::TASK_SMART_FLEE_PED(iLocal_734, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
						PED::SET_PED_KEEP_TASK(iLocal_734, 1);
						func_312(2);
					}
					else
...
void func_453()
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_734, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!iLocal_992)
		{
			iLocal_993 = GAMEPLAY::GET_GAME_TIMER() + 3000;
			iLocal_992 = 1;
		}
		else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_993)
		{
			if (func_362())
			{
...
void func_454()
{
	if (!PED::IS_PED_DEAD_OR_DYING(iLocal_734, 1) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_734, 0) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!iLocal_638)
			{
				iLocal_703 = GAMEPLAY::GET_GAME_TIMER() + 3000;
				iLocal_638 = 1;
			}
			else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_703)
			{
				if (!func_217())
				{
					if (!iLocal_659[8])
					{
						...
						{
							if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Local_982))
							{
								Local_982 = { func_455() };
							}
							else
		...
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_757, vLocal_760, 7f, 0, 1, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_734, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
			{
				if (!iLocal_644)
				{
					...
					{
						iLocal_718 = GAMEPLAY::GET_GAME_TIMER() + 20000;
						iLocal_644 = 1;
					}
				}
				else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_718)
				{
...
void func_464()
{
	if (!PED::IS_PED_DEAD_OR_DYING(iLocal_734, 1) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1))
	{
		if (!iLocal_988)
		{
			...
			{
				iLocal_989 = GAMEPLAY::GET_GAME_TIMER() + 3000;
				iLocal_988 = 1;
			}
		}
		else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_989)
		{
			if (!func_217() && func_362())
			{
				if (!iLocal_659[4])
...
void func_465()
{
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_757, vLocal_760, 16f, 0, 1, 0))
	{
		if ((iLocal_683[1] && !func_388("HT_NXTLOC", 0, 0)) && !func_217())
		{
			if (!iLocal_643)
			{
				iLocal_702 = GAMEPLAY::GET_GAME_TIMER() + 15000;
				iLocal_643 = 1;
			}
			else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_702)
			{
...
int func_467()
{
	if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3))
	{
		...
		{
			OBJECT::DELETE_OBJECT(&uLocal_732);
		}
	}
	else if (!ENTITY::DOES_ENTITY_EXIST(uLocal_732))
	{
		AI::CLEAR_PED_TASKS(iLocal_734);
		return 1;
	}
...
void func_468()
{
	...
	while (iVar0 < 3)
	{
		if (GAMEPLAY::IS_BULLET_IN_AREA(Local_322[iVar0 /*10*/].f_1, 10f, 1))
		{
			if (!func_217())
			{
...
void func_470(int iParam0)
{
	...
	if (((iLocal_724 < 3 && !func_388("HT_SHDISH", 0, 0)) && !func_388("HT_SHTYRE", 0, 0)) && !func_388("HT_SHCOY", 0, 0))
	{
		if (iLocal_624)
		{
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_712)
			{
		...
		{
			iLocal_713 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10000, 15000);
			iLocal_712 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_713);
			iLocal_624 = 1;
		}
	}
}
			...
			case 0:
				switch (iParam0)
				{
					case 0:
						...
						if (iLocal_616)
						{
							if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_734, vLocal_778, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !PED::_0xFCF37A457CB96DC0(iLocal_734, Local_322[iLocal_721 /*10*/].f_1, 30f))
							{
								if (AI::GET_SCRIPT_TASK_STATUS(iLocal_734, 713668775) != 1 || AI::GET_SCRIPT_TASK_STATUS(iLocal_734, 713668775) != 7)
								{
									iLocal_714 = 1;
								}
							}
					...
					case 1:
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_734, vLocal_781, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_472(iLocal_734, fLocal_691, 30f))
						{
							iLocal_714 = 1;
						}
						break;
					...
					case 2:
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_734, vLocal_788, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_472(iLocal_734, fLocal_699, 30f))
						{
							iLocal_714 = 1;
						}
						break;
	...
	if (!bParam1 || iLocal_616)
	{
		if (func_478())
		{
			...
			if (func_302(iLocal_734))
			{
				...
				if (bParam1)
				{
					AI::TASK_TURN_PED_TO_FACE_COORD(0, Local_322[iLocal_721 /*10*/].f_1, 0);
				}
				if (bParam0)
				{
					AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "point_fwd", 8f, -8f, -1, 16, 0, 0, 0, 0);
				}
				AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "binoculars_intro", 8f, -8f, -1, 16, 0, 0, 0, 0);
				AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 8f, -8f, -1, 17, 0, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(uVar0);
				AI::TASK_PERFORM_SEQUENCE(iLocal_734, uVar0);
...
int func_478()
{
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_732) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_732, iLocal_734))
	{
		return 1;
	}
	if (!iLocal_612)
...
void func_480(bool bParam0)
{
	...
	if (func_302(iLocal_734))
	{
		...
		{
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_734, 1);
			AI::TASK_CLEAR_LOOK_AT(iLocal_734);
			AI::OPEN_SEQUENCE_TASK(&uVar0);
			AI::TASK_PLAY_ANIM(0, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 8f, -8f, -1, 48, 0, 0, 0, 0);
			if (bParam0)
			{
				AI::TASK_WANDER_STANDARD(0, 1193033728, 0);
				PED::SET_PED_KEEP_TASK(iLocal_734, 1);
...
void func_482()
{
	if (!PED::IS_PED_INJURED(iLocal_734))
	{
		if (((GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) - Vector(2f, 2f, 2f), joaat("weapon_grenade"), 0) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) - Vector(2f, 2f, 2f), joaat("weapon_stickybomb"), 0)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_734, 0) - Vector(2f, 2f, 2f), joaat("weapon_molotov"), 0)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_734, 0), 10f))
		{
			PED::CLEAR_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_608, 1862763509);
		}
		if (!iLocal_619)
		{
		...
		else if (AI::IS_PED_GETTING_UP(iLocal_734))
		{
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_734, 1);
			bLocal_645 = false;
		}
...
void func_485()
{
	if (!PED::IS_PED_INJURED(iLocal_734))
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_732))
		{
			...
			{
				uLocal_732 = OBJECT::CREATE_OBJECT(iLocal_728, ENTITY::GET_ENTITY_COORDS(iLocal_734, 1), 0, 0, 0);
			}
		}
		else if (!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_732, iLocal_734))
		{
			ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_732, iLocal_734, PED::GET_PED_BONE_INDEX(iLocal_734, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
	}
}
...
void func_504()
{
	if (!iLocal_631)
	{
		PED::ADD_RELATIONSHIP_GROUP("FRIENDLIES", &uLocal_608);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_734, uLocal_608);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_608, 1862763509);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, 1862763509, uLocal_608);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_608, -2065892691);
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				...
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(1804.501f, 3922.917f, 32.8091f, 2f, 0, 0, 0, 0, 0, 0);
			}
			if (bVar4)
			{
				iLocal_79 = 3;
		...
		case 3:
			if (func_224(uParam0->f_28[0]))
			{
				...
				{
					AI::TASK_PLAY_ANIM(uParam0->f_28[0], "special_ped@cletus@base", "cletus_base", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
			}
