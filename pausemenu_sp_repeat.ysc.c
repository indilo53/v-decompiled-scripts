...
void func_1(int iParam0, int iParam1)
{
	...
	GAMEPLAY::SET_BIT(&Global_71838, 0);
}
...
void func_29(int iParam0, int iParam1)
{
	...
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT((3 - iVar2));
	func_30(sVar0);
	func_30(sVar1);
...
float func_48(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	else
	{
		GRAPHICS::_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_DESCRIPTION");
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(2);
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(func_49(iVar1));
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(fVar0);
...
void func_58(int iParam0, int iParam1, var uParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	...
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(SYSTEM::CEIL(fVar0));
	if (iParam6 == 0)
	{
		GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("PM_RP_STATD");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(sParam4);
...
void func_83(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, char* sParam5, var uParam6)
{
	if (GRAPHICS::_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_DATA_SLOT"))
	{
		...
		func_30(sParam5);
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam6);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	}
}
