...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (func_311(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, 1, 0))
			{
	...
	switch (iLocal_149)
	{
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_178))
			{
				...
				{
					if (func_310(PLAYER::PLAYER_PED_ID(), uLocal_178, 1f, 1))
					{
						WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), joaat("gadget_parachute"), 1, 0, 0);
						OBJECT::DELETE_OBJECT(&uLocal_178);
					}
				}
			}
			if (iLocal_347 == 0)
...
int func_39(var uParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(uParam0, func_82(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(uParam0, func_82(iParam1), Global_71402[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_82(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, 0);
		}
	}
...
int func_42(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_82(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_82(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_82(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_73(iVar0);
						if (Global_71400 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_82(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_82(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_82(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
int func_155(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_82(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_82(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_239()
{
	...
	switch (iLocal_149)
	{
			...
			if (!func_260())
			{
				if (func_254(1, 20f, 1))
				{
					if ((!iLocal_383 || GAMEPLAY::GET_GAME_TIMER() > iLocal_384 + 3000) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, 0, 1, 0))
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(uLocal_179) && !ENTITY::IS_ENTITY_DEAD(uLocal_179, 0))
						{
							ENTITY::SET_ENTITY_VISIBLE(uLocal_179, 0, 0);
						}
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							uLocal_172 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
							uLocal_181 = ENTITY::GET_ENTITY_MODEL(uLocal_172);
							if (VEHICLE::IS_THIS_MODEL_A_CAR(uLocal_181) == 1 || VEHICLE::IS_THIS_MODEL_A_BIKE(uLocal_181) == 1)
							{
		...
		case 2:
			...
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_179) && !ENTITY::IS_ENTITY_DEAD(uLocal_179, 0))
			{
				ENTITY::SET_ENTITY_VISIBLE(uLocal_179, 1, 0);
			}
			if (iLocal_151 == 0)
			{
...
void func_244(vector3 vParam0, float fParam3)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uVar0))
		{
			...
			{
				ENTITY::SET_ENTITY_COORDS(uVar0, vParam0, 1, 0, 0, 1);
...
int func_268(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_252(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_252(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_275()
{
	...
	AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_82.f_28[0], 1826.662f, 146.9161f, 170.4472f, 1f, -1, 1048576000, 0, 1193033728);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_173))
	{
		uLocal_173 = VEHICLE::CREATE_VEHICLE(joaat("sanchez"), 1662.88f, -14.255f, 172.7742f, 205.3516f, 1, 1, 0);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_174))
	{
		uLocal_174 = VEHICLE::CREATE_VEHICLE(joaat("bmx"), 1633.766f, -23.6768f, 127.0535f, 55.7565f, 1, 1, 0);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_176))
	{
		uLocal_176 = OBJECT::CREATE_OBJECT(1165008631, 1666.282f, -11.20408f, 172.7773f, 1, 1, 0);
		ENTITY::SET_ENTITY_ROTATION(uLocal_176, 0.000637f, -0.000136f, 10.66059f, 2, 1);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_177))
	{
		uLocal_177 = OBJECT::CREATE_OBJECT(1165008631, 1667.076f, -12.07778f, 173.2611f, 1, 1, 0);
		ENTITY::SET_ENTITY_ROTATION(uLocal_177, 90.03932f, -0.257438f, -13.86142f, 2, 1);
	}
	if (func_311(Local_155))
	{
		if (AI::GET_SCRIPT_TASK_STATUS(Local_155, 242628503) != 1)
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_179))
	{
		uLocal_179 = OBJECT::CREATE_AMBIENT_PICKUP(joaat("pickup_parachute"), 1665.264f, -11.4427f, 172.7747f, 7, -1, joaat("p_parachute_s"), 1, 1);
	}
	ENTITY::SET_ENTITY_ROTATION(uLocal_179, -111.8225f, -0.454914f, -162.2231f, 2, 1);
	ENTITY::PLAY_ENTITY_ANIM(uLocal_179, "Chute_Off_Bag", "skydive@parachute@", 4f, 0, 1, 0, 0.99f, 0);
	func_240(1);
}
...
{
	func_278(uParam0);
	*uParam0 = PED::CREATE_PED(iParam6, iParam1, vParam2, uParam5, 0, 0);
}
...
int func_287(int iParam0, int iParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if ((!PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_BOAT(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
		{
			if (!func_258(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_312()
{
	...
	{
		uLocal_175 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_box_guncase_03a"), 1658.299f, -7.930665f, 173.71f, 1, 1, 0);
		ENTITY::SET_ENTITY_ROTATION(uLocal_175, 90f, 0f, -63f, 2, 1);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_175, 1);
		ENTITY::SET_ENTITY_VISIBLE(uLocal_175, 0, 0);
	}
	func_316(1);
