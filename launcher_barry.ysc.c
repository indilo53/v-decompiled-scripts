...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_199(Var0.f_28[0]))
		{
			if (Var0 == 2)
			{
				if (func_197(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], 1), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
				{
			...
			{
				if (func_197(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], 1), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f))
				{
				}
			}
			else if (Var0 == 4)
			{
				func_186(&uLocal_105, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], 1), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar64 = 0;
		if (func_185(Var0))
		{
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_94) > 5000)
			{
				iVar64 = 1;
...
var func_167(vector3 vParam0, int iParam3)
{
	...
	UI::SET_BLIP_SCALE(uVar0, func_168(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
int func_170(int iParam0, int iParam1)
{
	switch (iParam0->f_16)
	{
		...
		case 3:
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), iParam0->f_17[0 /*3*/], 1) < iParam0->f_15)
			{
				if (func_176(2))
				{
					if (func_174(iParam0->f_27))
...
void func_186(var uParam0, vector3 vParam1, char[4] cParam4, char* sParam5)
{
	...
	{
		case 0:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_271) > 5000)
			{
				*uParam0 = 1;
			}
			break;
...
void func_196(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, int iParam10)
{
	...
	AI::TASK_PLAY_ANIM(0, iParam0->f_48, uParam1[uParam1.f_7], 4f, -4f, -1, 0 | iVar1, 0, 0, 0, 0);
	AI::TASK_PLAY_ANIM(0, iParam0->f_48, iParam0->f_48.f_1, 8f, -8f, -1, 1 | iVar1, 0, 0, 0, 0);
	AI::CLOSE_SEQUENCE_TASK(uVar0);
	AI::TASK_PERFORM_SEQUENCE(iParam0->f_28[iParam10], uVar0);
...
int func_197(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_199(PLAYER::PLAYER_PED_ID()) && func_199(iParam0->f_28[0])) && !func_144()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_195(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_211(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_211(uParam1) && uParam1->f_4 == 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_235(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_228(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_228(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_227(vVar3, vVar0);
...
void func_287(int iParam0, bool bParam1)
{
	...
	if (UI::DOES_BLIP_EXIST(uLocal_96))
	{
		UI::REMOVE_BLIP(&uLocal_96);
	}
	if (iLocal_93 != -1)
	{
