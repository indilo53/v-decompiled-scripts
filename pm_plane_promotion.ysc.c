...
void func_1()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_241))
	{
		...
		else if (iLocal_47 == 2)
		{
			...
			{
				if (!UI::DOES_BLIP_EXIST(uLocal_50))
				{
			...
			else if (UI::DOES_BLIP_EXIST(uLocal_50))
			{
				UI::CLEAR_PRINTS();
				UI::REMOVE_BLIP(&uLocal_50);
			}
		}
	}
	if ((((ENTITY::DOES_ENTITY_EXIST(iLocal_241) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_241, 0)) && ENTITY::IS_ENTITY_IN_AIR(iLocal_241)) && iLocal_325) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("PLANES", 0, -1))
	{
		if (!bLocal_326)
		{
			...
			{
				if (iLocal_324 == -1 || (GAMEPLAY::GET_GAME_TIMER() - iLocal_324) > 2000)
				{
		...
		else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_324) > 3000)
		{
			bLocal_326 = false;
		}
	}
	else if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_332))
	{
	...
	switch (iLocal_47)
	{
		case 0:
			...
			if (STREAMING::HAS_MODEL_LOADED(joaat("stunt")))
			{
				...
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_241))
				{
					iLocal_241 = VEHICLE::CREATE_VEHICLE(joaat("stunt"), vVar0, 121.2244f, 1, 1, 0);
		...
		case 3:
			if (func_24(&uLocal_51, vLocal_36, -1067.083f, -2922.601f, 12.82418f, -1091.854f, -2965.403f, 23.94564f, 31.5625f, 1, iLocal_241, "LAND", "", "BK_PLANE", 1, 0, 1, -1) && !ENTITY::IS_ENTITY_IN_AIR(iLocal_241))
			{
				func_127(&uLocal_51, 1, 0);
				iLocal_47++;
			}
	...
	switch (iLocal_48)
	{
		case 0:
			...
			else if ((func_20() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_49) > 5000) && iLocal_329)
			{
		...
		case 1:
			if (func_20() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_49) > 1000)
			{
		...
		if (CAM::IS_SCREEN_FADED_IN())
		{
			...
			if (bVar1)
			{
				...
				if (bParam26 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					if ((!func_42(uParam0, 1) && !func_41(uParam0)) && !GAMEPLAY::IS_BIT_SET(uParam0->f_13, 0))
					{
						if (bParam30)
						{
				...
				else
				{
					...
					else if (!func_35(vVar3, UI::GET_BLIP_COORDS(uParam0->f_5), 0.1f, 0))
					{
					...
					if (bParam28)
					{
						...
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vParam7, vParam10, uParam36, 0, iVar6, iVar7))
						{
							bVar1 = true;
						}
					}
					...
					if (bVar1)
					{
						...
						while (iVar2 < 3)
						{
							if (!PED::IS_PED_INJURED(uParam0->f_17[iVar2]))
							{
								...
								else if (!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar2], func_34()) || !func_32(uParam0->f_17[iVar2], 1))
								{
									bVar1 = false;
								}
							}
...
int func_27(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_28(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_28(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
int func_29(var uParam0)
{
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_13, 12))
	{
		...
		{
			if (func_30(1, 0, 1) || GAMEPLAY::IS_BIT_SET(uParam0->f_13, 7))
			{
				return 1;
			}
		}
	}
	else if (func_30(1, 0, 1) || GAMEPLAY::IS_BIT_SET(uParam0->f_13, 7))
	{
		return 1;
	}
	return 0;
...
int func_32(var uParam0, int iParam1)
{
	if (!PED::IS_PED_INJURED(uParam0))
	{
		...
		{
			if (func_33(PLAYER::PLAYER_PED_ID(), uParam0))
			{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_39(iParam2), 1);
}
	...
	if (!uParam0->f_6)
	{
		...
		if (!uParam0->f_6)
		{
			if (!UI::DOES_BLIP_EXIST(uParam0->f_4))
			{
				...
				UI::_0x75A16C3DA34F1245(uParam0->f_4, 0);
			}
			if (!UI::DOES_BLIP_EXIST(uParam0->f_5))
			{
...
var func_71(vector3 vParam0, var uParam3, bool bParam4)
{
	...
	uVar0 = UI::ADD_BLIP_FOR_RADIUS(vParam0, uParam3);
	UI::SET_BLIP_COLOUR(uVar0, 5);
	UI::SET_BLIP_ALPHA(uVar0, 64);
	UI::SET_BLIP_AS_SHORT_RANGE(uVar0, bParam4);
	if (!bParam4)
	{
		UI::SET_BLIP_DISPLAY(uVar0, 4);
	}
	return uVar0;
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_126(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_123(ENTITY::GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
void func_137()
{
	...
	while (iVar0 <= 9)
	{
		...
		{
			fVar1 = 0f;
			GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Local_242[iVar0 /*8*/], &fVar1, 0, 0);
...
void func_142()
{
	...
	if (UI::DOES_BLIP_EXIST(Local_242[0 /*8*/].f_4))
	{
		UI::REMOVE_BLIP(&(Local_242[0 /*8*/].f_4));
	}
	if (UI::DOES_BLIP_EXIST(Local_242[0 /*8*/].f_5))
	{
		UI::REMOVE_BLIP(&(Local_242[0 /*8*/].f_5));
	}
	if (UI::DOES_BLIP_EXIST(Local_242[1 /*8*/].f_4))
	{
		UI::REMOVE_BLIP(&(Local_242[1 /*8*/].f_4));
	}
	if (UI::DOES_BLIP_EXIST(Local_242[1 /*8*/].f_5))
	{
		UI::REMOVE_BLIP(&(Local_242[1 /*8*/].f_5));
	}
