						...
						if (SYSTEM::TIMERA() > 1000)
						{
							if (!PED::IS_PED_INJURED(uLocal_91[0]))
							{
								if (func_144())
								{
									...
									{
										fLocal_164 = func_140(PLAYER::PLAYER_PED_ID(), uLocal_91[0], 1);
										iLocal_64++;
									}
								}
								else if (!iLocal_119)
					...
					case 2:
						...
						if (!PED::IS_PED_INJURED(uLocal_91[0]))
						{
							if (func_144())
							{
								if (!iLocal_118)
								{
									if (func_140(PLAYER::PLAYER_PED_ID(), uLocal_91[0], 1) > (fLocal_164 + 5f))
									{
						...
						if (!PED::IS_PED_INJURED(uLocal_91[0]))
						{
							if (func_140(PLAYER::PLAYER_PED_ID(), uLocal_91[0], 1) > 50f)
							{
								func_60();
							}
						}
...
void func_76(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_78() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_78() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
int func_82(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_78() /*10778*/].f_6165.f_10, iParam0);
}
...
void func_120()
{
	...
	if ((ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "random@drunk_driver_2", "driver_enter_m", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "random@drunk_driver_2", "driver_idle_m", 3)) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "random@drunk_driver_2", "driver_exit_m", 3))
	{
		...
		if ((((((((func_125(64) || CONTROLS::IS_CONTROL_PRESSED(0, 86)) || CONTROLS::IS_CONTROL_PRESSED(0, 71)) || CONTROLS::IS_CONTROL_PRESSED(0, 72)) || CONTROLS::IS_CONTROL_PRESSED(0, 76)) || CONTROLS::IS_CONTROL_PRESSED(0, 73)) || CONTROLS::IS_CONTROL_PRESSED(0, 68)) || CONTROLS::IS_CONTROL_PRESSED(0, 75)) || iVar0)
		{
	...
	switch (iLocal_346)
	{
		...
		case 6:
			func_122();
			func_121();
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_347) > 5000 && func_124())
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), PED::GET_VEHICLE_PED_IS_IN(uLocal_91[1], 0), 0))
				{
...
void func_129()
{
	if (func_2() && iLocal_111 < 2)
	{
		...
		func_130(vLocal_160, (GAMEPLAY::GET_GAME_TIMER() - iLocal_159));
	}
	if (iLocal_163 > 17)
	{
		iLocal_109 = 1;
...
var func_137(vector3 vParam0, int iParam3)
{
	...
	UI::SET_BLIP_SCALE(uVar0, func_138(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
int func_146(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_138(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
int func_173(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_38() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_83(func_171(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_189()
{
	if ((Global_106554 == func_52() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
