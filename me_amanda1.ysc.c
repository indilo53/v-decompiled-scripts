...
void func_4(bool bParam0, bool bParam1)
{
	...
	else
	{
		...
		else if (func_526(iLocal_408) && ENTITY::IS_ENTITY_AT_COORD(iLocal_408, vLocal_390, 50f, 50f, 50f, 0, 1, 0))
		{
			func_11(iLocal_408);
		}
		else
	...
	PATHFIND::SET_PED_PATHS_IN_AREA(vLocal_381, vLocal_384, 1, 0);
		...
		switch (iLocal_405)
		{
			case 0:
				...
				else
				{
					...
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_294, 1f, 20000, 1048576000, 0, 1193033728);
...
int func_70(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_80(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_80(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_80(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_112(iVar0);
						if (Global_71400 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_80(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_80(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_80(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
void func_90(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_91(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
...
int func_95(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_97(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_97(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 4);
		}
	}
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_92(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_92(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_92(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_92(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_129(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_123(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_123(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_80(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_184(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_80(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_80(iParam1)))
	{
		return 1;
	}
	return 0;
		...
		switch (iLocal_405)
		{
			case 0:
				...
				else
				{
					...
					func_192(iLocal_408, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) + Vector(0f, 2f, 2f));
					ENTITY::SET_ENTITY_HEADING(iLocal_408, -155.84f);
					ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), -43.04f);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_408, 0);
					AI::OPEN_SEQUENCE_TASK(&uVar3);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 3000);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_291, 1f, 20000, 1048576000, 0, 1193033728);
					AI::CLOSE_SEQUENCE_TASK(uVar3);
					AI::TASK_PERFORM_SEQUENCE(iLocal_408, uVar3);
					AI::CLEAR_SEQUENCE_TASK(&uVar3);
...
void func_205()
{
	...
	if (GAMEPLAY::GET_GAME_TIMER() > iLocal_370)
	{
		...
		{
			uVar0 = PED::GET_VEHICLE_PED_IS_IN(iLocal_408, 0);
			if (func_8(uVar0) && !PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uVar0))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uVar0, PLAYER::PLAYER_PED_ID(), 1))
				{
					func_6(&uLocal_95, 4);
			...
			else if (FIRE::IS_ENTITY_ON_FIRE(uVar0))
			{
				func_6(&uLocal_95, 4);
				func_206(iLocal_408, "GENERIC_FRIGHTENED_HIGH", "AMANDA_NORMAL", 10);
				iLocal_370 = GAMEPLAY::GET_GAME_TIMER() + 5000;
...
void func_229()
{
	...
	if (((iLocal_462 && !UI::IS_MESSAGE_BEING_DISPLAYED()) && func_526(PLAYER::PLAYER_PED_ID())) && func_526(iLocal_408))
	{
...
void func_233()
{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vVar0, 1f, 1f, 2f, 1, 1, 0) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vVar0, 1) < 2.75f)
	{
		bVar3 = false;
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
	...
	if ((iLocal_430 < 3 && func_8(iLocal_428)) && func_236())
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_428, 0) && PED::IS_PED_IN_VEHICLE(iLocal_408, iLocal_428, 0))
		{
			if (((VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_428, 2, 5000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_428, 3, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_428, 0, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_428, 1, 5000))
			{
				...
				else if (GAMEPLAY::GET_GAME_TIMER() > iLocal_436 && !func_208())
				{
					func_63(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
...
void func_237()
{
	...
	if (func_526(PLAYER::PLAYER_PED_ID()) && GAMEPLAY::GET_GAME_TIMER() > iLocal_429)
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
...
void func_240()
{
	...
	if ((((iLocal_337 < 3 && GAMEPLAY::GET_GAME_TIMER() > iLocal_332) && func_236()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_239())
	{
		iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
...
void func_241()
{
	if (((iLocal_330 < 3 && GAMEPLAY::GET_GAME_TIMER() > iLocal_324) && func_236()) && func_239())
	{
...
void func_242()
{
	...
	if (((iLocal_323 < 4 && GAMEPLAY::GET_GAME_TIMER() > iLocal_317) && func_236()) && func_239())
	{
...
void func_258()
{
	if (((((func_526(PLAYER::PLAYER_PED_ID()) && func_526(iLocal_416)) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_416)) && !AI::IS_PED_GETTING_UP(iLocal_416)) && !PED::IS_PED_PRONE(iLocal_416)) && !PED::IS_PED_RAGDOLL(iLocal_416))
	{
...
{
	if (((((func_526(iLocal_416) && func_526(PLAYER::PLAYER_PED_ID())) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_416)) && !AI::IS_PED_GETTING_UP(iLocal_416)) && !PED::IS_PED_PRONE(iLocal_416)) && !PED::IS_PED_RAGDOLL(iLocal_416))
	{
		if (!func_5(iLocal_416) == joaat("weapon_pistol"))
		{
			PED::SET_PED_CAN_SWITCH_WEAPON(iLocal_416, 1);
...
int func_267(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_201(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_201(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_269()
{
	if ((iLocal_441 && GAMEPLAY::GET_GAME_TIMER() > iLocal_437) && func_239())
	{
		func_6(&uLocal_95, 4);
...
void func_271()
{
	...
	else if (func_208())
	{
		if (!iLocal_444)
		{
			Var0 = { func_225() };
			uVar6 = func_272(&Var0);
			if (GAMEPLAY::ARE_STRINGS_EQUAL(uVar6, "MEA1_SCENE"))
			{
				func_273(1);
				iLocal_444 = 1;
			}
...
void func_275()
{
	...
	if (((((PED::IS_PED_INJURED(iLocal_416) || PED::IS_PED_INJURED(iLocal_422)) || func_277(iLocal_416, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || func_277(iLocal_422, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || ((func_8(uVar0) && func_8(iLocal_410)) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(uVar0, iLocal_410))) || (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_387, 1) < 30f))
	{
		if (!PED::IS_PED_IN_VEHICLE(iLocal_408, iLocal_410, 0))
		{
			if (!PED::IS_PED_GROUP_MEMBER(iLocal_408, func_220()))
			{
				...
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_410, 0);
				if ((func_8(uVar0) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uVar0, 0)) && VEHICLE::IS_VEHICLE_SEAT_FREE(uVar0, 0, 0))
				{
					if (!func_51(iLocal_408, -1794415470))
					{
						AI::TASK_ENTER_VEHICLE(iLocal_408, uVar0, 20000, 0, 3f, 1, 0);
					}
				}
	...
	if (func_9(PLAYER::PLAYER_PED_ID()) && func_9(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_288(PLAYER::PLAYER_PED_ID(), iParam0, iParam2);
				}
			}
		}
		if (bParam4)
...
void func_291()
{
	...
	if (func_526(PLAYER::PLAYER_PED_ID()))
	{
		...
		else
		{
			...
			iLocal_441 = 1;
			iLocal_457 = -1;
			if ((((func_526(iLocal_416) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_416)) && !AI::IS_PED_GETTING_UP(iLocal_416)) && !PED::IS_PED_PRONE(iLocal_416)) && !PED::IS_PED_RAGDOLL(iLocal_416))
			{
		...
		switch (iLocal_316)
		{
			case 0:
				if (func_208())
				{
					...
					{
						Local_310 = { func_295() };
						if ((((((((func_294(PLAYER::PLAYER_PED_ID(), iLocal_410, 5f, 1) || func_294(PLAYER::PLAYER_PED_ID(), iLocal_416, 5f, 1)) && !GAMEPLAY::ARE_STRINGS_EQUAL(&Local_310, "MEA1_SCENE_1")) && !GAMEPLAY::ARE_STRINGS_EQUAL(&Local_310, "MEA1_SCENE_2")) && !GAMEPLAY::ARE_STRINGS_EQUAL(&Local_310, "MEA1_SCENE_3")) && !GAMEPLAY::ARE_STRINGS_EQUAL(&Local_310, "MEA1_SCENE_4")) && !GAMEPLAY::ARE_STRINGS_EQUAL(&Local_310, "MEA1_SCENE_5")) && !GAMEPLAY::ARE_STRINGS_EQUAL(&Local_310, "MEA1_SCENE_6")) && func_279(iLocal_416, 1126825984))
						{
...
void func_298()
{
	if ((((func_526(iLocal_416) && func_526(iLocal_422)) && func_526(iLocal_408)) && func_8(iLocal_410)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_379))
	{
		switch (iLocal_261)
		{
			case 0:
				func_299();
				uLocal_260 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_262, vLocal_265, 2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
		{
			if (func_358(24) != PLAYER::GET_PLAYERS_LAST_VEHICLE())
			{
				if (iParam4 == 1)
				{
					if (func_355(ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_333(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_377(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_379(Var11.f_1)) && iVar72 < 51)
			{
...
void func_383(var uParam0)
{
	...
	if (func_14(iVar0) && !PED::IS_PED_INJURED(uParam0))
	{
...
int func_393(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_409(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_394(iVar0, 0), 1);
...
void func_423()
{
	...
	switch (iLocal_405)
	{
		case 0:
			...
			UI::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_407, "MEA1_AMA");
			UI::SET_BLIP_COLOUR(uLocal_407, 3);
			UI::SET_BLIP_ROUTE(uLocal_407, 1);
		...
		case 1:
			if (func_526(PLAYER::PLAYER_PED_ID()))
			{
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_387, 1) < 200f)
				{
					iLocal_405 = 2;
				}
			}
		...
		case 2:
			...
			{
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_387, 1) < 30f)
				{
					iLocal_457 = -1;
					iLocal_405 = 0;
					iLocal_404 = 2;
...
void func_424()
{
	if ((((iLocal_305 < 1 && func_526(PLAYER::PLAYER_PED_ID())) && !func_208()) && !func_210("MEA1_01", 0, 0)) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_387, 1) > (30f * 3f))
	{
...
void func_425()
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_410))
	{
		...
		{
			iLocal_410 = VEHICLE::CREATE_VEHICLE(iLocal_411, vLocal_412, fLocal_415, 1, 1, 0);
			...
			VEHICLE::SET_VEHICLE_EXTRA(iLocal_410, 2, 1);
			iLocal_442 = 1;
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_411);
			PATHFIND::SET_ROADS_IN_ANGLED_AREA(vLocal_450, vLocal_453, fLocal_456, 0, 0, 1);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_408))
	{
		if (func_8(iLocal_410) && STREAMING::HAS_MODEL_LOADED(func_15(17)))
		{
			...
			PED::SET_PED_PROP_INDEX(iLocal_408, 1, 0, 0, 0);
			PED::SET_PED_CAN_BE_TARGETTED(iLocal_408, 0);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_416))
	{
		...
		{
			iLocal_416 = PED::CREATE_PED(6, iLocal_417, vLocal_418, fLocal_421, 1, 1);
			func_63(&uLocal_95, 6, iLocal_416, "MEAmandaCop", 1, 1);
			PED::SET_PED_CAN_SWITCH_WEAPON(iLocal_416, 0);
			PED::SET_PED_PROP_INDEX(iLocal_416, 1, 0, 0, 0);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_422))
	{
		...
		{
			iLocal_422 = PED::CREATE_PED(4, iLocal_423, vLocal_424, fLocal_427, 1, 1);
			...
			GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_418, 50f, 0);
			PATHFIND::DISABLE_NAVMESH_IN_AREA(vLocal_381, vLocal_384, 1);
			PATHFIND::SET_PED_PATHS_IN_AREA(vLocal_381, vLocal_384, 0, 0);
...
int func_426(var uParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	if (!func_14(iParam1))
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(iVar0))
		{
			...
			{
				*uParam0 = PED::CREATE_PED_INSIDE_VEHICLE(uParam2, 26, iVar0, iParam3, 0, 0);
...
void func_431()
{
	...
	if (UI::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		...
		if (func_33(0) && func_526(PLAYER::PLAYER_PED_ID()))
		{
			...
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vVar1, 100f, 0, 0, 0, 0, 0, 0);
		}
		if (func_455())
		{
			iVar5 = func_454();
			...
			switch (iVar5)
			{
				case 0:
					...
					{
						ENTITY::SET_ENTITY_COORDS(uVar6, -822.4044f, 182.6078f, 71.37809f, 1, 0, 0, 1);
						ENTITY::SET_ENTITY_HEADING(uVar6, 135.6541f);
					}
					func_7(&uVar6);
					func_446();
					iLocal_405 = 0;
				...
				case 2:
					func_432(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
...
void func_440()
{
	...
	if (func_526(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_8(uVar0))
		{
			ENTITY::SET_ENTITY_COORDS(uVar0, -836.72f, -179.78f, 37.1f, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(uVar0, 32.61f);
		}
		else
		{
...
void func_446()
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (func_8(uVar0))
		{
			...
			VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(uVar1, 1);
		}
	}
}
...
void func_458(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if ((func_14(iParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_462(*uParam1, 0, &uVar0))
		{
...
int func_493(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_484(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_496(*uParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_496(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_495(uParam0);
	if (func_494(*uParam0))
	{
...
int func_506(var uParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_507(uParam0, uVar1[iVar6], 1) && func_452(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_348(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&uParam0);
						return 1;
					}
...
void func_508(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_511(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_510())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
void func_523()
{
	...
	uVar0 = func_524(PLAYER::PLAYER_PED_ID(), vLocal_387, 1);
