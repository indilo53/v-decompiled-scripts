...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		fVar0 = (CAM::_GET_REPLAY_FREE_CAM_MAX_RANGE() + 20f);
		if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), vLocal_99) < (fVar0 * fVar0))
		{
			UNK1::_0xAF66DCEE6609B148();
		}
		if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), vLocal_103) < (fVar0 * fVar0))
		{
			UNK1::_0xAF66DCEE6609B148();
		}
...
int func_59()
{
	if (!PED::IS_COP_PED_IN_AREA_3D(vLocal_126, vLocal_129) && !(GAMEPLAY::IS_POSITION_OCCUPIED(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) && GAMEPLAY::IS_POSITION_OCCUPIED(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0)))
	{
	...
	else if (PED::IS_COP_PED_IN_AREA_3D(vLocal_126, vLocal_129) || (GAMEPLAY::IS_POSITION_OCCUPIED(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) && GAMEPLAY::IS_POSITION_OCCUPIED(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0)))
	{
		if (INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == GAMEPLAY::GET_HASH_KEY("rm_showroom"))
		{
		...
		case 1:
			if (!func_2(uLocal_91) || !func_2(uLocal_92))
			{
				...
				if (func_2(uLocal_91))
				{
					...
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_91, uLocal_150);
					ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_91, 1);
					WEAPON::GIVE_WEAPON_TO_PED(uLocal_91, joaat("weapon_pistol"), 999, 0, 0);
					ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(uLocal_91, 0, uLocal_148);
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_148, 1862763509);
				...
				if (func_2(uLocal_92))
				{
					...
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_92, uLocal_150);
					ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_92, 1);
					WEAPON::GIVE_WEAPON_TO_PED(uLocal_92, joaat("weapon_pistol"), 999, 0, 0);
					ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(uLocal_92, 0, uLocal_148);
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_148, 1862763509);
...
int func_90()
{
	if (((((((((((STREAMING::HAS_MODEL_LOADED(Local_47[0 /*20*/]) && STREAMING::HAS_MODEL_LOADED(Local_47[1 /*20*/])) && WEAPON::HAS_WEAPON_ASSET_LOADED(Local_47[0 /*20*/].f_17)) && WEAPON::HAS_WEAPON_ASSET_LOADED(Local_47[1 /*20*/].f_17)) && func_54()) && STREAMING::HAS_ANIM_DICT_LOADED("cellphone@")) && STREAMING::HAS_ANIM_DICT_LOADED("cellphone@str")) && AI::GET_IS_WAYPOINT_RECORDING_LOADED("reyetarian_simeonoffice")) && STREAMING::HAS_MODEL_LOADED(iLocal_122)) && STREAMING::HAS_MODEL_LOADED(joaat("bjxl"))) && STREAMING::HAS_MODEL_LOADED(joaat("tailgater"))) && STREAMING::HAS_MODEL_LOADED(joaat("baller2")))
	{
		return 1;
	}
	return 0;
...
void func_91(int iParam0)
{
	switch (Local_47[iParam0 /*20*/].f_18)
	{
			...
			if (!Local_47[iParam0 /*20*/].f_19)
			{
				if (!func_2(Local_47[iParam0 /*20*/].f_1))
				{
					...
					if (func_2(Local_47[iParam0 /*20*/].f_1))
					{
						if (iParam0 == 0)
						{
							AI::TASK_START_SCENARIO_AT_POSITION(Local_47[iParam0 /*20*/].f_1, "PROP_HUMAN_SEAT_CHAIR", vLocal_132[iParam0 /*3*/], fLocal_139[iParam0], 0, 0, 1);
						...
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_47[iParam0 /*20*/].f_1, uLocal_148);
						ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(Local_47[iParam0 /*20*/].f_1, 0, uLocal_148);
		...
		case 2:
			if (func_2(Local_47[iParam0 /*20*/].f_1))
			{
				if (iLocal_113)
				{
					...
					AI::OPEN_SEQUENCE_TASK(&uLocal_147);
					AI::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 12, 2);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_47[iParam0 /*20*/].f_14, 1f, -1, 3f, 0, 1193033728);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
					AI::CLOSE_SEQUENCE_TASK(uLocal_147);
					AI::TASK_PERFORM_SEQUENCE(Local_47[iParam0 /*20*/].f_1, uLocal_147);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_147);
					Local_47[iParam0 /*20*/].f_18 = 3;
				}
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(Local_47[iParam0 /*20*/].f_1, 0), 1) >= 250f)
				{
		...
		case 3:
			...
			{
				func_93(Local_47[iParam0 /*20*/].f_1, &(Local_47[iParam0 /*20*/].f_2), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
				if (AI::GET_SCRIPT_TASK_STATUS(Local_47[iParam0 /*20*/].f_1, 242628503) == 7 || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(Local_47[iParam0 /*20*/].f_1, 0), 1) <= 5f)
				{
					AI::TASK_LOOK_AT_ENTITY(Local_47[iParam0 /*20*/].f_1, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					AI::TASK_COMBAT_PED(Local_47[iParam0 /*20*/].f_1, PLAYER::PLAYER_PED_ID(), 0, 16);
		...
		case 4:
			...
			else
			{
				...
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(Local_47[iParam0 /*20*/].f_1, 0), 1) >= 75f)
				{
					Local_47[iParam0 /*20*/].f_18 = 5;
				}
			}
...
void func_94()
{
	...
	PED::REMOVE_RELATIONSHIP_GROUP(uLocal_150);
	if (iLocal_107 == 0)
	{
...
int func_123()
{
	if ((Global_106554 == func_31() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
void func_124()
{
	...
	PED::ADD_RELATIONSHIP_GROUP("GoonGroup", &uLocal_148);
	PED::ADD_RELATIONSHIP_GROUP("PlayerGroup", &uLocal_149);
	PED::ADD_RELATIONSHIP_GROUP("YetarianGroup", &uLocal_150);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_150, 1862763509);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, 1862763509, uLocal_150);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_148, 1862763509);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_148);
