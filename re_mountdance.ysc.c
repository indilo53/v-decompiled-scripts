		...
		switch (iLocal_99)
		{
			case 0:
				if ((BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() && !func_33()) && !func_12())
				{
					if (func_11())
					{
						uLocal_95 = PED::CREATE_PED(26, iLocal_90, vLocal_91, uLocal_94, 1, 1);
			...
			case 1:
				iLocal_101 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_91 + Vector(1f, 0f, 0f), 0f, 0f, uLocal_94, 2);
			...
			case 3:
				vVar0 = { ENTITY::GET_ENTITY_COORDS(uLocal_95, 1) };
				...
				if (((((PED::IS_PED_INJURED(uLocal_95) || GAMEPLAY::IS_BULLET_IN_AREA(vVar0, 50f, 1)) || GAMEPLAY::IS_BULLET_IN_AREA(vVar0, 50f, 0)) || GAMEPLAY::IS_PROJECTILE_IN_AREA(vVar0, 20f, 20f, 20f, 0)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vVar0, 50f)) || (((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_95) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_95)) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vVar0, 1) < 25f) && func_1(uLocal_95, PLAYER::PLAYER_PED_ID(), 1126825984, 0)))
				{
					AUDIO::STOP_SYNCHRONIZED_AUDIO_EVENT(iLocal_101);
					iLocal_99 = 4;
					iLocal_97 = 1;
...
int func_1(var uParam0, var uParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_3(ENTITY::GET_ENTITY_COORDS(uParam1, 1) - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_3(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
