	...
	if (func_22(Local_385))
	{
		if (func_423(Local_393))
		{
			if (func_57(2))
			{
				...
				AI::TASK_SYNCHRONIZED_SCENE(Local_385, uVar0, func_40(), func_50(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_393, uVar0, func_49(), func_40(), 1000f, -8f, iVar1, 1148846080);
...
void func_103(var uParam0, bool bParam1)
{
	if (func_22(uParam0))
	{
		...
		if (!func_63(uParam0, 1805844857))
		{
			...
			AI::TASK_SMART_FLEE_PED(uParam0, PLAYER::PLAYER_PED_ID(), 10000f, -1, 0, 0);
		}
		if (bParam1)
		{
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0, 1);
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_155(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_194(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_204(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_204(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_204(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_236(iVar0);
						if (Global_71400 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_204(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_204(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_204(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
void func_214(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_215(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
...
int func_216(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_204(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_219(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_221(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_221(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 4);
		}
	}
...
int func_221(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_204(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_216(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_216(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_216(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_216(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_253(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_247(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_247(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_204(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_308(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_204(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_204(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_310()
{
	...
	if (func_22(Local_112.f_9))
	{
		...
		{
			case 0:
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_664);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_664, 1862763509);
				...
				if (!iLocal_448)
				{
					...
					if (Local_112.f_10 == 22 || Local_112.f_10 == 23)
					{
						...
						else
						{
							...
							{
								if (func_117(iLocal_462, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_109(Local_112.f_9, vLocal_680, 30f))
									{
			...
			case 2:
				...
				iLocal_418 = 1;
				func_321();
				PED::CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_664);
				PED::CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_664, 1862763509);
				func_114(&(Local_112.f_8));
				iLocal_418 = 1;
				Local_112.f_17 = GAMEPLAY::GET_GAME_TIMER();
				func_319(&uLocal_44, 0, 0);
...
int func_324(var uParam0, vector3 vParam1)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (func_109(uParam0, vParam1, 3.5f) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), uParam0))
			{
				return 1;
			}
		}
...
void func_328(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_352(uParam1) && ENTITY::IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
int func_334(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_342() || func_341(Global_4456448.f_161209)) || func_340())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_338(uVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
{
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(uParam0, uLocal_664);
	...
	if (func_22(Local_112.f_9))
	{
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_112.f_10)
			{
				...
				case 3:
					if (func_117(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
				...
				case 7:
					if (func_117(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 1000)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_112.f_9))
						{
							PED::_0xF1C03A5352243A30(Local_112.f_9);
				...
				case 40:
					if (func_117(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 750)))
					{
				...
				case 19:
					...
					if (func_117(Local_112.f_18, 500))
					{
						if (PED::IS_PED_IN_PARACHUTE_FREE_FALL(Local_112.f_9))
						{
							...
							AI::TASK_PARACHUTE_TO_TARGET(Local_112.f_9, vLocal_683);
							Local_112.f_10 = 20;
						}
					}
					break;
				...
				case 20:
					...
					else if (PED::GET_PED_PARACHUTE_STATE(Local_112.f_9) == 2)
					{
						if (!iLocal_445)
						{
							...
							{
								AI::SET_PARACHUTE_TASK_TARGET(Local_112.f_9, vLocal_686);
								iLocal_445 = 1;
							}
						}
					}
				...
				case 22:
					if (func_117(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_112.f_9))
						{
				...
				case 24:
					...
					if (func_95(Local_254[0 /*6*/]))
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_254[0 /*6*/], 0) && func_109(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f)) && func_365(ENTITY::GET_ENTITY_HEADING(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f))
						{
							...
							else if (func_117(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 350)))
							{
								if (PED::IS_PED_USING_ANY_SCENARIO(Local_112.f_9))
								{
									PED::_0xFE07FF6495D52E2A(Local_112.f_9, vLocal_680);
								...
								AI::TASK_ENTER_VEHICLE(Local_112.f_9, Local_254[0 /*6*/], 25000, -1, 2f, 8388608, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
								Local_112.f_10 = 25;
							}
						}
				...
				case 26:
					...
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(Local_112.f_9, Local_254[0 /*6*/], PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 350f, 30f, 1);
			...
			else
			{
				...
				else if (Local_112.f_10 == 33 && func_63(Local_112.f_9, -1519143300))
				{
					if (func_109(Local_112.f_9, vLocal_680, 25f))
					{
						...
						{
							if (func_117(iLocal_463, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_61())
								{
									func_5();
				...
				else
				{
					...
					if (!func_61())
					{
						if (func_117(iLocal_462, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_109(Local_112.f_9, vLocal_680, 20f))
							{
			...
			else if (ENTITY::DOES_ENTITY_EXIST(Local_340[0 /*9*/]))
			{
				...
				else
				{
					...
					if (!func_63(Local_132[0 /*20*/], -875674219))
					{
						if (func_423(Local_112.f_9))
						{
							AI::TASK_LOOK_AT_ENTITY(Local_132[0 /*20*/], Local_112.f_9, -1, 2060, 3);
							AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_132[0 /*20*/], Local_112.f_9, -1);
						}
					}
				}
			}
...
void func_399()
{
	if (iLocal_478 < 10)
	{
		...
		{
			if (func_117(iLocal_479, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 4000)))
			{
				iLocal_431 = 0;
			}
		}
...
int func_417(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_185(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_185(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_376(vVar3, vVar0);
...
void func_426()
{
	...
	func_20();
	PED::REMOVE_RELATIONSHIP_GROUP(uLocal_664);
	func_511();
	func_127(0);
}
...
void func_439(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if ((func_83(iParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_443(*uParam1, 0, &uVar0))
		{
...
int func_473(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_464(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_476(*uParam0, ((*uParam1)[38] - 1)))
	{
...
int func_486(var uParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_488(uParam0, uVar1[iVar6], 1) && func_487(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_100(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&uParam0);
						return 1;
					}
...
void func_489(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_492(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_491())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
void func_511()
{
	...
	PED::ADD_RELATIONSHIP_GROUP("ENEMIES", &uLocal_664);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_664);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_664, 1862763509);
	vVar0 = { func_518(Local_103) };
	vVar3 = { func_517(Local_103) };
	PED::SET_PED_NON_CREATION_AREA(vVar0, vVar3);
	uLocal_482 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar3, 0, 1, 1, 1);
...
void func_512()
{
	if (func_22(Local_112.f_9))
	{
		...
		if (func_22(Local_132[0 /*20*/]))
		{
			AI::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_132[0 /*20*/], 0);
		}
...
void func_519()
{
	...
	GAMEPLAY::SET_BIT(&(Local_377[0 /*7*/].f_6), 3);
	GAMEPLAY::SET_BIT(&(Local_377[0 /*7*/].f_6), 4);
	GAMEPLAY::SET_BIT(&(Local_377[0 /*7*/].f_6), 1);
	iLocal_470 = 1;
