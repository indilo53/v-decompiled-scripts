	...
	if (func_517())
	{
		...
		if (iLocal_1209 == 0)
		{
			if (iLocal_1153)
			{
				...
				uVar0 = func_456(-1523.174f, -924.6732f, 9.1221f, 53.0177f);
				if (((!VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(uVar0)) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(uVar0))) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(uVar0))) && !VEHICLE::IS_BIG_VEHICLE(uVar0))
				{
		...
		else if (iLocal_1209 == 1)
		{
			if (iLocal_1153)
			{
				...
				uVar1 = func_456(-1266.405f, -219.1991f, 41.4459f, 304.8644f);
				if (((!VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(uVar1)) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(uVar1))) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(uVar1))) && !VEHICLE::IS_BIG_VEHICLE(uVar1))
				{
		...
		else if (iLocal_1209 == 2)
		{
			if (iLocal_1153)
			{
				...
				uVar2 = func_456(-1188.486f, -316.9884f, 36.6841f, 29.9702f);
				if (((!VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(uVar2)) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(uVar2))) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(uVar2))) && !VEHICLE::IS_BIG_VEHICLE(uVar2))
				{
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uVar2, 1084227584);
				}
				else
				{
					VEHICLE::DELETE_VEHICLE(&uVar2);
				}
			}
					...
					if (!iLocal_1170)
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (!PED::IS_PED_INJURED(iLocal_1057))
							{
								...
								if (iLocal_1044 == 1)
								{
									if (ENTITY::DOES_ENTITY_EXIST(uLocal_1314))
									{
										if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_1057, 0))
										{
											AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_1057, uLocal_1314, uLocal_1314, 2f, 0, 1056964608, 1082130432, 1, 0, -957453492);
										}
									}
								...
								else if (iLocal_1044 == 8)
								{
									...
									{
										AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_1057, iLocal_1312, iLocal_1312, 2f, 0, 1056964608, 1082130432, 1, 0, -957453492);
									}
...
void func_1()
{
	...
	{
		uVar0 = PED::GET_VEHICLE_PED_IS_IN(iLocal_1045, 0);
	...
	if (bLocal_1144)
	{
		if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uVar0, iLocal_1312))
		{
			VEHICLE::DETACH_VEHICLE_FROM_TOW_TRUCK(uVar0, iLocal_1312);
		}
	}
}
...
int func_30(int iParam0, bool bParam1)
{
	...
	while (iVar0 <= 1)
	{
		if (!PED::IS_PED_INJURED(uLocal_1047[iVar0]))
		{
			if (bParam1 || (!bParam1 && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_1054[iVar0], 0)))
			{
...
void func_34(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_36(Global_106070.f_18505[iVar0], &vVar2, &fVar5))
			{
...
void func_59(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_84(uParam1) && ENTITY::IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
int func_65(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_73() || func_72(Global_4456448.f_152990)) || func_71())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_69(uVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_92()
{
	...
	switch (iLocal_1207)
	{
		...
		case 2:
			...
			if (func_52(&uLocal_1339))
			{
				if ((func_46(&uLocal_1339) > fLocal_1244 && func_93()) || PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
				{
					func_3();
					if (!iLocal_1134)
					{
...
int func_93()
{
	...
	while (iVar0 < 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_1050[iVar0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_1050[iVar0], 0))
		{
			...
			if (PED::_CAN_PED_SEE_PED(uLocal_1050[iVar0], PLAYER::PLAYER_PED_ID()))
			{
				return 1;
			}
		}
	...
	while (iVar0 < 2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_1054[iVar0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_1054[iVar0], 0))
		{
			...
			if (PED::_CAN_PED_SEE_PED(uLocal_1054[iVar0], PLAYER::PLAYER_PED_ID()))
			{
				return 1;
			}
		}
	...
	while (iVar0 < 2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_1047[iVar0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_1047[iVar0], 0))
		{
			PED::SET_PED_RESET_FLAG(uLocal_1047[iVar0], 85, 1);
			if (PED::_CAN_PED_SEE_PED(uLocal_1047[iVar0], PLAYER::PLAYER_PED_ID()))
			{
				return 1;
			}
		}
...
int func_96()
{
	...
	if (iVar0 == 0)
	{
		...
		while (iVar1 < 2)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_1047[iVar1]) && !PED::IS_PED_INJURED(uLocal_1047[iVar1]))
			{
	...
	if (!iLocal_1134)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_1312))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0))
			{
				...
				{
					uVar0 = PED::GET_VEHICLE_PED_IS_IN(iLocal_1045, 0);
					if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(uVar0, iLocal_1312) || (bLocal_1144 && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uVar0, iLocal_1312)))
					{
						*iParam0 = 4;
						return 1;
					}
...
void func_104()
{
	...
	while (iVar0 < 2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_1047[iVar0]))
		{
			if (iLocal_1134 && !bLocal_1167)
			{
			...
			if (!PED::IS_PED_INJURED(uLocal_1047[iVar0]))
			{
				...
				{
					PED::SET_PED_RESET_FLAG(uLocal_1047[iVar0], 128, 1);
				}
			}
		}
		iVar0++;
...
void func_105(int iParam0)
{
	...
	switch (iLocal_1037[iParam0])
	{
		...
		case 5:
			if (!func_94(iLocal_1045))
			{
				if (func_46(&uLocal_1333) >= 27f || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
			...
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(uVar0) && VEHICLE::IS_VEHICLE_DRIVEABLE(uVar0, 0))
					{
						...
						if (fVar1 > 7f)
						{
							if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(uVar0, iParam0) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uVar0, iParam0, 1))
							{
								return 1;
							}
						}
...
int func_114(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (!bLocal_356)
		{
			iLocal_357 = ENTITY::GET_ENTITY_HEALTH(uParam0);
			bLocal_356 = true;
		}
		iLocal_358 = ENTITY::GET_ENTITY_HEALTH(uParam0);
	...
	if (func_115(PLAYER::PLAYER_PED_ID(), uParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (PED::IS_PED_RAGDOLL(uParam0) && func_23(uParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_117(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (WEAPON::IS_PED_ARMED(uParam0, 2))
	{
		...
		else
		{
			...
			if (PED::IS_PED_PLANTING_BOMB(uParam0) || func_102(iVar3))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(uParam1, ENTITY::GET_ENTITY_COORDS(uParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (PED::IS_PED_FACING_PED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(uParam1), uParam0, 120f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(uParam1, uParam0, 17))
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (func_24(iParam1, iParam0, 0) > fParam2 && func_23(iParam1, 1) < fParam3)
				{
					if (!PED::IS_PED_IN_VEHICLE(iParam1, iParam0, 0))
					{
						...
						{
							AI::TASK_ENTER_VEHICLE(iParam1, iParam0, 20000, -1, 1073741824, 1, 0);
						}
					}
...
void func_124(var uParam0, vector3 vParam1)
{
	if (!iLocal_1134)
	{
		...
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_1045, uParam0, vParam1, 0, 1, 0))
			{
				if (PED::IS_PED_FACING_PED(uParam0, iLocal_1045, 160f))
				{
					if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(uParam0, iLocal_1045, 17))
					{
						AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(uParam0, iLocal_1045, iLocal_1045, 1f, 0, -1f, 1082130432, 1, 0, -957453492);
						iLocal_1044 = 5;
						iLocal_1134 = 1;
					}
				}
			...
			{
				if (AI::GET_SCRIPT_TASK_STATUS(uParam0, -1207174364) != 1)
				{
					AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(uParam0, iLocal_1045, iLocal_1045, 1f, 0, -1f, 1082130432, 1, 0, -957453492);
				}
			}
	...
	if (!PED::IS_PED_INJURED(*uParam0))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(*uParam0, 0))
		{
			if (!iLocal_1136)
			{
				...
				else if (AI::GET_SCRIPT_TASK_STATUS(*uParam0, 1227113341) != 1)
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(*uParam0, iLocal_1045, -1);
				}
			}
			else if (*uParam0 != iLocal_1057)
			{
				if (AI::GET_SCRIPT_TASK_STATUS(*uParam0, 1227113341) != 1)
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(*uParam0, iLocal_1045, -1);
				}
			}
	...
	if (!ENTITY::IS_ENTITY_DEAD(uLocal_1054[iParam0], 0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1313, 0))
		{
			if (!PED::IS_PED_IN_VEHICLE(uLocal_1054[iParam0], iLocal_1313, 0))
			{
				...
				{
					AI::TASK_ENTER_VEHICLE(uLocal_1054[iParam0], iLocal_1313, 20000, iVar0, 1073741824, 1, 0);
				}
			}
		}
	}
	...
	switch (iLocal_1033[iParam0])
	{
		case 0:
			if (!PED::IS_PED_INJURED(iVar0))
			{
				AI::CLEAR_SEQUENCE_TASK(&uLocal_1324);
				AI::OPEN_SEQUENCE_TASK(&uLocal_1324);
				AI::TASK_GO_TO_COORD_ANY_MEANS(0, vLocal_1268[iParam0 /*3*/], 1f, 0, 0, 786603, -1082130432);
		...
		case 3:
			...
			else if (func_46(&uLocal_1333) > uLocal_1227[iParam0] || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			{
				func_125(&iVar0);
				iLocal_1033[iParam0] = 2;
			}
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0))
				{
					if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1312, -1, 0) == iVar0)
					{
						if (!PED::IS_PED_INJURED(iVar0))
						{
							...
							{
								AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iVar0, iLocal_1312, "OJASva_101", 181, 0, 0, -1, -1082130432, 0, 1073741824);
							}
						}
					}
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0))
				{
					if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1312, -1, 0) == iVar0)
					{
						if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0))
						{
							if (AI::GET_SCRIPT_TASK_STATUS(iVar0, -1273030092) != 1)
							{
								AI::TASK_VEHICLE_MISSION_COORS_TARGET(iVar0, iLocal_1312, vLocal_1290, 8, 25f, 786603, -1f, -1f, 1);
							}
						}
					}
				}
...
int func_136()
{
	...
	while (iVar0 <= 1)
	{
		if (!PED::IS_PED_INJURED(uLocal_1047[iVar0]))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(uLocal_1047[iVar0], 0))
			{
				iVar1 = 0;
			}
		}
...
void func_140(var uParam0, var uParam1)
{
	...
	if (iVar0 == 0)
	{
		AI::TASK_PLAY_ANIM(uParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_earpiece_a", 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 1, 0, 0);
	}
	else if (iVar0 == 1)
	{
		AI::TASK_PLAY_ANIM(uParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_earpiece_b", 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 1, 0, 0);
	}
	else if (iVar0 == 2)
	{
		AI::TASK_PLAY_ANIM(uParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_fold_arms", 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 1, 0, 0);
	}
	else if (iVar0 == 3)
	{
		AI::TASK_PLAY_ANIM(uParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_look", 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 1, 0, 0);
	}
	*uParam1 = iVar0;
}
...
void func_142(int iParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_1047[iParam0]))
	{
		return;
	}
	switch (iLocal_1041[iParam0])
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_1046, 0))
			{
				...
				{
					if (!PED::IS_PED_INJURED(uLocal_1047[iParam0]))
					{
						if (iParam0 == 0)
						{
							AI::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(uLocal_1047[iParam0], iLocal_1046, 1.5f, 0f, 0f, 1f, -1, 1036831949, 1);
						}
						else if (iParam0 == 1)
						{
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1313, 0))
							{
								...
								AI::TASK_PERFORM_SEQUENCE(uLocal_1047[iParam0], uVar2);
		...
		case 1:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uLocal_1047[iParam0], 0))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
				{
					if (!ENTITY::IS_ENTITY_DEAD(uLocal_1047[iParam0], 0))
					{
						if (!PED::IS_PED_IN_VEHICLE(uLocal_1047[iParam0], iVar0, 0))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_1046, 0))
							{
								if (AI::GET_SCRIPT_TASK_STATUS(uLocal_1047[iParam0], -1794415470) != 1)
								{
									AI::TASK_ENTER_VEHICLE(uLocal_1047[iParam0], iVar0, 30000, iVar1, 1f, 1, 0);
								}
							}
						}
						else
		...
		case 2:
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uLocal_1047[iParam0], 0))
				{
					if (PED::IS_PED_IN_VEHICLE(uLocal_1047[iParam0], iVar0, 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0))
					{
						if (iLocal_1134)
						{
							if (!bLocal_1164)
							{
								if (AI::GET_SCRIPT_TASK_STATUS(uLocal_1047[iParam0], 780511057) != 1)
								{
									if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
									{
									...
									AI::TASK_COMBAT_PED(uLocal_1047[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
								}
							}
							else if (AI::GET_SCRIPT_TASK_STATUS(uLocal_1047[iParam0], 780511057) != 1)
							{
								AI::TASK_COMBAT_PED(uLocal_1047[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
							}
						}
		...
		case 3:
			if (!PED::IS_PED_INJURED(uLocal_1047[iParam0]))
			{
				if (PED::IS_PED_USING_ANY_SCENARIO(uLocal_1047[iParam0]))
				{
					PED::_0xF1C03A5352243A30(uLocal_1047[iParam0]);
				}
			}
			if (bLocal_1159)
			{
				...
				AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(0, PLAYER::PLAYER_PED_ID(), func_123(), 1f, 0, 1056964608, 1082130432, 1, 0, -957453492);
				AI::CLOSE_SEQUENCE_TASK(uLocal_1324);
				AI::TASK_PERFORM_SEQUENCE(uLocal_1047[iParam0], uLocal_1324);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_1324);
			}
			else if (!PED::IS_PED_INJURED(uLocal_1047[iParam0]))
			{
				PED::SET_PED_SPHERE_DEFENSIVE_AREA(uLocal_1047[iParam0], vLocal_1305, 15f, 0, 0);
				PED::SET_PED_COMBAT_MOVEMENT(uLocal_1047[iParam0], 1);
				PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_1047[iParam0], 0, 1);
				PED::SET_PED_MAX_MOVE_BLEND_RATIO(uLocal_1047[iParam0], 2f);
				if (!iLocal_1131 && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_1047[iParam0], 0))
				{
					AI::OPEN_SEQUENCE_TASK(&uLocal_1324);
					if (PED::IS_PED_INJURED(iLocal_1046))
					{
				...
				else
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_1312) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1312, 0))
					{
						...
						vVar7 = { vVar4 - vVar7 };
						PED::_0xE4723DB6E736CCFF(uLocal_1047[iParam0], iLocal_1312, vVar7, 1.5f, 0);
					}
					AI::OPEN_SEQUENCE_TASK(&uLocal_1324);
					AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
		...
		case 4:
			if (!ENTITY::IS_ENTITY_DEAD(uLocal_1047[iParam0], 0))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_1047[iParam0], "oddjobs@assassinate@hotel@", "enter", 3))
				{
					fVar3 = ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_1047[iParam0], "oddjobs@assassinate@hotel@", "enter");
					if (fVar3 < 0.5f)
					{
						ENTITY::SET_ENTITY_ANIM_SPEED(uLocal_1047[iParam0], "oddjobs@assassinate@hotel@", "enter", 3.5f);
					}
					else
					{
						ENTITY::SET_ENTITY_ANIM_SPEED(uLocal_1047[iParam0], "oddjobs@assassinate@hotel@", "enter", 1f);
					}
				}
			}
			break;
		...
		case 5:
			...
			if (!PED::IS_PED_INJURED(iLocal_1046))
			{
				if (!PED::IS_PED_INJURED(uLocal_1047[iParam0]))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_1046, 0))
					{
						AI::TASK_COMBAT_PED(uLocal_1047[iParam0], iLocal_1045, 0, 16);
					}
					else
					{
						AI::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(uLocal_1047[iParam0], iLocal_1046, PLAYER::PLAYER_PED_ID(), 3f, 1, 0.005f, 1082130432, 1, 0, -957453492);
					}
				}
	...
	else if (iLocal_1041[iParam0] < 5)
	{
		if (!PED::IS_PED_INJURED(uLocal_1047[iParam0]))
		{
			...
			AI::TASK_CLEAR_DEFENSIVE_AREA(uLocal_1047[iParam0]);
			PED::SET_PED_COMBAT_MOVEMENT(uLocal_1047[iParam0], 2);
			PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_1047[iParam0], 13, 1);
		}
		iLocal_1041[iParam0] = 5;
	}
}
...
void func_151()
{
	...
	switch (iLocal_1215)
	{
		...
		case 1:
			...
			if (func_230(&uLocal_388, 1, 0) && AUDIO::_0x6F259F82D873B8B8())
			{
...
void func_194(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (!func_200(uParam0->f_1, 256) || (func_200(uParam0->f_1, 8192) && CONTROLS::_0x6CD79468A1E595C6(2)))
	{
		...
		if (GAMEPLAY::IS_PC_VERSION())
		{
			...
			GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(func_200(uParam0->f_1, 4096));
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		}
		iVar5 = 0;
		iVar6 = 0;
...
void func_203(var uParam0, bool bParam1)
{
	...
	func_199(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 215, 1));
	func_198("ES_HELP");
	if (GAMEPLAY::IS_PC_VERSION())
	{
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(1);
	...
	if (bParam1)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
		func_199(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 216, 1));
		func_198("ES_XPAND");
		if (GAMEPLAY::IS_PC_VERSION())
		{
			GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(1);
...
void func_205(var uParam0, float fParam1, var uParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	if (fVar11 >= 0f)
	{
		...
		func_220();
		GRAPHICS::DRAW_RECT(0.5f, (fVar1 - (func_223((2f - 0.5f)) - 0.001388889f)), fVar6, func_218(1f), uVar13, uVar14, uVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_204((fVar11 / (0.6f * func_223(25f))), 0f, 1f);
					func_220();
					GRAPHICS::DRAW_RECT(0.5f, (fVar1 + func_223((2f * 0.5f))), fVar6, func_218(1f), uVar13, uVar14, uVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_223((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_223((25f * 0.2f)));
...
void func_207(var uParam0, float fParam1, float fParam2, int iParam3, bool bParam4, int iParam5)
{
...
int func_208(int iParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)
{
	...
	if (GAMEPLAY::GET_HASH_KEY(&cVar16) != 0)
	{
		...
		vVar37.x = (vVar37.x * (func_209(iParam0) / fVar34));
		vVar37.y = (vVar37.y * (func_209(iParam0) / fVar34));
		if (!bParam2)
		{
...
struct<13> func_213(var uParam0)
{
	struct<13> Var0;
...
void func_215(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, var uParam5)
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			GRAPHICS::DRAW_SPRITE("CommonMenu", func_211(7, 0), (fParam4 - 0.006f), ((fParam2 + func_223(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, uParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_208(5, 0, 1, &fVar5, &fVar6, 0);
			GRAPHICS::DRAW_SPRITE("CommonMenu", func_211(5, 0), (fParam4 - 0.006f), ((fParam2 + func_223(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, uParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_208(6, 0, 1, &fVar5, &fVar6, 0);
			GRAPHICS::DRAW_SPRITE("CommonMenu", func_211(6, 0), (fParam4 - 0.006f), ((fParam2 + func_223(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, uParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_216(int iParam0, var uParam1, float fParam2, float fParam3, var uParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_231(var uParam0)
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(2);
	func_199(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 188, 1));
	func_198("ES_HELP_TU");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
	func_199(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 187, 1));
	func_198("ES_HELP_TD");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(0);
	func_199(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 202, 1));
	func_198("ES_HELP_AB");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
void func_234()
{
	...
	if (!iLocal_377)
	{
		...
		if (Global_87504)
		{
			func_239(&uLocal_388, 6, &(Local_965.f_12), "MTPHPERSKI", SYSTEM::FLOOR(fLocal_372), 0, 3, 0);
			func_239(&uLocal_388, 6, &(Local_965.f_24), "MTPHPERSKI", 0, 0, 3, 0);
			func_239(&uLocal_388, 6, &(Local_965.f_30), "MTPHPERSKI", SYSTEM::ROUND((fLocal_374 + fLocal_373)), 0, 3, 0);
			func_238();
		}
		else
		{
			if (bLocal_376)
			{
				func_239(&uLocal_388, 6, &(Local_965.f_12), "MTPHPERRET", SYSTEM::FLOOR(fLocal_372), 0, 3, 0);
			}
			else
			{
				func_239(&uLocal_388, 9, &(Local_965.f_12), "", SYSTEM::FLOOR(fLocal_372), 0, 0, 0);
			}
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_965.f_18)))
			{
				if (bLocal_375)
				{
					...
					func_239(&uLocal_388, 3, &(Local_965.f_30), "", SYSTEM::ROUND((fLocal_374 + fLocal_373)), 0, 2, 0);
				}
				else
				{
					func_239(&uLocal_388, 6, &(Local_965.f_24), "", 0, 0, 1, 0);
					func_239(&uLocal_388, 3, &(Local_965.f_30), "", SYSTEM::ROUND(fLocal_373), 0, 0, 0);
				}
			}
			else
			{
...
void func_235()
{
	...
	{
		func_236(38, SYSTEM::FLOOR(fLocal_372), 1);
		if (bLocal_375)
		{
			func_236(39, 1, 1);
		}
		...
		if (bLocal_375)
		{
			func_236(40, SYSTEM::ROUND((fLocal_374 + fLocal_373)), 1);
		}
		else
		{
			func_236(40, SYSTEM::ROUND(fLocal_373), 1);
		}
	...
	{
		func_236(52, SYSTEM::FLOOR(fLocal_372), 1);
		if (bLocal_375)
		{
			func_236(53, 1, 1);
		}
		...
		if (bLocal_375)
		{
			func_236(56, SYSTEM::ROUND((fLocal_374 + fLocal_373)), 1);
		}
		else
		{
			func_236(56, SYSTEM::ROUND(fLocal_373), 1);
		}
	...
	{
		func_236(66, SYSTEM::FLOOR(fLocal_372), 1);
		if (bLocal_375)
		{
			func_236(67, 1, 1);
		}
		...
		if (bLocal_375)
		{
			func_236(68, SYSTEM::ROUND((fLocal_374 + fLocal_373)), 1);
		}
		else
		{
			func_236(68, SYSTEM::ROUND(fLocal_373), 1);
		}
	...
	{
		func_236(81, SYSTEM::FLOOR(fLocal_372), 1);
		if (bLocal_375)
		{
			func_236(82, 1, 1);
		}
		...
		if (bLocal_375)
		{
			func_236(83, SYSTEM::ROUND((fLocal_374 + fLocal_373)), 1);
		}
		else
		{
			func_236(83, SYSTEM::ROUND(fLocal_373), 1);
		}
	...
	{
		func_236(97, SYSTEM::FLOOR(fLocal_372), 1);
		if (bLocal_375)
		{
			func_236(98, 1, 1);
		}
		...
		if (bLocal_375)
		{
			func_236(99, SYSTEM::ROUND((fLocal_374 + fLocal_373)), 1);
		}
		else
		{
			func_236(99, SYSTEM::ROUND(fLocal_373), 1);
		}
	...
	if (!bLocal_1175)
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				{
					if (VEHICLE::GET_IS_VEHICLE_ENGINE_RUNNING(uVar0))
					{
	...
	while (iVar0 < 2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_1047[iVar0]))
		{
			if (!PED::IS_PED_INJURED(uLocal_1047[iVar0]))
			{
				...
				AI::CLEAR_PED_TASKS(uLocal_1047[iVar0]);
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_1047[iVar0]));
			}
		}
		iVar0++;
	}
...
float func_257(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
void func_265()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_1046) && !ENTITY::IS_ENTITY_DEAD(iLocal_1046, 0))
	{
		...
		uVar10 = ENTITY::GET_ENTITY_HEADING(iLocal_1046);
	}
	vVar0[0 /*3*/] = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vVar7, uVar10, 1f, -1f, 0f) };
	vVar0[1 /*3*/] = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vVar7, uVar10, -1f, -1f, 0f) };
	iVar11 = 0;
	while (iVar11 < 2)
	{
		if (iVar11 == 0)
		{
			uLocal_1047[iVar11] = PED::CREATE_PED(26, iLocal_1327, vVar0[0 /*3*/], vVar0[0 /*3*/].f_1, 38.3253f, uLocal_1239[iLocal_1202], 1, 1);
		}
		else
		{
			uLocal_1047[iVar11] = PED::CREATE_PED(26, iLocal_1328, vVar0[1 /*3*/], vVar0[1 /*3*/].f_1, 38.3253f, uLocal_1239[iLocal_1202], 1, 1);
		}
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_1047[iVar11], 1, 1);
		PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uLocal_1047[iVar11]);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_1047[iVar11], 3, 0);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_1047[iVar11], 23, 1);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_1047[iVar11], 30, 0);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_1047[iVar11], 13, 1);
		PED::SET_PED_TARGET_LOSS_RESPONSE(uLocal_1047[iVar11], 2);
		PED::SET_PED_KEEP_TASK(uLocal_1047[iVar11], 1);
		func_266(uLocal_1047[iVar11], 1);
		PED::SET_PED_TO_LOAD_COVER(uLocal_1047[iVar11], 1);
		iVar11++;
	}
}
...
void func_266(int iParam0, bool bParam1)
{
	...
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(iParam0, uLocal_1332);
}
...
void func_267()
{
	...
	iLocal_1046 = PED::CREATE_PED(26, iLocal_1325, vLocal_1258[iLocal_1202 /*3*/], uLocal_1239[iLocal_1202], 1, 1);
...
void func_269()
{
	...
	while (iVar0 < 3)
	{
		if (!CAM::IS_SPHERE_VISIBLE(vLocal_1248[iVar0 /*3*/], 5f) && !func_273(iVar0, 6f))
		{
	...
	if (iLocal_1195 == 0)
	{
		...
		else
		{
			...
			while (iVar0 < 3)
			{
				if (func_271(vLocal_1248[iVar0 /*3*/], 1) > 30f && !func_273(iVar0, 6f))
				{
					vLocal_1258[iLocal_1195 /*3*/] = { vLocal_1248[iVar0 /*3*/] };
					uLocal_1239[iLocal_1195] = fLocal_1235[iVar0];
					iLocal_1195++;
...
float func_271(vector3 vParam0, int iParam3)
{
...
void func_278()
{
	switch (iLocal_1193)
	{
		...
		case 1:
			if (iLocal_1168)
			{
				if (((!func_281(&uLocal_1314) && !func_280(&(iLocal_1320[0]), &bLocal_1189)) && !func_280(&(iLocal_1320[1]), &bLocal_1189)) && !func_280(&(iLocal_1320[2]), &bLocal_1189))
				{
					SYSTEM::SETTIMERA(0);
					func_253();
					iLocal_1031 = 10;
...
void func_282()
{
	...
	while (iVar1 < 3)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_1050[iVar1]))
		{
			...
			uLocal_1050[iVar1] = PED::CREATE_PED(26, iVar0, vLocal_1268[iVar1 /*3*/], fLocal_1221[iVar1], 1, 1);
			if (iVar1 == 0)
			{
...
void func_300(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_362(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
...
void func_302(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
int func_309(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2535519[iParam0 /*3*/][func_310(iParam1)];
...
void func_316(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_318(Var11.f_1)) && iVar72 < 50)
			{
...
void func_322(var uParam0)
{
	...
	if (func_15(iVar0) && !PED::IS_PED_INJURED(uParam0))
	{
...
int func_324(vector3 vParam0, char* sParam3, vector3 vParam4)
{
	int iVar0;
	int iVar1;
...
int func_332(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_336(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	vVar18 = { Var12 - Var0 };
	vVar18 = { func_337(vVar18, -Var0.f_3.f_2) };
	vVar18 = { func_337(vVar18, vVar6.f_3.f_2) };
	*uParam2 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vVar6, 0f, vVar18) };
	uParam2->f_3 = { Var12.f_3 };
	return 1;
}

Vector3 func_337(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_355(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_371()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uVar0))
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(uVar0, -1214.517f, -158.91f, -39.165f, -1243.589f, -238.784f, 39.165f, 15f, 0, 0, 0) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uVar0, 0))
			{
				if (ENTITY::GET_ENTITY_SPEED(uVar0) <= 0.5f)
				{
...
void func_372()
{
	...
	{
		case 0:
			if (func_403(1084227584, 1) || (bLocal_1151 && STREAMING::_0x7D41E9D2D17C5B2D(uLocal_1130)))
			{
				func_402(-1248.398f, -183.366f, 37.72881f, -1216.437f, -196.8727f, 44.07541f, 59.25f, vLocal_1665, fLocal_1668, 1, 1, 1, 0, 0);
						...
						while (iLocal_1192 < 3)
						{
							if (!ENTITY::IS_ENTITY_DEAD(uLocal_1050[iLocal_1192], 0))
							{
								...
								if (AI::GET_SCRIPT_TASK_STATUS(uLocal_1050[iLocal_1192], 242628503) != 1)
								{
									...
									AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_1248[iLocal_1192 /*3*/], 1f, 20000, 1048576000, 0, 1193033728);
									AI::CLOSE_SEQUENCE_TASK(uLocal_1324);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_392(iVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_392(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = { func_394(vParam1 - vParam4) };
		vVar3 = { vVar0 };
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_393(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_393(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_393(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_393(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_393(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_393(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_393(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_393(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_393(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_393(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_393(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_393(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_393(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_393(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_393(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_393(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return 1;
		}
	}
...
void func_397()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_1315))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_1315, 0))
		{
			VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_1315, 0, 1, 0);
			ENTITY::SET_ENTITY_COORDS(uLocal_1315, -1251.873f, -256.7999f, 38.2695f, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(uLocal_1315, 296.7603f);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_1315, 1084227584);
		}
	}
}
...
{
	func_390(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}
...
int func_403(int iParam0, int iParam1)
{
	...
	if (((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_404(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam0, 1, 1056964608, 0, 1, 0)) && !ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_404(var uParam0, var uParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
		...
		case 1:
			...
			if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			{
				if (!func_416())
				{
					...
					{
						uLocal_1119 = func_415(vLocal_1302, 1);
				...
				else if (STREAMING::_0x7D41E9D2D17C5B2D(uLocal_1130) && func_412())
				{
					func_411();
					func_253();
					iLocal_1031 = 8;
...
void func_407()
{
	if (!iLocal_1132)
	{
		if (func_271(vLocal_1302, 1) <= 100f)
		{
			func_409();
	...
	else if (func_271(vLocal_1302, 1) > 120f)
	{
...
var func_415(vector3 vParam0, int iParam3)
{
	var uVar0;
...
int func_417()
{
	...
	{
		uLocal_1315 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
		iVar0 = ENTITY::GET_ENTITY_MODEL(uLocal_1315);
...
void func_418()
{
	...
	switch (iLocal_1205)
	{
		...
		case 1:
			Local_1691[0] = PED::CREATE_PED(4, joaat("a_f_m_bevhills_01"), -1220.679f, -203.2689f, 38.3251f, 321.2841f, 1, 1);
			Local_1691[1] = PED::CREATE_PED(4, joaat("a_f_m_bevhills_02"), -1219.596f, -201.3663f, 38.3251f, 110.7199f, 1, 1);
			...
			Local_1691.f_3 = PED::CREATE_PED_INSIDE_VEHICLE(Local_1691.f_4, 4, joaat("a_m_y_hipster_01"), -1, 1, 1);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1691.f_3, 1);
			AI::TASK_LOOK_AT_ENTITY(Local_1691.f_3, Local_1691[0], -1, 0, 2);
			Local_1691.f_8[0] = PED::CREATE_PED(4, joaat("a_m_m_bevhills_01"), -1211.597f, -184.5331f, 38.3255f, 4.5193f, 1, 1);
			Local_1691.f_8[1] = PED::CREATE_PED(4, joaat("a_m_y_hipster_01"), -1211.654f, -182.7625f, 38.3255f, 166.2532f, 1, 1);
			...
			Local_1691.f_5[0] = PED::CREATE_PED(4, joaat("a_m_m_bevhills_01"), -1229.099f, -176.3197f, 38.3255f, 231.8036f, 1, 1);
			Local_1691.f_5[1] = PED::CREATE_PED(4, joaat("a_f_m_bevhills_02"), -1249.779f, -162.4767f, 39.4131f, 220.1651f, 1, 1);
...
void func_421()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_1058))
	{
		func_426();
		if (!PED::IS_PED_INJURED(uLocal_1058))
		{
			fVar1 = func_23(uLocal_1058, 1);
			PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(uLocal_1058, 0);
			PED::SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(uLocal_1058, 0);
			PED::SET_PED_CAN_BE_TARGETTED(uLocal_1058, 0);
			PED::_SET_PED_RAGDOLL_BLOCKING_FLAGS(uLocal_1058, 16);
			PED::SET_PED_CONFIG_FLAG(uLocal_1058, 208, 1);
			if (fVar1 < 5f)
			{
			...
			{
				if (ENTITY::IS_ENTITY_OCCLUDED(uLocal_1058) || !ENTITY::IS_ENTITY_ON_SCREEN(uLocal_1058))
				{
					func_422();
				}
			}
			switch (iLocal_1191)
			{
				case 0:
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
					{
						if ((PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()) || (ENTITY::DOES_ENTITY_EXIST(uLocal_1058) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_1058, PLAYER::PLAYER_PED_ID(), 1))) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_1690, PLAYER::PLAYER_PED_ID(), 1))
						{
							if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_1690, PLAYER::PLAYER_PED_ID(), 1))
							{
							}
							PED::SET_PED_MOVEMENT_CLIPSET(uLocal_1058, "move_lester_CaneUp", 1048576000);
							AI::TASK_PLAY_ANIM(uLocal_1058, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 1000f, -4f, -1, 790536, 0, 0, 0, 0);
							iLocal_1191 = 1;
						}
					}
					break;
				...
				case 1:
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_1058, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 3))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_1058, "oddjobs@assassinate@hotel@leadin", "Lester_Getup") >= 0.376f)
						{
							AI::OPEN_SEQUENCE_TASK(&uVar0);
							...
							AI::TASK_WANDER_STANDARD(0, ENTITY::GET_ENTITY_HEADING(uLocal_1058), 0);
							AI::CLOSE_SEQUENCE_TASK(uVar0);
							AI::TASK_PERFORM_SEQUENCE(uLocal_1058, uVar0);
							AI::CLEAR_SEQUENCE_TASK(&uVar0);
							PED::FORCE_PED_MOTION_STATE(uLocal_1058, -668482597, 0, 0, 0);
							iLocal_1191 = 2;
						}
					}
					break;
...
void func_426()
{
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_1058))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_1058, PLAYER::PLAYER_PED_ID(), 1))
		{
			func_31(9);
		}
	}
...
void func_438()
{
	...
	PED::ADD_RELATIONSHIP_GROUP("Guards", &uLocal_1332);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, uLocal_1332);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_1332, -1533126372);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_1332, 1862763509);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_1332);
	...
	uLocal_1128 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar0 - Vector(15f, 15f, 15f), vVar0 + Vector(15f, 15f, 15f), 0, 1, 1, 1);
	uLocal_1129 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar3 - Vector(45f, 35f, 35f), vVar3 + Vector(45f, 35f, 35f), 0, 1, 1, 1);
}
	...
	switch (iLocal_1193)
	{
		...
		case 1:
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				{
					uLocal_1673 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_1675, vLocal_1678, 42.2032f, 1, 2);
					CAM::SHAKE_CAM(uLocal_1673, "HAND_SHAKE", 0.3f);
				}
				if (!CAM::DOES_CAM_EXIST(uLocal_1674))
				{
					uLocal_1674 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_1681, vLocal_1684, 42.2032f, 0, 2);
		...
		case 4:
			...
			CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_1058, "Lester", 2, joaat("ig_lestercrest"), 0);
		...
		case 6:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_1058))
			{
				if (CUTSCENE::DOES_CUTSCENE_ENTITY_EXIST("Lester", 0))
				{
					...
					{
						uLocal_1058 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Lester", 0));
					}
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_1059))
			{
				if (CUTSCENE::DOES_CUTSCENE_ENTITY_EXIST("WalkingStick_Lester", 0))
				{
					...
					{
						uLocal_1059 = CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("WalkingStick_Lester", 0);
					}
				}
			}
			CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
			...
			if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Lester", 0)))
			{
				...
				{
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_1058) && !PED::IS_PED_INJURED(uLocal_1058))
					{
						ENTITY::SET_ENTITY_COORDS(uLocal_1058, -1509.458f, -948.195f, 7.75f, 1, 0, 0, 1);
						ENTITY::SET_ENTITY_HEADING(uLocal_1058, -11f);
						AI::TASK_PLAY_ANIM(uLocal_1058, "oddjobs@assassinate@hotel@leadin", "lester_leadin", 1000f, -8f, -1, 790537, 0f, 0, 1, 0);
						PED::_0x2208438012482A1A(uLocal_1058, 0, 0);
					}
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Lester", 0)))
			{
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("WalkingStick_Lester", 0))
				{
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_1058) && !PED::IS_PED_INJURED(uLocal_1058))
					{
						ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_1059, uLocal_1058, PED::GET_PED_BONE_INDEX(uLocal_1058, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					}
				}
			}
			if (CUTSCENE::HAS_CUTSCENE_FINISHED() && !CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				...
				if (!PED::IS_PED_INJURED(uLocal_1058))
				{
					ENTITY::SET_ENTITY_PROOFS(uLocal_1058, 0, 0, 0, 0, 0, 0, 0, 0);
					PED::SET_PED_CAN_RAGDOLL(uLocal_1058, 1);
				}
				CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
				CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
				if (CAM::IS_SCREEN_FADED_OUT())
...
void func_443()
{
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_1690))
	{
		uLocal_1690 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1510.103f, -947.7194f, 8.2332f, 5f, -403891623, 1, 0, 1);
	}
}
	...
	if (Local_1691.f_11)
	{
		if (!bLocal_1169)
		{
			if (iLocal_1031 < 10)
			{
				...
				{
					uVar0 = func_30(1116471296, 1);
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(uVar0, 0))
					{
...
void func_449(var uParam0, bool bParam1)
{
	...
	if (!PED::IS_PED_INJURED(uParam0))
	{
		if ((bParam1 && AI::GET_SCRIPT_TASK_STATUS(uParam0, 242628503) != 1) || !bParam1)
		{
			AI::OPEN_SEQUENCE_TASK(&uVar0);
...
{
	return func_457(&(Global_99633.f_2875), vParam0, fParam3, 0);
}

int func_457(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
...
int func_483(var uParam0, vector3 vParam1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_485(uParam0, Global_70024.f_139[38], 0))
			{
				func_477(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_485(uParam0, Global_70024.f_139[43], 1))
			{
				func_477(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_485(uParam0, uVar1[iVar6], 1) && func_484(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_44(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
int func_484(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_485(var uParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_489(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_493(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_492(*uParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_492(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_491(uParam0);
	if (func_490(*uParam0))
	{
...
void func_504(vector3 vParam0, float fParam3, int iParam4)
{
	int iVar0;
...
void func_519()
{
	...
	while (iVar0 < 3)
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (func_271(vLocal_1248[iVar0 /*3*/], 1) < 5f)
			{
