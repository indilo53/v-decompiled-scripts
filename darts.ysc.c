...
void __EntryFunction__()
{
	...
	func_460(1);
	uLocal_325 = func_457(func_493(uLocal_295[0]), 1);
	...
	while (true)
	{
		...
		if ((PED::IS_PED_INJURED(ScriptParam_0.f_5) && !ENTITY::DOES_ENTITY_EXIST(func_491())) || (ENTITY::DOES_ENTITY_EXIST(func_491()) && PED::IS_PED_INJURED(func_491())))
		{
			func_462(&Var0, &Var508, &Var1191);
		}
		if (!PED::IS_PED_INJURED(uLocal_295[0]))
		{
			...
			switch (Var0)
			{
				...
				case 3:
					...
					{
						func_439(&(Var0.f_243), &Var465, &vVar471, 0);
				...
				case 4:
					if (!CAM::_0x705A276EBFF3133D())
					{
						...
						func_431(&(Var0.f_257), 0, PLAYER::PLAYER_PED_ID(), sLocal_390, 0, 1);
						if (ENTITY::IS_ENTITY_DEAD(func_491(), 0))
						{
							if (iLocal_334 == 2)
							{
				...
				case 5:
					if ((((!PED::IS_PED_INJURED(uLocal_295[1]) && PED::IS_PED_ON_FOOT(uLocal_295[0])) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_295[0], 1)) && PED::IS_PED_ON_FOOT(uLocal_295[1])) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_295[1], 1))
					{
						...
						if ((func_425() && GAMEPLAY::GET_GAME_TIMER() >= iLocal_323 + 1000) && iVar1774 != 9)
						{
						...
						case 1:
							if (GAMEPLAY::IS_PC_VERSION())
							{
								if (fLocal_134 != GRAPHICS::_GET_ASPECT_RATIO(0))
								{
									...
									CAM::SET_CAM_FOV(uLocal_120, func_399(fLocal_134));
									CAM::SET_CAM_FOV(uLocal_121, func_399(fLocal_134));
								}
							}
				...
				case 9:
					if (func_328(&Var0, &Var477, &Var508))
					{
						...
						if (func_327(Global_106070.f_18942.f_5, &uLocal_326))
						{
				...
				case 10:
					...
					func_241(&Var0, &vVar471, &Var477, &Var508, &uVar1794);
					break;
...
void func_117(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	if (!func_119(uParam0->f_1, 256) || (func_119(uParam0->f_1, 8192) && CONTROLS::_0x6CD79468A1E595C6(2)))
	{
		...
		if (GAMEPLAY::IS_PC_VERSION())
		{
			...
			GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(func_119(uParam0->f_1, 4096));
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		}
		iVar5 = 0;
		iVar6 = 0;
			...
			if (!func_148(uParam1))
			{
				...
				if (Global_1835392.f_2825 == -1)
				{
					...
					while (iVar0 < 3)
					{
						...
						func_147(*uParam0, iVar6, iVar31, &cVar51);
						iVar6++;
						iVar0++;
					}
					Global_1835392.f_2825 = 1;
				...
				else if (func_145(&(Global_1835392.f_2823), 300, 0))
				{
					...
					while (iVar0 < 3)
					{
						...
						iVar31 = 0;
						GAMEPLAY::SET_BIT(&iVar31, 7);
						func_147(*uParam0, iVar6, iVar31, &cVar57);
						iVar6++;
						iVar0++;
					}
...
void func_131(struct<30> Param0, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, int iParam43, int iParam44, bool bParam45, bool bParam46)
{
	...
	switch (Param0.f_29[iParam43])
	{
		...
		case 8:
			...
			{
				GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(func_133(func_136(iParam44), 0));
				GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
			}
			else
			{
		...
		case 16:
			if (bParam45)
			{
				...
				if (!GAMEPLAY::_0xD3D15555431AB793())
				{
					...
					{
						iParam44 = SYSTEM::FLOOR(func_130(SYSTEM::TO_FLOAT(iParam44)));
					}
					else
					{
						iParam44 = SYSTEM::FLOOR(func_129(SYSTEM::TO_FLOAT(iParam44)));
					}
				}
				GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("NUMBER");
				UI::ADD_TEXT_COMPONENT_INTEGER(iParam44);
...
void func_137(var uParam0, int iParam1, int iParam2, int iParam3, char[4] cParam4, var uParam5)
{
...
void func_147(var uParam0, int iParam1, int iParam2, char[4] cParam3)
{
...
int func_163(var uParam0, var uParam1, char* sParam2, var uParam3, var uParam4)
{
	int iVar0;
	struct<13> Var1[1];
	...
	switch ((*uParam0)[1])
	{
		case 0:
			...
			if (iVar107 > 0)
			{
				...
				if (func_178(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44), &(uParam0->f_113), uParam0->f_113[0 /*66*/], iVar112, 0, 100))
				{
					func_174(&Var98, &(uParam0->f_44));
					if (uParam0->f_5 && STATS::_0xA0F93D5465B3094D(&Var98))
					{
...
void func_186(var uParam0, var uParam1, char[4] cParam2, var uParam3, bool bParam4, int iParam5)
{
...
var func_222(struct<8> Param0, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	char cVar0[64];
			...
			if (iLocal_30 == 0)
			{
				...
				if (((((!func_298("DARTS_SHT_USE") && !func_298("DARTS_INSTR_W")) && !func_298("DARTS_INSTR_B")) && !func_298("DARTS_AIM_HLP")) && !func_298("DARTS_STD_HLP")) && !func_298("DARTS_FST_HLP"))
				{
					if (func_3(&(uParam3->f_666), 24))
					{
						...
						GAMEPLAY::SET_BIT(&(Global_106070.f_18942.f_6), uLocal_326);
...
void func_248(char* sParam0, var uParam1, int iParam2, int iParam3)
{
	iParam3 = iParam3;
	UI::BEGIN_TEXT_COMMAND_PRINT(sParam0);
	UI::ADD_TEXT_COMPONENT_INTEGER(uParam1);
...
void func_251(char* sParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
	iParam4 = iParam4;
	UI::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
Vector3 func_303(int iParam0)
{
	...
	{
		uVar0 = func_306(iParam0);
		vVar1.y = -0.5f;
		vVar1.x = func_305(uVar0);
		vVar1.z = func_304(uVar0);
	}
	return vVar1;
}
	...
	switch (*uParam0)
	{
		...
		case 1:
			if (CONTROLS::IS_CONTROL_PRESSED(2, 228))
			{
				...
				{
					func_312();
					func_311(&uLocal_335, vLocal_366, vLocal_369, 30f, 10, 10, 3, 15f, 0, 0, -1f, 1);
					*uParam0 = 2;
				}
			}
			else
...
void func_311(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7, int iParam8, int iParam9, int iParam10, float fParam11, int iParam12, int iParam13, float fParam14, bool bParam15)
{
	uParam0->f_1 = { vParam1 };
	uParam0->f_4 = { vParam4 };
	uParam0->f_7 = fParam7;
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_17367.f_5726)
		{
			...
			if (GAMEPLAY::GET_HASH_KEY(&(Global_17367.f_4690)) != 0 && Global_17367.f_4764 != -1)
			{
				...
				{
					func_18(Global_17367.f_4766, 1, 1, &fVar36, &fVar37, bParam7);
					func_355(Global_17367.f_4766, 1, &uVar47, &uVar48, &uVar49, &uVar50);
					GRAPHICS::DRAW_SPRITE(func_24(Global_17367.f_4766), func_21(Global_17367.f_4766, 1), ((Global_17364 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
				}
			...
			if (GAMEPLAY::GET_HASH_KEY(&(Global_4266986.f_21)) != 0 && Global_4266986.f_65 != -1)
			{
				...
				{
					func_18(Global_4266986.f_67, 1, 1, &fVar36, &fVar37, bParam7);
					func_355(Global_4266986.f_67, 1, &uVar47, &uVar48, &uVar49, &uVar50);
					GRAPHICS::DRAW_SPRITE(func_24(Global_4266986.f_67), func_21(Global_4266986.f_67, 1), ((Global_17364 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
				}
				fVar51 = (fVar51 + (((UI::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
			...
			func_350(uVar61, iParam1, iParam8, 0, 0, 0, bParam4, 1, 0);
			GRAPHICS::SET_SCRIPT_GFX_ALIGN(76, 84);
			GRAPHICS::_SCREEN_DRAW_POSITION_RATIO(-0.05f, -0.05f, 0f, 0f);
		}
		if (iVar5 == 1 || !Global_17367.f_5726)
									...
									if (iVar5 == 1 && bVar33)
									{
										...
										if (bVar54)
										{
											if (func_18(26, 1, 0, &fVar36, &fVar37, bParam7))
											{
												...
												{
													func_355(26, 1, &uVar47, &uVar48, &uVar49, &uVar50);
													GRAPHICS::DRAW_SPRITE(func_24(26), func_21(26, 1), ((fVar34 + fVar42) + fVar45), ((fVar35 - 0.00277776f) + (fVar57 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
												}
											}
											if (func_18(27, 1, 0, &fVar36, &fVar37, bParam7))
											{
												...
												{
													func_355(27, 1, &uVar47, &uVar48, &uVar49, &uVar50);
													GRAPHICS::DRAW_SPRITE(func_24(27), func_21(27, 1), (((fVar34 + fVar42) + fVar45) + (fVar43 + fVar44)), ((fVar35 - 0.00277776f) + (fVar57 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
												}
											}
										}
										iVar25 = 0;
											...
											else if (Global_17367.f_2124[iVar24 /*5*/][iVar14] == 4)
											{
												if (Global_17367.f_4433[(iVar22 + iVar28)] == 2 || Global_17367.f_4433[(iVar22 + iVar28)] == 48)
												{
													if (func_18(Global_17367.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
													{
														...
														{
															func_355(Global_17367.f_4433[(iVar22 + iVar28)], bVar32, &uVar47, &uVar48, &uVar49, &uVar50);
															if (Global_17367.f_5081[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_24(Global_17367.f_4433[(iVar22 + iVar28)]), func_21(Global_17367.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar42) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar57 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_24(Global_17367.f_4433[(iVar22 + iVar28)]), func_21(Global_17367.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar42) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar57 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
											...
											while (iVar14 < iVar28)
											{
												if (Global_17367.f_4433[(iVar22 + iVar14)] != 2 && Global_17367.f_4433[(iVar22 + iVar14)] != 48)
												{
													if (func_18(Global_17367.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
													{
														...
														{
															func_355(Global_17367.f_4433[(iVar22 + iVar14)], bVar32, &uVar47, &uVar48, &uVar49, &uVar50);
															if (Global_17367.f_4433[(iVar22 + iVar14)] == 30)
															{
																GRAPHICS::DRAW_SPRITE(func_24(Global_17367.f_4433[(iVar22 + iVar14)]), func_21(Global_17367.f_4433[(iVar22 + iVar14)], bVar32), (Global_17364 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
															else if (Global_17367.f_5081[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_24(Global_17367.f_4433[(iVar22 + iVar14)]), func_21(Global_17367.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar42) + fVar43) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar57 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_24(Global_17367.f_4433[(iVar22 + iVar14)]), func_21(Global_17367.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar42) + fVar43) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar57 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
														}
								...
								case 4:
									if (iVar5 == 1 && bVar33)
									{
										if (func_18(Global_17367.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
										{
											...
											{
												func_355(Global_17367.f_4433[iVar22], bVar32, &uVar47, &uVar48, &uVar49, &uVar50);
												GRAPHICS::DRAW_SPRITE(func_24(Global_17367.f_4433[iVar22]), func_21(Global_17367.f_4433[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar57 * 0.5f)), (fVar36 * func_343(Global_17367.f_4433[iVar22])), (fVar37 * func_343(Global_17367.f_4433[iVar22])), 0f, uVar47, uVar48, uVar49, uVar50, 0);
											}
										}
									}
									bVar41 = true;
...
void func_345(float fParam0, float fParam1, char* sParam2, var uParam3, int iParam4)
{
	UI::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
void func_350(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_355(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
...
float func_358(char* sParam0, var uParam1, var uParam2)
{
...
var func_373(char* sParam0, int iParam1)
{
...
float func_374(char* sParam0, var uParam1)
{
	if (!UI::DOES_TEXT_LABEL_EXIST(sParam0))
	{
		return 0f;
...
int func_402(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	...
	if ((func_425() && GAMEPLAY::GET_GAME_TIMER() >= iLocal_323 + 1000) && *iParam0 != 8)
	{
		if (!CAM::IS_SCREEN_FADED_OUT() && !CAM::IS_SCREEN_FADING_OUT())
		{
			CAM::DO_SCREEN_FADE_OUT(500);
	...
	switch (*iParam0)
	{
		...
		case 5:
			if (!CAM::IS_CAM_INTERPOLATING(uLocal_128) && !func_298("DARTS_DBL_WIN"))
			{
...
void func_404(vector3 vParam0, var uParam3, vector3 vParam4, vector3 vParam7, int iParam10)
{
...
void func_406(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	var uVar0;
	
	uVar0 = func_407(iParam5);
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(*uParam0, "RESET_MOVIE");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(*uParam0, uVar0);
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
...
void func_410(vector3 vParam0, var uParam3, vector3 vParam4, vector3 vParam7, int iParam10, bool bParam11)
{
...
void func_431(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_448(var uParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
	int iVar1;
	...
	if (!func_449(vParam2) && fParam5 != 0f)
	{
...
void func_453(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void func_471(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0) && !PED::IS_PED_INJURED(*uParam0))
	{
		...
		if (bLocal_310)
		{
			if (!GAMEPLAY::IS_BIT_SET(Global_106031, 10))
			{
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_472(iLocal_334 == 2, vLocal_375, vLocal_381), 1f, 20000, 0.25f, 0, func_118(iLocal_334 == 2, fLocal_385, fLocal_387));
			}
			else
			{
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_472(iLocal_334 == 2, vLocal_372, vLocal_378), 1f, 20000, 0.25f, 0, func_118(iLocal_334 == 2, fLocal_384, fLocal_386));
			}
			AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
		}
		else
		{
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_472(iLocal_334 == 2, vLocal_372, vLocal_378), 1f, 20000, 0.25f, 0, func_118(iLocal_334 == 2, 172.6813f, 142.6717f));
...
Vector3 func_472(bool bParam0, vector3 vParam1, vector3 vParam4)
{
	if (bParam0)
	{
		return vParam1;
...
void func_483(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_485(Global_106070.f_18505[iVar0], &vVar2, &fVar5))
			{
