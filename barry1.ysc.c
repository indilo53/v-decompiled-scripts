...
int func_13(int iParam0)
{
	...
	switch (iLocal_161)
	{
		...
		case 1:
			...
			CAM::ATTACH_CAM_TO_ENTITY(uVar5, PLAYER::PLAYER_PED_ID(), -vVar0, 1);
		...
		case 2:
			...
			if (iParam0 == 1)
			{
				if (func_34(&uLocal_390, "BARY1AU", "BARY1_PREOUT", 8, 0, 0, 0) || GAMEPLAY::GET_GAME_TIMER() > iLocal_158)
				{
		...
		case 5:
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_158)
			{
				if (iParam0 == 1)
				{
					...
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_174, 200f, 0, 0, 0, 0, 0, 0);
...
int func_15(int iParam0, int iParam1)
{
	...
	ENTITY::ATTACH_ENTITY_TO_ENTITY(uVar0, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), iVar1), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	return uVar0;
}
...
void func_62()
{
	...
	while (iVar0 < Local_586)
	{
		if (func_4(&(Local_586[iVar0 /*33*/])))
		{
			...
			AI::TASK_SMART_FLEE_COORD(Local_586[iVar0 /*33*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 400f, -1, 0, 0);
		}
		iVar0++;
	}
}
...
void func_64(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			AI::TASK_PLAY_ANIM(0, sLocal_338, sLocal_348, 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
...
int func_65()
{
	...
	{
		case 0:
			uLocal_930 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", vLocal_967, vLocal_970, 50f, 0, 2);
		...
		case 3:
			if (GAMEPLAY::GET_GAME_TIMER() > iLocal_966)
			{
				...
				if (CAM::_0xEE778F8C7E1142E2(0) != 4)
				{
					...
					{
						CAM::SET_CAM_ROT(uLocal_930, vLocal_970, 2);
...
int func_69(var uParam0, float fParam1)
{
	...
	if (!uParam0->f_15)
	{
		if (CAM::DOES_CAM_EXIST(uParam0->f_11))
		{
			...
			{
				fVar2 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uVar11, 1), CAM::GET_CAM_COORD(uParam0->f_11), 1);
			}
			else
			{
				fVar2 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uVar11, 0), CAM::GET_CAM_COORD(uParam0->f_11), 1);
			}
			fVar2 = func_72(fVar2, 50f, 4000f);
			iVar1 = SYSTEM::ROUND((((fVar2 / ((4000f - 50f) / (2000f - 1000f))) + 400f) * fParam1));
			if (PED::IS_PED_IN_ANY_VEHICLE(uVar11, 0))
			{
				uVar10 = PED::GET_VEHICLE_PED_IS_USING(uVar11);
				bVar9 = true;
			}
			...
			if (bVar9)
			{
				vVar6 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(uVar10, CAM::_GET_GAMEPLAY_CAM_COORDS()) };
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], uVar10, vVar6, 1);
			}
			else
			{
				vVar6 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(uVar11, CAM::_GET_GAMEPLAY_CAM_COORDS()) };
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], uVar11, vVar6, 1);
			}
			...
			{
				vVar6 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(uVar10, CAM::_GET_GAMEPLAY_CAM_COORDS()) };
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], uVar10, vVar6 + Vector(15f, 0f, 0f), 1);
			}
			else
			{
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], uVar11, 0f, 0f, 5f, 0);
			}
			...
			if (bVar9)
			{
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], uVar10, 0f, 0f, 75f, 0);
			}
			else
			{
				CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], uVar11, 0f, 0f, 75f, 0);
			}
			CAM::SET_CAM_ROT((*uParam0)[uParam0->f_24], -87.5f, 0f, vVar3.z, 2);
			CAM::SET_CAM_FOV((*uParam0)[uParam0->f_24], CAM::_0x80EC114669DAEFF4());
			CAM::_0x0FB82563989CF4FB(uParam0->f_9, (*uParam0)[uParam0->f_24], 400, 1);
		...
		if (CAM::DOES_CAM_EXIST(uParam0->f_9))
		{
			...
			if (!Global_17272.f_111)
			{
				...
				if (Global_17272.f_109 == -1)
				{
					...
					Global_17272.f_110 = GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME());
				}
	...
	if (uParam0->f_17)
	{
		...
		uParam0->f_24 = 0;
		uParam0->f_27 = 0;
		if (Global_17272.f_109 != -1 && Global_17272.f_110 == GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()))
		{
	...
	switch (*iParam0)
	{
		...
		case 1:
			if (func_327(1, 1093140480, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2"))
			{
				...
				func_326();
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_174, 250f, 0, 0, 0, 0, 0, 0);
				GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_174, 50f, 0);
				GAMEPLAY::CLEAR_AREA_OF_OBJECTS(vLocal_174, 30f, 0);
				GRAPHICS::REMOVE_DECALS_IN_RANGE(vLocal_174, 500f);
...
int func_104(var uParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(uParam0, func_147(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(uParam0, func_147(iParam1), Global_71402[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_147(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, 0);
		}
	}
...
int func_107(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_147(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_147(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_147(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_138(iVar0);
						if (Global_71400 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_147(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_147(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_147(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
int func_219(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_147(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_147(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_277()
{
	...
	{
		GAMEPLAY::CLEAR_AREA(vLocal_925, 3f, 1, 0, 0, 0);
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_305(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_347(var uParam0, bool bParam1)
{
	...
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar0, vLocal_170, 1) > fLocal_173)
	{
		return 0;
	}
...
{
	return GAMEPLAY::IS_POSITION_OCCUPIED(vParam0, fParam3, 0, 0, 1, 0, 0, iParam4, iParam5);
}
...
Vector3 func_350(vector3 vParam0, float fParam3, float fParam4)
{
	...
	fVar3 = (fParam4 / 2f);
	vVar0 = { func_351(vVar0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam3)) };
...
int func_353(var uParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	uParam0->f_2 = PED::CREATE_PED(26, iLocal_357, vParam1, 0, 1, 1);
...
void func_355(var uParam0)
{
	...
	uVar0 = func_356(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
...
void func_362(int iParam0)
{
	...
	*iParam0 = func_364(*iParam0);
	...
	WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), *iParam0, uVar0, 1, 1);
	...
	else
	{
		...
		WEAPON::ADD_AMMO_TO_PED(PLAYER::PLAYER_PED_ID(), *iParam0, uVar0);
	}
}
...
{
	uParam0->f_1 = (func_371(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
int func_422(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (func_426(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(uParam0, iVar2, func_426(iVar2, iVar8)))
			{
				if (func_425(func_426(iVar2, iVar8)))
				{
					uVar9 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_426(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_426(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(uParam0, iVar2, func_426(iVar2, iVar8)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_426(iVar2, iVar8));
...
void func_429(int iParam0)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar1 <= (8 - 1))
		{
			Global_106565.f_2357.f_539.f_1730[iVar1 /*4*/][iVar0] = UI::_0xA13E93403F26C812(iVar1);
			iVar1++;
		}
	}
}
...
void func_430(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_431(Var11.f_1)) && iVar72 < 51)
			{
...
void func_433(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 2:
			if (func_567(Local_96.f_28[0]))
			{
				if (!func_330() || GAMEPLAY::GET_GAME_TIMER() > iLocal_157)
				{
					*iParam0 = 4;
				}
			}
...
void func_443(var uParam0)
{
	...
	if (uParam0->f_26 == 0)
	{
		uParam0->f_26 = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(vVar5, vVar8, 511, uParam0->f_2, 7);
	}
	else
	{
		iVar1 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_26, &iVar0, &vVar11, &uVar14, &uVar17);
		if (iVar1 == 0)
		{
			uParam0->f_26 = 0;
		}
		else if (iVar1 == 2)
		{
			if (iVar0 > 0)
			{
				...
				uParam0->f_27 = { GAMEPLAY::_0x21C235BC64831E5A(vVar11, vVar5, vVar8, 0) };
				...
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(uParam0->f_27, vVar2, 1) <= 0.7f)
				{
					...
					if (GAMEPLAY::ABSF((uParam0->f_27.f_2 - vVar2.z)) < 1f)
					{
						...
						{
							GAMEPLAY::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vVar5, vVar8, 0, 1, joaat("weapon_pistol"), 0, 0, 1, -1082130432);
						}
						if (iLocal_851 == 1)
						{
...
void func_452(var uParam0, vector3 vParam1)
{
	...
	func_453(ENTITY::GET_ENTITY_COORDS(uParam0, 1), vParam1, &uVar0, &uVar1, 1);
	ENTITY::SET_ENTITY_ROTATION(uParam0, uVar0, 0f, uVar1, 2, 1);
}
...
void func_455(var uParam0)
{
	...
	if (uParam0->f_26 == 0)
	{
		...
		uParam0->f_26 = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(vVar3, vVar6, 511, PLAYER::PLAYER_PED_ID(), 7);
	...
	{
		iVar1 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_26, &iVar0, &vVar6, &uVar9, &uVar12);
		if (iVar1 == 2)
		{
			if (iVar0 == 0 && func_9())
			{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_457(iParam3), 0);
}
...
void func_458(var uParam0)
{
	...
	if (uParam0->f_18 > iLocal_565 || AI::GET_SCRIPT_TASK_STATUS(uParam0->f_2, 242628503) > 1)
	{
		...
		{
			AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_338, sLocal_345, 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
		}
	...
	if (GAMEPLAY::GET_GAME_TIMER() > uParam0->f_7)
	{
		AI::TASK_PLAY_ANIM(uParam0->f_2, sLocal_338, sLocal_347, 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
		func_60(&(uParam0->f_17));
		func_459();
	}
}
...
void func_464(var uParam0, var uParam1)
{
	...
	uVar0 = func_356(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(uParam1, 1), 1);
	ENTITY::SET_ENTITY_HEADING(uParam0, uVar0);
}
...
int func_465(var uParam0, var uParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_418(ENTITY::GET_ENTITY_COORDS(uParam1, 1) - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_418(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
				...
				if (iVar1 != 0 && iVar1 != 1993361168)
				{
					...
					if (iVar2 != 0 && iVar2 != joaat("weapon_unarmed"))
					{
						if (func_564(iVar2))
						{
							if (iVar7 == 0)
							{
								iVar72[iVar5] = WEAPON::GET_AMMO_IN_PED_WEAPON(uParam0, iVar2);
							}
							else
							{
				...
				if (iVar8 < 51)
				{
					if (DLC1::GET_DLC_WEAPON_DATA(iVar8, &Var9))
					{
						if (!DLC1::_IS_DLC_DATA_EMPTY(Var9) && !func_431(Var9.f_1))
						{
							if (iVar7 == 0)
							{
								iVar117[iVar8] = WEAPON::GET_AMMO_IN_PED_WEAPON(uParam0, Var9.f_1);
							}
							else
							{
								WEAPON::SET_PED_AMMO(uParam0, Var9.f_1, 0, 0);
								WEAPON::SET_AMMO_IN_CLIP(uParam0, Var9.f_1, 0);
							}
						}
						else
						{
		...
		while (iVar5 <= (44 - 1))
		{
			...
			if (iVar1 != 0 && iVar1 != 1993361168)
			{
						...
						while (iVar4 != 0)
						{
							if (GAMEPLAY::IS_BIT_SET((uParam1[iVar5 /*5*/])->f_2, iVar6))
							{
								if (!WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(uParam0, iVar3, iVar4))
								{
									...
									if (func_562(iVar4))
									{
										unk_0x9FE5633880ECD8ED(uParam0, iVar3, iVar4, (uParam1[iVar5 /*5*/])->f_4);
				...
				if (!bParam2)
				{
					if (iVar2 != 0 && iVar2 != joaat("weapon_unarmed"))
					{
						if (WEAPON::GET_AMMO_IN_PED_WEAPON(uParam0, iVar2) < iVar72[iVar5])
						{
							WEAPON::SET_PED_AMMO(uParam0, iVar2, iVar72[iVar5], 0);
						}
					}
				}
			}
		...
		while (iVar70 < uParam1->f_221)
		{
			...
			if ((iVar8 != -1 && iVar8 < 51) && !func_431(Var9.f_1))
			{
						...
						while (iVar6 < DLC1::GET_NUM_DLC_WEAPON_COMPONENTS(iVar8))
						{
							if (DLC1::GET_DLC_WEAPON_COMPONENT_DATA(iVar8, iVar6, &Var48))
							{
								if (!func_427(Var48.f_3))
								{
									...
									{
										if (!WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(uParam0, iVar3, Var48.f_3))
										{
											WEAPON::GIVE_WEAPON_COMPONENT_TO_PED(uParam0, iVar3, Var48.f_3);
											func_563(uParam0, iVar3, Var48.f_3);
											if (func_562(Var48.f_3))
											{
												unk_0x9FE5633880ECD8ED(uParam0, iVar3, Var48.f_3, uParam1->f_221[iVar70 /*5*/].f_4);
												func_561(uParam0, iVar3, Var48.f_3, uParam1->f_221[iVar70 /*5*/].f_4);
											}
										}
									}
									else if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(uParam0, iVar3, Var48.f_3))
									{
										WEAPON::REMOVE_WEAPON_COMPONENT_FROM_PED(uParam0, iVar3, Var48.f_3);
				...
				else if (bParam2)
				{
					if ((iVar2 != 0 && iVar2 != joaat("weapon_unarmed")) && iVar2 != joaat("object"))
					{
						...
						while (iVar6 < DLC1::GET_NUM_DLC_WEAPON_COMPONENTS(iVar8))
						{
							if (DLC1::GET_DLC_WEAPON_COMPONENT_DATA(iVar8, iVar6, &Var48))
							{
								if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(uParam0, iVar2, Var48.f_3))
								{
									WEAPON::REMOVE_WEAPON_COMPONENT_FROM_PED(uParam0, iVar2, Var48.f_3);
				...
				if (!bParam2)
				{
					...
					{
						if (WEAPON::GET_AMMO_IN_PED_WEAPON(uParam0, iVar3) < iVar117[iVar8])
						{
							WEAPON::SET_PED_AMMO(uParam0, iVar3, iVar117[iVar8], 0);
						}
					}
				}
			}
