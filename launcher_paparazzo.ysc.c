...
int func_195(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_126(PLAYER::PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && !func_145()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_190(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_217(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_219(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_226(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_219(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_219(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_218(vVar3, vVar0);
