	...
	while (true)
	{
		...
		if (func_172())
		{
			...
			if (iLocal_47 > 3)
			{
				if (fLocal_31 < 600f)
				{
					if (func_27(0) == 0 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_81) > 2000)
					{
...
void func_30(int iParam0)
{
	...
	switch (iLocal_53)
	{
		...
		case 3:
			...
			{
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_55, 4f, 0, 0, 0, 0, 0, 0);
		...
		case 4:
			...
			if (!bVar0 && !*iParam0)
			{
				...
				if (!iLocal_59)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_28, 0))
					{
						iVar1 = PED::GET_VEHICLE_PED_IS_USING(uLocal_28);
						if (iVar1 == iLocal_54)
						{
							iLocal_59 = 1;
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_54, 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					if (iVar2 == iLocal_54)
					{
						if (SYSTEM::VDIST2(vLocal_55, ENTITY::GET_ENTITY_COORDS(uLocal_28, 1)) < 100f)
						{
		...
		case 6:
			if (SCRIPT::HAS_SCRIPT_LOADED("Traffick_Ground"))
			{
				...
				if (iVar3 == 1)
				{
					...
					Var4.f_85 = 4;
					Var4.f_90 = 6;
					uLocal_30 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS("Traffick_Ground", &Var4, 97, 28000);
					func_80(16);
		...
		case 7:
			if (!SCRIPT::IS_THREAD_ACTIVE(uLocal_30))
			{
				iLocal_53 = 9;
...
void func_95(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_97(Var11.f_1)) && iVar72 < 51)
			{
	...
	switch (iLocal_47)
	{
		...
		case 3:
			...
			if (STREAMING::HAS_MODEL_LOADED(joaat("cuban800")))
			{
				...
				{
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_50, 8f, 0, 0, 0, 0, 0, 0);
		...
		case 4:
			...
			if (*iParam0)
			{
				PED::SET_PED_INTO_VEHICLE(uLocal_28, iLocal_48, -1);
			}
		...
		case 6:
			if (SCRIPT::HAS_SCRIPT_LOADED("Traffick_Air"))
			{
				...
				if (iVar3 == 1)
				{
					...
					uLocal_30 = SYSTEM::START_NEW_SCRIPT("Traffick_Air", 28000);
					func_80(15);
...
int func_172()
{
	...
	uLocal_28 = PLAYER::PLAYER_PED_ID();
