...
void func_1()
{
	switch (iLocal_153)
	{
		case 0:
			...
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_149, "rcmabigail", "loop_talk", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_149, "rcmabigail", "loop_look", 3))
				{
					AI::TASK_PLAY_ANIM(uLocal_149, "rcmabigail", "loop_2_cs", 8f, -8f, -1, 2, 0, 0, 0, 0);
		...
		case 1:
			func_293();
			if ((func_297(uLocal_149) && ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_149, "rcmabigail", "loop_2_cs", 3)) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_149, "rcmabigail", "loop_2_cs") > 0.99f)
			{
				iLocal_153++;
			}
			break;
		...
		case 2:
			...
			if (func_284(1, 1093140480, 0))
			{
				if (func_297(uLocal_149))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_149, "ABIGAIL", 0, 0, 0);
				}
				func_283();
		...
		case 4:
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				...
				if (func_297(uLocal_149) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Abigail", 0))
				{
					AI::CLEAR_PED_TASKS(uLocal_149);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_149, -1581.559f, 5198.014f, 3.0091f, 1f, 20000, 1048576000, 0, 1193033728);
				}
			}
			else
			{
		...
		case 5:
			...
			if (func_218(1000) || GAMEPLAY::GET_GAME_TIMER() > iLocal_152)
			{
...
void func_293()
{
	if (func_297(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (iLocal_154 == 0)
		{
			if (func_297(uLocal_149))
			{
				if (func_294(PLAYER::PLAYER_PED_ID(), uLocal_149, 1) < 4f || (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 2f && func_294(PLAYER::PLAYER_PED_ID(), uLocal_149, 1) < 6f))
				{
