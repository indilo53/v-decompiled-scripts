		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_85) && !ENTITY::IS_ENTITY_DEAD(uLocal_85, 0))
		{
			...
			switch (iLocal_95)
			{
						...
						if (bVar3)
						{
							...
							if (bVar3)
							{
								...
								if (func_77(uLocal_86))
								{
									...
									else if (!func_117(uLocal_94, 2048) || !UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_75(&iLocal_96);
				...
				case 6:
					...
					if (func_117(uLocal_94, 2097152))
					{
						if (!func_99(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_52))
						{
							func_110(10);
						}
					}
...
void func_4()
{
	...
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uLocal_129, 1, 1);
	}
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_127))
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uLocal_127, 1, 1);
	}
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_128))
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uLocal_128, 1, 1);
	}
	uLocal_130 = PED::ADD_SCENARIO_BLOCKING_AREA((vLocal_121.x - 3f), (vLocal_121.y - 3f), (vLocal_121.z - 3f), (vLocal_121.x + 3f), (vLocal_121.y + 3f), (vLocal_121.z + 3f), 0, 1, 1, 1);
	func_7();
	func_5();
}
...
void func_8(int iParam0, bool bParam1)
{
	...
	if (bParam1 != GAMEPLAY::IS_BIT_SET(Global_26140[iVar0 /*23*/].f_11, 13))
	{
		GAMEPLAY::SET_BIT(&(Global_26140[iVar0 /*23*/].f_11), 18);
	}
	if (bParam1)
	{
		GAMEPLAY::SET_BIT(&(Global_26140[iVar0 /*23*/].f_11), 13);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_26140[iVar0 /*23*/].f_11), 13);
	}
}
...
void func_19(int iParam0)
{
	...
	if (iVar1 < 3)
	{
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_20404.f_150[iVar1]), iVar0);
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_20404.f_150[iVar1]), iVar0);
	}
}
...
void func_60()
{
	...
	else if ((PED::IS_PED_INJURED(uLocal_129) || DECISIONEVENT::IS_SHOCKING_EVENT_IN_SPHERE(89, ENTITY::GET_ENTITY_COORDS(uLocal_129, 1), 40f)) || DECISIONEVENT::IS_SHOCKING_EVENT_IN_SPHERE(116, ENTITY::GET_ENTITY_COORDS(uLocal_129, 1), 40f))
	{
		func_78("TRI_DEATH", -1);
		iVar0 = iLocal_105;
		func_72(iLocal_105);
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_129))
	{
		if (!ENTITY::IS_ENTITY_DEAD(uLocal_129, 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uLocal_129, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) <= 144f)
			{
				if (AI::GET_SCRIPT_TASK_STATUS(uLocal_129, 150319005) != 1)
				{
					AI::TASK_LOOK_AT_ENTITY(uLocal_129, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				}
			}
			else if (AI::GET_SCRIPT_TASK_STATUS(uLocal_129, 150319005) == 1)
			{
				AI::TASK_CLEAR_LOOK_AT(uLocal_129);
			}
		}
	}
	if (bLocal_131)
...
void func_102()
{
	...
	if (bLocal_131)
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_125))
		{
			...
			uLocal_125 = OBJECT::CREATE_OBJECT(joaat("prop_tri_table_01"), vVar1, 1, 1, 0);
			ENTITY::SET_ENTITY_HEADING(uLocal_125, fVar0);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_126))
		{
			...
			uLocal_126 = OBJECT::CREATE_OBJECT(joaat("prop_chair_08"), vLocal_121, 1, 1, 0);
			ENTITY::SET_ENTITY_HEADING(uLocal_126, fVar0);
			ENTITY::FREEZE_ENTITY_POSITION(uLocal_126, 1);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_chair_08"));
		}
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_127))
		{
			vVar1.z = (vVar1.z + 0.54f);
			uLocal_127 = OBJECT::CREATE_OBJECT(joaat("p_cs_clipboard"), vVar1, 1, 1, 0);
			ENTITY::SET_ENTITY_ROTATION(uLocal_127, -90f, 0f, 90f, 2, 0);
			ROPE::ACTIVATE_PHYSICS(uLocal_127);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_129))
		{
			...
			uLocal_129 = PED::CREATE_PED(4, joaat("a_m_y_roadcyc_01"), vLocal_121, fVar0, 1, 1);
			PED::SET_PED_COMPONENT_VARIATION(uLocal_129, 0, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(uLocal_129, 4, 0, 3, 0);
			PED::SET_PED_COMPONENT_VARIATION(uLocal_129, 3, 0, 2, 0);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_128))
		{
			...
			uLocal_128 = OBJECT::CREATE_OBJECT(joaat("prop_pencil_01"), vVar4, 1, 1, 0);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_pencil_01"));
		}
		if (!PED::IS_PED_INJURED(uLocal_129))
		{
			if (AI::DOES_SCENARIO_EXIST_IN_AREA(vLocal_121, 3f, 1))
			{
				AI::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(uLocal_129, vLocal_121, 2f, 0);
			}
			else
			{
				switch (iLocal_135)
				...
				AI::TASK_START_SCENARIO_AT_POSITION(uLocal_129, "PROP_HUMAN_SEAT_CHAIR", vVar7, fVar10, -1, 0, 1);
			}
		}
		iVar18 = 0;
		while (iVar18 < iLocal_136)
		{
			...
			if (!func_103(vVar11))
			{
				iLocal_136[iVar18] = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(vVar11, vVar14, uVar17, 0, 7);
			}
			iVar18++;
		}
	}
...
void func_125()
{
	...
	if (fLocal_110 > (fLocal_102 * fLocal_102))
	{
		...
		{
			OBJECT::DELETE_OBJECT(&uLocal_124);
		}
	}
	func_126(1, -1);
	iVar0 = 0;
