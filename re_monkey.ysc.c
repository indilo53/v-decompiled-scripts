		...
		switch (iLocal_49)
		{
			...
			case 1:
				if (func_50())
				{
					...
					{
						if (CAM::_0x89215EC747DF244A(1106247680, 31086, 1061997773, 1060320051, 1048576000, 1090519040, 1051361018, 31086, 24818) == iLocal_50)
						{
...
int func_51()
{
	...
	else
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(1813637474))
		{
			...
			ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_64[0], iLocal_50, PED::GET_PED_BONE_INDEX(iLocal_50, 28422), 0f, -0.01f, -0.02f, vLocal_78, 1, 1, 0, 0, 2, 1);
...
int func_63(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_64(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_64(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
void func_66()
{
	...
	if (func_44(iLocal_50))
	{
		...
		if (iLocal_55 < 3)
		{
			if (GAMEPLAY::IS_BULLET_IN_AREA(vVar2, fVar8, 0) || GAMEPLAY::IS_PROJECTILE_IN_AREA(vVar2 - vVar9, vVar2 + vVar9, 0))
			{
				iLocal_55 = 3;
			}
		}
		switch (iLocal_55)
		{
			...
			case 1:
				...
				{
					AI::OPEN_SEQUENCE_TASK(&uLocal_82);
					AI::TASK_PLAY_ANIM(0, sLocal_74, sLocal_76, 8f, -8f, -1, 8192, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sLocal_74, sLocal_77, 8f, -2f, -1, 8193, 0, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uLocal_82);
					AI::TASK_PERFORM_SEQUENCE(iLocal_50, uLocal_82);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_82);
			...
			case 5:
				...
				if (!ENTITY::IS_ENTITY_ON_SCREEN(iLocal_50) && SYSTEM::VDIST2(vVar2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)) > 2500f)
				{
					uLocal_81 = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(vVar5, vVar2, 1, 0, 7);
					iLocal_55++;
				}
				break;
			...
			case 6:
				...
				iVar23 = WORLDPROBE::GET_SHAPE_TEST_RESULT(uLocal_81, &iVar15, &uVar16, &uVar19, &uVar22);
				if (iVar23 == 2)
				{
					if (iVar15 == 1)
					{
...
void func_73()
{
	if (iLocal_72 == 0)
	{
		iLocal_72 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY(sLocal_73, uLocal_64[0], vLocal_78, vLocal_78, 1065353216, 0, 0, 0);
...
int func_76(var uParam0, var uParam1, float fParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0) && ENTITY::DOES_ENTITY_EXIST(uParam1))
	{
		...
		return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uParam0, 0), ENTITY::GET_ENTITY_COORDS(uParam1, 0)) <= fVar0;
	}
	return 0;
}
...
int func_156()
{
	if ((Global_106554 == func_28() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
