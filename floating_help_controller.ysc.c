...
void func_1()
{
	...
	while (iVar0 < Global_105217)
	{
		...
		{
			iVar1 = iVar0;
			if (GAMEPLAY::GET_GAME_TIMER() > Global_105217[iVar0 /*28*/].f_21 && Global_105217[iVar0 /*28*/].f_21 != -1)
			{
				if (func_3(iVar0))
				{
			...
			else if (func_3(iVar0))
			{
				...
				{
					if (!GAMEPLAY::IS_BIT_SET(Global_105217[iVar0 /*28*/].f_27, 0))
					{
						Global_105217[iVar0 /*28*/].f_21 = (Global_105217[iVar0 /*28*/].f_21 + SYSTEM::ROUND((GAMEPLAY::GET_FRAME_TIME() * 1000f)));
						if (UI::_0x2432784ACA090DA4(iVar1))
						{
							GAMEPLAY::SET_BIT(&(Global_105217[iVar0 /*28*/].f_27), 0);
						}
					}
				}
				if (Global_105217[iVar0 /*28*/].f_24.f_2 != 9999f)
				{
					if (Global_105217[iVar0 /*28*/].f_23 != 0)
					{
						...
						{
							if (!GAMEPLAY::IS_BIT_SET(Global_105217[iVar0 /*28*/].f_27, 3))
							{
								UI::_0x784BA7E0ECEB4178(iVar1, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_105217[iVar0 /*28*/].f_23, Global_105217[iVar0 /*28*/].f_24));
							}
							else
							{
								UI::_0xB094BC1DB4018240(iVar1, Global_105217[iVar0 /*28*/].f_23, Global_105217[iVar0 /*28*/].f_24, Global_105217[iVar0 /*28*/].f_24.f_1);
							}
						}
					}
					else if ((Global_105217[iVar0 /*28*/].f_24 != 0f || Global_105217[iVar0 /*28*/].f_24.f_1 != 0f) || Global_105217[iVar0 /*28*/].f_24.f_2 != 0f)
					{
						UI::_0x784BA7E0ECEB4178(iVar1, Global_105217[iVar0 /*28*/].f_24);
					}
				}
				else
				{
					UI::_0x7679CC1BCEBE3D4C(iVar1, Global_105217[iVar0 /*28*/].f_24, Global_105217[iVar0 /*28*/].f_24.f_1);
				}
			}
			else if ((GAMEPLAY::GET_GAME_TIMER() - Global_105217[iVar0 /*28*/].f_22) > 1000)
			{
				func_2(iVar0);
			}
		}
...
int func_3(int iParam0)
{
	...
	iVar0 = iParam0;
	if (!GAMEPLAY::ARE_STRINGS_EQUAL(&(Global_105217[iParam0 /*28*/]), "") && !GAMEPLAY::IS_STRING_NULL(&(Global_105217[iParam0 /*28*/])))
	{
		if (GAMEPLAY::IS_BIT_SET(Global_105217[iParam0 /*28*/].f_27, 1))
		{
			if (GAMEPLAY::IS_BIT_SET(Global_105217[iParam0 /*28*/].f_27, 2))
			{
		...
		else if (GAMEPLAY::IS_BIT_SET(Global_105217[iParam0 /*28*/].f_27, 2))
		{
