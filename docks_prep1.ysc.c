...
void func_132(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_134(Var11.f_1)) && iVar72 < 51)
			{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_254(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_251(ENTITY::GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
void func_319()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[2 /*2*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_28[2], 1, 1);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_169[3 /*2*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_28[3], 1, 1);
			Local_169[3 /*2*/] = Global_90209.f_28[3];
		}
	}
	if (Global_90209.f_357)
	{
		if (ROPE::DOES_ROPE_EXIST(&(Global_90209.f_37[0])))
		{
			ROPE::_0xB1B6216CA2E7B55E(Global_90209.f_37[0], 1, 1);
			Local_145[0 /*5*/] = Global_90209.f_37[0];
			Global_90209.f_37[0] = 0;
		}
		if (ROPE::DOES_ROPE_EXIST(&(Global_90209.f_37[1])))
		{
			ROPE::_0xB1B6216CA2E7B55E(Global_90209.f_37[1], 1, 1);
			Local_145[1 /*5*/] = Global_90209.f_37[1];
			Global_90209.f_37[1] = 0;
		}
		if (ROPE::DOES_ROPE_EXIST(&(Global_90209.f_37[2])))
		{
			ROPE::_0xB1B6216CA2E7B55E(Global_90209.f_37[2], 1, 1);
			Local_145[2 /*5*/] = Global_90209.f_37[2];
			Global_90209.f_37[2] = 0;
		}
		if (ROPE::DOES_ROPE_EXIST(&(Global_90209.f_37[3])))
		{
			ROPE::_0xB1B6216CA2E7B55E(Global_90209.f_37[3], 1, 1);
