...
void func_22()
{
	switch (iLocal_146)
	{
		...
		case 1:
			...
			{
				if ((!func_231() && func_230(Local_83.f_28[0])) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_323) > 5000)
				{
			...
			else if ((!UI::IS_MESSAGE_BEING_DISPLAYED() && !func_231()) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_322) > iLocal_324)
			{
			...
			if (func_230(Local_83.f_28[0]))
			{
				...
				if (func_232(PLAYER::PLAYER_PED_ID(), Local_83.f_28[0], 1) >= 100f && !CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 1), 3f))
				{
					iLocal_146 = 3;
				}
				if ((((((GRAPHICS::_0x2F09F7976C512404(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), 5f) || GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), 5f, 0)) || GAMEPLAY::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), joaat("weapon_grenadelauncher"), 5f, 0)) || GAMEPLAY::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), joaat("weapon_rpg"), 5f, 0)) || GAMEPLAY::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), joaat("weapon_grenade"), 5f, 0)) || GAMEPLAY::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), joaat("weapon_molotov"), 5f, 0)) || GAMEPLAY::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_83.f_28[0], 0), joaat("weapon_flare"), 5f, 0))
				{
...
void func_23()
{
	...
	{
		Global_106565.f_10043.f_104 = TIME::GET_CLOCK_DAY_OF_MONTH();
	}
...
int func_52(var uParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(uParam0, func_95(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(uParam0, func_95(iParam1), Global_71402[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_95(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, 0);
		}
	}
...
void func_71(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_72(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
...
int func_76(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_78(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_78(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 4);
		}
	}
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_73(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_73(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_73(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_73(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_221(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_222(UI::_SET_NOTIFICATION_MESSAGE_2(&cVar2, &cVar2, 0, 2, UI::_GET_LABEL_TEXT(func_223(iParam1)), 0));
		}
		else
		{
			func_222(UI::_SET_NOTIFICATION_MESSAGE_2("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, UI::_GET_LABEL_TEXT(func_223(iParam1)), 0));
		}
		switch (Global_14553)
		{
			case 0:
