...
void func_23()
{
	if (bLocal_125)
	{
		if (bLocal_126)
		{
			...
			{
				ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_123);
			}
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_124))
			{
				ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_124);
			}
		}
	}
}
...
void func_38()
{
	...
	if ((ENTITY::DOES_ENTITY_EXIST(uLocal_124) && !ENTITY::IS_ENTITY_DEAD(uLocal_124, 0)) && !FIRE::IS_ENTITY_ON_FIRE(uLocal_124))
	{
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_124, 2);
		VEHICLE::SET_VEHICLE_UNDRIVEABLE(uLocal_124, 1);
		VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(uLocal_124, 0, 0);
		VEHICLE::_0x2B6747FAA9DB9D6B(uLocal_124, 1);
		uLocal_122 = uLocal_124;
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_123) && !ENTITY::IS_ENTITY_DEAD(uLocal_123, 0))
		{
			VEHICLE::SET_VEHICLE_UNDRIVEABLE(uLocal_123, 1);
			VEHICLE::_0x2B6747FAA9DB9D6B(uLocal_123, 1);
			VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(uLocal_123, 0, 0);
			VEHICLE::SET_VEHICLE_LIGHTS(uLocal_123, 1);
		}
	}
	else
	{
		if ((ENTITY::DOES_ENTITY_EXIST(uLocal_124) && ENTITY::IS_ENTITY_DEAD(uLocal_124, 0)) || !ENTITY::DOES_ENTITY_EXIST(uLocal_124))
		{
			func_39(0);
		}
		if ((ENTITY::DOES_ENTITY_EXIST(uLocal_123) && ENTITY::IS_ENTITY_DEAD(uLocal_123, 0)) || !ENTITY::DOES_ENTITY_EXIST(uLocal_123))
		{
			func_39(0);
		}
...
void func_76()
{
	if (bLocal_125)
	{
		...
		if (!iLocal_127)
		{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_123))
			{
				uLocal_123 = VEHICLE::CREATE_VEHICLE(joaat("blazer"), -1707.434f, 4666.563f, 22.1095f, 323.2491f, 1, 1, 0);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_124))
			{
				uLocal_124 = VEHICLE::CREATE_VEHICLE(joaat("journey"), -1702.695f, 4666.941f, 22.7091f, 80.03f, 1, 1, 0);
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(uLocal_124, 1);
			}
			iLocal_127 = 1;
		}
	}
