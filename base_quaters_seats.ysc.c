	...
	switch (uParam0->f_29.f_4)
	{
		...
		case 4:
			...
			if (Var20 != 3)
			{
				...
				vVar37 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_38(uParam0), func_37(uParam0), 0, 2) };
				uVar40 = vVar37.z;
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			uVar42 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_29.f_1);
		...
		case 8:
			uVar43 = NETWORK::_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_29.f_1);
...
void func_75(int iParam0, var uParam1, int iParam2)
{
	...
	(uParam1[iParam2 /*14*/])->f_8 = { func_78(func_79(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, (fVar3 + 0f) };
	(uParam1[iParam2 /*14*/])->f_1 = { func_78(func_77(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_78(func_76(), fVar3) + vVar0 };
...
void func_83(int iParam0, var uParam1, int iParam2)
{
	...
	func_88(iParam0, &vVar0, &fVar3);
	(*uParam1)[iParam2 /*14*/] = 5;
	(uParam1[iParam2 /*14*/])->f_8 = { func_78(func_86(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, (fVar3 + 3f) };
	(uParam1[iParam2 /*14*/])->f_1 = { func_78(func_85(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_78(func_84(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_6 = 0.73f;
}
