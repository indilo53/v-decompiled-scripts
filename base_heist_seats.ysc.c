...
void func_1()
{
	GAMEPLAY::CLEAR_BIT(&Global_1573968, 1);
	func_3(&Local_47);
	func_2();
}
...
{
	func_19(&Local_47);
	if (Global_1589667 == PLAYER::PLAYER_ID() && !GAMEPLAY::IS_BIT_SET(Global_1686664[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*39*/].f_27, 5))
	{
		...
		{
			GAMEPLAY::SET_BIT(&Global_1573968, 1);
			if ((((((iLocal_484 == 0 && !GAMEPLAY::IS_BIT_SET(Global_1686664[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*39*/].f_27, 3)) && !func_16()) && !UI::IS_PAUSE_MENU_ACTIVE()) && !func_15(0)) && !func_14()) && CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(0, 225))
			{
				func_12(&Local_47);
			}
		}
	...
	iLocal_484 = 0;
	if (GAMEPLAY::IS_BIT_SET(Global_1686664[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*39*/].f_27, 3))
	{
...
bool func_80(var uParam0, int iParam1)
{
	...
	if (func_83(PLAYER::PLAYER_ID()) || GAMEPLAY::IS_BIT_SET(iLocal_484, 0))
	{
		return 0;
	}
	vVar0 = { uParam0->f_1 };
...
int func_83(int iParam0)
{
	if (iParam0 != func_64())
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(Global_1686664[iParam0 /*39*/].f_27, 3))
			{
				return 1;
			}
		}
