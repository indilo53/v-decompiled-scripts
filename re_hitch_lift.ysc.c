	...
	if (bParam1)
	{
		if (!bVar0)
		{
			...
			switch (iParam2)
			{
				...
				case 6:
				case 7:
					GAMEPLAY::SET_BIT(&(Global_2097152[func_73() /*10778*/].f_6165.f_1272), iParam0);
					func_70(15, 0);
					break;
			}
			func_69(iVar1);
...
void func_86(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_73() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_73() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
int func_89(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_73() /*10778*/].f_6165.f_10, iParam0);
}
...
int func_212()
{
	if ((Global_106554 == func_40() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
