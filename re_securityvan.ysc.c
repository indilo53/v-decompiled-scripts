...
{
	GAMEPLAY::SET_BIT(&(Global_106565.f_24989.f_6), iParam0);
}
...
{
	return GAMEPLAY::IS_BIT_SET(Global_106565.f_24989.f_6, iParam0);
}
...
int func_178()
{
	if ((Global_106554 == func_59() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
