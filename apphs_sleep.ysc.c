...
void func_12()
{
	if (Global_14491 == 0)
	{
		if (func_11(2, Global_14482, 0))
		{
			...
			uLocal_36 = GRAPHICS::_END_SCALEFORM_MOVIE_METHOD_RETURN();
			while (!GRAPHICS::_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(uLocal_36))
			{
				SYSTEM::WAIT(0);
			}
			Global_3188[Global_14513 /*2811*/][iLocal_38 /*281*/].f_259 = iLocal_18[GRAPHICS::_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_INT(uLocal_36)];
		...
		while (iVar17 < 9)
		{
			if (Global_3188[Global_14513 /*2811*/][iLocal_38 /*281*/].f_124[iVar17] == 1)
			{
				if (iVar0[iVar17] == 0)
				{
					...
					{
						iVar18 = iVar17;
						func_20(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(13), SYSTEM::TO_FLOAT(iVar16), SYSTEM::TO_FLOAT(Global_3188[Global_14513 /*2811*/][iLocal_38 /*281*/].f_104[iVar18]), -1f, -1f, &(Global_3188[Global_14513 /*2811*/][iLocal_38 /*281*/].f_7[iVar18 /*4*/]), 0, 0, 0, 0);
					}
				}
			}
			iVar17++;
			...
			if (Global_3188[Global_14513 /*2811*/][iVar17 /*281*/].f_280 == 1)
			{
				if (iVar0[iVar17] == 0)
				{
					if (iVar17 == 0)
					{
						...
						{
							iVar18 = iVar17;
							func_20(Global_14494, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(2), SYSTEM::TO_FLOAT(iVar16), -1f, -1f, -1f, &(Global_3188[Global_14513 /*2811*/][iVar18 /*281*/].f_2), 0, 0, 0, 0);
						}
					}
				}
			}
