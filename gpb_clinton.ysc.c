...
void __EntryFunction__()
{
	...
	iLocal_241 = 1;
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_240) && func_97(uLocal_240))
	{
	...
	while (iVar0 == 1)
	{
		...
		fVar43 = func_91(PLAYER::PLAYER_PED_ID(), uLocal_240);
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if ((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_240) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_240)) && fVar43 < 25f) && func_83(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_80(uLocal_240, PLAYER::PLAYER_PED_ID(), 1126825984, 0))
			{
				if (!func_84())
				{
					func_86();
		...
		if (func_79(uLocal_240, PLAYER::PLAYER_PED_ID(), 1) < 25f)
		{
		...
		switch (iLocal_250)
		{
			...
			case 3:
				...
				if (func_79(uLocal_240, PLAYER::PLAYER_PED_ID(), 1) < fVar40)
				{
					if (func_53() == 1)
					{
						iLocal_250 = 8;
			...
			case 8:
				...
				else if (iLocal_440 == 1)
				{
					...
					{
						func_47(Global_106510[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_240, &Local_372, &Local_356));
					}
				}
				break;
		...
		if (((((((((((((iLocal_250 == 0 || iLocal_250 == 1) || iLocal_250 == 3) || iLocal_250 == 8) || iLocal_250 == 9) || iLocal_250 == 7) && func_79(uLocal_240, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_436 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar30 == 0) && bLocal_439 == 1) && !Global_3) && func_7()) && bVar81)
		{
			if (iLocal_298 == -1)
			{
			...
			if (func_4(iLocal_298, 1))
			{
				...
				iLocal_250 = 13;
				iVar29 = 0;
				iVar82 = func_73(GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()));
				if (func_72(iVar82))
				{
					if (!func_71(iVar82))
					{
	...
	while (true)
	{
		...
		if ((ENTITY::IS_ENTITY_OCCLUDED(uLocal_240) && func_79(uLocal_240, PLAYER::PLAYER_PED_ID(), 1) > 50f) && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			func_108(1);
		}
		SYSTEM::WAIT(0);
...
{
	func_9();
	if (func_97(uLocal_240) && func_97(PLAYER::PLAYER_PED_ID()))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_240, 0);
...
int func_80(var uParam0, var uParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_82(ENTITY::GET_ENTITY_COORDS(uParam1, 1) - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_82(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
