	...
	while (true)
	{
		...
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			...
			switch (iLocal_301)
			{
				...
				case 2:
					if (((ENTITY::DOES_ENTITY_EXIST(uLocal_317) && PED::IS_PED_DEAD_OR_DYING(uLocal_317, 1)) && iLocal_348 < 5) && !bLocal_345)
					{
						func_12();
					}
					func_1();
...
void func_1()
{
	if (iLocal_534 && !iLocal_535)
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(uLocal_319, 0))
		{
			VEHICLE::SET_VEHICLE_ENGINE_HEALTH(uLocal_319, 0f);
			ENTITY::FREEZE_ENTITY_POSITION(uLocal_319, 0);
		}
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_339))
		{
			ENTITY::FREEZE_ENTITY_POSITION(uLocal_339, 0);
		}
	...
	{
		if (!CAM::IS_SPHERE_VISIBLE(vLocal_308 + Vector(20f, 0f, 0f), 30f) && !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_308, 80f, 80f, 80f, 0, 1, 0))
		{
			func_174();
		}
	}
...
void func_12()
{
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_319))
		{
			ENTITY::FREEZE_ENTITY_POSITION(uLocal_319, 0);
			ENTITY::APPLY_FORCE_TO_ENTITY(uLocal_319, 0, 0f, 0f, 50f, 0f, 0f, 0f, 0, 1, 1, 1, 0, 1);
			if (!ENTITY::IS_ENTITY_DEAD(uLocal_319, 0))
			{
				VEHICLE::EXPLODE_VEHICLE(uLocal_319, 1, 0);
			}
		}
	}
}
	...
	if (iLocal_222 == 0)
	{
		if (FIRE::GET_CLOSEST_FIRE_POS(&vVar1, Local_229[0 /*5*/]))
		{
			...
			while (iVar0 < Local_229)
			{
				if (iVar0 > 0)
				{
					fVar4 = (fVar4 + GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Local_229[(iVar0 - 1) /*5*/], Local_229[iVar0 /*5*/], 1));
				}
				if (Local_229[iVar0 /*5*/].f_4)
				{
					if (FIRE::GET_CLOSEST_FIRE_POS(&vVar1, Local_229[iVar0 /*5*/]))
					{
						fVar6 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Local_229[iVar0 /*5*/], vVar1, 1);
						if (fVar6 < fVar7)
						{
							fVar7 = fVar6;
							fVar8 = fVar4;
...
void func_16(vector3 vParam0, int iParam3)
{
	...
	Local_66[iLocal_226 /*5*/] = FIRE::START_SCRIPT_FIRE(vParam0, uLocal_55, iParam3);
	iLocal_226++;
	if (iLocal_226 >= 31)
	{
		iLocal_226 = 0;
			...
			if (CONTROLS::IS_CONTROL_PRESSED(0, 24) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_56)
				{
					if (!bLocal_46)
					{
						...
						while (iVar0 < Local_229)
						{
							if (UI::DOES_BLIP_EXIST(Local_229[iVar0 /*5*/].f_3))
							{
								fVar2 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_59, UI::GET_BLIP_COORDS(Local_229[iVar0 /*5*/].f_3), 1);
								fVar3 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(Local_229[iVar0 /*5*/], UI::GET_BLIP_COORDS(Local_229[iVar0 /*5*/].f_3), 1);
							...
							if (iLocal_52 != -1)
							{
								...
								if (GAMEPLAY::ABSI((iLocal_53 - iVar5)) < 3 && GAMEPLAY::ABSI((iLocal_53 - iVar5)) > 0)
								{
									if (iLocal_53 < iVar5)
									{
										...
										while (iVar6 <= (iVar5 - 1))
										{
											if (UI::DOES_BLIP_EXIST(Local_229[iVar6 /*5*/].f_3))
											{
												if (UI::GET_BLIP_ALPHA(Local_229[iVar6 /*5*/].f_3) > 0)
												{
													UI::SET_BLIP_ALPHA(Local_229[iVar6 /*5*/].f_3, 0);
								...
								if (iVar5 == 0)
								{
									if (UI::DOES_BLIP_EXIST(Local_229[iVar5 /*5*/].f_3))
									{
										if (UI::GET_BLIP_ALPHA(Local_229[iVar5 /*5*/].f_3) > 0)
										{
											UI::SET_BLIP_ALPHA(Local_229[iVar5 /*5*/].f_3, 0);
...
void func_22()
{
	switch (iLocal_302)
	{
		case 0:
			...
			func_102(&Local_537);
			if ((AUDIO::REQUEST_SCRIPT_AUDIO_BANK("CONSTRUCTION_ACCIDENT_1", 0, -1) && STREAMING::HAS_ANIM_DICT_LOADED("re@construction")) && func_98(&Local_537))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_319, 0))
				{
					uLocal_317 = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_319, 26, joaat("s_m_m_dockwork_01"), -1, 1, 1);
					PED::SET_PED_COMPONENT_VARIATION(uLocal_317, 0, 1, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(uLocal_317, 3, 1, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(uLocal_317, 4, 0, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(uLocal_317, 8, 0, 0, 0);
					AI::TASK_PLAY_ANIM(uLocal_317, "re@construction", "idle_c", 1000f, -1000f, -1, 49, 0.4f, 0, 0, 0);
					uLocal_340 = OBJECT::CREATE_OBJECT(joaat("p_amb_phone_01"), -455.6561f, -985.8071f, 22.4868f, 1, 1, 0);
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("p_amb_phone_01"));
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_340, uLocal_317, PED::GET_PED_BONE_INDEX(uLocal_317, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_317, 17, 1);
					PED::SET_PED_STAY_IN_VEHICLE_WHEN_JACKED(uLocal_317, 1);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_317, 1);
					PED::SET_PED_CAN_BE_TARGETTED(uLocal_317, 0);
					func_97(&uLocal_358, 3, uLocal_317, "RECONACWorker", 0, 1);
					AUDIO::SET_AMBIENT_VOICE_NAME(uLocal_317, "S_M_Y_GENERICWORKER_01_WHITE_01");
					...
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_318, 1, 1);
					ENTITY::FREEZE_ENTITY_POSITION(uLocal_318, 1);
					DECISIONEVENT::SET_DECISION_MAKER(uLocal_317, -1143637011);
					...
					uLocal_339 = OBJECT::CREATE_OBJECT(-415509317, vLocal_526.x, (vLocal_526.y + 0.5f), (vLocal_526.z - 0.25f), 1, 1, 0);
					ENTITY::SET_ENTITY_HEADING(uLocal_339, 75f);
					ENTITY::SET_ENTITY_PROOFS(uLocal_339, 0, 1, 1, 0, 0, 0, 0, 0);
					uLocal_533 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_sparking_generator", uLocal_339, 0f, 0f, 0.2f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
					ENTITY::FREEZE_ENTITY_POSITION(uLocal_339, 1);
		...
		case 1:
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (!iLocal_342)
				{
					if (!PED::IS_PED_INJURED(uLocal_317))
					{
						...
						if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_317, PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_319, PLAYER::PLAYER_PED_ID(), 1))
						{
							ENTITY::FREEZE_ENTITY_POSITION(uLocal_319, 0);
							AI::CLEAR_PED_TASKS(uLocal_317);
							...
							AI::TASK_PERFORM_SEQUENCE(uLocal_317, uLocal_357);
							AI::CLEAR_SEQUENCE_TASK(&uLocal_357);
							func_89();
						}
						STREAMING::REQUEST_MODEL(joaat("prop_ld_pipe_single_01"));
						if ((((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -473.1686f, -984.6405f, 22.487f, 40f, 40f, 5f, 0, 1, 0) && !PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID())) && func_88(1, 0, 1)) && STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_pipe_single_01")))
						{
							if (!func_128())
							{
				...
				else
				{
					if (!PED::IS_PED_INJURED(uLocal_317))
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_317, 0))
						{
							if (!ENTITY::IS_ENTITY_DEAD(uLocal_319, 0) && !UI::DOES_BLIP_EXIST(uLocal_324))
							{
								uLocal_324 = func_90(uLocal_319, 0, 0);
							}
						}
					...
					if (!PED::IS_PED_INJURED(uLocal_317))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_317, vLocal_311, 0, 1, 0))
						{
							if (!bLocal_343)
							{
								func_42();
					...
					else
					{
						...
						if (PED::IS_PED_INJURED(uLocal_317) || ENTITY::IS_ENTITY_DEAD(uLocal_319, 0))
						{
							func_89();
						}
					}
					if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_320, 0))
					{
						if (UI::DOES_BLIP_EXIST(uLocal_325))
						{
							UI::REMOVE_BLIP(&uLocal_325);
					...
					if (iLocal_353 >= 3)
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), joaat("bulldozer")))
						{
							if (UI::DOES_BLIP_EXIST(uLocal_325))
							{
								...
								if (!PED::IS_PED_INJURED(uLocal_317) && !ENTITY::IS_ENTITY_DEAD(uLocal_319, 0))
								{
									if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_317, 0) && !UI::DOES_BLIP_EXIST(uLocal_324))
									{
										uLocal_324 = func_90(uLocal_319, 0, 0);
									}
								}
						...
						else if (!PED::IS_PED_INJURED(uLocal_317) && !ENTITY::IS_ENTITY_DEAD(uLocal_319, 0))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_317, 0) && UI::DOES_BLIP_EXIST(uLocal_324))
							{
								UI::REMOVE_BLIP(&uLocal_324);
				...
				if (!ENTITY::IS_ENTITY_DEAD(uLocal_319, 0))
				{
					if (FIRE::IS_ENTITY_ON_FIRE(uLocal_319))
					{
						iLocal_347 = 0;
						while (iLocal_347 < 11)
						{
						...
						if (!PED::IS_PED_INJURED(uLocal_317))
						{
							...
							{
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_317, 1);
								PED::SET_PED_CONFIG_FLAG(uLocal_317, 116, 0);
								PED::SET_PED_CONFIG_FLAG(uLocal_317, 29, 0);
								if (!bLocal_345)
								{
									func_40();
									SYSTEM::WAIT(0);
								...
								if (!PED::IS_PED_INJURED(uLocal_317))
								{
									ENTITY::SET_ENTITY_HEALTH(uLocal_317, 99, 0);
								}
								if (!ENTITY::IS_ENTITY_DEAD(uLocal_319, 0))
								{
									ENTITY::FREEZE_ENTITY_POSITION(uLocal_319, 0);
		...
		case 2:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_355) > iLocal_304 || func_45())
			{
				...
				if (!bLocal_345)
				{
					if (!PED::IS_PED_INJURED(uLocal_317) && !ENTITY::IS_ENTITY_DEAD(uLocal_319, 0))
					{
						if (!VEHICLE::_0x639431E895B9AA57(uLocal_317, uLocal_319, -1, 0, 0) && !VEHICLE::_0x639431E895B9AA57(uLocal_317, uLocal_319, 0, 0, 0))
						{
							func_40();
							SYSTEM::WAIT(0);
							func_24(&uLocal_358, "CONACAU", "CONAC_DIE", 4, 0, 0, 0);
...
void func_46()
{
	...
	switch (iLocal_348)
	{
		case 0:
			if (iLocal_353 >= 2)
			{
				if (!PED::IS_PED_INJURED(uLocal_317) && !ENTITY::IS_ENTITY_DEAD(uLocal_319, 0))
				{
					...
					OBJECT::DELETE_OBJECT(&uLocal_340);
					if (VEHICLE::_0x639431E895B9AA57(uLocal_317, uLocal_319, -1, 0, 0) || VEHICLE::_0x639431E895B9AA57(uLocal_317, uLocal_319, 0, 0, 0))
					{
						if (VEHICLE::_0x639431E895B9AA57(uLocal_317, uLocal_319, -1, 0, 0))
						{
							bLocal_344 = true;
							vLocal_314 = { ENTITY::GET_ENTITY_COORDS(uLocal_319, 0) + Vector(0f, -1f, -3f) };
						}
						else
						{
							vLocal_314 = { ENTITY::GET_ENTITY_COORDS(uLocal_319, 0) + Vector(0f, 1.5f, -3f) };
						}
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), vLocal_314, 4.2f, 4f, 5f, 0, 1, 0))
						{
							if (!bLocal_343)
							{
								func_40();
		...
		case 1:
			if (!PED::IS_PED_INJURED(uLocal_317) && !ENTITY::IS_ENTITY_DEAD(uLocal_319, 0))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uLocal_320, 0))
				{
					ENTITY::SET_ENTITY_PROOFS(uLocal_320, 0, 1, 1, 0, 0, 0, 0, 0);
				}
				ENTITY::SET_ENTITY_PROOFS(uLocal_317, 0, 1, 0, 0, 0, 0, 0, 0);
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_319, 0);
				AI::OPEN_SEQUENCE_TASK(&uLocal_357);
				if (bLocal_344)
				{
				...
				AI::TASK_PERFORM_SEQUENCE(uLocal_317, uLocal_357);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_357);
				PED::SET_PED_KEEP_TASK(uLocal_317, 1);
				iLocal_351 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_348++;
			}
			break;
		...
		case 2:
			if (!PED::IS_PED_INJURED(uLocal_317))
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_351) > 500 && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_317, 0))
				{
					iLocal_304 = 0;
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_319, 0))
					{
		...
		case 3:
			if (!PED::IS_PED_INJURED(uLocal_317))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(uLocal_317, -464.7217f, -989.7214f, 22.4867f, 3f, 10f, 3f, 0, 1, 0) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_351) > 10000)
				{
		...
		case 4:
			if (!PED::IS_PED_INJURED(uLocal_317))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(uLocal_317, -472.7056f, -991.105f, 22.4867f, 3f, 30f, 3f, 0, 1, 0) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_351) > 10000)
				{
					if (!ENTITY::IS_ENTITY_DEAD(uLocal_319, 0))
					{
						ENTITY::FREEZE_ENTITY_POSITION(uLocal_319, 0);
		...
		case 5:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_351) > 3000)
			{
				...
				if (!PED::IS_PED_INJURED(uLocal_317))
				{
					...
					if (!ENTITY::IS_ENTITY_DEAD(uLocal_320, 0))
					{
						ENTITY::SET_ENTITY_PROOFS(uLocal_320, 0, 0, 0, 0, 0, 0, 0, 0);
					}
					ENTITY::SET_ENTITY_PROOFS(uLocal_317, 0, 0, 0, 0, 0, 0, 0, 0);
					PED::SET_PED_CAN_RAGDOLL(uLocal_317, 1);
					PED::SET_PED_CAN_BE_TARGETTED(uLocal_317, 1);
					PED::SET_PED_STAY_IN_VEHICLE_WHEN_JACKED(uLocal_317, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_317, 0);
					DECISIONEVENT::SET_DECISION_MAKER(uLocal_317, -455129387);
					AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					AI::OPEN_SEQUENCE_TASK(&uLocal_357);
					AI::TASK_PLAY_ANIM(0, "re@construction", "Out_Of_Breath", 2f, -2f, -1, 0, 0, 0, 0, 0);
		...
		case 6:
			if (!PED::IS_PED_INJURED(uLocal_317))
			{
				if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_351) > 6400)
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_320))
					{
						if (ENTITY::IS_ENTITY_AT_COORD(uLocal_320, -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, 0, 1, 0))
						{
							vVar0 = { -477.7884f, -996.3974f, 23.5503f };
						}
					}
...
int func_76(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_77(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_77(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
void func_91()
{
	if (func_94(1000))
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(uLocal_319, 0))
		{
			VEHICLE::SET_VEHICLE_DAMAGE(uLocal_319, 0f, 1f, 1f, 200f, 800f, 1);
		}
		bLocal_536 = true;
		iLocal_303 = 8;
	}
	switch (iLocal_303)
	{
		case 0:
			...
			GAMEPLAY::CLEAR_AREA_OF_PEDS(vLocal_308, 50f, 0);
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_308, 30f, 0, 0, 0, 0, 0, 0);
			GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(vLocal_308, 100f, 0);
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), vLocal_308, 8f, 8f, 8f, 0, 1, 0))
				{
					uLocal_321 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uLocal_321, 1, 0);
					VEHICLE::DELETE_VEHICLE(&uLocal_321);
				}
			}
		...
		case 1:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_354) > 3500)
			{
				...
				AUDIO::PLAY_SOUND_FRONTEND(uLocal_350, "WIND", "CONSTRUCTION_ACCIDENT_1_SOUNDS", 1);
				...
				{
					AI::CLEAR_PED_TASKS(uLocal_317);
					AI::TASK_LOOK_AT_COORD(uLocal_317, -461.4785f, -984.8583f, 28.0809f, 30000, 2080, 2);
				}
				if (ENTITY::DOES_ENTITY_EXIST(uLocal_340))
				{
					ENTITY::DETACH_ENTITY(uLocal_340, 1, 1);
					OBJECT::DELETE_OBJECT(&uLocal_340);
				}
				iLocal_354 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_303 = 2;
		...
		case 5:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_354) > 500)
			{
				if (!ENTITY::IS_ENTITY_DEAD(uLocal_319, 0))
				{
					...
					if (!PED::IS_PED_INJURED(uLocal_317))
					{
						AI::TASK_CLEAR_LOOK_AT(uLocal_317);
					}
					AI::TASK_PLAY_ANIM(uLocal_317, "re@construction", "idle_panic", 8f, -8f, -1, 16, 0, 0, 0, 0);
					GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_reconstruct_pipe_impact", uLocal_319, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
		...
		case 6:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_354) > 500)
			{
				...
				if (!PED::IS_PED_INJURED(uLocal_317))
				{
					AI::TASK_LOOK_AT_COORD(uLocal_317, ENTITY::GET_ENTITY_COORDS(uLocal_317, 1) - Vector(10f, 0f, 2f), 30000, 2080, 2);
				}
				iLocal_354 = GAMEPLAY::GET_GAME_TIMER();
				iLocal_303 = 7;
			}
		...
		case 7:
			...
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_354) > 2500)
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_319, 0))
				{
					ENTITY::FREEZE_ENTITY_POSITION(uLocal_319, 1);
				}
				iLocal_303 = 8;
			}
			break;
		...
		case 8:
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_319, 0))
			{
				VEHICLE::SET_VEHICLE_ENGINE_HEALTH(uLocal_319, 250f);
				ENTITY::SET_ENTITY_COORDS(uLocal_319, vLocal_308, 1, 0, 0, 1);
				ENTITY::SET_ENTITY_HEADING(uLocal_319, 80f);
				GAMEPLAY::CLEAR_AREA_OF_OBJECTS(vLocal_308, 50f, 0);
			}
			if (!PED::IS_PED_INJURED(uLocal_317))
			{
				AI::CLEAR_PED_TASKS(uLocal_317);
				AI::TASK_CLEAR_LOOK_AT(uLocal_317);
				AI::TASK_PLAY_ANIM(uLocal_317, "re@construction", "idle_panic", 8f, -8f, -1, 1, 0, 0, 0, 0);
			}
...
void func_109()
{
	...
	if (func_98(&Local_537))
	{
		...
		uLocal_319 = VEHICLE::CREATE_VEHICLE(joaat("utillitruck2"), vLocal_308, 80f, 1, 1, 0);
		VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_319, 0, 1, 0);
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_319, 3);
		VEHICLE::SET_VEHICLE_EXTRA(uLocal_319, 1, 1);
		VEHICLE::SET_VEHICLE_EXTRA(uLocal_319, 2, 1);
		VEHICLE::SET_VEHICLE_EXTRA(uLocal_319, 3, 0);
		VEHICLE::SET_VEHICLE_EXTRA(uLocal_319, 4, 1);
		VEHICLE::SET_VEHICLE_EXTRA(uLocal_319, 5, 1);
		VEHICLE::SET_VEHICLE_EXTRA(uLocal_319, 6, 0);
		VEHICLE::SET_VEHICLE_EXTRA(uLocal_319, 7, 1);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_319, 1);
		ENTITY::SET_ENTITY_PROOFS(uLocal_319, 0, 0, 0, 1, 0, 0, 0, 0);
		ENTITY::SET_ENTITY_LOD_DIST(uLocal_319, 10000);
		VEHICLE::SET_VEHICLE_LOD_MULTIPLIER(uLocal_319, 5f);
		uLocal_320 = VEHICLE::CREATE_VEHICLE(joaat("bulldozer"), -472.9444f, -966.671f, 22.5534f, 181.8365f, 1, 1, 0);
		GAMEPLAY::CLEAR_AREA(vLocal_308, 10f, 1, 0, 0, 0);
...
int func_128()
{
	if ((Global_106554 == func_68() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
void func_174()
{
	if (iLocal_534)
	{
		if (!iLocal_535)
		{
			...
			if (!PED::IS_PED_INJURED(uLocal_317))
			{
				PED::SET_PED_CONFIG_FLAG(uLocal_317, 317, 1);
			}
