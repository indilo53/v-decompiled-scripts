...
void __EntryFunction__()
{
	...
	{
		vLocal_90 = { ENTITY::GET_ENTITY_COORDS(uScriptParam_0, 1) };
	...
	while (true)
	{
		...
		{
			fVar24 = 0f;
			if (GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(Var0.f_1[0 /*3*/], &fVar24, 0, 0))
			{
				if (fVar24 != 0f)
				{
			...
			switch (iLocal_95)
			{
				...
				case 3:
					...
					else
					{
						...
						if (bVar26)
						{
							if (!ENTITY::IS_ENTITY_AT_COORD(uLocal_85, Var0.f_1[0 /*3*/], fLocal_117, fLocal_117, 2f, 0, 1, iLocal_103))
							{
								bVar26 = false;
							}
							if (ENTITY::IS_ENTITY_DEAD(uLocal_156, 0))
							{
								uLocal_156 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_90, 2f, uLocal_118, 1, 0, 1);
								func_84(&uLocal_94, 128);
								bVar26 = false;
							}
							else
							{
								vLocal_137 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_156, vLocal_134) };
							...
							if (bVar26)
							{
								...
								if (func_76(uLocal_86))
								{
									...
									else if (!func_114(uLocal_94, 2048) || !UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_74(&iLocal_96);
				...
				case 6:
					...
					if (func_114(uLocal_94, 2097152))
					{
						if (!func_98(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_52))
						{
							func_107(10);
						}
					}
...
var func_23()
{
	...
	vVar0 = { ENTITY::GET_ENTITY_ROTATION(uLocal_156, 2) };
	Local_149 = { ENTITY::GET_ENTITY_COORDS(uLocal_156, 1) };
		...
		if (iLocal_147 == 0)
		{
			if (fVar32 < (10f * 10f))
			{
				...
				if (!func_100(6) && !func_100(7))
				{
					...
					{
						ENTITY::FREEZE_ENTITY_POSITION(uLocal_143, 0);
						AI::TASK_LOOK_AT_ENTITY(uLocal_143, uLocal_144, -1, 2049, 3);
						AI::TASK_START_SCENARIO_IN_PLACE(uLocal_143, "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
					}
					if (!ENTITY::IS_ENTITY_DEAD(uLocal_144, 0))
					{
						ENTITY::FREEZE_ENTITY_POSITION(uLocal_144, 0);
						AI::TASK_LOOK_AT_ENTITY(uLocal_144, uLocal_143, -1, 2049, 3);
						AI::TASK_START_SCENARIO_IN_PLACE(uLocal_144, "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
					}
				}
				else
				{
					if (!ENTITY::IS_ENTITY_DEAD(uLocal_143, 0))
					{
						...
						{
							AI::TASK_USE_NEAREST_SCENARIO_TO_COORD(uLocal_143, 1991.677f, 3044.957f, 46.21505f, 0.5f, 0);
						}
						else
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_143, 1991.677f, 3044.957f, 46.21505f, 1f, 20000, 1048576000, 0, 1193033728);
						}
					...
					if (!ENTITY::IS_ENTITY_DEAD(uLocal_144, 0))
					{
						...
						{
							AI::TASK_USE_NEAREST_SCENARIO_TO_COORD(uLocal_144, 1990.37f, 3045.121f, 46.21502f, 0.5f, 0);
						}
						else
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_144, 1990.37f, 3045.121f, 46.21502f, 1f, 20000, 1048576000, 0, 1193033728);
						}
						ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uLocal_144);
					}
				}
			}
		}
		else if (iLocal_147 == 1)
		{
			if (fVar32 >= (10f * 10f))
			{
				...
				if (!func_100(6) && !func_100(7))
				{
					if (!ENTITY::IS_ENTITY_DEAD(uLocal_143, 0))
					{
						AI::TASK_STAND_STILL(uLocal_143, -1);
						if (!ENTITY::IS_ENTITY_ATTACHED(uLocal_143))
						{
							ENTITY::FREEZE_ENTITY_POSITION(uLocal_143, 1);
						}
					}
					if (!ENTITY::IS_ENTITY_DEAD(uLocal_144, 0))
					{
						AI::TASK_STAND_STILL(uLocal_144, -1);
						if (!ENTITY::IS_ENTITY_ATTACHED(uLocal_144))
						{
							ENTITY::FREEZE_ENTITY_POSITION(uLocal_144, 1);
						}
					}
				}
				else
				{
					if (!ENTITY::IS_ENTITY_DEAD(uLocal_143, 0))
					{
						ENTITY::SET_ENTITY_COORDS(uLocal_143, 1991.677f, 3044.957f, 46.21505f, 1, 0, 0, 1);
						AI::TASK_STAND_STILL(uLocal_143, -1);
						if (!ENTITY::IS_ENTITY_ATTACHED(uLocal_143))
						{
							ENTITY::FREEZE_ENTITY_POSITION(uLocal_143, 1);
					...
					if (!ENTITY::IS_ENTITY_DEAD(uLocal_144, 0))
					{
						ENTITY::SET_ENTITY_COORDS(uLocal_144, 1990.37f, 3045.121f, 46.21502f, 1, 0, 0, 1);
						AI::TASK_STAND_STILL(uLocal_144, -1);
						if (!ENTITY::IS_ENTITY_ATTACHED(uLocal_144))
						{
							ENTITY::FREEZE_ENTITY_POSITION(uLocal_144, 1);
	...
	if (!iLocal_159)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (((PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::GET_PLAYER_INDEX(), 0)) || PED::IS_ANY_PED_SHOOTING_IN_AREA(937.0616f, -117.8927f, 72.9163f, 1021.849f, -120.5357f, 72.9163f, 1, 1)) || GAMEPLAY::IS_PROJECTILE_IN_AREA(1991.473f, 3045.98f, 49.532f, 1996.906f, 3052.17f, 46.3392f, 0))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uLocal_143, 0))
				{
					AI::TASK_SMART_FLEE_PED(uLocal_143, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
				}
				if (!ENTITY::IS_ENTITY_DEAD(uLocal_144, 0))
				{
					AI::TASK_SMART_FLEE_PED(uLocal_144, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
				}
				bVar28 = true;
			}
			else
		...
		if (!func_100(6) && !func_100(7))
		{
			if (!PED::IS_PED_INJURED(uLocal_143) && !PED::IS_PED_INJURED(uLocal_144))
			{
				if (PED::IS_PED_FLEEING(uLocal_143) || PED::IS_PED_FLEEING(uLocal_144))
				{
					bVar28 = true;
				}
			}
	...
	if (iLocal_148 == 1)
	{
		...
		else if (iLocal_157 == INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (!PED::IS_PED_INJURED(uLocal_143) && !PED::IS_PED_INJURED(uLocal_144))
			{
				if (iLocal_160)
				{
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_143, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_144, 0);
					iLocal_160 = 0;
				}
			}
		}
		else if (!PED::IS_PED_INJURED(uLocal_143) && !PED::IS_PED_INJURED(uLocal_144))
		{
			if (!iLocal_160)
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_143, 1);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_144, 1);
				iLocal_160 = 1;
			}
		}
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_59(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_77(var uParam0, vector3 vParam1, vector3 vParam4, var uParam7)
{
	...
	{
		case 0:
			uParam0->f_2 = WORLDPROBE::START_SHAPE_TEST_LOS_PROBE(vParam1, vParam4, 19, uParam7, 7);
			*uParam0 = 1;
			break;
		
		case 1:
			if (WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_2, &(uParam0->f_9), &uVar1, &uVar4, &iVar0) == 2)
			{
				if (uParam0->f_9 == 0)
				{
					*uParam0 = 3;
			...
			else if (WORLDPROBE::GET_SHAPE_TEST_RESULT(uParam0->f_2, &(uParam0->f_9), &uVar1, &uVar4, &iVar0) == 0)
			{
				*uParam0 = 3;
			}
			break;
...
void func_101()
{
	...
	if (bLocal_146)
	{
		...
		if ((fVar6 > 45f || Global_106527) && !ENTITY::DOES_ENTITY_EXIST(uLocal_143))
		{
			if (Global_106527)
			{
				Global_106527 = 0;
			...
			fVar21 = 142.6717f;
			fVar22 = 44.8785f;
			uVar23 = INTERIOR::GET_INTERIOR_AT_COORDS(func_70(iLocal_148));
			if (INTERIOR::IS_VALID_INTERIOR(uVar23))
			{
				INTERIOR::_LOAD_INTERIOR(uVar23);
				while (!INTERIOR::IS_INTERIOR_READY(uVar23))
				{
					SYSTEM::WAIT(0);
				}
				INTERIOR::UNPIN_INTERIOR(uVar23);
			}
			uLocal_143 = PED::CREATE_PED(26, iLocal_141, func_103(iLocal_148 == 1, vVar7, vVar13), func_102(iLocal_148 == 1, fVar19, fVar21), 1, 1);
			uLocal_144 = PED::CREATE_PED(26, iLocal_142, func_103(iLocal_148 == 1, vVar10, vVar16), func_102(iLocal_148 == 1, fVar20, fVar22), 1, 1);
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uLocal_143, 1, 0);
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uLocal_144, 1, 0);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_143, 1);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_144, 1);
			iLocal_160 = 1;
		...
		else
		{
			...
			else if (ENTITY::DOES_ENTITY_EXIST(uLocal_143))
			{
			}
			iLocal_145 = 0;
		}
