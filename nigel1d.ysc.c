...
void __EntryFunction__()
{
	...
	GAMEPLAY::CLEAR_BIT(&(Global_106565.f_18568.f_382), 4);
	func_507();
	iVar0 = 0;
	while (iVar0 <= (Local_481 - 1))
	{
		...
		{
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_481[iVar0 /*13*/], uLocal_774);
			ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(Local_481[iVar0 /*13*/], 0, uLocal_774);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_774, 1862763509);
		}
		iVar0++;
	}
...
void func_83(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_84(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_107(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_88(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_90(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_90(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 4);
		}
	}
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_107(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_85(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_85(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_85(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_85(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_125(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_118(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_118(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_107(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_248()
{
					...
					if (!func_14())
					{
						...
						if (func_5(Local_749))
						{
							if (func_6(Local_455))
							{
								if (!PED::IS_PED_IN_VEHICLE(Local_455, Local_749, 0))
								{
									AI::TASK_ENTER_VEHICLE(Local_455, Local_749, -1, -1, 1073741824, 1, 0);
								}
							}
						}
			...
			case 1:
				...
				else
				{
					if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_455, 11f, 11f, 11f, 0, 1, 0))
					{
						...
						AI::OPEN_SEQUENCE_TASK(&uLocal_776);
						...
						AI::SET_SEQUENCE_TO_REPEAT(uLocal_776, 1);
						AI::CLOSE_SEQUENCE_TASK(uLocal_776);
						AI::TASK_PERFORM_SEQUENCE(Local_455, uLocal_776);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_776);
				...
				if (((func_5(Local_749) && func_256(Local_455, Local_749, 1) < 10f) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_749, 0)) && !ENTITY::IS_ENTITY_UPSIDEDOWN(Local_749))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(Local_455, Local_749))
					{
						...
						if (func_6(Local_455))
						{
							if (!func_254())
							{
								AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_455, Local_749, "NIGEL1DGOLF", 786468, 0, 12, -1, -1082130432, 0, 1073741824);
							}
							else
							{
								iLocal_363 = 1;
								AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_455, Local_749, "NIGEL1DGOLF2", 786468, 0, 12, -1, -1082130432, 0, 1073741824);
							}
						}
						iLocal_170 = 4;
					}
	...
	else
	{
		...
		if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_18568.f_382, 4))
		{
			GAMEPLAY::SET_BIT(&(Global_106565.f_18568.f_382), 4);
		}
	}
}
	...
	if (iLocal_357 == 0)
	{
		...
		while (iVar0 <= 2)
		{
			if (func_506(Local_481[iVar0 /*13*/]))
			{
				...
				AI::OPEN_SEQUENCE_TASK(&uLocal_775);
				AI::TASK_PAUSE(0, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 600));
				AI::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
				AI::CLOSE_SEQUENCE_TASK(uLocal_775);
				AI::TASK_PERFORM_SEQUENCE(Local_481[iVar0 /*13*/], uLocal_775);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_775);
			...
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_749, 0))
			{
				if (func_6(Local_455))
				{
					if (!PED::IS_PED_IN_VEHICLE(Local_455, Local_749, 0))
					{
						...
						AI::TASK_ENTER_VEHICLE(0, Local_749, -1, -1, 1073741824, 1, 0);
						AI::CLOSE_SEQUENCE_TASK(uLocal_775);
						AI::TASK_PERFORM_SEQUENCE(Local_455, uLocal_775);
						AI::CLEAR_SEQUENCE_TASK(&uLocal_775);
		...
		if (func_506(Local_468))
		{
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_468, 1, 1);
		}
	...
	if (func_506(PLAYER::PLAYER_PED_ID()) && func_506(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_279(PLAYER::PLAYER_PED_ID(), iParam0, iParam2);
				}
			}
		}
		if (bParam4)
...
int func_283(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_275(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_275(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_274(vVar3, vVar0);
...
void func_290(int iParam0, int iParam1)
{
	if (func_6(iParam0))
	{
		...
		else
		{
			...
			AI::CLOSE_SEQUENCE_TASK(uLocal_776);
			AI::TASK_PERFORM_SEQUENCE(iParam0, uLocal_776);
			AI::CLEAR_SEQUENCE_TASK(&uLocal_776);
			PED::SET_PED_KEEP_TASK(iParam0, 1);
		}
	}
			...
			if (func_5(Local_749))
			{
				if (func_506(Local_455))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_455, Local_749, 0))
					{
						...
						else if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_640[iParam0 /*13*/], 1), 15f, 1))
						{
		...
		case 1:
			if (ENTITY::IS_ENTITY_AT_ENTITY(Local_455, Local_640[iParam0 /*13*/], 38f, 38f, 38f, 0, 1, 0))
			{
				if (func_6(Local_640[iParam0 /*13*/]))
				{
					...
					AI::TASK_GO_STRAIGHT_TO_COORD(Local_640[iParam0 /*13*/], Local_640[iParam0 /*13*/].f_4, 3f, -1, 1193033728, 1056964608);
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_298(iParam2), 1);
}
...
void func_300(int iParam0, int iParam1)
{
	...
	{
		*iParam0 = PED::CREATE_PED(26, iParam0->f_8, iParam0->f_1, 0, 1, 1);
		if (func_506(*iParam0))
		{
...
void func_304(int iParam0)
{
	...
	switch (iLocal_667[iParam0])
	{
							...
							if (iLocal_349 == 0)
							{
								...
								if (!UI::IS_MESSAGE_BEING_DISPLAYED() || GAMEPLAY::GET_PROFILE_SETTING(203) == 0)
								{
									if (func_263(&uLocal_174, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_1", 7, 0, 0))
									{
										...
										AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
										AI::CLOSE_SEQUENCE_TASK(uLocal_775);
										AI::TASK_PERFORM_SEQUENCE(Local_481[iParam0 /*13*/], uLocal_775);
										AI::CLEAR_SEQUENCE_TASK(&uLocal_775);
										iLocal_387 = GAMEPLAY::GET_GAME_TIMER();
										iLocal_349 = 1;
		...
		case 3:
			...
			{
				if (GAMEPLAY::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_481[iParam0 /*13*/], 1), 20f, 0) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
				{
					if (func_14())
					{
						func_12();
						...
						if (func_506(Local_455))
						{
							if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_455, 11f, 11f, 11f, 0, 1, 0))
							{
								if (func_6(Local_481[iParam0 /*13*/]))
								{
									...
									AI::TASK_GO_STRAIGHT_TO_COORD(Local_481[iParam0 /*13*/], Local_481[iParam0 /*13*/].f_1, 3f, -1, Local_481[iParam0 /*13*/].f_7, 1056964608);
								}
								iLocal_351 = 1;
								iLocal_667[iParam0] = 0;
							}
							...
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_481[iParam0 /*13*/], 9f, 9f, 9f, 0, 1, 0) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_387) >= 12000)
								{
									if (func_14())
									{
										func_12();
				...
				if (func_6(Local_481[iVar0 /*13*/]))
				{
					...
					if (iVar0 == 1)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_455))
						{
							...
							AI::TASK_GO_TO_ENTITY(Local_481[iVar0 /*13*/], Local_455, 20000, 6f, 1073741824, 1073741824, 0);
						}
					}
					else
					{
...
{
	if (func_6(uParam0) && PED::IS_PED_IN_ANY_VEHICLE(uParam0, 0))
	{
		if (func_6(iParam1))
		{
...
{
	if (func_255(&uLocal_831, ENTITY::GET_ENTITY_COORDS(uParam0, 1)))
	{
		return 1;
	}
	return 0;
...
void func_323()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_782.f_1))
	{
		uLocal_339 = UI::ADD_BLIP_FOR_ENTITY(Local_782.f_1);
		UI::SET_BLIP_COLOUR(uLocal_339, 2);
	}
}
...
void func_330(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_356(uParam1) && ENTITY::IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
int func_336(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_344() || func_343(Global_4456448.f_161209)) || func_342())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_340(uVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_360()
{
	switch (iLocal_171)
	{
		case 0:
			...
			iLocal_385 = GAMEPLAY::GET_GAME_TIMER();
			iLocal_386 = GAMEPLAY::GET_GAME_TIMER();
			UI::SET_BLIP_SCALE(uLocal_339, 1f);
			...
			if (func_5(Local_749))
			{
				if (PED::IS_PED_IN_VEHICLE(Local_455, Local_749, 0))
				{
					if (iLocal_363 == 0)
					{
						if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_749))
						{
							AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_455, Local_749, "NIGEL1DGOLF", 786468, 0, 8, -1, -1082130432, 0, 1073741824);
						}
					}
	...
	if (iLocal_347 == 0)
	{
		if (func_371(0))
		{
			...
			while (iVar0 <= 1)
			{
				...
				{
					AI::TASK_PLAY_ANIM(Local_561[iVar0 /*13*/], "rcmnigel1d", Local_561[iVar0 /*13*/].f_12, 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				iVar0++;
			}
			iVar0 = 2;
			while (iVar0 <= 3)
			{
				if (func_6(Local_561[iVar0 /*13*/]))
				{
					AI::TASK_PLAY_ANIM(Local_561[iVar0 /*13*/], "mini@golf", Local_561[iVar0 /*13*/].f_12, 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				iVar0++;
			}
			iLocal_347 = 1;
...
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uParam0, 0), ENTITY::GET_ENTITY_COORDS(uParam1, 1)) <= (fParam2 * fParam2);
}
	...
	switch (iLocal_690)
	{
		...
		case 1:
			...
			if (!CAM::DOES_CAM_EXIST(uLocal_341))
			{
				...
				CAM::_0x0A9F2A468B328E74(uLocal_341, uLocal_343, 1500, 3);
		...
		case 2:
			...
			else if (!CAM::IS_CAM_ACTIVE(uLocal_341))
			{
		...
		case 4:
			if (!CAM::DOES_CAM_EXIST(uLocal_342))
			{
				...
				CAM::_0x0A9F2A468B328E74(uLocal_342, uLocal_341, 1500, 3);
...
void func_383()
{
	if (func_506(PLAYER::PLAYER_PED_ID()))
	{
		if (!func_319(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				UI::SET_BLIP_FLASHES(uLocal_339, 1);
			}
		}
		else if (!UI::DOES_BLIP_EXIST(uLocal_339))
		{
		...
		{
			UI::SET_BLIP_FLASHES(uLocal_339, 0);
		}
	}
}
...
{
	if (func_255(&uLocal_883, ENTITY::GET_ENTITY_COORDS(uParam0, 0)))
	{
		return 1;
	}
	return 0;
...
void func_412(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_414(Var11.f_1)) && iVar72 < 51)
			{
...
void func_418(var uParam0)
{
	...
	if (func_185(iVar0) && !PED::IS_PED_INJURED(uParam0))
	{
...
int func_427(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_442(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_428(iVar0, 0), 1);
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_450(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_462(int iParam0)
{
	...
	{
		if (!UI::DOES_BLIP_EXIST(uLocal_340))
		{
			uLocal_340 = func_463(-1377.18f, 55.39f, 53.7f, 0);
			UI::SET_BLIP_SPRITE(uLocal_340, 109);
		}
		iLocal_690 = 0;
	}
}
...
var func_463(vector3 vParam0, int iParam3)
{
	...
	UI::SET_BLIP_SCALE(uVar0, func_464(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
void func_465()
{
	while (iLocal_354 == 0)
	{
		if (func_466(0))
		{
			...
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_455, 1, 1);
			func_476(Local_455, 0);
			...
			if (func_506(Local_455))
			{
				Local_782.f_3 = { OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(Local_455, 1), 1067030938, 1069547520) };
			}
...
void func_470()
{
	...
	PED::REMOVE_RELATIONSHIP_GROUP(uLocal_774);
...
void func_507()
{
	...
	PED::ADD_RELATIONSHIP_GROUP("SecurityGroup", &uLocal_774);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_774, -1533126372);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, uLocal_774);
