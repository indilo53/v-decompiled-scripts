						...
						if ((!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(uLocal_3109, 0)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_3109, 0))
						{
							if (!iLocal_468)
							{
								if (ENTITY::DOES_ENTITY_EXIST(Local_2996[0 /*20*/].f_6))
								{
									...
									{
										func_140(&uLocal_399, ENTITY::GET_ENTITY_COORDS(Local_2996[0 /*20*/].f_6, 1), 0, 0, 1, 1, 1);
									}
								}
							}
							else
...
int func_49()
{
	...
	switch (iLocal_3115)
	{
		...
		case 15:
			...
			func_94(&uLocal_2608, "TOW_UI07", 500, SYSTEM::ROUND(fLocal_428), SYSTEM::ROUND(fLocal_429), "TOW_UI08", 4000, 1);
			if (iLocal_472 > 0)
			{
...
void func_62(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_64() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_64() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
int func_70(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_64() /*10778*/].f_6165.f_10, iParam0);
}
...
int func_99(char* sParam0, vector3 vParam1)
{
	...
	while (iVar1 < 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_2996[iVar1 /*20*/].f_6))
		{
			...
			{
				if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[iVar1 /*20*/].f_6) && func_105())
				{
...
void func_106()
{
	...
	if (((!ENTITY::IS_ENTITY_DEAD(uLocal_3109, 0) && !ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0)) && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6)) || (Global_106565.f_19967.f_3 == 0 || Global_106565.f_19967.f_3 > 2))
	{
		return;
	}
	switch (iLocal_3050)
...
int func_116(var uParam0, var uParam1, int iParam2, int iParam3, float fParam4, float fParam5, bool bParam6)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0) && ENTITY::DOES_ENTITY_EXIST(uParam1))
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0) && !ENTITY::IS_ENTITY_DEAD(uParam1, 0))
		{
			...
			if (!ENTITY::IS_ENTITY_OCCLUDED(uParam0) && func_111(uParam0, 1) < fParam4)
			{
				*iParam2++;
			}
			else
			...
			if (((*iParam2 > iParam3 || func_111(uParam0, 1) < 8f) && ENTITY::GET_ENTITY_SPEED(uParam1) < fParam5) && !ENTITY::IS_ENTITY_OCCLUDED(uParam0))
			{
				*iParam2 = 0;
				return 1;
			}
...
void func_117()
{
	...
	if (!bLocal_2940)
	{
		iVar0 = SYSTEM::ROUND(((300f - func_121(&uLocal_3100)) * 1000f));
		if (iLocal_420 == 3)
		{
			if ((iVar0 / 1000) < 60)
			{
...
int func_126(bool bParam0, int iParam1)
{
	...
	else if (Local_650[iLocal_2604 /*23*/] == 4)
	{
		fLocal_3066 = -1f;
		iLocal_2950 = 1;
		uLocal_3110 = VEHICLE::CREATE_VEHICLE(joaat("ambulance"), Local_1870[func_250() /*28*/].f_23, Local_1870[func_250() /*28*/].f_26, 1, 1, 0);
...
void func_140(var uParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, int iParam7, bool bParam8)
{
	...
	else
	{
		if (!GAMEPLAY::IS_STRING_NULL(iVar0))
		{
			if (func_104(iVar0) && UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
			{
				UI::CLEAR_HELP(1);
			}
		}
...
int func_145(char* sParam0)
{
	if (!func_146(1, 1, 0))
	{
		if ((!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sParam0) && func_104(sParam0)) || func_104("CMN_HINT"))
		{
			UI::CLEAR_HELP(1);
		}
		return 0;
...
int func_146(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_154() || func_153(Global_4456448.f_161209)) || func_152())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_150(uVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_170(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_171(PLAYER::PLAYER_PED_ID(), uParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (PED::IS_PED_RAGDOLL(uParam0) && func_111(uParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_173(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (WEAPON::IS_PED_ARMED(uParam0, 2))
	{
		...
		else
		{
			...
			if (PED::IS_PED_PLANTING_BOMB(uParam0) || func_174(iVar3))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(uParam1, ENTITY::GET_ENTITY_COORDS(uParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (PED::IS_PED_FACING_PED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(uParam1), uParam0, 120f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(uParam1, uParam0, 17))
...
void func_181(var uParam0)
{
	...
	while (iVar0 < 1)
	{
		...
		if (iVar0 == 0)
		{
			Local_2556[iVar0 /*18*/].f_8 = { func_182(GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 0f) };
		}
		else
		{
...
int func_194()
{
	...
	switch (iLocal_3118)
	{
		...
		case 1:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uLocal_3109, 0) && !ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
			{
				if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6) || func_202(uLocal_3109, Local_2996[0 /*20*/].f_6, !(bLocal_2965 || bLocal_2966)))
				{
		...
		case 2:
			...
			if (!ENTITY::IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(Local_2996[0 /*20*/], 0))
				{
					...
					{
						if (func_198() || (!VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6) && !bLocal_2979))
						{
							func_166();
							iLocal_3118 = 5;
						}
...
int func_202(var uParam0, var uParam1, bool bParam2)
{
	...
	iVar0 = 0;
	if (PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::GET_PLAYER_INDEX()) && func_111(uParam1, 1) < 40f)
	{
		iVar0 = 1;
	}
	...
	if (!bLocal_467)
	{
		...
		switch (iLocal_2601)
		{
			...
			case 2:
				...
				{
					if (((SYSTEM::TIMERA() > 12000 || func_112(uParam0, uParam1, 1) < 15f) && func_112(uParam0, uParam1, 1) < 30f) && !func_41())
					{
			...
			case 4:
				...
				{
					if ((SYSTEM::TIMERA() > 12000 || func_112(uParam0, uParam1, 1) < 7.5f) || (iLocal_468 && func_112(uParam0, uParam1, 1) < 30f))
					{
						iLocal_443 = 1;
