...
void func_1()
{
	...
	{
		vVar0 = { ENTITY::GET_ENTITY_COORDS(uLocal_33, 0) };
		...
		if (SYSTEM::VDIST2(vVar3, vVar0) < IntToFloat(func_18(iLocal_29)))
		{
			...
			if (bVar6)
			{
				UI::SET_RADAR_AS_INTERIOR_THIS_FRAME(GAMEPLAY::GET_HASH_KEY(func_13(iLocal_29)), vVar3.x, vVar3.y, func_12(iLocal_29), func_11(iLocal_29));
				func_10(iLocal_29);
			}
		}
	}
