...
int func_2()
{
	...
	fVar0 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_82);
	if (fVar0 > (100f * 100f))
	{
		return 1;
	}
...
void func_19()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&cLocal_117))
		{
	...
	while (iVar0 < iLocal_72)
	{
		if (iLocal_77[iVar0] != 0)
		{
			iLocal_72[iVar0] = PED::CREATE_PED(26, iLocal_77[iVar0], vLocal_82 + vLocal_86[iVar0 /*3*/], 0, 1, 1);
			...
			AI::TASK_PLAY_ANIM_ADVANCED(iLocal_72[iVar0], &cLocal_117, &(Local_125[iVar0 /*8*/]), vLocal_82 + vLocal_86[iVar0 /*3*/], Vector(uLocal_85, 0f, 0f) + vLocal_99[iVar0 /*3*/], 1000f, -8f, -1, iLocal_158, 0, 2, 0);
...
void func_21()
{
	...
	switch (iLocal_70)
	{
		case 280:
			...
			iLocal_166[4] = 1015;
			iLocal_166[5] = 1015;
			vLocal_173[4 /*3*/] = { vLocal_173[0 /*3*/] + vLocal_173[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f)) };
			vLocal_173[5 /*3*/] = { vLocal_173[1 /*3*/] + vLocal_173[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f)) };
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_23(uParam109, 17, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_23(uParam109, 144, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_23(uParam109, 43, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
