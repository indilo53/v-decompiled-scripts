...
int func_186(var uParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_126(PLAYER::PLAYER_PED_ID()) && func_126(uParam0->f_28[0])) && !func_145()) && (GAMEPLAY::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_190(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
	...
	if (func_126(*uParam1) && func_126(PLAYER::PLAYER_PED_ID()))
	{
		switch (*iParam0)
		{
			case 0:
				...
				AI::TASK_PLAY_ANIM(*uParam1, cLocal_99, "base", 1000f, -8f, -1, 1, 0, 0, 0, 0);
				*iParam0 = 1;
				break;
			...
			case 1:
				...
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, 0, 1, 0))
					{
						AI::TASK_PLAY_ANIM(*uParam1, cLocal_99, "intro", 8f, -8f, -1, 2, 0, 0, 0, 0);
						*iParam0 = 3;
					}
				...
				{
					AI::TASK_PLAY_ANIM(*uParam1, cLocal_99, "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				break;
			...
			case 4:
				if (func_192(&(iParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, 0, 1, 0))
					{
						AI::TASK_PLAY_ANIM(*uParam1, cLocal_99, "loop_talk", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
					*iParam0 = 5;
				}
				break;
				...
				if (!func_145())
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_99, "loop_talk", 3))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_99, "loop_talk") > 0.99f)
						{
							...
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, 0, 1, 0))
							{
								AI::TASK_PLAY_ANIM(*uParam1, cLocal_99, "outro", 8f, -8f, -1, 2, 0, 0, 0, 0);
								*iParam0 = 1;
							}
							else
							{
								AI::TASK_PLAY_ANIM(*uParam1, cLocal_99, "loop_look", 8f, -8f, -1, 1, 0, 0, 0, 0);
								*iParam0 = 2;
							}
						}
					}
...
int func_255(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!STREAMING::HAS_MODEL_LOADED(uVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(cLocal_99))
			{
				return 0;
			}
			iLocal_91 = 2;
