...
int func_2()
{
	...
	if (!func_3(&uVar0))
	{
		vVar1 = { ENTITY::GET_ENTITY_COORDS(uLocal_72, 0) };
		fVar4 = SYSTEM::VDIST2(vLocal_176 + vLocal_181, vVar1);
		if (fVar4 < (4.5f * 4.5f))
		{
			AI::TASK_VEHICLE_DRIVE_WANDER(uLocal_72, uLocal_74, uLocal_179, 786599);
			return 1;
		}
	}
	return 0;
	...
	if (!func_3(&uVar0))
	{
		...
		else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
		{
			...
			if (!func_5(Global_93403, uLocal_74, 2))
			{
				if (fVar1 >= 0.9f)
				{
					PED::SET_PED_INTO_VEHICLE(Global_93403, uLocal_74, 2);
				}
			}
			if (!iLocal_180)
			{
			...
			AI::TASK_VEHICLE_TEMP_ACTION(uLocal_72, uLocal_74, 6, 50);
		}
		else
		{
			if (!func_5(Global_93403, uLocal_74, 2))
			...
			if (!func_3(&uVar0))
			{
				...
				AI::TASK_VEHICLE_TEMP_ACTION(0, uLocal_74, 24, 50);
				AI::TASK_PAUSE(0, 2000);
				AI::TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_74, vLocal_176 + vLocal_181, uLocal_179, 0, uLocal_75, 786599, ((4.5f / 2f) - 1f), 10f);
				AI::CLOSE_SEQUENCE_TASK(uVar2);
				AI::TASK_PERFORM_SEQUENCE(uLocal_72, uVar2);
...
void func_21()
{
	...
	uLocal_74 = VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(vLocal_181 + vLocal_173, 15f, uLocal_75, 2);
	iVar0 = 0;
	while ((!ENTITY::DOES_ENTITY_EXIST(Global_93403) || !ENTITY::DOES_ENTITY_EXIST(uLocal_74)) || (!STREAMING::HAS_MODEL_LOADED(iLocal_73) && iVar0 < 400))
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_74))
		{
			uLocal_74 = VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(vLocal_181 + vLocal_173, 15f, uLocal_75, 2);
		}
		iVar0++;
	...
	if (!ENTITY::IS_ENTITY_DEAD(uLocal_74, 0))
	{
		VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_74, 1, 1, 0);
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_74, 2);
		VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_74, 1084227584);
		uLocal_72 = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_74, 4, iLocal_73, -1, 1, 1);
		PED::SET_PED_RANDOM_COMPONENT_VARIATION(uLocal_72, 0);
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_26(uParam109, 17, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_26(uParam109, 144, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_26(uParam109, 43, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
...
void func_49()
{
	if (!ENTITY::IS_ENTITY_DEAD(uLocal_72, 0) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(uLocal_72, 1))
	{
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uLocal_72);
	}
	if (!ENTITY::IS_ENTITY_DEAD(uLocal_74, 0) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(uLocal_74, 1))
	{
		ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_74);
	}
