...
void func_133()
{
	...
	func_140();
	func_107();
	if (func_74(PLAYER::PLAYER_PED_ID(), vLocal_106, 150f) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -176.9431f, -651.257f, 31.2136f, -150.9563f, -579.7476f, 35.4245f, 50f, 0, 1, 0))
	{
		GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_106, 6f, 0, 1, 0, 0, 0, 0);
...
var func_141(vector3 vParam0, int iParam3)
{
	...
	UI::SET_BLIP_SCALE(uVar0, func_142(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
	...
	if (func_101(35))
	{
		if (iLocal_38 == 0)
		{
			if (!GAMEPLAY::IS_BIT_SET(uLocal_105, 1))
			{
				if (func_83(iLocal_109))
				{
					ENTITY::IS_ENTITY_AT_COORD(iLocal_109, vLocal_106, 4f, 4f, 2f, 1, 1, 0);
...
int func_167()
{
	...
	{
		iLocal_40 = 1;
		func_168(192, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
		return 1;
	}
	return 0;
}
...
void func_196()
{
	...
	if (((((((Global_36425 == 15 && iLocal_37 != 3) && GAMEPLAY::IS_BIT_SET(uLocal_105, 5)) && !func_164()) && Global_71587 == -1) && !func_206()) && !func_82(9)) || func_101(35))
	{
		func_205();
		func_204();
		switch (iLocal_39)
