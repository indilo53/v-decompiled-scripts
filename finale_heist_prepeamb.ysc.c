...
void func_196()
{
	...
	if (((((((Global_36117 == 15 && iLocal_37 != 3) && GAMEPLAY::IS_BIT_SET(uLocal_105, 5)) && !func_164()) && Global_71202 == -1) && !func_206()) && !func_82(9)) || func_101(35))
	{
		func_205();
		func_204();
		switch (iLocal_39)
...
int func_220(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2535519[iParam0 /*3*/][func_221(iParam1)];
