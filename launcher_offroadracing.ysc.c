		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_85) && !ENTITY::IS_ENTITY_DEAD(uLocal_85, 0))
		{
			...
			switch (iLocal_95)
			{
						...
						if (bVar3)
						{
							...
							if (bVar3)
							{
								...
								if (func_86(iLocal_86))
								{
									...
									else if (!func_136(uLocal_94, 2048) || !UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_84(&iLocal_96);
				...
				case 6:
					...
					if (func_136(uLocal_94, 2097152))
					{
						if (!func_108(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_52))
						{
							func_129(10);
						}
					}
...
void func_54()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_157) && !ENTITY::IS_ENTITY_DEAD(uLocal_157, 0))
	{
		if (AUDIO::IS_AMBIENT_SPEECH_PLAYING(uLocal_157))
		{
			return;
		}
	}
...
void func_71()
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uLocal_157, 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		switch (iLocal_328)
		{
			case 0:
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uLocal_157, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 64f && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					iLocal_161 = 0;
					iLocal_162 = 0;
					iLocal_328 = 1;
			...
			case 1:
				...
				AI::TASK_PERFORM_SEQUENCE(uLocal_157, uVar1);
				AI::CLEAR_SEQUENCE_TASK(&uVar1);
				iLocal_328 = 2;
				break;
			
			case 2:
				if ((AI::GET_SCRIPT_TASK_STATUS(uLocal_157, 242628503) != 1 || PED::IS_PED_FACING_PED(uLocal_157, PLAYER::PLAYER_PED_ID(), 20f)) && !AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
				{
					AI::TASK_TURN_PED_TO_FACE_ENTITY(uLocal_157, PLAYER::PLAYER_PED_ID(), -1);
					if (!iLocal_162)
					{
			...
			case 3:
				...
				{
					func_33(&uLocal_144);
					AI::TASK_PLAY_ANIM(uLocal_157, "random@street_race", "_streetracer_wait_loop", 4f, -4f, -1, 9, 0, 0, 0, 0);
					iLocal_328 = 4;
				}
				break;
			
			case 4:
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uLocal_157, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 225f)
				{
					...
					AI::TASK_PERFORM_SEQUENCE(uLocal_157, uVar2);
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_73(iParam3), 0);
}
...
void func_74()
{
	...
	while (iVar2 < 5)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_329[iVar2 /*14*/].f_1) && ENTITY::DOES_ENTITY_EXIST(Local_329[iVar2 /*14*/]))
		{
			...
			if (!PED::IS_PED_INJURED(Local_329[iVar2 /*14*/]))
			{
				if (func_26(&(vLocal_125[iVar2 /*3*/])))
				{
					if (func_23(&(vLocal_125[iVar2 /*3*/])) > uLocal_150[iVar2])
					{
						...
						{
							uVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500);
							uVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500);
							AI::OPEN_SEQUENCE_TASK(&uVar3);
							AI::TASK_VEHICLE_TEMP_ACTION(0, Local_329[iVar2 /*14*/].f_1, 1, uVar0);
							AI::TASK_VEHICLE_TEMP_ACTION(0, Local_329[iVar2 /*14*/].f_1, 31, uVar1);
							AI::CLOSE_SEQUENCE_TASK(uVar3);
							if (!PED::IS_PED_INJURED(Local_329[iVar2 /*14*/]))
							{
								AI::TASK_PERFORM_SEQUENCE(Local_329[iVar2 /*14*/], uVar3);
							}
			...
			{
				if ((ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_329[iVar2 /*14*/]) && !PED::IS_PED_RAGDOLL(Local_329[iVar2 /*14*/])) && !AI::IS_PED_GETTING_UP(Local_329[iVar2 /*14*/]))
				{
				...
				else if (Local_329[iVar2 /*14*/].f_11)
				{
					...
					AI::TASK_PLAY_ANIM(0, Local_329[iVar2 /*14*/].f_12, Local_329[iVar2 /*14*/].f_13, 4f, -8f, -1, 1, 0, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uVar3);
					AI::TASK_PERFORM_SEQUENCE(Local_329[iVar2 /*14*/], uVar3);
					AI::CLEAR_SEQUENCE_TASK(&uVar3);
				...
				{
					if (!Local_329[iVar2 /*14*/].f_10 && (PED::IS_PED_RAGDOLL(Local_329[iVar2 /*14*/]) || AI::IS_PED_GETTING_UP(Local_329[iVar2 /*14*/])))
					{
						Local_329.f_101++;
					}
				...
				else if (Local_329[iVar2 /*14*/].f_10)
				{
					...
					AI::TASK_PLAY_ANIM(0, "gestures@m@standing@casual", func_75(), 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					AI::TASK_ACHIEVE_HEADING(0, Local_329[iVar2 /*14*/].f_9, 1000);
					AI::TASK_PLAY_ANIM(0, Local_329[iVar2 /*14*/].f_12, Local_329[iVar2 /*14*/].f_13, 4f, -8f, -1, 1, 0, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uVar3);
					AI::TASK_PERFORM_SEQUENCE(Local_329[iVar2 /*14*/], uVar3);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_329.f_83.f_1) && ENTITY::DOES_ENTITY_EXIST(Local_329.f_83))
	{
			...
			if (func_26(&uLocal_141))
			{
				if (func_23(&uLocal_141) > fLocal_156)
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_329.f_83.f_1, 0) && PED::IS_PED_IN_VEHICLE(Local_329.f_83, Local_329.f_83.f_1, 0))
					{
						...
						uVar1 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500);
						AI::OPEN_SEQUENCE_TASK(&uVar3);
						AI::TASK_VEHICLE_TEMP_ACTION(0, Local_329.f_83.f_1, 1, uVar0);
						AI::TASK_VEHICLE_TEMP_ACTION(0, Local_329.f_83.f_1, 31, uVar1);
						AI::CLOSE_SEQUENCE_TASK(uVar3);
						if (!PED::IS_PED_INJURED(Local_329.f_83))
						{
							AI::TASK_PERFORM_SEQUENCE(Local_329.f_83, uVar3);
						}
						AI::CLEAR_SEQUENCE_TASK(&uVar3);
					}
					func_33(&uLocal_141);
		...
		{
			if ((ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_329.f_83) && !PED::IS_PED_RAGDOLL(Local_329.f_83)) && !AI::IS_PED_GETTING_UP(Local_329.f_83))
			{
			...
			else if (Local_329.f_83.f_10)
			{
				...
				AI::TASK_PLAY_ANIM(0, "gestures@m@standing@casual", func_75(), 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
				AI::TASK_ACHIEVE_HEADING(0, Local_329.f_83.f_9, 1000);
				AI::TASK_PLAY_ANIM(0, Local_329.f_83.f_12, Local_329.f_83.f_13, 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
				AI::CLOSE_SEQUENCE_TASK(uVar3);
				AI::TASK_PERFORM_SEQUENCE(Local_329.f_83, uVar3);
				AI::CLEAR_SEQUENCE_TASK(&uVar3);
				iLocal_328 = 4;
	...
	while (iVar12 < iVar0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iVar0[iVar12]) && !PED::IS_PED_INJURED(iVar0[iVar12]))
		{
			...
			else
			{
				...
				AI::TASK_PERFORM_SEQUENCE(iVar0[iVar12], uVar11);
...
int func_79(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
		if (!PED::IS_PED_INJURED(uParam0))
		{
			...
			if (bParam2)
			{
				if (PED::IS_PED_IN_COMBAT(uParam0, iVar0))
				{
					return 1;
				}
			}
			...
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(PED::GET_VEHICLE_PED_IS_IN(uParam0, 0), iVar0, 1))
				{
					return 1;
				}
			}
			...
			if (WEAPON::IS_PED_ARMED(iVar0, 4))
			{
				...
				{
					if (ENTITY::IS_ENTITY_AT_COORD(uParam0, ENTITY::GET_ENTITY_COORDS(iVar0, 1), 45f, 45f, 45f, 0, 1, 0))
					{
						return 1;
					}
				}
			...
			{
				if (PED::GET_PEDS_JACKER(uParam0) == iVar0)
				{
					return 1;
				}
			}
...
var func_81(var uParam0, var uParam1, var uParam2)
{
	...
	return GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vVar0, vVar3, uParam2);
}
...
void func_112()
{
	...
	if (fLocal_110 > 9f)
	{
		...
		while (iVar5 < Local_329)
		{
			...
			{
				Local_329[iVar5 /*14*/].f_1 = VEHICLE::CREATE_VEHICLE(func_116(0), Local_329[iVar5 /*14*/].f_2, Local_329[iVar5 /*14*/].f_5, 1, 1, 0);
				...
				{
					Local_329[iVar5 /*14*/] = PED::CREATE_PED_INSIDE_VEHICLE(Local_329[iVar5 /*14*/].f_1, 4, func_115(), -1, 1, 1);
					VEHICLE::SET_VEHICLE_ENGINE_ON(Local_329[iVar5 /*14*/].f_1, 1, 0, 0);
				}
				else
				{
					Local_329[iVar5 /*14*/] = PED::CREATE_PED(4, func_115(), Local_329[iVar5 /*14*/].f_6, Local_329[iVar5 /*14*/].f_9, 1, 1);
					iVar1 = iVar5;
					switch (iVar1)
					{
						case 0:
					...
					AI::TASK_PLAY_ANIM(0, sVar3, sVar4, 8f, -8f, -1, 8193, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uVar0);
					AI::TASK_PERFORM_SEQUENCE(Local_329[iVar5 /*14*/], uVar0);
		...
		Local_329.f_83.f_1 = VEHICLE::CREATE_VEHICLE(func_116(1), Local_329.f_83.f_2, Local_329.f_83.f_5, 1, 1, 0);
		...
		else
		{
			...
			AI::TASK_PLAY_ANIM(0, "amb@world_human_aa_smoke@male@idle_a", sVar4, 8f, -8f, -1, 1, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 0, 0, 0);
			AI::CLOSE_SEQUENCE_TASK(uVar0);
			AI::TASK_PERFORM_SEQUENCE(Local_329.f_83, uVar0);
			AI::CLEAR_SEQUENCE_TASK(&uVar0);
		}
	}
...
void func_121()
{
	switch (iLocal_124)
	{
		case 0:
			...
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-227.43f, 3888.9f, 36.41f, 50f, 1, 0, 0, 0, 0, 0);
...
int func_138(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		return GAMEPLAY::IS_BIT_SET(Global_26140[iVar0 /*23*/].f_11, 15);
	}
	return GAMEPLAY::IS_BIT_SET(Global_26140[iVar0 /*23*/].f_11, 0);
}
