...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		while (iVar0 < Local_131)
		{
			...
			{
				Local_131[iVar0 /*18*/].f_8 = { ENTITY::GET_ENTITY_COORDS(Local_131[iVar0 /*18*/], 1) };
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < Local_204)
		{
			...
			{
				Local_204[iVar0 /*18*/].f_6 = { ENTITY::GET_ENTITY_COORDS(Local_204[iVar0 /*18*/], 1) };
			}
			iVar0++;
		}
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			vLocal_60 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
		}
		if (!PED::IS_PED_INJURED(uLocal_86))
		{
			vLocal_63 = { ENTITY::GET_ENTITY_COORDS(uLocal_86, 1) };
		}
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_91) && !ENTITY::IS_ENTITY_DEAD(iLocal_91, 0))
		{
			vLocal_66 = { ENTITY::GET_ENTITY_COORDS(iLocal_91, 1) };
		}
		if (!func_224())
		{
		...
		else
		{
			...
			if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_63, 210f, 210f, 210f, 0, 1, 0))
			{
				func_193();
				func_274();
			}
		...
		if (iLocal_47 <= 0)
		{
			...
			{
				if ((!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 243.6443f, 123.7193f, 97.59898f, 262.4353f, 116.8746f, 107.4762f, 32.25f, 0, 1, 0) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_564) > 5000) && !PED::IS_PED_INJURED(Local_204[iVar1 /*18*/]))
				{
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(Local_204[iVar1 /*18*/], 1), vLocal_60) < (30.5f * 30.5f) && SYSTEM::VDIST2(vLocal_63, vLocal_60) > (22.5f * 22.5f))
					{
						if (func_224())
						{
...
int func_24()
{
	...
	while (iVar0 < Local_204)
	{
		if ((ENTITY::DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/]) && !PED::IS_PED_INJURED(Local_204[iVar0 /*18*/])) && !PED::IS_PED_INJURED(uLocal_86))
		{
	...
	switch (iLocal_49)
	{
		case 0:
			...
			if (((((STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_genstreet_02")) && STREAMING::HAS_MODEL_LOADED(joaat("prop_pap_camera_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("cavalcade2"))) && STREAMING::HAS_MODEL_LOADED(joaat("vader"))) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_373)) && STREAMING::HAS_ANIM_DICT_LOADED("random@paparazzi@pap_anims"))
			{
				...
				ENTITY::SET_ENTITY_COORDS(func_56(0, 1), 265.408f, 151.2875f, 103.5673f, 1, 0, 0, 1);
				ENTITY::SET_ENTITY_HEADING(func_56(0, 1), 217.1033f);
				ENTITY::SET_ENTITY_COORDS(func_56(2, 1), 245.9477f, 72.661f, 89.1067f, 1, 0, 0, 1);
				ENTITY::SET_ENTITY_HEADING(func_56(2, 1), 38.6283f);
				ENTITY::SET_ENTITY_COORDS(func_56(3, 1), 244.1872f, 73.3336f, 89.0917f, 1, 0, 0, 1);
				ENTITY::SET_ENTITY_HEADING(func_56(3, 1), 272.9875f);
				AI::TASK_PLAY_ANIM(func_56(0, 1), "random@paparazzi@pap_anims", "base_pap", 8f, -8f, -1, 1, 0, 0, 0, 0);
				AI::TASK_PLAY_ANIM(func_56(1, 0), "random@paparazzi@pap_anims", "pap_idle_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
				AI::TASK_PLAY_ANIM(func_56(1, 1), "random@paparazzi@pap_anims", "pap_idle_b", 8f, -8f, -1, 1, 0, 0, 0, 0);
				AI::TASK_PLAY_ANIM(func_56(2, 1), "random@paparazzi@pap_anims", "pap_idle_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
				AI::TASK_PLAY_ANIM(func_56(3, 1), "random@paparazzi@pap_anims", "pap_idle_b", 8f, -8f, -1, 1, 0, 0, 0, 0);
				iLocal_49 = 1;
			}
			break;
			...
			switch (iLocal_616)
			{
				case 0:
					...
					if (!ENTITY::DOES_ENTITY_EXIST(Local_131[2 /*18*/]))
					{
						...
						{
							func_58(func_61(2), ENTITY::GET_ENTITY_COORDS(Local_131[2 /*18*/], 1), 0f);
					...
					{
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(2, 1), vLocal_581, 2f, -1, 1048576000, 0, 1193033728);
					}
					if (!PED::IS_PED_INJURED(func_56(3, 1)))
					{
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(3, 1), vLocal_584, 2f, -1, 1048576000, 0, 1193033728);
					}
					...
					if (Global_3 || bLocal_70)
					{
						if (!PED::IS_PED_INJURED(func_56(1, 0)))
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(1, 0), vLocal_587, 2f, 20000, 1048576000, 0, 1193033728);
						}
						if (!PED::IS_PED_INJURED(func_56(1, 1)))
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(1, 1), vLocal_590, 2f, 20000, 1048576000, 0, 1193033728);
						}
						if (!PED::IS_PED_INJURED(func_56(0, 1)))
						{
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(0, 1), vLocal_593, 2f, 20000, 1048576000, 0, 1193033728);
						}
					}
					SYSTEM::SETTIMERB(0);
					iVar1 = 0;
				...
				case 1:
					...
					if ((VEHICLE::IS_VEHICLE_DRIVEABLE(Local_131[0 /*18*/], 0) && !PED::IS_PED_INJURED(func_56(0, 0))) && !PED::IS_PED_INJURED(func_56(0, 1)))
					{
						...
						{
							iLocal_571[1] = 1;
							AI::TASK_VEHICLE_DRIVE_TO_COORD(func_56(0, 0), Local_131[0 /*18*/], vLocal_575, 10f, 0, joaat("cavalcade2"), 786469, 2f, 10f);
						}
					}
					if ((VEHICLE::IS_VEHICLE_DRIVEABLE(Local_131[2 /*18*/], 0) && !PED::IS_PED_INJURED(func_56(2, 0))) && !PED::IS_PED_INJURED(func_56(2, 1)))
					{
						if (!iLocal_571[0])
						{
							AI::TASK_VEHICLE_DRIVE_TO_COORD(func_56(2, 0), Local_131[2 /*18*/], vLocal_578, 10f, 0, joaat("cavalcade2"), 786469, 2f, 10f);
							iLocal_571[0] = 1;
						}
					}
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_86) && !PED::IS_PED_INJURED(uLocal_86))
					{
						func_46(uLocal_86, 6);
						if (Global_3 || bLocal_70)
						{
							if (!PED::IS_PED_INJURED(func_56(1, 0)))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(func_56(1, 0), vLocal_587, Global_22, 0, 1, 0))
								{
							...
							if (!PED::IS_PED_INJURED(func_56(1, 1)))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(func_56(1, 1), vLocal_590, Global_22, 0, 1, 0))
								{
							...
							if (!PED::IS_PED_INJURED(func_56(0, 1)))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(func_56(0, 1), vLocal_590, Global_22, 0, 1, 0))
								{
					...
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iLocal_91, 1), vLocal_87) < 9f)
					{
						if (ENTITY::IS_ENTITY_AT_COORD(func_56(2, 1), vLocal_581, Global_22, 0, 1, 0))
						{
							func_45(uLocal_86, func_59(2));
						}
						if (ENTITY::IS_ENTITY_AT_COORD(func_56(3, 1), vLocal_584, Global_22, 0, 1, 0))
						{
							func_45(uLocal_86, func_59(3));
						}
						if (ENTITY::IS_ENTITY_AT_COORD(func_56(0, 1), vLocal_584, Global_22, 0, 1, 0))
						{
							func_45(uLocal_86, func_59(0));
						}
					}
					...
					{
						if (!GAMEPLAY::IS_BIT_SET(uLocal_619, 3))
						{
							AI::CLEAR_PED_TASKS(Local_204[func_59(3) /*18*/]);
							GAMEPLAY::SET_BIT(&uLocal_619, 3);
						}
						if (!GAMEPLAY::IS_BIT_SET(uLocal_619, 2))
						{
							AI::CLEAR_PED_TASKS(Local_204[func_59(2) /*18*/]);
							GAMEPLAY::SET_BIT(&uLocal_619, 2);
						}
						if (!GAMEPLAY::IS_BIT_SET(uLocal_619, 0))
						{
							AI::CLEAR_PED_TASKS(Local_204[func_59(0) /*18*/]);
							GAMEPLAY::SET_BIT(&uLocal_619, 0);
						}
						if (Global_3 || bLocal_70)
						{
							func_45(uLocal_86, func_59(3));
			...
			while (iVar0 < Local_131)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_131[iVar0 /*18*/]) && iLocal_47 != 6)
				{
					if ((iVar0 < 2 && ((iVar0 != iLocal_614 || !ENTITY::DOES_ENTITY_EXIST(Local_131[0 /*18*/])) || !ENTITY::DOES_ENTITY_EXIST(Local_131[1 /*18*/]))) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_615) > 500)
					{
						...
						{
							if (SYSTEM::VDIST2(vLocal_60, vLocal_87) < 62500f || (GAMEPLAY::GET_GAME_TIMER() - iLocal_370) < 30000)
							{
					...
					switch (Local_131[iVar0 /*18*/].f_17)
					{
							...
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_131[iVar0 /*18*/], 0))
							{
								if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_131[iVar0 /*18*/], 0))
								{
									if (!PED::IS_PED_INJURED(Local_204[iVar2 /*18*/]))
									{
										...
										{
											if (AI::GET_SCRIPT_TASK_STATUS(Local_204[iVar2 /*18*/], -1794415470) != 1 && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_131[iVar0 /*18*/], -1, 0))
											{
												AI::TASK_ENTER_VEHICLE(Local_204[iVar2 /*18*/], Local_131[iVar0 /*18*/], -1, -1, 1073741824, 1, 0);
											}
										}
									}
									if (iVar3 != -1)
									{
										if (!PED::IS_PED_INJURED(Local_204[iVar3 /*18*/]))
										{
											...
											{
												if (AI::GET_SCRIPT_TASK_STATUS(Local_204[iVar3 /*18*/], -1794415470) != 1 && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_131[iVar0 /*18*/], 0, 0))
												{
													AI::TASK_ENTER_VEHICLE(Local_204[iVar3 /*18*/], Local_131[iVar0 /*18*/], -1, 0, 1073741824, 1, 0);
												}
											}
										}
										if (!PED::IS_PED_INJURED(Local_204[iVar2 /*18*/]) && (iVar3 != -1 && !PED::IS_PED_INJURED(Local_204[iVar3 /*18*/])))
										{
											...
											{
												if (AI::GET_SCRIPT_TASK_STATUS(Local_204[iVar2 /*18*/], -1273030092) != 1 && AI::GET_SCRIPT_TASK_STATUS(Local_204[iVar2 /*18*/], -1817882002) != 1)
												{
													...
													if (iVar0 == 0)
													{
														AI::TASK_VEHICLE_MISSION(Local_204[iVar2 /*18*/], Local_131[iVar0 /*18*/], iLocal_91, 10, 50f, 786471, 4f, 10f, 1);
													}
													else if (iVar0 == 1)
													{
														AI::TASK_VEHICLE_MISSION(Local_204[iVar2 /*18*/], Local_131[iVar0 /*18*/], iLocal_91, 11, 50f, 786470, 4f, 10f, 1);
													}
													else if (iVar0 == 2)
													{
														AI::TASK_VEHICLE_MISSION(Local_204[iVar2 /*18*/], Local_131[iVar0 /*18*/], iLocal_91, 10, 50f, 786471, 4f, 10f, 1);
												...
												AI::SET_DRIVE_TASK_CRUISE_SPEED(Local_204[iVar2 /*18*/], func_39((3f * GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_66, Local_131[iVar0 /*18*/].f_8, 1)), 50f, 120f));
											}
										}
									}
							...
							else
							{
								if (!PED::IS_PED_INJURED(Local_204[iVar2 /*18*/]))
								{
									if (!PED::IS_PED_FLEEING(Local_204[iVar2 /*18*/]))
									{
										...
										AI::TASK_SMART_FLEE_PED(Local_204[iVar2 /*18*/], PLAYER::PLAYER_PED_ID(), 300f, 100000, 0, 0);
									}
								}
								if (iVar3 != -1)
								{
									if (!PED::IS_PED_INJURED(Local_204[iVar3 /*18*/]))
									{
										if (!PED::IS_PED_FLEEING(Local_204[iVar3 /*18*/]))
										{
											...
											AI::TASK_SMART_FLEE_PED(Local_204[iVar3 /*18*/], PLAYER::PLAYER_PED_ID(), 300f, 100000, 0, 0);
										}
									}
								}
							}
						...
						case 1:
							...
							{
								AI::TASK_LEAVE_ANY_VEHICLE(Local_204[iVar2 /*18*/], 1, 256);
							}
							else
							{
							...
							if (iVar3 != -1)
							{
								if (!PED::IS_PED_INJURED(Local_204[iVar3 /*18*/]))
								{
									...
									{
										AI::TASK_LEAVE_ANY_VEHICLE(Local_204[iVar3 /*18*/], 0, 256);
									}
									else
									{
				...
				while (iVar0 < Local_131)
				{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_131[iVar0 /*18*/], 0))
					{
						if (!PED::IS_PED_INJURED(Local_204[iVar5 /*18*/]))
						{
							...
							{
								if (AI::GET_SCRIPT_TASK_STATUS(Local_204[iVar5 /*18*/], -1794415470) != 1)
								{
									AI::TASK_ENTER_VEHICLE(Local_204[iVar5 /*18*/], Local_131[iVar0 /*18*/], -1, -1, 1073741824, 1, 0);
								}
							}
						}
						if (iVar6 != -1)
						{
							if (!PED::IS_PED_INJURED(Local_204[iVar6 /*18*/]))
							{
								...
								{
									if (AI::GET_SCRIPT_TASK_STATUS(Local_204[iVar6 /*18*/], -1794415470) != 1)
									{
										AI::TASK_ENTER_VEHICLE(Local_204[iVar6 /*18*/], Local_131[iVar0 /*18*/], -1, 0, 1073741824, 1, 0);
									}
								}
							}
							if (!PED::IS_PED_INJURED(Local_204[iVar5 /*18*/]) && (iVar6 != -1 && !PED::IS_PED_INJURED(Local_204[iVar6 /*18*/])))
							{
								...
								{
									fVar7 = func_39((70f - (SYSTEM::TO_FLOAT((GAMEPLAY::GET_GAME_TIMER() - iLocal_85)) / 50f)), 0f, 70f);
									if (fVar7 <= 1f || (GAMEPLAY::GET_GAME_TIMER() - iLocal_85) > 4000)
									{
										AI::SET_DRIVE_TASK_MAX_CRUISE_SPEED(Local_204[iVar5 /*18*/], fVar7);
										iVar8 = 0;
										while (iVar8 < Local_131)
										{
											if ((VEHICLE::IS_VEHICLE_DRIVEABLE(Local_131[iVar8 /*18*/], 0) && !PED::IS_PED_INJURED(func_56(iVar8, 0))) && PED::IS_PED_IN_VEHICLE(func_56(iVar8, 0), Local_131[iVar8 /*18*/], 0))
											{
												...
												AI::TASK_VEHICLE_MISSION(func_56(iVar8, 0), Local_131[iVar8 /*18*/], 0, 5, 10f, 786468, 10f, 10f, 1);
											}
											iVar8++;
										}
										iLocal_618 = 1;
									}
									else if (AI::GET_SCRIPT_TASK_STATUS(Local_204[iVar5 /*18*/], -1273030092) != 1 && AI::GET_SCRIPT_TASK_STATUS(Local_204[iVar5 /*18*/], -1817882002) != 1)
									{
										...
										if (iVar0 == 0)
										{
											AI::TASK_VEHICLE_MISSION(Local_204[iVar5 /*18*/], Local_131[iVar0 /*18*/], iLocal_91, 10, fVar7, 786471, 4f, 10f, 1);
										}
										else if (iVar0 == 1)
										{
											AI::TASK_VEHICLE_MISSION(Local_204[iVar5 /*18*/], Local_131[iVar0 /*18*/], iLocal_91, 11, fVar7, 786470, 4f, 10f, 1);
										}
										else if (iVar0 == 2)
										{
											AI::TASK_VEHICLE_MISSION(Local_204[iVar5 /*18*/], Local_131[iVar0 /*18*/], iLocal_91, 10, fVar7, 786471, 4f, 10f, 1);
					...
					else
					{
						if (!PED::IS_PED_INJURED(Local_204[iVar5 /*18*/]))
						{
							if (!PED::IS_PED_FLEEING(Local_204[iVar5 /*18*/]))
							{
								...
								AI::TASK_SMART_FLEE_PED(Local_204[iVar5 /*18*/], PLAYER::PLAYER_PED_ID(), 300f, 100000, 0, 0);
							}
						}
						if (iVar6 != -1)
						{
							if (!PED::IS_PED_INJURED(Local_204[iVar6 /*18*/]))
							{
								if (!PED::IS_PED_FLEEING(Local_204[iVar6 /*18*/]))
								{
									...
									AI::TASK_SMART_FLEE_PED(Local_204[iVar6 /*18*/], PLAYER::PLAYER_PED_ID(), 300f, 100000, 0, 0);
								}
							}
						}
					}
				...
				if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_373))
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/].f_2) && ENTITY::IS_ENTITY_ATTACHED(Local_204[iVar0 /*18*/].f_2))
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(Local_204[iVar0 /*18*/], 0))
						{
							...
							{
								if (AI::IS_PED_GETTING_UP(Local_204[iVar0 /*18*/]))
								{
									ENTITY::SET_ENTITY_VISIBLE(Local_204[iVar0 /*18*/].f_2, 0, 0);
								}
							}
							else if (!AI::IS_PED_GETTING_UP(Local_204[iVar0 /*18*/]))
							{
							...
							if (!ENTITY::IS_ENTITY_OCCLUDED(Local_204[iVar0 /*18*/]))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_204[iVar0 /*18*/], sLocal_373, func_27(iVar0), 3))
								{
									if (!Local_204[iVar0 /*18*/].f_11)
									{
										...
										{
											AI::TASK_PLAY_ANIM(Local_204[iVar0 /*18*/], sLocal_373, "grip", 1000f, -1000f, -1, 57, 0, 0, 0, 0);
								...
								{
									AI::TASK_PLAY_ANIM(Local_204[iVar0 /*18*/], sLocal_373, "grip", 1000f, -1000f, -1, 48, 0.99f, 0, 0, 0);
...
void func_28(int iParam0)
{
	...
	while (iVar0 < 15)
	{
		if (GAMEPLAY::IS_BIT_SET(Local_204[iParam0 /*18*/].f_15, iVar0))
		{
			iVar1 = 5;
			...
			if (iVar3 < iVar1)
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_204[iParam0 /*18*/], sLocal_373, func_27(iParam0), 3))
				{
					...
					{
						GAMEPLAY::CLEAR_BIT(&(Local_204[iParam0 /*18*/].f_15), iVar0);
					}
				}
			}
			else if (iVar3 < iVar2)
	...
	if (!PED::IS_PED_INJURED(uLocal_86))
	{
		...
		if (((ENTITY::DOES_ENTITY_EXIST(Local_131[iLocal_568 /*18*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_131[iLocal_568 /*18*/], 0)) && ENTITY::DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/])) && !PED::IS_PED_INJURED(Local_204[iVar0 /*18*/]))
		{
			if (VEHICLE::IS_VEHICLE_MODEL(Local_131[iLocal_568 /*18*/], joaat("cavalcade2")))
			{
				if (SYSTEM::VDIST2(Local_204[iVar0 /*18*/].f_6, vLocal_63) < SYSTEM::POW(30f, 2f) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_131[iLocal_568 /*18*/], 0, 0) == Local_204[iVar0 /*18*/])
				{
					...
					else if (!func_36(iVar0) && (GAMEPLAY::GET_GAME_TIMER() - Local_204[iVar0 /*18*/].f_13) > 1000)
					{
						...
						{
							AI::TASK_PLAY_ANIM(Local_204[iVar0 /*18*/], sLocal_374, "base", 8f, 1000f, -1, 16, 0, 0, 0, 0);
						}
					}
				}
			}
			else if (!Local_204[iVar0 /*18*/].f_9)
			{
				if (SYSTEM::VDIST2(Local_204[iVar0 /*18*/].f_6, vLocal_63) < SYSTEM::POW(30f, 2f) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_131[iLocal_568 /*18*/], 0, 0) == Local_204[iVar0 /*18*/])
				{
					AI::TASK_SWEEP_AIM_ENTITY(Local_204[iVar0 /*18*/], "random@paparazzi@pap_anims", "sweep_low", "sweep_med", "sweep_high", -1, uLocal_86, 1070134723, 1048576000);
...
void func_30(int iParam0)
{
	...
	if (!PED::IS_PED_INJURED(Local_204[iParam0 /*18*/]) && !PED::IS_PED_INJURED(uLocal_86))
	{
		iVar0 = 15;
...
void func_31(int iParam0, int iParam1)
{
	if (iParam1 < 15)
	{
		if (!GAMEPLAY::IS_BIT_SET(Local_204[iParam0 /*18*/].f_15, iParam1))
		{
			if (func_33(iParam1))
			{
				AI::TASK_PLAY_ANIM(Local_204[iParam0 /*18*/], sLocal_374, iLocal_375[func_32(iParam1)], 4f, -4f, -1, 16, 0, 0, 0, 0);
			}
			else if (iParam1 < 5)
			{
				AI::TASK_PLAY_ANIM(Local_204[iParam0 /*18*/], sLocal_373, func_27(iParam0), 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
			}
			else
			{
				AI::TASK_PLAY_ANIM(Local_204[iParam0 /*18*/], sLocal_373, "grip", 1000f, -1000f, -1, 57, 0, 0, 0, 0);
			}
			Local_204[iParam0 /*18*/].f_15 = 0;
			GAMEPLAY::SET_BIT(&(Local_204[iParam0 /*18*/].f_15), iParam1);
		}
	}
}
...
float func_34(vector3 vParam0, vector3 vParam3)
{
	...
	fVar0 = (GAMEPLAY::ATAN2(vParam3.y, vParam3.x) - GAMEPLAY::ATAN2(vParam0.y, vParam0.x));
	if (fVar0 > 180f)
	{
		fVar0 = (fVar0 - 360f);
	}
...
bool func_36(int iParam0)
{
	...
	if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_374))
	{
		...
		while (iVar1 <= 13)
		{
			if (!bVar0)
			{
				if (GAMEPLAY::IS_BIT_SET(Local_204[iParam0 /*18*/].f_15, iVar1))
				{
					bVar0 = true;
				}
			}
...
void func_37(int iParam0)
{
	...
	if (UI::DOES_BLIP_EXIST(Local_131[iParam0 /*18*/].f_1))
	{
		UI::REMOVE_BLIP(&(Local_131[iParam0 /*18*/].f_1));
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Local_204[iVar1 /*18*/]) && ENTITY::IS_ENTITY_OCCLUDED(Local_204[iVar1 /*18*/]))
		{
			...
			if (UI::DOES_BLIP_EXIST(Local_204[iVar1 /*18*/].f_1))
			{
				UI::REMOVE_BLIP(&(Local_204[iVar1 /*18*/].f_1));
			}
...
void func_40(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, vector3 vParam7, int iParam10, float fParam11)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (((((ENTITY::DOES_ENTITY_EXIST(iParam1) && iParam0 != iParam1) && !VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iParam1)))
		{
			...
			{
				if (func_43(iParam0, iParam1, uLocal_358, ENTITY::GET_ENTITY_COORDS(iParam1, 1), ENTITY::GET_ENTITY_ROTATION(iParam1, 2)))
				{
					*uParam2 = { *uParam4 };
					*uParam3 = *uParam5;
			...
			{
				if ((func_42(iParam0, iParam1, 1) > fParam11 && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam1, 1), *uParam2, 1) > 20f) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), *uParam2) > 100f)
				{
					if (!func_41(*uParam2))
					{
...
int func_43(int iParam0, int iParam1, var uParam2, vector3 vParam3, vector3 vParam6)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam2))
	{
		...
		GAMEPLAY::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iParam1), &vVar13, &uVar16);
...
{
	if (!PED::IS_PED_INJURED(Local_204[iParam1 /*18*/]) && !PED::IS_PED_INJURED(uParam0))
	{
		if (!PED::IS_PED_FACING_PED(Local_204[iParam1 /*18*/], uParam0, 20f))
		{
			if (AI::GET_SCRIPT_TASK_STATUS(Local_204[iParam1 /*18*/], -875674219) != 1)
			{
				AI::TASK_TURN_PED_TO_FACE_ENTITY(Local_204[iParam1 /*18*/], uParam0, 0);
			}
		}
		else if ((GAMEPLAY::GET_GAME_TIMER() - Local_204[iParam1 /*18*/].f_13) > 2000)
		{
			...
			{
				AI::TASK_PLAY_ANIM(Local_204[iParam1 /*18*/], sLocal_373, func_27(iParam1), 4f, -4f, -1, 0, 0, 0, 0, 0);
...
void func_46(var uParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(Local_204[iParam1 /*18*/]) && !PED::IS_PED_INJURED(uParam0))
	{
		vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, func_48(iParam1)) };
		switch (Local_204[iParam1 /*18*/].f_16)
		{
			...
			case 1:
				if (AI::GET_SCRIPT_TASK_STATUS(Local_204[iParam1 /*18*/], 713668775) != 1 || SYSTEM::VDIST(vVar0, Local_204[iParam1 /*18*/].f_6) > 5f)
				{
					Local_204[iParam1 /*18*/].f_16++;
				}
				break;
			...
			case 3:
				...
				if (AI::GET_SCRIPT_TASK_STATUS(Local_204[iParam1 /*18*/], 713668775) != 1)
				{
...
void func_47(vector3 vParam0, int iParam3, var uParam4)
{
	...
	vVar0 = { func_35(ENTITY::GET_ENTITY_COORDS(uParam4, 1) - vParam0) };
	uVar3 = GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(vVar0.x, vVar0.y);
	Local_204[iParam3 /*18*/].f_3 = { vParam0 };
	AI::CLEAR_PED_TASKS(Local_204[iParam3 /*18*/]);
	if (SYSTEM::VDIST(vParam0, Local_204[iParam3 /*18*/].f_6) < 2f)
	{
		AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_204[iParam3 /*18*/], Local_204[iParam3 /*18*/].f_3, 1f, -1, 0.5f, 512, uVar3);
	}
	else
	{
		AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_204[iParam3 /*18*/], Local_204[iParam3 /*18*/].f_3, 2f, -1, 0.5f, 512, uVar3);
	}
}
...
void func_49()
{
	...
	while (iVar0 < Local_204)
	{
		if (UI::DOES_BLIP_EXIST(Local_204[iVar0 /*18*/].f_1))
		{
			if (PED::IS_PED_INJURED(Local_204[iVar0 /*18*/]))
			{
				UI::REMOVE_BLIP(&(Local_204[iVar0 /*18*/].f_1));
			}
		...
		else if (!PED::IS_PED_INJURED(Local_204[iVar0 /*18*/]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_204[iVar0 /*18*/], 0))
		{
			...
			UI::SET_BLIP_NAME_FROM_TEXT_FILE(Local_204[iVar0 /*18*/].f_1, "EP_PAPBLIP");
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < Local_131)
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_131[iVar0 /*18*/], 0))
		{
			if (UI::DOES_BLIP_EXIST(Local_131[iVar0 /*18*/].f_1))
			{
				vVar1 = { UI::GET_BLIP_COORDS(Local_131[iVar0 /*18*/].f_1) };
				...
				UI::SET_BLIP_COORDS(Local_131[iVar0 /*18*/].f_1, vVar1);
				if (func_52(Local_131[iVar0 /*18*/], 1, 0, 0, 0, 0, 1, 0, 1))
				{
					UI::REMOVE_BLIP(&(Local_131[iVar0 /*18*/].f_1));
				}
			}
			else if (!func_52(Local_131[iVar0 /*18*/], 1, 0, 0, 0, 0, 1, 0, 1))
			{
				Local_131[iVar0 /*18*/].f_1 = func_50(Local_131[iVar0 /*18*/].f_8, 0);
				UI::SET_BLIP_COLOUR(Local_131[iVar0 /*18*/].f_1, 1);
				UI::SET_BLIP_NAME_FROM_TEXT_FILE(Local_131[iVar0 /*18*/].f_1, "EP_PAPBLIP");
				UI::SET_BLIP_PRIORITY(Local_131[iVar0 /*18*/].f_1, 9);
			}
		}
		else if (UI::DOES_BLIP_EXIST(Local_131[iVar0 /*18*/].f_1))
		{
			UI::REMOVE_BLIP(&(Local_131[iVar0 /*18*/].f_1));
		}
		iVar0++;
...
void func_54(int iParam0, vector3 vParam1, float fParam4, char* sParam5, char* sParam6, int iParam7)
{
	...
	{
		if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(Local_204[iParam0 /*18*/], 1), vParam1) > 1.5f)
		{
			if (AI::GET_SCRIPT_TASK_STATUS(Local_204[iParam0 /*18*/], 713668775) != 1)
			{
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_204[iParam0 /*18*/], vParam1, 2f, -1, 0.25f, 0, fParam4);
			}
		}
		else if (GAMEPLAY::ABSF((func_55(ENTITY::GET_ENTITY_HEADING(Local_204[iParam0 /*18*/])) - func_55(fParam4))) > 10f)
		{
			if (AI::GET_SCRIPT_TASK_STATUS(Local_204[iParam0 /*18*/], 1920390111) != 1)
			{
				AI::TASK_ACHIEVE_HEADING(Local_204[iParam0 /*18*/], fParam4, 0);
			}
		}
		else
		{
			switch (Local_204[iParam0 /*18*/].f_16)
			{
				case 0:
					if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(iParam7))
					{
						...
						{
							AI::TASK_PLAY_ANIM(Local_204[iParam0 /*18*/], sParam5, sParam6, 4f, -4f, -1, 1, 0, 0, 0, 0);
						}
					}
					else if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_204[iParam0 /*18*/], sParam5, sParam6, 3))
					{
						AI::TASK_PLAY_ANIM(Local_204[iParam0 /*18*/], sParam5, sParam6, 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_204[iParam0 /*18*/], sParam5, sParam6) > 0.99f)
					{
						AI::TASK_PLAY_ANIM(Local_204[iParam0 /*18*/], sParam5, iParam7, 4f, -4f, -1, 0, 0, 0, 0, 0);
...
void func_57(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	if ((iParam0 % 2) == 1)
	{
		Local_131[iParam0 /*18*/] = VEHICLE::CREATE_VEHICLE(joaat("vader"), vParam1, fParam4, 1, 1, 0);
	}
	else
	{
		Local_131[iParam0 /*18*/] = VEHICLE::CREATE_VEHICLE(joaat("cavalcade2"), vParam1, fParam4, 1, 1, 0);
...
{
	Local_204[iParam0 /*18*/] = PED::CREATE_PED(26, joaat("a_m_y_genstreet_02"), vParam1, fParam4, 1, 1);
	...
	ENTITY::_SET_ENTITY_SOMETHING(Local_204[iParam0 /*18*/], 0);
...
int func_63()
{
	...
	if (!PED::IS_PED_INJURED(uLocal_86))
	{
		...
		if (func_66())
		{
			...
			{
				if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(func_65(), 1), vLocal_63) < 5f && ENTITY::GET_ENTITY_SPEED(iLocal_91) < 1f)
				{
					bVar0 = true;
				}
			}
		...
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_91, 0) && PED::IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 0))
			{
		...
		if (iLocal_71)
		{
			if (!PED::IS_PED_SITTING_IN_VEHICLE(uLocal_86, iLocal_91))
			{
				if (PED::IS_PED_RAGDOLL(uLocal_86))
				{
					bVar1 = true;
				}
				iLocal_71 = 0;
		...
		if (((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0) && func_64(iLocal_91)) && (!bLocal_368 || iLocal_47 == 1)) && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(uLocal_86, 1), vLocal_56) > 15f)
		{
			bVar1 = true;
		}
...
int func_66()
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
	{
		if (!PED::IS_PED_INJURED(uLocal_86))
		{
			if (PED::IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 0) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_91, 0))
			{
				return 1;
			}
		}
...
int func_68(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!PED::IS_PED_INJURED(uParam0))
	{
		...
		if (SYSTEM::VDIST2(vVar0, vLocal_60) < 400f)
		{
			...
			if (((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uParam0)) && (func_69(vLocal_60, uParam0) && SYSTEM::VDIST2(vLocal_60, ENTITY::GET_ENTITY_COORDS(uParam0, 1)) < 100f)) && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				return 1;
			}
			if (iLocal_385 > 150)
		...
		if (GRAPHICS::_0x2F09F7976C512404(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f), 6f))
		{
			return 1;
		}
	}
	else if (ENTITY::DOES_ENTITY_EXIST(uParam0) && iParam1)
	{
		return 1;
	}
	return 0;
...
int func_69(vector3 vParam0, var uParam3)
{
	...
	vVar0 = { ENTITY::GET_ENTITY_COORDS(uParam3, 1) };
	vVar3 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam3, 0f, 1f, 0f) - vVar0 };
	vVar6 = { vParam0 - vVar0 };
...
bool func_74()
{
	if (!PED::IS_PED_INJURED(uLocal_86) && SYSTEM::VDIST2(vLocal_60, vLocal_63) < 400f)
	{
...
void func_75()
{
	if (!PED::IS_PED_INJURED(uLocal_86))
	{
		...
		if (!Global_3 && !bLocal_70)
		{
			PED::SET_PED_CONFIG_FLAG(uLocal_86, 317, 1);
...
void func_100()
{
	...
	switch (iLocal_369)
	{
		case 0:
			if (!PED::IS_PED_INJURED(uLocal_86))
			{
				AI::TASK_SMART_FLEE_PED(uLocal_86, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
			}
			iVar0 = 0;
			while (iVar0 < Local_204)
			{
...
void func_101(char* sParam0)
{
	...
	if (!iLocal_672)
	{
		...
		while (iVar0 < Local_204)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/]) && !PED::IS_PED_INJURED(Local_204[iVar0 /*18*/]))
			{
				AI::CLEAR_PED_TASKS(Local_204[iVar0 /*18*/]);
		...
		if (ENTITY::DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/]))
		{
			if (!PED::IS_PED_INJURED(Local_204[iVar0 /*18*/]))
			{
				...
				if (!PED::IS_PED_INJURED(uLocal_86))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(Local_204[iVar0 /*18*/], 0))
					{
						AI::TASK_LEAVE_ANY_VEHICLE(Local_204[iVar0 /*18*/], 0, 0);
					}
					else
					{
				...
				else if (AI::GET_SCRIPT_TASK_STATUS(Local_204[iVar0 /*18*/], -1146898486) != 1)
				{
					AI::TASK_WANDER_STANDARD(Local_204[iVar0 /*18*/], 1193033728, 0);
				}
			}
	...
	while (iVar0 < Local_131)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_131[iVar0 /*18*/]))
		{
			if ((ENTITY::IS_ENTITY_OCCLUDED(Local_131[iVar0 /*18*/]) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(Local_131[iVar0 /*18*/], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 2500f) && func_52(Local_131[iVar0 /*18*/], 0, 0, 0, 0, 0, 1, 0, 1))
			{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_86))
	{
		if (ENTITY::IS_ENTITY_OCCLUDED(uLocal_86) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_63) > 2500f)
		{
	...
	switch (iLocal_369)
	{
		case 0:
			...
			if (!PED::IS_PED_INJURED(uLocal_86))
			{
				...
				PED::SET_PED_MAX_MOVE_BLEND_RATIO(uLocal_86, 3f);
			}
			func_102();
		...
		case 1:
			if (((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0) && PED::IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 0)) && !bLocal_368) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_91, -1, 0))
			{
				if (SYSTEM::VDIST(vLocal_63, vLocal_53) < 100f)
				{
					AI::OPEN_SEQUENCE_TASK(&uVar2);
					AI::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(0, iLocal_91, 0);
					AI::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_91, vLocal_53, 20f, 0, joaat("serrano"), 786599, 10f, 10f);
					AI::TASK_VEHICLE_PARK(0, iLocal_91, vLocal_53, 288.7089f, 1, 50f, 0);
					...
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_56, 1f, -1, 0.25f, 512, fLocal_59);
					AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_SMOKING", 0, 1);
					AI::CLOSE_SEQUENCE_TASK(uVar2);
					AI::TASK_PERFORM_SEQUENCE(uLocal_86, uVar2);
				...
				else
				{
					...
					AI::TASK_PERFORM_SEQUENCE(uLocal_86, uVar3);
			...
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_86, 0))
				{
					AI::TASK_LEAVE_ANY_VEHICLE(uLocal_86, 0, 0);
				}
				iLocal_369++;
			}
			break;
		...
		case 2:
			if (iVar1 > 0)
			{
				AI::TASK_SMART_FLEE_PED(uLocal_86, PLAYER::PLAYER_PED_ID(), 3000f, -1, 1, 0);
				iLocal_369 = 1000;
			}
			else
			{
				if (SYSTEM::VDIST(vLocal_63, vLocal_53) < 100f)
				{
					...
					AI::TASK_PERFORM_SEQUENCE(uLocal_86, uVar4);
					AI::CLEAR_SEQUENCE_TASK(&uVar4);
				}
				else
				{
					AI::TASK_WANDER_STANDARD(uLocal_86, 1193033728, 0);
				}
				iLocal_369 = 1000;
			}
			break;
...
{
	func_102();
	if (!PED::IS_PED_INJURED(uLocal_86) && SYSTEM::VDIST2(vLocal_60, vLocal_63) < 900f)
	{
		AI::CLEAR_PED_TASKS(uLocal_86);
		...
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_86, -2065892691);
	}
	else
	{
		func_193();
	...
	switch (iLocal_369)
	{
		case 0:
			...
			if (!PED::IS_PED_INJURED(uLocal_86))
			{
				...
				AI::TASK_LEAVE_VEHICLE(0, iLocal_91, 0);
				AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_56, 1f, 30000, 0.25f, 512, fLocal_59);
				AI::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_SMOKING", 0, 1);
				AI::CLOSE_SEQUENCE_TASK(uVar0);
				AI::TASK_PERFORM_SEQUENCE(uLocal_86, uVar0);
				AI::CLEAR_SEQUENCE_TASK(&uVar0);
				if (PED::IS_PED_IN_GROUP(uLocal_86))
				{
					PED::REMOVE_PED_FROM_GROUP(uLocal_86);
				}
				func_102();
				iLocal_369++;
			}
		...
		case 1:
			if (!func_73() && !PED::IS_PED_INJURED(uLocal_86))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(uLocal_86, vLocal_56, 3f, 3f, 3f, 0, 1, 0) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_56, 5f, 5f, 5f, 0, 1, 0))
				{
					iLocal_369++;
				}
			}
...
void func_111(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_113() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_113() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
int func_117(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_113() /*10778*/].f_6165.f_10, iParam0);
}
...
void func_139(bool bParam0)
{
	if (!PED::IS_PED_INJURED(uLocal_86))
	{
		if (iLocal_621 > 1)
		{
			if (!PED::IS_PED_FACING_PED(uLocal_86, PLAYER::PLAYER_PED_ID(), 60f))
			{
				iLocal_621 = 0;
				iLocal_622 = 0;
			}
		...
		switch (iLocal_621)
		{
			case 0:
				AI::CLEAR_PED_TASKS(uLocal_86);
				AI::TASK_LOOK_AT_ENTITY(uLocal_86, PLAYER::PLAYER_PED_ID(), -1, 16, 2);
				...
				AI::TASK_PERFORM_SEQUENCE(uLocal_86, uLocal_620);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_620);
				iLocal_621++;
				break;
			
			case 1:
				if (AI::GET_SCRIPT_TASK_STATUS(uLocal_86, 242628503) != 1)
				{
					iLocal_621++;
				}
				break;
			...
			case 2:
				if (bParam0)
				{
					...
					{
						case 0:
							if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_86, "random@paparazzi@wait", "wait_a", 3))
							{
								AI::TASK_PLAY_ANIM(uLocal_86, "random@paparazzi@wait", "wait_a", 4f, -4f, -1, 0, 0, 0, 0, 0);
							}
							else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_86, "random@paparazzi@wait", "wait_a") > 0.95f)
							{
								AI::TASK_PLAY_ANIM(uLocal_86, "random@paparazzi@wait", "wait_b", 4f, -4f, -1, 0, 0, 0, 0, 0);
								iLocal_622++;
							}
							break;
						
						case 1:
							if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_86, "random@paparazzi@wait", "wait_b", 3))
							{
								AI::TASK_PLAY_ANIM(uLocal_86, "random@paparazzi@wait", "wait_b", 4f, -4f, -1, 0, 0, 0, 0, 0);
							}
							else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_86, "random@paparazzi@wait", "wait_b") > 0.95f)
							{
								AI::TASK_PLAY_ANIM(uLocal_86, "random@paparazzi@wait", "wait_c", 4f, -4f, -1, 0, 0, 0, 0, 0);
								iLocal_622++;
							}
							break;
						
						case 2:
							if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_86, "random@paparazzi@wait", "wait_c", 3))
							{
								AI::TASK_PLAY_ANIM(uLocal_86, "random@paparazzi@wait", "wait_c", 4f, -4f, -1, 0, 0, 0, 0, 0);
							}
							else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_86, "random@paparazzi@wait", "wait_c") > 0.95f)
							{
								AI::TASK_PLAY_ANIM(uLocal_86, "random@paparazzi@wait", "wait_a", 4f, -4f, -1, 0, 0, 0, 0, 0);
								iLocal_622 = 0;
							}
...
void func_141()
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
	{
		...
		{
			case 0:
				if (!PED::IS_PED_INJURED(uLocal_86) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
				{
					func_140();
					...
					if (!PED::IS_PED_INJURED(uLocal_86))
					{
						AI::TASK_LOOK_AT_COORD(uLocal_86, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_91, -10f, 5f, 0f), -1, 16, 4);
					}
					...
					{
						AI::TASK_LOOK_AT_COORD(uLocal_86, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_91, -10f, 5f, 0f), -1, 16, 4);
						PED::_0x2208438012482A1A(uLocal_86, 0, 0);
					}
					AI::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_91, 10f, 5f, 0f), 15000, 16, 4);
					iLocal_369++;
				}
			...
			case 2:
				if (!PED::IS_PED_INJURED(uLocal_86) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
				{
					if (!PED::IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 0))
					{
						SYSTEM::SETTIMERA(0);
						if (bLocal_368)
						{
			...
			case 3:
				if ((!PED::IS_PED_INJURED(uLocal_86) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0)) && SYSTEM::TIMERA() > 1000)
				{
...
void func_153()
{
	...
	if (bLocal_368 && !PED::IS_PED_INJURED(uLocal_86))
	{
		...
		if (UI::DOES_BLIP_EXIST(uLocal_363) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_86, 0))
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_56, 15f, 15f, 15f, 0, 1, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 231.7982f, 672.7683f, 189.2f, 1f, 1f, 2.5f, 1, 1, 0))
			{
				func_181(4);
			}
		}
		else if (iLocal_369 != 100)
		{
			...
			else if (!PED::IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 0))
			{
				if (AI::GET_SCRIPT_TASK_STATUS(uLocal_86, -1794415470) != 1)
				{
					AI::TASK_ENTER_VEHICLE(uLocal_86, iLocal_91, -1, func_171(iLocal_91), 2f, 8388608, 0);
				}
			}
		}
	}
	...
	switch (iLocal_369)
	{
		case 0:
			if (func_66())
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_86, "VEH@STD@PS@IDLE_PANIC", "sit", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_86, "VEH@LOW@FRONT_PS@IDLE_PANIC", "sit", 3))
				{
					AI::CLEAR_PED_TASKS(uLocal_86);
				}
	...
	if (func_19() == 2)
	{
		if ((func_154() && !func_167()) && iLocal_47 != 8)
		{
			if (!PED::IS_PED_INJURED(uLocal_86))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(uLocal_86, -1034.6f, 4918.6f, 205.9f, 5f, 5f, 5f, 0, 1, 0))
				{
					if (!PED::IS_PED_GROUP_MEMBER(uLocal_86, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID())))
					{
						PED::SET_PED_AS_GROUP_MEMBER(uLocal_86, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID()));
					}
					func_102();
					iLocal_47 = 8;
				}
...
int func_161()
{
	if (bLocal_368)
	{
		...
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_86, 0))
		{
...
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0) && !PED::IS_PED_INJURED(uLocal_86))
	{
		if (func_66())
		{
			if (bParam0)
...
{
	if (PED::IS_PED_GROUP_MEMBER(uParam0, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID())))
	{
		if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0, 25f, 25f, 25f, 0, 1, 0))
		{
			PED::REMOVE_PED_FROM_GROUP(uParam0);
		}
		return 1;
	}
	else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0, Global_19, 0, 1, 0))
	{
		PED::SET_PED_AS_GROUP_MEMBER(uParam0, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID()));
	}
	return 0;
}
...
void func_175()
{
	if (!PED::IS_PED_INJURED(uLocal_86) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
	{
		if (!PED::IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 1))
		{
			if (AI::GET_SCRIPT_TASK_STATUS(uLocal_86, -1794415470) != 1)
			{
				AI::TASK_ENTER_VEHICLE(uLocal_86, iLocal_91, -1, func_171(iLocal_91), 2f, 8388608, 0);
		...
		if ((ENTITY::DOES_ENTITY_EXIST(func_65()) && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uLocal_86, 1), ENTITY::GET_ENTITY_COORDS(func_65(), 1)) < 100f) && (ENTITY::GET_ENTITY_SPEED(iLocal_91) < 5f || !VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iLocal_91))))
		{
			if (bLocal_368)
			{
				if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_86, "VEH@STD@PS@IDLE_PANIC", "sit", 3) && PED::IS_PED_SITTING_IN_VEHICLE(uLocal_86, iLocal_91))
				{
					AI::TASK_PLAY_ANIM(uLocal_86, "VEH@STD@PS@IDLE_PANIC", "sit", 4f, -4f, -1, 48, 0, 0, 0, 0);
				}
			}
			else if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_86, "VEH@LOW@FRONT_PS@IDLE_PANIC", "sit", 3) && PED::IS_PED_SITTING_IN_VEHICLE(uLocal_86, iLocal_91))
			{
				AI::TASK_PLAY_ANIM(uLocal_86, "VEH@LOW@FRONT_PS@IDLE_PANIC", "sit", 4f, -4f, -1, 48, 0, 0, 0, 0);
			}
		}
		else if ((ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_86, "VEH@STD@PS@IDLE_PANIC", "sit", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_86, "VEH@LOW@FRONT_PS@IDLE_PANIC", "sit", 3)) && PED::IS_PED_SITTING_IN_VEHICLE(uLocal_86, iLocal_91))
		{
			AI::CLEAR_PED_TASKS(uLocal_86);
		}
		switch (iLocal_369)
		{
			case 0:
				if (SYSTEM::TIMERA() > 2000)
				{
					...
					if (func_5(&Local_395, cLocal_372, "REPAP_GO", 4, 0, 0, 0))
					{
						...
						uLocal_358 = OBJECT::CREATE_OBJECT(joaat("prop_ld_test_01"), vLocal_87, 1, 1, 0);
						ENTITY::SET_ENTITY_COLLISION(uLocal_358, 0, 0);
						ENTITY::SET_ENTITY_VISIBLE(uLocal_358, 0, 0);
						ENTITY::FREEZE_ENTITY_POSITION(uLocal_358, 1);
						iLocal_369++;
					}
				}
				break;
			...
			case 1:
				func_177();
				if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_86, 243.5571f, 77.51265f, 90.08002f, 268.2083f, 144.2189f, 109.853f, 23.25f, 0, 1, 0))
				{
					iLocal_369++;
			...
			case 2:
				...
				if (Global_3 || bLocal_70)
				{
					if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 244.2175f, 441.0128f, 126.2767f, 33.5f, 40f, 14.75f, 0, 1, 0) && func_66())
					{
						iLocal_49 = 4;
...
int func_176()
{
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_91) && PED::IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 0))
		{
...
void func_177()
{
	...
	{
		if ((!PED::IS_PED_INJURED(uLocal_86) && ENTITY::DOES_ENTITY_EXIST(func_65())) && !PED::IS_PED_INJURED(func_65()))
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_63, ENTITY::GET_ENTITY_COORDS(func_65(), 1), 1) < 8f)
			{
	...
	if (!PED::IS_PED_INJURED(uLocal_86))
	{
		...
		switch (iLocal_369)
		{
			case 0:
				...
				{
					uLocal_625 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_653, vLocal_656, 2);
					AI::TASK_SYNCHRONIZED_SCENE(uLocal_86, uLocal_625, "random@paparazzi@peek", "left_peek_a", 1000f, -8f, 1, 0, 1148846080, 0);
					AI::TASK_LOOK_AT_ENTITY(uLocal_86, PLAYER::PLAYER_PED_ID(), -1, 4, 4);
					sLocal_626[0] = "peek_a";
					sLocal_626[1] = "peek_b";
					sLocal_626[2] = "peek_c";
					PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.2f);
			...
			case 1:
				...
				iVar2 = 0;
				bVar0 = ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_639, vLocal_642, fLocal_645, 0, 1, 0);
				bVar1 = ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_632, vLocal_635, fLocal_638, 0, 1, 0);
				...
				if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_625) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_625) > 0.9f) || iVar2)
				{
					if (iLocal_660 == 0)
					{
						...
						uLocal_625 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_653, vLocal_656, 2);
						AI::TASK_SYNCHRONIZED_SCENE(uLocal_86, uLocal_625, "random@paparazzi@peek", &cVar3, 4f, -4f, 1, 0, 1148846080, 0);
				...
				if (bVar0 || bVar1)
				{
					...
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_624) > 5000 && iLocal_660 == 0)
					{
						if (SYSTEM::VDIST2(vLocal_60, vLocal_63) < (22.2f * 22.2f))
						{
							...
							{
								iLocal_662 = 1;
								if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_86, 7f, 7f, 7f, 0, 1, 0))
								{
									AI::CLEAR_PED_TASKS(uLocal_86);
									StringCopy(&cVar10, sLocal_631, 24);
									StringConCat(&cVar10, "come_here", 24);
									uLocal_625 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_653, vLocal_656, 2);
									AI::TASK_SYNCHRONIZED_SCENE(uLocal_86, uLocal_625, "random@paparazzi@peek", &cVar10, 4f, -4f, 1, 0, 1148846080, 0);
									GAMEPLAY::SET_BIT(&iLocal_660, 0);
								}
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_646, vLocal_649, fLocal_652, 0, 1, 0) && iLocal_660 == 0)
				{
					...
					if (bVar1)
					{
						AI::TASK_SYNCHRONIZED_SCENE(uLocal_86, uLocal_625, "random@paparazzi@trans", "trans_left_to_wait", 8f, -4f, 1, 0, 1148846080, 0);
					}
					else
					{
						AI::TASK_SYNCHRONIZED_SCENE(uLocal_86, uLocal_625, "random@paparazzi@trans", "trans_right_to_wait", 8f, -4f, 1, 0, 1148846080, 0);
					}
					GAMEPLAY::SET_BIT(&iLocal_660, 0);
					iLocal_369++;
				}
			...
			case 2:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_625) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_625) > 0.9f)
				{
					...
					{
						AI::CLEAR_PED_TASKS(uLocal_86);
						AI::TASK_PLAY_ANIM(uLocal_86, "random@paparazzi@wait", "wait_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
						iLocal_621 = 2;
						SYSTEM::SETTIMERA(0);
					}
					iLocal_369++;
			...
			case 4:
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_91, uLocal_86, Global_19 + Vector(2f, 12f, 12f), 0, 1, 0) && !bLocal_368)
					{
						if (AI::GET_SCRIPT_TASK_STATUS(uLocal_86, 242628503) != 1 && !iLocal_659)
						{
							...
							AI::TASK_PERFORM_SEQUENCE(uLocal_86, uVar16);
							PED::_0x2208438012482A1A(uLocal_86, 0, 0);
						...
						{
							PED::SET_PED_MAX_MOVE_BLEND_RATIO(uLocal_86, 1f);
					...
					if ((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_91, uLocal_86, Global_19, 0, 1, 0) && func_173(iLocal_91)) && (SYSTEM::TIMERA() > 6000 || !bLocal_368))
					{
						if (!iLocal_623)
						{
							func_102();
						...
						else
						{
							...
							AI::CLEAR_PED_TASKS(uLocal_86);
							AI::TASK_ENTER_VEHICLE(uLocal_86, iLocal_91, -1, func_171(iLocal_91), 1f, 8388608, 0);
						}
					}
				}
				break;
			...
			case 5:
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
				{
					if (!PED::IS_PED_INJURED(uLocal_86) && PED::IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 0))
					{
						if (UI::DOES_BLIP_EXIST(uLocal_360))
						{
							UI::REMOVE_BLIP(&uLocal_360);
					...
					else
					{
						if (!Global_3 && !bLocal_70)
						{
							if ((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_91, 0) && !PED::IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 1)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_91, 225.1779f, 125.6632f, 113.6647f, 262.3032f, 111.8771f, 97.16339f, 37f, 0, 1, 0))
							{
								if (bLocal_368)
								{
									PED::SET_PED_FLEE_ATTRIBUTES(uLocal_86, 2, 1);
									sLocal_371 = "REPAP_GUP";
									func_181(6);
								}
								else
			...
			else
			{
				if (!bLocal_368)
				{
					if (!Global_3 && !bLocal_70)
					{
						...
						if (iLocal_84 > 250)
						{
							if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(uLocal_86, iLocal_91) && SYSTEM::VDIST(vLocal_63, vLocal_66) < 25f)
							{
								func_181(5);
							}
						}
...
void func_179(vector3 vParam0, bool bParam3)
{
	...
	{
		if (AI::GET_SCRIPT_TASK_STATUS(uLocal_86, 713668775) != 1)
		{
			AI::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_86, vParam0, 1f, -1, 0.25f, 0, 1193033728);
		}
	}
	else if (AI::GET_SCRIPT_TASK_STATUS(uLocal_86, 713668775) != 1)
	{
		func_139(bParam3);
		AI::TASK_LOOK_AT_ENTITY(uLocal_86, PLAYER::PLAYER_PED_ID(), -1, 16, 2);
	}
...
void func_193()
{
	...
	if (!PED::IS_PED_INJURED(uLocal_86))
	{
		PED::SET_PED_FLEE_ATTRIBUTES(uLocal_86, 2, 0);
		AI::TASK_SMART_FLEE_PED(uLocal_86, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
	}
	iVar0 = 0;
	while (iVar0 < Local_204)
	{
		if (!PED::IS_PED_INJURED(Local_204[iVar0 /*18*/]))
		{
			AI::TASK_SMART_FLEE_PED(Local_204[iVar0 /*18*/], PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
...
int func_194()
{
	...
	while (iVar1 < Local_204)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_204[iVar1 /*18*/]) && !PED::IS_PED_INJURED(Local_204[iVar1 /*18*/]))
		{
			...
			{
				if (((GAMEPLAY::IS_BULLET_IN_AREA(Local_204[iVar1 /*18*/].f_6, 5f, 1) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_204[iVar1 /*18*/].f_6, 10f)) || PED::IS_PED_FLEEING(Local_204[iVar1 /*18*/])) || (iLocal_386[iVar1] > 10 && iLocal_47 == 0))
				{
					iVar0 = 1;
				}
			}
...
void func_207()
{
	...
	uLocal_86 = PED::CREATE_PED(26, joaat("a_f_y_bevhills_03"), vLocal_87, fLocal_90, 1, 1);
	PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_86, 1, 1);
	PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_86, 17, 1);
	PED::SET_PED_FLEE_ATTRIBUTES(uLocal_86, 128, 1);
	PED::SET_PED_KEEP_TASK(uLocal_86, 1);
	PED::SET_PED_CAN_BE_DRAGGED_OUT(uLocal_86, 0);
	PED::SET_PED_COMPONENT_VARIATION(uLocal_86, 0, 0, 1, 0);
	PED::SET_PED_COMPONENT_VARIATION(uLocal_86, 2, 0, 0, 0);
	PED::SET_PED_COMPONENT_VARIATION(uLocal_86, 3, 0, 0, 0);
	PED::SET_PED_COMPONENT_VARIATION(uLocal_86, 4, 0, 0, 0);
	PED::SET_PED_COMPONENT_VARIATION(uLocal_86, 7, 1, 0, 0);
	PED::SET_PED_COMPONENT_VARIATION(uLocal_86, 8, 0, 0, 0);
	PED::SET_PED_DIES_INSTANTLY_IN_WATER(uLocal_86, 1);
	PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_86, 1);
	PED::SET_PED_CAN_BE_TARGETTED(uLocal_86, 0);
	AUDIO::SET_AMBIENT_VOICE_NAME(uLocal_86, "LACEY");
	if (Global_3 || bLocal_70)
	{
		ENTITY::SET_ENTITY_INVINCIBLE(uLocal_86, 1);
	}
	if (PED::ADD_RELATIONSHIP_GROUP("CELEBRITY", &uLocal_69))
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_86, uLocal_69);
	}
	iLocal_91 = VEHICLE::CREATE_VEHICLE(joaat("surano"), vLocal_92, fLocal_95, 1, 1, 0);
...
int func_213(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_83() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_118(func_211(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_224()
{
	if ((Global_106554 == func_97() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
void func_274()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_86) && !PED::IS_PED_INJURED(uLocal_86))
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_86, 1))
		{
			if (!PED::IS_PED_FLEEING(uLocal_86))
			{
				AI::TASK_LEAVE_ANY_VEHICLE(uLocal_86, 0, 0);
