...
void func_3(int iParam0, bool bParam1)
{
	...
	func_31();
	if (GAMEPLAY::IS_BIT_SET(Global_106565.f_10010.f_25, 3))
	{
		func_30();
	}
	func_12();
...
void func_12()
{
	...
	Global_93719 = 0;
	Global_87887 = -1;
	GAMEPLAY::CLEAR_BIT(&(Global_93682.f_20), 17);
	Global_93717 = 0;
...
void func_17()
{
	...
	GAMEPLAY::CLEAR_BIT(&(Global_93682.f_20), 25);
	Global_93716 = 0;
	func_20(0);
	func_19();
	func_18();
...
void func_18()
{
	GAMEPLAY::CLEAR_BIT(&(Global_93682.f_20), 22);
	GAMEPLAY::CLEAR_BIT(&(Global_93682.f_20), 8);
}
...
void func_30()
{
	...
	GAMEPLAY::SET_BIT(&Global_2423, 25);
...
int func_32(var uParam0, int iParam1, int iParam2)
{
	...
	{
		PED::CLEAR_PED_PROP(uParam0, Global_71402[1 /*14*/].f_12);
	}
	else
	{
		uVar31 = { func_79(iVar0, 0) };
		Global_71402[1 /*14*/] = { func_83(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(uParam0, func_75(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(uParam0, func_75(iParam1), Global_71402[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_75(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, 0);
		}
	}
...
int func_35(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_75(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_75(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_75(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_66(iVar0);
						if (Global_71400 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_75(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_75(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_75(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_53(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_53(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_53(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_53(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_93(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_86(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_86(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_75(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_148(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_75(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_75(iParam1)))
	{
		return 1;
	}
	return 0;
...
{
	if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Global_90782))
	{
		return;
	}
	if (GAMEPLAY::COMPARE_STRINGS(uParam0, &Global_90782, 0, -1) != 0)
	{
		return;
	}
...
{
	Global_36976 = (GAMEPLAY::GET_GAME_TIMER() + iParam0);
}
...
void func_171(int iParam0, bool bParam1)
{
		...
		if (Var0.f_5 != 4)
		{
			...
			while (iVar34 < 63)
			{
				...
				if (iVar67 != iParam0)
				{
					...
					{
						if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_18568[iVar67 /*6*/], 3))
						{
							bVar33 = false;
						}
						if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_18568[iVar67 /*6*/], 0))
						{
							func_176(iVar67);
						}
					}
	...
	if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_18568[iParam0 /*6*/], 3))
	{
		GAMEPLAY::SET_BIT(&(Global_106565.f_18568[iParam0 /*6*/]), 3);
...
void func_176(int iParam0)
{
	...
	func_177(iParam0);
	GAMEPLAY::SET_BIT(&(Global_106565.f_18568[iParam0 /*6*/]), 0);
}
...
int func_188(int iParam0)
{
	switch (iParam0)
	{
		...
		case 8:
			if (GAMEPLAY::IS_BIT_SET(Global_106565.f_18568.f_382, 0))
			{
				return 46;
			}
			break;
...
void func_190(int iParam0, bool bParam1)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (!func_197(iParam0))
		{
			GAMEPLAY::SET_BIT(&(Global_106565.f_26428), iVar0);
			if (!bParam1)
			{
...
int func_197(int iParam0)
{
	...
	{
		return GAMEPLAY::IS_BIT_SET(Global_106565.f_26428, iParam0);
	}
	return 0;
}
	...
	if (func_219(PLAYER::PLAYER_PED_ID()) && func_219(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_233(PLAYER::PLAYER_PED_ID(), iParam0, iParam2);
				}
			}
		}
		if (bParam4)
...
int func_237(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_229(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_229(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_228(vVar3, vVar0);
	...
	switch (iLocal_84)
	{
		case 0:
			...
			if (func_268(1, 1093140480, 0))
			{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_149[0], sLocal_156, 0, iLocal_152, 0);
				}
				else
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_149[0], sLocal_156, 2, iLocal_152, 0);
				}
				if (ENTITY::DOES_ENTITY_EXIST(uLocal_149[1]))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_149[1], sLocal_157, 0, iLocal_153, 0);
				}
				else
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_149[1], sLocal_157, 2, iLocal_153, 0);
				}
				if (ENTITY::DOES_ENTITY_EXIST(uLocal_147))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_147, sLocal_159, 0, iLocal_155, 0);
				}
				else
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_147, sLocal_159, 2, iLocal_155, 0);
				}
				if (ENTITY::DOES_ENTITY_EXIST(uLocal_148))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_148, sLocal_158, 0, iLocal_154, 0);
				}
				else
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_148, sLocal_158, 2, iLocal_154, 0);
				}
		...
		case 1:
			...
			{
				uLocal_332 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_333, vLocal_336, 2);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_148))
			{
				...
				{
					uLocal_148 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_158, iLocal_154));
				}
			}
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_332) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_158, 0))
			{
				ENTITY::SET_ENTITY_COORDS(uLocal_148, vLocal_333, 0, 0, 0, 1);
				ENTITY::SET_ENTITY_ROTATION(uLocal_148, vLocal_336, 2, 0);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_148, uLocal_332, "leadout_pap_3_rcm_dumpster", sLocal_161, 1000f, -8f, 0, 1148846080);
				ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(uLocal_148);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_149[0]))
			{
				if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_156, 0)))
				{
					uLocal_149[0] = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_156, iLocal_152));
				}
			}
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_332) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_156, 0))
			{
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_149[0], uLocal_332, "leadout_pap_3_rcm_lid_l", sLocal_161, 1000f, -8f, 1, 1148846080);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_149[1]))
			{
				...
				{
					uLocal_149[1] = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_157, iLocal_153));
				}
			}
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_332) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_157, 0))
			{
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_149[1], uLocal_332, "leadout_pap_3_rcm_lid_r", sLocal_161, 1000f, -8f, 1, 1148846080);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_147))
			{
				...
				{
					uLocal_147 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_159, iLocal_155));
				}
			}
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_332) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_159, 0))
			{
				ENTITY::SET_ENTITY_COORDS(uLocal_147, -261.1132f, 294.1956f, 90.68612f, 0, 0, 0, 1);
				ENTITY::SET_ENTITY_ROTATION(uLocal_147, -0.604164f, -2.332095f, 89.8831f, 2, 0);
				ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(uLocal_147);
			}
...
int func_265()
{
	...
	{
		GAMEPLAY::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(uVar10), &(vVar0[0 /*3*/]), &(vVar0[1 /*3*/]));
		vVar7 = { func_266() };
...
void func_282()
{
	...
	switch (iLocal_84)
	{
		case 0:
			...
			if (func_218(Local_85.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uLocal_148))
			{
				uLocal_330 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(uLocal_148, 1), ENTITY::GET_ENTITY_ROTATION(uLocal_148, 2), 2);
				AI::TASK_SYNCHRONIZED_SCENE(Local_85.f_28[0], uLocal_330, sLocal_161, "leadin_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				if (ENTITY::DOES_ENTITY_EXIST(uLocal_148))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_148, uLocal_330, "leadin_pap_3_rcm_dumpster", sLocal_161, 1000f, -8f, 0, 1148846080);
				}
				if (ENTITY::DOES_ENTITY_EXIST(uLocal_149[0]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_149[0], uLocal_330, "leadin_pap_3_rcm_lid_l", sLocal_161, 1000f, -8f, 0, 1148846080);
				}
				if (ENTITY::DOES_ENTITY_EXIST(uLocal_149[1]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_149[1], uLocal_330, "leadin_pap_3_rcm_lid_r", sLocal_161, 1000f, -8f, 0, 1148846080);
				}
				func_242(1, 1, 1, 1);
				iLocal_84 = 1;
			}
			...
			if (func_218(Local_85.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uLocal_148))
			{
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_330))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_330) > 0.99f)
					{
						...
						{
							uLocal_331 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(uLocal_148, 1), ENTITY::GET_ENTITY_ROTATION(uLocal_148, 2), 2);
							AI::TASK_SYNCHRONIZED_SCENE(Local_85.f_28[0], uLocal_331, sLocal_161, "idle_01_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
							PED::_0x2208438012482A1A(Local_85.f_28[0], 0, 0);
							if (ENTITY::DOES_ENTITY_EXIST(uLocal_148))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_148, uLocal_331, "idle_01_pap_3_rcm_dumpster", sLocal_161, 1000f, -8f, 0, 1148846080);
								ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(uLocal_148);
							}
							if (ENTITY::DOES_ENTITY_EXIST(uLocal_149[0]))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_149[0], uLocal_331, "idle_01_pap_3_rcm_lid_l", sLocal_161, 1000f, -8f, 0, 1148846080);
								ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(uLocal_149[0]);
							}
							if (ENTITY::DOES_ENTITY_EXIST(uLocal_149[1]))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_149[1], uLocal_331, "idle_01_pap_3_rcm_lid_r", sLocal_161, 1000f, -8f, 0, 1148846080);
								ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(uLocal_149[1]);
							}
						}
					}
...
void func_283()
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_85.f_41[3]) && !iLocal_345)
	{
		...
		{
			AUDIO::PLAY_SOUND_FROM_COORD(uLocal_339, "CAMERA", PED::GET_PED_BONE_COORDS(Local_85.f_28[0], 28422, vLocal_340), sLocal_344, 0, 0, 0);
			iLocal_345 = 1;
		}
	}
}
...
void func_292()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_147))
	{
		uLocal_147 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-261.19f, 292.22f, 90.79f, 10f, iLocal_155, 1, 0, 1);
		ENTITY::_0xA80AE305E0A3044F(uLocal_147, 0);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_148))
	{
...
void func_296()
{
	if (func_219(Local_85.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uLocal_148))
	{
		uLocal_332 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_333, vLocal_336, 2);
		AI::TASK_SYNCHRONIZED_SCENE(Local_85.f_28[0], uLocal_332, sLocal_161, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_148))
...
void func_327(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if ((func_151(iParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_332(*uParam1, 0, &uVar0))
		{
...
int func_384(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_356(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_387(*uParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_387(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_386(uParam0);
	if (func_385(*uParam0))
	{
...
int func_402(var uParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_404(uParam0, uVar1[iVar6], 1) && func_403(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_398(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_405(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_408(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_407())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			if (bVar32)
			{
				...
				uParam0->f_41[0] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_cs_dumpster_01a"), vVar10[0 /*3*/], 1, 1, 0);
				ENTITY::SET_ENTITY_ROTATION(uParam0->f_41[0], vVar20[0 /*3*/], 2, 1);
				ENTITY::_0xA80AE305E0A3044F(uParam0->f_41[0], 0);
				uParam0->f_41[1] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_cs_dumpster_lidl"), vVar10[1 /*3*/], 1, 1, 0);
				ENTITY::SET_ENTITY_ROTATION(uParam0->f_41[1], vVar20[1 /*3*/], 2, 1);
				ENTITY::_0xA80AE305E0A3044F(uParam0->f_41[1], 0);
				uParam0->f_41[2] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_cs_dumpster_lidr"), vVar10[2 /*3*/], 1, 1, 0);
...
void func_432()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_149[0]))
	{
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_149[0], 1);
	}
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_149[1]))
	{
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_149[1], 1);
	}
...
int func_449(char* sParam0, int iParam1, int iParam2)
{
	...
	func_458(0);
	func_457(1);
	GAMEPLAY::CLEAR_BIT(&(Global_93682.f_20), 9);
	GAMEPLAY::CLEAR_BIT(&(Global_93682.f_20), 6);
	GAMEPLAY::CLEAR_BIT(&(Global_93682.f_20), 20);
	GAMEPLAY::CLEAR_BIT(&(Global_93682.f_20), 21);
	GAMEPLAY::CLEAR_BIT(&(Global_93682.f_20), 5);
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				{
					GAMEPLAY::SET_BIT(&(Global_93682.f_20), 5);
				}
			}
		}
	}
	...
	if (func_455())
	{
		if (func_454())
		{
			...
			{
				if (!GAMEPLAY::IS_BIT_SET(Global_84500[iParam2 /*34*/].f_15, 16))
				{
...
void func_457(int iParam0)
{
	...
	{
		UI::_0xFDB423997FA30340();
		GAMEPLAY::SET_BIT(&(Global_93682.f_20), 3);
	}
	else if (GAMEPLAY::IS_BIT_SET(Global_93682.f_20, 3))
	{
		UI::_0xE1CD1E48E025E661();
		GAMEPLAY::CLEAR_BIT(&(Global_93682.f_20), 3);
	}
}
...
void func_458(int iParam0)
{
	if (iParam0 == 1)
	{
		if (GAMEPLAY::IS_BIT_SET(Global_93682.f_20, 4))
		{
			func_460();
			GAMEPLAY::CLEAR_BIT(&(Global_93682.f_20), 4);
		}
	}
	else
	{
		func_459();
		GAMEPLAY::SET_BIT(&(Global_93682.f_20), 4);
	}
}
