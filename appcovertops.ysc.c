...
void __EntryFunction__()
{
	...
	iLocal_219 = -1;
	sLocal_221 = "";
	if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GAMEPLAY::GET_HASH_KEY("appCovertOps")) > 1)
	{
		func_230(0, 0);
	}
	func_182();
	while (func_181())
	{
		...
		func_161();
		func_37();
		if (!GAMEPLAY::IS_BIT_SET(uLocal_216, 3))
		{
			func_31();
			func_11();
		}
...
void func_1()
{
	if (((!GAMEPLAY::IS_BIT_SET(uLocal_216, 7) && !GAMEPLAY::IS_BIT_SET(uLocal_216, 6)) && iLocal_354 == 1) && !func_10())
	{
		if (!func_9())
		{
...
void func_31()
{
	...
	if ((!GAMEPLAY::IS_BIT_SET(uLocal_216, 4) && !func_10()) && iLocal_354 == 1)
	{
		if (!GAMEPLAY::IS_BIT_SET(uLocal_216, 5))
		{
			if (!func_5(15378, -1, -1))
			{
				bVar0 = true;
	...
	if (bVar0)
	{
		GAMEPLAY::SET_BIT(&uLocal_216, 4);
	}
	else if (GAMEPLAY::IS_BIT_SET(uLocal_216, 4))
	{
		...
		{
			GAMEPLAY::CLEAR_BIT(&uLocal_216, 4);
			iLocal_218 = 0;
			func_33(&uLocal_358);
			if (func_32())
			{
				GAMEPLAY::SET_BIT(&uLocal_216, 3);
			}
		}
	}
}
...
int func_32()
{
	if ((func_5(15378, -1, -1) || GAMEPLAY::IS_BIT_SET(uLocal_216, 5)) && func_5(15379, -1, -1))
	{
		return 1;
	}
	return 0;
...
void func_37()
{
	...
	{
		if (GRAPHICS::_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(uLocal_526) && GRAPHICS::_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(uLocal_527))
		{
			iVar0 = GRAPHICS::_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_INT(uLocal_526);
			iVar1 = GRAPHICS::_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_INT(uLocal_527);
			switch (iVar0)
			{
				case 102:
			...
			iLocal_354 = iVar1;
			GAMEPLAY::CLEAR_BIT(&uLocal_216, 0);
		}
	}
}
...
int func_56(var uParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 < func_155(iParam2))
	{
		...
		if (iVar1 != -1)
		{
			...
			func_133();
			UI::_BEGIN_TEXT_COMMAND_BUSY_STRING("FMMC_PLYLOAD");
...
void func_73(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (bParam1)
			{
				if (!func_77(uVar25) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar25))
				{
					if (!bVar21)
					{
...
char* func_111(int iParam0)
{
	...
	if (func_112(Global_4456448.f_161209) && GAMEPLAY::IS_BIT_SET(Global_4456448.f_162445.f_2808, 2))
	{
...
void func_126(int iParam0)
{
	...
	if (func_128() == 0 || UI::IS_PAUSE_MENU_ACTIVE())
	{
		func_127(1);
...
void func_130(int iParam0)
{
	...
	if ((func_128() == 1 || UI::IS_PAUSE_MENU_ACTIVE()) || iParam0)
	{
		func_127(0);
...
void func_133()
{
	GAMEPLAY::SET_BIT(&(Global_2448756.f_3), 4);
}

void func_134()
{
	GAMEPLAY::SET_BIT(&(Global_1625319[PLAYER::PLAYER_ID() /*38*/].f_29), 12);
}
...
void func_141()
{
	GAMEPLAY::CLEAR_BIT(&(Global_2448756.f_2), 14);
}

void func_142()
{
	GAMEPLAY::SET_BIT(&Global_2448756, 5);
	func_143();
}

void func_143()
{
	GAMEPLAY::SET_BIT(&Global_2448756, 8);
}
...
void func_158()
{
	...
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	func_43(0);
	GAMEPLAY::CLEAR_BIT(&uLocal_216, 1);
}
...
void func_159()
{
	if (func_160())
	{
		if (!GAMEPLAY::IS_BIT_SET(uLocal_216, 0))
		{
			...
			uLocal_526 = GRAPHICS::_END_SCALEFORM_MOVIE_METHOD_RETURN();
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_525, "GET_CURRENT_SCREEN_ID");
			uLocal_527 = GRAPHICS::_END_SCALEFORM_MOVIE_METHOD_RETURN();
...
void func_161()
{
	...
	else
	{
		...
		if (((iVar0 != 127 || iLocal_528 != 127) || iVar1 != 127) || iLocal_529 != 127)
		{
			...
			GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_528);
			GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_529);
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		}
	}
	...
	if (((iVar2 != 127 || iLocal_530 != 127) || iVar3 != 127) || iLocal_531 != 127)
	{
		...
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_530);
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iLocal_531);
...
bool func_162()
{
	return GAMEPLAY::IS_BIT_SET(uLocal_216, 1);
}
...
void func_188(int iParam0)
{
	...
	{
		GAMEPLAY::CLEAR_BIT(&uLocal_216, 7);
	}
	if (iVar1 != -1)
	{
		if (!func_220())
		{
			...
			if (iVar1 != -1)
			{
				func_189(&fVar5, &fVar6, 0, 9, 0, 0, GAMEPLAY::GET_HASH_KEY(&(Global_794709.f_4[iVar1 /*88*/])));
			}
			if (fVar5 == 1f)
			{
				fVar5 = 0f;
	...
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(bVar3);
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(SYSTEM::FLOOR(fVar6));
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(SYSTEM::FLOOR(fVar5));
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
bool func_216(int iParam0)
{
	...
	if (bVar0)
	{
		...
		while (!bVar9)
		{
			...
			{
				StringCopy(&(Local_222[iVar7 /*16*/]), UI::_GET_TEXT_SUBSTRING_SAFE(uVar4, iVar5, iVar6, 63), 64);
				iVar5 = (iVar5 + UI::GET_LENGTH_OF_LITERAL_STRING(&(Local_222[iVar7 /*16*/])));
				iVar7++;
			}
		}
	}
