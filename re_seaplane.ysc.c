...
int func_38(int iParam0, bool bParam1)
{
	...
	else
	{
		...
		{
			iVar0 = iParam0;
			if (iVar0 >= 7 && !UI::DOES_BLIP_EXIST(Local_49[iParam0 /*6*/].f_1))
			{
				return 1;
			}
		}
...
int func_54(int iParam0, bool bParam1, vector3 vParam2, float fParam5)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_49[iParam0 /*6*/]))
	{
		...
		{
			Local_49[iParam0 /*6*/] = PED::CREATE_PED(26, iVar4, vVar0, fVar3, 1, 1);
			ENTITY::SET_ENTITY_COLLISION(Local_49[iParam0 /*6*/], iVar42, 0);
			ENTITY::_SET_ENTITY_COLLISION_2(Local_49[iParam0 /*6*/], !bVar66, 0);
		}
		if (bVar41)
		{
		...
		{
			AI::TASK_START_SCENARIO_IN_PLACE(Local_49[iParam0 /*6*/], sVar74, -1, 0);
		}
		if (iVar17 > 0)
		{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uVar8))
		{
			ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_49[iParam0 /*6*/], uVar8, -1, vVar9, vVar12, 1, 1, 1, 0, 2, 1);
...
int func_63(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_116[iParam0 /*4*/]))
	{
		...
		Local_116[iParam0 /*4*/] = VEHICLE::CREATE_VEHICLE(iVar4, vVar0, fVar3, 1, 1, 0);
		func_66(iParam0);
		func_65(iParam0);
		ENTITY::SET_ENTITY_VISIBLE(Local_116[iParam0 /*4*/], iVar7, 0);
		if (ENTITY::DOES_ENTITY_EXIST(uVar26))
		{
			ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_116[iParam0 /*4*/], uVar26, -1, vVar27, vVar30, 0, 0, 0, 0, 2, 1);
		}
		else
		{
		...
		{
			VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(Local_116[iParam0 /*4*/], uVar33);
		}
		if (fVar23 > 0f)
		{
...
void func_84()
{
	...
	while (iVar0 < 11)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_49[iVar0 /*6*/]) && UI::DOES_BLIP_EXIST(Local_49[iVar0 /*6*/].f_1))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_49[iVar0 /*6*/], 0))
			{
				if (!func_88(iVar0, 0))
				{
					UI::SET_BLIP_SCALE(Local_49[iVar0 /*6*/].f_1, 1f);
					func_57(iVar0, 0);
				}
				if (func_87(Local_49[iVar0 /*6*/], 0) != -1)
				{
					if (func_86(iVar0))
					{
						if (UI::GET_BLIP_ALPHA(Local_49[iVar0 /*6*/].f_1) > 0)
						{
							UI::SET_BLIP_ALPHA(Local_49[iVar0 /*6*/].f_1, 0);
							UI::_0x54318C915D27E4CE(Local_49[iVar0 /*6*/].f_1, 1);
						}
					}
					else if (UI::GET_BLIP_ALPHA(Local_49[iVar0 /*6*/].f_1) == 0)
					{
						UI::SET_BLIP_ALPHA(Local_49[iVar0 /*6*/].f_1, 255);
						UI::_0x54318C915D27E4CE(Local_49[iVar0 /*6*/].f_1, 0);
					}
				}
			}
			else if (func_88(iVar0, 0))
			{
				UI::SET_BLIP_SCALE(Local_49[iVar0 /*6*/].f_1, 0.7f);
				func_85(iVar0, 0);
				if (UI::GET_BLIP_ALPHA(Local_49[iVar0 /*6*/].f_1) == 0)
				{
					UI::SET_BLIP_ALPHA(Local_49[iVar0 /*6*/].f_1, 255);
	...
	while (iVar0 < 5)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_116[iVar0 /*4*/]) && UI::DOES_BLIP_EXIST(Local_116[iVar0 /*4*/].f_1))
		{
			...
			case 2:
				...
				switch (Local_49[iParam0 /*6*/].f_3)
				{
					case 0:
						...
						{
							func_99(iParam0);
							AI::TASK_COMBAT_PED(Local_49[iParam0 /*6*/], PLAYER::PLAYER_PED_ID(), 0, 16);
					...
					case 2:
						...
						AI::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sVar4, ENTITY::GET_ENTITY_COORDS(Local_49[iParam0 /*6*/], 1), &iVar2);
						...
						if (((((iParam0 == 0 && iLocal_151 != iVar1) && iVar1 > iVar2) || ((iParam0 == 2 && iLocal_152 != iVar1) && iVar1 > iVar2)) && func_198(PED::GET_VEHICLE_PED_IS_USING(Local_49[iParam0 /*6*/]))) && !PED::IS_PED_BEING_STUNNED(Local_49[iParam0 /*6*/], 0))
						{
							...
							AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_49[iParam0 /*6*/], PED::GET_VEHICLE_PED_IS_USING(Local_49[iParam0 /*6*/]), sVar4, 786469, 0, iVar5, iVar1, -1f, 0, 6f);
						}
						if ((!func_97(Local_49[iParam0 /*6*/], -235832601, 1) && AI::GET_SCRIPT_TASK_STATUS(Local_49[iParam0 /*6*/], -235832601) == 7) && !func_97(Local_49[iParam0 /*6*/], 538064912, 1))
						{
							AI::TASK_VEHICLE_SHOOT_AT_PED(Local_49[iParam0 /*6*/], PLAYER::PLAYER_PED_ID(), 1101004800);
						...
						if (!func_88(iParam0, 4))
						{
							...
							{
								func_57(iParam0, 4);
								AI::CLEAR_PED_TASKS(Local_49[iParam0 /*6*/]);
						...
						if ((AI::GET_SCRIPT_TASK_STATUS(Local_49[iParam0 /*6*/], -235832601) == 1 && !VEHICLE::IS_VEHICLE_STOPPED(PED::GET_VEHICLE_PED_IS_USING(Local_49[iParam0 /*6*/]))) && !AI::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(Local_49[iParam0 /*6*/]))
						{
							AI::TASK_DRIVE_BY(Local_49[iParam0 /*6*/], PLAYER::PLAYER_PED_ID(), 0, vLocal_139, 500f, 100, 1, -687903391);
						}
						AI::WAYPOINT_RECORDING_GET_COORD(sVar4, (iVar3 - 1), &vVar6);
						if (ENTITY::IS_ENTITY_AT_COORD(Local_49[iParam0 /*6*/], vVar6, 8f, 8f, 8f, 0, 1, 0))
						{
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_49[iParam0 /*6*/], 1);
							AI::TASK_BOAT_MISSION(Local_49[iParam0 /*6*/], PED::GET_VEHICLE_PED_IS_USING(Local_49[iParam0 /*6*/]), 0, PLAYER::PLAYER_PED_ID(), vLocal_139, 7, 20f, 786469, 5f, 7);
							func_67(5);
					...
					case 3:
						if (PED::IS_PED_IN_ANY_VEHICLE(Local_49[iParam0 /*6*/], 0) && func_198(PED::GET_VEHICLE_PED_IS_IN(Local_49[iParam0 /*6*/], 0)))
						{
							...
							{
								AI::_TASK_GET_OFF_BOAT(Local_49[iParam0 /*6*/], -1);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_49[iParam0 /*6*/], 1);
								PED::SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 1, 0);
								Local_49[iParam0 /*6*/].f_3++;
							}
							else if (AI::GET_SCRIPT_TASK_STATUS(Local_49[iParam0 /*6*/], -1273030092) == 1 && !AI::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(Local_49[iParam0 /*6*/]))
							{
								AI::TASK_DRIVE_BY(Local_49[iParam0 /*6*/], PLAYER::PLAYER_PED_ID(), 0, vLocal_139, 500f, 100, 1, -687903391);
							}
						}
				...
				switch (Local_49[iParam0 /*6*/].f_3)
				{
					...
					case 1:
						if (GAMEPLAY::GET_GAME_TIMER() >= Local_49[iParam0 /*6*/].f_4)
						{
							...
							{
								AI::CLEAR_PED_TASKS(Local_49[iParam0 /*6*/]);
								AI::TASK_ENTER_VEHICLE(Local_49[iParam0 /*6*/], Local_116[1 /*4*/], 20000, 0, 3f, 1, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_49[iParam0 /*6*/], 1);
							}
							if ((iParam0 == 3 && func_198(Local_116[2 /*4*/])) && func_198(VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_116[2 /*4*/], -1, 0)))
							{
								AI::CLEAR_PED_TASKS(Local_49[iParam0 /*6*/]);
								AI::TASK_ENTER_VEHICLE(Local_49[iParam0 /*6*/], Local_116[2 /*4*/], 20000, 0, 3f, 1, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_49[iParam0 /*6*/], 1);
							}
							if ((iParam0 == 4 && func_198(Local_116[2 /*4*/])) && func_198(VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_116[2 /*4*/], -1, 0)))
							{
								AI::CLEAR_PED_TASKS(Local_49[iParam0 /*6*/]);
								AI::TASK_ENTER_VEHICLE(Local_49[iParam0 /*6*/], Local_116[2 /*4*/], 20000, 1, 3f, 1, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_49[iParam0 /*6*/], 1);
							}
							Local_49[iParam0 /*6*/].f_3++;
						}
					...
					case 2:
						...
						else if (!func_97(Local_49[iParam0 /*6*/], -1794415470, 1))
						{
							...
							{
								AI::TASK_ENTER_VEHICLE(Local_49[iParam0 /*6*/], Local_116[iVar9 /*4*/], 20000, 0, 3f, 1, 0);
							}
							if (iParam0 == 4 && func_198(Local_116[iVar9 /*4*/]))
							{
								AI::TASK_ENTER_VEHICLE(Local_49[iParam0 /*6*/], Local_116[iVar9 /*4*/], 20000, 1, 3f, 1, 0);
							}
						}
						break;
					...
					case 3:
						if (PED::IS_PED_IN_ANY_VEHICLE(Local_49[iParam0 /*6*/], 0) && func_198(PED::GET_VEHICLE_PED_IS_IN(Local_49[iParam0 /*6*/], 0)))
						{
							...
							if (Local_49[iParam0 /*6*/].f_3 == 3)
							{
								...
								{
									AI::_TASK_GET_OFF_BOAT(Local_49[iParam0 /*6*/], 20000);
									PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_49[iParam0 /*6*/], 1);
									PED::SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 1, 0);
									Local_49[iParam0 /*6*/].f_3 = 5;
								}
			...
			case 10:
				...
				switch (Local_49[iParam0 /*6*/].f_3)
				{
					case 0:
						...
						{
							Local_49[iParam0 /*6*/].f_1 = func_59(Local_49[iParam0 /*6*/], 1, 145);
							UI::SET_BLIP_ALPHA(Local_49[iParam0 /*6*/].f_1, 0);
							UI::_0x54318C915D27E4CE(Local_49[iParam0 /*6*/].f_1, 1);
							Local_49[iParam0 /*6*/].f_3++;
						}
						break;
...
int func_96(int iParam0, int iParam1)
{
	...
	if (func_198(Local_116[iVar0 /*4*/]))
	{
		...
		{
			Local_116[iVar0 /*4*/].f_3 = (Local_116[iVar0 /*4*/].f_3 + GAMEPLAY::GET_FRAME_TIME());
		}
		else
		{
...
int func_119()
{
	if ((Global_106554 == func_29() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
