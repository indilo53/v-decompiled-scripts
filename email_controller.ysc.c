...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!Global_37587 && GAMEPLAY::GET_GAME_TIMER() > Global_36976)
		{
			iVar127 = 0;
			while (iVar127 < 122)
			{
...
void func_2(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_3(UI::_SET_NOTIFICATION_MESSAGE_2(&cVar2, &cVar2, 0, 2, UI::_GET_LABEL_TEXT(func_4(iParam1)), 0));
		}
		else
		{
			func_3(UI::_SET_NOTIFICATION_MESSAGE_2("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, UI::_GET_LABEL_TEXT(func_4(iParam1)), 0));
		}
		switch (Global_14553)
		{
			case 0:
