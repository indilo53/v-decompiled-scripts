...
void __EntryFunction__()
{
	...
	if (Var0 == 17)
	{
		uLocal_97 = PED::ADD_SCENARIO_BLOCKING_AREA(vVar61 - Vector(40f, 40f, 40f), vVar61 + Vector(40f, 40f, 40f), 0, 1, 1, 1);
	...
	while (true)
	{
		...
		else if (Var0 == 19)
		{
			...
			if ((((((!func_188() && func_187(Var0.f_28[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && AUDIO::HAS_SOUND_FINISHED(uLocal_96)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", 0, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", 0, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", 0, -1))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_96, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
			}
			if ((iLocal_95 == 0 && func_187(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vVar61, Var0.f_15, Var0.f_15, Var0.f_15, 0, 0, 0))
			{
...
int func_189(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_187(PLAYER::PLAYER_PED_ID()) && func_187(iParam0->f_28[0])) && !func_188()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_193(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_206(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_206(uParam1) && uParam1->f_4 == 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_227(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_187(PLAYER::PLAYER_PED_ID()) && func_187(uParam0))
	{
...
int func_230(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_223(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_223(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_222(vVar3, vVar0);
