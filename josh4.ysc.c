...
void func_1()
{
	...
	switch (iLocal_88)
	{
		case 0:
			...
			{
				ENTITY::SET_ENTITY_PROOFS(uLocal_507, 0, 0, 0, 0, 0, 0, 0, 0);
			}
			if (func_428(uLocal_508))
			{
				ENTITY::SET_ENTITY_PROOFS(uLocal_508, 0, 0, 0, 0, 0, 0, 0, 0);
			}
		...
		case 1:
			...
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) <= 0 && !func_205())
			{
				...
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_507, 0))
					{
						func_202(777);
					}
				}
	...
	switch (iLocal_102)
	{
		case 0:
			if (iLocal_101 == 3)
			{
				if (func_428(Local_443.f_28[0]))
				{
					...
					{
						if (GAMEPLAY::IS_POSITION_OCCUPIED(-1138.421f, 298.0307f, 65.90032f, 4f, 0, 1, 0, 0, 0, uLocal_508, 0))
						{
							func_476("Back gate blocked");
							vLocal_110 = { -1130.35f, 307.92f, 65.19f };
							AI::OPEN_SEQUENCE_TASK(&uLocal_506);
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_110, 2f, 20000, 1f, 1, 1193033728);
						...
						else
						{
							...
							if (func_203(uLocal_508))
							{
								AI::TASK_VEHICLE_MISSION_PED_TARGET(0, uLocal_508, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, 1);
							}
							else
							{
								AI::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
					...
					else
					{
						...
						if (func_203(uLocal_508))
						{
							AI::TASK_ENTER_VEHICLE(0, uLocal_508, 20000, -1, 1073741824, 1, 0);
							AI::TASK_VEHICLE_MISSION_PED_TARGET(0, uLocal_508, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, 1);
						}
						else
						{
		...
		case 1:
			if (func_428(Local_443.f_28[0]))
			{
				...
				if (func_203(uLocal_508))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_443.f_28[0], uLocal_508, 1))
					{
						if (VEHICLE::GET_VEHICLE_ENGINE_HEALTH(uLocal_508) < 20f)
						{
							AI::CLEAR_PED_TASKS(Local_443.f_28[0]);
					...
					if (func_428(PLAYER::PLAYER_PED_ID()))
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_508, 1))
						{
							AI::CLEAR_PED_TASKS(Local_443.f_28[0]);
							AI::TASK_SMART_FLEE_PED(Local_443.f_28[0], PLAYER::PLAYER_PED_ID(), 510f, -1, 0, 0);
							func_228(&uLocal_508);
				...
				if (func_428(PLAYER::PLAYER_PED_ID()) && func_428(Local_443.f_28[0]))
				{
					if (iLocal_529 < 3)
					{
						...
						{
							if (!func_205() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_532) > 8000)
							{
...
void func_231()
{
	switch (Local_89.f_11)
	{
		...
		case 1:
			...
			{
				Local_89.f_7 = VEHICLE::CREATE_VEHICLE(iLocal_85, Local_89, 0, 1, 1, 0);
	...
	if (func_428(PLAYER::PLAYER_PED_ID()) && func_428(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_247(PLAYER::PLAYER_PED_ID(), iParam0, iParam2);
				}
			}
		}
		if (bParam4)
...
int func_251(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_243(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_243(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_242(vVar3, vVar0);
				...
				case 0:
					if (func_284(1, 1093140480, 0))
					{
						...
						if (func_203(uVar0))
						{
							...
							else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(uVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, 0, 1, 0))
							{
						...
						if (func_203(uLocal_507))
						{
							ENTITY::SET_ENTITY_COORDS(uLocal_507, -1107.5f, 280.33f, 64.01f, 1, 0, 0, 1);
							ENTITY::SET_ENTITY_HEADING(uLocal_507, 97.97f);
							VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_507, 1084227584);
						}
						iLocal_527++;
					}
					break;
...
void func_267()
{
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Security_guard_pistol", 0))
	{
		...
		{
			WEAPON::GIVE_WEAPON_OBJECT_TO_PED(uLocal_504, Local_443.f_28[1]);
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("FBI_Agent_1_Gun", 0))
	{
		...
		{
			WEAPON::GIVE_WEAPON_OBJECT_TO_PED(uLocal_505, Local_443.f_28[2]);
...
void func_283()
{
	...
	if (func_428(Local_443.f_28[1]))
	{
		uLocal_504 = WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_pistol"), -1, ENTITY::GET_ENTITY_COORDS(Local_443.f_28[1], 1), 1, 1065353216, 0, 0, 1);
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_443.f_28[1], "Cop_standing_idle", 0, 0, 0);
		func_476("*** Registered Cop standing");
	}
	if (func_428(Local_443.f_28[2]))
	{
		uLocal_505 = WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_pistol"), -1, ENTITY::GET_ENTITY_COORDS(Local_443.f_28[2], 1), 1, 1065353216, 0, 0, 1);
	...
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_504, "Security_guard_pistol", 0, 0, 0);
		func_476("*** Registered idle cop gun");
	}
	if (func_428(uLocal_505))
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_505, "FBI_Agent_1_Gun", 0, 0, 0);
...
void func_291(int iParam0)
{
	...
	if (func_428(Local_443.f_28[0]))
	{
		if (iParam0 == 1)
		{
			...
			AI::TASK_PLAY_ANIM(Local_443.f_28[0], "rcmjosh4", "josh_leadout_loop", 1090519040, -1056964608, -1, 1, 0, 0, 0, 0);
		}
...
{
	func_227(uParam0);
	*uParam0 = PED::CREATE_PED(iParam6, uParam1, vParam2, fParam5, 0, 0);
}
