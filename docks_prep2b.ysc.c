...
{
	func_6(&(Global_99633.f_2875), vParam0, fParam3);
}
...
void func_15(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_17(Global_106070.f_18505[iVar0], &vVar2, &fVar5))
			{
...
{
	return func_38(&(Global_99633.f_2875), vParam0, fParam3, 0);
}
...
int func_156(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2535519[iParam0 /*3*/][func_157(iParam1)];
...
void func_164(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_166(Var11.f_1)) && iVar72 < 50)
			{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_96664.f_4, 0))
		{
			if (func_249(24) != Global_96664.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_246(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
