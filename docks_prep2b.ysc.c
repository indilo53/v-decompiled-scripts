...
void func_36()
{
	switch (iLocal_28)
	{
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_48))
			{
				GAMEPLAY::CLEAR_AREA(vLocal_311, 10f, 1, 0, 0, 0);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_49[0]))
			{
				if (STREAMING::HAS_MODEL_LOADED(joaat("buzzard")))
				{
					...
					uLocal_49[0] = VEHICLE::CREATE_VEHICLE(joaat("buzzard"), -1866.446f, 3071.395f, 31.8104f, 150.2863f, 1, 1, 0);
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_49[0], 1, 1);
					VEHICLE::SET_VEHICLE_CAN_BE_TARGETTED(uLocal_49[0], 1);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_49[0], 1084227584);
					AUDIO::_DYNAMIC_MIXER_RELATED_FN(uLocal_49[0], "DH_P_2B_ENEMY_CHOPPERS", 0);
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("buzzard"));
					VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_49[0], 0);
				}
			}
			if (func_267())
			{
		...
		case 3:
			...
			{
				uLocal_31[0] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_49[0], 26, joaat("s_m_m_pilot_02"), -1, 1, 1);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("s_m_m_pilot_02"));
			}
			else if (!PED::IS_PED_IN_VEHICLE(uLocal_31[0], uLocal_49[0], 0))
			{
		...
		case 5:
			...
			{
				uLocal_51[0] = VEHICLE::CREATE_VEHICLE(joaat("sandking"), 1754.951f, 3290.994f, 40.1176f, 182.397f, 1, 1, 0);
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_51[0], 1);
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_8(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
	...
	if (iLocal_201 == 0)
	{
		if (STREAMING::HAS_MODEL_LOADED(joaat("s_m_y_marine_01")) && STREAMING::HAS_MODEL_LOADED(joaat("s_m_m_pilot_02")))
		{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_31[0]))
			{
				...
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_31[0], uLocal_60);
			...
			while (iLocal_176 <= 12)
			{
				if (iLocal_275[iLocal_176] == 0)
				{
					if (!PED::IS_PED_INJURED(uLocal_33[iLocal_176]))
					{
						...
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_33[iLocal_176], uLocal_60);
...
void func_115()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_49[0]))
	{
		AUDIO::_0x18EB48CFC41F2EA0(uLocal_49[0], 0);
	}
	...
	{
		VEHICLE::DELETE_VEHICLE(&uLocal_47);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_55))
	{
	...
	if (iLocal_175 == 1)
	{
		if (iLocal_308 == 0)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_48))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_48, 0))
					{
						if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_311, 1) > 800f)
						{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_48))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_48, 0))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_314, 2f, 2f, 2f, 1, 1, 0))
					{
					}
...
void func_164(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_166(Var11.f_1)) && iVar72 < 51)
			{
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_204(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_223()
{
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_314, 1) < 500f)
	{
		if (iLocal_214 == 0)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_51[0]))
	...
	{
		if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_314, 1) > 550f)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_51[0]))
			{
				VEHICLE::DELETE_VEHICLE(&(uLocal_51[0]));
...
void func_228()
{
	uLocal_53 = VEHICLE::GET_CLOSEST_VEHICLE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 300f, joaat("lazer"), 4);
	uLocal_54 = VEHICLE::GET_CLOSEST_VEHICLE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 300f, joaat("lazer"), 16386);
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_53) && ENTITY::IS_ENTITY_IN_AIR(uLocal_53))
	{
		if (!UI::DOES_BLIP_EXIST(uLocal_65))
		{
			uLocal_65 = UI::ADD_BLIP_FOR_ENTITY(uLocal_53);
			UI::SET_BLIP_AS_FRIENDLY(uLocal_65, 0);
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_54) && ENTITY::IS_ENTITY_IN_AIR(uLocal_54))
	{
		if (!UI::DOES_BLIP_EXIST(uLocal_66))
		{
			uLocal_66 = UI::ADD_BLIP_FOR_ENTITY(uLocal_54);
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_48))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_48, 0))
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(uLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(uLocal_31[0]))
								{
									...
									{
										if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_320, -75.8f, -819.9f, 326f, 1) > 1600f && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_320, -2159f, 3067f, 33f, 1) < 1000f)
										{
											if (vLocal_320.z > 70f)
											{
												if (iLocal_30 != 2)
										...
										{
											if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_320, -75.8f, -819.9f, 326f, 1) < 1600f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_215[0] = 1;
											...
											if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_320, -2159f, 3067f, 33f, 1) > 1000f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_215[0] = 1;
				...
				else if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_320, -75.8f, -819.9f, 326f, 1) > 1600f)
				{
					if (iLocal_30 != 0)
					{
						iLocal_215[0] = 1;
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
				{
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_31[0]))
					{
						if (!PED::IS_PED_INJURED(uLocal_31[0]))
						{
							...
							{
								vLocal_317 = { ENTITY::GET_ENTITY_COORDS(uLocal_49[0], 1) };
								AI::CLEAR_PED_TASKS(uLocal_31[0]);
								PED::SET_PED_SPHERE_DEFENSIVE_AREA(uLocal_31[0], vLocal_317, 10f, 0, 0);
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
				{
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_31[0]))
					{
						if (!PED::IS_PED_INJURED(uLocal_31[0]))
						{
							...
							if (!PED::IS_PED_IN_VEHICLE(uLocal_31[0], uLocal_49[0], 0))
							{
								AI::TASK_ENTER_VEHICLE(0, uLocal_49[0], 20000, -1, 1073741824, 1, 0);
							}
							AI::TASK_HELI_MISSION(0, uLocal_49[0], 0, 0, vLocal_317.x, vLocal_317.y, (vLocal_317.z + 20f), 4, 30f, 10f, -1f, 170, 40, -1082130432, 0);
							AI::TASK_HELI_MISSION(0, uLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 40, -1082130432, 0);
				...
				if (ENTITY::DOES_ENTITY_EXIST(uLocal_31[0]))
				{
					if (!PED::IS_PED_INJURED(uLocal_31[0]))
					{
						if (PED::IS_PED_IN_VEHICLE(uLocal_31[0], uLocal_49[0], 0))
						{
							...
							if (func_2(uLocal_49[0], PLAYER::PLAYER_PED_ID(), 1) < 300f)
							{
								if (iLocal_299 == 0)
								{
					...
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(uLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(uLocal_31[0]))
								{
									AI::TASK_HELI_MISSION(uLocal_31[0], uLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 15, 10, -1082130432, 0);
									iLocal_215[0] = 0;
								}
							}
						}
					...
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(uLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(uLocal_31[0]))
								{
									AI::TASK_HELI_MISSION(uLocal_31[0], uLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 50, 20, -1082130432, 0);
									iLocal_215[0] = 0;
								}
							}
						}
					...
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(uLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(uLocal_31[0]))
								{
									AI::TASK_HELI_MISSION(uLocal_31[0], uLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 70, -1082130432, 0);
									iLocal_215[0] = 0;
								}
							}
						}
					...
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(uLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(uLocal_31[0]))
								{
									AI::TASK_HELI_MISSION(uLocal_31[0], uLocal_49[0], 0, 0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_49[0], 20f, 0f, 0f), 4, 10f, 10f, ENTITY::GET_ENTITY_HEADING(uLocal_49[0]), SYSTEM::ROUND(ENTITY::GET_ENTITY_HEIGHT(uLocal_49[0], ENTITY::GET_ENTITY_COORDS(uLocal_49[0], 1), 1, 1)), 100, -1082130432, 0);
									iLocal_215[0] = 0;
								}
							}
						}
						...
						if (ENTITY::DOES_ENTITY_EXIST(uLocal_49[0]))
						{
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
							{
								if (ENTITY::DOES_ENTITY_EXIST(uLocal_31[0]))
								{
									if (!PED::IS_PED_INJURED(uLocal_31[0]))
									{
										AI::TASK_HELI_MISSION(uLocal_31[0], uLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 170, 70, -1082130432, 0);
										iLocal_295 = 1;
									}
								}
							}
					...
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_49[0]))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
						{
							if (ENTITY::DOES_ENTITY_EXIST(uLocal_31[0]))
							{
								if (!PED::IS_PED_INJURED(uLocal_31[0]))
								{
									AI::TASK_HELI_MISSION(uLocal_31[0], uLocal_49[0], 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 8, 40f, 50f, -1f, 200, 170, -1082130432, 0);
									iLocal_215[0] = 0;
								}
							}
						}
		...
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_49[0]))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_90209[1]))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_90209[1], 0))
				{
					...
					VEHICLE::SET_VEHICLE_CAN_BE_TARGETTED(uLocal_49[0], 1);
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_49[0], 1, 1);
					ENTITY::FREEZE_ENTITY_POSITION(uLocal_49[0], 0);
					AUDIO::_DYNAMIC_MIXER_RELATED_FN(uLocal_49[0], "DH_P_2B_ENEMY_CHOPPERS", 0);
					VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_49[0], 0);
				}
			}
				...
				while (iLocal_184 <= 12)
				{
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_33[iLocal_184]))
					{
						if (!PED::IS_PED_INJURED(uLocal_33[iLocal_184]))
						{
							...
							{
								if (PED::_CAN_PED_SEE_PED(uLocal_33[iLocal_184], PLAYER::PLAYER_PED_ID()))
								{
...
{
	GAMEPLAY::CLEAR_BIT(&Global_89567, iParam0);
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_249(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_246(ENTITY::GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
void func_250()
{
	if (iLocal_175 == 0)
	{
		...
		func_254(4, 0);
		func_254(12, 0);
		PED::ADD_RELATIONSHIP_GROUP("MarineGroupHash", &uLocal_60);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_60, 1862763509);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, -472287501, 1862763509);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_60, -472287501);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -472287501, uLocal_60);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, uLocal_60);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_60, -1533126372);
...
void func_258()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (func_231(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 3, 200, 0) || iLocal_211 == 1)
			{
		...
		if (iLocal_28 == 4)
		{
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) != 0 && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_311, 1) > 1000f)
			{
				PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 0, 0);
				PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), 0);
			}
	...
	if (iLocal_289 == 0)
	{
		...
		while (iLocal_185 <= 12)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_33[iLocal_185]))
			{
				...
				{
					if (PED::_CAN_PED_SEE_PED(uLocal_33[iLocal_185], PLAYER::PLAYER_PED_ID()))
					{
					...
					if (iLocal_290 == 0 && iLocal_291 == 0)
					{
						if (!func_124())
						{
							if (!UI::IS_MESSAGE_BEING_DISPLAYED() || !UI::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
							{
								...
								{
									if (PED::_CAN_PED_SEE_PED(uLocal_33[iLocal_192], PLAYER::PLAYER_PED_ID()))
									{
										if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !func_237(0))
										{
											if (func_236(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed"))
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_262(iParam2), 1);
}
