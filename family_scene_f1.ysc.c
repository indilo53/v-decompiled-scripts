	...
	if (Global_88735 != 8)
	{
		if (Global_88736 == -1)
		{
			...
			if (func_7())
			{
				...
				{
					Global_88736 = GAMEPLAY::GET_GAME_TIMER();
					return 1;
				}
			}
			else
...
void func_8(vector3 vParam0, vector3 vParam3, var uParam6)
{
	if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if ((FIRE::IS_EXPLOSION_IN_AREA(0, vParam0, vParam3) || FIRE::IS_EXPLOSION_IN_AREA(2, vParam0, vParam3)) || GAMEPLAY::IS_PROJECTILE_TYPE_IN_AREA(vParam0, vParam3, joaat("weapon_grenadelauncher"), 1))
		{
			Global_88735 = 5;
		}
	}
...
int func_41(int iParam0, vector3 vParam1, float fParam4)
{
	...
	if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vParam1, 1) >= (100f * fParam4))
	{
		return 0;
	}
	if (Global_93732)
...
int func_42(int iParam0)
{
	...
	if (GAMEPLAY::GET_RANDOM_EVENT_FLAG() && Global_106555)
	{
		return 0;
	}
	if (!func_27(iParam0))
	...
	if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_9079.f_2[27 /*3*/], 1))
	{
		return 0;
	}
	return 1;
...
int func_69()
{
	...
	while (iVar23 < 11)
	{
		...
		{
			uVar24 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vVar1, 10f, iVar0, 0, 0, 1);
			if (ENTITY::DOES_ENTITY_EXIST(uVar24))
			{
				if (iVar5 == 825812850)
				{
					ENTITY::SET_ENTITY_ROTATION(uVar24, 0f, 0f, 21f, 2, 1);
				}
				ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uVar24);
			}
		}
		if (iVar4 != 226)
		{
...
int func_77(var uParam0, char* sParam1, int iParam2)
{
	...
	if (PLAYER::GET_CAUSE_OF_MOST_RECENT_FORCE_CLEANUP() == 64 && ENTITY::GET_ENTITY_MODEL(uParam0) != joaat("prop_bong_01"))
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0) && !ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(uParam0, 1))
		{
	...
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(uParam0) && PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(uParam0), 0))
			{
				return 0;
			}
		}
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
	{
		...
		if (ENTITY::GET_ENTITY_MODEL(uParam0) == joaat("prop_bong_01"))
		{
			return 0;
		}
	}
