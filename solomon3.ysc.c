...
void func_60(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_62(Var11.f_1)) && iVar72 < 51)
			{
				...
				case 0:
					...
					if (func_395())
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(Global_90209[3]))
						{
							...
							{
								ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_90209[3], 1, 1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_365(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_362(ENTITY::GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
