...
void func_17()
{
	...
	else
	{
		...
		{
			if (!bLocal_427 && CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(0, 75))
			{
				bLocal_427 = true;
			}
			switch (iLocal_424)
			{
				...
				case 2:
					AI::OPEN_SEQUENCE_TASK(&uLocal_430);
					AI::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_loop", 8f, -8f, 1500, 9, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uLocal_430);
					AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_430);
					AI::CLEAR_SEQUENCE_TASK(&uLocal_430);
					iLocal_421 = GAMEPLAY::GET_GAME_TIMER() + 2000;
					iLocal_424 = 3;
					break;
				
				case 3:
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_421)
					{
						...
						iLocal_421 = GAMEPLAY::GET_GAME_TIMER() + 2400;
						iLocal_424 = 4;
					}
					break;
				...
				case 7:
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_421 && !AI::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2))
					{
						AI::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
						AI::TASK_LEAVE_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_159.f_4, 0);
						PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 1, 0);
					}
					break;
				}
	...
	switch (iLocal_157)
	{
		case 0:
			...
			if (func_410(iLocal_188))
			{
				...
				UI::SET_BLIP_ROUTE(uLocal_158, 1);
				if (bLocal_180)
				{
					func_12(7);
				}
				if ((!func_15() && iLocal_438) && !CONTROLS::IS_CONTROL_PRESSED(0, 74))
				{
					iLocal_431 = 0;
				}
				iLocal_157 = 1;
...
{
	UI::CLEAR_THIS_PRINT(vLocal_458[iParam0 /*3*/].f_2);
}
...
void func_135(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_129(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_129(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_118(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_243()
{
	if (GAMEPLAY::GET_GAME_TIMER() > iLocal_422)
	{
...
void func_270(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_272(Var11.f_1)) && iVar72 < 51)
			{
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_310(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
		...
		case 1:
			...
			else if (func_2())
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_159.f_4, Local_439[0 /*7*/][0 /*3*/], Local_439[0 /*7*/][1 /*3*/], fLocal_454[0], 0, 1, 0))
				{
					...
					if (!iLocal_420)
					{
						if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_423) > 1000)
						{
		...
		case 2:
			...
			else if (!VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_188, Local_159.f_4))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_159.f_4, Local_439[1 /*7*/][0 /*3*/], Local_439[1 /*7*/][1 /*3*/], fLocal_454[1], 0, 1, 0))
				{
					...
					{
						iLocal_422 = GAMEPLAY::GET_GAME_TIMER() + 5000;
						iLocal_156 = 12;
					}
				}
				else
...
void func_331()
{
	switch (iLocal_157)
	{
		case 0:
			...
			{
				func_17();
				if (!iLocal_416 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_422) > 8000)
				{
				...
				else if (!iLocal_417 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_422) > 120000)
				{
					if (!func_333())
					{
				...
				else if (!iLocal_418 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_422) > 160000)
				{
...
void func_364()
{
	switch (iLocal_157)
	{
		...
		case 1:
			if (((!bLocal_427 && iLocal_424 != 0) && (iLocal_425 > 0 && iLocal_425 < 4)) && CONTROLS::IS_DISABLED_CONTROL_JUST_PRESSED(0, 75))
			{
				bLocal_427 = true;
			}
			switch (iLocal_424)
			{
				...
				case 2:
					if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_159.f_4, -1, 0) == PLAYER::PLAYER_PED_ID() && PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_159.f_4))
					{
						if (iLocal_425 == 3)
						{
							AI::OPEN_SEQUENCE_TASK(&uLocal_430);
							AI::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
							AI::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_loop", 8f, -8f, 8000, 9, 0, 0, 0, 0);
							AI::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
							AI::CLOSE_SEQUENCE_TASK(uLocal_430);
							AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_430);
							AI::CLEAR_SEQUENCE_TASK(&uLocal_430);
						...
						else if (iLocal_425 == 2)
						{
							if (func_21(&uLocal_251, "BAR3CAU", "BAR3C_C1", 7, 0, 0, 0))
							{
								AI::OPEN_SEQUENCE_TASK(&uLocal_430);
								AI::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
								AI::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_loop", 8f, -8f, (1200 + iLocal_425 * 250), 9, 0, 0, 0, 0);
								AI::TASK_PLAY_ANIM(0, sLocal_429, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
								AI::CLOSE_SEQUENCE_TASK(uLocal_430);
								AI::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_430);
								AI::CLEAR_SEQUENCE_TASK(&uLocal_430);
				...
				case 3:
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_421)
					{
						if (iLocal_425 == 4)
						{
							...
							iLocal_421 = GAMEPLAY::GET_GAME_TIMER() + 9100;
						}
						else
						{
							AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_426, "IGNITION_FAIL", Local_159.f_4, "BARRY_03_SOUNDSET", 0, 0);
							AUDIO::SET_VARIABLE_ON_SOUND(uLocal_426, "HOLD TIME", (SYSTEM::TO_FLOAT((1200 + iLocal_425 * 250)) / 1000f));
							iLocal_421 = (GAMEPLAY::GET_GAME_TIMER() + iLocal_425 * 250) + 1200 + 766;
						}
						iLocal_424 = 4;
					}
					break;
				...
				case 4:
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_421)
					{
						...
						else
						{
							...
							if (iLocal_425 == 4)
							{
								AI::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_429, "franklinfailingtostartcar_slamwheel", 1000f, -8f, 3300, 0, 0, 0, 0, 0);
								iLocal_421 = GAMEPLAY::GET_GAME_TIMER() + 330;
								iLocal_424 = 5;
							}
							else
							{
				...
				case 5:
					if (GAMEPLAY::GET_GAME_TIMER() > iLocal_421)
					{
						VEHICLE::START_VEHICLE_HORN(Local_159.f_4, 500, GAMEPLAY::GET_HASH_KEY("NORMAL"), 0);
						iLocal_421 = GAMEPLAY::GET_GAME_TIMER() + 2000;
						iLocal_424 = 8;
					}
					break;
		...
		case 2:
			if (!func_15() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_421) > 2500)
			{
				iLocal_157 = 0;
				iLocal_156 = 2;
			}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_159.f_4))
	{
		...
		else if (iLocal_169)
		{
			if (VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(Local_159.f_4))
			{
				if (iLocal_166)
				{
					if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_170) > 7000)
					{
				...
				{
					iLocal_166 = 1;
					iLocal_170 = GAMEPLAY::GET_GAME_TIMER();
				}
			}
			else
			{
...
void func_374()
{
	switch (iLocal_157)
	{
		case 0:
			func_41(&uLocal_158);
			if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_487))
			{
				sLocal_487 = "DEFAULT";
			}
			if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_487, "DEFAULT"))
			{
				func_460(1);
			}
			else
...
void func_415(vector3 vParam0, float fParam3, bool bParam4)
{
	...
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iLocal_188, uLocal_190);
...
void func_418(vector3 vParam0, float fParam3)
{
	...
	uLocal_172 = OBJECT::CREATE_OBJECT(iLocal_179, vParam0 + vLocal_173, 1, 1, 0);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_172, Local_159.f_4, 0, vLocal_173, vLocal_176, 0, 0, 0, 0, 2, 1);
}
...
void func_431(bool bParam0)
{
	...
	{
		iLocal_457 = 0;
		iLocal_422 = GAMEPLAY::GET_GAME_TIMER() + 3000;
		iLocal_156 = 12;
	}
	iLocal_157 = 0;
	iLocal_250 = 0;
