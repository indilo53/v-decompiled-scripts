...
void func_3(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	switch (func_306(uParam1))
	{
		...
		case 4:
			if (func_267(uParam0))
			{
				if (uParam0->f_1657 == 1)
				{
					...
					func_265(uParam0[iParam3 /*94*/], PED::CREATE_PED(1, uParam0->f_1669, vVar23, GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(uParam0->f_1658, uParam0->f_1658.f_1), 0, 0));
					...
					func_265(uParam0[iParam4 /*94*/], PED::CREATE_PED(1, uParam0->f_1668, vVar3, GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(-uParam0->f_1658, -uParam0->f_1658.f_1), 0, 0));
		...
		case 8:
			...
			bVar26 = (GAMEPLAY::GET_GAME_TIMER() > func_253(uParam0[iParam3 /*94*/]) && GAMEPLAY::GET_GAME_TIMER() > func_253(uParam0[iParam4 /*94*/]));
...
{
	if (!((!PED::IS_PED_INJURED(func_264(uParam0)) && AI::_0x921CE12C489C4C41(func_264(uParam0))) && GAMEPLAY::ARE_STRINGS_EQUAL(AI::_GET_PED_NETWORK_TASK_PHASE(func_264(uParam0)), "running")))
	{
...
int func_40(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2535519[iParam0 /*3*/][func_38(iParam1)];
...
void func_108(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_45(func_264(uParam0)) == 17 && GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.5f)
	{
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, uParam1, uParam2, func_111(iParam3), 0);
}
...
int func_139(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	if (iVar0 == 72)
	{
		iVar19 = func_143(uParam0, &vVar20, &vVar23, &vLocal_314, &vLocal_320, &vLocal_323, 0, &fVar29, &fVar30, &uVar26);
		if (iVar19 == 0)
		{
	...
	{
		iVar19 = func_143(uParam0, &vVar20, &vVar23, &vLocal_302, &vLocal_308, &vLocal_311, 1, &fVar29, &fVar30, &uVar26);
		if (iVar19 == 0)
		{
			func_142(uParam0, 0.5f);
			func_141(uParam0, 1f);
...
int func_143(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, float fParam7, float fParam8, var uParam9)
{
	...
	*fParam8 = GAMEPLAY::_0x7F8F6405F4777AF6(vVar9, func_116(bParam6, *uParam5, *uParam4), func_116(bParam6, *uParam4, *uParam5), 0);
				...
				if ((uParam3[iVar32 /*12*/])->f_1 >= 0f)
				{
					...
					if (iVar3 < (*uParam4 - 2) && iVar3 >= 0)
					{
						if (iVar24 == 0 && (iVar32 == 72 || iVar32 == 73))
						{
							...
							if (iVar32 == 72)
							{
								iVar37 = func_143(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &vLocal_314, &vLocal_320, &vLocal_323, 0, &fVar38, &fVar39, &vVar28);
							}
							else
							{
								iVar37 = func_143(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &vLocal_302, &vLocal_308, &vLocal_311, 1, &fVar38, &fVar39, &vVar28);
							}
							if (iVar37 != 0)
							{
...
int func_182(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (func_104(uParam2, 4))
	{
		...
		else if (uParam2->f_4.f_20 == 0)
		{
			...
			iVar0 = func_50(GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.2f, 6, uVar12);
		}
		else if (uParam2->f_4.f_20 == 1)
		{
			uVar12 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(1, 4);
			iVar0 = func_50(GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.1f, 6, uVar12);
		}
		else if (uParam2->f_4.f_20 == 2)
		{
			iVar0 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 2);
		}
		vVar6 = { func_122(vVar9, vVar6, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216)) };
...
void func_183(var uParam0, var uParam1, var uParam2)
{
	...
	uVar0 = *uParam1;
	vVar1 = { func_184(SYSTEM::TO_FLOAT(*uParam2), SYSTEM::TO_FLOAT(uParam2->f_1), uVar0, &(uParam1->f_40), &(uParam1->f_43)) };
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_247))
	{
		if (uParam0->f_1657 != 1 && !func_274(&(uParam0->f_247)))
		{
...
void func_200(var uParam0)
{
	if (func_211(uParam0))
	{
		if (!func_210(uParam0))
		{
			uParam0->f_2 = (func_201(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
...
void func_205(var uParam0)
{
	if (func_211(uParam0))
	{
		if (func_210(uParam0))
		{
			uParam0->f_1 = (func_201(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - uParam0->f_2);
			uParam0->f_2 = 0f;
...
{
	uParam0->f_1 = (func_201(GAMEPLAY::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
int func_213(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else if (func_104(uParam0[iParam1 /*94*/], 8192) && iParam1 == iParam2)
	{
		...
		{
			if (GAMEPLAY::ARE_STRINGS_EQUAL(AI::_GET_PED_NETWORK_TASK_PHASE(func_264(uParam0[iParam1 /*94*/])), "Intro") && AI::_0x30ED88D5E0C56A37(func_264(uParam0[iParam1 /*94*/])))
			{
...
void func_217(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (!PED::IS_PED_INJURED(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		else
		{
			...
			fVar4 = (GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(uParam0->f_40, uParam0->f_40.f_1) + func_144(bParam6, 180f, 0f));
			...
			if (!bParam6 && bParam7)
			{
				...
				AI::TASK_PLAY_ANIM(0, func_195(func_196(uParam0), "mini@tennis", "mini@tennis@female"), "idle", 1.5f, -8f, iVar10, 0, 0, 0, 0, 0);
			}
			if (!bParam8)
			{
...
void func_226(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	if (!PED::IS_PED_INJURED(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		else
		{
			ENTITY::SET_ENTITY_HEADING(uParam0->f_32, ENTITY::GET_ENTITY_HEADING(uParam0->f_32));
			func_58(uParam0, 16384);
			fVar4 = (GAMEPLAY::GET_HEADING_FROM_VECTOR_2D(uParam0->f_40, uParam0->f_40.f_1) + func_144(bParam8, 180f, 0f));
			vVar5 = { uParam1->f_189.f_29 - ENTITY::GET_ENTITY_COORDS((uParam1[iParam3 /*94*/])->f_32, 1) };
			bVar8 = func_69(vVar5, uParam0->f_40) < 0f;
			bVar9 = func_69(vVar5, uParam0->f_43) < 0f;
			func_221(uParam0, 0);
...
void func_235(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	else if (uParam0->f_31 != 3)
	{
		...
		{
			if (GAMEPLAY::ARE_STRINGS_EQUAL(AI::_GET_PED_NETWORK_TASK_PHASE(func_264(uParam0)), "Intro") && AI::_0x30ED88D5E0C56A37(func_264(uParam0)))
			{
			...
			AI::_SET_NETWORK_TASK_PARAM_BOOL(func_264(uParam0), &(uParam1->f_1670), 1);
			AI::_SET_NETWORK_TASK_PARAM_FLOAT(func_264(uParam0), "Speed", uParam0->f_62);
		}
	}
	...
	switch (func_147(&(uParam0->f_4)))
	{
		...
		case 5:
			if (func_75(uParam0) == 75)
			{
				...
				{
					AI::TASK_GO_STRAIGHT_TO_COORD(func_264(uParam0), vVar3, 2f, -1, 1193033728, 1056964608);
				...
				else if ((ENTITY::IS_ENTITY_AT_COORD(uParam0->f_32, func_70(&(uParam0->f_4)), vVar6, 0, 1, 0) || AI::GET_SCRIPT_TASK_STATUS(func_264(uParam0), 2106541073) == 7) && !func_227(&(uParam0->f_4), 256))
				{
					func_234(&(uParam0->f_4), 0);
					func_216(&(uParam0->f_4), 4);
				}
		...
		case 1:
			if (func_75(uParam0) == 75)
			{
				GAMEPLAY::_0xF56DFB7B61BE7276(func_282(uParam4), func_282(uParam4) + uParam4->f_10, uParam0->f_37, uParam0->f_40, &fVar9);
				...
				else if (SYSTEM::VDIST2(uParam0->f_37, vVar3) <= (0f * 0f) || AI::GET_SCRIPT_TASK_STATUS(func_264(uParam0), 2106541073) == 7)
				{
...
void func_261(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!PED::IS_PED_INJURED(func_264(uParam0[iParam1 /*94*/])) && !PED::IS_PED_INJURED(func_264(uParam0[iParam2 /*94*/])))
	{
		...
		else
		{
			if (!bParam4)
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam1 /*94*/])->f_33, func_264(uParam0[iParam1 /*94*/]), PED::GET_PED_BONE_INDEX(func_264(uParam0[iParam1 /*94*/]), 28422), vLocal_296, vLocal_299, 0, 0, 0, 0, 2, 1);
			}
			ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam2 /*94*/])->f_33, func_264(uParam0[iParam2 /*94*/]), PED::GET_PED_BONE_INDEX(func_264(uParam0[iParam2 /*94*/]), 28422), vLocal_296, vLocal_299, 0, 0, 0, 0, 2, 1);
		}
	}
}
...
int func_278(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, bool bParam8, float fParam9, bool bParam10, float fParam11, bool bParam12)
{
	...
	vVar0 = { 0f, 0f, 1f };
	fVar3 = func_144(fParam9 == -1f, GAMEPLAY::GET_FRAME_TIME(), fParam9);
	iVar4 = 0;
...
void func_332(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_334(Global_106070.f_18505[iVar0], &vVar2, &fVar5))
			{
