...
void __EntryFunction__()
{
	...
	GAMEPLAY::CLEAR_BIT(&(Global_106565.f_18568.f_382), 1);
...
void func_4()
{
	...
	if (iLocal_370 == 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			{
				PATHFIND::GET_SAFE_COORD_FOR_PED(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 0, &vLocal_230, 0);
...
void func_30(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_32() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_32() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
int func_38(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_32() /*10778*/].f_6165.f_10, iParam0);
}
...
void func_62()
{
	...
	else if (UI::DOES_BLIP_EXIST(uLocal_941))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_289(PLAYER::PLAYER_PED_ID(), uLocal_597[3], 0) < 1f)
			{
				UI::REMOVE_BLIP(&uLocal_941);
	...
	{
		vVar1 = { ENTITY::GET_ENTITY_COORDS(iLocal_615, 1) };
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_615, 0f, 0f, (vVar1.z - 200f)), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_615, 500f, 0f, (vVar1.z + 200f)), 1000f, 0, 1, 0))
		{
...
int func_116(var uParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(uParam0, func_156(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(uParam0, func_156(iParam1), Global_71402[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_156(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, 0);
		}
	}
...
int func_119(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_156(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_156(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_156(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_150(iVar0);
						if (Global_71400 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_156(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_156(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_156(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
void func_135(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_136(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
...
int func_137(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_156(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_142(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_156(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_137(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_137(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_137(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_137(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_173(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_167(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_167(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_156(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_228(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_156(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_156(iParam1)))
	{
		return 1;
	}
	return 0;
	...
	if (func_87(iLocal_578))
	{
		if (func_18(iLocal_615))
		{
			if (PED::IS_PED_IN_VEHICLE(iLocal_578, iLocal_615, 0))
			{
				...
				if (iLocal_333 == 0)
				{
					vLocal_209 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
							...
							if (iLocal_257 == iLocal_258 + 1 || iLocal_364 == 1)
							{
								...
								if (iLocal_281 > 3)
								{
									if (func_65(iLocal_578))
									{
										...
										if (iLocal_360 == 1)
										{
											AI::TASK_HELI_MISSION(iLocal_578, iLocal_615, 0, PLAYER::PLAYER_PED_ID(), vLocal_209, 9, 200f, 2f, -1f, iLocal_260 + 10, 50, -1082130432, 0);
											if (iLocal_262 > 0)
											{
												if (!func_291())
												{
					...
					{
						AI::TASK_HELI_MISSION(iLocal_578, iLocal_615, 0, 0, (vLocal_209.x + 600f), (vLocal_209.y + 600f), (vLocal_209.z + 100f), 4, 200f, -1f, -1f, -1, 100, -1082130432, 0);
	...
	if (iLocal_336 == 0)
	{
		if (iLocal_333 == 0)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_632, 0))
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_632, 0))
				{
					if (!UI::DOES_BLIP_EXIST(uLocal_938))
					{
						uLocal_938 = func_283(iLocal_632, 1, 5);
						if (iLocal_568 == 3)
						{
							if (UI::DOES_BLIP_EXIST(uLocal_939))
							{
								func_25(&uLocal_939);
								if (iLocal_332 == 0)
								{
						...
						{
							if (UI::DOES_BLIP_EXIST(uLocal_935))
							{
								func_25(&uLocal_935);
								if (iLocal_332 == 0)
								{
				...
				else
				{
					...
					else if (iLocal_568 == 4)
					{
						if (!UI::DOES_BLIP_EXIST(uLocal_935))
						{
							uLocal_935 = UI::ADD_BLIP_FOR_COORD(vLocal_158);
						}
					}
				}
			}
...
void func_284()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_580[iLocal_256]))
	{
		...
		{
			if (UI::DOES_BLIP_EXIST(uLocal_911[iLocal_256]))
			{
		...
		else if (!func_64(uLocal_580[iLocal_256], PLAYER::PLAYER_PED_ID(), fLocal_144, 1))
		{
			if (UI::DOES_BLIP_EXIST(uLocal_911[iLocal_256]))
			{
		...
		else if (UI::DOES_BLIP_EXIST(uLocal_911[iLocal_256]))
		{
			if (iLocal_256 != 0)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -367.5617f, -107.3702f, 32.44559f, -356.0586f, -74.55742f, 50.42249f, 82.25f, 0, 1, 0))
				{
					...
					else
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(uLocal_616[iLocal_256], 0))
						{
							...
							{
								if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_580[iLocal_256], 1), vLocal_224, 1) < GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_580[iLocal_256], 1), vLocal_227, 1))
								{
									AI::TASK_VEHICLE_DRIVE_TO_COORD(uLocal_580[iLocal_256], uLocal_616[iLocal_256], vLocal_224, 50f, 0, ENTITY::GET_ENTITY_MODEL(uLocal_616[iLocal_256]), 786468, 7f, 1f);
								}
								else
								{
									AI::TASK_VEHICLE_DRIVE_TO_COORD(uLocal_580[iLocal_256], uLocal_616[iLocal_256], vLocal_227, 50f, 0, ENTITY::GET_ENTITY_MODEL(uLocal_616[iLocal_256]), 786468, 7f, 1f);
								}
							}
						}
					}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (!ENTITY::IS_ENTITY_DEAD(uLocal_616[iLocal_256], 0))
							{
								...
								else if (func_87(uLocal_580[iLocal_256]))
								{
									...
									{
										AI::TASK_ENTER_VEHICLE(uLocal_580[iLocal_256], uLocal_616[iLocal_256], 20000, -1, 1073741824, 1, 0);
									}
								}
							}
						}
			...
			{
				UI::SET_BLIP_SCALE(uLocal_911[iLocal_256], fLocal_148);
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
			...
			{
				UI::SET_BLIP_SCALE(uLocal_911[iLocal_256], fLocal_147);
			}
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_588[iLocal_256]))
	{
		...
		{
			if (UI::DOES_BLIP_EXIST(uLocal_919[iLocal_256]))
			{
		...
		else if (!func_64(uLocal_588[iLocal_256], PLAYER::PLAYER_PED_ID(), fLocal_144, 1))
		{
			if (UI::DOES_BLIP_EXIST(uLocal_919[iLocal_256]))
			{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_570[iLocal_256]))
	{
		...
		{
			if (UI::DOES_BLIP_EXIST(uLocal_927[iLocal_256]))
			{
		...
		else if (!func_64(uLocal_570[iLocal_256], PLAYER::PLAYER_PED_ID(), fLocal_145, 1))
		{
	...
	if (iLocal_256 == 1 || iLocal_256 == 4)
	{
		...
		{
			if (UI::DOES_BLIP_EXIST(uLocal_936))
			{
				func_25(&uLocal_936);
	...
	if (iLocal_256 == 2 || iLocal_256 == 6)
	{
		if (!func_87(iLocal_578))
		{
			if (UI::DOES_BLIP_EXIST(uLocal_937))
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_615, 0))
				{
					VEHICLE::SET_VEHICLE_OUT_OF_CONTROL(iLocal_615, 0, 1);
		...
		else if (!func_64(iLocal_578, PLAYER::PLAYER_PED_ID(), fLocal_146, 1) && GAMEPLAY::GET_GAME_TIMER() > iLocal_290 + 15000)
		{
			if (UI::DOES_BLIP_EXIST(uLocal_937))
			{
		...
		if (!UI::DOES_BLIP_EXIST(uLocal_936))
		{
			if (func_64(iLocal_596, PLAYER::PLAYER_PED_ID(), fLocal_145, 1))
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_596, 0))
				{
					...
					UI::SET_BLIP_SCALE(uLocal_936, fLocal_147);
	...
	if (func_87(uLocal_588[iLocal_256]))
	{
		if (!UI::DOES_BLIP_EXIST(uLocal_919[iLocal_256]))
		{
			if ((PED::IS_PED_IN_COMBAT(uLocal_588[iLocal_256], PLAYER::PLAYER_PED_ID()) || GAMEPLAY::GET_GAME_TIMER() > iLocal_290 + 20100) || !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -335.8581f, -97.34045f, 62.20868f, -403.0932f, -76.60052f, 25.80415f, 34f, 0, 1, 0))
			{
				...
				UI::SET_BLIP_SCALE(uLocal_919[iLocal_256], fLocal_147);
			...
			if (PED::IS_PED_IN_COMBAT(uLocal_570[iLocal_256], PLAYER::PLAYER_PED_ID()) || GAMEPLAY::GET_GAME_TIMER() > iLocal_290 + 50)
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(uLocal_570[iLocal_256], 0))
				{
					if (func_64(uLocal_570[iLocal_256], PLAYER::PLAYER_PED_ID(), fLocal_145, 1))
					{
						...
						UI::SET_BLIP_SCALE(uLocal_927[iLocal_256], fLocal_147);
		...
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_290 + 300)
		{
			if (func_18(iLocal_615))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_578, 0))
				{
					if (!UI::DOES_BLIP_EXIST(uLocal_937))
					{
						uLocal_937 = UI::ADD_BLIP_FOR_ENTITY(iLocal_578);
						if (PED::IS_PED_IN_VEHICLE(iLocal_578, iLocal_615, 0) && iLocal_333 == 0)
						{
							UI::SET_BLIP_SCALE(uLocal_937, fLocal_148);
							UI::SET_BLIP_PRIORITY(uLocal_937, 7);
							UI::SET_BLIP_SPRITE(uLocal_937, 353);
							UI::SET_BLIP_COLOUR(uLocal_937, 1);
						}
						else
						{
							UI::SET_BLIP_SCALE(uLocal_937, fLocal_147);
							UI::SET_BLIP_PRIORITY(uLocal_937, 3);
							if (func_87(iLocal_578))
							{
								if (PED::IS_PED_IN_VEHICLE(iLocal_578, iLocal_615, 0))
								{
...
void func_294()
{
	...
	if (iLocal_369 == 0)
	{
		if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_632, 0))
		{
			...
			UI::SET_BLIP_SCALE(uLocal_940, fLocal_147);
			iLocal_369 = 1;
		}
	}
	if (iLocal_331 == 0)
...
void func_295()
{
	...
	if ((func_87(uLocal_570[5]) && func_17(iLocal_632)) && func_17(iLocal_615))
	{
		switch (iLocal_387)
		{
			...
			case 3:
				if ((func_281(uLocal_570[5], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_615, -1.5f, 0f, 0f), 0.5f) && AI::GET_SCRIPT_TASK_STATUS(uLocal_570[5], 713668775) != 1) && AI::GET_SCRIPT_TASK_STATUS(uLocal_570[5], 713668775) != 0)
				{
...
void func_297()
{
	...
	if (iLocal_336 == 0)
	{
		if (iLocal_298 == 0)
		{
			vLocal_218 = { ENTITY::GET_ENTITY_COORDS(iLocal_632, 1) };
...
void func_302()
{
	...
	{
		if ((func_18(iLocal_633) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -383.1558f, -102.7442f, 37.43079f, -371.1183f, -109.4619f, 40.42916f, 13f, 0, 1, 0)) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
		{
			if (func_87(iLocal_596))
			{
				if (iLocal_338 == 1)
				...
				else
				{
					...
					if (iLocal_363 == 1)
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_632, 0))
						{
							...
							else if (!func_64(PLAYER::PLAYER_PED_ID(), uLocal_580[3], 30f, 1))
							{
								if (!AI::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_616[3]))
								{
	...
	else
	{
		if (func_87(uLocal_570[0]))
		{
			if (func_64(uLocal_570[0], PLAYER::PLAYER_PED_ID(), 100f, 1))
			{
				...
				UI::SET_BLIP_SCALE(uLocal_927[0], fLocal_147);
		...
		if (func_87(uLocal_570[2]))
		{
			if (func_64(uLocal_570[2], PLAYER::PLAYER_PED_ID(), 100f, 1))
			{
				...
				UI::SET_BLIP_SCALE(uLocal_927[2], fLocal_147);
		...
		if (func_87(uLocal_570[3]))
		{
			if (func_64(uLocal_570[3], PLAYER::PLAYER_PED_ID(), 100f, 1))
			{
				...
				UI::SET_BLIP_SCALE(uLocal_927[3], fLocal_147);
		...
		if (func_87(uLocal_570[4]))
		{
			if (func_64(uLocal_570[4], PLAYER::PLAYER_PED_ID(), 100f, 1))
			{
				...
				UI::SET_BLIP_SCALE(uLocal_927[4], fLocal_147);
		...
		if (func_87(uLocal_570[5]))
		{
			if (func_64(uLocal_570[5], PLAYER::PLAYER_PED_ID(), 100f, 1))
			{
				...
				UI::SET_BLIP_SCALE(uLocal_927[5], fLocal_147);
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_616[iLocal_256]))
	{
		if (!ENTITY::IS_ENTITY_DEAD(uLocal_616[iLocal_256], 0))
		{
			if (((GAMEPLAY::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(uLocal_616[iLocal_256], 1), joaat("weapon_grenade"), 4f, 1) || GAMEPLAY::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(uLocal_616[iLocal_256], 1), joaat("weapon_molotov"), 4f, 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(uLocal_616[iLocal_256], 1), joaat("weapon_smokegrenade"), 4f, 1)) || GAMEPLAY::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(uLocal_616[iLocal_256], 1), joaat("weapon_stickybomb"), 4f, 1))
			{
				iLocal_311 = 1;
			}
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_616[iLocal_256], 0))
...
void func_305()
{
	...
	if (!func_291())
	{
		if (!UI::DOES_BLIP_EXIST(uLocal_940))
		{
			if (iLocal_369 == 0)
			{
				uLocal_940 = func_287(iLocal_596, 1, 1, 5);
		...
		if (STREAMING::HAS_MODEL_LOADED(joaat("tractor")))
		{
			if (!func_291())
			{
				if (func_280(&uLocal_390, "EPS8AU", "EPS8_ESC", 7, 0, 0, 0))
				{
					...
					func_5(0);
					vLocal_215 = { ENTITY::GET_ENTITY_COORDS(iLocal_632, 1) };
					uLocal_940 = func_287(iLocal_596, 1, 1, 5);
					iLocal_369 = 1;
					UI::SET_BLIP_SCALE(uLocal_940, fLocal_147);
...
void func_310()
{
	...
	func_302();
	func_300();
	if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_632, vLocal_158, 2f, 2f, 2f, 0, 1, 0))
	{
		func_282();
	}
	if (!PED::IS_PED_HEADTRACKING_PED(iLocal_596, PLAYER::PLAYER_PED_ID()))
	...
	if (ENTITY::IS_ENTITY_AT_COORD(iLocal_632, vLocal_158, 2f, 2f, 2f, 0, 1, 0) && VEHICLE::IS_VEHICLE_STOPPED(iLocal_632))
	{
		func_25(&uLocal_935);
	...
	else if (ENTITY::IS_ENTITY_AT_COORD(iLocal_632, vLocal_158, 2f, 2f, 2f, 0, 1, 0))
	{
		func_25(&uLocal_935);
	...
	{
		iLocal_382 = 0;
		if (ENTITY::IS_ENTITY_AT_COORD(iLocal_632, vLocal_158, 6f, 6f, 2f, 1, 1, 0))
		{
		}
	}
}
...
void func_315(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_340(uParam1) && ENTITY::IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
int func_321(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_329() || func_328(Global_4456448.f_161209)) || func_327())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_325(uVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_345()
{
	...
	if ((((STREAMING::HAS_MODEL_LOADED(joaat("taxi")) && STREAMING::HAS_MODEL_LOADED(joaat("sadler"))) && STREAMING::HAS_MODEL_LOADED(joaat("habanero"))) && STREAMING::HAS_MODEL_LOADED(joaat("schafter2"))) && STREAMING::HAS_MODEL_LOADED(joaat("rumpo")))
	{
		...
		if (AI::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC01"))
		{
			...
			{
				if (!func_281(PLAYER::PLAYER_PED_ID(), vLocal_650[iLocal_910 /*3*/], 50f) && !GAMEPLAY::IS_POSITION_OCCUPIED(vLocal_650[iLocal_910 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_650[iLocal_910 /*3*/], 8f))
					{
						...
						if (!GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vLocal_650[iLocal_910 /*3*/], &uVar2, 0, 0))
						{
							uVar2 = vLocal_650[iLocal_910 /*3*/].f_2;
						}
						if (iLocal_910 > 4 || func_281(PLAYER::PLAYER_PED_ID(), vLocal_158, 150f))
						{
							uLocal_634[iLocal_910] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_650[iLocal_910 /*3*/], vLocal_650[iLocal_910 /*3*/].f_1, uVar2, fLocal_672[iLocal_910], 1, 1, 0);
							...
							AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(uLocal_642[iLocal_910], uLocal_634[iLocal_910], "Eps8TRAFFIC01", 262275, 0, 1032, -1, -1082130432, 0, 1073741824);
						}
					}
				}
			}
		...
		if (AI::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC02"))
		{
			...
			{
				if (!func_281(PLAYER::PLAYER_PED_ID(), vLocal_696[iLocal_910 /*3*/], 50f) && !GAMEPLAY::IS_POSITION_OCCUPIED(vLocal_696[iLocal_910 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_696[iLocal_910 /*3*/], 8f))
					{
						...
						if (!GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vLocal_696[iLocal_910 /*3*/], &uVar2, 0, 0))
						{
							uVar2 = vLocal_696[iLocal_910 /*3*/].f_2;
						}
						uLocal_680[iLocal_910] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_696[iLocal_910 /*3*/], vLocal_696[iLocal_910 /*3*/].f_1, uVar2, fLocal_718[iLocal_910], 1, 1, 0);
						...
						AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(uLocal_688[iLocal_910], uLocal_680[iLocal_910], "Eps8TRAFFIC02", 262275, 0, 1032, -1, -1082130432, 0, 1073741824);
					}
				}
			}
		...
		if (AI::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC03"))
		{
			...
			{
				if ((!func_281(PLAYER::PLAYER_PED_ID(), vLocal_742[iLocal_910 /*3*/], 50f) && func_281(PLAYER::PLAYER_PED_ID(), vLocal_742[iLocal_910 /*3*/], 220f)) && !GAMEPLAY::IS_POSITION_OCCUPIED(vLocal_742[iLocal_910 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_742[iLocal_910 /*3*/], 8f))
					{
						...
						if (!GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vLocal_742[iLocal_910 /*3*/], &uVar2, 0, 0))
						{
							uVar2 = vLocal_742[iLocal_910 /*3*/].f_2;
						}
						uLocal_726[iLocal_910] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_742[iLocal_910 /*3*/], vLocal_742[iLocal_910 /*3*/].f_1, uVar2, fLocal_764[iLocal_910], 1, 1, 0);
						...
						AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(uLocal_734[iLocal_910], uLocal_726[iLocal_910], "Eps8TRAFFIC03", 262275, 0, 1032, -1, -1082130432, 0, 1073741824);
					}
				}
			}
		...
		if (AI::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC04"))
		{
			...
			{
				if (!func_281(PLAYER::PLAYER_PED_ID(), vLocal_788[iLocal_910 /*3*/], 50f) && !GAMEPLAY::IS_POSITION_OCCUPIED(vLocal_788[iLocal_910 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_788[iLocal_910 /*3*/], 8f))
					{
						...
						if (!GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vLocal_788[iLocal_910 /*3*/], &uVar2, 0, 0))
						{
							uVar2 = vLocal_788[iLocal_910 /*3*/].f_2;
						}
						uLocal_772[iLocal_910] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_788[iLocal_910 /*3*/], vLocal_788[iLocal_910 /*3*/].f_1, uVar2, fLocal_810[iLocal_910], 1, 1, 0);
						...
						AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(uLocal_780[iLocal_910], uLocal_772[iLocal_910], "Eps8TRAFFIC04", 262275, 0, 1032, -1, -1082130432, 0, 1073741824);
					}
				}
			}
		...
		if (AI::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC05"))
		{
			...
			{
				if ((!func_281(PLAYER::PLAYER_PED_ID(), vLocal_834[iLocal_910 /*3*/], 50f) && func_281(PLAYER::PLAYER_PED_ID(), vLocal_834[iLocal_910 /*3*/], 170f)) && !GAMEPLAY::IS_POSITION_OCCUPIED(vLocal_834[iLocal_910 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_834[iLocal_910 /*3*/], 8f))
					{
						...
						if (!GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vLocal_834[iLocal_910 /*3*/], &uVar2, 0, 0))
						{
							uVar2 = vLocal_834[iLocal_910 /*3*/].f_2;
						}
						uLocal_818[iLocal_910] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_834[iLocal_910 /*3*/], vLocal_834[iLocal_910 /*3*/].f_1, uVar2, fLocal_856[iLocal_910], 1, 1, 0);
						...
						AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(uLocal_826[iLocal_910], uLocal_818[iLocal_910], "Eps8TRAFFIC05", 262275, 0, 1032, -1, -1082130432, 0, 1073741824);
					}
				}
			}
		...
		if (AI::GET_IS_WAYPOINT_RECORDING_LOADED("Eps8TRAFFIC06"))
		{
			...
			{
				if ((!func_281(PLAYER::PLAYER_PED_ID(), vLocal_880[iLocal_910 /*3*/], 50f) && func_281(PLAYER::PLAYER_PED_ID(), vLocal_880[iLocal_910 /*3*/], 170f)) && !GAMEPLAY::IS_POSITION_OCCUPIED(vLocal_880[iLocal_910 /*3*/], 15f, 0, 1, 0, 0, 0, 0, 0))
				{
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_880[iLocal_910 /*3*/], 8f))
					{
						...
						if (!GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vLocal_880[iLocal_910 /*3*/], &uVar2, 0, 0))
						{
							uVar2 = vLocal_880[iLocal_910 /*3*/].f_2;
						}
						uLocal_864[iLocal_910] = VEHICLE::CREATE_VEHICLE(iVar0, vLocal_880[iLocal_910 /*3*/], vLocal_880[iLocal_910 /*3*/].f_1, uVar2, fLocal_902[iLocal_910], 1, 1, 0);
						...
						AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(uLocal_872[iLocal_910], uLocal_864[iLocal_910], "Eps8TRAFFIC06", 262275, 0, 1032, -1, -1082130432, 0, 1073741824);
					}
				}
			}
...
void func_349()
{
	...
	uLocal_616[2] = VEHICLE::CREATE_VEHICLE(joaat("sentinel"), vLocal_162[2 /*3*/], fLocal_233[2], 1, 1, 0);
	...
	uLocal_616[3] = VEHICLE::CREATE_VEHICLE(joaat("sentinel"), vLocal_162[3 /*3*/], fLocal_233[3], 1, 1, 0);
	...
	uLocal_570[3] = PED::CREATE_PED(26, joaat("s_m_m_highsec_01"), vLocal_184[3 /*3*/], fLocal_241[3], 1, 1);
	...
	uLocal_570[4] = PED::CREATE_PED(26, joaat("s_m_m_highsec_01"), vLocal_184[4 /*3*/], fLocal_241[4], 1, 1);
	...
	switch (iLocal_567)
	{
		case 0:
			...
			else if (iLocal_308 == 1)
			{
				...
				if (GAMEPLAY::GET_GAME_TIMER() > iLocal_307 + 6000 || func_432(1000))
				{
					iLocal_308 = 2;
				}
			}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_418(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_415(ENTITY::GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_398(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_427(int iParam0, int iParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_311(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_437()
{
	...
	if (func_18(Local_83.f_35[1]))
	{
		...
		Local_83.f_35[1] = 0;
		func_309(iLocal_632, 0);
		vVar0 = { ENTITY::GET_ENTITY_COORDS(iLocal_632, 1) };
	...
	if (func_18(Local_83.f_35[0]))
	{
		...
		vVar3 = { ENTITY::GET_ENTITY_COORDS(iLocal_632, 1) };
	...
	{
		uLocal_616[0] = VEHICLE::CREATE_VEHICLE(joaat("landstalker"), vLocal_162[0 /*3*/], fLocal_233[0], 1, 1, 0);
	...
	{
		uLocal_570[0] = PED::CREATE_PED(26, joaat("s_m_m_highsec_01"), vLocal_184[0 /*3*/], fLocal_241[0], 1, 1);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_570[2]))
	{
		uLocal_570[2] = PED::CREATE_PED(26, joaat("s_m_m_highsec_01"), vLocal_184[2 /*3*/], fLocal_241[2], 1, 1);
	}
}
	...
	if ((((iLocal_568 == 3 || iLocal_568 == 4) || iLocal_568 == 5) || iLocal_568 == 6) || iLocal_568 == 7)
	{
		...
		if (!func_291() || !iLocal_353 == 1)
		{
			if (iLocal_311 == 1)
			{
				...
				{
					uLocal_941 = UI::ADD_BLIP_FOR_ENTITY(uLocal_597[3]);
					UI::SET_BLIP_COLOUR(uLocal_941, 2);
					UI::SET_BLIP_SCALE(uLocal_941, fLocal_149);
					func_290("EPS8_21", 7500, 0);
				}
				if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_18568.f_382, 1))
				{
					GAMEPLAY::SET_BIT(&(Global_106565.f_18568.f_382), 1);
				}
				iLocal_568 = 8;
			}
		}
				...
				else
				{
					...
					if (iLocal_568 != 7)
					{
						if (iLocal_329 == 0)
						{
							...
							{
								if ((iLocal_299 != -1 && func_87(uLocal_570[iLocal_299])) && PED::IS_PED_IN_VEHICLE(uLocal_570[iLocal_299], iLocal_632, 0))
								{
...
int func_471(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_95() == 0)
		{
			return GAMEPLAY::IS_BIT_SET(func_39(func_469(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
{
	func_16(uParam0);
	*uParam0 = VEHICLE::CREATE_VEHICLE(uParam1, vParam2, fParam5, 1, 1, 0);
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
