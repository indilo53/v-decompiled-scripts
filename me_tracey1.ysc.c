...
int func_24(int iParam0)
{
	...
	if (TIME::GET_CLOCK_DAY_OF_MONTH() != iLocal_301)
	{
		iVar0 = (60 * ((24 - iLocal_302) + TIME::GET_CLOCK_HOURS()));
		iVar0 = ((iVar0 - iLocal_303) + TIME::GET_CLOCK_MINUTES());
	}
	else
	{
		iVar0 = (((60 * TIME::GET_CLOCK_HOURS()) + TIME::GET_CLOCK_MINUTES()) - (iLocal_303 + (60 * iLocal_302)));
	}
	if (iVar0 >= (60 * iParam0))
	{
		return 1;
...
{
	UI::CLEAR_THIS_PRINT(vLocal_341[iParam0 /*3*/].f_2);
}
...
void func_34()
{
	...
	switch (iLocal_93)
	{
		case 0:
			...
			if (func_179(iLocal_273, 5f, 5, 1056964608, 0, 1, 0))
			{
				if (bLocal_533)
				{
					...
					AI::TASK_PAUSE(0, 650);
					AI::TASK_LEAVE_VEHICLE(0, iLocal_273, 0);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_530, 1f, 20000, 1048576000, 0, 1193033728);
				...
				AI::CLEAR_PED_TASKS(iLocal_289);
				AI::TASK_PERFORM_SEQUENCE(iLocal_289, uVar0);
				...
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_527, 8f, 1, 0, 0, 0, 0, 0);
				if (!bLocal_533)
				{
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(-820.2315f, 176.7027f, 70.6122f, 8f, 1, 0, 0, 0, 0, 0);
				}
				if (bLocal_533)
				{
		...
		case 1:
			...
			else if ((func_56(iLocal_289, vLocal_530, 2f) || (GAMEPLAY::GET_GAME_TIMER() - iLocal_474) > 5000) || bLocal_475)
			{
				if (bLocal_476)
				{
		...
		case 2:
			...
			else
			{
				if (bLocal_475)
				{
					AI::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_289);
...
void func_36(bool bParam0, int iParam1)
{
	...
	if (Global_106565.f_9079 || func_39(0))
	{
		...
		if (GAMEPLAY::IS_BIT_SET(Global_84464[iVar0 /*5*/].f_1, 4))
		{
			return;
		}
		if (GAMEPLAY::IS_BIT_SET(Global_84464[iVar0 /*5*/].f_1, 5))
		{
			return;
		}
		GAMEPLAY::SET_BIT(&(Global_84464[iVar0 /*5*/].f_1), 4);
		GAMEPLAY::SET_BIT(&Global_71838, 1);
		Global_71854 = uVar2;
		Global_71855 = GAMEPLAY::GET_GAME_TIMER();
	}
}
...
int func_62(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						uVar28 = 9;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_72(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_72(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_72(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_104(iVar0);
						if (Global_71400 == 1)
						{
			...
			else if (iVar0 != 12 && iVar0 != 14)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 3))
				{
					if (iVar0 == 2)
					{
						if (iVar10 == joaat("player_one"))
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_72(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_72(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_72(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
bool func_67(int iParam0, int iParam1, int iParam2)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 2);
}
...
void func_82(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_83(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_72(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_87(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_89(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_89(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 4);
		}
	}
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_72(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_84(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_84(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_84(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_84(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
{
	if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 1) && !GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 6))
	{
...
int func_110(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
		{
			GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/][iParam3]), uParam4);
		}
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/][iParam3]), uParam4);
		}
		return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/][iParam3], uParam4);
	}
	else if (iParam0 == 1)
	{
		if (iParam5 == 1)
		{
			GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_4[iParam3]), uParam4);
		}
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_4[iParam3]), uParam4);
		}
		return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_4[iParam3], uParam4);
	}
	else if (iParam0 == 2)
	{
		if (iParam5 == 1)
		{
			GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_8[iParam3]), uParam4);
		}
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_8[iParam3]), uParam4);
		}
		return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_8[iParam3], uParam4);
	}
	else if (iParam0 == 3)
	{
		if (iParam2 == 0)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_12[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_12[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_12[iParam3], uParam4);
		}
		else if (iParam2 == 1)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_16[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_16[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_16[iParam3], uParam4);
		}
		else if (iParam2 == 2)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_20[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_20[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_20[iParam3], uParam4);
		}
		else if (iParam2 == 3)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_24[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_24[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_24[iParam3], uParam4);
		}
		else if (iParam2 == 4)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_28[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_28[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_28[iParam3], uParam4);
		}
		else if (iParam2 == 5)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_32[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_32[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_32[iParam3], uParam4);
		}
		else if (iParam2 == 6)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_36[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_36[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_36[iParam3], uParam4);
		}
		else if (iParam2 == 7)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_40[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_40[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_40[iParam3], uParam4);
		}
		else if (iParam2 == 8)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_44[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_44[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_44[iParam3], uParam4);
		}
		else if (iParam2 == 9)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_48[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_48[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_48[iParam3], uParam4);
		}
	}
	else if (iParam0 == 4)
	{
		if (iParam2 == 0)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_52[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_52[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_52[iParam3], uParam4);
		}
		else if (iParam2 == 1)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_56[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_56[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_56[iParam3], uParam4);
		}
		else if (iParam2 == 2)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_60[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_60[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_60[iParam3], uParam4);
		}
		else if (iParam2 == 3)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_64[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_64[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_64[iParam3], uParam4);
		}
	}
	else if (iParam0 == 5)
	{
		if (iParam5 == 1)
		{
			GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_68[iParam3]), uParam4);
		}
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_68[iParam3]), uParam4);
		}
		return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_68[iParam3], uParam4);
	}
	else if (iParam0 == 6)
	{
		if (iParam2 == 0)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_72[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_72[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_72[iParam3], uParam4);
		}
		else if (iParam2 == 1)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_76[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_76[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_76[iParam3], uParam4);
		}
		else if (iParam2 == 2)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_80[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_80[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_80[iParam3], uParam4);
		}
		else if (iParam2 == 3)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_84[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_84[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_84[iParam3], uParam4);
		}
		else if (iParam2 == 4)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_88[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_88[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_88[iParam3], uParam4);
		}
	}
	else if (iParam0 == 7)
	{
		if (iParam5 == 1)
		{
			GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_92[iParam3]), uParam4);
		}
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_92[iParam3]), uParam4);
		}
		return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_92[iParam3], uParam4);
	}
	else if (iParam0 == 8)
	{
		if (iParam2 == 0)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_96[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_96[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_96[iParam3], uParam4);
		}
		else if (iParam2 == 1)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_100[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_100[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_100[iParam3], uParam4);
		}
		else if (iParam2 == 2)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_104[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_104[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_104[iParam3], uParam4);
		}
	}
	else if (iParam0 == 9)
	{
		if (iParam5 == 1)
		{
			GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_108[iParam3]), uParam4);
		}
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_108[iParam3]), uParam4);
		}
		return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_108[iParam3], uParam4);
	}
	else if (iParam0 == 10)
	{
		if (iParam2 == 0)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_112[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_112[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_112[iParam3], uParam4);
		}
		else if (iParam2 == 1)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_116[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_116[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_116[iParam3], uParam4);
		}
	}
	else if (iParam0 == 11)
	{
		if (iParam2 == 0)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_120[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_120[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_120[iParam3], uParam4);
		}
		else if (iParam2 == 1)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_124[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_124[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_124[iParam3], uParam4);
		}
	}
	else if (iParam0 == 12)
	{
		if (iParam2 == 0)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_128[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_128[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_128[iParam3], uParam4);
		}
		else if (iParam2 == 1)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_132[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_132[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_132[iParam3], uParam4);
		}
	}
	else if (iParam0 == 13)
	{
		if (iParam5 == 1)
		{
			GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_136[iParam3]), uParam4);
		}
		if (iParam6 == 1)
		{
			GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_136[iParam3]), uParam4);
		}
		return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_136[iParam3], uParam4);
	}
	else if (iParam0 == 14)
	{
		if (iParam2 == 0)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_140[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_140[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_140[iParam3], uParam4);
		}
		else if (iParam2 == 1)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_144[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_144[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_144[iParam3], uParam4);
		}
		else if (iParam2 == 2)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_148[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_148[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_148[iParam3], uParam4);
		}
		else if (iParam2 == 3)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_152[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_152[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_152[iParam3], uParam4);
		}
		else if (iParam2 == 4)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_156[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_156[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_156[iParam3], uParam4);
		}
		else if (iParam2 == 5)
		{
			if (iParam5 == 1)
			{
				GAMEPLAY::SET_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_160[iParam3]), uParam4);
			}
			if (iParam6 == 1)
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_2357[iParam1 /*164*/].f_160[iParam3]), uParam4);
			}
			return GAMEPLAY::IS_BIT_SET(Global_106565.f_2357[iParam1 /*164*/].f_160[iParam3], uParam4);
		}
	}
	return 0;
}
...
int func_111(int iParam0)
{
	...
	if (iParam0 == 1)
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 1))
		{
			return 0;
		}
		if (!GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 2))
		{
			return 0;
		}
	}
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_115(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_115(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_72(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_176(var uParam0, int iParam1, int iParam2)
{
	...
	{
		if (PED::GET_PED_PROP_INDEX(uParam0, Global_71402[1 /*14*/].f_12) == Global_71402[1 /*14*/].f_3 && (PED::GET_PED_PROP_TEXTURE_INDEX(uParam0, Global_71402[1 /*14*/].f_12) == Global_71402[1 /*14*/].f_4 || Global_71402[1 /*14*/].f_3 == -1))
		{
			return 1;
		}
	}
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_72(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_72(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_181()
{
	switch (iLocal_93)
	{
		case 0:
			...
			{
				if (!UI::DOES_BLIP_EXIST(uLocal_298))
				{
		...
		case 1:
			...
			else if (iLocal_306)
			{
				...
				{
					iLocal_307 = 1;
					AI::TASK_ENTER_VEHICLE(iLocal_289, iLocal_273, 20000, 0, 2f, 1, 0);
				}
				if (PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, 0))
				{
					iLocal_306 = 0;
			...
			else if (iLocal_309)
			{
				if (iLocal_310)
				{
					if (GAMEPLAY::GET_PROFILE_SETTING(203) == 0 || (iLocal_466 >= 4 && !func_23()))
					{
						func_28(3);
						iLocal_310 = 0;
					}
...
void func_182(int iParam0)
{
	if (iLocal_574 != iParam0)
	{
		...
		while (iLocal_572 <= 7)
		{
			...
			{
				if (!GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_575[iLocal_572], "NONE"))
				{
	...
	if (iLocal_466 == 0)
	{
		if (bLocal_336)
		{
			if (bLocal_337)
			{
				...
				{
					AI::OPEN_SEQUENCE_TASK(&uVar0);
					AI::TASK_PLAY_ANIM(0, sLocal_296, "react_intro", 8f, -8f, 4900, 8, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sLocal_296, "react_loop", 8f, -4f, 12400, 8, 0, 0, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uVar0);
					AI::CLEAR_PED_TASKS(iLocal_289);
					AI::TASK_PERFORM_SEQUENCE(iLocal_289, uVar0);
					iLocal_466 += 4;
			...
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_467) > vLocal_438[3 /*3*/] && !func_56(PLAYER::PLAYER_PED_ID(), vLocal_527, 50f))
			{
				if (func_3(&uLocal_96, vLocal_438[3 /*3*/].f_1, vLocal_438[3 /*3*/].f_2, 7, 0, 0, 0))
				{
					if (!bLocal_337)
					{
						...
						AI::CLEAR_PED_TASKS(iLocal_289);
						AI::TASK_PERFORM_SEQUENCE(iLocal_289, uVar1);
					}
					iLocal_466++;
				}
			}
...
void func_195()
{
	if (bLocal_312 == 0)
	{
		...
		if (GAMEPLAY::GET_GAME_TIMER() > iLocal_314 && PLAYER::HAS_PLAYER_DAMAGED_AT_LEAST_ONE_PED(PLAYER::PLAYER_ID()))
		{
			iLocal_313++;
...
void func_198(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		if (iVar1 != -1 && iVar1 != 94)
		{
			...
			STATS::PLAYSTATS_MISSION_CHECKPOINT(&cVar3, uVar2, Global_93719, iParam0);
		}
		else
		{
...
void func_224(int iParam0, bool bParam1)
{
	...
	if (func_12(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			...
			while (iVar2 <= (8 - 1))
			{
				Global_106565.f_2357.f_539.f_1730[iVar2 /*4*/][iVar0] = UI::_0xA13E93403F26C812(iVar2);
				if (bParam1)
				{
...
void func_225(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_227(Var11.f_1)) && iVar72 < 51)
			{
...
void func_231(var uParam0)
{
	...
	if (func_12(iVar0) && !PED::IS_PED_INJURED(uParam0))
	{
		Global_106565.f_2357.f_539.f_294[iVar0] = PED::GET_PED_ARMOUR(uParam0);
	}
}
...
void func_232(var uParam0, int iParam1)
{
	...
	*uParam0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_71838, 4))
	{
		*uParam0 = { 452.0255f, 5571.85f, 780.1859f };
		uParam0->f_3 = 78.9858f;
	}
	else if (GAMEPLAY::IS_BIT_SET(Global_71838, 5))
	{
		*uParam0 = { -745.4462f, 5595.146f, 40.6594f };
		uParam0->f_3 = 261.747f;
	}
	else if (GAMEPLAY::IS_BIT_SET(Global_71838, 6))
	{
		*uParam0 = { -1675.521f, -1125.59f, 12.091f };
		uParam0->f_3 = 271.8208f;
	}
	else if (GAMEPLAY::IS_BIT_SET(Global_71838, 7))
	{
...
int func_242(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_258(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_243(iVar0, 0), 1);
...
Vector3 func_245(int iParam0, int iParam1)
{
	...
	if (Global_1589661 != func_253())
	{
		...
		{
			if (GAMEPLAY::IS_BIT_SET(Global_1589819[Global_1589661 /*818*/].f_273.f_253, 4))
			{
				if (func_246(iParam0, 1, &vVar0, 0, 0))
				{
					vVar6 = { vVar0 };
			...
			else if (GAMEPLAY::IS_BIT_SET(Global_1589819[Global_1589661 /*818*/].f_273.f_253, 5))
			{
...
int func_252(int iParam0)
{
	if (iParam0 != func_253())
	{
		if ((GAMEPLAY::IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_273.f_253, 3) || GAMEPLAY::IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_273.f_253, 4)) || GAMEPLAY::IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_273.f_253, 5))
		{
			return 1;
		}
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_266(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_284()
{
	...
	switch (iLocal_93)
	{
		case 0:
			...
			{
				AI::CLEAR_PED_TASKS(iLocal_290);
				PED::SET_PED_FLEE_ATTRIBUTES(iLocal_290, 2, 0);
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_290, 0))
				{
					AI::OPEN_SEQUENCE_TASK(&uVar0);
					AI::TASK_LEAVE_ANY_VEHICLE(0, 0, 257);
					AI::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2000f, -1, 0, 0);
					AI::CLOSE_SEQUENCE_TASK(uVar0);
					AI::TASK_PERFORM_SEQUENCE(iLocal_290, uVar0);
					AI::CLEAR_SEQUENCE_TASK(&uVar0);
				}
				else
				{
					AI::TASK_SMART_FLEE_COORD(iLocal_290, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2000f, -1, 0, 0);
				}
				iLocal_413 = 0;
				bLocal_414 = false;
				iLocal_415 = 0;
		...
		case 1:
			...
			if (func_26(iLocal_290))
			{
				...
				else
				{
					...
					else if ((((PED::IS_PED_ON_FOOT(iLocal_290) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !AI::IS_PED_GETTING_UP(iLocal_290)) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_290)) && !ENTITY::IS_ENTITY_IN_AIR(iLocal_290))
					{
...
void func_287()
{
	if (!bLocal_604)
	{
		...
		{
			func_290(1);
			if (((func_289(vLocal_584[0 /*3*/], vLocal_584[2 /*3*/], 1f) && !PED::IS_PED_IN_MELEE_COMBAT(iLocal_290)) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !AI::IS_PED_GETTING_UP(iLocal_290))
			{
				AI::TASK_COWER(iLocal_290, -1);
				bLocal_604 = true;
			}
		}
		if (!bLocal_604)
		{
			...
			{
				if (((GAMEPLAY::GET_GAME_TIMER() > uLocal_606[0] && func_191(PLAYER::PLAYER_PED_ID(), iLocal_290, 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !AI::IS_PED_GETTING_UP(iLocal_290))
				{
					func_288(0, 0);
				}
				else if (GAMEPLAY::GET_GAME_TIMER() > uLocal_606[1])
				{
					if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_290, 0f, 1f, -2f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_290, 0f, 7f, 5f), 5f, 0, 1, 0) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !AI::IS_PED_GETTING_UP(iLocal_290))
					{
						func_288(0, 1);
					}
					else
...
void func_288(int iParam0, bool bParam1)
{
	...
	{
		AI::TASK_SMART_FLEE_PED(iLocal_290, PLAYER::PLAYER_PED_ID(), 2000f, -1, 0, 0);
		uLocal_606[0] = GAMEPLAY::GET_GAME_TIMER() + 10000;
		if (bParam1)
		{
			uLocal_606[1] = GAMEPLAY::GET_GAME_TIMER() + 10000;
...
void func_290(bool bParam0)
{
	...
	if (bParam0)
	{
		vLocal_584[5 /*3*/] = { ENTITY::GET_ENTITY_COORDS(iLocal_290, 1) };
	}
	else
	{
		vLocal_584[5 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Local_277, 1) };
	}
}
...
void func_291()
{
	...
	if (func_294() && GAMEPLAY::GET_GAME_TIMER() > iLocal_412)
	{
...
int func_292()
{
	...
	if (Global_15866 == 4)
	{
		...
		if (iVar0 > -1)
		{
			if (UI::DOES_TEXT_LABEL_EXIST(&(Global_14734[iVar0 /*6*/])))
			{
				cVar1 = { Global_15485 };
...
int func_296()
{
	...
	else if (bLocal_336)
	{
		...
		else if (func_56(iLocal_289, ENTITY::GET_ENTITY_COORDS(iLocal_290, 0), 10f))
		{
			return 1;
		}
...
int func_301(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_303(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
void func_311(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_335(uParam1) && ENTITY::IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
int func_317(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_324() || func_323(Global_4456448.f_161209)) || func_322())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_320(uVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_338()
{
	...
	vVar0 = { ENTITY::GET_ENTITY_COORDS(iLocal_290, 1) };
	...
	switch (iLocal_93)
	{
			...
			if (func_26(iLocal_290))
			{
				...
				else
				{
					...
					if (!iLocal_333)
					{
						iLocal_333 = 1;
						AI::CLEAR_PED_TASKS(iLocal_290);
						AI::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_290, Local_277, PLAYER::PLAYER_PED_ID(), 8, 25f, 786477, 100f, 1f, 1);
					}
					iLocal_603 = GAMEPLAY::GET_GAME_TIMER();
					if (func_26(Local_277))
					{
						vLocal_584[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Local_277, 1) };
		...
		case 1:
			if (func_26(iLocal_290))
			{
				...
				if ((UI::DOES_BLIP_EXIST(uLocal_297) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, 0)) && PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, 0))
				{
					func_354(uLocal_297, iLocal_290, 220f, 0.75f, 0);
				}
				func_308(&uLocal_261, iLocal_290, 0, 0, 1, 1, 1);
...
void func_340()
{
	...
	{
		case 0:
			if ((((GAMEPLAY::GET_GAME_TIMER() - iLocal_374) > 4000 && func_26(iLocal_290)) && !func_186()) && !func_23())
			{
				func_21(&uLocal_96, 4, iLocal_290, "Stalker", 0, 1);
				iLocal_380 = 1;
			}
		...
		case 1:
			if (func_26(iLocal_290))
			{
				...
				else if (func_341() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_331) > 6000)
				{
					iLocal_380 = 7;
				}
...
void func_343()
{
	if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_330) > 3000)
	{
		...
		vLocal_320[2 /*3*/] = { ENTITY::GET_ENTITY_COORDS(iLocal_273, 1) };
		iLocal_330 = GAMEPLAY::GET_GAME_TIMER();
	}
}
...
void func_349()
{
	if (iLocal_617 == 0)
	{
		if (bLocal_609 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_613) > iLocal_615)
		{
			iLocal_613 = GAMEPLAY::GET_GAME_TIMER();
			iLocal_617 = 2;
		}
		else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_613) > iLocal_616 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_277, 0f, -0.5f, -1.5f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_277, 0f, 6f, 2f), 12f, 0, 1, 0))
		{
			iLocal_613 = GAMEPLAY::GET_GAME_TIMER();
			iLocal_617 = 1;
		}
	...
	if (iLocal_617 == 1)
	{
		...
		else if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_613) < iLocal_614 && func_350(1))
		{
	...
	if (iLocal_617 == 2)
	{
		if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_613) < iLocal_614 && func_350(0))
		{
...
int func_353(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		vVar1 = { func_303(ENTITY::GET_ENTITY_COORDS(uVar0, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
		...
		case 0:
			if (!func_361())
			{
				...
				if (func_357(Local_277.f_6, Local_277.f_9, 0))
				{
					...
					AI::OPEN_SEQUENCE_TASK(&uVar0);
					AI::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_277, ENTITY::GET_ENTITY_COORDS(iLocal_273, 1), 4, 35f, 2883621, 10f, 12f, 1);
					AI::TASK_VEHICLE_ESCORT(0, Local_277, iLocal_273, -1, 25f, 2883621, -1082130432, 20, 1101004800);
					AI::CLOSE_SEQUENCE_TASK(uVar0);
					AI::TASK_PERFORM_SEQUENCE(iLocal_290, uVar0);
					AI::CLEAR_SEQUENCE_TASK(&uVar0);
			...
			if (func_26(iLocal_290))
			{
				if (func_26(Local_277))
				{
					if (!iLocal_335)
					{
						...
						{
							AI::TASK_PLAY_ANIM(iLocal_289, "missmichael_event@tracy", "base", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
							STREAMING::REMOVE_ANIM_DICT("missmichael_event@tracy");
							if (!UI::DOES_BLIP_EXIST(uLocal_297))
							{
								uLocal_297 = func_196(Local_277, 0, 5);
								UI::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_297, "MET1LBSTALK");
								func_182(4);
							}
							iLocal_335 = 1;
						}
...
int func_357(vector3 vParam0, float fParam3, int iParam4)
{
	...
	else if (iLocal_292)
	{
		...
		{
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(Local_277.f_6, 5f, 0, 0, 0, 0, 0, 0);
			Local_277 = VEHICLE::CREATE_VEHICLE(Local_277.f_1, vParam0, fParam3, 1, 1, 0);
			...
			VEHICLE::SET_VEHICLE_ENGINE_ON(Local_277, 1, 1, 0);
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_277, 1, 1);
			...
			iLocal_317 = 1;
			iLocal_290 = PED::CREATE_PED_INSIDE_VEHICLE(Local_277, 26, iLocal_291, -1, 1, 1);
		...
		case 1:
			if (!func_361())
			{
				...
				if (iLocal_305)
				{
					...
					{
						AI::CLEAR_PED_TASKS(iLocal_289);
						AI::TASK_SMART_FLEE_PED(iLocal_289, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
						if (func_23())
						{
							if (func_292() == 3)
							{
					...
					switch (iLocal_316)
					{
						...
						case 4:
							...
							else if (!func_23() && GAMEPLAY::GET_GAME_TIMER() > iLocal_543)
							{
								if (!func_188())
								{
									if (bLocal_312 && !GAMEPLAY::ARE_STRINGS_EQUAL(Local_487[iLocal_520 /*8*/].f_6, "NULL"))
									{
...
void func_363()
{
	...
	{
		if (func_341() && (GAMEPLAY::GET_GAME_TIMER() - iLocal_331) > 18000)
		{
...
void func_364()
{
	...
	Var27[0 /*4*/][0] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3);
	if (Var27[0 /*4*/][0] < 2)
	{
		Var27[0 /*4*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2, 3);
	}
	else
	{
		Var27[0 /*4*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 1);
	}
	if (Var27[0 /*4*/][0] > 1)
	{
		Var27[0 /*4*/][2] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2, 3);
	}
	else
	{
		Var27[0 /*4*/][2] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 1);
	}
	Var16[0 /*5*/][0] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(300, 600);
	Var16[0 /*5*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(400, 1000);
	Var16[0 /*5*/][2] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 1000);
	Var16[0 /*5*/][3] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 1000);
	AI::OPEN_SEQUENCE_TASK(&(uVar0[0]));
	AI::TASK_PAUSE(0, Var16[0 /*5*/][0]);
	AI::TASK_LOOK_AT_COORD(0, vVar3[Var27[0 /*4*/][0] /*3*/], Var16[0 /*5*/][1], 2048, 2);
	AI::TASK_LOOK_AT_COORD(0, vVar3[Var27[0 /*4*/][1] /*3*/], Var16[0 /*5*/][2], 2048, 2);
	AI::TASK_LOOK_AT_COORD(0, vVar3[Var27[0 /*4*/][2] /*3*/], Var16[0 /*5*/][3], 2048, 2);
	AI::CLOSE_SEQUENCE_TASK(uVar0[0]);
	AI::TASK_PERFORM_SEQUENCE(iLocal_289, uVar0[0]);
	AI::CLEAR_SEQUENCE_TASK(&(uVar0[0]));
	Var27[1 /*4*/][0] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 3);
	...
	if (Var27[1 /*4*/][0] < 2)
	{
		Var27[1 /*4*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2, 3);
	}
	else
	{
		Var27[1 /*4*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 1);
	}
	if (Var27[1 /*4*/][0] > 1)
	{
		Var27[1 /*4*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2, 3);
	...
	Var16[1 /*5*/][0] = 0;
	Var16[1 /*5*/][1] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 1000);
	Var16[1 /*5*/][2] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 1000);
	Var16[1 /*5*/][3] = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(500, 1000);
	AI::OPEN_SEQUENCE_TASK(&(uVar0[1]));
	AI::TASK_PAUSE(0, Var16[1 /*5*/][0]);
	AI::TASK_LOOK_AT_COORD(0, vVar3[Var27[1 /*4*/][0] /*3*/], Var16[1 /*5*/][1], 2048, 2);
	AI::TASK_LOOK_AT_COORD(0, vVar3[Var27[1 /*4*/][1] /*3*/], Var16[1 /*5*/][2], 2048, 2);
	AI::TASK_LOOK_AT_COORD(0, vVar3[Var27[1 /*4*/][2] /*3*/], Var16[1 /*5*/][3], 2048, 2);
	...
	if (func_26(PLAYER::PLAYER_PED_ID()) && func_26(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_369(PLAYER::PLAYER_PED_ID(), iParam0, iParam2);
				}
			}
		}
		if (bParam4)
...
bool func_369(var uParam0, int iParam1, var uParam2)
{
	...
	vVar3 = { ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(uParam0, 1) };
...
int func_373(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_303(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_303(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_302(vVar3, vVar0);
	...
	switch (iLocal_93)
	{
		case 0:
			...
			if (!func_361())
			{
				if (!func_2())
				{
					if (((func_388(&iLocal_289, vLocal_483, iLocal_486, 1) && func_378(&iLocal_273, 15, vLocal_479, fLocal_482, 1, 0)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_296)) && func_26(iLocal_273))
					{
						iLocal_293 = 1;
						...
						func_377();
						AI::TASK_PLAY_ANIM(iLocal_289, sLocal_296, "nervous_loop", 8f, -8f, -1, 1, 0, 0, 0, 0);
					...
					switch (iLocal_304)
					{
						case 0:
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 246.1479f, -39.21085f, 67.89664f, 202.6635f, -23.77725f, 72.90416f, 22f, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 233.7891f, -45.51515f, 67.57388f, 229.9916f, -55.96275f, 72.28979f, 12.5f, 0, 1, 0))
							{
								...
								AI::OPEN_SEQUENCE_TASK(&uVar0);
								AI::TASK_PLAY_ANIM(0, sLocal_296, "breakout", 8f, -4f, -1, 0, 0, 0, 0, 0);
								AI::TASK_ENTER_VEHICLE(0, iLocal_273, 60000, 0, 2f, 1, 0);
								AI::CLOSE_SEQUENCE_TASK(uVar0);
								AI::CLEAR_PED_TASKS(iLocal_289);
								AI::TASK_LOOK_AT_ENTITY(iLocal_289, PLAYER::PLAYER_PED_ID(), 4000, 0, 3);
								AI::TASK_PERFORM_SEQUENCE(iLocal_289, uVar0);
								AI::CLEAR_SEQUENCE_TASK(&uVar0);
						...
						case 1:
							...
							AI::TASK_LOOK_AT_ENTITY(iLocal_289, PLAYER::PLAYER_PED_ID(), 2000, 2048, 4);
							break;
						...
						case 2:
							...
							if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, 0))
							{
								...
								else if (func_194(2))
								{
									func_27(&uLocal_297);
									uLocal_297 = func_193(iLocal_289, 1, 1, 5);
									UI::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_297, "MET1LBTRAC");
									func_28(2);
								}
							}
							AI::TASK_LOOK_AT_ENTITY(iLocal_289, PLAYER::PLAYER_PED_ID(), 2000, 2048, 4);
...
void func_376()
{
	...
	{
		case 0:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_369) > 5000 && func_191(iLocal_289, PLAYER::PLAYER_PED_ID(), 25f, 1))
			{
				iLocal_371 = 9;
			}
			break;
...
void func_377()
{
	if (!iLocal_294)
	{
		PED::ADD_RELATIONSHIP_GROUP("FRIENDLIES", &uLocal_295);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_295, 1862763509);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, 1862763509, uLocal_295);
		iLocal_294 = 1;
	}
	...
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_289, uLocal_295);
}
...
int func_378(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	...
	if (!func_12(iParam1))
	{
		...
		if ((iParam1 == 17 && Global_106565.f_2357.f_539.f_3618[0 /*197*/][0 /*98*/] == Var0) || (iParam1 == 15 && Global_106565.f_2357.f_539.f_3618[0 /*197*/][1 /*98*/] == Var0))
		{
			...
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar98 /*98*/], vParam2, fParam5, 0, 0, 0);
				...
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 2, GAMEPLAY::IS_BIT_SET(Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_92, 28));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 3, GAMEPLAY::IS_BIT_SET(Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_92, 29));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 0, GAMEPLAY::IS_BIT_SET(Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_92, 30));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 1, GAMEPLAY::IS_BIT_SET(Global_106565.f_2357.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_92, 31));
...
int func_382(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_386(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_385(*uParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_385(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_384(uParam0);
	if (func_383(*uParam0))
	{
...
int func_388(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	{
		func_33(iParam0);
		*iParam0 = PED::CREATE_PED(26, uVar0, vParam1, iParam4, 0, 0);
	...
	switch (iLocal_93)
	{
		...
		case 2:
			if (!func_2())
			{
				...
				GAMEPLAY::CLEAR_AREA(vLocal_479, 30f, 0, 0, 0, 0);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_479, 30f, 0, 0, 0, 0, 0, 0);
				iLocal_93 = 0;
				iLocal_92 = 2;
			}
			break;
...
var func_391(vector3 vParam0, int iParam3)
{
	...
	UI::SET_BLIP_PRIORITY(uVar0, 7);
	UI::SET_BLIP_SCALE(uVar0, 0.7f);
	UI::SET_BLIP_COLOUR(uVar0, 3);
	UI::SET_BLIP_ROUTE(uVar0, iParam3);
	UI::SET_BLIP_NAME_FROM_TEXT_FILE(uVar0, "MET1LBTRAC");
	return uVar0;
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_423(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_420(ENTITY::GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
void func_394(int iParam0, vector3 vParam1, var uParam4, int iParam5, bool bParam6)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (iParam5 == 24)
		{
			...
			{
				Global_71397 = GAMEPLAY::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME());
			}
		}
...
void func_395(int iParam0, int iParam1, int iParam2)
{
	...
	if (!GAMEPLAY::IS_BIT_SET(Global_70409.f_555[0 /*21*/].f_9, 12) && !GAMEPLAY::IS_BIT_SET(Global_70409.f_555[0 /*21*/].f_9, 10))
	{
...
void func_413(int iParam0, var uParam1, vector3 vParam2, var uParam5, int iParam6)
{
	if (func_412(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
		if (GAMEPLAY::IS_BIT_SET(Global_70409.f_555[0 /*21*/].f_9, 10))
		{
			func_418(iParam0);
			func_417(uParam1, &(Global_106565.f_32743.f_69[Global_70409.f_555[0 /*21*/].f_14 /*78*/]));
			if (GAMEPLAY::IS_BIT_SET(Global_70409.f_555[0 /*21*/].f_9, 11))
			{
	...
	while (iVar0 <= (10 - 1))
	{
		if (Global_88750[iVar0 /*10*/].f_7 != 263)
		{
			if (Global_88750[iVar0 /*10*/].f_9 == iParam3 || iParam3 == 145)
			{
				...
				{
					fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_88750[iVar0 /*10*/].f_3, 1);
					if (fVar1 < fVar2)
					{
						fVar2 = fVar1;
						iVar3 = iVar0;
...
{
	return GAMEPLAY::IS_BIT_SET(Global_106565.f_7223[iParam0], 0);
}
...
void func_424()
{
	...
	if (bLocal_337 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_340) > 8000)
	{
		UNK1::_0x293220DA1B46CEBC((2.5f + 8f), 1073741824, 3);
		iLocal_339 = 1;
	}
	if (!bLocal_337 && (GAMEPLAY::GET_GAME_TIMER() - iLocal_340) > 2000)
	{
...
void func_430()
{
	switch (iLocal_93)
	{
		case 0:
			func_27(&uLocal_297);
			if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(sLocal_573))
			{
				sLocal_573 = "DEFAULT";
			}
			if (GAMEPLAY::ARE_STRINGS_EQUAL(sLocal_573, "DEFAULT"))
			{
				func_434(0);
			}
			else
...
void func_441(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		...
		fLocal_621 = fVar7;
		GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_618, 10f, 0, 0, 0, 0, 0, 0);
	...
	else if ((((iLocal_92 == 3 || iLocal_92 == 4) || iLocal_92 == 5) && func_26(iLocal_273)) && func_26(iLocal_289))
	{
		if (func_26(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, 0))
			{
				...
				vLocal_618 = { ENTITY::GET_ENTITY_COORDS(iLocal_273, 1) };
			}
		}
	}
	else
	{
		...
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vLocal_618, 1, 0, 0, 1);
...
void func_449(int iParam0)
{
	if (iParam0 == 1)
	{
		GAMEPLAY::SET_BIT(&(Global_93682.f_20), 13);
	}
	else
	{
		GAMEPLAY::CLEAR_BIT(&(Global_93682.f_20), 13);
	}
}

var func_450()
{
	return GAMEPLAY::IS_BIT_SET(Global_93682.f_20, 13);
}
...
void func_456(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	if (func_536())
	{
		...
		GAMEPLAY::CLEAR_BIT(&(Global_93682.f_20), 2);
		...
		if (iParam4 == 1)
		{
			GAMEPLAY::SET_BIT(&(Global_93682.f_20), 14);
		}
		else
		{
			GAMEPLAY::CLEAR_BIT(&(Global_93682.f_20), 14);
		}
		if (iParam5 == 1)
		{
			GAMEPLAY::SET_BIT(&(Global_93682.f_20), 24);
		}
		else
		{
			GAMEPLAY::CLEAR_BIT(&(Global_93682.f_20), 24);
		}
		func_449(1);
	}
}
...
void func_460(bool bParam0)
{
	...
	else
	{
		...
		if (func_26(iLocal_273))
		{
			GAMEPLAY::CLEAR_AREA_OF_VEHICLES(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_273, 0f, -8f, 0f), 6f, 0, 0, 0, 0, 0, 0);
		}
	}
	...
	if (func_26(PLAYER::PLAYER_PED_ID()))
	{
		if (bParam0)
		{
			if (func_491())
			{
				...
				fLocal_621 = 251.1f;
				bLocal_622 = true;
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(99.6208f, -21.0027f, 67.0114f, 7f, 0, 0, 0, 0, 0, 0);
				func_489();
				while (!func_488())
				{
					SYSTEM::WAIT(0);
			...
			{
				GAMEPLAY::CLEAR_AREA(181.2331f, -33.9939f, 67.2522f, 3f, 1, 0, 0, 0);
...
void func_462()
{
	iLocal_301 = TIME::GET_CLOCK_DAY_OF_MONTH();
	iLocal_302 = TIME::GET_CLOCK_HOURS();
	iLocal_303 = TIME::GET_CLOCK_MINUTES();
}
...
int func_469(var uParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_471(uParam0, uVar1[iVar6], 1) && func_470(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_235(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_474(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_477(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_476())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
void func_497(var uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, var uParam10, int iParam11, int iParam12, int iParam13)
{
	...
	else if (iParam9 == 1)
	{
		...
		{
			STREAMING::REQUEST_MODEL(uParam10);
			while (!STREAMING::HAS_MODEL_LOADED(uParam10))
			{
				SYSTEM::WAIT(0);
			}
			*uParam0 = VEHICLE::CREATE_VEHICLE(uParam10, vParam1, fParam4, 1, 1, 0);
			...
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(uParam10);
		}
	}
	if (iParam5 == 1)
	{
...
void func_499(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if ((func_12(iParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_503(*uParam1, 0, &uVar0))
		{
...
void func_550(bool bParam0, bool bParam1)
{
	...
	if (iLocal_294)
	{
		PED::REMOVE_RELATIONSHIP_GROUP(uLocal_295);
	}
