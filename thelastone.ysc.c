...
void __EntryFunction__()
{
	...
	uLocal_1066 = WEAPON::GET_WEAPONTYPE_MODEL(iLocal_1061);
	uLocal_1067 = WEAPON::GET_WEAPONTYPE_MODEL(iLocal_1062);
...
void func_17()
{
	switch (Local_215.f_1)
	{
		...
		case 1:
			if ((GAMEPLAY::GET_GAME_TIMER() > iLocal_878 && !func_18()) || !func_463(Local_647.f_2))
			{
				func_19();
			}
			break;
...
void func_233()
{
	...
	if (Local_215.f_3 == 1)
	{
		...
		{
			func_342(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
		}
		Local_215.f_3 = 0;
	}
	if (Local_215.f_1 == 0)
	{
		...
		if (func_353(1, 1093140480, 0))
		{
			...
			if (func_330(uVar0))
			{
				ENTITY::SET_ENTITY_COORDS(uVar0, vLocal_1081, 1, 0, 0, 1);
				ENTITY::SET_ENTITY_HEADING(uVar0, fLocal_1084);
	...
	if (Local_215.f_1 == 1)
	{
		if (!func_330(uLocal_1080))
		{
			...
			if (!func_330(uLocal_1080) && STREAMING::HAS_MODEL_LOADED(iLocal_1070))
			{
				uLocal_1080 = VEHICLE::CREATE_VEHICLE(iLocal_1070, vLocal_1081, fLocal_1084, 1, 1, 0);
				if (func_330(uLocal_1080))
				{
		...
		if (func_463(Local_647.f_2))
		{
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Orleans", 0))
			{
				...
				AI::TASK_PERFORM_SEQUENCE(Local_647.f_2, uVar1);
...
void func_279(var uParam0)
{
	...
	if (func_168(iVar0) && !PED::IS_PED_INJURED(uParam0))
	{
...
int func_364()
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		Local_647.f_2 = PED::CREATE_PED(25, iLocal_1063, Local_293.f_1[1 /*14*/].f_1, 0, 1, 1);
	}
	else
	{
		Local_647.f_2 = PED::CREATE_PED(25, iLocal_1063, Local_293.f_1[0 /*14*/].f_1, 0, 1, 1);
	}
	if (func_463(Local_647.f_2))
	{
...
void func_371()
{
	if (Local_215.f_3 == 1)
	{
		...
		if (func_463(PLAYER::PLAYER_PED_ID()) && !func_352())
		{
			...
			ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), uLocal_1126);
		}
		while (!func_362())
		{
			SYSTEM::WAIT(0);
	...
	if (Local_215.f_1 == 1)
	{
		...
		else
		{
			...
			else if (iLocal_868 == 0)
			{
				...
				{
					if (!func_18() && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_1097, 35f, 35f, 35f, 0, 1, 0))
					{
						func_374();
						func_232(&uLocal_888, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			...
			if (iLocal_857 == 0)
			{
				if (!func_373(&uLocal_752, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
				{
...
void func_372()
{
	UI::CLEAR_PRINTS();
	func_11(&(Local_647.f_3));
	if (func_373(&uLocal_804, ENTITY::GET_ENTITY_COORDS(Local_647.f_2, 0)))
	{
		bLocal_869 = false;
	}
	else
				...
				if (ENTITY::DOES_ENTITY_EXIST(uVar1))
				{
					if (ENTITY::IS_ENTITY_A_PED(uVar1))
					{
						...
						if (func_383(uVar3))
						{
							...
							{
								ENTITY::SET_ENTITY_HEALTH(uVar3, 0, 0);
								func_396(808, 1, 0);
							}
						}
					}
...
void func_385(var uParam0)
{
	...
	switch (uParam0->f_1)
	{
		case 1:
			...
			else if (func_386(*uParam0, PLAYER::PLAYER_PED_ID(), uParam0->f_15, 1))
			{
			...
			if (func_463(Local_647.f_2))
			{
				...
				else if (Local_647.f_1 == 1)
				{
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						if (func_330(uVar3) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(uVar3, Local_647.f_2))
						{
							Local_647 = 6;
							Local_647.f_1 = 0;
						}
		...
		case 5:
			if (func_463(Local_647.f_2))
			{
				if (Local_647.f_1 == 0)
				{
					...
					AI::TASK_PERFORM_SEQUENCE(Local_647.f_2, uVar6);
					func_374();
					Local_647.f_1 = 1;
					Local_647.f_9 = 0;
				}
...
int func_393(var uParam0)
{
	...
	vVar0 = { func_336(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - uParam0->f_1) };
...
void func_405()
{
	...
	if (Local_215.f_1 == 0)
	{
		...
		if (func_442())
		{
			...
			uLocal_750 = UI::ADD_BLIP_FOR_RADIUS(vLocal_1091, 75f);
			UI::SET_BLIP_COLOUR(uLocal_750, 5);
			UI::SET_BLIP_ALPHA(uLocal_750, 128);
			UI::_0x75A16C3DA34F1245(uLocal_750, 0);
	...
	if (Local_215.f_1 == 1)
	{
		...
		{
			bVar0 = func_373(&uLocal_752, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
...
int func_421(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_336(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_428(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_236(PLAYER::PLAYER_PED_ID()) && func_236(uParam0))
	{
...
int func_431(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_336(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_336(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_422(vVar3, vVar0);
		...
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_286, sLocal_1072, "hunter_leadout", 3))
		{
			if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_286, sLocal_1072, "hunter_leadout") > 0.9f)
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_1072))
				{
					...
					AI::TASK_PLAY_ANIM(0, sLocal_1072, "hunter_idle_action", 1000f, -1000f, -1, iLocal_1075, 0, 0, 0, 0);
					...
					AI::TASK_PLAY_ANIM(0, sLocal_1072, "hunter_idle", 1000f, -1000f, -1, iLocal_1075, 0, 0, 0, 0);
					AI::TASK_PLAY_ANIM(0, sLocal_1072, "hunter_idle_look", 1000f, -1000f, -1, iLocal_1075, 0, 0, 0, 0);
					AI::SET_SEQUENCE_TO_REPEAT(uVar0, 1);
					AI::CLOSE_SEQUENCE_TASK(uVar0);
					AI::TASK_PERFORM_SEQUENCE(Local_286, uVar0);
...
void func_438()
{
	...
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(uLocal_1066);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(uLocal_1067);
	...
	if (Local_286.f_4 == 0)
	{
		if (bParam0)
		{
			...
			if (func_463(Local_225.f_28[0]))
			{
				...
				ENTITY::SET_ENTITY_HEADING(Local_286, uLocal_1107);
			}
			else
			{
				Local_286 = PED::CREATE_PED(26, iLocal_1064, vLocal_1104, uLocal_1107, 1, 1);
...
int func_442()
{
	if (((((((STREAMING::HAS_MODEL_LOADED(iLocal_1064) && STREAMING::HAS_MODEL_LOADED(iLocal_1065)) && STREAMING::HAS_MODEL_LOADED(uLocal_1066)) && STREAMING::HAS_MODEL_LOADED(uLocal_1067)) && STREAMING::HAS_MODEL_LOADED(iLocal_1068)) && VEHICLE::HAS_VEHICLE_ASSET_LOADED(iLocal_1065)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_1072)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_1073))
	{
		return 1;
	}
	return 0;
...
void func_443()
{
	...
	STREAMING::REQUEST_MODEL(uLocal_1066);
	STREAMING::REQUEST_MODEL(uLocal_1067);
	...
	if (Local_215.f_1 == 0)
	{
		...
		if (func_353(1, 1093140480, 0))
		{
			...
			if (func_463(Local_225.f_28[0]))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(uLocal_751))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_751, "SAS_SniperRifle", 0, 0, 0);
				}
			}
			func_350(500, 0);
		...
		if (func_463(Local_225.f_28[0]))
		{
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Hunter", 0))
			{
				...
				if (func_441(Local_286, 1862763509, iLocal_1061))
				{
					if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_1072))
					{
						AI::TASK_PLAY_ANIM(Local_286, sLocal_1072, "hunter_leadout", 1000f, -8f, -1, iLocal_1075, 0, 0, 0, 0);
					}
				}
			}
		}
...
int func_455(var uParam0, var uParam1, int iParam2, bool bParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8)
{
	...
	while (func_276(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(uParam0, iVar2, func_276(iVar2, iVar8)))
			{
				if (func_458(func_276(iVar2, iVar8)))
				{
					uVar9 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_276(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_276(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(uParam0, iVar2, func_276(iVar2, iVar8)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_276(iVar2, iVar8));
...
void func_460()
{
	...
	if ((((AUDIO::REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\SAS_BANK_01", 0, -1) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\SAS_BANK_02", 0, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("SAS_BANK_03", 0, -1)) && func_362()) && func_361())
	{
		if (AUDIO::IS_AMBIENT_ZONE_ENABLED("AZ_DISTANT_SASQUATCH"))
		{
