	...
	while (!GAMEPLAY::IS_BIT_SET(uLocal_216, 1))
	{
		if (!GAMEPLAY::IS_BIT_SET(uLocal_216, 0))
		{
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_46))
			{
				if (!PED::IS_PED_INJURED(uLocal_46))
				{
					...
					PED::ADD_RELATIONSHIP_GROUP("Lester Group", &uLocal_50);
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_50, 1862763509);
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, 1862763509, uLocal_50);
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_46, uLocal_50);
					...
					AI::TASK_PLAY_ANIM_ADVANCED(0, "MISSHEIST_JEWEL@HACKING", "HACK_INTRO", vVar0, vVar3, 8f, -8f, -1, 262152, 0, 2, 0);
					AI::TASK_PLAY_ANIM_ADVANCED(0, "MISSHEIST_JEWEL@HACKING", "HACK_LOOP", vVar0, vVar3, 8f, -8f, -1, 262153, 0, 2, 0);
		...
		else if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(uLocal_46, 0))
			{
				...
				if (Global_71854 == 86)
				{
					if (!Global_106560 == 1 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 718.0749f, -976.0472f, 22.91482f, 718.0593f, -979.455f, 27.1191f, 5.75f, 0, 1, 0))
					{
						func_3(7, 1);
						Global_106556 = 0;
						Global_106560 = 1;
...
void func_24()
{
	...
	PED::REMOVE_RELATIONSHIP_GROUP(uLocal_50);
	func_25();
