...
int func_2()
{
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_271))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_93018, &sLocal_277, &cLocal_309, 3))
			{
				...
				else if (fVar0 < 0.4778f)
				{
					if (iLocal_326 == 0)
					{
						iLocal_326 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_lamgraff_paint_spray", uLocal_271, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
...
int func_20()
{
	...
	if (!PED::IS_PED_INJURED(Global_93018))
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_271))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_93018, &sLocal_277, &cLocal_293, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_93018))
				{
					AI::STOP_ANIM_PLAYBACK(Global_93018, 0, 0);
				...
				else
				{
					...
					{
						iLocal_325 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_273, 0f, 0f, uLocal_276, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_325, 1);
					}
					AI::TASK_SYNCHRONIZED_SCENE(Global_93018, iLocal_325, &sLocal_277, &cLocal_309, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
...
void func_31()
{
	...
	while (!ENTITY::DOES_ENTITY_EXIST(Global_93018) || !STREAMING::HAS_MODEL_LOADED(iLocal_272))
	{
		SYSTEM::WAIT(0);
	}
	...
	uLocal_271 = OBJECT::CREATE_OBJECT(iLocal_272, ENTITY::GET_ENTITY_COORDS(Global_93018, 1), 1, 1, 0);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_271, Global_93018, PED::GET_PED_BONE_INDEX(Global_93018, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
}
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_38(uParam109, 17, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_38(uParam109, 144, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_38(uParam109, 43, 1785177548, 1785177548, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
