				...
				if (iLocal_49 == 2 || bLocal_74 == 1)
				{
					switch (iLocal_247)
					{
						...
						case 2:
							...
							if (ENTITY::IS_ENTITY_AT_COORD(uLocal_55, ENTITY::GET_ENTITY_COORDS(uLocal_54, 0), 4f, 4f, 3f, 0, 1, 0))
							{
								if (AI::GET_SCRIPT_TASK_STATUS(uLocal_55, 242628503) == 7 || func_74(&uLocal_78, "REARRAU", sLocal_271, 4, iLocal_254, 0, 0))
								{
									iLocal_247 = 6;
								}
							}
...
void func_19(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_21() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_21() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
int func_27(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_21() /*10778*/].f_6165.f_10, iParam0);
}
...
void func_57()
{
	...
	if (!PED::IS_PED_INJURED(uLocal_54))
	{
		...
		if ((((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_54, PLAYER::PLAYER_PED_ID(), 1) && ENTITY::GET_ENTITY_HEALTH(uLocal_54) < 190) || func_61()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || func_60()) || (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_54, PLAYER::PLAYER_PED_ID(), 1) && PED::IS_PED_RAGDOLL(uLocal_54))) || iVar2 == 1)
		{
			func_63(1);
...
int func_85()
{
	if (ENTITY::IS_ENTITY_AT_ENTITY(uLocal_55, uLocal_54, 3.5f, 3.5f, 3.5f, 0, 1, 0) || func_88())
	{
...
int func_105(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_106(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_143(GAMEPLAY::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_146()
{
	...
	func_152(&uVar0, TIME::GET_CLOCK_SECONDS());
	func_151(&uVar0, TIME::GET_CLOCK_MINUTES());
	func_150(&uVar0, TIME::GET_CLOCK_HOURS());
...
int func_185()
{
	if ((Global_106554 == func_127() && GAMEPLAY::GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
