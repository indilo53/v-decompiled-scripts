...
int func_4(struct<6> Param0, struct<16> Param6, var uParam22, struct<13> Param23, var uParam36, int iParam37)
{
	...
	while (iVar21 <= 11)
	{
		if (iVar20 == Global_2395292[iVar21 /*4*/].f_3 && GAMEPLAY::GET_GAME_TIMER() < Global_2395292[iVar21 /*4*/].f_2)
		{
			Global_2395292[iVar21 /*4*/].f_2 = GAMEPLAY::GET_GAME_TIMER() + 30000;
			iVar21 = 12;
			func_45(uParam22);
			return 0;
		}
	...
	{
		Global_2392991[iVar82 /*99*/].f_48 = GAMEPLAY::GET_GAME_TIMER() + 15000;
	}
	return 1;
}
...
int func_35(var uParam0, int iParam1, int iParam2)
{
	...
	iVar0 = UI::_GET_LENGTH_OF_STRING(uParam0);
	if (!iVar0 > 12)
	{
		return 0;
	}
	StringCopy(&cVar1, UI::_GET_TEXT_SUBSTRING_SLICE(uParam0, 0, 5), 8);
	if (!GAMEPLAY::ARE_STRINGS_EQUAL(&cVar1, "FAKE_"))
	{
		return 0;
	}
	StringCopy(&cVar3, UI::_GET_TEXT_SUBSTRING_SLICE(uParam0, 5, 12), 16);
	...
	StringCopy(&cVar7, UI::_GET_TEXT_SUBSTRING_SLICE(uParam0, 12, iVar0), 8);
...
void func_72(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (bParam1)
			{
				if (!func_76(uVar25) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar25))
				{
					if (!bVar21)
					{
...
void func_83()
{
	GAMEPLAY::SET_BIT(&Global_2448756, 7);
}

void func_84()
{
	GAMEPLAY::SET_BIT(&(Global_2448756.f_2), 15);
}
