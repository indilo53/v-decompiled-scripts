	...
	while (true)
	{
		...
		if ((GAMEPLAY::GET_GAME_TIMER() - iVar6) > 100)
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					if (SYSTEM::VDIST2(vVar0, ENTITY::GET_ENTITY_COORDS(iLocal_79[iVar3], 0)) >= IntToFloat((iVar5 * iVar5)) && ENTITY::IS_ENTITY_OCCLUDED(iLocal_79[iVar3]))
					{
...
void func_18()
{
	...
	PED::ADD_RELATIONSHIP_GROUP("ENEMIES", &uLocal_145);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_145);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_145, 1862763509);
	iVar0 = 0;
	while (iVar0 <= (iLocal_79.f_5 - 1))
	{
	...
	while (iVar0 <= (iLocal_79 - 1))
	{
		if (func_8(iLocal_79[iVar0]))
		{
			...
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_79[iVar0], uLocal_145);
...
void func_19()
{
	...
	PED::CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_145);
	PED::CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_145, 1862763509);
	iVar0 = 0;
	while (iVar0 <= (iLocal_79 - 1))
	{
