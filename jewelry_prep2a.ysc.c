	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96664.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_96664.f_4, 0))
		{
			if (func_185(24) != Global_96664.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_182(ENTITY::GET_ENTITY_COORDS(Global_96664.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_134(Global_96664.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
		...
		else
		{
			...
			switch (iLocal_93)
			{
				case 0:
					...
					func_269(&uLocal_99, &Global_90189);
					break;
		...
		if (Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/], vParam2, uParam5, 0, 0, 0);
				...
				func_241(uParam0, &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/], vParam2, uParam5, 0, 0, 0);
				...
				func_241(uParam0, &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*uParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*uParam0) == joaat("bodhi2"))
...
void func_207(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if ((func_168(iParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		{
			func_178(uParam1, &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106070.f_2355.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106070.f_20090[iParam0 /*43*/].f_31 = func_210(*uParam1);
...
int func_261(bool bParam0)
{
	...
	if ((STREAMING::HAS_MODEL_LOADED(joaat("s_m_m_armoured_01")) && STREAMING::HAS_MODEL_LOADED(iLocal_85)) && STREAMING::HAS_MODEL_LOADED(iLocal_86))
	{
		if (bParam0)
		{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(vLocal_1306.x))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_89824.f_9[0]))
				{
					...
					vLocal_1306.x = Global_89824.f_9[0];
				}
				else
				{
					bVar0 = false;
		...
		{
			func_270(&uLocal_99, iLocal_84);
			if (STREAMING::HAS_MODEL_LOADED(iLocal_84) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(&Global_90189))
			{
				if (GAMEPLAY::ARE_STRINGS_EQUAL(&Global_90189, "jhp2a_main"))
				{
					...
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1318, 1084227584);
					AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1306.x, Local_1318, &Global_90189, 786475, 23, 16, -1, 12f, 0, 1073741824);
				}
				else
				{
					...
					vLocal_1306.x = PED::CREATE_PED_INSIDE_VEHICLE(Local_1318, 26, iLocal_83, -1, 1, 1);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1318, 1084227584);
					AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1306.x, Local_1318, &Global_90189, 786475, 29, 16, -1, 12f, 0, 1073741824);
				}
			}
		}
		if (ENTITY::DOES_ENTITY_EXIST(Local_1318))
...
void func_287()
{
	func_295(&(Local_1084[0 /*8*/]), 78104, "Van Driver Manager");
	func_295(&(Local_1084[1 /*8*/]), 76751, "Cargo Manager");
}
				...
				case 1:
					...
					else
					{
						...
						if (!func_298(vLocal_1306.x, -235832601, 1))
						{
							...
							{
								AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1306.x, Local_1318, &Global_90189, 786475, -1, 24, -1, 12f, 0, 1073741824);
							}
						}
					}
					break;
...
void func_305(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_307(Global_106070.f_18505[iVar0], &vVar2, &fVar5))
			{
