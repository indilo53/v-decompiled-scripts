...
void func_8(bool bParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_1329))
	{
		if (bParam0)
		{
			OBJECT::DELETE_OBJECT(&uLocal_1329);
		}
		else
		{
			if (ENTITY::IS_ENTITY_ATTACHED(uLocal_1329))
			{
				ENTITY::DETACH_ENTITY(uLocal_1329, 1, 1);
			}
			ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_1329);
		}
	}
	if (iLocal_1330 != 0)
	{
		...
		switch (iLocal_94)
		{
			case 1:
				...
				else if ((ENTITY::DOES_ENTITY_EXIST(iLocal_1320) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1320, 0)) && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_1320, Local_1318))
				{
					...
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_1318, 692.9143f, -1003.556f, 21.50839f, 692.6511f, -1021.604f, 26.20675f, 9.75f, 0, 1, 0))
					{
				...
				else if (iLocal_1303 == 0)
				{
					...
					if (func_92(&uLocal_1101, vVar0, 692.9143f, -1003.556f, 21.50839f, 692.6511f, -1021.604f, 26.20675f, 9.75f, 1, Local_1318, "JHP2A_RTNVAN", "", "", PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1318, 0), 0, 1, -1))
					{
						iLocal_94 = 101;
					}
					if (UI::DOES_BLIP_EXIST(uLocal_1101) && UI::_0xDD2238F57B977751(uLocal_1101))
					{
						UI::SET_BLIP_ROUTE(uLocal_1101, 0);
					}
				}
				break;
					...
					while (iVar6 < Local_1322)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_1322[iVar6 /*2*/]) && !ENTITY::IS_ENTITY_ATTACHED(Local_1322[iVar6 /*2*/]))
						{
							if (!WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_briefcase"), 0))
							{
								...
								if ((bVar9 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, 0f, -3f, -0.5f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, 0f, -4.5f, 1f), 1.68f, 0, 1, 1)) || (!bVar9 && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(Local_1322[iVar6 /*2*/], 1), 0.75f, 0.75f, 4f, 0, 0, 1)))
								{
				...
				else
				{
					...
					if (bVar11)
					{
						...
						if (CONTROLS::IS_CONTROL_JUST_PRESSED(0, 51) && iVar10 == joaat("weapon_briefcase"))
						{
							...
							ROPE::ACTIVATE_PHYSICS(uVar13);
							UNK1::_0x293220DA1B46CEBC(3f, 5f, 4);
							AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "Drop_Case", uVar13, "JWL_PREP_2A_SOUNDS", 0, 0);
							ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uVar13);
		...
		if (CAM::IS_SCREEN_FADED_IN())
		{
			...
			if (bVar1)
			{
				...
				if (bParam26 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					if ((!func_60(uParam0, 1) && !func_59(uParam0)) && !GAMEPLAY::IS_BIT_SET(uParam0->f_13, 0))
					{
						if (bParam30)
						{
				...
				else
				{
					...
					else if (!func_53(vVar3, UI::GET_BLIP_COORDS(uParam0->f_5), 0.1f, 0))
					{
					...
					if (bVar1)
					{
						...
						while (iVar2 < 3)
						{
							if (!PED::IS_PED_INJURED(uParam0->f_17[iVar2]))
							{
								...
								else if (!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar2], func_52()) || !func_50(uParam0->f_17[iVar2], 1))
								{
									bVar1 = false;
								}
							}
...
int func_45(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_46(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		UI::SET_BLIP_SCALE(uVar0, func_46(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		UI::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
int func_47(var uParam0)
{
	if (GAMEPLAY::IS_BIT_SET(uParam0->f_13, 12))
	{
		...
		{
			if (func_48(1, 0, 1) || GAMEPLAY::IS_BIT_SET(uParam0->f_13, 7))
			{
				return 1;
			}
		}
	}
	else if (func_48(1, 0, 1) || GAMEPLAY::IS_BIT_SET(uParam0->f_13, 7))
	{
		return 1;
	}
	return 0;
...
int func_50(var uParam0, int iParam1)
{
	if (!PED::IS_PED_INJURED(uParam0))
	{
		...
		{
			if (func_51(PLAYER::PLAYER_PED_ID(), uParam0))
			{
				PED::SET_GROUP_SEPARATION_RANGE(func_52(), 50f);
				return 1;
			}
		}
		else if (PED::IS_PED_GROUP_MEMBER(uParam0, func_52()))
		{
			PED::SET_GROUP_SEPARATION_RANGE(func_52(), 50f);
			return 1;
		}
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_57(iParam2), 1);
}
...
int func_72(var uParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(uParam0))
	{
		if (!PED::IS_PED_GROUP_MEMBER(uParam0, func_52()))
		{
...
int func_88(var uParam0)
{
	...
	vVar0 = { GAMEPLAY::_0x21C235BC64831E5A(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, vLocal_87), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, vLocal_90), 0) };
...
void func_97(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
		{
			...
			if (bParam1)
			{
				if (PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_52()) && uParam0->f_17[iVar0] != PLAYER::PLAYER_PED_ID())
				{
					PED::REMOVE_PED_FROM_GROUP(uParam0->f_17[iVar0]);
				}
			}
...
void func_103(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_127(uParam1) && ENTITY::IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
int func_108(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_116() || func_115(Global_4456448.f_161209)) || func_114())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_112(uVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
	...
	if (iLocal_1303 == 0)
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("towtruck") || ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("towtruck2"))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(uVar0, 0))
				{
					if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uVar0, Local_1318))
					{
						iLocal_1320 = uVar0;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_185(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_182(ENTITY::GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_160(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_193(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
		switch (ENTITY::GET_ENTITY_TYPE(uParam0))
		{
			case 1:
				if (!PED::IS_PED_INJURED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(uParam0)))
				{
		...
		else
		{
			...
			switch (iLocal_93)
			{
				case 0:
					...
					if (GAMEPLAY::ARE_STRINGS_EQUAL(&Global_90574, "jhp2a_main"))
					{
						while (!func_205(&iLocal_1316, 1395.851f, -1069.306f, 52.4779f, 118.1591f, 1))
						{
							SYSTEM::WAIT(0);
							GAMEPLAY::CLEAR_AREA_OF_VEHICLES(1395.851f, -1069.306f, 52.4779f, 20f, 0, 0, 0, 0, 0, 0);
						}
					}
					else
					{
						...
						{
							SYSTEM::WAIT(0);
							GAMEPLAY::CLEAR_AREA_OF_VEHICLES(1256.913f, 556.8416f, 79.7013f, 20f, 0, 0, 0, 0, 0, 0);
						}
					}
				...
				case 1:
					if (!func_7(87))
					{
						Local_1318 = VEHICLE::CREATE_VEHICLE(joaat("boxville3"), 693.725f, -1006.302f, 21.8355f, 359.884f, 1, 1, 0);
						VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_1318, 0);
...
int func_205(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if (Var0.f_66 != 0)
	{
		if (!func_257(0, &Var0))
		{
			if (VEHICLE::IS_THIS_MODEL_A_CAR(Var0.f_66) || VEHICLE::IS_THIS_MODEL_A_BIKE(Var0.f_66))
			{
				...
				{
					*uParam0 = VEHICLE::CREATE_VEHICLE(Var0.f_66, vParam1, fParam4, 1, 1, 0);
	...
	if (bParam5)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			...
			{
				VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(func_166(0, 0), 1);
				return 1;
			}
		}
		return 0;
...
void func_207(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if ((func_168(iParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_211(*uParam1, 0, &uVar0))
		{
...
int func_241(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_232(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_244(*uParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_244(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_243(uParam0);
	if (func_242(*uParam0))
	{
...
void func_246(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_249(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_248())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
int func_257(int iParam0, var uParam1)
{
	...
	{
		if (Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam0 /*98*/] == uParam1->f_66 && GAMEPLAY::GET_HASH_KEY(&(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam0 /*98*/].f_27)) == GAMEPLAY::GET_HASH_KEY(&(uParam1->f_1)))
		{
			return 1;
		}
	}
	...
	{
		if (Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam0 /*98*/] == uParam1->f_66 && GAMEPLAY::GET_HASH_KEY(&(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam0 /*98*/].f_27)) == GAMEPLAY::GET_HASH_KEY(&(uParam1->f_1)))
		{
			return 1;
		}
	}
	...
	if ((STREAMING::HAS_MODEL_LOADED(joaat("s_m_m_armoured_01")) && STREAMING::HAS_MODEL_LOADED(iLocal_85)) && STREAMING::HAS_MODEL_LOADED(iLocal_86))
	{
		if (bParam0)
		{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(vLocal_1306.x))
			{
				...
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_9[0], 1, 1);
		...
		{
			func_270(&uLocal_99, iLocal_84);
			if (STREAMING::HAS_MODEL_LOADED(iLocal_84) && AI::GET_IS_WAYPOINT_RECORDING_LOADED(&Global_90574))
			{
				if (GAMEPLAY::ARE_STRINGS_EQUAL(&Global_90574, "jhp2a_main"))
				{
					AI::WAYPOINT_RECORDING_GET_COORD(&Global_90574, 23, &vVar1);
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vVar1, 20f, 0, 0, 0, 0, 0, 0);
					Local_1318 = VEHICLE::CREATE_VEHICLE(iLocal_84, vVar1, 119.4988f, 1, 1, 0);
					vLocal_1306.x = PED::CREATE_PED_INSIDE_VEHICLE(Local_1318, 26, iLocal_83, -1, 1, 1);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1318, 1084227584);
					AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1306.x, Local_1318, &Global_90574, 786475, 23, 16, -1, 12f, 0, 1073741824);
				}
				else
				{
					AI::WAYPOINT_RECORDING_GET_COORD(&Global_90574, 29, &vVar1);
					GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vVar1, 20f, 0, 0, 0, 0, 0, 0);
					Local_1318 = VEHICLE::CREATE_VEHICLE(iLocal_84, vVar1, 134.0011f, 1, 1, 0);
					vLocal_1306.x = PED::CREATE_PED_INSIDE_VEHICLE(Local_1318, 26, iLocal_83, -1, 1, 1);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1318, 1084227584);
					AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1306.x, Local_1318, &Global_90574, 786475, 29, 16, -1, 12f, 0, 1073741824);
				}
			}
		}
		if (ENTITY::DOES_ENTITY_EXIST(Local_1318))
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1318, 0))
			{
				...
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_1318, 1, 1);
		...
		if (ENTITY::DOES_ENTITY_EXIST(vLocal_1306.x))
		{
			if (!PED::IS_PED_INJURED(vLocal_1306.x))
			{
				...
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(vLocal_1306.x, uLocal_1305);
...
void func_264()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_1318))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_1318, 0) && !ENTITY::DOES_ENTITY_EXIST(uLocal_1329))
		{
			uLocal_1329 = OBJECT::CREATE_OBJECT(iLocal_86, ENTITY::GET_ENTITY_COORDS(Local_1318, 1), 1, 1, 0);
			OBJECT::SET_OBJECT_PHYSICS_PARAMS(uLocal_1329, 0.1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f);
			ENTITY::ATTACH_ENTITY_TO_ENTITY_PHYSICALLY(uLocal_1329, Local_1318, -1, -1, ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_1318, ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(Local_1318, 5)) + Vector(0f, 0f, 0.02f), 0f, 0f, 0f, 0f, 0f, 0f, -1f, 1, 1, 0, 1, 2);
			ENTITY::SET_ENTITY_VISIBLE(uLocal_1329, 0, 0);
		}
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1322[0 /*2*/]))
		{
			if (ENTITY::IS_ENTITY_DEAD(Local_1318, 0))
			{
				vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-2.5f, 2.5f), -5f, 0f) };
				GAMEPLAY::GET_GROUND_Z_FOR_3D_COORD(vVar0, &(vVar0.f_2), 0, 0);
				Local_1322[0 /*2*/] = OBJECT::CREATE_OBJECT(iLocal_85, vVar0, 1, 1, 0);
			}
			else
			{
				Local_1322[0 /*2*/] = OBJECT::CREATE_OBJECT(iLocal_85, ENTITY::GET_ENTITY_COORDS(Local_1318, 1), 1, 1, 0);
				...
				ENTITY::_SET_ENTITY_SOMETHING(Local_1322[0 /*2*/], 1);
			}
		}
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1322[1 /*2*/]))
		{
			...
			{
				Local_1322[1 /*2*/] = OBJECT::CREATE_OBJECT(iLocal_85, ENTITY::GET_ENTITY_COORDS(Local_1318, 1), 1, 1, 0);
				...
				ENTITY::_SET_ENTITY_SOMETHING(Local_1322[1 /*2*/], 1);
			}
		}
		if (!ENTITY::DOES_ENTITY_EXIST(Local_1322[2 /*2*/]))
		{
			...
			{
				Local_1322[2 /*2*/] = OBJECT::CREATE_OBJECT(iLocal_85, ENTITY::GET_ENTITY_COORDS(Local_1318, 1), 1, 1, 0);
				...
				ENTITY::_SET_ENTITY_SOMETHING(Local_1322[2 /*2*/], 1);
			}
		}
	}
}
...
void func_280()
{
	...
	func_287();
	PED::ADD_RELATIONSHIP_GROUP("SECDRIVER", &uLocal_1305);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_1305, -1533126372);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_1305, -183807561);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, uLocal_1305);
	...
	func_281();
	if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&Global_90574))
	{
	}
			...
			switch (uParam0->f_1)
			{
				case 1:
					...
					if (AUDIO::REQUEST_SCRIPT_AUDIO_BANK("JWL_HEIST_PREP_2A_SHOOTING_LOCK", 0, -1))
					{
						...
						{
							if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_1329, PLAYER::PLAYER_PED_ID(), 0))
							{
								if ((((WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(uLocal_1329, joaat("weapon_molotov"), 0) || WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(uLocal_1329, joaat("weapon_bzgas"), 0)) || WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(uLocal_1329, joaat("weapon_knife"), 0)) || WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(uLocal_1329, joaat("weapon_unarmed"), 0)) || WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(uLocal_1329, joaat("weapon_hit_by_water_cannon"), 0))
								{
									WEAPON::CLEAR_ENTITY_LAST_WEAPON_DAMAGE(uLocal_1329);
								}
								else
								{
									ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_1329);
									iLocal_1336 = GAMEPLAY::GET_GAME_TIMER();
									iLocal_1335++;
									if (iLocal_1335 >= 3)
									{
										AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "Lock_Destroyed", uLocal_1329, "JWL_PREP_2A_SOUNDS", 0, 0);
									}
									else
									{
										AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "Lock_Damage", uLocal_1329, "JWL_PREP_2A_SOUNDS", 0, 0);
									}
								}
							}
						}
					...
					if (((((iLocal_1335 >= 3 || ENTITY::IS_ENTITY_DEAD(uLocal_1329, 0)) || VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1318, 2)) || VEHICLE::IS_VEHICLE_DOOR_DAMAGED(Local_1318, 3)) || VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1318, 2) > 0f) || VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1318, 3) > 0f)
					{
						if (ENTITY::DOES_ENTITY_EXIST(uLocal_1329))
						{
							OBJECT::DELETE_OBJECT(&uLocal_1329);
				...
				case 2:
					...
					{
						if (GAMEPLAY::ABSF(VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1318, 2)) > 0.5f && GAMEPLAY::ABSF(VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1318, 3)) > 0.5f)
						{
...
void func_293(var uParam0, bool bParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
		...
		{
			ENTITY::DETACH_ENTITY(uParam0, 1, bParam1);
			ENTITY::SET_ENTITY_COLLISION(uParam0, 1, 0);
			ROPE::ACTIVATE_PHYSICS(uParam0);
		}
		if (bParam1)
		{
			vVar0 = { func_294(ENTITY::GET_ENTITY_COORDS(uParam0, 1) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-0.15f, 0.15f), IntToFloat(-GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3, 6)), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-0.1f, 0.1f))) };
			ENTITY::APPLY_FORCE_TO_ENTITY_CENTER_OF_MASS(uParam0, 1, vVar0 * FtoV(GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0.25f, 0.5f)), 0, 1, 1, 0);
			ENTITY::APPLY_FORCE_TO_ENTITY_CENTER_OF_MASS(uParam0, 5, IntToFloat(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 10)), IntToFloat(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 10)), IntToFloat(GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 10)), 0, 1, 1, 0);
			ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(uParam0, Local_1318, 1);
		}
	}
}
	...
	if (!func_130(uParam0))
	{
		...
		else
		{
			...
			else if ((uParam0->f_1 == 1 || uParam0->f_1 == 2) || uParam0->f_1 == 4)
			{
				...
				{
					uVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
					if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(uVar0, Local_1318))
					{
					...
					vVar1 = { func_294(ENTITY::GET_ENTITY_COORDS(uVar0, 1) - ENTITY::GET_ENTITY_COORDS(Local_1318, 1)) };
					vVar4 = { ENTITY::GET_ENTITY_VELOCITY(Local_1318) - ENTITY::GET_ENTITY_VELOCITY(uVar0) };
			...
			switch (uParam0->f_1)
			{
				case 1:
					...
					else
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_1318) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1318, 0))
						{
							if ((ENTITY::IS_ENTITY_STATIC(PLAYER::PLAYER_PED_ID()) || fLocal_1333 > 0.5f) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, 0f, 2f, -0.5f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, 0f, 10f, 2f), 4.5f, 0, 1, 0))
							{
						...
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_1318, -990.6312f, -2413.214f, 12.69471f, -996.0194f, -2422.608f, 16.05846f, 8.75f, 0, 1, 0))
							{
							...
							{
								AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1306.x, Local_1318, &Global_90574, 786475, -1, 24, -1, 12f, 0, 1073741824);
							}
						}
					}
					break;
				...
				case 2:
					...
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_1318, -1096.139f, -2467.117f, 12.69561f, -1101.641f, -2476.775f, 15.6304f, 7.8125f, 0, 1, 0))
						{
							iLocal_1337 = 0;
							iLocal_1338 = 0;
							StringCopy(&cLocal_1339, "", 24);
						...
						{
							AI::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1306.x, Local_1318, "jhp2a_airport", 786475, -1, 24, -1, 12f, 0, 1073741824);
						}
					}
					break;
				...
				case 3:
					...
					else
					{
						...
						{
							AI::OPEN_SEQUENCE_TASK(&uLocal_1304);
							...
							AI::CLOSE_SEQUENCE_TASK(uLocal_1304);
							AI::TASK_PERFORM_SEQUENCE(vLocal_1306.x, uLocal_1304);
							AI::CLEAR_SEQUENCE_TASK(&uLocal_1304);
						}
					}
					break;
				...
				case 4:
					...
					{
						AI::TASK_VEHICLE_MISSION_PED_TARGET(vLocal_1306.x, Local_1318, PLAYER::PLAYER_PED_ID(), 8, 90f, 786468, 400f, 10f, 0);
					}
					break;
					...
					switch (iLocal_1337)
					{
						...
						case 2:
							if (func_36() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(vLocal_1306.x))
							{
								...
								{
									fVar8 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(vLocal_1306.x, 1));
									if ((((((iLocal_1332 || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 122)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 123)) || PED::HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 124)) || fVar8 < 49f) && (GAMEPLAY::GET_GAME_TIMER() - iLocal_1338) > 5000) && fVar8 < 225f)
									{
					...
					switch (iLocal_1337)
					{
						case 0:
							if (func_36() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(vLocal_1306.x))
							{
								if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&cLocal_1339))
								{
									if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_1338) > 5000 && SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(vLocal_1306.x, 1)) < 400f)
									{
										if (GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 2) == 0)
										{
