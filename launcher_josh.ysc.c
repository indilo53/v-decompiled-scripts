...
void __EntryFunction__()
{
	...
	else if (Var0 == 30)
	{
		...
		iLocal_262 = GAMEPLAY::GET_GAME_TIMER();
	}
	while (true)
	{
		SYSTEM::WAIT(0);
...
void func_190()
{
	...
	{
		case 0:
			if ((GAMEPLAY::GET_GAME_TIMER() - iLocal_262) > 100 && bLocal_263 == 0)
			{
				iLocal_96 = 1;
			}
			break;
...
int func_200(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_199(PLAYER::PLAYER_PED_ID()) && func_199(iParam0->f_28[0])) && !func_144()) && (GAMEPLAY::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_211(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_215(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_215(uParam1) && uParam1->f_4 == 0) && GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_229(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_231(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_238(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_231(vParam1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_231(PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_230(vVar3, vVar0);
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_199(uParam0->f_28[0]))
			{
				...
				AI::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_94, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
...
void func_283(int iParam0, bool bParam1)
{
	...
	if (UI::DOES_BLIP_EXIST(uLocal_264))
	{
		UI::REMOVE_BLIP(&uLocal_264);
	}
