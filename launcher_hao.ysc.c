...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (!func_197(-72.323f, -1258.643f, 28.648f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[0], 1), 1056964608))
			{
...
int func_181(var uParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_126(PLAYER::PLAYER_PED_ID()) && func_126(uParam0->f_28[0])) && !func_145()) && (GAMEPLAY::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_185(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
	...
	switch (iLocal_91)
	{
		...
		case 3:
			if (func_125(uParam0->f_28[0]) && func_198(uParam0->f_35[0]))
			{
				...
				vVar10 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(uParam0->f_35[0], uVar9) };
				uVar6 = PED::CREATE_SYNCHRONIZED_SCENE(vVar10, ENTITY::GET_ENTITY_ROTATION(uParam0->f_35[0], 2), 2);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(uVar6, 1);
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uVar6, 0);
				AI::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uVar6, sVar7, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
