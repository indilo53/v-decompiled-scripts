...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_309, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) < 3f)
			{
				switch (iLocal_307)
				{
					case 0:
...
void func_1()
{
	...
	switch (iLocal_308)
	{
				...
				if (func_35(vLocal_309, vVar0) && OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vLocal_309, 3f, joaat("prop_cs_remote_01"), 0))
				{
					if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
					{
						if ((!PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()) && !PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) && CONTROLS::IS_CONTROL_PRESSED(0, 51))
						{
							...
							GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(vLocal_312, 3f, 0);
		...
		case 2:
			...
			uLocal_319 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_323, vLocal_326, 2);
...
var func_18()
{
	...
	uVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_309, 3f, joaat("prop_cs_remote_01"), 0, 0, 1);
	return uVar0;
}
		...
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				if ((((CAM::IS_GAMEPLAY_CAM_RENDERING() && !CUTSCENE::IS_CUTSCENE_PLAYING()) && !CAM::IS_CINEMATIC_CAM_RENDERING()) && !func_39(0)) && !func_38())
				{
					...
					if (func_36(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vParam0, fParam3, 0))
					{
						return 1;
					}
				}
...
int func_41()
{
	...
	uVar0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vLocal_309, 10f, joaat("prop_cs_remote_01"), 0, 0, 1);
