					...
					else
					{
						if (iLocal_58)
						{
							...
							while (iLocal_68 < 8)
							{
								...
								{
									if (func_32(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), iLocal_68 + 1, 0, 0))
									{
						...
						if (SYSTEM::TIMERA() > 125)
						{
							...
							if (func_29(iLocal_37, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)))
							{
								...
								if (func_28(iLocal_37))
								{
									...
									if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GAMEPLAY::GET_HASH_KEY(&Local_72)) == 0)
									{
								...
								else if (!Global_25979[iLocal_37])
								{
									...
									else
									{
										...
										if (!bLocal_56)
										{
											if (func_32(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), iLocal_37, 0, 0))
											{
												if (!iLocal_37 == 4 || (GAMEPLAY::GET_GAME_TIMER() - uLocal_78[iLocal_70]) > 8000)
												{
													func_18();
												}
											}
