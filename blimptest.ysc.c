...
void func_1()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_40))
	{
		if ((ENTITY::IS_ENTITY_DEAD(uLocal_40, 0) || ENTITY::GET_ENTITY_HEALTH(uLocal_40) <= 0) || VEHICLE::GET_VEHICLE_ENGINE_HEALTH(uLocal_40) <= 0f)
		{
			...
			if (iLocal_47 == 1)
			{
				vVar0 = { ENTITY::GET_ENTITY_COORDS(uLocal_40, 0) };
				func_8(vVar0);
			}
			if (iLocal_47 == 1)
			{
...
void func_17()
{
	...
	uLocal_40 = VEHICLE::CREATE_VEHICLE(iLocal_41, VEHICLE::_0x92523B76657A517D(VEHICLE::GET_VEHICLE_RECORDING_ID(1, "Blimp_City"), 0f), vVar0.z, 1, 1, 0);
