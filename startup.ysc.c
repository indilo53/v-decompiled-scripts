...
void __EntryFunction__()
{
	...
	switch (iLocal_56)
	{
		case 0:
			...
			while ((!GAMEPLAY::IS_BIT_SET(Global_4270166, 0) || !GAMEPLAY::IS_BIT_SET(Global_4270166, 1)) || !GAMEPLAY::IS_BIT_SET(Global_4270166, 2))
			{
				if (!GAMEPLAY::IS_BIT_SET(Global_4270166, 0))
				{
				}
				if (!GAMEPLAY::IS_BIT_SET(Global_4270166, 1))
				{
				}
				if (!GAMEPLAY::IS_BIT_SET(Global_4270166, 2))
				{
				}
				SYSTEM::WAIT(0);
			}
			GAMEPLAY::START_SAVE_DATA(&Global_106565, 1, 1);
			GAMEPLAY::REGISTER_FLOAT_TO_SAVE(&Global_106565, "fSaveVersion");
	...
	GAMEPLAY::START_SAVE_DATA(&Global_2097152, 10779, 0);
	GAMEPLAY::_START_SAVE_ARRAY(&Global_2097152, 10779, "g_savedMPGlobals");
	iVar1 = 0;
	while (iVar1 < 1)
	{
...
void func_4(var uParam0, int iParam1)
{
	...
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_10751.f_19), 8, &cVar0);
	GAMEPLAY::_START_SAVE_STRUCT(&(uParam0->f_10751.f_19[0 /*7*/]), 7, "TEMPSTAT_DATE");
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_10751.f_19[0 /*7*/]), "TEMPSTAT_DATE.year");
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_10751.f_19[0 /*7*/].f_1), "TEMPSTAT_DATE.month");
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_10751.f_19[0 /*7*/].f_2), "TEMPSTAT_DATE.day");
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_10751.f_19[0 /*7*/].f_3), "TEMPSTAT_DATE.hour");
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_10751.f_19[0 /*7*/].f_4), "TEMPSTAT_DATE.minute");
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_10751.f_19[0 /*7*/].f_5), "TEMPSTAT_DATE.seconds");
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_10751.f_19[0 /*7*/].f_6), "TEMPSTAT_DATE.Milliseconds");
	GAMEPLAY::STOP_SAVE_STRUCT();
...
void func_5(var uParam0, int iParam1)
{
	...
	StringIntConCat(&cVar0, iParam1, 32);
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_10751.f_15), 4, &cVar0);
	GAMEPLAY::_START_SAVE_STRUCT(&(uParam0->f_10751.f_15[0 /*3*/]), 3, "TEMPSTAT_VEC");
	GAMEPLAY::REGISTER_FLOAT_TO_SAVE(&(uParam0->f_10751.f_15[0 /*3*/]), "TEMPSTAT_VEC.x");
	GAMEPLAY::REGISTER_FLOAT_TO_SAVE(&(uParam0->f_10751.f_15[0 /*3*/].f_1), "TEMPSTAT_VEC.y");
	GAMEPLAY::REGISTER_FLOAT_TO_SAVE(&(uParam0->f_10751.f_15[0 /*3*/].f_2), "TEMPSTAT_VEC.z");
	GAMEPLAY::STOP_SAVE_STRUCT();
	GAMEPLAY::STOP_SAVE_ARRAY();
}
...
void func_6(var uParam0, int iParam1)
{
	...
	StringIntConCat(&cVar0, iParam1, 32);
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_10751.f_6), 9, &cVar0);
	GAMEPLAY::_0x8269816F6CFD40F8(&(uParam0->f_10751.f_6[0 /*8*/]), "TEMPSTAT_LABEL");
	GAMEPLAY::STOP_SAVE_ARRAY();
}
...
void func_7(var uParam0, int iParam1)
{
	...
	StringIntConCat(&cVar0, iParam1, 32);
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_10751.f_4), 2, &cVar0);
	GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_10751.f_4[0]), "TEMPSTAT_BOOL");
	GAMEPLAY::STOP_SAVE_ARRAY();
}
...
void func_8(var uParam0, int iParam1)
{
	...
	StringIntConCat(&cVar0, iParam1, 32);
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_10751.f_2), 2, &cVar0);
	GAMEPLAY::REGISTER_FLOAT_TO_SAVE(&(uParam0->f_10751.f_2[0]), "TEMPSTAT_FLOAT");
	GAMEPLAY::STOP_SAVE_ARRAY();
}
...
void func_9(var uParam0, int iParam1)
{
	...
	StringIntConCat(&cVar0, iParam1, 32);
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_10751), 2, &cVar0);
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_10751[0]), "TEMPSTAT_INT1");
	GAMEPLAY::STOP_SAVE_ARRAY();
}
...
void func_10(var uParam0, int iParam1)
{
	...
	GAMEPLAY::_START_SAVE_STRUCT(&(uParam0->f_10601), 150, &cVar0);
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_10601), "MPATM_CARET_");
	iVar6 = 0;
	StringCopy(&Var7, "MPATMLOGVAL", 16);
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_10601.f_1), 17, &Var7);
	iVar6 = 0;
	while (iVar6 < 16)
	{
		cVar11 = { Var7 };
		StringIntConCat(&cVar11, iVar6, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_10601.f_1[iVar6]), &cVar11);
		iVar6++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	StringCopy(&Var7, "MPATMLOGSCRS", 16);
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_10601.f_18), 97, &Var7);
	iVar6 = 0;
	while (iVar6 < 16)
	{
		cVar15 = { Var7 };
		StringIntConCat(&cVar15, iVar6, 16);
		GAMEPLAY::_0x48F069265A0E4BEC(&(uParam0->f_10601.f_18[iVar6 /*6*/]), &cVar15);
		iVar6++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	StringCopy(&Var7, "MPATMLOGACT", 16);
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_10601.f_115), 17, &Var7);
	iVar6 = 0;
	while (iVar6 < 16)
	{
		cVar19 = { Var7 };
		StringIntConCat(&cVar19, iVar6, 16);
		GAMEPLAY::REGISTER_ENUM_TO_SAVE(&(uParam0->f_10601.f_115[iVar6]), &cVar19);
		iVar6++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	StringCopy(&Var7, "MPATMLOGDAT", 16);
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_10601.f_132), 17, &Var7);
	iVar6 = 0;
	while (iVar6 < 16)
	{
		cVar23 = { Var7 };
		StringIntConCat(&cVar23, iVar6, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_10601.f_132[iVar6]), &cVar23);
		iVar6++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_10601.f_149), "mpAnyVecBought");
	GAMEPLAY::STOP_SAVE_STRUCT();
}
...
void func_11(var uParam0, int iParam1)
{
	...
	GAMEPLAY::_START_SAVE_STRUCT(&(uParam0->f_10360), 241, &Var0);
	GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360), "BOUNTY_GAMERH64_1");
	GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_1), "BOUNTY_GAMERH64_2");
	GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_2), "BOUNTY_GAMERH64_3");
	GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_3), "BOUNTY_GAMERH64_4");
	GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_4), "BOUNTY_GAMERH64_5");
	GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_5), "BOUNTY_GAMERH64_6");
	GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_6), "BOUNTY_GAMERH64_7");
	GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_7), "BOUNTY_GAMERH64_8");
	GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_8), "BOUNTY_GAMERH64_9");
	GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_9), "BOUNTY_GAMERH64_10");
	GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_10), "BOUNTY_GAMERH64_11");
	GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_11), "BOUNTY_GAMERH64_12");
	GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_12), "BOUNTY_GAMERH64_13");
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_10360.f_13), "BOUNTY_TIME");
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_10360.f_14), "BOUNTY_VALUE");
	StringConCat(&Var0, "_GH", 24);
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_10360.f_15), 209, &Var0);
	iVar14 = 0;
	while (iVar14 < 16)
	{
		...
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_15[iVar14 /*13*/]), &cVar6);
		MemCopy(&cVar6, {Var0}, 8);
		StringConCat(&cVar6, "64_", 32);
		StringIntConCat(&cVar6, iVar14, 32);
		StringConCat(&cVar6, "_2", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_15[iVar14 /*13*/].f_1), &cVar6);
		MemCopy(&cVar6, {Var0}, 8);
		StringConCat(&cVar6, "64_", 32);
		StringIntConCat(&cVar6, iVar14, 32);
		StringConCat(&cVar6, "_3", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_15[iVar14 /*13*/].f_2), &cVar6);
		MemCopy(&cVar6, {Var0}, 8);
		StringConCat(&cVar6, "64_", 32);
		StringIntConCat(&cVar6, iVar14, 32);
		StringConCat(&cVar6, "_4", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_15[iVar14 /*13*/].f_3), &cVar6);
		MemCopy(&cVar6, {Var0}, 8);
		StringConCat(&cVar6, "64_", 32);
		StringIntConCat(&cVar6, iVar14, 32);
		StringConCat(&cVar6, "_5", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_15[iVar14 /*13*/].f_4), &cVar6);
		MemCopy(&cVar6, {Var0}, 8);
		StringConCat(&cVar6, "64_", 32);
		StringIntConCat(&cVar6, iVar14, 32);
		StringConCat(&cVar6, "_6", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_15[iVar14 /*13*/].f_5), &cVar6);
		MemCopy(&cVar6, {Var0}, 8);
		StringConCat(&cVar6, "64_", 32);
		StringIntConCat(&cVar6, iVar14, 32);
		StringConCat(&cVar6, "_7", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_15[iVar14 /*13*/].f_6), &cVar6);
		MemCopy(&cVar6, {Var0}, 8);
		StringConCat(&cVar6, "64_", 32);
		StringIntConCat(&cVar6, iVar14, 32);
		StringConCat(&cVar6, "_8", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_15[iVar14 /*13*/].f_7), &cVar6);
		MemCopy(&cVar6, {Var0}, 8);
		StringConCat(&cVar6, "64_", 32);
		StringIntConCat(&cVar6, iVar14, 32);
		StringConCat(&cVar6, "_9", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_15[iVar14 /*13*/].f_8), &cVar6);
		MemCopy(&cVar6, {Var0}, 8);
		StringConCat(&cVar6, "64_", 32);
		StringIntConCat(&cVar6, iVar14, 32);
		StringConCat(&cVar6, "_10", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_15[iVar14 /*13*/].f_9), &cVar6);
		MemCopy(&cVar6, {Var0}, 8);
		StringConCat(&cVar6, "64_", 32);
		StringIntConCat(&cVar6, iVar14, 32);
		StringConCat(&cVar6, "_11", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_15[iVar14 /*13*/].f_10), &cVar6);
		MemCopy(&cVar6, {Var0}, 8);
		StringConCat(&cVar6, "64_", 32);
		StringIntConCat(&cVar6, iVar14, 32);
		StringConCat(&cVar6, "_12", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_15[iVar14 /*13*/].f_11), &cVar6);
		MemCopy(&cVar6, {Var0}, 8);
		StringConCat(&cVar6, "64_", 32);
		StringIntConCat(&cVar6, iVar14, 32);
		StringConCat(&cVar6, "_13", 32);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_10360.f_15[iVar14 /*13*/].f_12), &cVar6);
		iVar14++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	StringCopy(&Var0, "MP_BOUNTY_SAVED", 24);
	...
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_10360.f_224), 17, &Var0);
	iVar14 = 0;
	while (iVar14 < 16)
	{
		MemCopy(&cVar6, {Var0}, 8);
		StringIntConCat(&cVar6, iVar14, 32);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_10360.f_224[iVar14]), &cVar6);
		iVar14++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::STOP_SAVE_STRUCT();
...
void func_13(var uParam0, char[4] cParam1)
{
	...
	GAMEPLAY::_START_SAVE_STRUCT(uParam0, 4195, cParam1);
	...
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_1325), "LAST_ACC_SMPLINT");
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_1304), 21, "PROP_ARY_VAL");
	iVar22 = 0;
	...
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_1326), "KR_PATCH_UPDATE");
	iVar22 = 0;
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_2682), 919, "DLC_MODS");
	iVar22 = 0;
	while (iVar22 < uParam0->f_2682)
	{
		StringCopy(&Var1, "DLC_MODS_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_2682[iVar22]), &Var1);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	iVar22 = 0;
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_3601), 362, "DLC_SUPERMODS");
	iVar22 = 0;
	while (iVar22 < uParam0->f_3601)
	{
		StringCopy(&Var1, "DLC_SMODS_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_3601[iVar22]), &Var1);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_1327), 274, "OUTFIT_CompDraw");
	iVar22 = 0;
	while (iVar22 < 21)
	{
		...
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_1327[iVar22 /*13*/]), 13, &Var1);
		iVar23 = 0;
		while (iVar23 < 12)
		{
			StringCopy(&Var1, "CompDraw", 16);
			...
			GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_1327[iVar22 /*13*/][iVar23]), &Var1);
			iVar23++;
		}
		GAMEPLAY::STOP_SAVE_ARRAY();
		iVar22++;
	...
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_1601), 274, "OUTFIT_CompTex");
	iVar22 = 0;
	while (iVar22 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_1601[iVar22 /*13*/]), 13, &Var1);
		iVar23 = 0;
		while (iVar23 < 12)
		{
			StringCopy(&Var1, "CompTex", 16);
			...
			StringConCat(&Var1, "_", 16);
			StringIntConCat(&Var1, iVar23, 16);
			GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_1601[iVar22 /*13*/][iVar23]), &Var1);
			iVar23++;
		}
		GAMEPLAY::STOP_SAVE_ARRAY();
		iVar22++;
	...
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_1875), 211, "OUTFIT_PropID");
	iVar22 = 0;
	while (iVar22 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_1875[iVar22 /*10*/]), 10, &Var1);
		iVar23 = 0;
		while (iVar23 < 9)
		{
			StringCopy(&Var1, "PropID", 16);
			...
			StringConCat(&Var1, "_", 16);
			StringIntConCat(&Var1, iVar23, 16);
			GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_1875[iVar22 /*10*/][iVar23]), &Var1);
			iVar23++;
		}
		GAMEPLAY::STOP_SAVE_ARRAY();
		iVar22++;
	...
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_2086), 211, "OUTFIT_PropTex");
	iVar22 = 0;
	while (iVar22 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_2086[iVar22 /*10*/]), 10, &Var1);
		iVar23 = 0;
		while (iVar23 < 9)
		{
			StringCopy(&Var1, "PropTex", 16);
			...
			StringConCat(&Var1, "_", 16);
			StringIntConCat(&Var1, iVar23, 16);
			GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_2086[iVar22 /*10*/][iVar23]), &Var1);
			iVar23++;
		}
		GAMEPLAY::STOP_SAVE_ARRAY();
		iVar22++;
	...
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_2297), 22, "OUTFIT_Stored");
	iVar22 = 0;
	while (iVar22 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2297[iVar22]), &Var1);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_2319), 22, "OUTFIT_CrewTatA");
	iVar22 = 0;
	while (iVar22 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2319[iVar22]), &Var1);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_2341), 22, "OUTFIT_CrewTatB");
	iVar22 = 0;
	while (iVar22 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2341[iVar22]), &Var1);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_2363), 22, "OUTFIT_CrewTatC");
	iVar22 = 0;
	while (iVar22 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2363[iVar22]), &Var1);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_2385), 22, "OUTFIT_CrewTatD");
	iVar22 = 0;
	while (iVar22 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2385[iVar22]), &Var1);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_2407), 22, "OUTFIT_CrewTatE");
	iVar22 = 0;
	while (iVar22 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2407[iVar22]), &Var1);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_2429), 22, "OUTFIT_CrewTatF");
	iVar22 = 0;
	while (iVar22 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_2429[iVar22]), &Var1);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_2620), 22, "OUTFIT_Shirt");
	iVar22 = 0;
	while (iVar22 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_2620[iVar22]), &Var1);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_2451), 169, "OUTFIT_Name");
	iVar22 = 0;
	while (iVar22 < 21)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::_0x8269816F6CFD40F8(&(uParam0->f_2451[iVar22 /*8*/]), &Var1);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_2642), 40, "LAST_JobGamer");
	iVar22 = 0;
	while (iVar22 < 3)
	{
		...
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2642[iVar22 /*13*/]), &cVar24);
		cVar24 = { Var1 };
		StringConCat(&cVar24, "_2", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2642[iVar22 /*13*/].f_1), &cVar24);
		cVar24 = { Var1 };
		StringConCat(&cVar24, "_3", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2642[iVar22 /*13*/].f_2), &cVar24);
		cVar24 = { Var1 };
		StringConCat(&cVar24, "_4", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2642[iVar22 /*13*/].f_3), &cVar24);
		cVar24 = { Var1 };
		StringConCat(&cVar24, "_5", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2642[iVar22 /*13*/].f_4), &cVar24);
		cVar24 = { Var1 };
		StringConCat(&cVar24, "_6", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2642[iVar22 /*13*/].f_5), &cVar24);
		cVar24 = { Var1 };
		StringConCat(&cVar24, "_7", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2642[iVar22 /*13*/].f_6), &cVar24);
		cVar24 = { Var1 };
		StringConCat(&cVar24, "_8", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2642[iVar22 /*13*/].f_7), &cVar24);
		cVar24 = { Var1 };
		StringConCat(&cVar24, "_9", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2642[iVar22 /*13*/].f_8), &cVar24);
		cVar24 = { Var1 };
		StringConCat(&cVar24, "_10", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2642[iVar22 /*13*/].f_9), &cVar24);
		cVar24 = { Var1 };
		StringConCat(&cVar24, "_11", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2642[iVar22 /*13*/].f_10), &cVar24);
		cVar24 = { Var1 };
		StringConCat(&cVar24, "_12", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2642[iVar22 /*13*/].f_11), &cVar24);
		cVar24 = { Var1 };
		StringConCat(&cVar24, "_13", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_2642[iVar22 /*13*/].f_12), &cVar24);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_3963), "DO_CompletedObjectives");
	GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_3964), "DO_LoggedInToday");
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_3965), "DO_xValue");
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_3966), "DO_LastHistoryLength");
	GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_3967), "DO_LastResetTime");
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_3968), 10, "DO_Objectives");
	iVar22 = 0;
	while (iVar22 < 3)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_3968[iVar22 /*3*/]), &Var1);
		StringCopy(&Var1, "Completed", 16);
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::REGISTER_BOOL_TO_SAVE(&(uParam0->f_3968[iVar22 /*3*/].f_1), &Var1);
		StringCopy(&Var1, "Initial", 16);
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_3968[iVar22 /*3*/].f_2), &Var1);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_3978), 25, "DO_History");
	iVar22 = 0;
	while (iVar22 < 24)
	{
		...
		StringConCat(&Var1, "_", 16);
		StringIntConCat(&Var1, iVar22, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_3978[iVar22]), &Var1);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_4003), 49, "LAST_JobGamer_TL");
	iVar22 = 0;
	while (iVar22 < 3)
	{
		...
		GAMEPLAY::_0xFAA457EF263E8763(&(uParam0->f_4003[iVar22 /*16*/]), &cVar28);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_4052), 11, "BGSAVEINT");
	iVar0 = 0;
	while (iVar0 < 10)
	{
		StringCopy(&Var1, "BGSAVEINT", 16);
		StringIntConCat(&Var1, iVar0, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_4052[iVar0]), &Var1);
		iVar0++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_4063), 3, "PROPLIB");
	iVar0 = 0;
	while (iVar0 < uParam0->f_4063)
	{
		StringCopy(&Var1, "PROPLIB", 16);
		StringIntConCat(&Var1, iVar0, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_4063[iVar0]), &Var1);
		iVar0++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_4066), 40, "LAST_GOGamer");
	iVar22 = 0;
	while (iVar22 < 3)
	{
		...
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4066[iVar22 /*13*/]), &cVar32);
		cVar32 = { Var1 };
		StringConCat(&cVar32, "_2", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4066[iVar22 /*13*/].f_1), &cVar32);
		cVar32 = { Var1 };
		StringConCat(&cVar32, "_3", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4066[iVar22 /*13*/].f_2), &cVar32);
		cVar32 = { Var1 };
		StringConCat(&cVar32, "_4", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4066[iVar22 /*13*/].f_3), &cVar32);
		cVar32 = { Var1 };
		StringConCat(&cVar32, "_5", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4066[iVar22 /*13*/].f_4), &cVar32);
		cVar32 = { Var1 };
		StringConCat(&cVar32, "_6", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4066[iVar22 /*13*/].f_5), &cVar32);
		cVar32 = { Var1 };
		StringConCat(&cVar32, "_7", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4066[iVar22 /*13*/].f_6), &cVar32);
		cVar32 = { Var1 };
		StringConCat(&cVar32, "_8", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4066[iVar22 /*13*/].f_7), &cVar32);
		cVar32 = { Var1 };
		StringConCat(&cVar32, "_9", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4066[iVar22 /*13*/].f_8), &cVar32);
		cVar32 = { Var1 };
		StringConCat(&cVar32, "_10", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4066[iVar22 /*13*/].f_9), &cVar32);
		cVar32 = { Var1 };
		StringConCat(&cVar32, "_11", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4066[iVar22 /*13*/].f_10), &cVar32);
		cVar32 = { Var1 };
		StringConCat(&cVar32, "_12", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4066[iVar22 /*13*/].f_11), &cVar32);
		cVar32 = { Var1 };
		StringConCat(&cVar32, "_13", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4066[iVar22 /*13*/].f_12), &cVar32);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_4106), 40, "LAST_GOJobGamer");
	iVar22 = 0;
	while (iVar22 < 3)
	{
		...
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4106[iVar22 /*13*/]), &cVar36);
		cVar36 = { Var1 };
		StringConCat(&cVar36, "_2", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4106[iVar22 /*13*/].f_1), &cVar36);
		cVar36 = { Var1 };
		StringConCat(&cVar36, "_3", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4106[iVar22 /*13*/].f_2), &cVar36);
		cVar36 = { Var1 };
		StringConCat(&cVar36, "_4", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4106[iVar22 /*13*/].f_3), &cVar36);
		cVar36 = { Var1 };
		StringConCat(&cVar36, "_5", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4106[iVar22 /*13*/].f_4), &cVar36);
		cVar36 = { Var1 };
		StringConCat(&cVar36, "_6", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4106[iVar22 /*13*/].f_5), &cVar36);
		cVar36 = { Var1 };
		StringConCat(&cVar36, "_7", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4106[iVar22 /*13*/].f_6), &cVar36);
		cVar36 = { Var1 };
		StringConCat(&cVar36, "_8", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4106[iVar22 /*13*/].f_7), &cVar36);
		cVar36 = { Var1 };
		StringConCat(&cVar36, "_9", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4106[iVar22 /*13*/].f_8), &cVar36);
		cVar36 = { Var1 };
		StringConCat(&cVar36, "_10", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4106[iVar22 /*13*/].f_9), &cVar36);
		cVar36 = { Var1 };
		StringConCat(&cVar36, "_11", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4106[iVar22 /*13*/].f_10), &cVar36);
		cVar36 = { Var1 };
		StringConCat(&cVar36, "_12", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4106[iVar22 /*13*/].f_11), &cVar36);
		cVar36 = { Var1 };
		StringConCat(&cVar36, "_13", 16);
		GAMEPLAY::_0xA735353C77334EA0(&(uParam0->f_4106[iVar22 /*13*/].f_12), &cVar36);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_4146), 49, "LAST_GOJobGamer_TL");
	iVar22 = 0;
	while (iVar22 < 3)
	{
		...
		GAMEPLAY::_0xFAA457EF263E8763(&(uParam0->f_4146[iVar22 /*16*/]), &cVar40);
		iVar22++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::STOP_SAVE_ARRAY();
...
void func_18(var uParam0, char[4] cParam1)
{
	...
	GAMEPLAY::_START_SAVE_STRUCT(uParam0, 571, cParam1);
	...
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_36), 18, "PROP_DRINKS");
	...
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_54), 18, "PROP_SMOKES");
	StringCopy(&cVar1, "SMOKED_", 16);
	iVar0 = 0;
	while (iVar0 < 5)
	{
		StringIntConCat(&cVar1, iVar0 + 5, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_54[iVar0]), &cVar1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 12)
	...
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_72), 18, "PROP_STRIPPERS");
	StringCopy(&cVar1, "STRIPPERS_", 16);
	iVar0 = 0;
	while (iVar0 < 5)
	{
		StringIntConCat(&cVar1, iVar0 + 5, 16);
		GAMEPLAY::REGISTER_INT_TO_SAVE(&(uParam0->f_72[iVar0]), &cVar1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 12)
	...
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::_START_SAVE_ARRAY(&(uParam0->f_90), 481, "PROP_NAMEDVEHS");
	iVar0 = 0;
	while (iVar0 < 30)
	{
		StringCopy(&cVar1, "NAMEDVEH_", 16);
		StringIntConCat(&cVar1, iVar0, 16);
		GAMEPLAY::_0xFAA457EF263E8763(&(uParam0->f_90[iVar0 /*16*/]), &cVar1);
		iVar0++;
	}
	GAMEPLAY::STOP_SAVE_ARRAY();
	GAMEPLAY::STOP_SAVE_ARRAY();
...
void func_30()
{
	...
	while (iVar0 < 3)
	{
		...
		while (iVar1 <= 198)
		{
			if (GAMEPLAY::IS_BIT_SET(Global_106565.f_25176[iVar1], iVar0))
			{
				GAMEPLAY::CLEAR_BIT(&(Global_106565.f_25176[iVar1]), iVar0);
				iVar2 = (iVar1 + (198 - 171)) + 1;
				GAMEPLAY::SET_BIT(&(Global_106565.f_25176[iVar2]), iVar0);
			}
			iVar1++;
		}
		iVar0++;
...
int func_40()
{
	if (((UNK::_RETURN_ZERO2() || UNK::_RETURN_ZERO()) || NETWORK::_0x88B588B41FF7868E()) || NETWORK::_0x67FC09BC554A75E5())
	{
		return 1;
	}
	return 0;
