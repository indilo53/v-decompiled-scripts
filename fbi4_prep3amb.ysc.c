...
void func_163()
{
	if ((GAMEPLAY::IS_BIT_SET(uLocal_105, 0) && Global_36117 == 15) && !func_194())
	{
		if (iLocal_38 == 0)
		{
			if (!GAMEPLAY::IS_BIT_SET(uLocal_105, 1))
...
void func_209()
{
	...
	if (((((((Global_36117 == 15 && iLocal_37 != 3) && GAMEPLAY::IS_BIT_SET(uLocal_105, 5)) && !func_194()) && Global_71202 == -1) && !func_219()) && !func_82(9)) || func_101(35))
	{
		func_218();
		func_216();
		switch (iLocal_39)
...
int func_233(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2535519[iParam0 /*3*/][func_234(iParam1)];
