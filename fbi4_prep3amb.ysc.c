...
void func_1(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (iParam0 != 46)
		{
			if ((!func_2(func_3(iParam0)) && !Global_105205) && !GAMEPLAY::IS_BIT_SET(uLocal_105, 15))
			{
				GAMEPLAY::SET_BIT(&uLocal_105, 15);
				UI::CLEAR_HELP(1);
			}
		}
		else if ((UI::IS_HELP_MESSAGE_BEING_DISPLAYED() && !Global_105205) && !GAMEPLAY::IS_BIT_SET(uLocal_105, 15))
		{
			GAMEPLAY::SET_BIT(&uLocal_105, 15);
			UI::CLEAR_HELP(1);
		}
	...
	else if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_14534) == 1)
	{
		if (func_10())
		{
			if (func_9())
			{
				...
				while ((!GRAPHICS::_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(uVar0) && iVar6 == 0) && GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_14534) == 1)
				{
					SYSTEM::WAIT(0);
...
void func_163()
{
	if ((GAMEPLAY::IS_BIT_SET(uLocal_105, 0) && Global_36425 == 15) && !func_194())
	{
		if (iLocal_38 == 0)
		{
			if (!GAMEPLAY::IS_BIT_SET(uLocal_105, 1))
			{
				if (!func_74(PLAYER::PLAYER_PED_ID(), vLocal_106, 5f))
				{
					...
					{
						if ((func_236(PLAYER::PLAYER_PED_ID()) && !GAMEPLAY::IS_BIT_SET(uLocal_101[0], 17)) && !GAMEPLAY::IS_BIT_SET(uLocal_101[1], 18))
						{
...
int func_175(vector3 vParam0, bool bParam3)
{
	...
	while (iVar0 <= (7 - 1))
	{
		...
		{
			if (!bParam3 || GAMEPLAY::IS_BIT_SET(Global_106565.f_7223.f_17[iVar0], 0))
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_88851[iVar0 /*9*/].f_3, 1);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
void func_209()
{
	...
	if (((((((Global_36425 == 15 && iLocal_37 != 3) && GAMEPLAY::IS_BIT_SET(uLocal_105, 5)) && !func_194()) && Global_71587 == -1) && !func_219()) && !func_82(9)) || func_101(35))
	{
		func_218();
		func_216();
		switch (iLocal_39)
...
int func_214(int iParam0)
{
	...
	{
		if (GAMEPLAY::IS_BIT_SET(Global_106565.f_7682.f_651[iVar0 /*14*/].f_2, iParam0))
		{
			return 1;
		}
		iVar0++;
	...
	{
		if (GAMEPLAY::IS_BIT_SET(Global_106565.f_7682.f_765[iVar0 /*10*/].f_2, iParam0))
		{
			return 1;
		}
		iVar0++;
...
void func_222()
{
	if (iLocal_37 != 4)
	{
		if (iLocal_37 != 2)
		{
			if (UI::IS_HELP_MESSAGE_BEING_DISPLAYED() && !Global_105205)
			{
				GAMEPLAY::SET_BIT(&uLocal_105, 15);
				UI::CLEAR_HELP(1);
			}
