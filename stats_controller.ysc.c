		...
		while (iVar12 < iVar11)
		{
			...
			if (func_56(iLocal_58, iVar8, iVar3, &iVar4))
			{
				...
				if (iVar4 > func_53(iLocal_58, iVar8, -1))
				{
					...
					else if ((!Global_106565.f_9079 && !func_52(0)) || !GAMEPLAY::IS_BIT_SET(Global_106565.f_9079.f_2[27 /*3*/], 2))
					{
						bVar13 = false;
					}
					iVar14 = iVar4;
...
int func_9()
{
	if ((UI::IS_HUD_HIDDEN() && UI::IS_RADAR_HIDDEN()) && !func_44(PLAYER::PLAYER_ID()))
	{
		return 0;
	}
	if (Global_1657222 == 1)
...
{
	return GAMEPLAY::IS_BIT_SET(Global_1625319[iParam0 /*38*/].f_14, 0);
}
...
int func_24(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		...
		default:
			if (GAMEPLAY::IS_BIT_SET(Global_1371947.f_1046, iParam0))
			{
				return 1;
			}
			if (GAMEPLAY::IS_BIT_SET(Global_1371947.f_1047, iParam0))
			{
				return 1;
			}
			break;
...
void func_89()
{
	...
	if (iLocal_61)
	{
		...
		UI::_SET_NOTIFICATION_MESSAGE(func_91(iLocal_63), func_90(iLocal_63), iLocal_64, (iLocal_65 - iLocal_64), 0, sVar0, sVar0);
		iLocal_82 = 1;
...
void func_98()
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_2097152[func_81() /*10778*/].f_6165.f_1273, 2))
		{
			fVar0 = (SYSTEM::TO_FLOAT(func_70(192, -1, 0)) / 20f);
			iVar1 = SYSTEM::FLOOR(fVar0);
			iVar1 = func_69(iVar1, 0, 100);
			func_80(3, 2, iVar1);
			GAMEPLAY::SET_BIT(&(Global_2097152[func_81() /*10778*/].f_6165.f_1273), 2);
		}
	}
	bLocal_59 = true;
	iLocal_54 = 1;
		...
		while (iVar3 < 3)
		{
			...
			while (iVar4 < 8)
			{
				if (iVar4 != 0)
				{
					...
					STATS::STAT_SET_INT(uVar5, func_53(iVar3, iVar4, -1), 1);
				}
				iVar4++;
			}
			iVar3++;
