...
void func_4()
{
	...
	if (!NETWORK::NETWORK_IS_SIGNED_ONLINE())
	{
		...
		{
			Global_53666 = 0;
			Global_53667 = GAMEPLAY::GET_GAME_TIMER();
			Global_56479 = 1;
		}
		return;
	}
	...
	while (iVar0 < 80)
	{
		if (Global_48793[iVar0 /*36*/].f_8)
		{
			if (Global_48793[iVar0 /*36*/].f_35 > -1)
			{
				...
				STATS::STAT_GET_FLOAT(uVar2, &(Global_48793[iVar0 /*36*/].f_9), -1);
				if (Global_48793[iVar0 /*36*/].f_9 > 0f)
				{
					fVar3 = 0f;
					STATS::_0xBED9F5693F34ED17(uVar2, 0, &(Global_48793[iVar0 /*36*/].f_33));
...
float func_9(int iParam0, var uParam1)
{
	...
	iVar3 = 0;
	if (GAMEPLAY::IS_BIT_SET(uParam1, 3))
	{
		iVar3++;
	}
	if (GAMEPLAY::IS_BIT_SET(uParam1, 4))
	{
		iVar3 += 2;
	}
	if (GAMEPLAY::IS_BIT_SET(uParam1, 5))
	{
		iVar3 += 4;
	}
	if (GAMEPLAY::IS_BIT_SET(uParam1, 20))
	{
		iVar3 += 8;
	}
	...
	if (GAMEPLAY::IS_BIT_SET(uParam1, 16))
	{
		fVar0 = (fVar0 - 0.5f);
	}
	if (GAMEPLAY::IS_BIT_SET(uParam1, 17))
	{
		fVar0 = (fVar0 - 0.25f);
	}
	if (GAMEPLAY::IS_BIT_SET(uParam1, 18))
	{
		fVar0 = (fVar0 - 0.1f);
	}
	if (GAMEPLAY::IS_BIT_SET(uParam1, 19))
	{
		fVar0 = (fVar0 - 0.33f);
	}
	if (bVar1)
	...
	if (!GAMEPLAY::IS_BIT_SET(uParam1, 1))
	{
		if (GAMEPLAY::IS_BIT_SET(uParam1, 6))
		{
			fVar6 = 0f;
			if (GAMEPLAY::IS_BIT_SET(uParam1, 8))
			{
				fVar6 = (fVar6 + 0.5f);
			}
			if (GAMEPLAY::IS_BIT_SET(uParam1, 9))
			{
				fVar6 = (fVar6 + 0.25f);
			}
			if (GAMEPLAY::IS_BIT_SET(uParam1, 10))
			{
				fVar6 = (fVar6 + 0.125f);
			}
			if (fVar5 < fVar6)
			{
				fVar7 = (fVar5 / fVar6);
				if (GAMEPLAY::IS_BIT_SET(uParam1, 7))
				{
					fVar7 = (1f - fVar7);
					fVar7 = (fVar7 * fVar7);
					fVar7 = (1f - fVar7);
		...
		if (GAMEPLAY::IS_BIT_SET(uParam1, 11))
		{
			fVar8 = 0f;
			if (GAMEPLAY::IS_BIT_SET(uParam1, 13))
			{
				fVar8 = (fVar8 + 0.5f);
			}
			if (GAMEPLAY::IS_BIT_SET(uParam1, 14))
			{
				fVar8 = (fVar8 + 0.25f);
			}
			if (GAMEPLAY::IS_BIT_SET(uParam1, 15))
			{
				fVar8 = (fVar8 + 0.125f);
			}
			fVar9 = (1f - fVar8);
			if (fVar5 > fVar9)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(uParam1, 12))
				{
...
void func_27()
{
	...
	while (iVar0 < 8)
	{
		if (!GAMEPLAY::IS_BIT_SET(Global_106565.f_20558.f_461[iVar0], 1))
		{
...
void func_41()
{
	...
	while (iVar0 < 80)
	{
		if (!Global_48793[iVar0 /*36*/].f_8)
		{
			...
			fVar5 = (fVar5 + ((GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-Global_51948[iVar4 /*7*/].f_6, Global_51948[iVar4 /*7*/].f_6) * 0.1f) * Global_48793[iVar0 /*36*/].f_9));
...
int func_60(int iParam0, var uParam1)
{
	...
	while (iVar0 < 68)
	{
		if (Global_70409.f_484[iVar0] == iParam0)
		{
			...
			{
				if (GAMEPLAY::IS_BIT_SET(Global_70409.f_555[0 /*21*/].f_9, 10) && Global_70409.f_555[0 /*21*/].f_4 == ENTITY::GET_ENTITY_MODEL(iParam0))
				{
					*uParam1 = iVar0;
					return 1;
				}
			...
			case 140:
				...
				if (bVar4)
				{
					if (ENTITY::DOES_ENTITY_EXIST(uVar1))
					{
						...
						{
							if (func_72(ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(uVar1)))
							{
								func_2(3, 1);
							}
							func_71(ENTITY::GET_ENTITY_MODEL(uVar1));
						}
			...
			case 139:
				...
				if (bVar4)
				{
					if (ENTITY::DOES_ENTITY_EXIST(uVar1))
					{
						if (ENTITY::IS_ENTITY_A_PED(uVar1))
						{
							iVar3 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(uVar1);
							if (func_48() == 0 && iVar3 != PLAYER::PLAYER_PED_ID())
							{
								if (ENTITY::IS_ENTITY_DEAD(uVar1, 0) || IntToFloat(ENTITY::GET_ENTITY_HEALTH(uVar1)) < (0.5f * IntToFloat(PED::GET_PED_MAX_HEALTH(iVar3))))
								{
						...
						{
							func_68(ENTITY::GET_ENTITY_MODEL(uVar1));
							func_2(111, 1);
						}
						else if (ENTITY::IS_ENTITY_AN_OBJECT(uVar1))
						{
...
void func_73(var uParam0)
{
	...
	if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0))
	{
		...
		else
		{
			...
			iVar4 = ENTITY::GET_ENTITY_MODEL(uParam0);
...
int func_74(var uParam0)
{
	...
	iVar0 = PED::GET_PED_SOURCE_OF_DEATH(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(uParam0));
...
void func_79()
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), 0))
	{
		...
		if (func_80(iVar1, GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vLocal_27, vLocal_30, 0)))
		{
			vLocal_30 = { vLocal_27 };
		}
	}
			...
			if ((Global_48793[iVar1 /*36*/].f_32 > 0f && Global_48793[iVar1 /*36*/].f_31 > 0f) && Global_48793[iVar1 /*36*/].f_9 > 0f)
			{
				...
				if (fVar16 != 1f)
				{
					...
					while (iVar3 <= 15)
					{
						...
						Global_48793[iVar1 /*36*/].f_14[iVar3] = (Global_48793[iVar1 /*36*/].f_14[iVar3] * (GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(0.95f, 1.05f) + (fVar18 * fVar17)));
						if (iVar3 == 15)
						{
...
void func_93()
{
	...
	if (!Global_106565.f_20558.f_101)
	{
		...
		while (iVar0 < 80)
		{
			if (!Global_48793[iVar0 /*36*/].f_8)
			{
				Global_48793[iVar0 /*36*/].f_9 = GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(15f, 290f);
			}
			iVar0++;
		}
		iVar0 = 0;
		...
		while (iVar1 <= 15)
		{
			...
			while (iVar0 < 80)
			{
				...
				Global_48793[iVar0 /*36*/].f_9 = (Global_48793[iVar0 /*36*/].f_9 * GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(fVar2, fVar3));
				Global_48793[iVar0 /*36*/].f_9 = func_92(func_91(GAMEPLAY::ABSF(Global_48793[iVar0 /*36*/].f_9), 3.5f), 290f);
				iVar0++;
			}
			iVar1++;
		}
...
void func_94()
{
	...
	iVar2 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, (Global_53955 - 1));
	iVar0 = 0;
	while (iVar0 < 4)
	{
		iVar1 = 0;
