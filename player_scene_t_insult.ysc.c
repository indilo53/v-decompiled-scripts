...
int func_2()
{
	...
	while (iVar0 < iLocal_237)
	{
		...
		{
			vVar5 = { ENTITY::GET_ENTITY_COORDS(iLocal_237[iVar0], 1) };
		...
		switch (iLocal_240[iParam1])
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, &cLocal_345, &(Local_394[iParam1 /*16*/]), 2))
				{
					fVar0 = -1f;
					fVar1 = -1f;
					if (ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_345, &(Local_394[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1) || func_29(&cLocal_345, &(Local_394[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1))
					{
						...
						if (fVar2 > fVar0)
						{
							...
							AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, vLocal_273 + vLocal_284[iParam1 /*3*/], fVar3, -1, (fLocal_294[iParam1] * 0.1f), 0, 1193033728);
				...
				{
					AI::CLEAR_PED_TASKS(iParam0);
					if (GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_427[iParam1 /*16*/])))
					{
						...
						if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_691[iParam1 /*16*/])))
						{
							PED::SET_PED_MOVEMENT_CLIPSET(iParam0, &(Local_691[iParam1 /*16*/]), 1048576000);
						}
						AI::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, vLocal_273 + vLocal_284[iParam1 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
						iLocal_240[iParam1] = 1;
					}
					else
					{
						...
						AI::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_427[iParam1 /*16*/]), 1000f, -1000f, iVar8, iVar9, 1000f, iVar10);
						iVar11 = 0;
						while (iVar11 < iLocal_253)
						{
							if (iLocal_256[iVar11] != 0)
							{
								if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_592[iVar11 /*16*/])))
								{
									ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar11], iLocal_724, &(Local_592[iVar11 /*16*/]), &cLocal_345, 8f, 1090519040, 0, 1148846080);
								}
							}
							iVar11++;
						}
			...
			case 1:
				...
				if (AI::GET_SCRIPT_TASK_STATUS(iParam0, 713668775) != 1)
				{
					...
					AI::TASK_WANDER_IN_AREA(iParam0, vLocal_273 + vLocal_284[iParam1 /*3*/], fLocal_294[iParam1], 1077936128, 1086324736);
			...
			case 10:
				...
				else
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_427[iParam1 /*16*/]), 1000f, -1000f, iVar13, iVar14, 1000f, iVar15);
					iVar16 = 0;
					while (iVar16 < iLocal_253)
					{
						if (iLocal_256[iVar16] != 0)
						{
							if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_592[iVar16 /*16*/])))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar16], iLocal_724, &(Local_592[iVar16 /*16*/]), &cLocal_345, 8f, 1090519040, 0, 1148846080);
							}
						}
						iVar16++;
					}
				...
				if (bVar18)
				{
					...
					iVar20 = 4276;
					iVar21 = 0;
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_460[iParam1 /*16*/]), 8f, -1000f, iVar19, iVar20, 8f, iVar21);
					...
					while (iVar22 < iLocal_253)
					{
						...
						{
							if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_625[iVar22 /*16*/])))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar22], iLocal_724, &(Local_625[iVar22 /*16*/]), &cLocal_345, 8f, 1090519040, 0, 1148846080);
			...
			case 11:
				...
				if (!bVar23)
				{
					...
					iVar25 = 180;
					iVar26 = 0;
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_493[iParam1 /*16*/]), 1000f, -1000f, iVar24, iVar25, 1000f, iVar26);
					iVar27 = 0;
					while (iVar27 < iLocal_253)
					{
						if (iLocal_256[iVar27] != 0)
						{
							if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_658[iVar27 /*16*/])))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar27], iLocal_724, &(Local_658[iVar27 /*16*/]), &cLocal_345, 8f, 1090519040, 0, 1148846080);
							}
						}
						iVar27++;
					}
			...
			case 12:
				...
				if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_237[iParam1], &cLocal_345, &(Local_493[iParam1 /*16*/]), 2))
				{
					...
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_493[iParam1 /*16*/]), 1000f, -1000f, 0, 0, 1148846080, 0);
					iVar28 = 0;
					while (iVar28 < iLocal_253)
					{
						if (iLocal_256[iVar28] != 0)
						{
							if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_658[iVar28 /*16*/])))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar28], iLocal_724, &(Local_658[iVar28 /*16*/]), &cLocal_345, 8f, 1090519040, 0, 1148846080);
							}
						}
						iVar28++;
					}
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_28(iParam3), 0);
}
...
int func_29(char[4] cParam0, var uParam1, char* sParam2, float fParam3, float fParam4)
{
	if (GAMEPLAY::ARE_STRINGS_EQUAL(sParam2, "WalkInterruptible"))
	{
		...
		{
			if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam1, "EXIT_STRIPPER_01") || GAMEPLAY::ARE_STRINGS_EQUAL(uParam1, "EXIT_STRIPPER_02"))
			{
				*fParam3 = 0.4f;
				*fParam4 = 1f;
				return 1;
		...
		{
			if (GAMEPLAY::ARE_STRINGS_EQUAL(uParam1, "EXIT_Ped"))
			{
				*fParam3 = 0.7f;
				*fParam4 = 1f;
				return 1;
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
		{
			...
			while (iVar0 < iLocal_237)
			{
				if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
				{
					...
					fVar6 = -1f;
					fVar7 = -1f;
					if (ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_345, &(Local_394[iVar0 /*16*/]), "WalkInterruptible", &fVar6, &fVar7) || func_29(&cLocal_345, &(Local_394[iVar0 /*16*/]), "WalkInterruptible", &fVar6, &fVar7))
					{
						fVar1 = -8f;
						iVar2 = 2;
						iVar3 = 0;
					...
					AI::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_91042, &cLocal_345, &(Local_394[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
					iLocal_240[iVar0] = 0;
				}
				iVar0++;
			}
			...
			while (iVar0 < iLocal_253)
			{
				...
				{
					if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_559[iVar0 /*16*/])))
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_91042, &(Local_559[iVar0 /*16*/]), &cLocal_345, 8f, -1000f, 0, 1148846080);
					}
				}
				iVar0++;
			}
...
int func_32()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_91041))
	{
		...
		while (iVar0 < iLocal_237)
		{
			if (!PED::IS_PED_INJURED(iLocal_237[iVar0]))
			{
				AI::TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_91041, &cLocal_345, &(Local_361[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_253)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_253[iVar0]))
			{
				if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_526[iVar0 /*16*/])))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_91041, &(Local_526[iVar0 /*16*/]), &cLocal_345, 8f, -1000f, 0, 1148846080);
				}
			}
			iVar0++;
		}
...
void func_41()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_243)
		{
			...
			if (!GAMEPLAY::IS_STRING_NULL_OR_EMPTY(&(Local_691[iVar0 /*16*/])))
			{
	...
	while (iVar0 < iLocal_237)
	{
		if (iLocal_243[iVar0] != 0)
		{
			iLocal_237[iVar0] = PED::CREATE_PED(26, iLocal_243[iVar0], vLocal_273 + vLocal_277[iVar0 /*3*/], 0, 1, 1);
			...
			AI::TASK_PLAY_ANIM(iLocal_237[iVar0], &cLocal_345, &(Local_361[iVar0 /*16*/]), 8f, -8f, -1, 1, 0f, 0, 0, 0);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_253)
	{
		if (iLocal_256[iVar0] != 0)
		{
			iLocal_253[iVar0] = OBJECT::CREATE_OBJECT(iLocal_256[iVar0], vLocal_273 + vLocal_277[iVar0 /*3*/] + vLocal_259[iVar0 /*3*/], 1, 1, 0);
...
void func_42()
{
	...
	switch (iLocal_70)
	{
		case 237:
			...
			fLocal_729 = 0.15f;
			vLocal_277[0 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_277[1 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
		...
		case 244:
			...
			StringCopy(&(Local_427[0 /*16*/]), "", 64);
			vLocal_277[0 /*3*/] = { GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f };
