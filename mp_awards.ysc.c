...
void __EntryFunction__()
{
	...
	func_132();
	UI::PAUSE_MENU_ACTIVATE_CONTEXT(874957556);
				...
				if (iVar1 == 1)
				{
					if (iVar2 == 0)
					{
						if (UI::_0x3BAB9A4E4F2FF5C7())
						{
							...
							GRAPHICS::_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_COLUMN_FOCUS");
						...
						else
						{
							switch (Global_1367983.f_7)
							{
								case 0:
									...
									UI::PAUSE_MENU_ACTIVATE_CONTEXT(817402210);
									UI::OBJECT_DECAL_TOGGLE(874957556);
									UI::ENABLE_DEATHBLOOD_SEETHROUGH(0);
...
void func_2(var uParam0, var uParam1, var uParam2)
{
	...
	if ((CONTROLS::IS_CONTROL_PRESSED(2, 187) || func_12(187, &(Global_1371947.f_1060), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
		GAMEPLAY::SET_BIT(&(uParam0->f_464), 0);
	}
	if ((CONTROLS::IS_CONTROL_PRESSED(2, 188) || func_12(188, &(Global_1371947.f_1060), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
		GAMEPLAY::SET_BIT(&(uParam0->f_464), 1);
	}
	if (((CONTROLS::IS_CONTROL_PRESSED(2, 189) || CONTROLS::IS_CONTROL_PRESSED(2, 241)) || func_12(189, &(Global_1371947.f_1060), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
		GAMEPLAY::SET_BIT(&(uParam0->f_464), 2);
	}
	if (((CONTROLS::IS_CONTROL_PRESSED(2, 190) || CONTROLS::IS_CONTROL_PRESSED(2, 242)) || func_12(190, &(Global_1371947.f_1060), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
	...
	if (*uParam0 == 0)
	{
		...
		while (iVar0 <= 15)
		{
			if (uParam0->f_1[iVar0] == 1)
			{
				...
				GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(0);
				GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(0);
				GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_309[iVar0]);
				GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
				if (uParam0->f_378)
				{
				...
				GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_292[iVar0]);
				GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_343[iVar0]);
				GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_360[iVar0]);
				GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(-1);
				GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(-1);
				GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(-1);
				GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_326[iVar0]);
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			}
			*uParam0 = 1;
			iVar0++;
...
void func_17(var uParam0, int iParam1)
{
	...
	if (uParam0->f_381 == 0)
	{
		if (uParam0->f_380 != -1)
		{
			...
			GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(0);
			GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_380);
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			uParam0->f_380 = -1;
			uParam0->f_381 = 1;
		}
		...
		if (func_39(uParam0))
		{
			...
			while (iVar0 <= 11)
			{
				...
				if (uParam0->f_1[iVar0] == 1)
				{
					...
					GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_428[iVar0]);
					GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(iVar1);
					if (func_37(&cVar3))
					{
					...
					else
					{
						...
						UI::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&cVar3);
						GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
					}
...
void func_30(var uParam0, int iParam1)
{
	...
	if (uParam0->f_458 == 0)
	{
		GRAPHICS::_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_COLUMN_HIGHLIGHT");
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(1);
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(uParam0->f_455);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		uParam0->f_455 = -1;
		uParam0->f_458 = 1;
	}
...
int func_51(int iParam0, int iParam1)
{
	...
	iVar1 = iParam0;
	return GAMEPLAY::IS_BIT_SET(uVar0, func_52(iVar1));
}
	...
	else
	{
		switch (iParam0)
		{
			case 17:
				...
				while (iVar0 < 28)
				{
					if (GAMEPLAY::IS_BIT_SET(uVar13, iVar0))
					{
						iVar11++;
					}
					iVar0++;
				}
				if (GAMEPLAY::IS_BIT_SET(uVar13, 9))
				{
					iVar11 = (iVar11 - 1);
				}
				if (GAMEPLAY::IS_BIT_SET(uVar13, 26))
				{
					iVar11 = (iVar11 - 1);
				}
				if (iVar11 < 0)
...
int func_95(int iParam0)
{
	...
	while (iVar2 < 29)
	{
		if (GAMEPLAY::IS_BIT_SET(uVar1, iVar2))
		{
			iVar0++;
		}
		iVar2++;
...
int func_108()
{
	...
	if (GAMEPLAY::IS_BIT_SET(iVar0, 19))
	{
		return 6;
	}
	...
	else if (GAMEPLAY::IS_BIT_SET(iVar0, 0))
	{
		return 1;
	}
	return 0;
