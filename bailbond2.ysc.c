	...
	switch (iLocal_100)
	{
		case 0:
			...
			while (iVar0 <= (iLocal_473 - 1))
			{
				if (func_22(Local_132[iVar0 /*20*/]))
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_132[iVar0 /*20*/], uLocal_664);
...
void func_114(int iParam0)
{
	...
	{
		AI::CLEAR_PED_SECONDARY_TASK(Local_132[iParam0 /*20*/]);
		AI::CLEAR_PED_TASKS(Local_132[iParam0 /*20*/]);
		AI::TASK_CLEAR_LOOK_AT(Local_132[iParam0 /*20*/]);
		...
		PED::SET_PED_ACCURACY(Local_132[iParam0 /*20*/], GAMEPLAY::GET_RANDOM_INT_IN_RANGE(10, 20));
		PED::SET_PED_SHOOT_RATE(Local_132[iParam0 /*20*/], GAMEPLAY::GET_RANDOM_INT_IN_RANGE(15, 20));
		...
		AI::TASK_LOOK_AT_ENTITY(Local_132[iParam0 /*20*/], PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
		AI::TASK_COMBAT_PED(Local_132[iParam0 /*20*/], PLAYER::PLAYER_PED_ID(), 0, 16);
...
int func_192(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_202(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_202(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_202(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_234(iVar0);
						if (Global_71400 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_202(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_202(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_202(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_202(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_202(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_251(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_245(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_245(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_202(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_306(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_202(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_202(iParam1)))
	{
		return 1;
	}
	return 0;
				...
				if (!iLocal_448)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						else
						{
							...
							{
								if (func_113(iLocal_463, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_105(Local_112.f_9, vLocal_692, 30f))
									{
			...
			switch (Local_112.f_10)
			{
				...
				case 29:
					if (func_113(Local_112.f_18, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						AI::TASK_COMBAT_PED(Local_112.f_9, PLAYER::PLAYER_PED_ID(), 0, 16);
						AI::TASK_SET_SPHERE_DEFENSIVE_AREA(Local_112.f_9, vLocal_695, 30f);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
						Local_112.f_10 = 30;
					}
					break;
			...
			else
			{
				...
				else if (Local_112.f_10 == 24 && func_63(Local_112.f_9, -1519143300))
				{
					if (func_105(Local_112.f_9, vLocal_692, 25f))
					{
						...
						{
							if (func_113(iLocal_464, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_61())
								{
									func_3();
				...
				else
				{
					...
					if (!func_61())
					{
						if (func_113(iLocal_463, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_105(Local_112.f_9, vLocal_692, 20f))
							{
		...
		switch (iLocal_100)
		{
			...
			case 1:
				...
				if (!iLocal_448)
				{
					...
					{
						if (func_113(iLocal_463, GAMEPLAY::GET_RANDOM_INT_IN_RANGE(3500, 7000)))
						{
							if (func_105(Local_112.f_9, vLocal_692, 30f))
							{
								if (GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 101) < 30)
...
void func_395(int iParam0)
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_22(Local_132[iVar0 /*20*/]))
		{
			Local_132[iVar0 /*20*/].f_15 = GAMEPLAY::GET_GAME_TIMER();
...
void func_443(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if ((func_83(iParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_447(*uParam1, 0, &uVar0))
		{
...
int func_477(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_468(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_480(*uParam0, ((*uParam1)[38] - 1)))
	{
...
int func_490(var uParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_492(uParam0, uVar1[iVar6], 1) && func_491(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
	...
	while (iVar0 <= 5)
	{
		if (func_22(Local_132[iVar0 /*20*/]))
		{
			...
			if (iVar0 == 0)
			{
				...
				AI::SET_SEQUENCE_TO_REPEAT(uLocal_484, 1);
				AI::CLOSE_SEQUENCE_TASK(uLocal_484);
				AI::TASK_PERFORM_SEQUENCE(Local_132[iVar0 /*20*/], uLocal_484);
				AI::CLEAR_SEQUENCE_TASK(&uLocal_484);
				if (func_22(Local_132[iVar0 /*20*/]))
				{
