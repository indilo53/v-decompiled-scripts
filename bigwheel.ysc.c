...
void __EntryFunction__()
{
	...
	func_31();
	GAMEPLAY::SET_BIT(&Global_71838, 6);
	while (true)
	{
...
Vector3 func_20(var uParam0)
{
	...
	vVar0.x = (SYSTEM::SIN(uParam0) * vLocal_281.x);
	vVar0.y = (SYSTEM::COS(uParam0) * vLocal_281.y);
...
void func_24()
{
	...
	{
		ENTITY::SET_ENTITY_COORDS(uLocal_161, vLocal_278, 1, 0, 0, 1);
		ENTITY::SET_ENTITY_ROTATION(uLocal_161, (-fLocal_276 - (360f / 16f)), 0f, 0f, 2, 1);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_161, 1);
	}
	if (AUDIO::IS_AUDIO_SCENE_ACTIVE("FAIRGROUND_RIDES_FERRIS_WHALE"))
	{
		if (func_30(PLAYER::PLAYER_PED_ID()))
...
Vector3 func_27(var uParam0)
{
	...
	fVar0 = ((360f / SYSTEM::TO_FLOAT(16)) * SYSTEM::TO_FLOAT(uParam0));
...
void func_31()
{
	...
	GAMEPLAY::CLEAR_AREA_OF_PROJECTILES(vLocal_278, 60f, 0);
	...
	AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_287, "GENERATOR", uLocal_161, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
	iLocal_289 = AUDIO::GET_SOUND_ID();
	AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_289, "SLOW_SQUEAK", uLocal_161, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
...
void func_33()
{
	...
	func_43(64, 1, 0, 1, 0);
	uLocal_161 = OBJECT::CREATE_OBJECT(iLocal_158, 0f, 1f, 2f, 1, 1, 0);
	ENTITY::SET_ENTITY_COORDS(uLocal_161, vLocal_278, 1, 0, 0, 1);
	ENTITY::SET_ENTITY_ROTATION(uLocal_161, fLocal_276, 0f, 0f, 2, 1);
	ENTITY::FREEZE_ENTITY_POSITION(uLocal_161, 1);
...
void func_34(var uParam0, int iParam1, bool bParam2)
{
	...
	PED::SET_SYNCHRONIZED_SCENE_ORIGIN(uParam0->f_1, 0f, 0f, 0f, 0f, 0f, uVar4, 2);
	PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uParam0->f_1, uParam0->f_3, -1);
	PED::SET_SYNCHRONIZED_SCENE_LOOPED(uParam0->f_1, 1);
	iVar0 = 0;
	while (iVar0 < 2)
...
void func_130(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_124(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_124(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
...
void func_208(bool bParam0)
{
	if (bParam0)
	{
		UI::CLEAR_HELP(1);
		func_23(500, 1);
		GAMEPLAY::CLEAR_BIT(&Global_71838, 6);
	}
	func_254();
	func_252(1, 1, 1, 1);
	func_202(0);
...
void func_222(int iParam0)
{
	...
	else if (GAMEPLAY::IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || GAMEPLAY::IS_BIT_SET(Global_2097152[func_224() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		GAMEPLAY::CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		GAMEPLAY::CLEAR_BIT(&(Global_2097152[func_224() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
int func_226(int iParam0)
{
	...
	return GAMEPLAY::IS_BIT_SET(Global_2097152[func_224() /*10778*/].f_6165.f_10, iParam0);
}
