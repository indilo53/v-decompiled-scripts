	...
	if (iParam4 && !bParam7)
	{
		if (func_3(PLAYER::PLAYER_ID(), 1, 1))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_50(PLAYER::PLAYER_ID()), vParam0, 1) <= (fVar2 + fParam3))
				{
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != PLAYER::PLAYER_ID()))
				{
					if ((func_47(iVar1) || !bParam10) && !Global_2424047[iVar1 /*416*/].f_259)
					{
						...
						if (!bParam7)
						{
							...
							{
								if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_50(iVar1), vParam0, 1) <= (fVar2 + fParam3))
								{
				...
				if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
				{
					if (!bParam7 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_47(iVar1)))
					{
						if ((!bParam6 || (bParam6 == 1 && PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) != PLAYER::GET_PLAYER_TEAM(iVar1))) || PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1)
						{
							...
							{
								if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(func_51(iVar1), vParam0, 1) < fParam3)
								{
									return 1;
								}
							}
...
Vector3 func_62(vector3 vParam0, float fParam3, float fParam4, float fParam5)
{
	...
	fVar3 = (fParam5 / 2f);
	vVar0 = { func_63(vVar0, GAMEPLAY::GET_RANDOM_FLOAT_IN_RANGE(fParam3, fParam4)) };
			...
			if (((vLocal_117[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 1 || vLocal_117[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 2) || vLocal_117[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 3) || vLocal_117[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 4)
			{
				...
				if (vLocal_117[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 1)
				{
					if (func_72(Local_95.f_2))
					{
						...
						{
							func_85(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 23, 1), "BTX_ENTER", &uLocal_221, 0);
						}
					}
				}
				else
			...
			while (iVar0 < uParam2->f_680)
			{
				if (GAMEPLAY::IS_BIT_SET(uParam2->f_676, iVar0))
				{
					...
					if (!GAMEPLAY::IS_BIT_SET(uParam2->f_677, iVar0))
					{
						...
						func_80(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(uVar1, uVar2, 1));
						if (iVar3 < 359)
						{
							func_80(CONTROLS::GET_CONTROL_INSTRUCTIONAL_BUTTON(uVar1, iVar3, 1));
						}
					}
					else
					{
