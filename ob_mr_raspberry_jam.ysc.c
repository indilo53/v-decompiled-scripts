...
void __EntryFunction__()
{
	...
	vLocal_286 = { 0f, 0f, 0f };
	vLocal_289 = { 0f, 0f, 0f };
	iLocal_296 = GAMEPLAY::GET_RANDOM_INT_IN_RANGE(0, 4);
	func_70();
	...
	while (true)
	{
		...
		{
			if (((((BRAIN::IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE(uLocal_41) && !ENTITY::IS_ENTITY_DEAD(uLocal_41, 0)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && func_57()) && func_56(0)) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
			{
				switch (iLocal_292)
				{
					case 0:
...
void func_1()
{
	...
	{
		case 0:
			if (func_46(vVar0, vVar3) && PED::_0xFCF37A457CB96DC0(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(uLocal_41, 1), 90f))
			{
				func_70();
		...
		case 2:
			...
			uLocal_294 = PED::CREATE_SYNCHRONIZED_SCENE(func_31(), func_30(), 2);
			AI::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_294, func_29(), func_28(iLocal_296), 8f, -2f, 0, 0, 1148846080, 0);
			ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_41, uLocal_294, func_27(iLocal_296), func_29(), 8f, -2f, 0, 1148846080);
			if (PED::_0x7F2F4F13AC5257EF(uLocal_294))
			{
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_294, 0);
			}
			if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
			{
				uLocal_295 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
				CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_295, uLocal_294, func_24(iLocal_296), func_29());
			...
			iLocal_299 = 0;
			iLocal_300 = (GAMEPLAY::GET_GAME_TIMER() + func_23());
			iLocal_293 = 3;
			break;
		...
		case 3:
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_294))
			{
				...
				if (!iLocal_299 && GAMEPLAY::GET_GAME_TIMER() > iLocal_300)
				{
...
int func_56(int iParam0)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		{
			if (func_47(ENTITY::GET_ENTITY_COORDS(uLocal_41, 0), func_51(), 5f, 0))
			{
				return 1;
			}
		}
