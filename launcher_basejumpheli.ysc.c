		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_85) && !ENTITY::IS_ENTITY_DEAD(uLocal_85, 0))
		{
			...
			switch (iLocal_95)
			{
						...
						if (bVar2)
						{
							...
							if (bVar2)
							{
								...
								if (func_109(iLocal_86))
								{
									...
									else if (!func_152(uLocal_94, 2048) || !UI::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_107(&iLocal_96);
				...
				case 6:
					...
					if (func_152(uLocal_94, 2097152))
					{
						if (!func_130(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_52))
						{
							func_145(10);
						}
					}
...
void func_16(var uParam0, var uParam1)
{
	...
	{
		vVar6 = { CAM::GET_CAM_COORD(*uParam0) };
		...
		CAM::SET_CAM_ROT(*uParam0, vVar0, 2);
	}
}
...
void func_51()
{
	...
	if (func_100(Local_287.f_3, Local_287, 1, 1, 1, 1, 0) || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Local_287.f_3) && !PED::IS_PED_INJURED(Local_287.f_3))
		{
			...
			{
				AI::TASK_VEHICLE_MISSION_COORS_TARGET(Local_287.f_3, Local_287, ENTITY::GET_ENTITY_COORDS(Local_287, 1) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_287) + Vector(500f, 0f, 0f), 4, VEHICLE::_GET_VEHICLE_MAX_SPEED(Local_287), 262144, 50f, 50f, 1);
			}
			else
			{
	...
	fVar10 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_99(iLocal_121));
	if (fVar10 < 11664f)
	{
		if (!iLocal_460)
		{
	...
	if (fVar10 < 10000f)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(Local_287.f_3))
		{
			...
			{
				Local_287.f_3 = PED::CREATE_PED_INSIDE_VEHICLE(Local_287, 4, func_98(iLocal_121), -1, 1, 1);
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_287, 0))
			{
				...
				if (iVar0 != 0 && iVar0 != 1)
				{
					...
					if (!ENTITY::IS_ENTITY_DEAD(Local_287.f_3, 0) && !ENTITY::IS_ENTITY_DEAD(Local_287, 0))
					{
						...
						AI::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_287, ENTITY::GET_ENTITY_COORDS(Local_287, 1) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_287) + Vector(500f, 0f, 0f), 4, VEHICLE::_GET_VEHICLE_MAX_SPEED(Local_287), 262144, 50f, 50f, 1);
...
int func_75(int iParam0, var uParam1)
{
	...
	if (PED::IS_PED_IN_VEHICLE(iParam0, uParam1, 0) && func_76(iParam0, uParam1) == -1)
	{
		return 1;
	}
	return 0;
...
int func_100(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (((!ENTITY::DOES_ENTITY_EXIST(uParam1) || ENTITY::IS_ENTITY_DEAD(uParam1, 0)) || !VEHICLE::IS_VEHICLE_DRIVEABLE(uParam1, 0)) || FIRE::IS_ENTITY_ON_FIRE(uParam1))
	{
		return 1;
	}
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (bParam3)
			{
				if (PED::IS_PED_IN_COMBAT(iParam0, uVar0))
				{
					return 1;
				}
			}
			...
			if (bParam4)
			{
				...
				{
					if (PED::IS_PED_FACING_PED(iParam0, uVar0, 90f))
					{
			...
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(PED::GET_VEHICLE_PED_IS_IN(iParam0, 0), uVar0, 1))
				{
					return 1;
				}
			}
			if (WEAPON::IS_PED_ARMED(uVar0, 4))
			{
				if (PED::IS_PED_SHOOTING(uVar0))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iParam0, ENTITY::GET_ENTITY_COORDS(uVar0, 1), 45f, 45f, 45f, 0, 1, 0))
					{
						return 1;
					}
				}
			...
			if (PED::IS_PED_BEING_JACKED(iParam0) || !func_75(iParam0, uParam1))
			{
				return 1;
			}
...
{
	return func_102(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), uParam0, iParam1);
}
...
void func_135(vector3 vParam0, float fParam3)
{
	...
	if (bVar1)
	{
		...
		if (iLocal_121 == 3)
		{
			Local_287 = VEHICLE::CREATE_VEHICLE(joaat("frogger"), vParam0, fParam3, 1, 1, 0);
			VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_287, 5);
		}
		else
		{
			Local_287 = VEHICLE::CREATE_VEHICLE(joaat("maverick"), vParam0, fParam3, 1, 1, 0);
