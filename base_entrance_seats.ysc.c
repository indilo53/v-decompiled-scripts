...
void func_73(int iParam0, var uParam1, int iParam2)
{
	...
	func_80(iParam0, &vVar0, &fVar3);
	iVar4 = 0;
	while (iVar4 < 2)
	{
		(*uParam1)[(*iParam2)[iVar4] /*14*/] = 2;
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_8 = { func_76(func_77(iVar4), fVar3) + vVar0 };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_8.f_3 = { 0f, 0f, (fVar3 + 174f) };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_1 = { func_76(func_75(iVar4), fVar3) + vVar0 };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_1.f_3 = { func_76(func_74(iVar4), fVar3) + vVar0 };
...
Vector3 func_76(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
