...
void func_40(bool bParam0, bool bParam1)
{
	...
	else
	{
		...
		else if (func_36(iLocal_392) && ENTITY::IS_ENTITY_AT_COORD(iLocal_392, vLocal_380, 50f, 50f, 50f, 0, 1, 0))
		{
			func_44(iLocal_392);
		}
		else
		...
		switch (iLocal_389)
		{
			case 0:
				...
				else
				{
					...
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_296, 1f, 20000, 1048576000, 0, 1193033728);
			...
			case 3:
				...
				if (((!func_21() && func_76(iLocal_392, vLocal_296, 4f)) || bLocal_300) || GAMEPLAY::GET_GAME_TIMER() > iLocal_299)
				{
					if (bLocal_300)
					{
						if (func_21())
...
int func_85(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (GAMEPLAY::IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_95(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_95(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(uParam0, func_95(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_127(iVar0);
						if (Global_71400 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_95(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_95(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(uParam0, func_95(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
void func_105(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_106(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, DLC1::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_95(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_110(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_112(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_112(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 4);
		}
	}
...
int func_112(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_95(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_107(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_107(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 1) || DLC1::_IS_TAG_RESTRICTED(func_107(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (DLC1::_IS_TAG_RESTRICTED(iParam3, -1757550583, 0) || DLC1::_IS_TAG_RESTRICTED(func_107(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_144(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!DLC1::_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_138(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, DLC1::_IS_TAG_RESTRICTED(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_138(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, DLC1::_IS_TAG_RESTRICTED(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = DLC1::_GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_95(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_199(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_95(iParam1)) && Global_71402[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(uParam0, func_95(iParam1)))
	{
		return 1;
	}
	return 0;
		...
		switch (iLocal_389)
		{
			case 0:
				...
				else
				{
					...
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2f, 20000, 1048576000, 0, 1193033728);
					AI::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000);
					AI::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_293, 1f, 20000, 1048576000, 0, 1193033728);
					AI::CLOSE_SEQUENCE_TASK(uVar1);
					AI::TASK_PERFORM_SEQUENCE(iLocal_392, uVar1);
					AI::CLEAR_SEQUENCE_TASK(&uVar1);
				}
			...
			case 3:
				...
				if (((!func_21() && (func_76(iLocal_392, vLocal_287, 2f) || func_76(iLocal_392, vLocal_290, 2f))) || bLocal_300) || GAMEPLAY::GET_GAME_TIMER() > iLocal_299)
				{
					if (bLocal_300)
					{
						if (func_21())
						...
						{
							AI::CLEAR_PED_TASKS(iLocal_392);
							ENTITY::SET_ENTITY_COORDS(iLocal_392, vLocal_293, 1, 0, 0, 1);
...
int func_218()
{
	...
	{
		vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_403, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) };
		if (vVar0.y < -1f)
		{
			return 1;
		}
...
void func_221()
{
	...
	if (func_36(iLocal_392))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_392, 0))
		{
			uVar0 = PED::GET_VEHICLE_PED_IS_IN(iLocal_392, 0);
			if (ENTITY::DOES_ENTITY_EXIST(uVar0))
			{
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uVar0, 0) && ENTITY::IS_ENTITY_IN_WATER(uVar0))
				{
...
void func_222()
{
	if ((iLocal_349 < 3 && GAMEPLAY::GET_GAME_TIMER() > iLocal_343) && (func_225() || func_224()))
	{
...
int func_225()
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (func_43(uVar0) && PED::IS_PED_IN_VEHICLE(iLocal_392, uVar0, 0))
		{
			return 1;
		}
	}
...
void func_226()
{
	...
	if ((iLocal_332 < 6 && GAMEPLAY::GET_GAME_TIMER() > iLocal_324) && func_225())
	{
	...
	switch (iLocal_389)
	{
		case 0:
			...
			if (func_331() == 1)
			{
				...
				VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_383 - Vector(10f, 10f, 10f), vLocal_383 + Vector(10f, 10f, 10f), 0, 1);
				GAMEPLAY::CLEAR_AREA_OF_VEHICLES(vLocal_383, 10f, 0, 0, 0, 0, 0, 0);
			}
			else
			{
...
void func_241()
{
	...
	if (func_36(PLAYER::PLAYER_PED_ID()) && GAMEPLAY::GET_GAME_TIMER() > iLocal_374)
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
...
void func_243()
{
	if ((iLocal_372 < 12 && GAMEPLAY::GET_GAME_TIMER() > iLocal_358) && func_36(uLocal_394[0]))
	{
		if (func_219(PLAYER::PLAYER_PED_ID(), uLocal_394[0]) < 30f)
		{
			if (!func_21() && func_223())
			{
...
void func_244()
{
	...
	if ((iLocal_342 < 3 && GAMEPLAY::GET_GAME_TIMER() > iLocal_333) && (func_225() || func_224()))
	{
...
void func_245()
{
	...
	{
		if (((!func_21() && func_223()) && func_225()) && GAMEPLAY::GET_GAME_TIMER() > iLocal_319)
		{
...
void func_246()
{
	if (((((iLocal_375 && ENTITY::DOES_ENTITY_EXIST(uLocal_394[0])) && ENTITY::DOES_ENTITY_EXIST(uLocal_394[1])) && ENTITY::DOES_ENTITY_EXIST(uLocal_394[2])) && func_36(iLocal_392)) && !UI::IS_MESSAGE_BEING_DISPLAYED())
	{
...
void func_272(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar9 < iVar10)
		{
			if ((DLC1::GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_274(Var11.f_1)) && iVar72 < 51)
			{
...
int func_289(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_305(iVar0))
		{
			...
			{
				fVar1 = GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_290(iVar0, 0), 1);
...
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_313(GAMEPLAY::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_334()
{
	...
	switch (iLocal_389)
	{
		case 0:
			...
			if ((((func_43(iLocal_403) && func_36(uLocal_394[0])) && func_36(uLocal_394[1])) && func_36(uLocal_394[2])) && func_36(iLocal_392))
			{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					if (func_35(uVar1))
					{
						VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(uVar1, 1);
					}
					func_41(&uVar1);
				}
			}
		...
		case 1:
			...
			if (func_43(iLocal_403) && ENTITY::DOES_ENTITY_EXIST(uLocal_394[0]))
			{
...
int func_344(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, float fParam6)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		vVar1 = { func_30(ENTITY::GET_ENTITY_COORDS(uVar0, 1) - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
		vVar4 = { ENTITY::GET_ENTITY_VELOCITY(uParam0) - ENTITY::GET_ENTITY_VELOCITY(uVar0) };
...
int func_345()
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_43(iLocal_403))
	{
		...
		if (func_43(uVar0))
		{
			...
			{
				if (VEHICLE::IS_VEHICLE_SIREN_ON(uVar0) && func_34(uVar0, iLocal_403, 15f, 1))
				{
					return 1;
				}
			}
...
void func_350(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_373(uParam1) && ENTITY::IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
int func_355(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_362() || func_361(Global_4456448.f_161209)) || func_360())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(uVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_358(uVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
void func_378()
{
	...
	if ((func_36(PLAYER::PLAYER_PED_ID()) && func_36(uLocal_394[0])) && func_43(iLocal_403))
	{
		if (iLocal_310 == -1 && iLocal_311 == -1)
		{
			...
			else if (func_219(PLAYER::PLAYER_PED_ID(), uLocal_394[0]) < 50f && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_403))
			{
		...
		else if (((iLocal_310 < 8 && func_219(PLAYER::PLAYER_PED_ID(), uLocal_394[0]) < 50f) && !func_21()) && !func_377("MEJ1_02", 0, 0))
		{
...
void func_381(int iParam0, int iParam1, int iParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			...
			{
				uVar5 = PED::GET_VEHICLE_PED_IS_IN(iParam0, 0);
				if (func_43(uVar5))
				{
...
void func_387()
{
	...
	switch (iLocal_389)
	{
		case 0:
			...
			UI::SET_BLIP_COLOUR(uLocal_391, 3);
			UI::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_391, "MEJ1_JIM");
			UI::SET_BLIP_ROUTE(uLocal_391, 1);
		...
		case 1:
			if (GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_377, 1) < 1400f)
			{
				iLocal_389 = 2;
			}
			break;
...
int func_388()
{
	if (((func_43(iLocal_403) && func_36(PLAYER::PLAYER_PED_ID())) && func_36(uLocal_394[0])) && func_36(iLocal_392))
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_409, vLocal_412, fLocal_433, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_415, vLocal_418, fLocal_434, 0, 1, 0))
		{
			ENTITY::SET_ENTITY_COORDS(iLocal_403, vLocal_405, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(iLocal_403, fLocal_408);
			return 1;
		}
		else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_421, vLocal_424, fLocal_433, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_427, vLocal_430, fLocal_434, 0, 1, 0))
		{
			ENTITY::SET_ENTITY_COORDS(iLocal_403, vLocal_405, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(iLocal_403, fLocal_408);
			return 1;
...
void func_389()
{
	...
	if (func_43(iLocal_403))
	{
		...
		while (iVar0 < 3)
		{
			if (!func_36(uLocal_394[iVar0]))
			{
				...
				{
					uLocal_394[iVar0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_403, 4, iLocal_402, iLocal_398[iVar0], 1, 1);
					PED::SET_PED_COMPONENT_VARIATION(uLocal_394[iVar0], 0, iVar0, iVar0, 0);
					PED::SET_PED_COMPONENT_VARIATION(uLocal_394[iVar0], 2, iVar0, iVar0, 0);
					PED::SET_PED_COMPONENT_VARIATION(uLocal_394[iVar0], 3, iVar0, iVar0, 0);
					PED::SET_PED_COMPONENT_VARIATION(uLocal_394[iVar0], 4, iVar0, iVar0, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_394[iVar0], 1);
					ENTITY::SET_ENTITY_VISIBLE(uLocal_394[iVar0], 0, 0);
					PED::SET_PED_FLEE_ATTRIBUTES(uLocal_394[iVar0], 2, 0);
					PED::SET_PED_FLEE_ATTRIBUTES(uLocal_394[iVar0], 128, 0);
					PED::SET_PED_FLEE_ATTRIBUTES(uLocal_394[iVar0], 65536, 1);
					PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_394[iVar0], 17, 1);
					ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_394[iVar0], 1);
					if (iVar0 == 0)
					{
	...
	{
		iLocal_403 = VEHICLE::CREATE_VEHICLE(iLocal_404, vLocal_405, fLocal_408, 1, 1, 0);
...
int func_390(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	{
		func_48(uParam0);
		*uParam0 = PED::CREATE_PED(26, iVar0, vParam1, fParam4, 0, 0);
		...
		PED::SET_PED_COMPONENT_VARIATION(*uParam0, 1, 3, 0, 0);
		if (bParam5)
		{
	...
	if (UI::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		...
		if (func_391())
		{
			...
			switch (iVar5)
			{
				...
				case 3:
					func_396(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
...
void func_403(bool bParam0)
{
	...
	if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_392))
	{
		...
		else
		{
			...
			if ((func_43(uVar1) && VEHICLE::IS_VEHICLE_SEAT_FREE(uVar1, 0, 0)) && func_36(iLocal_392))
			{
				PED::SET_PED_INTO_VEHICLE(iLocal_392, uVar1, 0);
...
int func_407(int iParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_394[2]))
	{
		return 0;
	}
...
void func_411()
{
	...
	if (func_36(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_43(uVar0))
		{
			VEHICLE::SET_VEHICLE_FORWARD_SPEED(uVar0, 25f);
		}
	}
	func_402(1, 1, 1);
}
...
void func_432(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if ((func_13(iParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_436(*uParam1, 0, &uVar0))
		{
...
int func_473(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_458(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_476(*uParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_476(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_475(uParam0);
	if (func_474(*uParam0))
	{
...
int func_491(var uParam0, vector3 vParam1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_492(uParam0, uVar1[iVar6], 1) && func_418(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_282(vParam1, 0f, 0f, 0f, 0)) || GAMEPLAY::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&uParam0);
						return 1;
					}
...
void func_493(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((GAMEPLAY::IS_BIT_SET(uParam1->f_77, 15) || func_496(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_495())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
void func_509(bool bParam0)
{
	...
	CAM::SET_WIDESCREEN_BORDERS(0, 0);
	VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_383 - Vector(10f, 10f, 10f), vLocal_383 + Vector(10f, 10f, 10f), 1, 1);
	func_508(0);
